...
public final class GoogleCloudPolicysimulatorV1ExplainedAccess extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudPolicysimulatorV1ExplainedAccess setAccessState(java.lang.String accessState) {
   ...
   */
  public GoogleCloudPolicysimulatorV1ExplainedAccess setErrors(java.util.List<GoogleRpcStatus> errors) {
    this.errors = errors;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudPolicysimulatorV1ExplainedPolicy> getPolicies() {
    return policies;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1ExplainedAccess setPolicies(java.util.List<GoogleCloudPolicysimulatorV1ExplainedPolicy> policies) {
    this.policies = policies;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1ExplainedAccess set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1ExplainedAccess) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1ExplainedAccess clone() {
    return (GoogleCloudPolicysimulatorV1ExplainedAccess) super.clone();
  }
