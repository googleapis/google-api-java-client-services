# Cloud OS Config API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1beta-rev20200706-1.30.10</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-osconfig:v1beta-rev20200706-1.30.10'
}
```
