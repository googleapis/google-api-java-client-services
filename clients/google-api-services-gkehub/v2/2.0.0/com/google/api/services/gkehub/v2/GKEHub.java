...
package com.google.api.services.gkehub.v2;
...
public class GKEHub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends GKEHubRequest<com.google.api.services.gkehub.v2.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v2.model.Location.class);
      ...
      public class List extends GKEHubRequest<com.google.api.services.gkehub.v2.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v2.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.gkehub.v2.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.gkehub.v2.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends GKEHubRequest<com.google.api.services.gkehub.v2.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.gkehub.v2.model.CancelOperationRequest content) {
            super(GKEHub.this, "POST", REST_PATH, content, com.google.api.services.gkehub.v2.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends GKEHubRequest<com.google.api.services.gkehub.v2.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends GKEHubRequest<com.google.api.services.gkehub.v2.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v2.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
