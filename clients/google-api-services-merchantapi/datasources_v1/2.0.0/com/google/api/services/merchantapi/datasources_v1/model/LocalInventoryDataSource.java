...
public final class LocalInventoryDataSource extends com.google.api.client.json.GenericJson {

  /**
   * Required. Immutable. The two-letter ISO 639-1 language of the items to which the local
   ...
   */
  public LocalInventoryDataSource setContentLanguage(java.lang.String contentLanguage) {
  ...
  @Override
  public LocalInventoryDataSource set(String fieldName, Object value) {
    return (LocalInventoryDataSource) super.set(fieldName, value);
  }

  @Override
  public LocalInventoryDataSource clone() {
    return (LocalInventoryDataSource) super.clone();
  }
