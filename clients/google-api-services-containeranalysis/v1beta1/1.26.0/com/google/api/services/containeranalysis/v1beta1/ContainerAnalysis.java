...
public class ContainerAnalysis extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Container Analysis API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class ScanConfigs {
      ...
      public class Get extends ContainerAnalysisRequest<com.google.api.services.containeranalysis.v1beta1.model.ScanConfig> {
       ...
       *        `projects/[PROJECT_ID]/scanConfigs/[SCAN_CONFIG_ID]`.
         ...
         */
        protected Get(java.lang.String name) {
          super(ContainerAnalysis.this, "GET", REST_PATH, null, com.google.api.services.containeranalysis.v1beta1.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends ContainerAnalysisRequest<com.google.api.services.containeranalysis.v1beta1.model.ListScanConfigsResponse> {
      ...
      `projects/[PROJECT_ID]`.
         ...
         */
        protected List(java.lang.String parent) {
          super(ContainerAnalysis.this, "GET", REST_PATH, null, com.google.api.services.containeranalysis.v1beta1.model.ListScanConfigsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *
       * Create a request for the method "scanConfigs.update".
       *
       * This request holds the parameters needed by the containeranalysis server.  After setting any
       ...
       * @return the request
       */
      public Update update(java.lang.String name, com.google.api.services.containeranalysis.v1beta1.model.ScanConfig content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends ContainerAnalysisRequest<com.google.api.services.containeranalysis.v1beta1.model.ScanConfig> {
       ...
       *        `projects/[PROJECT_ID]/scanConfigs/[SCAN_CONFIG_ID]`.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.api.services.containeranalysis.v1beta1.model.ScanConfig content) {
          super(ContainerAnalysis.this, "PUT", REST_PATH, content, com.google.api.services.containeranalysis.v1beta1.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
