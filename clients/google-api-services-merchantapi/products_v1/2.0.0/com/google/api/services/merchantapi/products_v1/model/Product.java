...
public final class Product extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Determines whether the product is **only** targeting local destinations and
   * whether the product name should be distinguished with a `local~` prefix. For example,
   ...
   */
  public Product setLegacyLocal(java.lang.Boolean legacyLocal) {
   ...
   */
  public Product setProductAttributes(ProductAttributes productAttributes) {
