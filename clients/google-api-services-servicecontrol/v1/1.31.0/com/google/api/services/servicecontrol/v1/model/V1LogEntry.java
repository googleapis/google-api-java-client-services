...
public final class V1LogEntry extends com.google.api.client.json.GenericJson {
   ...
   */
  public V1LogEntry setHttpRequest(V1HttpRequest httpRequest) {
   ...
   */
  public V1LogEntry setInsertId(java.lang.String insertId) {
   ...
   */
  public V1LogEntry setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public V1LogEntry setMonitoredResourceLabels(java.util.Map<String, java.lang.String> monitoredResourceLabels) {
   ...
   */
  public V1LogEntry setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public V1LogEntry setOperation(V1LogEntryOperation operation) {
   ...
   */
  public V1LogEntry setProtoPayload(java.util.Map<String, java.lang.Object> protoPayload) {
   ...
   */
  public V1LogEntry setSeverity(java.lang.String severity) {
   ...
   */
  public V1LogEntry setSourceLocation(V1LogEntrySourceLocation sourceLocation) {
   ...
   */
  public V1LogEntry setStructPayload(java.util.Map<String, java.lang.Object> structPayload) {
   ...
   */
  public V1LogEntry setTextPayload(java.lang.String textPayload) {
   ...
   */
  public V1LogEntry setTimestamp(String timestamp) {
   ...
   */
  public V1LogEntry setTrace(java.lang.String trace) {
    this.trace = trace;
    return this;
  }

  @Override
  public V1LogEntry set(String fieldName, Object value) {
    return (V1LogEntry) super.set(fieldName, value);
  }

  @Override
  public V1LogEntry clone() {
    return (V1LogEntry) super.clone();
  }
