...
public final class RemoveHeldAccountsRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RemoveHeldAccountsRequest set(String fieldName, Object value) {
    return (RemoveHeldAccountsRequest) super.set(fieldName, value);
  }

  @Override
  public RemoveHeldAccountsRequest clone() {
    return (RemoveHeldAccountsRequest) super.clone();
  }
