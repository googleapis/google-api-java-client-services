...
public final class ModifyContactGroupMembersResponse extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getNotFoundResourceNames() {
    return notFoundResourceNames;
  }

  /**
   * The contact people resource names that were not found.
   * @param notFoundResourceNames notFoundResourceNames or {@code null} for none
   */
  public ModifyContactGroupMembersResponse setNotFoundResourceNames(java.util.List<java.lang.String> notFoundResourceNames) {
    this.notFoundResourceNames = notFoundResourceNames;
    return this;
  }

  @Override
  public ModifyContactGroupMembersResponse set(String fieldName, Object value) {
    return (ModifyContactGroupMembersResponse) super.set(fieldName, value);
  }
