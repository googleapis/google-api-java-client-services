 ...
 * google.devtools.remoteexecution.v1test.requestmetadata-bin contents: the base64 encoded binary
...
public final class GoogleDevtoolsRemoteexecutionV1testRequestMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata setActionId(java.lang.String actionId) {
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata setCorrelatedInvocationsId(java.lang.String correlatedInvocationsId) {
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata setToolDetails(GoogleDevtoolsRemoteexecutionV1testToolDetails toolDetails) {
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata setToolInvocationId(java.lang.String toolInvocationId) {
    this.toolInvocationId = toolInvocationId;
    return this;
  }

  @Override
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata set(String fieldName, Object value) {
    return (GoogleDevtoolsRemoteexecutionV1testRequestMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleDevtoolsRemoteexecutionV1testRequestMetadata clone() {
