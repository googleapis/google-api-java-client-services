...
public final class Network extends com.google.api.client.json.GenericJson {
   ...
   * `projects/{project}/locations/{location}/networks/{network}` This field will contain the same
   * value as field "network", which will soon be deprecated. Please use this field to reference the
