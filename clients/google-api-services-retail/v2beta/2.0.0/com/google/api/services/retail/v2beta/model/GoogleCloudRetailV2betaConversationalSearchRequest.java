...
public final class GoogleCloudRetailV2betaConversationalSearchRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudRetailV2betaConversationalSearchRequestConversationalFilteringSpec conversationalFilteringSpec;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2betaSafetySetting> safetySettings;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudRetailV2betaConversationalSearchRequestSearchParams searchParams;
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setBranch(java.lang.String branch) {
    this.branch = branch;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setConversationId(java.lang.String conversationId) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudRetailV2betaConversationalSearchRequestConversationalFilteringSpec getConversationalFilteringSpec() {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setConversationalFilteringSpec(GoogleCloudRetailV2betaConversationalSearchRequestConversationalFilteringSpec conversationalFilteringSpec) {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setQuery(java.lang.String query) {
    this.query = query;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2betaSafetySetting> getSafetySettings() {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setSafetySettings(java.util.List<GoogleCloudRetailV2betaSafetySetting> safetySettings) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudRetailV2betaConversationalSearchRequestSearchParams getSearchParams() {
    return searchParams;
  }
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setSearchParams(GoogleCloudRetailV2betaConversationalSearchRequestSearchParams searchParams) {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setUserInfo(GoogleCloudRetailV2betaUserInfo userInfo) {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setUserLabels(java.util.Map<String, java.lang.String> userLabels) {
   ...
   */
  public GoogleCloudRetailV2betaConversationalSearchRequest setVisitorId(java.lang.String visitorId) {
    this.visitorId = visitorId;
    return this;
  }

  @Override
  public GoogleCloudRetailV2betaConversationalSearchRequest set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaConversationalSearchRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaConversationalSearchRequest clone() {
    return (GoogleCloudRetailV2betaConversationalSearchRequest) super.clone();
  }
