  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Endpoints {
         ...
         *        Endpoint.name field.
         * @param content the {@link com.google.api.services.alloydb.v1alpha.model.Endpoint}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.alloydb.v1alpha.model.Endpoint content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
         ...
         *        Endpoint.name field.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.alloydb.v1alpha.model.Endpoint content) {
            super(CloudAlloyDBAdmin.this, "POST", REST_PATH, content, com.google.api.services.alloydb.v1alpha.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends CloudAlloyDBAdminRequest<com.google.api.services.alloydb.v1alpha.model.Endpoint> {
         ...
         *        field.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudAlloyDBAdmin.this, "GET", REST_PATH, null, com.google.api.services.alloydb.v1alpha.model.Endpoint.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudAlloyDBAdminRequest<com.google.api.services.alloydb.v1alpha.model.ListEndpointsResponse> {
         ...
         *        specifying a value with the following format: * projects/{project}/locations/-
           ...
           */
          protected List(java.lang.String parent) {
            super(CloudAlloyDBAdmin.this, "GET", REST_PATH, null, com.google.api.services.alloydb.v1alpha.model.ListEndpointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.alloydb.v1alpha.model.Endpoint content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }
         ...
         *        parent resource: * projects/{project}/locations/{region}
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.alloydb.v1alpha.model.Endpoint content) {
            super(CloudAlloyDBAdmin.this, "PATCH", REST_PATH, content, com.google.api.services.alloydb.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
