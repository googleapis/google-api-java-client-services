...
public final class CloudAiLargeModelsVisionGenerateVideoExperiments extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private CloudAiLargeModelsVisionGenerateVideoExperimentsOmniRewriterConfig omniRewriter;
   ...
   * @return value or {@code null} for none
   */
  public CloudAiLargeModelsVisionGenerateVideoExperimentsOmniRewriterConfig getOmniRewriter() {
    return omniRewriter;
  }

  /**
   * Optional. Omni Rewriter configuration.
   * @param omniRewriter omniRewriter or {@code null} for none
   */
  public CloudAiLargeModelsVisionGenerateVideoExperiments setOmniRewriter(CloudAiLargeModelsVisionGenerateVideoExperimentsOmniRewriterConfig omniRewriter) {
