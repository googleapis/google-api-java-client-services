...
public final class ReservationsScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public ReservationsScopedList setReservations(java.util.List<Reservation> reservations) {
   ...
   */
  public ReservationsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationsScopedList set(String fieldName, Object value) {
    return (ReservationsScopedList) super.set(fieldName, value);
  }

  @Override
  public ReservationsScopedList clone() {
    return (ReservationsScopedList) super.clone();
  }
