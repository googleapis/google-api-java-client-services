...
public final class DiskTypeAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public DiskTypeAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, DiskTypesScopedList> getItems() {
    return items;
  }
   ...
   */
  public DiskTypeAggregatedList setItems(java.util.Map<String, DiskTypesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public DiskTypeAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public DiskTypeAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public DiskTypeAggregatedList set(String fieldName, Object value) {
    return (DiskTypeAggregatedList) super.set(fieldName, value);
  }

  @Override
  public DiskTypeAggregatedList clone() {
    return (DiskTypeAggregatedList) super.clone();
  }
