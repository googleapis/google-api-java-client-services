 ...
 * that was running on the user's device. * `versionCode` (int64): version of the app that was
 * running on the user's device. * `deviceModel` (string): unique identifier of the user's device
 * model. * `deviceBrand` (string): unique identifier of the user's device brand. * `deviceType`
...
public final class GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet extends com.google.api.client.json.GenericJson {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet setFreshnessInfo(GooglePlayDeveloperReportingV1alpha1FreshnessInfo freshnessInfo) {
  ...
  @Override
  public GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet clone() {
    return (GooglePlayDeveloperReportingV1alpha1ExcessiveWakeupRateMetricSet) super.clone();
  }
