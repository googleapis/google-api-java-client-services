# Stackdriver Logging API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v2-rev20190803-1.30.1</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-logging:v2-rev20190803-1.30.1'
}
```
