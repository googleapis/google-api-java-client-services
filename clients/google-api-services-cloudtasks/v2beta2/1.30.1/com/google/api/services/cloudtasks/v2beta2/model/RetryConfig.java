...
public final class RetryConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The maximum number of attempts for a task. Cloud Tasks will attempt the task `max_attempts`
   * times (that is, if the first attempt fails, then there will be `max_attempts - 1` retries).
   * Must be > 0.
   ...
   * queue is created, Cloud Tasks will pick the default. This field is output only for pull queues.
   * `max_backoff` will be truncated to the nearest second. This field has the same meaning as
   ...
   * unspecified when the queue is created, Cloud Tasks will pick the default. This field is output
   * only for pull queues. This field has the same meaning as [max_doublings in queue.yaml/xml](http
   ...
   * Cloud Tasks will pick the default. This field is output only for pull queues.
   ...
   * if the queue's RetryConfig specifies that the task should be retried. If unspecified when the
   * queue is created, Cloud Tasks will pick the default. This field is output only for pull queues.
   * `min_backoff` will be truncated to the nearest second. This field has the same meaning as
