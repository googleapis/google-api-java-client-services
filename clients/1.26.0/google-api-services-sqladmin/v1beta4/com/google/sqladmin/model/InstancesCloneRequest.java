...
public final class InstancesCloneRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public InstancesCloneRequest set(String fieldName, Object value) {
    return (InstancesCloneRequest) super.set(fieldName, value);
  }

  @Override
  public InstancesCloneRequest clone() {
    return (InstancesCloneRequest) super.clone();
  }
