...
/**
 * Singleton resource representing the set of Bitmap Memory Usage metrics. This metric set contains
 * bitmap memory usage data combined with usage data. **Supported aggregation periods:** * DAILY:
 * metrics are aggregated in calendar date intervals. Due to historical constraints, the only
 * supported timezone is `America/Los_Angeles`. **Supported metrics:** * `bitmapMemoryUsageP50`
 ...
 * the aggregation period. Care must be taken not to aggregate this count further, as it may result
 * in users being counted multiple times. The value is rounded to the nearest multiple of 10, 100,
...
public final class GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet extends com.google.api.client.json.GenericJson {
   ...
   */
  public GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet setFreshnessInfo(GooglePlayDeveloperReportingV1beta1FreshnessInfo freshnessInfo) {
   ...
   */
  public GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet setName(java.lang.String name) {
    this.name = name;
    return this;
  }

  @Override
  public GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet clone() {
    return (GooglePlayDeveloperReportingV1beta1BitmapMemoryUsageMetricSet) super.clone();
  }
