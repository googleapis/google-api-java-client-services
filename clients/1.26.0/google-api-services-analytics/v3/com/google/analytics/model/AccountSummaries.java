...
/**
 * An AccountSummary collection lists a summary of accounts, properties and views (profiles) to
 * which the user has access. Each resource in the collection corresponds to a single
 * AccountSummary.
 *
...
public final class AccountSummaries extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<AccountSummary> items;
   ...
   */
  public java.util.List<AccountSummary> getItems() {
    return items;
  }
   ...
   */
  public AccountSummaries setItems(java.util.List<AccountSummary> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AccountSummaries setItemsPerPage(java.lang.Integer itemsPerPage) {
   ...
   */
  public AccountSummaries setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public AccountSummaries setNextLink(java.lang.String nextLink) {
   ...
   */
  public AccountSummaries setPreviousLink(java.lang.String previousLink) {
   ...
   */
  public AccountSummaries setStartIndex(java.lang.Integer startIndex) {
   ...
   */
  public AccountSummaries setTotalResults(java.lang.Integer totalResults) {
   ...
   */
  public AccountSummaries setUsername(java.lang.String username) {
    this.username = username;
    return this;
  }

  @Override
  public AccountSummaries set(String fieldName, Object value) {
    return (AccountSummaries) super.set(fieldName, value);
  }
