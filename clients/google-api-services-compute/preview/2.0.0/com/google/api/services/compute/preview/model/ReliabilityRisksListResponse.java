...
public final class ReliabilityRisksListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ReliabilityRisk> items;

  static {
    // hack to force ProGuard to consider ReliabilityRisk used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ReliabilityRisk.class);
  }
   ...
   */
  public ReliabilityRisksListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ReliabilityRisk> getItems() {
    return items;
  }
   ...
   */
  public ReliabilityRisksListResponse setItems(java.util.List<ReliabilityRisk> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReliabilityRisksListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReliabilityRisksListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReliabilityRisksListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public ReliabilityRisksListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReliabilityRisksListResponse set(String fieldName, Object value) {
    return (ReliabilityRisksListResponse) super.set(fieldName, value);
  }

  @Override
  public ReliabilityRisksListResponse clone() {
    return (ReliabilityRisksListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ReliabilityRisksListResponseWarningData.
     */
