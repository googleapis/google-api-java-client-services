...
public final class Policy extends com.google.api.client.json.GenericJson {
   ...
   * denied.   Logging will be applied if one or more matching rule requires logging. - Otherwise,
   * if any ALLOW/ALLOW_WITH_LOG rule matches, permission is   granted.   Logging will be applied if
   * one or more matching rule requires logging. - Otherwise, if no rule applies, permission is
   * denied.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
