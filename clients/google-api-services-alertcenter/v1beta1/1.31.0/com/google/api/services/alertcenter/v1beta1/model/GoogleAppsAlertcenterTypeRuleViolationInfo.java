...
public final class GoogleAppsAlertcenterTypeRuleViolationInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfo> matchInfo;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoActionInfo> triggeredActionInfo;
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setDataSource(java.lang.String dataSource) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfo> getMatchInfo() {
    return matchInfo;
  }
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setMatchInfo(java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoMatchInfo> matchInfo) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setRecipients(java.util.List<java.lang.String> recipients) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setResourceInfo(GoogleAppsAlertcenterTypeRuleViolationInfoResourceInfo resourceInfo) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setRuleInfo(GoogleAppsAlertcenterTypeRuleViolationInfoRuleInfo ruleInfo) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setSuppressedActionTypes(java.util.List<java.lang.String> suppressedActionTypes) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setTrigger(java.lang.String trigger) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoActionInfo> getTriggeredActionInfo() {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setTriggeredActionInfo(java.util.List<GoogleAppsAlertcenterTypeRuleViolationInfoActionInfo> triggeredActionInfo) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setTriggeredActionTypes(java.util.List<java.lang.String> triggeredActionTypes) {
   ...
   */
  public GoogleAppsAlertcenterTypeRuleViolationInfo setTriggeringUserEmail(java.lang.String triggeringUserEmail) {
    this.triggeringUserEmail = triggeringUserEmail;
    return this;
  }

  @Override
  public GoogleAppsAlertcenterTypeRuleViolationInfo set(String fieldName, Object value) {
    return (GoogleAppsAlertcenterTypeRuleViolationInfo) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsAlertcenterTypeRuleViolationInfo clone() {
