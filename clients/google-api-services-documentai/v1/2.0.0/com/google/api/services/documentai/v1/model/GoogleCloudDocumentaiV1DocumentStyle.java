...
public final class GoogleCloudDocumentaiV1DocumentStyle extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDocumentaiV1DocumentStyle setBackgroundColor(GoogleTypeColor backgroundColor) {
   ...
   */
  public GoogleCloudDocumentaiV1DocumentStyle setColor(GoogleTypeColor color) {
    this.color = color;
    return this;
  }
   ...
   */
  public GoogleCloudDocumentaiV1DocumentStyle setFontFamily(java.lang.String fontFamily) {
   ...
   */
  public GoogleCloudDocumentaiV1DocumentStyle setFontSize(GoogleCloudDocumentaiV1DocumentStyleFontSize fontSize) {
   ...
   */
  public GoogleCloudDocumentaiV1DocumentStyle setTextAnchor(GoogleCloudDocumentaiV1DocumentTextAnchor textAnchor) {
  ...
  @Override
  public GoogleCloudDocumentaiV1DocumentStyle set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1DocumentStyle) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1DocumentStyle clone() {
