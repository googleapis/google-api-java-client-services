...
/**
 * Details of the derived image portion of the DockerImage relationship. This image would be
...
public final class ImageOccurrence extends com.google.api.client.json.GenericJson {
   ...
   */
  public ImageOccurrence setBaseResourceUrl(java.lang.String baseResourceUrl) {
   ...
   */
  public ImageOccurrence setDistance(java.lang.Integer distance) {
   ...
   */
  public ImageOccurrence setFingerprint(Fingerprint fingerprint) {
   ...
   */
  public ImageOccurrence setLayerInfo(java.util.List<Layer> layerInfo) {
    this.layerInfo = layerInfo;
    return this;
  }

  @Override
  public ImageOccurrence set(String fieldName, Object value) {
    return (ImageOccurrence) super.set(fieldName, value);
  }

  @Override
  public ImageOccurrence clone() {
    return (ImageOccurrence) super.clone();
  }
