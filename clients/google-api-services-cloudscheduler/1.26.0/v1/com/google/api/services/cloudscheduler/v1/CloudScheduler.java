...
public class CloudScheduler extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Cloud Scheduler API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.Location.class);
      ...
      public class List extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Jobs {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.cloudscheduler.v1.model.Job content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.cloudscheduler.v1.model.Job content) {
            super(CloudScheduler.this, "POST", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Job.class);
        ...
        public class Delete extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Empty> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
          ...
          protected Delete(java.lang.String name) {
            super(CloudScheduler.this, "DELETE", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.Job.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.ListJobsResponse> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID`.
          ...
          protected List(java.lang.String parent) {
            super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.ListJobsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        * `JOB_ID` can contain only letters ([A-Za-z]),
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.Job content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        * `JOB_ID` can contain only letters ([A-Za-z]),
         *        numbers ([0-9]),
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.Job content) {
            super(CloudScheduler.this, "PATCH", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Job.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @return the request
         */
        public Pause pause(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.PauseJobRequest content) throws java.io.IOException {
          Pause result = new Pause(name, content);
          initialize(result);
          return result;
        }

        public class Pause extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
           ...
           * @since 1.13
           */
          protected Pause(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.PauseJobRequest content) {
            super(CloudScheduler.this, "POST", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Job.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         * @return the request
         */
        public Resume resume(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.ResumeJobRequest content) throws java.io.IOException {
          Resume result = new Resume(name, content);
          initialize(result);
          return result;
        }

        public class Resume extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
           ...
           * @since 1.13
           */
          protected Resume(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.ResumeJobRequest content) {
            super(CloudScheduler.this, "POST", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Job.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         * @return the request
         */
        public Run run(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.RunJobRequest content) throws java.io.IOException {
          Run result = new Run(name, content);
          initialize(result);
          return result;
        }

        public class Run extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Job> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/jobs/JOB_ID`.
           ...
           * @since 1.13
           */
          protected Run(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.RunJobRequest content) {
            super(CloudScheduler.this, "POST", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Job.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
