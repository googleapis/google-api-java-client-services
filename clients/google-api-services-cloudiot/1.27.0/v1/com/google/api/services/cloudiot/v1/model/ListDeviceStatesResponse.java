...
public final class ListDeviceStatesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<DeviceState> getDeviceStates() {
    return deviceStates;
  }
   ...
   * The last few device states. States are listed in descending order of server update time,
   * starting from the most recent one.
   * @param deviceStates deviceStates or {@code null} for none
   */
  public ListDeviceStatesResponse setDeviceStates(java.util.List<DeviceState> deviceStates) {
    this.deviceStates = deviceStates;
    return this;
  }

  @Override
  public ListDeviceStatesResponse set(String fieldName, Object value) {
    return (ListDeviceStatesResponse) super.set(fieldName, value);
  }
