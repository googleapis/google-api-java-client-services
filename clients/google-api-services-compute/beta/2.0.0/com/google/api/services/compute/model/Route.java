...
public final class Route extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] The full resource name of the Network Connectivity Center hub that
   * will handle matching packets.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output only] Internal fixed region-to-region cost that Google Cloud calculates
   * based on factors such as network performance, distance, and available bandwidth between
   * regions.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The URL to an InterconnectAttachment which is the next hop for the
   * route. This field will only be populated for dynamic routes generated by Cloud Router with a
   * linked interconnectAttachment or the static route generated by each L2 Interconnect Attachment.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] Multi-Exit Discriminator, a BGP route metric that indicates the
  ...
  /**
   * Output only. [Output Only] Indicates the origin of the route. Can be IGP (Interior Gateway
  ...
  /**
   * Output only. [Output Only] The network peering name that should handle matching packets, which
   ...
   * 'TRANSIT' for a transit route that this router learned from another Cloud Router and will
   * readvertise to one of its BGP peers  - 'SUBNET' for a route from a subnet of the VPC  - 'BGP'
   * for a route learned from a BGP peer of this router  - 'STATIC' for a static route
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] If potential misconfigurations are detected for this route, this
