...
public final class GoogleCloudRetailV2CatalogAttributeFacetConfig extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudRetailV2Interval> facetIntervals;
   ...
   */
  public java.util.List<GoogleCloudRetailV2Interval> getFacetIntervals() {
   ...
   */
  public GoogleCloudRetailV2CatalogAttributeFacetConfig setFacetIntervals(java.util.List<GoogleCloudRetailV2Interval> facetIntervals) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues> getIgnoredFacetValues() {
   ...
   */
  public GoogleCloudRetailV2CatalogAttributeFacetConfig setIgnoredFacetValues(java.util.List<GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues> ignoredFacetValues) {
   ...
   */
  public GoogleCloudRetailV2CatalogAttributeFacetConfig setRerankConfig(GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig rerankConfig) {
    this.rerankConfig = rerankConfig;
    return this;
  }

  @Override
  public GoogleCloudRetailV2CatalogAttributeFacetConfig set(String fieldName, Object value) {
    return (GoogleCloudRetailV2CatalogAttributeFacetConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2CatalogAttributeFacetConfig clone() {
    return (GoogleCloudRetailV2CatalogAttributeFacetConfig) super.clone();
  }
