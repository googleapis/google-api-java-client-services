...
public class Calendar extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Calendar API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Acl {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.AclRule> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
      ...
      protected Get(java.lang.String calendarId, java.lang.String ruleId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.AclRule.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.ruleId = com.google.api.client.util.Preconditions.checkNotNull(ruleId, "Required parameter ruleId must be specified.");
      }
     ...
     * @param calendarId Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
     * @param content the {@link com.google.calendar.model.AclRule}
     * @return the request
     */
    public Insert insert(java.lang.String calendarId, com.google.calendar.model.AclRule content) throws java.io.IOException {
      Insert result = new Insert(calendarId, content);
      initialize(result);
      return result;
    }

    public class Insert extends CalendarRequest<com.google.calendar.model.AclRule> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String calendarId, com.google.calendar.model.AclRule content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.AclRule.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
    ...
    public class List extends CalendarRequest<com.google.calendar.model.Acl> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
      ...
      protected List(java.lang.String calendarId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Acl.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String calendarId, java.lang.String ruleId, com.google.calendar.model.AclRule content) throws java.io.IOException {
      Patch result = new Patch(calendarId, ruleId, content);
      initialize(result);
      return result;
    }

    public class Patch extends CalendarRequest<com.google.calendar.model.AclRule> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String calendarId, java.lang.String ruleId, com.google.calendar.model.AclRule content) {
        super(Calendar.this, "PATCH", REST_PATH, content, com.google.calendar.model.AclRule.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.ruleId = com.google.api.client.util.Preconditions.checkNotNull(ruleId, "Required parameter ruleId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String calendarId, java.lang.String ruleId, com.google.calendar.model.AclRule content) throws java.io.IOException {
      Update result = new Update(calendarId, ruleId, content);
      initialize(result);
      return result;
    }

    public class Update extends CalendarRequest<com.google.calendar.model.AclRule> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String calendarId, java.lang.String ruleId, com.google.calendar.model.AclRule content) {
        super(Calendar.this, "PUT", REST_PATH, content, com.google.calendar.model.AclRule.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.ruleId = com.google.api.client.util.Preconditions.checkNotNull(ruleId, "Required parameter ruleId must be specified.");
      }
     ...
     * @param calendarId Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
     * @param content the {@link com.google.calendar.model.Channel}
     * @return the request
     */
    public Watch watch(java.lang.String calendarId, com.google.calendar.model.Channel content) throws java.io.IOException {
      Watch result = new Watch(calendarId, content);
      initialize(result);
      return result;
    }

    public class Watch extends CalendarRequest<com.google.calendar.model.Channel> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Watch(java.lang.String calendarId, com.google.calendar.model.Channel content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.Channel.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
  ...
  public class CalendarList {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.CalendarListEntry> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
      ...
      protected Get(java.lang.String calendarId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.CalendarListEntry.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.calendar.model.CalendarListEntry}
     * @return the request
     */
    public Insert insert(com.google.calendar.model.CalendarListEntry content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends CalendarRequest<com.google.calendar.model.CalendarListEntry> {
       ...
       * @since 1.13
       */
      protected Insert(com.google.calendar.model.CalendarListEntry content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.CalendarListEntry.class);
        checkRequiredParameter(content, "content");
    ...
    public class List extends CalendarRequest<com.google.calendar.model.CalendarList> {
       ...
       */
      protected List() {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.CalendarList.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String calendarId, com.google.calendar.model.CalendarListEntry content) throws java.io.IOException {
      Patch result = new Patch(calendarId, content);
      initialize(result);
      return result;
    }

    public class Patch extends CalendarRequest<com.google.calendar.model.CalendarListEntry> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String calendarId, com.google.calendar.model.CalendarListEntry content) {
        super(Calendar.this, "PATCH", REST_PATH, content, com.google.calendar.model.CalendarListEntry.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String calendarId, com.google.calendar.model.CalendarListEntry content) throws java.io.IOException {
      Update result = new Update(calendarId, content);
      initialize(result);
      return result;
    }

    public class Update extends CalendarRequest<com.google.calendar.model.CalendarListEntry> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String calendarId, com.google.calendar.model.CalendarListEntry content) {
        super(Calendar.this, "PUT", REST_PATH, content, com.google.calendar.model.CalendarListEntry.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * @return the request
     */
    public Watch watch(com.google.calendar.model.Channel content) throws java.io.IOException {
    ...
    public class Watch extends CalendarRequest<com.google.calendar.model.Channel> {
       ...
       * @since 1.13
       */
      protected Watch(com.google.calendar.model.Channel content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.Channel.class);
      }
  ...
  public class Calendars {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.Calendar> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       */
      protected Get(java.lang.String calendarId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Calendar.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.calendar.model.Calendar}
     * @return the request
     */
    public Insert insert(com.google.calendar.model.Calendar content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends CalendarRequest<com.google.calendar.model.Calendar> {
       ...
       * @since 1.13
       */
      protected Insert(com.google.calendar.model.Calendar content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.Calendar.class);
        checkRequiredParameter(content, "content");
     ...
     * @return the request
     */
    public Patch patch(java.lang.String calendarId, com.google.calendar.model.Calendar content) throws java.io.IOException {
      Patch result = new Patch(calendarId, content);
      initialize(result);
      return result;
    }

    public class Patch extends CalendarRequest<com.google.calendar.model.Calendar> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String calendarId, com.google.calendar.model.Calendar content) {
        super(Calendar.this, "PATCH", REST_PATH, content, com.google.calendar.model.Calendar.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String calendarId, com.google.calendar.model.Calendar content) throws java.io.IOException {
      Update result = new Update(calendarId, content);
      initialize(result);
      return result;
    }

    public class Update extends CalendarRequest<com.google.calendar.model.Calendar> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String calendarId, com.google.calendar.model.Calendar content) {
        super(Calendar.this, "PUT", REST_PATH, content, com.google.calendar.model.Calendar.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
  ...
  public class Channels {
     ...
     * @return the request
     */
    public Stop stop(com.google.calendar.model.Channel content) throws java.io.IOException {
    ...
    public class Stop extends CalendarRequest<Void> {
       ...
       * @since 1.13
       */
      protected Stop(com.google.calendar.model.Channel content) {
  ...
  public class Colors {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.Colors> {
       ...
       */
      protected Get() {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Colors.class);
      }
  ...
  public class Events {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
      ...
      protected Get(java.lang.String calendarId, java.lang.String eventId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.eventId = com.google.api.client.util.Preconditions.checkNotNull(eventId, "Required parameter eventId must be specified.");
      }
     ...
     * @param calendarId Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
     * @param content the {@link com.google.calendar.model.Event}
     * @return the request
     */
    public CalendarImport calendarImport(java.lang.String calendarId, com.google.calendar.model.Event content) throws java.io.IOException {
      CalendarImport result = new CalendarImport(calendarId, content);
      initialize(result);
      return result;
    }

    public class CalendarImport extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected CalendarImport(java.lang.String calendarId, com.google.calendar.model.Event content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        checkRequiredParameter(content, "content");
     ...
     * @return the request
     */
    public Insert insert(java.lang.String calendarId, com.google.calendar.model.Event content) throws java.io.IOException {
      Insert result = new Insert(calendarId, content);
      initialize(result);
      return result;
    }

    public class Insert extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String calendarId, com.google.calendar.model.Event content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
      }
    ...
    public class Instances extends CalendarRequest<com.google.calendar.model.Events> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
      ...
      protected Instances(java.lang.String calendarId, java.lang.String eventId) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Events.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.eventId = com.google.api.client.util.Preconditions.checkNotNull(eventId, "Required parameter eventId must be specified.");
      }
    ...
    public class List extends CalendarRequest<com.google.calendar.model.Events> {
    ...
    public class Move extends CalendarRequest<com.google.calendar.model.Event> {
      ...
      protected Move(java.lang.String calendarId, java.lang.String eventId, java.lang.String destination) {
        super(Calendar.this, "POST", REST_PATH, null, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.eventId = com.google.api.client.util.Preconditions.checkNotNull(eventId, "Required parameter eventId must be specified.");
     ...
     * @return the request
     */
    public Patch patch(java.lang.String calendarId, java.lang.String eventId, com.google.calendar.model.Event content) throws java.io.IOException {
      Patch result = new Patch(calendarId, eventId, content);
      initialize(result);
      return result;
    }

    public class Patch extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String calendarId, java.lang.String eventId, com.google.calendar.model.Event content) {
        super(Calendar.this, "PATCH", REST_PATH, content, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.eventId = com.google.api.client.util.Preconditions.checkNotNull(eventId, "Required parameter eventId must be specified.");
      }
    ...
    public class QuickAdd extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     * @return the request
     */
    public Update update(java.lang.String calendarId, java.lang.String eventId, com.google.calendar.model.Event content) throws java.io.IOException {
      Update result = new Update(calendarId, eventId, content);
      initialize(result);
      return result;
    }

    public class Update extends CalendarRequest<com.google.calendar.model.Event> {
     ...
     *        access the primary calendar of the currently logged in user, use the "primary" keyword.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String calendarId, java.lang.String eventId, com.google.calendar.model.Event content) {
        super(Calendar.this, "PUT", REST_PATH, content, com.google.calendar.model.Event.class);
        this.calendarId = com.google.api.client.util.Preconditions.checkNotNull(calendarId, "Required parameter calendarId must be specified.");
        this.eventId = com.google.api.client.util.Preconditions.checkNotNull(eventId, "Required parameter eventId must be specified.");
      }
  ...
  public class Freebusy {
     ...
     *
     * @param content the {@link com.google.calendar.model.FreeBusyRequest}
     * @return the request
     */
    public Query query(com.google.calendar.model.FreeBusyRequest content) throws java.io.IOException {
      Query result = new Query(content);
      initialize(result);
      return result;
    }

    public class Query extends CalendarRequest<com.google.calendar.model.FreeBusyResponse> {
       ...
       * @since 1.13
       */
      protected Query(com.google.calendar.model.FreeBusyRequest content) {
        super(Calendar.this, "POST", REST_PATH, content, com.google.calendar.model.FreeBusyResponse.class);
      }
  ...
  public class Settings {
    ...
    public class Get extends CalendarRequest<com.google.calendar.model.Setting> {
      ...
      protected Get(java.lang.String setting) {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Setting.class);
    ...
    public class List extends CalendarRequest<com.google.calendar.model.Settings> {
       ...
       */
      protected List() {
        super(Calendar.this, "GET", REST_PATH, null, com.google.calendar.model.Settings.class);
      }
