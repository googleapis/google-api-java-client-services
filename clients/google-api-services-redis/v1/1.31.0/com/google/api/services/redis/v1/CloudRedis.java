...
public class CloudRedis extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Google Cloud Memorystore for Redis API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Instances {
         ...
         *        `projects/{project_id}/locations/{location_id}/instances/{instance_id}` where
         *        `location_id` refers to a GCP region.
         * @param content the {@link com.google.api.services.redis.v1.model.UpgradeInstanceRequest}
         * @return the request
         */
        public Upgrade upgrade(java.lang.String name, com.google.api.services.redis.v1.model.UpgradeInstanceRequest content) throws java.io.IOException {
          Upgrade result = new Upgrade(name, content);
          initialize(result);
          return result;
        }

        public class Upgrade extends CloudRedisRequest<com.google.api.services.redis.v1.model.Operation> {
         ...
         *        `location_id` refers to a GCP region.
           ...
           * @since 1.13
           */
          protected Upgrade(java.lang.String name, com.google.api.services.redis.v1.model.UpgradeInstanceRequest content) {
            super(CloudRedis.this, "POST", REST_PATH, content, com.google.api.services.redis.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
