...
public final class TargetInstanceList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetInstance> items;
   ...
   */
  public TargetInstanceList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetInstance> getItems() {
    return items;
  }
   ...
   */
  public TargetInstanceList setItems(java.util.List<TargetInstance> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetInstanceList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetInstanceList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetInstanceList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetInstanceList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetInstanceList set(String fieldName, Object value) {
    return (TargetInstanceList) super.set(fieldName, value);
  }

  @Override
  public TargetInstanceList clone() {
    return (TargetInstanceList) super.clone();
  }
