...
public class CloudIdentity extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class AllowlistedDomains {
     ...
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.AllowlistedDomain}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1beta1.model.AllowlistedDomain content) throws java.io.IOException {
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
      ...
      private static final String REST_PATH = "v1beta1/allowlistedDomains";
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1beta1.model.AllowlistedDomain content) {
    ...
    public class Get extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.AllowlistedDomain> {
      ...
      protected Get(java.lang.String name) {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.AllowlistedDomain.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.ListAllowlistedDomainsResponse> {
       ...
       */
      protected List() {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.ListAllowlistedDomainsResponse.class);
      }
  ...
  public class Devices {
    ...
    public class DeviceUsers {
       ...
       * the caller to ensure that the DeviceUser is uniquely identified. - iOS: If either the `partner`
       * or `ios_device_id` field is provided, then both fields are required. - Android: Specifying the
      ...
      public class Lookup extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.LookupSelfDeviceUsersResponse> {
         ...
         * information from the caller to ensure that the DeviceUser is uniquely identified. - iOS: If
         * either the `partner` or `ios_device_id` field is provided, then both fields are required. -
  ...
  public class Groups {
    ...
    public class GetSecuritySettings extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.SecuritySettings> {
      ...
      protected GetSecuritySettings(java.lang.String name) {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.SecuritySettings.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.SecuritySettings}
     * @return the request
     */
    public UpdateSecuritySettings updateSecuritySettings(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.SecuritySettings content) throws java.io.IOException {
      UpdateSecuritySettings result = new UpdateSecuritySettings(name, content);
      initialize(result);
      return result;
    }

    public class UpdateSecuritySettings extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
     ...
     *        `groups/{group_id}/securitySettings`.
       ...
       * @since 1.13
       */
      protected UpdateSecuritySettings(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.SecuritySettings content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public class InboundOidcSsoProfiles {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
      ...
      private static final String REST_PATH = "v1beta1/inboundOidcSsoProfiles";
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile content) {
        super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
      }
    ...
    public class Get extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile> {
     ...
     *        InboundOidcSsoProfile to get. Format: `inboundOidcSsoProfiles/{sso_profile_id}`
       ...
       */
      protected Get(java.lang.String name) {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.ListInboundOidcSsoProfilesResponse> {
       ...
       */
      protected List() {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.ListInboundOidcSsoProfilesResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }
     ...
     *        profile.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundOidcSsoProfile content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public class InboundSamlSsoProfiles {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile content) {
        super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
      }
    ...
    public class Get extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile> {
     ...
     *        InboundSamlSsoProfile to get. Format: `inboundSamlSsoProfiles/{sso_profile_id}`
       ...
       */
      protected Get(java.lang.String name) {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.ListInboundSamlSsoProfilesResponse> {
       ...
       */
      protected List() {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.ListInboundSamlSsoProfilesResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }
     ...
     *        profile.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundSamlSsoProfile content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
    ...
    public class IdpCredentials {
       ...
       * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.AddIdpCredentialRequest}
       * @return the request
       */
      public Add add(java.lang.String parent, com.google.api.services.cloudidentity.v1beta1.model.AddIdpCredentialRequest content) throws java.io.IOException {
        Add result = new Add(parent, content);
        initialize(result);
        return result;
      }

      public class Add extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {

        private static final String REST_PATH = "v1beta1/{+parent}/idpCredentials:add";
       ...
       *        `inboundSamlSsoProfiles/{sso_profile_id}`
         ...
         * @since 1.13
         */
        protected Add(java.lang.String parent, com.google.api.services.cloudidentity.v1beta1.model.AddIdpCredentialRequest content) {
          super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
      ...
      public class Get extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.IdpCredential> {
       ...
       *        `inboundSamlSsoProfiles/{sso_profile_id}/idpCredentials/{idp_credential_id}`
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.IdpCredential.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.ListIdpCredentialsResponse> {

        private static final String REST_PATH = "v1beta1/{+parent}/idpCredentials";
       ...
       *        `inboundSamlSsoProfiles/{sso_profile_id}`
         ...
         */
        protected List(java.lang.String parent) {
          super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.ListIdpCredentialsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
  ...
  public class InboundSsoAssignments {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
      ...
      private static final String REST_PATH = "v1beta1/inboundSsoAssignments";
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment content) {
        super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
      }
    ...
    public class Get extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment> {
     ...
     *        InboundSsoAssignment to fetch. Format: `inboundSsoAssignments/{assignment}`
       ...
       */
      protected Get(java.lang.String name) {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.ListInboundSsoAssignmentsResponse> {
       ...
       */
      protected List() {
        super(CloudIdentity.this, "GET", REST_PATH, null, com.google.api.services.cloudidentity.v1beta1.model.ListInboundSsoAssignmentsResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }
     ...
     *        Assignment.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.InboundSsoAssignment content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public class Policies {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.Policy}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1beta1.model.Policy content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1beta1.model.Operation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1beta1.model.Policy content) {
        super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
      }
     ...
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
     * @param name Output only. Identifier. The [resource name](https://cloud.google.com/apis/design/resource_names) of
     *        the Policy. Format: policies/{policy}.
     * @param content the {@link com.google.api.services.cloudidentity.v1beta1.model.Policy}
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.Policy content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }
     ...
     *        the Policy. Format: policies/{policy}.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.api.services.cloudidentity.v1beta1.model.Policy content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1beta1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      /** Output only. Identifier. The [resource name](https://cloud.google.com/apis/design/resource_names)
