...
public final class GoogleCloudDiscoveryengineV1alphaImportErrorConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportErrorConfig setGcsPrefix(java.lang.String gcsPrefix) {
    this.gcsPrefix = gcsPrefix;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaImportErrorConfig set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaImportErrorConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaImportErrorConfig clone() {
    return (GoogleCloudDiscoveryengineV1alphaImportErrorConfig) super.clone();
  }
