...
public final class GoogleFirestoreAdminV1beta1ExportDocumentsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirestoreAdminV1beta1ExportDocumentsRequest setCollectionIds(java.util.List<java.lang.String> collectionIds) {
   ...
   */
  public GoogleFirestoreAdminV1beta1ExportDocumentsRequest setOutputUriPrefix(java.lang.String outputUriPrefix) {
    this.outputUriPrefix = outputUriPrefix;
    return this;
  }

  @Override
  public GoogleFirestoreAdminV1beta1ExportDocumentsRequest set(String fieldName, Object value) {
    return (GoogleFirestoreAdminV1beta1ExportDocumentsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirestoreAdminV1beta1ExportDocumentsRequest clone() {
