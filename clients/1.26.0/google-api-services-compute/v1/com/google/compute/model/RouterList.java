...
public final class RouterList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Router> items;

  static {
    // hack to force ProGuard to consider Router used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Router.class);
  }
   ...
   */
  public RouterList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Router> getItems() {
    return items;
  }
   ...
   */
  public RouterList setItems(java.util.List<Router> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RouterList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RouterList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RouterList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RouterList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RouterList set(String fieldName, Object value) {
    return (RouterList) super.set(fieldName, value);
  }

  @Override
  public RouterList clone() {
    return (RouterList) super.clone();
  }
