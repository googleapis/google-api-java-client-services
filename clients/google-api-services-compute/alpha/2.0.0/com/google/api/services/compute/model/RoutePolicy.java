...
public final class RoutePolicy extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<RoutePolicyPolicyTerm> terms;
   ...
   */
  public RoutePolicy setFingerprint(java.lang.String fingerprint) {
   ...
   */
  public RoutePolicy setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RoutePolicyPolicyTerm> getTerms() {
    return terms;
  }
   ...
   */
  public RoutePolicy setTerms(java.util.List<RoutePolicyPolicyTerm> terms) {
    this.terms = terms;
    return this;
  }
   ...
   */
  public RoutePolicy setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public RoutePolicy set(String fieldName, Object value) {
    return (RoutePolicy) super.set(fieldName, value);
  }

  @Override
  public RoutePolicy clone() {
    return (RoutePolicy) super.clone();
  }
