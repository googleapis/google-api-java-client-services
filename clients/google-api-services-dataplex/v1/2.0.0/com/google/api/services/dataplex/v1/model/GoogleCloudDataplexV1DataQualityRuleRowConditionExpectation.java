...
public final class GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation set(String fieldName, Object value) {
    return (GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation clone() {
    return (GoogleCloudDataplexV1DataQualityRuleRowConditionExpectation) super.clone();
  }
