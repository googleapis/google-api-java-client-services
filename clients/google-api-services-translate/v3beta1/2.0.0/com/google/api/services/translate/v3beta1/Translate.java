...
/**
 * Service definition for Translate (v3beta1).
 *
 * <p>
...
public class Translate extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
     ...
     * @param content the {@link com.google.api.services.translate.v3beta1.model.DetectLanguageRequest}
     * @return the request
     */
    public DetectLanguage detectLanguage(java.lang.String parent, com.google.api.services.translate.v3beta1.model.DetectLanguageRequest content) throws java.io.IOException {
      DetectLanguage result = new DetectLanguage(parent, content);
      initialize(result);
      return result;
    }

    public class DetectLanguage extends TranslateRequest<com.google.api.services.translate.v3beta1.model.DetectLanguageResponse> {
     ...
     *        id) can be used. Otherwise an INVALID_ARGUMENT (400) error is returned.
       ...
       * @since 1.13
       */
      protected DetectLanguage(java.lang.String parent, com.google.api.services.translate.v3beta1.model.DetectLanguageRequest content) {
        super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.DetectLanguageResponse.class);
    ...
    public class GetSupportedLanguages extends TranslateRequest<com.google.api.services.translate.v3beta1.model.SupportedLanguages> {
     ...
     *        INVALID_ARGUMENT (400) error is returned.
      ...
      protected GetSupportedLanguages(java.lang.String parent) {
        super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.SupportedLanguages.class);
        this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
              "Parameter parent must conform to the pattern " +
     ...
     * @param content the {@link com.google.api.services.translate.v3beta1.model.TranslateTextRequest}
     * @return the request
     */
    public TranslateText translateText(java.lang.String parent, com.google.api.services.translate.v3beta1.model.TranslateTextRequest content) throws java.io.IOException {
      TranslateText result = new TranslateText(parent, content);
      initialize(result);
      return result;
    }

    public class TranslateText extends TranslateRequest<com.google.api.services.translate.v3beta1.model.TranslateTextResponse> {
     ...
     *        (have same location-id), otherwise an INVALID_ARGUMENT (400) error is returned.
       ...
       * @since 1.13
       */
      protected TranslateText(java.lang.String parent, com.google.api.services.translate.v3beta1.model.TranslateTextRequest content) {
        super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.TranslateTextResponse.class);
        this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
              "Parameter parent must conform to the pattern " +
    ...
    public class Locations {
       ...
       * @param content the {@link com.google.api.services.translate.v3beta1.model.BatchTranslateDocumentRequest}
       * @return the request
       */
      public BatchTranslateDocument batchTranslateDocument(java.lang.String parent, com.google.api.services.translate.v3beta1.model.BatchTranslateDocumentRequest content) throws java.io.IOException {
        BatchTranslateDocument result = new BatchTranslateDocument(parent, content);
        initialize(result);
        return result;
      }

      public class BatchTranslateDocument extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {

        private static final String REST_PATH = "v3beta1/{+parent}:batchTranslateDocument";
       ...
       *        same location-id) can be used, otherwise an INVALID_ARGUMENT (400) error is returned.
         ...
         * @since 1.13
         */
        protected BatchTranslateDocument(java.lang.String parent, com.google.api.services.translate.v3beta1.model.BatchTranslateDocumentRequest content) {
          super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *        translation. Only AutoML Translation models or glossaries within the same region (have the
       *        same location-id) can be used, otherwise an INVALID_ARGUMENT (400) error is returned.
       * @param content the {@link com.google.api.services.translate.v3beta1.model.BatchTranslateTextRequest}
       * @return the request
       */
      public BatchTranslateText batchTranslateText(java.lang.String parent, com.google.api.services.translate.v3beta1.model.BatchTranslateTextRequest content) throws java.io.IOException {
        BatchTranslateText result = new BatchTranslateText(parent, content);
        initialize(result);
        return result;
      }

      public class BatchTranslateText extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {
       ...
       *        same location-id) can be used, otherwise an INVALID_ARGUMENT (400) error is returned.
         ...
         * @since 1.13
         */
        protected BatchTranslateText(java.lang.String parent, com.google.api.services.translate.v3beta1.model.BatchTranslateTextRequest content) {
          super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
      ...
      public class Get extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.Location.class);
      ...
      public class List extends TranslateRequest<com.google.api.services.translate.v3beta1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param parent Required. Location to make a regional call. Format: `projects/{project-number-or-
       *        id}/locations/{location-id}`. For global calls, use `projects/{project-number-or-
       *        id}/locations/global`. Non-global location is required for requests using AutoML models or
       *        custom glossaries. Models and glossaries must be within the same region (have the same
       *        location-id), otherwise an INVALID_ARGUMENT (400) error is returned.
       * @param content the {@link com.google.api.services.translate.v3beta1.model.TranslateDocumentRequest}
       * @return the request
       */
      public TranslateDocument translateDocument(java.lang.String parent, com.google.api.services.translate.v3beta1.model.TranslateDocumentRequest content) throws java.io.IOException {
        TranslateDocument result = new TranslateDocument(parent, content);
        initialize(result);
        return result;
      }

      public class TranslateDocument extends TranslateRequest<com.google.api.services.translate.v3beta1.model.TranslateDocumentResponse> {

        private static final String REST_PATH = "v3beta1/{+parent}:translateDocument";
       ...
       *        location-id), otherwise an INVALID_ARGUMENT (400) error is returned.
         ...
         * @since 1.13
         */
        protected TranslateDocument(java.lang.String parent, com.google.api.services.translate.v3beta1.model.TranslateDocumentRequest content) {
          super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.TranslateDocumentResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /** Required. Location to make a regional call. Format: `projects/{project-number-or-
       id}/locations/{location-id}`. For global calls, use `projects/{project-number-or-
       id}/locations/global`. Non-global location is required for requests using AutoML models or custom
       glossaries. Models and glossaries must be within the same region (have the same location-id),
      ...
      public class Glossaries {
         ...
         * @param content the {@link com.google.api.services.translate.v3beta1.model.Glossary}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.translate.v3beta1.model.Glossary content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.translate.v3beta1.model.Glossary content) {
            super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Delete extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {
          ...
          protected Delete(java.lang.String name) {
            super(Translate.this, "DELETE", REST_PATH, null, com.google.api.services.translate.v3beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Glossary> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.Glossary.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TranslateRequest<com.google.api.services.translate.v3beta1.model.ListGlossariesResponse> {
          ...
          protected List(java.lang.String parent) {
            super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.ListGlossariesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.translate.v3beta1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.translate.v3beta1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.translate.v3beta1.model.CancelOperationRequest content) {
            super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(Translate.this, "DELETE", REST_PATH, null, com.google.api.services.translate.v3beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TranslateRequest<com.google.api.services.translate.v3beta1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(Translate.this, "GET", REST_PATH, null, com.google.api.services.translate.v3beta1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.translate.v3beta1.model.WaitOperationRequest}
         * @return the request
         */
        public Wait wait(java.lang.String name, com.google.api.services.translate.v3beta1.model.WaitOperationRequest content) throws java.io.IOException {
          Wait result = new Wait(name, content);
          initialize(result);
          return result;
        }

        public class Wait extends TranslateRequest<com.google.api.services.translate.v3beta1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Wait(java.lang.String name, com.google.api.services.translate.v3beta1.model.WaitOperationRequest content) {
            super(Translate.this, "POST", REST_PATH, content, com.google.api.services.translate.v3beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
