...
public final class CallInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.lang.String> availableAnnotationToolTypes;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getAvailableAnnotationToolTypes() {
    return availableAnnotationToolTypes;
  }

  /**
   * Available screen annotation tool types.
   * @param availableAnnotationToolTypes availableAnnotationToolTypes or {@code null} for none
   */
  public CallInfo setAvailableAnnotationToolTypes(java.util.List<java.lang.String> availableAnnotationToolTypes) {
