...
public final class HttpHealthCheckList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HttpHealthCheck> items;

  static {
    // hack to force ProGuard to consider HttpHealthCheck used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(HttpHealthCheck.class);
  }
   ...
   */
  public HttpHealthCheckList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<HttpHealthCheck> getItems() {
    return items;
  }
   ...
   */
  public HttpHealthCheckList setItems(java.util.List<HttpHealthCheck> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HttpHealthCheckList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public HttpHealthCheckList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HttpHealthCheckList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HttpHealthCheckList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HttpHealthCheckList set(String fieldName, Object value) {
    return (HttpHealthCheckList) super.set(fieldName, value);
  }

  @Override
  public HttpHealthCheckList clone() {
    return (HttpHealthCheckList) super.clone();
  }
