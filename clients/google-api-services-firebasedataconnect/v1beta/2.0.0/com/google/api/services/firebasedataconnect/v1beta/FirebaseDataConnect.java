...
public class FirebaseDataConnect extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "2.0.0 of the Firebase SQL Connect API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Services {
         ...
         *        projects/{project}/locations/{location}/services/{service}
         * @param content the {@link com.google.api.services.firebasedataconnect.v1beta.model.GenerateQueryRequest}
         * @return the request
         */
        public GenerateQuery generateQuery(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GenerateQueryRequest content) throws java.io.IOException {
          GenerateQuery result = new GenerateQuery(name, content);
          initialize(result);
          return result;
        }

        public class GenerateQuery extends FirebaseDataConnectRequest<com.google.api.services.firebasedataconnect.v1beta.model.GenerateQueryResponse> {

          private static final String REST_PATH = "v1beta/{+name}:generateQuery";
         ...
         *        projects/{project}/locations/{location}/services/{service}
           ...
           * @since 1.13
           */
          protected GenerateQuery(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GenerateQueryRequest content) {
            super(FirebaseDataConnect.this, "POST", REST_PATH, content, com.google.api.services.firebasedataconnect.v1beta.model.GenerateQueryResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        projects/{project}/locations/{location}/services/{service}
         * @param content the {@link com.google.api.services.firebasedataconnect.v1beta.model.GenerateSchemaRequest}
         * @return the request
         */
        public GenerateSchema generateSchema(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GenerateSchemaRequest content) throws java.io.IOException {
          GenerateSchema result = new GenerateSchema(name, content);
          initialize(result);
          return result;
        }

        public class GenerateSchema extends FirebaseDataConnectRequest<com.google.api.services.firebasedataconnect.v1beta.model.GenerateSchemaResponse> {

          private static final String REST_PATH = "v1beta/{+name}:generateSchema";
         ...
         *        projects/{project}/locations/{location}/services/{service}
           ...
           * @since 1.13
           */
          protected GenerateSchema(java.lang.String name, com.google.api.services.firebasedataconnect.v1beta.model.GenerateSchemaRequest content) {
            super(FirebaseDataConnect.this, "POST", REST_PATH, content, com.google.api.services.firebasedataconnect.v1beta.model.GenerateSchemaResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
