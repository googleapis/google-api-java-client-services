...
public final class GoogleCloudTalentV4CompensationInfoCompensationRange extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationRange setMaxCompensation(Money maxCompensation) {
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationRange setMinCompensation(Money minCompensation) {
    this.minCompensation = minCompensation;
    return this;
  }

  @Override
  public GoogleCloudTalentV4CompensationInfoCompensationRange set(String fieldName, Object value) {
    return (GoogleCloudTalentV4CompensationInfoCompensationRange) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudTalentV4CompensationInfoCompensationRange clone() {
    return (GoogleCloudTalentV4CompensationInfoCompensationRange) super.clone();
  }
