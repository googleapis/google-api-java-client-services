...
public final class GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
  ...
  @Override
  public GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest clone() {
    return (GoogleCloudDiscoveryengineV1betaPurgeDocumentsRequest) super.clone();
  }
