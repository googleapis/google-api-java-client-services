...
<project>
  <dependencies>
    <dependency>
      ...
      <version>loyaltycustomers_v1-rev20260901-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:loyaltycustomers_v1-rev20260901-2.0.0'
}
```
