...
/**
 * Model definition for DeleteOrderDealsResponse.
 *
...
public final class DeleteOrderDealsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public DeleteOrderDealsResponse setDeals(java.util.List<MarketplaceDeal> deals) {
    this.deals = deals;
    return this;
  }
   ...
   */
  public DeleteOrderDealsResponse setProposalRevisionNumber(java.lang.Long proposalRevisionNumber) {
    this.proposalRevisionNumber = proposalRevisionNumber;
    return this;
  }

  @Override
  public DeleteOrderDealsResponse set(String fieldName, Object value) {
    return (DeleteOrderDealsResponse) super.set(fieldName, value);
  }

  @Override
  public DeleteOrderDealsResponse clone() {
    return (DeleteOrderDealsResponse) super.clone();
  }
