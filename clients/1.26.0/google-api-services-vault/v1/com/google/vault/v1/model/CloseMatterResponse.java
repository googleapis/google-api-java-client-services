...
public final class CloseMatterResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CloseMatterResponse set(String fieldName, Object value) {
    return (CloseMatterResponse) super.set(fieldName, value);
  }

  @Override
  public CloseMatterResponse clone() {
    return (CloseMatterResponse) super.clone();
  }
