...
public final class NodeTypesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public NodeTypesScopedList setNodeTypes(java.util.List<NodeType> nodeTypes) {
   ...
   */
  public NodeTypesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeTypesScopedList set(String fieldName, Object value) {
    return (NodeTypesScopedList) super.set(fieldName, value);
  }

  @Override
  public NodeTypesScopedList clone() {
    return (NodeTypesScopedList) super.clone();
  }
