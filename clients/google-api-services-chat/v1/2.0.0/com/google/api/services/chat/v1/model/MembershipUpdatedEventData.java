...
public final class MembershipUpdatedEventData extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public MembershipUpdatedEventData set(String fieldName, Object value) {
    return (MembershipUpdatedEventData) super.set(fieldName, value);
  }

  @Override
  public MembershipUpdatedEventData clone() {
    return (MembershipUpdatedEventData) super.clone();
  }
