...
package com.google.api.services.speech.v2beta.model;
...
public final class LongRunningRecognizeMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Approximate percentage of audio processed thus far. Guaranteed to be 100 when the
   * audio is fully processed and the results are available.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
