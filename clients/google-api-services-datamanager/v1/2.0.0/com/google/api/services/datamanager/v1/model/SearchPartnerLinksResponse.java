...
public final class SearchPartnerLinksResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<PartnerLink> partnerLinks;

  static {
    // hack to force ProGuard to consider PartnerLink used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(PartnerLink.class);
  }
  ...
  @Override
  public SearchPartnerLinksResponse set(String fieldName, Object value) {
    return (SearchPartnerLinksResponse) super.set(fieldName, value);
  }

  @Override
  public SearchPartnerLinksResponse clone() {
    return (SearchPartnerLinksResponse) super.clone();
  }
