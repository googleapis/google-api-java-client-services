...
public final class ResourcePolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ResourcePolicy> items;

  static {
    // hack to force ProGuard to consider ResourcePolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ResourcePolicy.class);
  }
   ...
   */
  public ResourcePolicyList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ResourcePolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ResourcePolicy> getItems() {
    return items;
  }
   ...
   */
  public ResourcePolicyList setItems(java.util.List<ResourcePolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ResourcePolicyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ResourcePolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ResourcePolicyList set(String fieldName, Object value) {
    return (ResourcePolicyList) super.set(fieldName, value);
  }

  @Override
  public ResourcePolicyList clone() {
    return (ResourcePolicyList) super.clone();
  }
