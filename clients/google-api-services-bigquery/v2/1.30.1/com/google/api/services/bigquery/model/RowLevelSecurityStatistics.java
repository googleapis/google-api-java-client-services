...
public final class RowLevelSecurityStatistics extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RowLevelSecurityStatistics set(String fieldName, Object value) {
    return (RowLevelSecurityStatistics) super.set(fieldName, value);
  }

  @Override
  public RowLevelSecurityStatistics clone() {
    return (RowLevelSecurityStatistics) super.clone();
  }
