...
public final class VpnGatewaysScopedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] A list of VPN gateways contained in this scope.
   * @param vpnGateways vpnGateways or {@code null} for none
   */
  public VpnGatewaysScopedList setVpnGateways(java.util.List<VpnGateway> vpnGateways) {
   ...
   */
  public VpnGatewaysScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VpnGatewaysScopedList set(String fieldName, Object value) {
    return (VpnGatewaysScopedList) super.set(fieldName, value);
  }

  @Override
  public VpnGatewaysScopedList clone() {
    return (VpnGatewaysScopedList) super.clone();
  }
