...
public final class TeamDriveList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TeamDrive> teamDrives;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TeamDrive> getTeamDrives() {
    return teamDrives;
  }
   ...
   */
  public TeamDriveList setTeamDrives(java.util.List<TeamDrive> teamDrives) {
