...
public final class RemoteAgentDetails extends com.google.api.client.json.GenericJson {

  @Override
  public RemoteAgentDetails set(String fieldName, Object value) {
    return (RemoteAgentDetails) super.set(fieldName, value);
  }

  @Override
  public RemoteAgentDetails clone() {
    return (RemoteAgentDetails) super.clone();
  }
