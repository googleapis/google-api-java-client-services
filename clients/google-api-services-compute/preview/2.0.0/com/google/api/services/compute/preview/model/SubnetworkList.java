...
public final class SubnetworkList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Subnetwork> items;
  ...
  /**
   * Output only. [Output Only] Type of resource. Always compute#subnetworkList for lists of
   * subnetworks.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public SubnetworkList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Subnetwork> getItems() {
    return items;
  }
   ...
   */
  public SubnetworkList setItems(java.util.List<Subnetwork> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SubnetworkList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public SubnetworkList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SubnetworkList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public SubnetworkList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SubnetworkList set(String fieldName, Object value) {
    return (SubnetworkList) super.set(fieldName, value);
  }

  @Override
  public SubnetworkList clone() {
    return (SubnetworkList) super.clone();
  }
