...
public final class TaskGroup extends com.google.api.client.json.GenericJson {
   ...
   * true, Batch will make sure to run the runnables using a non-root user. Currently, the non-root
   * user Batch used is generated by OS Login. For more information, see [About OS
