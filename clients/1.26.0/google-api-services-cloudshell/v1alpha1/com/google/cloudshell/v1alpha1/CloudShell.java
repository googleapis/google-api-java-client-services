...
package com.google.cloudshell.v1alpha1;
...
public class CloudShell extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Cloud Shell API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Users {
    ...
    public class Environments {
       ...
       * @param content the {@link com.google.cloudshell.v1alpha1.model.AuthorizeEnvironmentRequest}
       * @return the request
       */
      public Authorize authorize(java.lang.String name, com.google.cloudshell.v1alpha1.model.AuthorizeEnvironmentRequest content) throws java.io.IOException {
        Authorize result = new Authorize(name, content);
        initialize(result);
        return result;
      }

      public class Authorize extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.Empty> {
       ...
       *        `users/someone@example.com/environments/default`.
         ...
         * @since 1.13
         */
        protected Authorize(java.lang.String name, com.google.cloudshell.v1alpha1.model.AuthorizeEnvironmentRequest content) {
          super(CloudShell.this, "POST", REST_PATH, content, com.google.cloudshell.v1alpha1.model.Empty.class);
      ...
      public class Get extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.Environment> {
       ...
       *        `users/someone@example.com/environments/default`.
        ...
        protected Get(java.lang.String name) {
          super(CloudShell.this, "GET", REST_PATH, null, com.google.cloudshell.v1alpha1.model.Environment.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      `users/me/environments/default` or
       *        `users/someone@example.com/environments/default`.
       * @param content the {@link com.google.cloudshell.v1alpha1.model.Environment}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.cloudshell.v1alpha1.model.Environment content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.Environment> {
       ...
       *        `users/someone@example.com/environments/default`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.cloudshell.v1alpha1.model.Environment content) {
          super(CloudShell.this, "PATCH", REST_PATH, content, com.google.cloudshell.v1alpha1.model.Environment.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      `users/me/environments/default` or
       *        `users/someone@example.com/environments/default`.
       * @param content the {@link com.google.cloudshell.v1alpha1.model.StartEnvironmentRequest}
       * @return the request
       */
      public Start start(java.lang.String name, com.google.cloudshell.v1alpha1.model.StartEnvironmentRequest content) throws java.io.IOException {
        Start result = new Start(name, content);
        initialize(result);
        return result;
      }

      public class Start extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.Operation> {
       ...
       *        `users/someone@example.com/environments/default`.
         ...
         * @since 1.13
         */
        protected Start(java.lang.String name, com.google.cloudshell.v1alpha1.model.StartEnvironmentRequest content) {
          super(CloudShell.this, "POST", REST_PATH, content, com.google.cloudshell.v1alpha1.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class PublicKeys {
         ...
         * @param content the {@link com.google.cloudshell.v1alpha1.model.CreatePublicKeyRequest}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.cloudshell.v1alpha1.model.CreatePublicKeyRequest content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.PublicKey> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.cloudshell.v1alpha1.model.CreatePublicKeyRequest content) {
            super(CloudShell.this, "POST", REST_PATH, content, com.google.cloudshell.v1alpha1.model.PublicKey.class);
        ...
        public class Delete extends CloudShellRequest<com.google.cloudshell.v1alpha1.model.Empty> {
        ...
        `users/me/environments/default/publicKeys/my-key`.
          ...
          protected Delete(java.lang.String name) {
            super(CloudShell.this, "DELETE", REST_PATH, null, com.google.cloudshell.v1alpha1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
