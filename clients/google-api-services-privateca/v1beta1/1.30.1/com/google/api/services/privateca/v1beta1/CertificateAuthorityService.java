...
public class CertificateAuthorityService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.10 of the Certificate Authority API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
    ...
    public class Locations {
      ...
      public class CertificateAuthorities {
        ...
        public class CertificateRevocationLists {
          ...
          /**
           * Create a new CertificateRevocationList in a given Project, Location for a particular
           * CertificateAuthority.
           *
           * Create a request for the method "certificateRevocationLists.create".
           *
           * This request holds the parameters needed by the privateca server.  After setting any optional
           * parameters, call the {@link Create#execute()} method to invoke the remote operation.
           *
           * @param parent Required. The resource name of the location and CertificateAuthority associated with the
           *        CertificateRevocationList, in the format `projects/locations/certificateAuthorities`.
           * @param content the {@link com.google.api.services.privateca.v1beta1.model.CertificateRevocationList}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.privateca.v1beta1.model.CertificateRevocationList content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
           ...
           *        CertificateRevocationList, in the format `projects/locations/certificateAuthorities`.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.privateca.v1beta1.model.CertificateRevocationList content) {
              super(CertificateAuthorityService.this, "POST", REST_PATH, content, com.google.api.services.privateca.v1beta1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
             ...
             * the CertificateRevocationList, in the format
             * `projects/locations/certificateAuthorities`.
             */
            @com.google.api.client.util.Key
            private java.lang.String parent;
           ...
           CertificateRevocationList, in the format `projects/locations/certificateAuthorities`.
             ...
             */
            @com.google.api.client.util.Key
            private java.lang.String certificateRevocationListId;

            /** Required. It must be unique within a location and match the regular expression
           `[a-zA-Z0-9_-]{1,63}`
             */
            public java.lang.String getCertificateRevocationListId() {
              return certificateRevocationListId;
            }
             ...
             * `[a-zA-Z0-9_-]{1,63}`
             */
            public Create setCertificateRevocationListId(java.lang.String certificateRevocationListId) {
