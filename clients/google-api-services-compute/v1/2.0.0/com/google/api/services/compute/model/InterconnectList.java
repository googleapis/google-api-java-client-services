...
public final class InterconnectList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Interconnect> items;

  static {
    // hack to force ProGuard to consider Interconnect used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Interconnect.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#interconnectList for lists of
   * interconnects.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public InterconnectList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Interconnect> getItems() {
    return items;
  }
   ...
   */
  public InterconnectList setItems(java.util.List<Interconnect> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InterconnectList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InterconnectList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InterconnectList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InterconnectList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectList set(String fieldName, Object value) {
    return (InterconnectList) super.set(fieldName, value);
  }

  @Override
  public InterconnectList clone() {
    return (InterconnectList) super.clone();
  }
