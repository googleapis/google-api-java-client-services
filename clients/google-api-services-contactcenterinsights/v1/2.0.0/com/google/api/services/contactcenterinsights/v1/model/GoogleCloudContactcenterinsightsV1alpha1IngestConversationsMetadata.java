...
public final class GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata setCreateTime(String createTime) {
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata setPartialErrors(java.util.List<GoogleRpcStatus> partialErrors) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequest getRequest() {
    return request;
  }
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata setRequest(GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequest request) {
  ...
  @Override
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata clone() {
    return (GoogleCloudContactcenterinsightsV1alpha1IngestConversationsMetadata) super.clone();
  }
