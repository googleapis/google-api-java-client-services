...
public final class UndeleteFolderMetadata extends com.google.api.client.json.GenericJson {

  @Override
  public UndeleteFolderMetadata set(String fieldName, Object value) {
    return (UndeleteFolderMetadata) super.set(fieldName, value);
  }

  @Override
  public UndeleteFolderMetadata clone() {
    return (UndeleteFolderMetadata) super.clone();
  }
