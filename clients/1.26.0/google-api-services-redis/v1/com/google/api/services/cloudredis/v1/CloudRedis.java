...
package com.google.api.services.cloudredis.v1;
...
public class CloudRedis extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Location.class);
      ...
      public class List extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Instances {
         ...
         * @param content the {@link com.google.api.services.cloudredis.v1.model.Instance}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.cloudredis.v1.model.Instance content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Operation> {
        ...
        where `location_id` refers to a GCP region
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.cloudredis.v1.model.Instance content) {
            super(CloudRedis.this, "POST", REST_PATH, content, com.google.api.services.cloudredis.v1.model.Operation.class);
        ...
        public class Delete extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Operation> {
         ...
         *        `location_id` refers to a GCP region
          ...
          protected Delete(java.lang.String name) {
            super(CloudRedis.this, "DELETE", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Instance> {
         ...
         *        `location_id` refers to a GCP region
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Instance.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.ListInstancesResponse> {
        ...
        where `location_id` refers to a GCP region
          ...
          protected List(java.lang.String parent) {
            super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.ListInstancesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.cloudredis.v1.model.Instance content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Operation> {
         ...
         *        [alternative_location_id] fields for more details.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.cloudredis.v1.model.Instance content) {
            super(CloudRedis.this, "PATCH", REST_PATH, content, com.google.api.services.cloudredis.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Cancel extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(CloudRedis.this, "POST", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(CloudRedis.this, "DELETE", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudRedisRequest<com.google.api.services.cloudredis.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(CloudRedis.this, "GET", REST_PATH, null, com.google.api.services.cloudredis.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
