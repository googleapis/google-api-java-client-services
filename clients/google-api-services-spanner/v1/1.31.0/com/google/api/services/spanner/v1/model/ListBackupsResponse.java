...
public final class ListBackupsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The list of matching backups. Backups returned are ordered by `create_time` in descending
  ...
  /**
   * `next_page_token` can be sent in a subsequent ListBackups call to fetch more of the matching
   * backups.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
