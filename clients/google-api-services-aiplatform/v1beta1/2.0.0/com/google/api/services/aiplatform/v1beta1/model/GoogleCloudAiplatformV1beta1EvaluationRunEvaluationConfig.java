...
public final class GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1EvaluationRunMetric> metrics;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfigOutputConfig outputConfig;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1EvaluationRubricConfig> rubricConfigs;

  static {
    // hack to force ProGuard to consider GoogleCloudAiplatformV1beta1EvaluationRubricConfig used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAiplatformV1beta1EvaluationRubricConfig.class);
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfigAutoraterConfig getAutoraterConfig() {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfigOutputConfig getOutputConfig() {
    return outputConfig;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig setOutputConfig(GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfigOutputConfig outputConfig) {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig setPromptTemplate(GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfigPromptTemplate promptTemplate) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1EvaluationRubricConfig> getRubricConfigs() {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig setRubricConfigs(java.util.List<GoogleCloudAiplatformV1beta1EvaluationRubricConfig> rubricConfigs) {
    this.rubricConfigs = rubricConfigs;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig clone() {
    return (GoogleCloudAiplatformV1beta1EvaluationRunEvaluationConfig) super.clone();
  }
