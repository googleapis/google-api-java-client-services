...
public class Speech extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.28.0 of the Cloud Speech-to-Text API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
        ...
        public class List extends SpeechRequest<com.google.api.services.speech.v1p1beta1.model.ListOperationsResponse> {
          ...
          private static final String REST_PATH = "v1p1beta1/{+name}/operations";
    ...
    public class Operations {
      ...
      /**
       * An accessor for creating requests from the ManualRecognitionTasks collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code Speech speech = new Speech(...);}
       *   {@code Speech.ManualRecognitionTasks.List request = speech.manualRecognitionTasks().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public ManualRecognitionTasks manualRecognitionTasks() {
        return new ManualRecognitionTasks();
      }

      /**
       * The "manualRecognitionTasks" collection of methods.
       */
      public class ManualRecognitionTasks {

        /**
         * Gets the latest state of a long-running operation.  Clients can use this method to poll the
         * operation result at intervals as recommended by the API service.
         *
         * Create a request for the method "manualRecognitionTasks.get".
         *
         * This request holds the parameters needed by the speech server.  After setting any optional
         * parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
        ...
        public class Get extends SpeechRequest<com.google.api.services.speech.v1p1beta1.model.Operation> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/operations/manualRecognitionTasks/[^/]+$");
