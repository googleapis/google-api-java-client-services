...
public final class GenaiVertexV1beta1Content extends com.google.api.client.json.GenericJson {

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private GenaiVertexV1beta1AudioContent audio;

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private GenaiVertexV1beta1DocumentContent document;
   ...
   */
  public GenaiVertexV1beta1AudioContent getAudio() {
    return audio;
  }
   ...
   */
  public GenaiVertexV1beta1Content setAudio(GenaiVertexV1beta1AudioContent audio) {
    this.audio = audio;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GenaiVertexV1beta1DocumentContent getDocument() {
    return document;
  }
   ...
   */
  public GenaiVertexV1beta1Content setDocument(GenaiVertexV1beta1DocumentContent document) {
   ...
   */
  public GenaiVertexV1beta1Content setImage(GenaiVertexV1beta1ImageContent image) {
    this.image = image;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GenaiVertexV1beta1VideoContent getVideo() {
    return video;
  }
   ...
   */
  public GenaiVertexV1beta1Content setVideo(GenaiVertexV1beta1VideoContent video) {
    this.video = video;
    return this;
  }

  @Override
  public GenaiVertexV1beta1Content set(String fieldName, Object value) {
    return (GenaiVertexV1beta1Content) super.set(fieldName, value);
  }

  @Override
  public GenaiVertexV1beta1Content clone() {
    return (GenaiVertexV1beta1Content) super.clone();
  }
