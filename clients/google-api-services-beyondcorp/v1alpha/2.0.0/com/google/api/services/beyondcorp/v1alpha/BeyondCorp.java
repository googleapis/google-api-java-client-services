      ...
      public class Global {
        ...
        public class PartnerTenants {
          ...
          public class BrowserDlpRules {
            ...
            public class Get extends BeyondCorpRequest<com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule> {
             ...
             *        ocations/global/partnerTenants/{partner_tenant_id}/browserDlpRules/{browser_dlp_rule_id}`
               ...
               */
              protected Get(java.lang.String name) {
                super(BeyondCorp.this, "GET", REST_PATH, null, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
             ...
             *
             * Create a request for the method "browserDlpRules.list".
             *
             * This request holds the parameters needed by the beyondcorp server.  After setting any optional
             * parameters, call the {@link List#execute()} method to invoke the remote operation.
             *
             * @param parent Required. The parent partnerTenant to which the BrowserDlpRules belong. Format:
             *        `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
             * @return the request
             */
            public List list(java.lang.String parent) throws java.io.IOException {
            ...
            public class List extends BeyondCorpRequest<com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaListBrowserDlpRulesResponse> {

              private static final String REST_PATH = "v1alpha/{+parent}/browserDlpRules";
             ...
             *        `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
               ...
               */
              protected List(java.lang.String parent) {
                super(BeyondCorp.this, "GET", REST_PATH, null, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaListBrowserDlpRulesResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
              ...
              /**
               * Required. The parent partnerTenant to which the BrowserDlpRules belong. Format: `or
               * ganizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
               */
              @com.google.api.client.util.Key
              private java.lang.String parent;
          ...
          public class ProxyConfigs {
            ...
            /**
             * Creates a new BeyondCorp Enterprise ProxyConfig in a given organization and PartnerTenant. Can
             ...
             *        `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
             ...
             `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
               ...
               * ProxyConfigs with displayName "test-config" organizations/${ORG_ID}/locations/globa
               * l/partnerTenants/${PARTNER_TENANT_ID}/proxyConfigs?filter=displayName="test-config"
               * Nested fields are also supported. The follow query will return ProxyConfigs with
               * pacUri "example.com/pac.pac" organizations/${ORG_ID}/locations/global/partnerTenant
               * s/${PARTNER_TENANT_ID}/proxyConfigs?filter=routingInfo.pacUri="example.com/pac.pac"
               * For more information, please refer to https://google.aip.dev/160.
               */
              @com.google.api.client.util.Key
              private java.lang.String filter;

              /** Optional. A filter specifying constraints of a list operation. All fields in the ProxyConfig
             message are supported. For example, the following query will return the ProxyConfigs with
             displayName "test-config" organizations/${ORG_ID}/locations/global/partnerTenants/${PARTNER_TENANT_
             ID}/proxyConfigs?filter=displayName="test-config" Nested fields are also supported. The follow
             query will return ProxyConfigs with pacUri "example.com/pac.pac" organizations/${ORG_ID}/locations/
             global/partnerTenants/${PARTNER_TENANT_ID}/proxyConfigs?filter=routingInfo.pacUri="example.com/pac.
             ...
             order](https://cloud.google.com/apis/design/design_patterns#sorting_order) for more information.
               ...
               * of 50 will be used by the service. Regardless of the page_size value, the response
               * may include a partial list and a caller should only rely on response's
