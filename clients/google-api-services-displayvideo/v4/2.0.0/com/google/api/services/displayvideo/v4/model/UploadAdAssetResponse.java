...
public final class UploadAdAssetResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public UploadAdAssetResponse set(String fieldName, Object value) {
    return (UploadAdAssetResponse) super.set(fieldName, value);
  }

  @Override
  public UploadAdAssetResponse clone() {
    return (UploadAdAssetResponse) super.clone();
  }
