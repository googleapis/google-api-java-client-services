      ...
      public class Catalogs {
        ...
        public class Branches {
          ...
          public class Products {
             ...
             * timestamp. If a place in the provided list does not exist, the place will be created. If a place
             * in the provided list already exists, it will be updated while respecting the last update
             * timestamps of each inventory field. If an existing place is not in the provided list, it will be
             * removed. This process is asynchronous. If the request is valid, the set operation will be
             * enqueued and processed downstream. As a consequence, when a response is returned, set operations
             * are not immediately manifested in the Product queried by GetProduct or ListProducts. When
             * applying the set operation, this process takes a snapshot of currently existing places and their
             * corresponding timestamps to determine the places to update. Avoid concurrent AddLocalInventories
             * and RemoveLocalInventories calls, since they can introduce asynchronous updates that could be
             * missed by the set operation. Local inventory information can only be updated with this method and
             * other local inventory-specific methods. CreateProduct and UpdateProduct has no effect on local
             * inventories. This feature is only available for users who have Retail Search enabled. Please
             * submit a form [here](https://cloud.google.com/contact) to contact Cloud sales if you are
             * interested in using Retail Search.
             *
             * Create a request for the method "products.setLocalInventories".
             *
             * This request holds the parameters needed by the retail server.  After setting any optional
             * parameters, call the {@link SetLocalInventories#execute()} method to invoke the remote operation.
             *
             * @param product Required. Full resource name of Product, such as `projects/locations/global/catalogs/default_catalog
             *        /branches/default_branch/products/some_product_id`. If the caller does not have permission
             *        to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error
             *        is returned.
             * @param content the {@link com.google.api.services.retail.v2alpha.model.GoogleCloudRetailV2alphaSetLocalInventoriesRequest}
             * @return the request
             */
            public SetLocalInventories setLocalInventories(java.lang.String product, com.google.api.services.retail.v2alpha.model.GoogleCloudRetailV2alphaSetLocalInventoriesRequest content) throws java.io.IOException {
              SetLocalInventories result = new SetLocalInventories(product, content);
              initialize(result);
              return result;
            }

            public class SetLocalInventories extends CloudRetailRequest<com.google.api.services.retail.v2alpha.model.GoogleLongrunningOperation> {

              private static final String REST_PATH = "v2alpha/{+product}:setLocalInventories";
               ...
               * place in the provided list already exists, it will be updated while respecting the last update
               * timestamps of each inventory field. If an existing place is not in the provided list, it will
               * be removed. This process is asynchronous. If the request is valid, the set operation will be
               * enqueued and processed downstream. As a consequence, when a response is returned, set
               * operations are not immediately manifested in the Product queried by GetProduct or ListProducts.
               * When applying the set operation, this process takes a snapshot of currently existing places and
               * their corresponding timestamps to determine the places to update. Avoid concurrent
               * AddLocalInventories and RemoveLocalInventories calls, since they can introduce asynchronous
               * updates that could be missed by the set operation. Local inventory information can only be
               * updated with this method and other local inventory-specific methods. CreateProduct and
               * UpdateProduct has no effect on local inventories. This feature is only available for users who
               * have Retail Search enabled. Please submit a form [here](https://cloud.google.com/contact) to
               * contact Cloud sales if you are interested in using Retail Search.
               *
               * Create a request for the method "products.setLocalInventories".
               *
               * This request holds the parameters needed by the the retail server.  After setting any optional
               * parameters, call the {@link SetLocalInventories#execute()} method to invoke the remote
               * operation. <p> {@link SetLocalInventories#initialize(com.google.api.client.googleapis.services.
               * AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
               * invoking the constructor. </p>
               *
               * @param product Required. Full resource name of Product, such as `projects/locations/global/catalogs/default_catalog
             ...
             *        is returned.
               ...
               * @since 1.13
               */
              protected SetLocalInventories(java.lang.String product, com.google.api.services.retail.v2alpha.model.GoogleCloudRetailV2alphaSetLocalInventoriesRequest content) {
                super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2alpha.model.GoogleLongrunningOperation.class);
                this.product = com.google.api.client.util.Preconditions.checkNotNull(product, "Required parameter product must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PRODUCT_PATTERN.matcher(product).matches(),
              ...
              @Override
              public SetLocalInventories set$Xgafv(java.lang.String $Xgafv) {
                return (SetLocalInventories) super.set$Xgafv($Xgafv);
              }

              @Override
              public SetLocalInventories setAccessToken(java.lang.String accessToken) {
                return (SetLocalInventories) super.setAccessToken(accessToken);
              }

              @Override
              public SetLocalInventories setAlt(java.lang.String alt) {
                return (SetLocalInventories) super.setAlt(alt);
              }

              @Override
              public SetLocalInventories setCallback(java.lang.String callback) {
                return (SetLocalInventories) super.setCallback(callback);
              }

              @Override
              public SetLocalInventories setFields(java.lang.String fields) {
                return (SetLocalInventories) super.setFields(fields);
              }

              @Override
              public SetLocalInventories setKey(java.lang.String key) {
                return (SetLocalInventories) super.setKey(key);
              }

              @Override
              public SetLocalInventories setOauthToken(java.lang.String oauthToken) {
                return (SetLocalInventories) super.setOauthToken(oauthToken);
              }

              @Override
              public SetLocalInventories setPrettyPrint(java.lang.Boolean prettyPrint) {
                return (SetLocalInventories) super.setPrettyPrint(prettyPrint);
              }

              @Override
              public SetLocalInventories setQuotaUser(java.lang.String quotaUser) {
                return (SetLocalInventories) super.setQuotaUser(quotaUser);
              }

              @Override
              public SetLocalInventories setUploadType(java.lang.String uploadType) {
                return (SetLocalInventories) super.setUploadType(uploadType);
              }

              @Override
              public SetLocalInventories setUploadProtocol(java.lang.String uploadProtocol) {
                return (SetLocalInventories) super.setUploadProtocol(uploadProtocol);
              }
             ...
             access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error is returned.
               ...
               * exists, a PERMISSION_DENIED error is returned.
               */
              public SetLocalInventories setProduct(java.lang.String product) {
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PRODUCT_PATTERN.matcher(product).matches(),
                      "Parameter product must conform to the pattern " +
                      "^projects/[^/]+/locations/[^/]+/catalogs/[^/]+/branches/[^/]+/products/.*$");
              ...
              @Override
              public SetLocalInventories set(String parameterName, Object value) {
                return (SetLocalInventories) super.set(parameterName, value);
              }
            }
