 ...
 * <a href="https://cloud.google.com/datastream/" target="_blank">API Documentation</a>
 * </p>
 *
 * <p>
 * This service uses {@link DatastreamRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class Datastream extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Datastream API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public Datastream(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class FetchStaticIps extends DatastreamRequest<com.google.api.services.datastream.v1.model.FetchStaticIpsResponse> {
        ...
        protected FetchStaticIps(java.lang.String name) {
          super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.FetchStaticIpsResponse.class);
      ...
      public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.Location.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class ConnectionProfiles {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.datastream.v1.model.ConnectionProfile content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.datastream.v1.model.ConnectionProfile content) {
        ...
        public class Delete extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
          ...
          protected Delete(java.lang.String name) {
            super(Datastream.this, "DELETE", REST_PATH, null, com.google.api.services.datastream.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        `projects/locations`.
         * @param content the {@link com.google.api.services.datastream.v1.model.DiscoverConnectionProfileRequest}
         * @return the request
         */
        public Discover discover(java.lang.String parent, com.google.api.services.datastream.v1.model.DiscoverConnectionProfileRequest content) throws java.io.IOException {
          Discover result = new Discover(parent, content);
          initialize(result);
          return result;
        }

        public class Discover extends DatastreamRequest<com.google.api.services.datastream.v1.model.DiscoverConnectionProfileResponse> {
           ...
           *
           * This request holds the parameters needed by the the datastream server.  After setting any
           * optional parameters, call the {@link Discover#execute()} method to invoke the remote operation.
           * <p> {@link
         ...
         *        `projects/locations`.
           ...
           * @since 1.13
           */
          protected Discover(java.lang.String parent, com.google.api.services.datastream.v1.model.DiscoverConnectionProfileRequest content) {
            super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.DiscoverConnectionProfileResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.ConnectionProfile> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ConnectionProfile.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListConnectionProfilesResponse> {
          ...
          protected List(java.lang.String parent) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListConnectionProfilesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.datastream.v1.model.ConnectionProfile content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.datastream.v1.model.ConnectionProfile content) {
            super(Datastream.this, "PATCH", REST_PATH, content, com.google.api.services.datastream.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.datastream.v1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.datastream.v1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends DatastreamRequest<com.google.api.services.datastream.v1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.datastream.v1.model.CancelOperationRequest content) {
            super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends DatastreamRequest<com.google.api.services.datastream.v1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(Datastream.this, "DELETE", REST_PATH, null, com.google.api.services.datastream.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class PrivateConnections {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.datastream.v1.model.PrivateConnection content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
        ...
        public class Create extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.datastream.v1.model.PrivateConnection content) {
            super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.PrivateConnection> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.PrivateConnection.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListPrivateConnectionsResponse> {
           ...
           */
          protected List(java.lang.String parent) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListPrivateConnectionsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /** Maximum number of private connectivity configurations to return. If unspecified, at most 50 private
         connectivity configurations that will be returned. The maximum value is 1000; values above 1000
        ...
        public class Routes {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.datastream.v1.model.Route content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
          ...
          public class Create extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.datastream.v1.model.Route content) {
              super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Delete extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
            ...
            private final java.util.regex.Pattern NAME_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/privateConnections/[^/]+/routes/[^/]+$");
          ...
          public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.Route> {
             ...
             */
            protected Get(java.lang.String name) {
              super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.Route.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListRoutesResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListRoutesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
      ...
      public class Streams {
         ...
         *
         * Create a request for the method "streams.create".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         * parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.datastream.v1.model.Stream content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
        ...
        public class Create extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.datastream.v1.model.Stream content) {
            super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
         ...
         *
         * Create a request for the method "streams.delete".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
         *
         ...
         *
         * Create a request for the method "streams.get".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         * parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
        ...
        public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.Stream> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.Stream.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * Create a request for the method "streams.list".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         * parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
        ...
        public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListStreamsResponse> {
           ...
           */
          protected List(java.lang.String parent) {
            super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListStreamsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *
         * Create a request for the method "streams.patch".
         *
         * This request holds the parameters needed by the datastream server.  After setting any optional
         * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
         *
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.datastream.v1.model.Stream content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }
        ...
        public class Patch extends DatastreamRequest<com.google.api.services.datastream.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.datastream.v1.model.Stream content) {
            super(Datastream.this, "PATCH", REST_PATH, content, com.google.api.services.datastream.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         UUID is not supported (00000000-0000-0000-0000-000000000000).
          ...
          /** Optional. Field mask is used to specify the fields to be overwritten in the stream resource by the
         ...
         fields will be overwritten.
          ...
          /** Optional. Only validate the stream with the changes, without actually updating it. The default is
         false.
           */
          public java.lang.Boolean getValidateOnly() {
            return validateOnly;
        ...
        public class Objects {
          ...
          public class Get extends DatastreamRequest<com.google.api.services.datastream.v1.model.StreamObject> {
             ...
             */
            protected Get(java.lang.String name) {
              super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.StreamObject.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends DatastreamRequest<com.google.api.services.datastream.v1.model.ListStreamObjectsResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(Datastream.this, "GET", REST_PATH, null, com.google.api.services.datastream.v1.model.ListStreamObjectsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           *
           * @param parent Required. The parent stream that owns the collection of objects.
           * @param content the {@link com.google.api.services.datastream.v1.model.LookupStreamObjectRequest}
           * @return the request
           */
          public Lookup lookup(java.lang.String parent, com.google.api.services.datastream.v1.model.LookupStreamObjectRequest content) throws java.io.IOException {
            Lookup result = new Lookup(parent, content);
            initialize(result);
            return result;
          }

          public class Lookup extends DatastreamRequest<com.google.api.services.datastream.v1.model.StreamObject> {
             ...
             * @since 1.13
             */
            protected Lookup(java.lang.String parent, com.google.api.services.datastream.v1.model.LookupStreamObjectRequest content) {
              super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.StreamObject.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @param content the {@link com.google.api.services.datastream.v1.model.StartBackfillJobRequest}
           * @return the request
           */
          public StartBackfillJob startBackfillJob(java.lang.String object__, com.google.api.services.datastream.v1.model.StartBackfillJobRequest content) throws java.io.IOException {
            StartBackfillJob result = new StartBackfillJob(object__, content);
            initialize(result);
            return result;
          }

          public class StartBackfillJob extends DatastreamRequest<com.google.api.services.datastream.v1.model.StartBackfillJobResponse> {
             ...
             * @since 1.13
             */
            protected StartBackfillJob(java.lang.String object__, com.google.api.services.datastream.v1.model.StartBackfillJobRequest content) {
              super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.StartBackfillJobResponse.class);
           ...
           * @param content the {@link com.google.api.services.datastream.v1.model.StopBackfillJobRequest}
           * @return the request
           */
          public StopBackfillJob stopBackfillJob(java.lang.String object__, com.google.api.services.datastream.v1.model.StopBackfillJobRequest content) throws java.io.IOException {
            StopBackfillJob result = new StopBackfillJob(object__, content);
            initialize(result);
            return result;
          }

          public class StopBackfillJob extends DatastreamRequest<com.google.api.services.datastream.v1.model.StopBackfillJobResponse> {
             ...
             * @since 1.13
             */
            protected StopBackfillJob(java.lang.String object__, com.google.api.services.datastream.v1.model.StopBackfillJobRequest content) {
              super(Datastream.this, "POST", REST_PATH, content, com.google.api.services.datastream.v1.model.StopBackfillJobResponse.class);
              this.object__ = com.google.api.client.util.Preconditions.checkNotNull(object__, "Required parameter object__ must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(OBJECT___PATTERN.matcher(object__).matches(),
                    "Parameter object__ must conform to the pattern " +
