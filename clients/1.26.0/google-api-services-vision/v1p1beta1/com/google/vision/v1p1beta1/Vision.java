...
package com.google.vision.v1p1beta1;
...
public class Vision extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Cloud Vision API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Files {
     ...
     *
     * @param content the {@link com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest}
     * @return the request
     */
    public AsyncBatchAnnotate asyncBatchAnnotate(com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest content) throws java.io.IOException {
      AsyncBatchAnnotate result = new AsyncBatchAnnotate(content);
      initialize(result);
      return result;
    }

    public class AsyncBatchAnnotate extends VisionRequest<com.google.vision.v1p1beta1.model.Operation> {
       ...
       * @since 1.13
       */
      protected AsyncBatchAnnotate(com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest content) {
        super(Vision.this, "POST", REST_PATH, content, com.google.vision.v1p1beta1.model.Operation.class);
      }
  ...
  public class Images {
     ...
     *
     * @param content the {@link com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest}
     * @return the request
     */
    public Annotate annotate(com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest content) throws java.io.IOException {
      Annotate result = new Annotate(content);
      initialize(result);
      return result;
    }

    public class Annotate extends VisionRequest<com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse> {
       ...
       * @since 1.13
       */
      protected Annotate(com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1BatchAnnotateImagesRequest content) {
        super(Vision.this, "POST", REST_PATH, content, com.google.vision.v1p1beta1.model.GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse.class);
      }
