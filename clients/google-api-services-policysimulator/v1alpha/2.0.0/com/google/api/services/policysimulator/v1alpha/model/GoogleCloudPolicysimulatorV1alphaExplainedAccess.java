...
public final class GoogleCloudPolicysimulatorV1alphaExplainedAccess extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudPolicysimulatorV1alphaExplainedPolicy> policies;
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedAccess setAccessState(java.lang.String accessState) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedAccess setErrors(java.util.List<GoogleRpcStatus> errors) {
    this.errors = errors;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudPolicysimulatorV1alphaExplainedPolicy> getPolicies() {
    return policies;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedAccess setPolicies(java.util.List<GoogleCloudPolicysimulatorV1alphaExplainedPolicy> policies) {
    this.policies = policies;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaExplainedAccess set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1alphaExplainedAccess) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaExplainedAccess clone() {
    return (GoogleCloudPolicysimulatorV1alphaExplainedAccess) super.clone();
  }
