...
public class Fitness extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.10 of the Fitness API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Users {
    ...
    public class DataSources {
       ...
       *
       * A data source is a unique source of sensor data. Data sources can expose raw data coming from
       ...
       * data source.
       *
       * Data sources are identified using a string generated by the server, based on the contents of the
       * source being created. The dataStreamId field should not be set when invoking this method. It will
       * be automatically generated by the server with the correct format. If a dataStreamId is set, it
       * must match the format that the server would generate. This format is a combination of some fields
       * from the data source, and has a specific order. If it doesn't match, the request will fail with
       * an error.
       *
       * Specifying a DataType which is not a known type (beginning with "com.google.") will create a
       * DataSource with a custom data type. Custom data types are only readable by the application that
       * created them. Custom data types are deprecated; use standard data types instead.
       *
       * In addition to the data source fields included in the data source ID, the developer project
      ...
      public class Create extends FitnessRequest<com.google.api.services.fitness.model.DataSource> {
         ...
         * data source.
         *
         * Data sources are identified using a string generated by the server, based on the contents of
         * the source being created. The dataStreamId field should not be set when invoking this method.
         * It will be automatically generated by the server with the correct format. If a dataStreamId is
         * set, it must match the format that the server would generate. This format is a combination of
         * some fields from the data source, and has a specific order. If it doesn't match, the request
