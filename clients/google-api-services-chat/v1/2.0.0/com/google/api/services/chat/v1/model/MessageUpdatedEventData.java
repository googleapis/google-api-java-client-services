...
public final class MessageUpdatedEventData extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public MessageUpdatedEventData set(String fieldName, Object value) {
    return (MessageUpdatedEventData) super.set(fieldName, value);
  }

  @Override
  public MessageUpdatedEventData clone() {
    return (MessageUpdatedEventData) super.clone();
  }
