...
public final class GitSourceRepository extends com.google.api.client.json.GenericJson {
   ...
   */
  public GitSourceRepository setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public GitSourceRepository set(String fieldName, Object value) {
    return (GitSourceRepository) super.set(fieldName, value);
  }

  @Override
  public GitSourceRepository clone() {
    return (GitSourceRepository) super.clone();
  }
