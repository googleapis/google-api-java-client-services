...
public final class GoogleCloudTalentV4CompensationInfoCompensationEntry extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setAmount(Money amount) {
    this.amount = amount;
    return this;
  }
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setExpectedUnitsPerYear(java.lang.Double expectedUnitsPerYear) {
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setRange(GoogleCloudTalentV4CompensationInfoCompensationRange range) {
    this.range = range;
    return this;
  }
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setType(java.lang.String type) {
    this.type = type;
    return this;
  }
   ...
   */
  public GoogleCloudTalentV4CompensationInfoCompensationEntry setUnit(java.lang.String unit) {
    this.unit = unit;
    return this;
  }

  @Override
  public GoogleCloudTalentV4CompensationInfoCompensationEntry set(String fieldName, Object value) {
    return (GoogleCloudTalentV4CompensationInfoCompensationEntry) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudTalentV4CompensationInfoCompensationEntry clone() {
