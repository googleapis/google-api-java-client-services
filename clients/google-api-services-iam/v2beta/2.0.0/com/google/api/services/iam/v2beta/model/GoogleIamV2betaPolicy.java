...
public final class GoogleIamV2betaPolicy extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleIamV2betaPolicyRule> rules;
   ...
   */
  public GoogleIamV2betaPolicy setAnnotations(java.util.Map<String, java.lang.String> annotations) {
   ...
   */
  public GoogleIamV2betaPolicy setCreateTime(String createTime) {
   ...
   */
  public GoogleIamV2betaPolicy setDeleteTime(String deleteTime) {
   ...
   */
  public GoogleIamV2betaPolicy setDisplayName(java.lang.String displayName) {
   ...
   */
  public GoogleIamV2betaPolicy setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public GoogleIamV2betaPolicy setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleIamV2betaPolicyRule> getRules() {
    return rules;
  }
   ...
   */
  public GoogleIamV2betaPolicy setRules(java.util.List<GoogleIamV2betaPolicyRule> rules) {
    this.rules = rules;
    return this;
  }
   ...
   */
  public GoogleIamV2betaPolicy setUid(java.lang.String uid) {
    this.uid = uid;
    return this;
  }
   ...
   */
  public GoogleIamV2betaPolicy setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public GoogleIamV2betaPolicy set(String fieldName, Object value) {
    return (GoogleIamV2betaPolicy) super.set(fieldName, value);
  }

  @Override
  public GoogleIamV2betaPolicy clone() {
    return (GoogleIamV2betaPolicy) super.clone();
  }
