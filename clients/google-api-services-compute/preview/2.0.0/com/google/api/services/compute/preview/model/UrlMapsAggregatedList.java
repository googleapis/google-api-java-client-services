...
public final class UrlMapsAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, UrlMapsScopedList> items;
   ...
   */
  public UrlMapsAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, UrlMapsScopedList> getItems() {
    return items;
  }
   ...
   */
  public UrlMapsAggregatedList setItems(java.util.Map<String, UrlMapsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public UrlMapsAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public UrlMapsAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public UrlMapsAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public UrlMapsAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public UrlMapsAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public UrlMapsAggregatedList set(String fieldName, Object value) {
    return (UrlMapsAggregatedList) super.set(fieldName, value);
  }

  @Override
  public UrlMapsAggregatedList clone() {
    return (UrlMapsAggregatedList) super.clone();
  }
