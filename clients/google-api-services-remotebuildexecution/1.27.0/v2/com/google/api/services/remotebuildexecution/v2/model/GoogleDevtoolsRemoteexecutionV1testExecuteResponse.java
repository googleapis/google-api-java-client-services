...
public final class GoogleDevtoolsRemoteexecutionV1testExecuteResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleDevtoolsRemoteexecutionV1testActionResult result;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, GoogleDevtoolsRemoteexecutionV1testLogFile> serverLogs;
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse setCachedResult(java.lang.Boolean cachedResult) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleDevtoolsRemoteexecutionV1testActionResult getResult() {
    return result;
  }
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse setResult(GoogleDevtoolsRemoteexecutionV1testActionResult result) {
    this.result = result;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, GoogleDevtoolsRemoteexecutionV1testLogFile> getServerLogs() {
    return serverLogs;
  }
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse setServerLogs(java.util.Map<String, GoogleDevtoolsRemoteexecutionV1testLogFile> serverLogs) {
   ...
   */
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse setStatus(GoogleRpcStatus status) {
    this.status = status;
    return this;
  }

  @Override
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse set(String fieldName, Object value) {
    return (GoogleDevtoolsRemoteexecutionV1testExecuteResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleDevtoolsRemoteexecutionV1testExecuteResponse clone() {
    return (GoogleDevtoolsRemoteexecutionV1testExecuteResponse) super.clone();
  }
