# Stackdriver Error Reporting API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1beta1-rev20190411-1.30.1</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-clouderrorreporting:v1beta1-rev20190411-1.30.1'
}
```
