...
public final class CreateTaskRequest extends com.google.api.client.json.GenericJson {
   ...
   * deleted or executed. If the task's queue was created using queue.yaml or queue.xml, then
   * another task with the same name can't be created for ~9 days after the original task was
   * deleted or executed. Because there is an extra lookup cost to identify duplicate task names,
