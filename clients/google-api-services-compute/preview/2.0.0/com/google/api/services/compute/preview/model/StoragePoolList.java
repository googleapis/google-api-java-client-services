...
public final class StoragePoolList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<StoragePool> items;

  static {
    // hack to force ProGuard to consider StoragePool used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(StoragePool.class);
  }
   ...
   */
  public StoragePoolList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public StoragePoolList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<StoragePool> getItems() {
    return items;
  }
   ...
   */
  public StoragePoolList setItems(java.util.List<StoragePool> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public StoragePoolList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public StoragePoolList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolList set(String fieldName, Object value) {
    return (StoragePoolList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolList clone() {
    return (StoragePoolList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolListWarningData.
     */
