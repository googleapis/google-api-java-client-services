...
public final class BooleanConstraint extends com.google.api.client.json.GenericJson {

  @Override
  public BooleanConstraint set(String fieldName, Object value) {
    return (BooleanConstraint) super.set(fieldName, value);
  }

  @Override
  public BooleanConstraint clone() {
    return (BooleanConstraint) super.clone();
  }
