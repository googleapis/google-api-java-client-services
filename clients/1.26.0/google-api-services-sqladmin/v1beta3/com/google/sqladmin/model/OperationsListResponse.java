...
public final class OperationsListResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<InstanceOperation> items;

  static {
    // hack to force ProGuard to consider InstanceOperation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InstanceOperation.class);
  }
   ...
   */
  public java.util.List<InstanceOperation> getItems() {
    return items;
  }
   ...
   */
  public OperationsListResponse setItems(java.util.List<InstanceOperation> items) {
    this.items = items;
    return this;
  }
