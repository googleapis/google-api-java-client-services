...
public final class NotificationEndpointAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, NotificationEndpointsScopedList> items;
   ...
   */
  public NotificationEndpointAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NotificationEndpointsScopedList> getItems() {
    return items;
  }
   ...
   */
  public NotificationEndpointAggregatedList setItems(java.util.Map<String, NotificationEndpointsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NotificationEndpointAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NotificationEndpointAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NotificationEndpointAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NotificationEndpointAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NotificationEndpointAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NotificationEndpointAggregatedList set(String fieldName, Object value) {
    return (NotificationEndpointAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NotificationEndpointAggregatedList clone() {
    return (NotificationEndpointAggregatedList) super.clone();
  }
