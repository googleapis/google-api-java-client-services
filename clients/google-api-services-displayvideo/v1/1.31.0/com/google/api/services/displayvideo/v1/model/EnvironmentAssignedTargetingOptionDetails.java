...
public final class EnvironmentAssignedTargetingOptionDetails extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_ENVIRONMENT`
   * (e.g., "508010" for targeting the `ENVIRONMENT_WEB_OPTIMIZED` option).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public EnvironmentAssignedTargetingOptionDetails setTargetingOptionId(java.lang.String targetingOptionId) {
