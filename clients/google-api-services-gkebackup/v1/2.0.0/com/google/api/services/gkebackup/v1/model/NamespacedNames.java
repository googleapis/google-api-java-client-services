...
public final class NamespacedNames extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NamespacedName> namespacedNames;

  static {
    // hack to force ProGuard to consider NamespacedName used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NamespacedName.class);
  }
  ...
  @Override
  public NamespacedNames set(String fieldName, Object value) {
    return (NamespacedNames) super.set(fieldName, value);
  }

  @Override
  public NamespacedNames clone() {
    return (NamespacedNames) super.clone();
  }
