    ...
    public class Locations {
      ...
      public class Queues {
        ...
        public class Tasks {
           ...
           * @param content the {@link com.google.api.services.cloudtasks.v2.model.BatchCreateTasksRequest}
           * @return the request
           */
          public BatchCreate batchCreate(java.lang.String parent, com.google.api.services.cloudtasks.v2.model.BatchCreateTasksRequest content) throws java.io.IOException {
            BatchCreate result = new BatchCreate(parent, content);
            initialize(result);
            return result;
          }

          public class BatchCreate extends CloudTasksRequest<com.google.api.services.cloudtasks.v2.model.Operation> {

            private static final String REST_PATH = "v2/{+parent}/tasks:batchCreate";
           ...
           *        The queue must already exist.
             ...
             * @since 1.13
             */
            protected BatchCreate(java.lang.String parent, com.google.api.services.cloudtasks.v2.model.BatchCreateTasksRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.api.services.cloudtasks.v2.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
           * @param content the {@link com.google.api.services.cloudtasks.v2.model.BatchDeleteTasksRequest}
           * @return the request
           */
          public BatchDelete batchDelete(java.lang.String parent, com.google.api.services.cloudtasks.v2.model.BatchDeleteTasksRequest content) throws java.io.IOException {
            BatchDelete result = new BatchDelete(parent, content);
            initialize(result);
            return result;
          }

          public class BatchDelete extends CloudTasksRequest<com.google.api.services.cloudtasks.v2.model.Operation> {

            private static final String REST_PATH = "v2/{+parent}/tasks:batchDelete";
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
             ...
             * @since 1.13
             */
            protected BatchDelete(java.lang.String parent, com.google.api.services.cloudtasks.v2.model.BatchDeleteTasksRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.api.services.cloudtasks.v2.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
