...
public final class GoogleCloudDataplexV1ListAssetsResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDataplexV1Asset> assets;

  static {
    // hack to force ProGuard to consider GoogleCloudDataplexV1Asset used, since otherwise it would be stripped out
   ...
   */
  public GoogleCloudDataplexV1ListAssetsResponse setAssets(java.util.List<GoogleCloudDataplexV1Asset> assets) {
    this.assets = assets;
    return this;
  }
