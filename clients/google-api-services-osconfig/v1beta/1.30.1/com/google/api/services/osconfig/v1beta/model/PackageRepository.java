...
public final class PackageRepository extends com.google.api.client.json.GenericJson {
   ...
   */
  public PackageRepository setApt(AptRepository apt) {
    this.apt = apt;
    return this;
  }
   ...
   */
  public PackageRepository setGoo(GooRepository goo) {
    this.goo = goo;
    return this;
  }
   ...
   */
  public PackageRepository setYum(YumRepository yum) {
    this.yum = yum;
    return this;
  }
   ...
   */
  public PackageRepository setZypper(ZypperRepository zypper) {
    this.zypper = zypper;
    return this;
  }

  @Override
  public PackageRepository set(String fieldName, Object value) {
    return (PackageRepository) super.set(fieldName, value);
  }
