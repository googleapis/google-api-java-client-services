...
public final class GoogleCloudPolicysimulatorV1alphaExplainedPolicy extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudPolicysimulatorV1alphaBindingExplanation> bindingExplanations;

  static {
    // hack to force ProGuard to consider GoogleCloudPolicysimulatorV1alphaBindingExplanation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudPolicysimulatorV1alphaBindingExplanation.class);
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy setAccess(java.lang.String access) {
    this.access = access;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudPolicysimulatorV1alphaBindingExplanation> getBindingExplanations() {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy setBindingExplanations(java.util.List<GoogleCloudPolicysimulatorV1alphaBindingExplanation> bindingExplanations) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy setFullResourceName(java.lang.String fullResourceName) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy setPolicy(GoogleIamV1Policy policy) {
    this.policy = policy;
    return this;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy setRelevance(java.lang.String relevance) {
    this.relevance = relevance;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1alphaExplainedPolicy) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaExplainedPolicy clone() {
    return (GoogleCloudPolicysimulatorV1alphaExplainedPolicy) super.clone();
  }
