  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Catalogs {
        ...
        public class CompleteQuery extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompleteQueryResponse> {
         ...
         *        `projects/locations/global/catalogs/default_catalog`.
          ...
          protected CompleteQuery(java.lang.String catalog) {
            super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompleteQueryResponse.class);
        ...
        public class GetCompletionConfig extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig> {
         ...
         *        projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/completionConfig
          ...
          protected GetCompletionConfig(java.lang.String name) {
            super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
          ...
          /**
           * Required. Full CompletionConfig resource name. Format: projects/{project_number}/locati
           * ons/{location_id}/catalogs/{catalog_id}/completionConfig
           */
          @com.google.api.client.util.Key
          private java.lang.String name;
        ...
        public class GetDefaultBranch extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaGetDefaultBranchResponse> {
          ...
          protected GetDefaultBranch(java.lang.String catalog) {
            super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaGetDefaultBranchResponse.class);
            this.catalog = com.google.api.client.util.Preconditions.checkNotNull(catalog, "Required parameter catalog must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(CATALOG_PATTERN.matcher(catalog).matches(),
                  "Parameter catalog must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetDefaultBranchRequest}
         * @return the request
         */
        public SetDefaultBranch setDefaultBranch(java.lang.String catalog, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetDefaultBranchRequest content) throws java.io.IOException {
          SetDefaultBranch result = new SetDefaultBranch(catalog, content);
          initialize(result);
          return result;
        }

        public class SetDefaultBranch extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleProtobufEmpty> {
           ...
           * @since 1.13
           */
          protected SetDefaultBranch(java.lang.String catalog, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetDefaultBranchRequest content) {
            super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleProtobufEmpty.class);
            this.catalog = com.google.api.client.util.Preconditions.checkNotNull(catalog, "Required parameter catalog must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(CATALOG_PATTERN.matcher(catalog).matches(),
                  "Parameter catalog must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig}
         * @return the request
         */
        public UpdateCompletionConfig updateCompletionConfig(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig content) throws java.io.IOException {
          UpdateCompletionConfig result = new UpdateCompletionConfig(name, content);
          initialize(result);
          return result;
        }

        public class UpdateCompletionConfig extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig> {
           ...
           * @since 1.13
           */
          protected UpdateCompletionConfig(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig content) {
            super(CloudRetail.this, "PATCH", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaCompletionConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Branches {
          ...
          public class Products {
             ...
             *        is returned.
             * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddFulfillmentPlacesRequest}
             * @return the request
             */
            public AddFulfillmentPlaces addFulfillmentPlaces(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddFulfillmentPlacesRequest content) throws java.io.IOException {
              AddFulfillmentPlaces result = new AddFulfillmentPlaces(product, content);
              initialize(result);
              return result;
            }

            public class AddFulfillmentPlaces extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation> {
             ...
             *        is returned.
               ...
               * @since 1.13
               */
              protected AddFulfillmentPlaces(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddFulfillmentPlacesRequest content) {
             ...
             *        to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error
             *        is returned.
             * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddLocalInventoriesRequest}
             * @return the request
             */
            public AddLocalInventories addLocalInventories(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddLocalInventoriesRequest content) throws java.io.IOException {
              AddLocalInventories result = new AddLocalInventories(product, content);
              initialize(result);
              return result;
            }

            public class AddLocalInventories extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation> {
             ...
             *        is returned.
               ...
               * @since 1.13
               */
              protected AddLocalInventories(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddLocalInventoriesRequest content) {
                super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation.class);
                this.product = com.google.api.client.util.Preconditions.checkNotNull(product, "Required parameter product must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PRODUCT_PATTERN.matcher(product).matches(),
            ...
            public class List extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListProductsResponse> {
             ...
             *        exists, a PERMISSION_DENIED error is returned.
               ...
               */
              protected List(java.lang.String parent) {
                super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListProductsResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
             ...
             *        to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error
             *        is returned.
             * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveFulfillmentPlacesRequest}
             * @return the request
             */
            public RemoveFulfillmentPlaces removeFulfillmentPlaces(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveFulfillmentPlacesRequest content) throws java.io.IOException {
              RemoveFulfillmentPlaces result = new RemoveFulfillmentPlaces(product, content);
              initialize(result);
              return result;
            }

            public class RemoveFulfillmentPlaces extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation> {
             ...
             *        is returned.
               ...
               * @since 1.13
               */
              protected RemoveFulfillmentPlaces(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveFulfillmentPlacesRequest content) {
                super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation.class);
                this.product = com.google.api.client.util.Preconditions.checkNotNull(product, "Required parameter product must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PRODUCT_PATTERN.matcher(product).matches(),
             ...
             *        to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error
             *        is returned.
             * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveLocalInventoriesRequest}
             * @return the request
             */
            public RemoveLocalInventories removeLocalInventories(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveLocalInventoriesRequest content) throws java.io.IOException {
              RemoveLocalInventories result = new RemoveLocalInventories(product, content);
              initialize(result);
              return result;
            }

            public class RemoveLocalInventories extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation> {
             ...
             *        is returned.
               ...
               * @since 1.13
               */
              protected RemoveLocalInventories(java.lang.String product, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveLocalInventoriesRequest content) {
                super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation.class);
                this.product = com.google.api.client.util.Preconditions.checkNotNull(product, "Required parameter product must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PRODUCT_PATTERN.matcher(product).matches(),
             ...
             *        `projects/locations/global/catalogs/default_catalog/branches/default_branch/products/produ
             *        ct_id`.
             * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetInventoryRequest}
             * @return the request
             */
            public SetInventory setInventory(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetInventoryRequest content) throws java.io.IOException {
              SetInventory result = new SetInventory(name, content);
              initialize(result);
              return result;
            }

            public class SetInventory extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation> {
             ...
             *        ct_id`.
               ...
               * @since 1.13
               */
              protected SetInventory(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSetInventoryRequest content) {
                super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class CompletionData {
           ...
           * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaImportCompletionDataRequest}
           * @return the request
           */
          public CloudRetailImport retailImport(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaImportCompletionDataRequest content) throws java.io.IOException {
            CloudRetailImport result = new CloudRetailImport(parent, content);
            initialize(result);
            return result;
          }
           ...
           *        `projects/1234/locations/global/catalogs/default_catalog`.
             ...
             * @since 1.13
             */
            protected CloudRetailImport(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaImportCompletionDataRequest content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleLongrunningOperation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Controls {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl> {
           ...
           *        projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
          ...
          public class Get extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl> {
           ...
           *        id}
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListControlsResponse> {
           ...
           *        projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListControlsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }

          public class Patch extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl> {
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl content) {
              super(CloudRetail.this, "PATCH", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaControl.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
        ...
        public class Placements {
           ...
           *        https://console.cloud.google.com/ai/retail/catalogs/default_catalog/configs
             ...
             * {name=projects/locations/global/catalogs/default_catalog/servingConfigs} or
             * {name=projects/locations/global/catalogs/default_catalog/placements}. We recommend
           ...
           * @return the request
           */
          public Search search(java.lang.String placement, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSearchRequest content) throws java.io.IOException {
            Search result = new Search(placement, content);
            initialize(result);
            return result;
          }

          public class Search extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSearchResponse> {
           ...
           *        to make the search.
             ...
             * @since 1.13
             */
            protected Search(java.lang.String placement, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSearchRequest content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaSearchResponse.class);
              this.placement = com.google.api.client.util.Preconditions.checkNotNull(placement, "Required parameter placement must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PLACEMENT_PATTERN.matcher(placement).matches(),
                    "Parameter placement must conform to the pattern " +
        ...
        public class ServingConfigs {
           ...
           * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddControlRequest}
           * @return the request
           */
          public AddControl addControl(java.lang.String servingConfig, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddControlRequest content) throws java.io.IOException {
            AddControl result = new AddControl(servingConfig, content);
            initialize(result);
            return result;
          }

          public class AddControl extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig> {
           ...
           *        tion_id}/catalogs/{catalog_id}/servingConfigs/{serving_config_id}
             ...
             * @since 1.13
             */
            protected AddControl(java.lang.String servingConfig, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaAddControlRequest content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig.class);
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig> {
           ...
           *        projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig> {
           ...
           *        /{location_id}/catalogs/{catalog_id}/servingConfigs/{serving_config_id}
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListServingConfigsResponse> {
           ...
           *        projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaListServingConfigsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }

          public class Patch extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig> {
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig content) {
              super(CloudRetail.this, "PATCH", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           * @param servingConfig Required. The source ServingConfig resource name . Format: projects/{project_number}/locations/{loca
           *        tion_id}/catalogs/{catalog_id}/servingConfigs/{serving_config_id}
           * @param content the {@link com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveControlRequest}
           * @return the request
           */
          public RemoveControl removeControl(java.lang.String servingConfig, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveControlRequest content) throws java.io.IOException {
            RemoveControl result = new RemoveControl(servingConfig, content);
            initialize(result);
            return result;
          }

          public class RemoveControl extends CloudRetailRequest<com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig> {
           ...
           *        tion_id}/catalogs/{catalog_id}/servingConfigs/{serving_config_id}
             ...
             * @since 1.13
             */
            protected RemoveControl(java.lang.String servingConfig, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaRemoveControlRequest content) {
              super(CloudRetail.this, "POST", REST_PATH, content, com.google.api.services.retail.v2beta.model.GoogleCloudRetailV2betaServingConfig.class);
              this.servingConfig = com.google.api.client.util.Preconditions.checkNotNull(servingConfig, "Required parameter servingConfig must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SERVING_CONFIG_PATTERN.matcher(servingConfig).matches(),
