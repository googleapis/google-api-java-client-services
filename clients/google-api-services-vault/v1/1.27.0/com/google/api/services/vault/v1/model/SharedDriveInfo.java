...
public final class SharedDriveInfo extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public SharedDriveInfo set(String fieldName, Object value) {
    return (SharedDriveInfo) super.set(fieldName, value);
  }

  @Override
  public SharedDriveInfo clone() {
    return (SharedDriveInfo) super.clone();
  }
