...
public final class NetworkEndpointGroupList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NetworkEndpointGroup> items;

  static {
    // hack to force ProGuard to consider NetworkEndpointGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkEndpointGroup.class);
  }

  /**
   * [Output Only] The resource type, which is alwayscompute#networkEndpointGroupList for network
   ...
   */
  public NetworkEndpointGroupList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkEndpointGroup> getItems() {
    return items;
  }
   ...
   */
  public NetworkEndpointGroupList setItems(java.util.List<NetworkEndpointGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkEndpointGroupList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkEndpointGroupList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkEndpointGroupList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkEndpointGroupList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkEndpointGroupList set(String fieldName, Object value) {
    return (NetworkEndpointGroupList) super.set(fieldName, value);
  }

  @Override
  public NetworkEndpointGroupList clone() {
    return (NetworkEndpointGroupList) super.clone();
  }
