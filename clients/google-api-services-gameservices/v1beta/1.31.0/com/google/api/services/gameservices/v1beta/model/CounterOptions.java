 ...
 * correspond to IAM request parameters and field values are their respective values. Supported
 * field names: - "authority", which is "[token]" if IAMContext.token is present, otherwise the
 * value of IAMContext.authority_selector if present, and otherwise a representation of
 * IAMContext.principal; or - "iam_principal", a representation of IAMContext.principal even if a
 * token or authority selector is present; or - "" (empty string), resulting in a counter with no
 * fields. Examples: counter { metric: "/debug_access_count" field: "iam_principal" } ==> increment
...
public final class CounterOptions extends com.google.api.client.json.GenericJson {
   ...
   */
  public CounterOptions setField(java.lang.String field) {
    this.field = field;
    return this;
  }
   ...
   */
  public CounterOptions setMetric(java.lang.String metric) {
    this.metric = metric;
    return this;
  }

  @Override
  public CounterOptions set(String fieldName, Object value) {
    return (CounterOptions) super.set(fieldName, value);
  }
