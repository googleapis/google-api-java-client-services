...
public final class GoogleChromePolicyV1ListGroupPriorityOrderingResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleChromePolicyV1ListGroupPriorityOrderingResponse setGroupIds(java.util.List<java.lang.String> groupIds) {
   ...
   */
  public GoogleChromePolicyV1ListGroupPriorityOrderingResponse setPolicyNamespace(java.lang.String policyNamespace) {
   ...
   */
  public GoogleChromePolicyV1ListGroupPriorityOrderingResponse setPolicyTargetKey(GoogleChromePolicyV1PolicyTargetKey policyTargetKey) {
    this.policyTargetKey = policyTargetKey;
    return this;
  }

  @Override
  public GoogleChromePolicyV1ListGroupPriorityOrderingResponse set(String fieldName, Object value) {
    return (GoogleChromePolicyV1ListGroupPriorityOrderingResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyV1ListGroupPriorityOrderingResponse clone() {
    return (GoogleChromePolicyV1ListGroupPriorityOrderingResponse) super.clone();
  }
