...
public final class GoogleChromePolicyV1NetworkSetting extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleChromePolicyV1NetworkSetting setPolicySchema(java.lang.String policySchema) {
   ...
   */
  public GoogleChromePolicyV1NetworkSetting setValue(java.util.Map<String, java.lang.Object> value) {
    this.value = value;
    return this;
  }

  @Override
  public GoogleChromePolicyV1NetworkSetting set(String fieldName, Object value) {
    return (GoogleChromePolicyV1NetworkSetting) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyV1NetworkSetting clone() {
    return (GoogleChromePolicyV1NetworkSetting) super.clone();
  }
