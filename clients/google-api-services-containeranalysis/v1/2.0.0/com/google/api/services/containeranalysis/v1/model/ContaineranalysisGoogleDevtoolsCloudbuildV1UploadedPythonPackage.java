...
public final class ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage extends com.google.api.client.json.GenericJson {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage setFileHashes(ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes fileHashes) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage setPushTiming(ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan pushTiming) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage setUri(java.lang.String uri) {
    this.uri = uri;
    return this;
  }

  @Override
  public ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage set(String fieldName, Object value) {
    return (ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage) super.set(fieldName, value);
  }

  @Override
  public ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage clone() {
    return (ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage) super.clone();
  }
