...
public final class DataPart extends com.google.api.client.json.GenericJson {
   ...
   */
  public DataPart setData(java.util.Map<String, java.lang.Object> data) {
    this.data = data;
    return this;
  }

  @Override
  public DataPart set(String fieldName, Object value) {
    return (DataPart) super.set(fieldName, value);
  }

  @Override
  public DataPart clone() {
    return (DataPart) super.clone();
  }
