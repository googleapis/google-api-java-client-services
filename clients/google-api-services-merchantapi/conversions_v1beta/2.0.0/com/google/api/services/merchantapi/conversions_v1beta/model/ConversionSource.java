...
public final class ConversionSource extends com.google.api.client.json.GenericJson {
   ...
   * `ConversionSource`. Format: [a-z]{4}:.+ The four characters before the colon represent the type
   * of conversio source. Content after the colon represents the ID of the conversion source within
   * that type. The ID of two different conversion sources might be the same across different types.
   * The following type prefixes are supported: - galk: For GoogleAnalyticsLink sources. - mcdn: For
