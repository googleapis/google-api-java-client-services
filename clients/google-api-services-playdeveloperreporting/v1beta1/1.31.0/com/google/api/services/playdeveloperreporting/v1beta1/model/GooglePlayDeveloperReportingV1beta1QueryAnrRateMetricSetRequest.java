...
public final class GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest setDimensions(java.util.List<java.lang.String> dimensions) {
   ...
   */
  public GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
  ...
  @Override
  public GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest clone() {
    return (GooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest) super.clone();
  }
