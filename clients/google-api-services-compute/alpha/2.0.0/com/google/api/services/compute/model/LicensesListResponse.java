...
public final class LicensesListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<License> items;
   ...
   */
  public LicensesListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<License> getItems() {
    return items;
  }
   ...
   */
  public LicensesListResponse setItems(java.util.List<License> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public LicensesListResponse setNextPageToken(java.lang.String nextPageToken) {
  ...
  @Override
  public LicensesListResponse set(String fieldName, Object value) {
    return (LicensesListResponse) super.set(fieldName, value);
  }

  @Override
  public LicensesListResponse clone() {
