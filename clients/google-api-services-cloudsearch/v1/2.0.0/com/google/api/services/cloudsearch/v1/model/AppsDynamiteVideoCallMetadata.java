...
/**
 * Model definition for AppsDynamiteVideoCallMetadata.
 *
...
public final class AppsDynamiteVideoCallMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public AppsDynamiteVideoCallMetadata setMeetingSpace(MeetingSpace meetingSpace) {
   ...
   */
  public AppsDynamiteVideoCallMetadata setShouldNotRender(java.lang.Boolean shouldNotRender) {
   ...
   */
  public AppsDynamiteVideoCallMetadata setWasCreatedInCurrentGroup(java.lang.Boolean wasCreatedInCurrentGroup) {
    this.wasCreatedInCurrentGroup = wasCreatedInCurrentGroup;
    return this;
  }

  @Override
  public AppsDynamiteVideoCallMetadata set(String fieldName, Object value) {
    return (AppsDynamiteVideoCallMetadata) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteVideoCallMetadata clone() {
    return (AppsDynamiteVideoCallMetadata) super.clone();
  }
