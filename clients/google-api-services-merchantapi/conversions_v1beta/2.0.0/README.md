...
<project>
  <dependencies>
    <dependency>
      ...
      <version>conversions_v1beta-rev20241101-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:conversions_v1beta-rev20241101-2.0.0'
}
```
