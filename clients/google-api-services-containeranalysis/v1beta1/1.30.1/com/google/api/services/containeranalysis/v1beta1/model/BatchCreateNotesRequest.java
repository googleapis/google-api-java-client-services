...
public final class BatchCreateNotesRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public BatchCreateNotesRequest set(String fieldName, Object value) {
    return (BatchCreateNotesRequest) super.set(fieldName, value);
  }

  @Override
  public BatchCreateNotesRequest clone() {
    return (BatchCreateNotesRequest) super.clone();
  }
