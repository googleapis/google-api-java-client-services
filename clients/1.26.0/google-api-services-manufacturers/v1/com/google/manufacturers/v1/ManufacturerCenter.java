...
public class ManufacturerCenter extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Manufacturer Center API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Accounts {
    ...
    public class Products {
      ...
      public class Delete extends ManufacturerCenterRequest<com.google.manufacturers.v1.model.Empty> {
       ...
       *        https://support.google.com/manufacturers/answer/6124116#id.
        ...
        protected Delete(java.lang.String parent, java.lang.String name) {
          super(ManufacturerCenter.this, "DELETE", REST_PATH, null, com.google.manufacturers.v1.model.Empty.class);
      ...
      public class Get extends ManufacturerCenterRequest<com.google.manufacturers.v1.model.Product> {
       ...
       *        https://support.google.com/manufacturers/answer/6124116#id.
        ...
        protected Get(java.lang.String parent, java.lang.String name) {
          super(ManufacturerCenter.this, "GET", REST_PATH, null, com.google.manufacturers.v1.model.Product.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class List extends ManufacturerCenterRequest<com.google.manufacturers.v1.model.ListProductsResponse> {
       ...
       *        account.
        ...
        protected List(java.lang.String parent) {
          super(ManufacturerCenter.this, "GET", REST_PATH, null, com.google.manufacturers.v1.model.ListProductsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *        more information, see
       *        https://support.google.com/manufacturers/answer/6124116#id.
       * @param content the {@link com.google.manufacturers.v1.model.Attributes}
       * @return the request
       */
      public Update update(java.lang.String parent, java.lang.String name, com.google.manufacturers.v1.model.Attributes content) throws java.io.IOException {
        Update result = new Update(parent, name, content);
        initialize(result);
        return result;
      }

      public class Update extends ManufacturerCenterRequest<com.google.manufacturers.v1.model.Empty> {
       ...
       *        https://support.google.com/manufacturers/answer/6124116#id.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String parent, java.lang.String name, com.google.manufacturers.v1.model.Attributes content) {
          super(ManufacturerCenter.this, "PUT", REST_PATH, content, com.google.manufacturers.v1.model.Empty.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
