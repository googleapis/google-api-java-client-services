...
public final class GoogleCloudContactcenterinsightsV1alpha1QaScorecardResult extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaAnswer> qaAnswers;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultQaTagResult> qaTagResults;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultScoreSource> scoreSources;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaAnswer> getQaAnswers() {
    return qaAnswers;
  }
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1QaScorecardResult setQaAnswers(java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaAnswer> qaAnswers) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultQaTagResult> getQaTagResults() {
    return qaTagResults;
  }
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1QaScorecardResult setQaTagResults(java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultQaTagResult> qaTagResults) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultScoreSource> getScoreSources() {
    return scoreSources;
  }
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1QaScorecardResult setScoreSources(java.util.List<GoogleCloudContactcenterinsightsV1alpha1QaScorecardResultScoreSource> scoreSources) {
