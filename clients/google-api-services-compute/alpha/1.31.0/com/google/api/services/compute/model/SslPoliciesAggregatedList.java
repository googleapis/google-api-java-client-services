...
/**
 * Model definition for SslPoliciesAggregatedList.
 *
...
public final class SslPoliciesAggregatedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] Type of resource. Always compute#sslPolicyAggregatedList for lists of SSL
   * Policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public SslPoliciesAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public SslPoliciesAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, SslPoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public SslPoliciesAggregatedList setItems(java.util.Map<String, SslPoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SslPoliciesAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SslPoliciesAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SslPoliciesAggregatedList set(String fieldName, Object value) {
    return (SslPoliciesAggregatedList) super.set(fieldName, value);
  }

  @Override
  public SslPoliciesAggregatedList clone() {
    return (SslPoliciesAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for SslPoliciesAggregatedListWarningData.
     */
