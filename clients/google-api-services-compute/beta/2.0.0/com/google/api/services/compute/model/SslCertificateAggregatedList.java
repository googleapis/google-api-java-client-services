...
public final class SslCertificateAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, SslCertificatesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#sslCertificateAggregatedList for
   * lists of SSL Certificates.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public SslCertificateAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, SslCertificatesScopedList> getItems() {
    return items;
  }
   ...
   */
  public SslCertificateAggregatedList setItems(java.util.Map<String, SslCertificatesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SslCertificateAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public SslCertificateAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SslCertificateAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public SslCertificateAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public SslCertificateAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SslCertificateAggregatedList set(String fieldName, Object value) {
    return (SslCertificateAggregatedList) super.set(fieldName, value);
  }

  @Override
  public SslCertificateAggregatedList clone() {
    return (SslCertificateAggregatedList) super.clone();
  }
