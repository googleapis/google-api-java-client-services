...
public class CloudRun extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.31.0 of the Cloud Run Admin API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Namespaces {
    ...
    /**
     * An accessor for creating requests from the Cloudschedulersources collection.
     *
     * <p>The typical use is:</p>
     * <pre>
     *   {@code CloudRun run = new CloudRun(...);}
     *   {@code CloudRun.Cloudschedulersources.List request = run.cloudschedulersources().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    public Cloudschedulersources cloudschedulersources() {
      return new Cloudschedulersources();
    }

    /**
     * The "cloudschedulersources" collection of methods.
     */
    public class Cloudschedulersources {

      /**
       * Creates a new cloudschedulersource.
       *
       * Create a request for the method "cloudschedulersources.create".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudSchedulerSource> {

        private static final String REST_PATH = "apis/events.cloud.google.com/v1alpha1/{+parent}/cloudschedulersources";
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource content) {
          super(CloudRun.this, "POST", REST_PATH, content, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /**
         * Required. The project ID or project number in which this cloudschedulersource should be
         * created.
         */
        @com.google.api.client.util.Key
        private java.lang.String parent;
       ...
       *
       * Create a request for the method "cloudschedulersources.delete".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       *
       * Create a request for the method "cloudschedulersources.get".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
      ...
      public class Get extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudSchedulerSource> {
       ...
       *        with the project ID.
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudRun.this, "GET", REST_PATH, null, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *
       * Create a request for the method "cloudschedulersources.list".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
      ...
      public class List extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.ListCloudSchedulerSourcesResponse> {
         ...
         */
        protected List(java.lang.String parent) {
          super(CloudRun.this, "GET", REST_PATH, null, com.google.api.services.run.v1alpha1.model.ListCloudSchedulerSourcesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public ReplaceCloudSchedulerSource replaceCloudSchedulerSource(java.lang.String name, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource content) throws java.io.IOException {
        ReplaceCloudSchedulerSource result = new ReplaceCloudSchedulerSource(name, content);
        initialize(result);
        return result;
      }

      public class ReplaceCloudSchedulerSource extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudSchedulerSource> {
         ...
         * This request holds the parameters needed by the the run server.  After setting any optional
         * parameters, call the {@link ReplaceCloudSchedulerSource#execute()} method to invoke the remote
         * operation. <p> {@link ReplaceCloudSchedulerSource#initialize(com.google.api.client.googleapis.s
       ...
       *        with the project ID.
         ...
         * @since 1.13
         */
        protected ReplaceCloudSchedulerSource(java.lang.String name, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource content) {
          super(CloudRun.this, "PUT", REST_PATH, content, com.google.api.services.run.v1alpha1.model.CloudSchedulerSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
        ...
        @Override
        public ReplaceCloudSchedulerSource set$Xgafv(java.lang.String $Xgafv) {
          return (ReplaceCloudSchedulerSource) super.set$Xgafv($Xgafv);
        }

        @Override
        public ReplaceCloudSchedulerSource setAccessToken(java.lang.String accessToken) {
          return (ReplaceCloudSchedulerSource) super.setAccessToken(accessToken);
        }

        @Override
        public ReplaceCloudSchedulerSource setAlt(java.lang.String alt) {
          return (ReplaceCloudSchedulerSource) super.setAlt(alt);
        }

        @Override
        public ReplaceCloudSchedulerSource setCallback(java.lang.String callback) {
          return (ReplaceCloudSchedulerSource) super.setCallback(callback);
        }

        @Override
        public ReplaceCloudSchedulerSource setFields(java.lang.String fields) {
          return (ReplaceCloudSchedulerSource) super.setFields(fields);
        }

        @Override
        public ReplaceCloudSchedulerSource setKey(java.lang.String key) {
          return (ReplaceCloudSchedulerSource) super.setKey(key);
        }

        @Override
        public ReplaceCloudSchedulerSource setOauthToken(java.lang.String oauthToken) {
          return (ReplaceCloudSchedulerSource) super.setOauthToken(oauthToken);
        }

        @Override
        public ReplaceCloudSchedulerSource setPrettyPrint(java.lang.Boolean prettyPrint) {
          return (ReplaceCloudSchedulerSource) super.setPrettyPrint(prettyPrint);
        }

        @Override
        public ReplaceCloudSchedulerSource setQuotaUser(java.lang.String quotaUser) {
          return (ReplaceCloudSchedulerSource) super.setQuotaUser(quotaUser);
        }

        @Override
        public ReplaceCloudSchedulerSource setUploadType(java.lang.String uploadType) {
          return (ReplaceCloudSchedulerSource) super.setUploadType(uploadType);
        }

        @Override
        public ReplaceCloudSchedulerSource setUploadProtocol(java.lang.String uploadProtocol) {
          return (ReplaceCloudSchedulerSource) super.setUploadProtocol(uploadProtocol);
        }
       ...
       with the project ID.
         ...
         * {namespace_id} with the project ID.
         */
        public ReplaceCloudSchedulerSource setName(java.lang.String name) {
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
                "^namespaces/[^/]+/cloudschedulersources/[^/]+$");
        ...
        @Override
        public ReplaceCloudSchedulerSource set(String parameterName, Object value) {
          return (ReplaceCloudSchedulerSource) super.set(parameterName, value);
        }
      }

    }
    /**
     * An accessor for creating requests from the Cloudstoragesources collection.
     *
     * <p>The typical use is:</p>
     * <pre>
     *   {@code CloudRun run = new CloudRun(...);}
     *   {@code CloudRun.Cloudstoragesources.List request = run.cloudstoragesources().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    public Cloudstoragesources cloudstoragesources() {
      return new Cloudstoragesources();
    }

    /**
     * The "cloudstoragesources" collection of methods.
     */
    public class Cloudstoragesources {

      /**
       * Creates a new cloudstoragesource.
       *
       * Create a request for the method "cloudstoragesources.create".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.run.v1alpha1.model.CloudStorageSource content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudStorageSource> {

        private static final String REST_PATH = "apis/events.cloud.google.com/v1alpha1/{+parent}/cloudstoragesources";
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.run.v1alpha1.model.CloudStorageSource content) {
          super(CloudRun.this, "POST", REST_PATH, content, com.google.api.services.run.v1alpha1.model.CloudStorageSource.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /**
         * Required. The project ID or project number in which this cloudstoragesource should be
         * created.
         */
        @com.google.api.client.util.Key
        private java.lang.String parent;
       ...
       *
       * Create a request for the method "cloudstoragesources.delete".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       *
       * Create a request for the method "cloudstoragesources.get".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
      ...
      public class Get extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudStorageSource> {
       ...
       *        the project ID.
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudRun.this, "GET", REST_PATH, null, com.google.api.services.run.v1alpha1.model.CloudStorageSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *
       * Create a request for the method "cloudstoragesources.list".
       *
       * This request holds the parameters needed by the run server.  After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
      ...
      public class List extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.ListCloudStorageSourcesResponse> {
         ...
         */
        protected List(java.lang.String parent) {
          super(CloudRun.this, "GET", REST_PATH, null, com.google.api.services.run.v1alpha1.model.ListCloudStorageSourcesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /**
         * Required. The project ID or project number from which the cloudstoragesources should be
         * listed.
         */
        @com.google.api.client.util.Key
        private java.lang.String parent;
       ...
       * @return the request
       */
      public ReplaceCloudStorageSource replaceCloudStorageSource(java.lang.String name, com.google.api.services.run.v1alpha1.model.CloudStorageSource content) throws java.io.IOException {
        ReplaceCloudStorageSource result = new ReplaceCloudStorageSource(name, content);
        initialize(result);
        return result;
      }

      public class ReplaceCloudStorageSource extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudStorageSource> {
         ...
         * This request holds the parameters needed by the the run server.  After setting any optional
         * parameters, call the {@link ReplaceCloudStorageSource#execute()} method to invoke the remote
         * operation. <p> {@link ReplaceCloudStorageSource#initialize(com.google.api.client.googleapis.ser
       ...
       *        the project ID.
         ...
         * @since 1.13
         */
        protected ReplaceCloudStorageSource(java.lang.String name, com.google.api.services.run.v1alpha1.model.CloudStorageSource content) {
          super(CloudRun.this, "PUT", REST_PATH, content, com.google.api.services.run.v1alpha1.model.CloudStorageSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
        ...
        @Override
        public ReplaceCloudStorageSource set$Xgafv(java.lang.String $Xgafv) {
          return (ReplaceCloudStorageSource) super.set$Xgafv($Xgafv);
        }

        @Override
        public ReplaceCloudStorageSource setAccessToken(java.lang.String accessToken) {
          return (ReplaceCloudStorageSource) super.setAccessToken(accessToken);
        }

        @Override
        public ReplaceCloudStorageSource setAlt(java.lang.String alt) {
          return (ReplaceCloudStorageSource) super.setAlt(alt);
        }

        @Override
        public ReplaceCloudStorageSource setCallback(java.lang.String callback) {
          return (ReplaceCloudStorageSource) super.setCallback(callback);
        }

        @Override
        public ReplaceCloudStorageSource setFields(java.lang.String fields) {
          return (ReplaceCloudStorageSource) super.setFields(fields);
        }

        @Override
        public ReplaceCloudStorageSource setKey(java.lang.String key) {
          return (ReplaceCloudStorageSource) super.setKey(key);
        }

        @Override
        public ReplaceCloudStorageSource setOauthToken(java.lang.String oauthToken) {
          return (ReplaceCloudStorageSource) super.setOauthToken(oauthToken);
        }

        @Override
        public ReplaceCloudStorageSource setPrettyPrint(java.lang.Boolean prettyPrint) {
          return (ReplaceCloudStorageSource) super.setPrettyPrint(prettyPrint);
        }

        @Override
        public ReplaceCloudStorageSource setQuotaUser(java.lang.String quotaUser) {
          return (ReplaceCloudStorageSource) super.setQuotaUser(quotaUser);
        }

        @Override
        public ReplaceCloudStorageSource setUploadType(java.lang.String uploadType) {
          return (ReplaceCloudStorageSource) super.setUploadType(uploadType);
        }

        @Override
        public ReplaceCloudStorageSource setUploadProtocol(java.lang.String uploadProtocol) {
          return (ReplaceCloudStorageSource) super.setUploadProtocol(uploadProtocol);
        }
       ...
       with the project ID.
         ...
         * {namespace_id} with the project ID.
         */
        public ReplaceCloudStorageSource setName(java.lang.String name) {
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
                "^namespaces/[^/]+/cloudstoragesources/[^/]+$");
        ...
        @Override
        public ReplaceCloudStorageSource set(String parameterName, Object value) {
          return (ReplaceCloudStorageSource) super.set(parameterName, value);
        }
      }
    ...
    public class Locations {
      ...
      public class Cloudschedulersources {
        ...
        public class Create extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudSchedulerSource> {
          ...
          private static final String REST_PATH = "v1alpha1/{+parent}/cloudschedulersources";
        ...
        public class List extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.ListCloudSchedulerSourcesResponse> {
          ...
          /**
           * Required. The project ID or project number from which the cloudschedulersources should
           * be listed.
           */
          @com.google.api.client.util.Key
          private java.lang.String parent;
      ...
      public class Cloudstoragesources {
        ...
        public class Create extends CloudRunRequest<com.google.api.services.run.v1alpha1.model.CloudStorageSource> {
          ...
          private static final String REST_PATH = "v1alpha1/{+parent}/cloudstoragesources";
