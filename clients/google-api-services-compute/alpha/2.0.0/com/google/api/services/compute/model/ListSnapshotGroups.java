...
public final class ListSnapshotGroups extends com.google.api.client.json.GenericJson {
   ...
   */
  public ListSnapshotGroups setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ListSnapshotGroups setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<SnapshotGroup> getItems() {
    return items;
  }
   ...
   */
  public ListSnapshotGroups setItems(java.util.List<SnapshotGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ListSnapshotGroups setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ListSnapshotGroups setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ListSnapshotGroups set(String fieldName, Object value) {
    return (ListSnapshotGroups) super.set(fieldName, value);
  }

  @Override
  public ListSnapshotGroups clone() {
    return (ListSnapshotGroups) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ListSnapshotGroupsWarningData.
     */
