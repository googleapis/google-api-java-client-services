      ...
      public class Clusters {
         ...
         *        Cluster.name field.
         ...
         exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
          ...
          /**
           * Optional. If set, performs request validation (e.g. permission checks and any other
         ...
         * @param content the {@link com.google.api.services.alloydb.v1beta.model.GenerateClientCertificateRequest}
         * @return the request
         */
        public GenerateClientCertificate generateClientCertificate(java.lang.String parent, com.google.api.services.alloydb.v1beta.model.GenerateClientCertificateRequest content) throws java.io.IOException {
          GenerateClientCertificate result = new GenerateClientCertificate(parent, content);
          initialize(result);
          return result;
        }

        public class GenerateClientCertificate extends CloudAlloyDBAdminRequest<com.google.api.services.alloydb.v1beta.model.GenerateClientCertificateResponse> {

          private static final String REST_PATH = "v1beta/{+parent}:generateClientCertificate";
         ...
         *        projects/{project}/locations/{location}/clusters/{cluster}
           ...
           * @since 1.13
           */
          protected GenerateClientCertificate(java.lang.String parent, com.google.api.services.alloydb.v1beta.model.GenerateClientCertificateRequest content) {
            super(CloudAlloyDBAdmin.this, "POST", REST_PATH, content, com.google.api.services.alloydb.v1beta.model.GenerateClientCertificateResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
