...
public class Oauth2 extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google OAuth2 API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Userinfo {
    ...
    public class Get extends Oauth2Request<com.google.oauth2.model.Userinfoplus> {
       ...
       */
      protected Get() {
        super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.Userinfoplus.class);
      }
  ...
  public class GetCertForOpenIdConnect extends Oauth2Request<com.google.oauth2.model.X509> {
    ...
    protected GetCertForOpenIdConnect() {
      super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.X509.class);
    }
   ...
   *
   * This request holds the parameters needed by the oauth2 server.  After setting any optional
   * parameters, call the {@link GetCertForOpenIdConnectRaw#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public GetCertForOpenIdConnectRaw getCertForOpenIdConnectRaw() throws java.io.IOException {
    GetCertForOpenIdConnectRaw result = new GetCertForOpenIdConnectRaw();
    initialize(result);
    return result;
  }

  public class GetCertForOpenIdConnectRaw extends Oauth2Request<com.google.oauth2.model.Raw> {
     ...
     * This request holds the parameters needed by the the oauth2 server.  After setting any optional
     * parameters, call the {@link GetCertForOpenIdConnectRaw#execute()} method to invoke the remote
     * operation. <p> {@link GetCertForOpenIdConnectRaw#initialize(com.google.api.client.googleapis.se
    ...
    protected GetCertForOpenIdConnectRaw() {
      super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.Raw.class);
    }
    ...
    @Override
    public GetCertForOpenIdConnectRaw setAlt(java.lang.String alt) {
      return (GetCertForOpenIdConnectRaw) super.setAlt(alt);
    }

    @Override
    public GetCertForOpenIdConnectRaw setFields(java.lang.String fields) {
      return (GetCertForOpenIdConnectRaw) super.setFields(fields);
    }

    @Override
    public GetCertForOpenIdConnectRaw setKey(java.lang.String key) {
      return (GetCertForOpenIdConnectRaw) super.setKey(key);
    }

    @Override
    public GetCertForOpenIdConnectRaw setOauthToken(java.lang.String oauthToken) {
      return (GetCertForOpenIdConnectRaw) super.setOauthToken(oauthToken);
    }

    @Override
    public GetCertForOpenIdConnectRaw setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetCertForOpenIdConnectRaw) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetCertForOpenIdConnectRaw setQuotaUser(java.lang.String quotaUser) {
      return (GetCertForOpenIdConnectRaw) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetCertForOpenIdConnectRaw setUserIp(java.lang.String userIp) {
   ...
   *
   * This request holds the parameters needed by the oauth2 server.  After setting any optional
   * parameters, call the {@link GetRobotJwk#execute()} method to invoke the remote operation.
   *
   * @param robotEmail The email of robot account.
   * @return the request
   */
  public GetRobotJwk getRobotJwk(java.lang.String robotEmail) throws java.io.IOException {
    GetRobotJwk result = new GetRobotJwk(robotEmail);
    initialize(result);
    return result;
  }

  public class GetRobotJwk extends Oauth2Request<com.google.oauth2.model.Jwk> {
     ...
     *
     * This request holds the parameters needed by the the oauth2 server.  After setting any optional
     * parameters, call the {@link GetRobotJwk#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetRobotJwk#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
    ...
    protected GetRobotJwk(java.lang.String robotEmail) {
      super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.Jwk.class);
      this.robotEmail = com.google.api.client.util.Preconditions.checkNotNull(robotEmail, "Required parameter robotEmail must be specified.");
    }
    ...
    @Override
    public GetRobotJwk setAlt(java.lang.String alt) {
      return (GetRobotJwk) super.setAlt(alt);
    }

    @Override
    public GetRobotJwk setFields(java.lang.String fields) {
      return (GetRobotJwk) super.setFields(fields);
    }

    @Override
    public GetRobotJwk setKey(java.lang.String key) {
      return (GetRobotJwk) super.setKey(key);
    }

    @Override
    public GetRobotJwk setOauthToken(java.lang.String oauthToken) {
      return (GetRobotJwk) super.setOauthToken(oauthToken);
    }

    @Override
    public GetRobotJwk setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetRobotJwk) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetRobotJwk setQuotaUser(java.lang.String quotaUser) {
      return (GetRobotJwk) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetRobotJwk setUserIp(java.lang.String userIp) {
      return (GetRobotJwk) super.setUserIp(userIp);
    }

    /** The email of robot account. */
    @com.google.api.client.util.Key
    private java.lang.String robotEmail;
    ...
    /** The email of robot account. */
    public GetRobotJwk setRobotEmail(java.lang.String robotEmail) {
   ...
   *
   * This request holds the parameters needed by the oauth2 server.  After setting any optional
   * parameters, call the {@link GetRobotMetadataRaw#execute()} method to invoke the remote operation.
   *
   * @param robotEmail The email of robot account.
   * @return the request
   */
  public GetRobotMetadataRaw getRobotMetadataRaw(java.lang.String robotEmail) throws java.io.IOException {
    GetRobotMetadataRaw result = new GetRobotMetadataRaw(robotEmail);
    initialize(result);
    return result;
  }

  public class GetRobotMetadataRaw extends Oauth2Request<com.google.oauth2.model.Raw> {
     ...
     *
     * This request holds the parameters needed by the the oauth2 server.  After setting any optional
     * parameters, call the {@link GetRobotMetadataRaw#execute()} method to invoke the remote
     * operation. <p> {@link GetRobotMetadataRaw#initialize(com.google.api.client.googleapis.services.
     ...
     * @since 1.13
     */
    protected GetRobotMetadataRaw(java.lang.String robotEmail) {
      super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.Raw.class);
      this.robotEmail = com.google.api.client.util.Preconditions.checkNotNull(robotEmail, "Required parameter robotEmail must be specified.");
    }
    ...
    @Override
    public GetRobotMetadataRaw setAlt(java.lang.String alt) {
      return (GetRobotMetadataRaw) super.setAlt(alt);
    }

    @Override
    public GetRobotMetadataRaw setFields(java.lang.String fields) {
      return (GetRobotMetadataRaw) super.setFields(fields);
    }

    @Override
    public GetRobotMetadataRaw setKey(java.lang.String key) {
      return (GetRobotMetadataRaw) super.setKey(key);
    }

    @Override
    public GetRobotMetadataRaw setOauthToken(java.lang.String oauthToken) {
      return (GetRobotMetadataRaw) super.setOauthToken(oauthToken);
    }

    @Override
    public GetRobotMetadataRaw setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetRobotMetadataRaw) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetRobotMetadataRaw setQuotaUser(java.lang.String quotaUser) {
      return (GetRobotMetadataRaw) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetRobotMetadataRaw setUserIp(java.lang.String userIp) {
    ...
    /** The email of robot account. */
    public GetRobotMetadataRaw setRobotEmail(java.lang.String robotEmail) {
      this.robotEmail = robotEmail;
      return this;
    }
   ...
   *
   * This request holds the parameters needed by the oauth2 server.  After setting any optional
   * parameters, call the {@link GetRobotMetadataX509#execute()} method to invoke the remote
   * operation.
   *
   * @param robotEmail The email of robot account.
   * @return the request
   */
  public GetRobotMetadataX509 getRobotMetadataX509(java.lang.String robotEmail) throws java.io.IOException {
    GetRobotMetadataX509 result = new GetRobotMetadataX509(robotEmail);
    initialize(result);
    return result;
  }

  public class GetRobotMetadataX509 extends Oauth2Request<com.google.oauth2.model.X509> {
     ...
     * This request holds the parameters needed by the the oauth2 server.  After setting any optional
     * parameters, call the {@link GetRobotMetadataX509#execute()} method to invoke the remote
     * operation. <p> {@link GetRobotMetadataX509#initialize(com.google.api.client.googleapis.services
     * .AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @param robotEmail The email of robot account.
     * @since 1.13
     */
    protected GetRobotMetadataX509(java.lang.String robotEmail) {
      super(Oauth2.this, "GET", REST_PATH, null, com.google.oauth2.model.X509.class);
      this.robotEmail = com.google.api.client.util.Preconditions.checkNotNull(robotEmail, "Required parameter robotEmail must be specified.");
    }
    ...
    @Override
    public GetRobotMetadataX509 setAlt(java.lang.String alt) {
      return (GetRobotMetadataX509) super.setAlt(alt);
    }

    @Override
    public GetRobotMetadataX509 setFields(java.lang.String fields) {
      return (GetRobotMetadataX509) super.setFields(fields);
    }

    @Override
    public GetRobotMetadataX509 setKey(java.lang.String key) {
      return (GetRobotMetadataX509) super.setKey(key);
    }

    @Override
    public GetRobotMetadataX509 setOauthToken(java.lang.String oauthToken) {
      return (GetRobotMetadataX509) super.setOauthToken(oauthToken);
    }

    @Override
    public GetRobotMetadataX509 setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetRobotMetadataX509) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetRobotMetadataX509 setQuotaUser(java.lang.String quotaUser) {
      return (GetRobotMetadataX509) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetRobotMetadataX509 setUserIp(java.lang.String userIp) {
    ...
    /** The email of robot account. */
    public GetRobotMetadataX509 setRobotEmail(java.lang.String robotEmail) {
      this.robotEmail = robotEmail;
      return this;
    }
  ...
  public class Tokeninfo extends Oauth2Request<com.google.oauth2.model.Tokeninfo> {
     ...
     */
    protected Tokeninfo() {
      super(Oauth2.this, "POST", REST_PATH, null, com.google.oauth2.model.Tokeninfo.class);
    }
