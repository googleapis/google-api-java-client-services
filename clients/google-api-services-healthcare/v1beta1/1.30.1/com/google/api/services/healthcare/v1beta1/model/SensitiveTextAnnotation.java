...
public final class SensitiveTextAnnotation extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Maps from a resource slice. For example, FHIR resource field path to a set of sensitive text
   * findings. For example, Appointment.Narrative text1 --> {findings_1, findings_2, findings_3}
