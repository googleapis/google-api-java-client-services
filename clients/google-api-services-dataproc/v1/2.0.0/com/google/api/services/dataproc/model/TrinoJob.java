...
public final class TrinoJob extends com.google.api.client.json.GenericJson {
   ...
   */
  public TrinoJob setClientTags(java.util.List<java.lang.String> clientTags) {
   ...
   */
  public TrinoJob setContinueOnFailure(java.lang.Boolean continueOnFailure) {
   ...
   */
  public TrinoJob setOutputFormat(java.lang.String outputFormat) {
   ...
   */
  public TrinoJob setProperties(java.util.Map<String, java.lang.String> properties) {
   ...
   */
  public TrinoJob setQueryFileUri(java.lang.String queryFileUri) {
  ...
  @Override
  public TrinoJob set(String fieldName, Object value) {
    return (TrinoJob) super.set(fieldName, value);
  }

  @Override
  public TrinoJob clone() {
    return (TrinoJob) super.clone();
  }
