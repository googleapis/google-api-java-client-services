...
public final class TargetHttpProxiesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<TargetHttpProxy> targetHttpProxies;
   ...
   */
  public java.util.List<TargetHttpProxy> getTargetHttpProxies() {
    return targetHttpProxies;
  }

  /**
   * A list of TargetHttpProxies contained in this scope.
   * @param targetHttpProxies targetHttpProxies or {@code null} for none
   */
  public TargetHttpProxiesScopedList setTargetHttpProxies(java.util.List<TargetHttpProxy> targetHttpProxies) {
   ...
   */
  public TargetHttpProxiesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetHttpProxiesScopedList set(String fieldName, Object value) {
    return (TargetHttpProxiesScopedList) super.set(fieldName, value);
  }

  @Override
  public TargetHttpProxiesScopedList clone() {
    return (TargetHttpProxiesScopedList) super.clone();
  }
