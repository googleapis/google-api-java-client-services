...
public final class GoogleChromePolicyVersionsV1PolicyValue extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicyValue setPolicySchema(java.lang.String policySchema) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicyValue setValue(java.util.Map<String, java.lang.Object> value) {
    this.value = value;
    return this;
  }

  @Override
  public GoogleChromePolicyVersionsV1PolicyValue set(String fieldName, Object value) {
    return (GoogleChromePolicyVersionsV1PolicyValue) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyVersionsV1PolicyValue clone() {
    return (GoogleChromePolicyVersionsV1PolicyValue) super.clone();
  }
