  ...
  public class Organizations {
    ...
    public class Locations {
      ...
      public class OrgPolicyViolationsPreviews {
         ...
         * @return the request
         */
        public Generate generate(java.lang.String parent, com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview content) throws java.io.IOException {
          Generate result = new Generate(parent, content);
          initialize(result);
          return result;
        }

        public class Generate extends PolicySimulatorRequest<com.google.api.services.policysimulator.v1alpha.model.GoogleLongrunningOperation> {

          private static final String REST_PATH = "v1alpha/{+parent}/orgPolicyViolationsPreviews:generate";
         ...
         *        `organizations/my-example-org/locations/global`
           ...
           * @since 1.13
           */
          protected Generate(java.lang.String parent, com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview content) {
            super(PolicySimulator.this, "POST", REST_PATH, content, com.google.api.services.policysimulator.v1alpha.model.GoogleLongrunningOperation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends PolicySimulatorRequest<com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview> {
           ...
           */
          protected Get(java.lang.String name) {
            super(PolicySimulator.this, "GET", REST_PATH, null, com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaOrgPolicyViolationsPreview.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends PolicySimulatorRequest<com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsPreviewsResponse> {
         ...
         *        org/locations/global`
           ...
           */
          protected List(java.lang.String parent) {
            super(PolicySimulator.this, "GET", REST_PATH, null, com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsPreviewsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class OrgPolicyViolations {
          ...
          public class List extends PolicySimulatorRequest<com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsResponse> {

            private static final String REST_PATH = "v1alpha/{+parent}/orgPolicyViolations";
           ...
           *        anization}/locations/{location}/orgPolicyViolationsPreviews/{orgPolicyViolationsPreview}
             ...
             */
            protected List(java.lang.String parent) {
              super(PolicySimulator.this, "GET", REST_PATH, null, com.google.api.services.policysimulator.v1alpha.model.GoogleCloudPolicysimulatorV1alphaListOrgPolicyViolationsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
