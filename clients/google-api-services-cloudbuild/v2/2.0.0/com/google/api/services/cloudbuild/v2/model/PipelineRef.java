...
public final class PipelineRef extends com.google.api.client.json.GenericJson {
   ...
   */
  public PipelineRef setParams(java.util.List<Param> params) {
    this.params = params;
    return this;
  }
   ...
   */
  public PipelineRef setResolver(java.lang.String resolver) {
    this.resolver = resolver;
    return this;
  }

  @Override
  public PipelineRef set(String fieldName, Object value) {
    return (PipelineRef) super.set(fieldName, value);
  }

  @Override
  public PipelineRef clone() {
    return (PipelineRef) super.clone();
  }
