...
public final class CmekSettings extends com.google.api.client.json.GenericJson {
   ...
   * encryption unless access to that key has been revoked.To disable CMEK for the Logs Router, set
   ...
   * key.Before enabling CMEK for Logs Router, you must first assign the
   * cloudkms.cryptoKeyEncrypterDecrypter role to the service account that the Logs Router will use
