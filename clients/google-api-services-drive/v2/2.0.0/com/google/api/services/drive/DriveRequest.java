...
public abstract class DriveRequest<T> extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<T> {
  ...
  /** V1 error format. */
  public DriveRequest<T> set$Xgafv(java.lang.String $Xgafv) {
    this.$Xgafv = $Xgafv;
    return this;
  }
  ...
  /** OAuth access token. */
  public DriveRequest<T> setAccessToken(java.lang.String accessToken) {
  ...
  /** JSONP */
  public DriveRequest<T> setCallback(java.lang.String callback) {
  ...
  /** Legacy upload protocol for media (e.g. "media", "multipart"). */
  public DriveRequest<T> setUploadType(java.lang.String uploadType) {
  ...
  /** Upload protocol for media (e.g. "raw", "multipart"). */
  public DriveRequest<T> setUploadProtocol(java.lang.String uploadProtocol) {
