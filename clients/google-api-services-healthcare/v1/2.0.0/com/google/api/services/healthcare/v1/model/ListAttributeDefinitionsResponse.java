...
public final class ListAttributeDefinitionsResponse extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider AttributeDefinition used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(AttributeDefinition.class);
  }
   ...
   */
  public ListAttributeDefinitionsResponse setAttributeDefinitions(java.util.List<AttributeDefinition> attributeDefinitions) {
  ...
  @Override
  public ListAttributeDefinitionsResponse set(String fieldName, Object value) {
    return (ListAttributeDefinitionsResponse) super.set(fieldName, value);
  }

  @Override
  public ListAttributeDefinitionsResponse clone() {
    return (ListAttributeDefinitionsResponse) super.clone();
  }
