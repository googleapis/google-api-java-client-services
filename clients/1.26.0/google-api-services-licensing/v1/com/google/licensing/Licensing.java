...
public class Licensing extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Enterprise License Manager API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class LicenseAssignments {
    ...
    public class Get extends LicensingRequest<com.google.licensing.model.LicenseAssignment> {
      ...
      protected Get(java.lang.String productId, java.lang.String skuId, java.lang.String userId) {
        super(Licensing.this, "GET", REST_PATH, null, com.google.licensing.model.LicenseAssignment.class);
        this.productId = com.google.api.client.util.Preconditions.checkNotNull(productId, "Required parameter productId must be specified.");
        this.skuId = com.google.api.client.util.Preconditions.checkNotNull(skuId, "Required parameter skuId must be specified.");
        this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
      }
     ...
     * @param productId Name for product
     * @param skuId Name for sku
     * @param content the {@link com.google.licensing.model.LicenseAssignmentInsert}
     * @return the request
     */
    public Insert insert(java.lang.String productId, java.lang.String skuId, com.google.licensing.model.LicenseAssignmentInsert content) throws java.io.IOException {
      Insert result = new Insert(productId, skuId, content);
      initialize(result);
      return result;
    }

    public class Insert extends LicensingRequest<com.google.licensing.model.LicenseAssignment> {
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String productId, java.lang.String skuId, com.google.licensing.model.LicenseAssignmentInsert content) {
        super(Licensing.this, "POST", REST_PATH, content, com.google.licensing.model.LicenseAssignment.class);
        this.productId = com.google.api.client.util.Preconditions.checkNotNull(productId, "Required parameter productId must be specified.");
        this.skuId = com.google.api.client.util.Preconditions.checkNotNull(skuId, "Required parameter skuId must be specified.");
      }
    ...
    public class ListForProduct extends LicensingRequest<com.google.licensing.model.LicenseAssignmentList> {
      ...
      protected ListForProduct(java.lang.String productId, java.lang.String customerId) {
        super(Licensing.this, "GET", REST_PATH, null, com.google.licensing.model.LicenseAssignmentList.class);
        this.productId = com.google.api.client.util.Preconditions.checkNotNull(productId, "Required parameter productId must be specified.");
      ...
      @Override
      public ListForProduct setUserIp(java.lang.String userIp) {
    ...
    public class ListForProductAndSku extends LicensingRequest<com.google.licensing.model.LicenseAssignmentList> {
      ...
      @Override
      public ListForProductAndSku setUserIp(java.lang.String userIp) {
     ...
     * @param userId email id or unique Id of the user
     * @param content the {@link com.google.licensing.model.LicenseAssignment}
     * @return the request
     */
    public Patch patch(java.lang.String productId, java.lang.String skuId, java.lang.String userId, com.google.licensing.model.LicenseAssignment content) throws java.io.IOException {
      Patch result = new Patch(productId, skuId, userId, content);
      initialize(result);
      return result;
    }

    public class Patch extends LicensingRequest<com.google.licensing.model.LicenseAssignment> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String productId, java.lang.String skuId, java.lang.String userId, com.google.licensing.model.LicenseAssignment content) {
        super(Licensing.this, "PATCH", REST_PATH, content, com.google.licensing.model.LicenseAssignment.class);
        this.productId = com.google.api.client.util.Preconditions.checkNotNull(productId, "Required parameter productId must be specified.");
        this.skuId = com.google.api.client.util.Preconditions.checkNotNull(skuId, "Required parameter skuId must be specified.");
        this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String productId, java.lang.String skuId, java.lang.String userId, com.google.licensing.model.LicenseAssignment content) throws java.io.IOException {
      Update result = new Update(productId, skuId, userId, content);
      initialize(result);
      return result;
    }

    public class Update extends LicensingRequest<com.google.licensing.model.LicenseAssignment> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String productId, java.lang.String skuId, java.lang.String userId, com.google.licensing.model.LicenseAssignment content) {
        super(Licensing.this, "PUT", REST_PATH, content, com.google.licensing.model.LicenseAssignment.class);
        this.productId = com.google.api.client.util.Preconditions.checkNotNull(productId, "Required parameter productId must be specified.");
        this.skuId = com.google.api.client.util.Preconditions.checkNotNull(skuId, "Required parameter skuId must be specified.");
        this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
