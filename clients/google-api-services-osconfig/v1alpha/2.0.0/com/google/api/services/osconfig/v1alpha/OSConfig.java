  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
        ...
        public class Delete extends OSConfigRequest<com.google.api.services.osconfig.v1alpha.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(OSConfig.this, "DELETE", REST_PATH, null, com.google.api.services.osconfig.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends OSConfigRequest<com.google.api.services.osconfig.v1alpha.model.ListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(OSConfig.this, "GET", REST_PATH, null, com.google.api.services.osconfig.v1alpha.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
