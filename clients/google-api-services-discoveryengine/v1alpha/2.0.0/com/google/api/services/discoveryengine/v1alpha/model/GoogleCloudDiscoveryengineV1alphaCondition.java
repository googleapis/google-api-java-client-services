...
public final class GoogleCloudDiscoveryengineV1alphaCondition extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1alphaConditionQueryTerm> queryTerms;

  /**
   * Range of time(s) specifying when condition is active. Maximum of 10 time ranges.
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1alphaConditionTimeRange> getActiveTimeRange() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaCondition setActiveTimeRange(java.util.List<GoogleCloudDiscoveryengineV1alphaConditionTimeRange> activeTimeRange) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1alphaCondition set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaCondition) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaCondition clone() {
    return (GoogleCloudDiscoveryengineV1alphaCondition) super.clone();
  }
