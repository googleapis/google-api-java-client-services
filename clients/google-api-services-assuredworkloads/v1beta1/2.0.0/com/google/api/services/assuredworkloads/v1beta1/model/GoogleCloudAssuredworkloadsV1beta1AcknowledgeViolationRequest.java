...
public final class GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest set(String fieldName, Object value) {
    return (GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest clone() {
    return (GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest) super.clone();
  }
