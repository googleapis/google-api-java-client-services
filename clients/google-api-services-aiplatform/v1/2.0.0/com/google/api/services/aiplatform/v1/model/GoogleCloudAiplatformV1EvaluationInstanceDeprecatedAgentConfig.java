...
public final class GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfigTools tools;
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setAgentId(java.lang.String agentId) {
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setAgentType(java.lang.String agentType) {
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setDeveloperInstruction(GoogleCloudAiplatformV1EvaluationInstanceInstanceData developerInstruction) {
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setSubAgents(java.util.List<java.lang.String> subAgents) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfigTools getTools() {
    return tools;
  }
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setTools(GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfigTools tools) {
    this.tools = tools;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig setToolsText(java.lang.String toolsText) {
    this.toolsText = toolsText;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig clone() {
    return (GoogleCloudAiplatformV1EvaluationInstanceDeprecatedAgentConfig) super.clone();
  }
