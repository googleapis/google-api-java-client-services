...
public final class MigratingVm extends com.google.api.client.json.GenericJson {
  ...
  public TargetVMDetails getComputeEngineVmDefaults() {
    return computeEngineVmDefaults;
  }

  /**
   * Details of the VM in Compute Engine. Deprecated: Use compute_engine_target_defaults instead.
   * @param computeEngineVmDefaults computeEngineVmDefaults or {@code null} for none
   */
  public MigratingVm setComputeEngineVmDefaults(TargetVMDetails computeEngineVmDefaults) {
