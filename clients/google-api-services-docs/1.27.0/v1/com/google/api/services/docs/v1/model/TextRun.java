...
public final class TextRun extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The suggested insertion IDs. A TextRun may have multiple insertion IDs if it is a nested
  ...
  static {
    // hack to force ProGuard to consider SuggestedTextStyle used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(SuggestedTextStyle.class);
  }
   ...
   */
  public TextRun setSuggestedDeletionIds(java.util.List<java.lang.String> suggestedDeletionIds) {
   ...
   */
  public TextRun setSuggestedInsertionIds(java.util.List<java.lang.String> suggestedInsertionIds) {
   ...
   */
  public TextRun setSuggestedTextStyleChanges(java.util.Map<String, SuggestedTextStyle> suggestedTextStyleChanges) {
