...
/**
 * Model definition for StoragePoolAggregatedList.
 *
...
public final class StoragePoolAggregatedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] Type of resource. Always compute#storagePoolAggregatedList for aggregated lists
   * of storage pools.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public StoragePoolAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public StoragePoolAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, StoragePoolsScopedList> getItems() {
    return items;
  }
   ...
   */
  public StoragePoolAggregatedList setItems(java.util.Map<String, StoragePoolsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public StoragePoolAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public StoragePoolAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolAggregatedList set(String fieldName, Object value) {
    return (StoragePoolAggregatedList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolAggregatedList clone() {
    return (StoragePoolAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolAggregatedListWarningData.
     */
