...
public final class QueryAuditableServicesRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public QueryAuditableServicesRequest set(String fieldName, Object value) {
    return (QueryAuditableServicesRequest) super.set(fieldName, value);
  }

  @Override
  public QueryAuditableServicesRequest clone() {
    return (QueryAuditableServicesRequest) super.clone();
  }
