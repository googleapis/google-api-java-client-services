...
public final class RealmAggregatedData extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RealmAggregatedData set(String fieldName, Object value) {
    return (RealmAggregatedData) super.set(fieldName, value);
  }

  @Override
  public RealmAggregatedData clone() {
    return (RealmAggregatedData) super.clone();
  }
