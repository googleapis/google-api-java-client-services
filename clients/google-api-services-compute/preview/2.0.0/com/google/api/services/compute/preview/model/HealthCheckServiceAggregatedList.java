...
public final class HealthCheckServiceAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, HealthCheckServicesScopedList> items;
   ...
   */
  public HealthCheckServiceAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, HealthCheckServicesScopedList> getItems() {
    return items;
  }
   ...
   */
  public HealthCheckServiceAggregatedList setItems(java.util.Map<String, HealthCheckServicesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HealthCheckServiceAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public HealthCheckServiceAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HealthCheckServiceAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HealthCheckServiceAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public HealthCheckServiceAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthCheckServiceAggregatedList set(String fieldName, Object value) {
    return (HealthCheckServiceAggregatedList) super.set(fieldName, value);
  }

  @Override
  public HealthCheckServiceAggregatedList clone() {
    return (HealthCheckServiceAggregatedList) super.clone();
  }
