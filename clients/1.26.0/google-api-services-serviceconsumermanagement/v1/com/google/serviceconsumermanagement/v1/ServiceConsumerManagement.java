...
package com.google.serviceconsumermanagement.v1;
...
public class ServiceConsumerManagement extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Service Consumer Management API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Operations {
     ...
     * @param content the {@link com.google.serviceconsumermanagement.v1.model.CancelOperationRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.serviceconsumermanagement.v1.model.CancelOperationRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Empty> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.serviceconsumermanagement.v1.model.CancelOperationRequest content) {
        super(ServiceConsumerManagement.this, "POST", REST_PATH, content, com.google.serviceconsumermanagement.v1.model.Empty.class);
    ...
    public class Delete extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Empty> {
      ...
      protected Delete(java.lang.String name) {
        super(ServiceConsumerManagement.this, "DELETE", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Get extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Operation> {
      ...
      protected Get(java.lang.String name) {
        super(ServiceConsumerManagement.this, "GET", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.ListOperationsResponse> {
      ...
      protected List(java.lang.String name) {
        super(ServiceConsumerManagement.this, "GET", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.ListOperationsResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
  ...
  public class Services {
    ...
    public class Search extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.SearchTenancyUnitsResponse> {
     ...
     *        example 'service.googleapis.com'.
      ...
      protected Search(java.lang.String parent) {
        super(ServiceConsumerManagement.this, "GET", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.SearchTenancyUnitsResponse.class);
    ...
    public class TenancyUnits {
       ...
       * @param content the {@link com.google.serviceconsumermanagement.v1.model.AddTenantProjectRequest}
       * @return the request
       */
      public AddProject addProject(java.lang.String parent, com.google.serviceconsumermanagement.v1.model.AddTenantProjectRequest content) throws java.io.IOException {
        AddProject result = new AddProject(parent, content);
        initialize(result);
        return result;
      }

      public class AddProject extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Operation> {
         ...
         * @since 1.13
         */
        protected AddProject(java.lang.String parent, com.google.serviceconsumermanagement.v1.model.AddTenantProjectRequest content) {
          super(ServiceConsumerManagement.this, "POST", REST_PATH, content, com.google.serviceconsumermanagement.v1.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *        new tenancy unit.
       * @param content the {@link com.google.serviceconsumermanagement.v1.model.CreateTenancyUnitRequest}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.serviceconsumermanagement.v1.model.CreateTenancyUnitRequest content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.TenancyUnit> {
       ...
       *        new tenancy unit.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.serviceconsumermanagement.v1.model.CreateTenancyUnitRequest content) {
          super(ServiceConsumerManagement.this, "POST", REST_PATH, content, com.google.serviceconsumermanagement.v1.model.TenancyUnit.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Delete extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Operation> {
         ...
         */
        protected Delete(java.lang.String name) {
          super(ServiceConsumerManagement.this, "DELETE", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.ListTenancyUnitsResponse> {
      ...
      {service} the name of a service, for example 'service.googleapis.com'.
        ...
        protected List(java.lang.String parent) {
          super(ServiceConsumerManagement.this, "GET", REST_PATH, null, com.google.serviceconsumermanagement.v1.model.ListTenancyUnitsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @param content the {@link com.google.serviceconsumermanagement.v1.model.RemoveTenantProjectRequest}
       * @return the request
       */
      public RemoveProject removeProject(java.lang.String name, com.google.serviceconsumermanagement.v1.model.RemoveTenantProjectRequest content) throws java.io.IOException {
        RemoveProject result = new RemoveProject(name, content);
        initialize(result);
        return result;
      }

      public class RemoveProject extends ServiceConsumerManagementRequest<com.google.serviceconsumermanagement.v1.model.Operation> {
       ...
       *        'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
         ...
         * @since 1.13
         */
        protected RemoveProject(java.lang.String name, com.google.serviceconsumermanagement.v1.model.RemoveTenantProjectRequest content) {
          super(ServiceConsumerManagement.this, "POST", REST_PATH, content, com.google.serviceconsumermanagement.v1.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
