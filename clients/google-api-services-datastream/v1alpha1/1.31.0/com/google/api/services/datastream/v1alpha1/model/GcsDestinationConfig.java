...
public final class GcsDestinationConfig extends com.google.api.client.json.GenericJson {
  ...
  private AvroFileFormat avroFileFormat;
   ...
   */
  @com.google.api.client.util.Key
  private java.lang.Integer fileRotationMb;

  /**
   * File format that data should be written in. Deprecated field (b/169501737) - use file_format
   * instead.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.String gcsFileFormat;
