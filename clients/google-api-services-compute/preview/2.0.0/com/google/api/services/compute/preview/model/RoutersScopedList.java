...
public final class RoutersScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Router> routers;
  ...
  /**
   * A list of routers contained in this scope.
   * @param routers routers or {@code null} for none
   */
  public RoutersScopedList setRouters(java.util.List<Router> routers) {
   ...
   */
  public RoutersScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RoutersScopedList set(String fieldName, Object value) {
    return (RoutersScopedList) super.set(fieldName, value);
  }

  @Override
  public RoutersScopedList clone() {
    return (RoutersScopedList) super.clone();
  }
