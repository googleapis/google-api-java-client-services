      ...
      public class Environments {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
         ...
         "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
           ...
           * { "config":{ "softwareConfig":{ "pypiPackages":{ "botocore":"==1.7.14" } } } } *Note:*
           ...
           * one or more individual environment variables. config.softwareConfig.imageVersion
           ...
           * Additionally, the new image version cannot effect a version downgrade and must match
           * the current image version's Composer major version and Airflow major and minor
           ...
           * db-n1-standard-16. config.webServerConfig.machineType Machine type on which Airflow web
         ...
         variables. config.softwareConfig.imageVersion Upgrade the version of the environment in-place.
         ...
         Composer Version List for valid values. config.databaseConfig.machineType Cloud SQL machine type
         used by Airflow database. It has to be one of: db-n1-standard-2, db-n1-standard-4, db-n1-standard-8
         or db-n1-standard-16. config.webServerConfig.machineType Machine type on which Airflow web server
