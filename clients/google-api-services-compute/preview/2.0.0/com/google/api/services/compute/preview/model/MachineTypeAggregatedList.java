...
public final class MachineTypeAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, MachineTypesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#machineTypeAggregatedList for
   ...
   */
  public MachineTypeAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, MachineTypesScopedList> getItems() {
    return items;
  }
   ...
   */
  public MachineTypeAggregatedList setItems(java.util.Map<String, MachineTypesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public MachineTypeAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public MachineTypeAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public MachineTypeAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public MachineTypeAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public MachineTypeAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public MachineTypeAggregatedList set(String fieldName, Object value) {
    return (MachineTypeAggregatedList) super.set(fieldName, value);
  }

  @Override
  public MachineTypeAggregatedList clone() {
