...
public class Surveys extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.28.0 of the Surveys API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Results {
    ...
    public class Get extends SurveysRequest<com.google.api.services.surveys.model.SurveyResults> {
      ...
      protected Get(java.lang.String surveyUrlId) {
        super(Surveys.this, "GET", REST_PATH, null, com.google.api.services.surveys.model.SurveyResults.class);
  ...
  public class SurveysOperations {
    ...
    public class Delete extends SurveysRequest<com.google.api.services.surveys.model.SurveysDeleteResponse> {
      ...
      protected Delete(java.lang.String surveyUrlId) {
        super(Surveys.this, "DELETE", REST_PATH, null, com.google.api.services.surveys.model.SurveysDeleteResponse.class);
        this.surveyUrlId = com.google.api.client.util.Preconditions.checkNotNull(surveyUrlId, "Required parameter surveyUrlId must be specified.");
      }
    ...
    public class Get extends SurveysRequest<com.google.api.services.surveys.model.Survey> {
       ...
       */
      protected Get(java.lang.String surveyUrlId) {
        super(Surveys.this, "GET", REST_PATH, null, com.google.api.services.surveys.model.Survey.class);
        this.surveyUrlId = com.google.api.client.util.Preconditions.checkNotNull(surveyUrlId, "Required parameter surveyUrlId must be specified.");
      }
     ...
     *
     * @param content the {@link com.google.api.services.surveys.model.Survey}
     * @return the request
     */
    public Insert insert(com.google.api.services.surveys.model.Survey content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends SurveysRequest<com.google.api.services.surveys.model.Survey> {
       ...
       * @since 1.13
       */
      protected Insert(com.google.api.services.surveys.model.Survey content) {
        super(Surveys.this, "POST", REST_PATH, content, com.google.api.services.surveys.model.Survey.class);
      }
    ...
    public class List extends SurveysRequest<com.google.api.services.surveys.model.SurveysListResponse> {
       ...
       */
      protected List() {
        super(Surveys.this, "GET", REST_PATH, null, com.google.api.services.surveys.model.SurveysListResponse.class);
      }
     ...
     *
     * @param resourceId
     * @param content the {@link com.google.api.services.surveys.model.SurveysStartRequest}
     * @return the request
     */
    public Start start(java.lang.String resourceId, com.google.api.services.surveys.model.SurveysStartRequest content) throws java.io.IOException {
      Start result = new Start(resourceId, content);
      initialize(result);
      return result;
    }

    public class Start extends SurveysRequest<com.google.api.services.surveys.model.SurveysStartResponse> {
       ...
       * @since 1.13
       */
      protected Start(java.lang.String resourceId, com.google.api.services.surveys.model.SurveysStartRequest content) {
        super(Surveys.this, "POST", REST_PATH, content, com.google.api.services.surveys.model.SurveysStartResponse.class);
    ...
    public class Stop extends SurveysRequest<com.google.api.services.surveys.model.SurveysStopResponse> {
      ...
      protected Stop(java.lang.String resourceId) {
        super(Surveys.this, "POST", REST_PATH, null, com.google.api.services.surveys.model.SurveysStopResponse.class);
        this.resourceId = com.google.api.client.util.Preconditions.checkNotNull(resourceId, "Required parameter resourceId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String surveyUrlId, com.google.api.services.surveys.model.Survey content) throws java.io.IOException {
      Update result = new Update(surveyUrlId, content);
      initialize(result);
      return result;
    }

    public class Update extends SurveysRequest<com.google.api.services.surveys.model.Survey> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String surveyUrlId, com.google.api.services.surveys.model.Survey content) {
        super(Surveys.this, "PUT", REST_PATH, content, com.google.api.services.surveys.model.Survey.class);
        this.surveyUrlId = com.google.api.client.util.Preconditions.checkNotNull(surveyUrlId, "Required parameter surveyUrlId must be specified.");
      }
