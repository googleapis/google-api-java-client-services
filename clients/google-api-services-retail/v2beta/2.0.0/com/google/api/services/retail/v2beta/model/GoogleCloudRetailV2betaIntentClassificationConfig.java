...
public final class GoogleCloudRetailV2betaIntentClassificationConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2betaIntentClassificationConfigExample> example;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudRetailV2betaIntentClassificationConfigInlineSource inlineSource;
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfig setBlocklistKeywords(java.util.List<java.lang.String> blocklistKeywords) {
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfig setDisabledIntentTypes(java.util.List<java.lang.String> disabledIntentTypes) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2betaIntentClassificationConfigExample> getExample() {
    return example;
  }
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfig setExample(java.util.List<GoogleCloudRetailV2betaIntentClassificationConfigExample> example) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudRetailV2betaIntentClassificationConfigInlineSource getInlineSource() {
    return inlineSource;
  }
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfig setInlineSource(GoogleCloudRetailV2betaIntentClassificationConfigInlineSource inlineSource) {
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfig setModelPreamble(java.lang.String modelPreamble) {
    this.modelPreamble = modelPreamble;
    return this;
  }

  @Override
  public GoogleCloudRetailV2betaIntentClassificationConfig set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaIntentClassificationConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaIntentClassificationConfig clone() {
    return (GoogleCloudRetailV2betaIntentClassificationConfig) super.clone();
  }
