...
public final class IngressFrom extends com.google.api.client.json.GenericJson {
   ...
   */
  public IngressFrom setIdentityType(java.lang.String identityType) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<IngressSource> getSources() {
    return sources;
  }
   ...
   */
  public IngressFrom setSources(java.util.List<IngressSource> sources) {
    this.sources = sources;
    return this;
  }

  @Override
  public IngressFrom set(String fieldName, Object value) {
    return (IngressFrom) super.set(fieldName, value);
  }

  @Override
  public IngressFrom clone() {
    return (IngressFrom) super.clone();
  }
