...
public final class GoogleCloudRetailV2FulfillmentInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2FulfillmentInfo setPlaceIds(java.util.List<java.lang.String> placeIds) {
   ...
   */
  public GoogleCloudRetailV2FulfillmentInfo setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public GoogleCloudRetailV2FulfillmentInfo set(String fieldName, Object value) {
    return (GoogleCloudRetailV2FulfillmentInfo) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2FulfillmentInfo clone() {
    return (GoogleCloudRetailV2FulfillmentInfo) super.clone();
  }
