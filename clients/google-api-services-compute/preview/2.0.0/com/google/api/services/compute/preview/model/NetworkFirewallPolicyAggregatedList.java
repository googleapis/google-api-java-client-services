...
/**
 * Model definition for NetworkFirewallPolicyAggregatedList.
 *
...
public final class NetworkFirewallPolicyAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, FirewallPoliciesScopedList> items;

  static {
    // hack to force ProGuard to consider FirewallPoliciesScopedList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(FirewallPoliciesScopedList.class);
  }

  /**
   * Output only. [Output Only] Type of resource.
   * Alwayscompute#networkFirewallPoliciesAggregatedList for lists of network firewall policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NetworkFirewallPolicyAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, FirewallPoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public NetworkFirewallPolicyAggregatedList setItems(java.util.Map<String, FirewallPoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkFirewallPolicyAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkFirewallPolicyAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkFirewallPolicyAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkFirewallPolicyAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NetworkFirewallPolicyAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkFirewallPolicyAggregatedList set(String fieldName, Object value) {
    return (NetworkFirewallPolicyAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NetworkFirewallPolicyAggregatedList clone() {
    return (NetworkFirewallPolicyAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkFirewallPolicyAggregatedListWarningData.
     */
