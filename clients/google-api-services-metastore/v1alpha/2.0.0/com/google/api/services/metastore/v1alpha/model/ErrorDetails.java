...
public final class ErrorDetails extends com.google.api.client.json.GenericJson {

  /**
   * Additional structured details about this error.Keys define the failure items. Value describes
   * the exception or details of the item.
   ...
   */
  public ErrorDetails setDetails(java.util.Map<String, java.lang.String> details) {
