...
public final class ImapUpdate extends com.google.api.client.json.GenericJson {
  ...
  /**
   * @param imapUidsReassign imapUidsReassign or {@code null} for none
   */
  ...
  @Override
  public ImapUpdate set(String fieldName, Object value) {
    return (ImapUpdate) super.set(fieldName, value);
  }

  @Override
  public ImapUpdate clone() {
