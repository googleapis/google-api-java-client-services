...
/**
 * Model definition for InstantSnapshotAggregatedList.
 *
...
public final class InstantSnapshotAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, InstantSnapshotsScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#instantSnapshotAggregatedList for
   * aggregated lists of instantSnapshots.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public InstantSnapshotAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, InstantSnapshotsScopedList> getItems() {
    return items;
  }
   ...
   */
  public InstantSnapshotAggregatedList setItems(java.util.Map<String, InstantSnapshotsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstantSnapshotAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InstantSnapshotAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstantSnapshotAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InstantSnapshotAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public InstantSnapshotAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstantSnapshotAggregatedList set(String fieldName, Object value) {
    return (InstantSnapshotAggregatedList) super.set(fieldName, value);
  }

  @Override
  public InstantSnapshotAggregatedList clone() {
    return (InstantSnapshotAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for InstantSnapshotAggregatedListWarningData.
     */
