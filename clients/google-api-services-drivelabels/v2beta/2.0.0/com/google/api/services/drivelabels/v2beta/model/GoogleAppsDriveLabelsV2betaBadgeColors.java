...
public final class GoogleAppsDriveLabelsV2betaBadgeColors extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleAppsDriveLabelsV2betaBadgeColors setBackgroundColor(GoogleTypeColor backgroundColor) {
   ...
   */
  public GoogleAppsDriveLabelsV2betaBadgeColors setForegroundColor(GoogleTypeColor foregroundColor) {
   ...
   */
  public GoogleAppsDriveLabelsV2betaBadgeColors setSoloColor(GoogleTypeColor soloColor) {
    this.soloColor = soloColor;
    return this;
  }

  @Override
  public GoogleAppsDriveLabelsV2betaBadgeColors set(String fieldName, Object value) {
    return (GoogleAppsDriveLabelsV2betaBadgeColors) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsDriveLabelsV2betaBadgeColors clone() {
    return (GoogleAppsDriveLabelsV2betaBadgeColors) super.clone();
  }
