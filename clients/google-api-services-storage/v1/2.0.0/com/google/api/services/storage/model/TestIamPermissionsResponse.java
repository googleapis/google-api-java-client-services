...
public final class TestIamPermissionsResponse extends com.google.api.client.json.GenericJson {
   ...
   * storage.resource.capability, where resource is one of buckets, objects, or managedFolders. The
   * supported permissions are as follows: - storage.buckets.delete - Delete bucket.   -
   * storage.buckets.get - Read bucket metadata.   - storage.buckets.getIamPolicy - Read bucket IAM
   * policy.   - storage.buckets.create - Create bucket.   - storage.buckets.list - List buckets.
   ...
   * object metadata.  - storage.managedFolders.delete - Delete managed folder.   -
   * storage.managedFolders.get - Read managed folder metadata.   -
   * storage.managedFolders.getIamPolicy - Read managed folder IAM policy.   -
   * storage.managedFolders.create - Create managed folder.   - storage.managedFolders.list - List
   * managed folders.   - storage.managedFolders.setIamPolicy - Update managed folder IAM policy.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
