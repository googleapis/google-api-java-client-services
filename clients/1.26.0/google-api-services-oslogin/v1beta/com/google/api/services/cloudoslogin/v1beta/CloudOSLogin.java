...
package com.google.api.services.cloudoslogin.v1beta;
...
public class CloudOSLogin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Users {
    ...
    public class GetLoginProfile extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1beta.model.LoginProfile> {
      ...
      protected GetLoginProfile(java.lang.String name) {
        super(CloudOSLogin.this, "GET", REST_PATH, null, com.google.api.services.cloudoslogin.v1beta.model.LoginProfile.class);
     ...
     * @param content the {@link com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey}
     * @return the request
     */
    public ImportSshPublicKey importSshPublicKey(java.lang.String parent, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey content) throws java.io.IOException {
      ImportSshPublicKey result = new ImportSshPublicKey(parent, content);
      initialize(result);
      return result;
    }

    public class ImportSshPublicKey extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1beta.model.ImportSshPublicKeyResponse> {
       ...
       * @since 1.13
       */
      protected ImportSshPublicKey(java.lang.String parent, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey content) {
        super(CloudOSLogin.this, "POST", REST_PATH, content, com.google.api.services.cloudoslogin.v1beta.model.ImportSshPublicKeyResponse.class);
    ...
    public class Projects {
      ...
      public class Delete extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1beta.model.Empty> {
       ...
       *        `users/{user}/projects/{project}`.
        ...
        protected Delete(java.lang.String name) {
          super(CloudOSLogin.this, "DELETE", REST_PATH, null, com.google.api.services.cloudoslogin.v1beta.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class SshPublicKeys {
      ...
      public class Get extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey> {
       ...
       *        `users/{user}/sshPublicKeys/{fingerprint}`.
        ...
        protected Get(java.lang.String name) {
          super(CloudOSLogin.this, "GET", REST_PATH, null, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey> {
       ...
       *        `users/{user}/sshPublicKeys/{fingerprint}`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey content) {
          super(CloudOSLogin.this, "PATCH", REST_PATH, content, com.google.api.services.cloudoslogin.v1beta.model.SshPublicKey.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
