...
public final class Creative extends com.google.api.client.json.GenericJson {
   ...
   * auto-generated to contain all features detected by DCM for all the assets of this creative and
   * can then be modified by the client. To reset this field, copy over all the creativeAssets'
   * detected features. Applicable to the following creative types: HTML5_BANNER. Applicable to
  ...
  /**
   * Whether HTML code is DCM-generated or manually entered. Set to true to ignore changes to
  ...
  /**
   * The internal Flash version for this creative as calculated by DoubleClick Studio. This is a
   * read-only field. Applicable to the following creative types: FLASH_INPAGE all RICH_MEDIA, and
   * all VPAID. Applicable to DISPLAY when the primary asset type is not HTML_IMAGE.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
