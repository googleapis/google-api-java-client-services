...
package com.google.proximitybeacon.v1beta1;
...
public class Proximitybeacon extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Proximity Beacon API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Beaconinfo {
     ...
     * operation.
     *
     * @param content the {@link com.google.proximitybeacon.v1beta1.model.GetInfoForObservedBeaconsRequest}
     * @return the request
     */
    public Getforobserved getforobserved(com.google.proximitybeacon.v1beta1.model.GetInfoForObservedBeaconsRequest content) throws java.io.IOException {
      Getforobserved result = new Getforobserved(content);
      initialize(result);
      return result;
    }

    public class Getforobserved extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.GetInfoForObservedBeaconsResponse> {
       ...
       * @since 1.13
       */
      protected Getforobserved(com.google.proximitybeacon.v1beta1.model.GetInfoForObservedBeaconsRequest content) {
        super(Proximitybeacon.this, "POST", REST_PATH, content, com.google.proximitybeacon.v1beta1.model.GetInfoForObservedBeaconsResponse.class);
      }
  ...
  public class Beacons {
    ...
    public class Activate extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Empty> {
    ...
    Required.
      ...
      protected Activate(java.lang.String beaconName) {
        super(Proximitybeacon.this, "POST", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.Empty.class);
    ...
    public class Deactivate extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Empty> {
    ...
    public class Decommission extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Empty> {
    ...
    public class Delete extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Empty> {
    ...
    Required.
      ...
      protected Delete(java.lang.String beaconName) {
        super(Proximitybeacon.this, "DELETE", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.Empty.class);
        this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
              "Parameter beaconName must conform to the pattern " +
    ...
    public class Get extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Beacon> {
    ...
    Required.
      ...
      protected Get(java.lang.String beaconName) {
        super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.Beacon.class);
        this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
              "Parameter beaconName must conform to the pattern " +
    ...
    public class List extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.ListBeaconsResponse> {
       ...
       */
      protected List() {
        super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.ListBeaconsResponse.class);
      }
     ...
     *
     * @param content the {@link com.google.proximitybeacon.v1beta1.model.Beacon}
     * @return the request
     */
    public Register register(com.google.proximitybeacon.v1beta1.model.Beacon content) throws java.io.IOException {
      Register result = new Register(content);
      initialize(result);
      return result;
    }

    public class Register extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Beacon> {
       ...
       * @since 1.13
       */
      protected Register(com.google.proximitybeacon.v1beta1.model.Beacon content) {
        super(Proximitybeacon.this, "POST", REST_PATH, content, com.google.proximitybeacon.v1beta1.model.Beacon.class);
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String beaconName, com.google.proximitybeacon.v1beta1.model.Beacon content) throws java.io.IOException {
      Update result = new Update(beaconName, content);
      initialize(result);
      return result;
    }

    public class Update extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Beacon> {
     ...
     *        operations.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String beaconName, com.google.proximitybeacon.v1beta1.model.Beacon content) {
        super(Proximitybeacon.this, "PUT", REST_PATH, content, com.google.proximitybeacon.v1beta1.model.Beacon.class);
        this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
              "Parameter beaconName must conform to the pattern " +
    ...
    public class Attachments {
      ...
      public class BatchDelete extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.DeleteAttachmentsResponse> {
      ...
      Required.
        ...
        protected BatchDelete(java.lang.String beaconName) {
          super(Proximitybeacon.this, "POST", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.DeleteAttachmentsResponse.class);
          this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
                "Parameter beaconName must conform to the pattern " +
       ...
       *        EID or the beacon's "stable" UID.
      Required.
       * @param content the {@link com.google.proximitybeacon.v1beta1.model.BeaconAttachment}
       * @return the request
       */
      public Create create(java.lang.String beaconName, com.google.proximitybeacon.v1beta1.model.BeaconAttachment content) throws java.io.IOException {
        Create result = new Create(beaconName, content);
        initialize(result);
        return result;
      }

      public class Create extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.BeaconAttachment> {
      ...
      Required.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String beaconName, com.google.proximitybeacon.v1beta1.model.BeaconAttachment content) {
          super(Proximitybeacon.this, "POST", REST_PATH, content, com.google.proximitybeacon.v1beta1.model.BeaconAttachment.class);
          this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
                "Parameter beaconName must conform to the pattern " +
      ...
      public class List extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.ListBeaconAttachmentsResponse> {
      ...
      Required.
        ...
        protected List(java.lang.String beaconName) {
          super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.ListBeaconAttachmentsResponse.class);
          this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
                "Parameter beaconName must conform to the pattern " +
    ...
    public class Diagnostics {
      ...
      public class List extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.ListDiagnosticsResponse> {
         ...
         */
        protected List(java.lang.String beaconName) {
          super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.ListDiagnosticsResponse.class);
          this.beaconName = com.google.api.client.util.Preconditions.checkNotNull(beaconName, "Required parameter beaconName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(BEACON_NAME_PATTERN.matcher(beaconName).matches(),
                "Parameter beaconName must conform to the pattern " +
  ...
  public class Namespaces {
    ...
    public class List extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.ListNamespacesResponse> {
       ...
       */
      protected List() {
        super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.ListNamespacesResponse.class);
      }
     ...
     * @param content the {@link com.google.proximitybeacon.v1beta1.model.Namespace}
     * @return the request
     */
    public Update update(java.lang.String namespaceName, com.google.proximitybeacon.v1beta1.model.Namespace content) throws java.io.IOException {
      Update result = new Update(namespaceName, content);
      initialize(result);
      return result;
    }

    public class Update extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.Namespace> {
    ...
    namespaces/namespace.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String namespaceName, com.google.proximitybeacon.v1beta1.model.Namespace content) {
        super(Proximitybeacon.this, "PUT", REST_PATH, content, com.google.proximitybeacon.v1beta1.model.Namespace.class);
  ...
  public class V1beta1 {
    ...
    public class GetEidparams extends ProximitybeaconRequest<com.google.proximitybeacon.v1beta1.model.EphemeralIdRegistrationParams> {
      ...
      protected GetEidparams() {
        super(Proximitybeacon.this, "GET", REST_PATH, null, com.google.proximitybeacon.v1beta1.model.EphemeralIdRegistrationParams.class);
      }
