...
/**
 * Model definition for StoragePoolListDisks.
 *
...
public final class StoragePoolListDisks extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<StoragePoolDisk> items;

  static {
    // hack to force ProGuard to consider StoragePoolDisk used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(StoragePoolDisk.class);
  }
   ...
   */
  public StoragePoolListDisks setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<StoragePoolDisk> getItems() {
    return items;
  }
   ...
   */
  public StoragePoolListDisks setItems(java.util.List<StoragePoolDisk> items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public StoragePoolListDisks set(String fieldName, Object value) {
    return (StoragePoolListDisks) super.set(fieldName, value);
  }

  @Override
  public StoragePoolListDisks clone() {
    return (StoragePoolListDisks) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolListDisksWarningData.
     */
