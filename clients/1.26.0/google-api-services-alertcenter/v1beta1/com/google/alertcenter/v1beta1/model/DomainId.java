...
public final class DomainId extends com.google.api.client.json.GenericJson {
   ...
   */
  public DomainId setCustomerPrimaryDomain(java.lang.String customerPrimaryDomain) {
    this.customerPrimaryDomain = customerPrimaryDomain;
    return this;
  }

  @Override
  public DomainId set(String fieldName, Object value) {
    return (DomainId) super.set(fieldName, value);
  }

  @Override
  public DomainId clone() {
    return (DomainId) super.clone();
  }
