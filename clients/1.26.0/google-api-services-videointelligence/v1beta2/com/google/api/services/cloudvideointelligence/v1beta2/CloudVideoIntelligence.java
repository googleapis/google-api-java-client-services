...
public class CloudVideoIntelligence extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Videos {
     ...
     *
     * @param content the {@link com.google.api.services.cloudvideointelligence.v1beta2.model.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest}
     * @return the request
     */
    public Annotate annotate(com.google.api.services.cloudvideointelligence.v1beta2.model.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest content) throws java.io.IOException {
      Annotate result = new Annotate(content);
      initialize(result);
      return result;
    }

    public class Annotate extends CloudVideoIntelligenceRequest<com.google.api.services.cloudvideointelligence.v1beta2.model.GoogleLongrunningOperation> {
       ...
       * @since 1.13
       */
      protected Annotate(com.google.api.services.cloudvideointelligence.v1beta2.model.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest content) {
        super(CloudVideoIntelligence.this, "POST", REST_PATH, content, com.google.api.services.cloudvideointelligence.v1beta2.model.GoogleLongrunningOperation.class);
      }
