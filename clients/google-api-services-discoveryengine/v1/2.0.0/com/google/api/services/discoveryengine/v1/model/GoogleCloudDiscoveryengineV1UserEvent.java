...
public final class GoogleCloudDiscoveryengineV1UserEvent extends com.google.api.client.json.GenericJson {

  /**
   * Optional. Extra user event features to include in the recommendation model. These attributes
   * must NOT contain data that needs to be parsed or processed further, e.g. JSON or other
   * encodings. If you provide custom attributes for ingested user events, also include them in the
   * user events that you associate with prediction requests. Custom attribute formatting must be
   * consistent between imported events and events provided with prediction requests. This lets the
   * Discovery Engine API use those custom attributes when training models and serving predictions,
   * which helps improve recommendation quality. This field needs to pass all below criteria,
   * otherwise an `INVALID_ARGUMENT` error is returned: * The key must be a UTF-8 encoded string
   * with a length limit of 5,000 characters. * For text attributes, at most 400 values are allowed.
   * Empty values are not allowed. Each value must be a UTF-8 encoded string with a length limit of
   * 256 characters. * For number attributes, at most 400 values are allowed. For product
  ...
  private java.util.Map<String, GoogleCloudDiscoveryengineV1CustomAttribute> attributes;

  static {
    // hack to force ProGuard to consider GoogleCloudDiscoveryengineV1CustomAttribute used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDiscoveryengineV1CustomAttribute.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1DocumentInfo> documents;

  static {
    // hack to force ProGuard to consider GoogleCloudDiscoveryengineV1DocumentInfo used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDiscoveryengineV1DocumentInfo.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1MediaInfo mediaInfo;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1PageInfo pageInfo;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1SearchInfo searchInfo;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1TransactionInfo transactionInfo;
   ...
   */
  public java.util.Map<String, GoogleCloudDiscoveryengineV1CustomAttribute> getAttributes() {
    return attributes;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setAttributes(java.util.Map<String, GoogleCloudDiscoveryengineV1CustomAttribute> attributes) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setAttributionToken(java.lang.String attributionToken) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1CompletionInfo getCompletionInfo() {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setCompletionInfo(GoogleCloudDiscoveryengineV1CompletionInfo completionInfo) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setDataStore(java.lang.String dataStore) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setDirectUserRequest(java.lang.Boolean directUserRequest) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1DocumentInfo> getDocuments() {
    return documents;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setDocuments(java.util.List<GoogleCloudDiscoveryengineV1DocumentInfo> documents) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setEventTime(String eventTime) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1MediaInfo getMediaInfo() {
    return mediaInfo;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setMediaInfo(GoogleCloudDiscoveryengineV1MediaInfo mediaInfo) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1PageInfo getPageInfo() {
    return pageInfo;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setPageInfo(GoogleCloudDiscoveryengineV1PageInfo pageInfo) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1PanelInfo getPanel() {
    return panel;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setPromotionIds(java.util.List<java.lang.String> promotionIds) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1SearchInfo getSearchInfo() {
    return searchInfo;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setSearchInfo(GoogleCloudDiscoveryengineV1SearchInfo searchInfo) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setSessionId(java.lang.String sessionId) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setTagIds(java.util.List<java.lang.String> tagIds) {
    this.tagIds = tagIds;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1TransactionInfo getTransactionInfo() {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setTransactionInfo(GoogleCloudDiscoveryengineV1TransactionInfo transactionInfo) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setUserInfo(GoogleCloudDiscoveryengineV1UserInfo userInfo) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserEvent setUserPseudoId(java.lang.String userPseudoId) {
    this.userPseudoId = userPseudoId;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserEvent set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1UserEvent) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserEvent clone() {
    return (GoogleCloudDiscoveryengineV1UserEvent) super.clone();
  }
