...
public final class GoogleCloudContactcenterinsightsV1BulkUploadFeedbackLabelsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudContactcenterinsightsV1BulkUploadFeedbackLabelsRequestSheetsSource sheetsSource;
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudContactcenterinsightsV1BulkUploadFeedbackLabelsRequestSheetsSource getSheetsSource() {
    return sheetsSource;
  }

  /**
   * A sheets document source.
   * @param sheetsSource sheetsSource or {@code null} for none
   */
  public GoogleCloudContactcenterinsightsV1BulkUploadFeedbackLabelsRequest setSheetsSource(GoogleCloudContactcenterinsightsV1BulkUploadFeedbackLabelsRequestSheetsSource sheetsSource) {
