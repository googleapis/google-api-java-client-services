...
public final class GoogleCloudContactcenterinsightsV1GeneratorSuggestion extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudContactcenterinsightsV1GeneratorSuggestion setAgentCoachingSuggestion(GoogleCloudContactcenterinsightsV1AgentCoachingSuggestion agentCoachingSuggestion) {
   ...
   */
  public GoogleCloudContactcenterinsightsV1GeneratorSuggestion setFreeFormSuggestion(GoogleCloudContactcenterinsightsV1FreeFormSuggestion freeFormSuggestion) {
   ...
   */
  public GoogleCloudContactcenterinsightsV1GeneratorSuggestion setSummarySuggestion(GoogleCloudContactcenterinsightsV1SummarySuggestion summarySuggestion) {
    this.summarySuggestion = summarySuggestion;
    return this;
  }

  @Override
  public GoogleCloudContactcenterinsightsV1GeneratorSuggestion set(String fieldName, Object value) {
    return (GoogleCloudContactcenterinsightsV1GeneratorSuggestion) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudContactcenterinsightsV1GeneratorSuggestion clone() {
