...
public final class VoterInfoResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<StreetSegment> segments;

  static {
    // hack to force ProGuard to consider StreetSegment used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(StreetSegment.class);
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<StreetSegment> getSegments() {
    return segments;
  }
   ...
   */
  public VoterInfoResponse setSegments(java.util.List<StreetSegment> segments) {
