...
public class AdExchangeBuyer extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class DirectDeals {
    ...
    public class Get extends AdExchangeBuyerRequest<com.google.adexchangebuyer.model.DirectDeal> {
      ...
      protected Get(java.lang.Long id) {
        super(AdExchangeBuyer.this, "GET", REST_PATH, null, com.google.adexchangebuyer.model.DirectDeal.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class List extends AdExchangeBuyerRequest<com.google.adexchangebuyer.model.DirectDealsList> {
       ...
       */
      protected List() {
        super(AdExchangeBuyer.this, "GET", REST_PATH, null, com.google.adexchangebuyer.model.DirectDealsList.class);
      }
