...
public final class Hl7V2NotificationConfig extends com.google.api.client.json.GenericJson {
   ...
   * example, `send_time < "2017-01-02T00:00:00-05:00"`. * `send_facility`, the care center that the
   * message came from, from the MSH-4 segment. For example, `send_facility = "ABC"`. *
