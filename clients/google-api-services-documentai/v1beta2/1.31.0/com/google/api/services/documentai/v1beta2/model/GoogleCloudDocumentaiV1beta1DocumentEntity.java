...
public final class GoogleCloudDocumentaiV1beta1DocumentEntity extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDocumentaiV1beta1DocumentPageAnchor pageAnchor;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDocumentaiV1beta1DocumentEntity> properties;
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageAnchor getPageAnchor() {
    return pageAnchor;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setPageAnchor(GoogleCloudDocumentaiV1beta1DocumentPageAnchor pageAnchor) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDocumentaiV1beta1DocumentEntity> getProperties() {
    return properties;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setProperties(java.util.List<GoogleCloudDocumentaiV1beta1DocumentEntity> properties) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setProvenance(GoogleCloudDocumentaiV1beta1DocumentProvenance provenance) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setTextAnchor(GoogleCloudDocumentaiV1beta1DocumentTextAnchor textAnchor) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentEntity setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentEntity set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta1DocumentEntity) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentEntity clone() {
    return (GoogleCloudDocumentaiV1beta1DocumentEntity) super.clone();
  }
