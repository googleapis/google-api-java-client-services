...
public final class SetLabelsRequest extends com.google.api.client.json.GenericJson {
   ...
   * fingerprint is initially generated by Kubernetes Engine and changes after every request to
   * modify or update labels. You must always provide an up-to-date fingerprint hash when updating
   * or changing labels. Make a get() request to the resource to get the latest fingerprint.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
