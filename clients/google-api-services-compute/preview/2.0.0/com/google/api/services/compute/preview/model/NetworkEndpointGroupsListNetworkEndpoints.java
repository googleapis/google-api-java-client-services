...
public final class NetworkEndpointGroupsListNetworkEndpoints extends com.google.api.client.json.GenericJson {
   ...
   */
  public NetworkEndpointGroupsListNetworkEndpoints setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkEndpointWithHealthStatus> getItems() {
    return items;
  }
   ...
   */
  public NetworkEndpointGroupsListNetworkEndpoints setItems(java.util.List<NetworkEndpointWithHealthStatus> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkEndpointGroupsListNetworkEndpoints setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkEndpointGroupsListNetworkEndpoints setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkEndpointGroupsListNetworkEndpoints set(String fieldName, Object value) {
    return (NetworkEndpointGroupsListNetworkEndpoints) super.set(fieldName, value);
  }

  @Override
  public NetworkEndpointGroupsListNetworkEndpoints clone() {
    return (NetworkEndpointGroupsListNetworkEndpoints) super.clone();
  }
