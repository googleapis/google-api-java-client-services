...
public final class InstancesResumeRequest extends com.google.api.client.json.GenericJson {

  /**
   * Array of disks associated with this instance that are protected with a customer-supplied
   * encryption key. In order to resume the instance, the disk url and its corresponding key must be
   ...
   */
  public InstancesResumeRequest setDisks(java.util.List<CustomerEncryptionKeyProtectedDisk> disks) {
    this.disks = disks;
    return this;
  }
  ...
  @Override
  public InstancesResumeRequest set(String fieldName, Object value) {
    return (InstancesResumeRequest) super.set(fieldName, value);
  }

  @Override
  public InstancesResumeRequest clone() {
    return (InstancesResumeRequest) super.clone();
  }
