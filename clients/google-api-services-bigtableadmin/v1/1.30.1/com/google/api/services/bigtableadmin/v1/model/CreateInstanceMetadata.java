...
public final class CreateInstanceMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private CreateInstanceRequest originalRequest;
   ...
   */
  public CreateInstanceMetadata setFinishTime(String finishTime) {
   ...
   * @return value or {@code null} for none
   */
  public CreateInstanceRequest getOriginalRequest() {
   ...
   */
  public CreateInstanceMetadata setOriginalRequest(CreateInstanceRequest originalRequest) {
   ...
   */
  public CreateInstanceMetadata setRequestTime(String requestTime) {
