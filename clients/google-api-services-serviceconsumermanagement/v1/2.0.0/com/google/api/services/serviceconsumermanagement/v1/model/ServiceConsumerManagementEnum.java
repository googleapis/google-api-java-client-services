...
public final class ServiceConsumerManagementEnum extends com.google.api.client.json.GenericJson {
   ...
   */
  public ServiceConsumerManagementEnum setEdition(java.lang.String edition) {
   ...
   */
  public ServiceConsumerManagementEnum setEnumvalue(java.util.List<EnumValue> enumvalue) {
   ...
   */
  public ServiceConsumerManagementEnum setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public ServiceConsumerManagementEnum setOptions(java.util.List<Option> options) {
   ...
   */
  public ServiceConsumerManagementEnum setSourceContext(SourceContext sourceContext) {
   ...
   */
  public ServiceConsumerManagementEnum setSyntax(java.lang.String syntax) {
    this.syntax = syntax;
    return this;
  }

  @Override
  public ServiceConsumerManagementEnum set(String fieldName, Object value) {
    return (ServiceConsumerManagementEnum) super.set(fieldName, value);
  }

  @Override
  public ServiceConsumerManagementEnum clone() {
    return (ServiceConsumerManagementEnum) super.clone();
  }
