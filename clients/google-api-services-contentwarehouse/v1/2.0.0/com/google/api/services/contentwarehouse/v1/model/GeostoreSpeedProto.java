...
public final class GeostoreSpeedProto extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GeostoreSpeedProto set(String fieldName, Object value) {
    return (GeostoreSpeedProto) super.set(fieldName, value);
  }

  @Override
  public GeostoreSpeedProto clone() {
    return (GeostoreSpeedProto) super.clone();
  }
