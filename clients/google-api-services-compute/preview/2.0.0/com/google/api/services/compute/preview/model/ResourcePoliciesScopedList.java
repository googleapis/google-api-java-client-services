...
public final class ResourcePoliciesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public ResourcePoliciesScopedList setResourcePolicies(java.util.List<ResourcePolicy> resourcePolicies) {
   ...
   */
  public ResourcePoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ResourcePoliciesScopedList set(String fieldName, Object value) {
    return (ResourcePoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public ResourcePoliciesScopedList clone() {
    return (ResourcePoliciesScopedList) super.clone();
  }
