  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Functions {
         ...
         * @param content the {@link com.google.api.services.cloudfunctions.v2alpha.model.CommitFunctionUpgradeAsGen2Request}
         * @return the request
         */
        public CommitFunctionUpgradeAsGen2 commitFunctionUpgradeAsGen2(java.lang.String name, com.google.api.services.cloudfunctions.v2alpha.model.CommitFunctionUpgradeAsGen2Request content) throws java.io.IOException {
          CommitFunctionUpgradeAsGen2 result = new CommitFunctionUpgradeAsGen2(name, content);
          initialize(result);
          return result;
        }

        public class CommitFunctionUpgradeAsGen2 extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2alpha.model.Operation> {

          private static final String REST_PATH = "v2alpha/{+name}:commitFunctionUpgradeAsGen2";
           ...
           * @since 1.13
           */
          protected CommitFunctionUpgradeAsGen2(java.lang.String name, com.google.api.services.cloudfunctions.v2alpha.model.CommitFunctionUpgradeAsGen2Request content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.api.services.cloudfunctions.v2alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
