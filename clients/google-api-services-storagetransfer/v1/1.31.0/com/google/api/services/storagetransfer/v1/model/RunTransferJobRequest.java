...
public final class RunTransferJobRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RunTransferJobRequest set(String fieldName, Object value) {
    return (RunTransferJobRequest) super.set(fieldName, value);
  }

  @Override
  public RunTransferJobRequest clone() {
    return (RunTransferJobRequest) super.clone();
  }
