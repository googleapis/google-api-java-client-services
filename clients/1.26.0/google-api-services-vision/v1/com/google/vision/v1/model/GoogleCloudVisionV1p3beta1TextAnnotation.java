...
public final class GoogleCloudVisionV1p3beta1TextAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<GoogleCloudVisionV1p3beta1Page> getPages() {
    return pages;
  }
   ...
   */
  public GoogleCloudVisionV1p3beta1TextAnnotation setPages(java.util.List<GoogleCloudVisionV1p3beta1Page> pages) {
    this.pages = pages;
    return this;
  }
   ...
   */
  public GoogleCloudVisionV1p3beta1TextAnnotation setText(java.lang.String text) {
    this.text = text;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p3beta1TextAnnotation set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p3beta1TextAnnotation) super.set(fieldName, value);
  }
