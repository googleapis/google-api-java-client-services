...
public final class GoogleCloudRetailV2betaOutputResult extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudRetailV2betaBigQueryOutputResult> bigqueryResult;

  static {
    // hack to force ProGuard to consider GoogleCloudRetailV2betaBigQueryOutputResult used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudRetailV2betaBigQueryOutputResult.class);
  }
  ...
  @Override
  public GoogleCloudRetailV2betaOutputResult set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaOutputResult) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaOutputResult clone() {
    return (GoogleCloudRetailV2betaOutputResult) super.clone();
  }
