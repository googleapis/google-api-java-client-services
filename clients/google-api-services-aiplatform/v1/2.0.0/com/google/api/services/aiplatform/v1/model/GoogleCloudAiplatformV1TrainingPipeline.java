...
public final class GoogleCloudAiplatformV1TrainingPipeline extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setCreateTime(String createTime) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setDisplayName(java.lang.String displayName) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setEncryptionSpec(GoogleCloudAiplatformV1EncryptionSpec encryptionSpec) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setEndTime(String endTime) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setError(GoogleRpcStatus error) {
    this.error = error;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setInputDataConfig(GoogleCloudAiplatformV1InputDataConfig inputDataConfig) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setModelId(java.lang.String modelId) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setModelToUpload(GoogleCloudAiplatformV1Model modelToUpload) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setParentModel(java.lang.String parentModel) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setStartTime(String startTime) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setState(java.lang.String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setTrainingTaskDefinition(java.lang.String trainingTaskDefinition) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setTrainingTaskInputs(java.lang.Object trainingTaskInputs) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setTrainingTaskMetadata(java.lang.Object trainingTaskMetadata) {
   ...
   */
  public GoogleCloudAiplatformV1TrainingPipeline setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1TrainingPipeline set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1TrainingPipeline) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1TrainingPipeline clone() {
