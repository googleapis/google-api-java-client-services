...
public class DoubleClickBidManager extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the DoubleClick Bid Manager API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Lineitems {
     ...
     * operation.
     *
     * @param content the {@link com.google.doubleclickbidmanager.model.DownloadLineItemsRequest}
     * @return the request
     */
    public Downloadlineitems downloadlineitems(com.google.doubleclickbidmanager.model.DownloadLineItemsRequest content) throws java.io.IOException {
      Downloadlineitems result = new Downloadlineitems(content);
      initialize(result);
      return result;
    }

    public class Downloadlineitems extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.DownloadLineItemsResponse> {
       ...
       * @since 1.13
       */
      protected Downloadlineitems(com.google.doubleclickbidmanager.model.DownloadLineItemsRequest content) {
        super(DoubleClickBidManager.this, "POST", REST_PATH, content, com.google.doubleclickbidmanager.model.DownloadLineItemsResponse.class);
      }
     ...
     * operation.
     *
     * @param content the {@link com.google.doubleclickbidmanager.model.UploadLineItemsRequest}
     * @return the request
     */
    public Uploadlineitems uploadlineitems(com.google.doubleclickbidmanager.model.UploadLineItemsRequest content) throws java.io.IOException {
      Uploadlineitems result = new Uploadlineitems(content);
      initialize(result);
      return result;
    }

    public class Uploadlineitems extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.UploadLineItemsResponse> {
       ...
       * @since 1.13
       */
      protected Uploadlineitems(com.google.doubleclickbidmanager.model.UploadLineItemsRequest content) {
        super(DoubleClickBidManager.this, "POST", REST_PATH, content, com.google.doubleclickbidmanager.model.UploadLineItemsResponse.class);
      }
  ...
  public class Queries {
     ...
     * operation.
     *
     * @param content the {@link com.google.doubleclickbidmanager.model.Query}
     * @return the request
     */
    public Createquery createquery(com.google.doubleclickbidmanager.model.Query content) throws java.io.IOException {
      Createquery result = new Createquery(content);
      initialize(result);
      return result;
    }

    public class Createquery extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.Query> {
       ...
       * @since 1.13
       */
      protected Createquery(com.google.doubleclickbidmanager.model.Query content) {
        super(DoubleClickBidManager.this, "POST", REST_PATH, content, com.google.doubleclickbidmanager.model.Query.class);
      }
    ...
    public class Getquery extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.Query> {
      ...
      protected Getquery(java.lang.Long queryId) {
        super(DoubleClickBidManager.this, "GET", REST_PATH, null, com.google.doubleclickbidmanager.model.Query.class);
        this.queryId = com.google.api.client.util.Preconditions.checkNotNull(queryId, "Required parameter queryId must be specified.");
      }
    ...
    public class Listqueries extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.ListQueriesResponse> {
      ...
      protected Listqueries() {
        super(DoubleClickBidManager.this, "GET", REST_PATH, null, com.google.doubleclickbidmanager.model.ListQueriesResponse.class);
      }
     ...
     * @param content the {@link com.google.doubleclickbidmanager.model.RunQueryRequest}
     * @return the request
     */
    public Runquery runquery(java.lang.Long queryId, com.google.doubleclickbidmanager.model.RunQueryRequest content) throws java.io.IOException {
    ...
    public class Runquery extends DoubleClickBidManagerRequest<Void> {
       ...
       * @since 1.13
       */
      protected Runquery(java.lang.Long queryId, com.google.doubleclickbidmanager.model.RunQueryRequest content) {
  ...
  public class Reports {
    ...
    public class Listreports extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.ListReportsResponse> {
      ...
      protected Listreports(java.lang.Long queryId) {
        super(DoubleClickBidManager.this, "GET", REST_PATH, null, com.google.doubleclickbidmanager.model.ListReportsResponse.class);
        this.queryId = com.google.api.client.util.Preconditions.checkNotNull(queryId, "Required parameter queryId must be specified.");
      }
  ...
  public class Sdf {
     ...
     *
     * @param content the {@link com.google.doubleclickbidmanager.model.DownloadRequest}
     * @return the request
     */
    public Download download(com.google.doubleclickbidmanager.model.DownloadRequest content) throws java.io.IOException {
      Download result = new Download(content);
      initialize(result);
      return result;
    }

    public class Download extends DoubleClickBidManagerRequest<com.google.doubleclickbidmanager.model.DownloadResponse> {
       ...
       * @since 1.13
       */
      protected Download(com.google.doubleclickbidmanager.model.DownloadRequest content) {
        super(DoubleClickBidManager.this, "POST", REST_PATH, content, com.google.doubleclickbidmanager.model.DownloadResponse.class);
      }
