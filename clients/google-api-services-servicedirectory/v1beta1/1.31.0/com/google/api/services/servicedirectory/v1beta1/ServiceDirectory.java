        ...
        public class Services {
          ...
          public class Endpoints {
            ...
            public class List extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ListEndpointsResponse> {
             ...
             Of which `:` means `HAS`, and is roughly the same as `=` * `` must be the same data type as field *
             `` can be `AND`, `OR`, `NOT` Examples of valid filters: * `metadata.owner` returns endpoints that
             have a metadata with the key `owner`, this is the same as `metadata:owner` *
             `metadata.protocol=gRPC` returns endpoints that have key/value `protocol=gRPC` *
             ...
             endpoints, it returns no results For more information about filtering, see [API
             Filtering](https://aip.dev/160).
               */
              public java.lang.String getFilter() {
                return filter;
