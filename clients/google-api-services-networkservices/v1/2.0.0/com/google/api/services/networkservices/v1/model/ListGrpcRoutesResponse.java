...
public final class ListGrpcRoutesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GrpcRoute> grpcRoutes;

  static {
    // hack to force ProGuard to consider GrpcRoute used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GrpcRoute.class);
  }
   ...
   */
  public java.util.List<GrpcRoute> getGrpcRoutes() {
    return grpcRoutes;
  }

  /**
   * List of GrpcRoute resources.
   * @param grpcRoutes grpcRoutes or {@code null} for none
   */
  public ListGrpcRoutesResponse setGrpcRoutes(java.util.List<GrpcRoute> grpcRoutes) {
  ...
  @Override
  public ListGrpcRoutesResponse set(String fieldName, Object value) {
    return (ListGrpcRoutesResponse) super.set(fieldName, value);
  }

  @Override
  public ListGrpcRoutesResponse clone() {
    return (ListGrpcRoutesResponse) super.clone();
  }
