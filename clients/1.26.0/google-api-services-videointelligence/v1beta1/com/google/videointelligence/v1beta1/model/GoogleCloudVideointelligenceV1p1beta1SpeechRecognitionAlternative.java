...
public final class GoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative extends com.google.api.client.json.GenericJson {
   ...
   * rely on the `confidence` field as it is not guaranteed to be accurate or consistent. The
  ...
  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1p1beta1WordInfo used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1p1beta1WordInfo.class);
  }
