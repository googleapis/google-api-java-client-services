...
public final class RejectHubSpokeRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public RejectHubSpokeRequest setDetails(java.lang.String details) {
   ...
   */
  public RejectHubSpokeRequest setRequestId(java.lang.String requestId) {
   ...
   */
  public RejectHubSpokeRequest setSpokeUri(java.lang.String spokeUri) {
    this.spokeUri = spokeUri;
    return this;
  }

  @Override
  public RejectHubSpokeRequest set(String fieldName, Object value) {
    return (RejectHubSpokeRequest) super.set(fieldName, value);
  }

  @Override
  public RejectHubSpokeRequest clone() {
    return (RejectHubSpokeRequest) super.clone();
  }
