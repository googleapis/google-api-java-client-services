...
public final class GoogleCloudDiscoveryengineV1betaAssistAnswer extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1betaAssistAnswerReply> replies;
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAssistAnswer setConnectorDisplayNames(java.util.Map<String, java.lang.String> connectorDisplayNames) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAssistAnswer setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1betaAssistAnswerReply> getReplies() {
    return replies;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAssistAnswer setReplies(java.util.List<GoogleCloudDiscoveryengineV1betaAssistAnswerReply> replies) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAssistAnswer setState(java.lang.String state) {
    this.state = state;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaAssistAnswer set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaAssistAnswer) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaAssistAnswer clone() {
    return (GoogleCloudDiscoveryengineV1betaAssistAnswer) super.clone();
  }
