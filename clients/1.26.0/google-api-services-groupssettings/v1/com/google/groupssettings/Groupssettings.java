...
public class Groupssettings extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Groups Settings API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Groups {
    ...
    public class Get extends GroupssettingsRequest<com.google.groupssettings.model.Groups> {
      ...
      protected Get(java.lang.String groupUniqueId) {
        super(Groupssettings.this, "GET", REST_PATH, null, com.google.groupssettings.model.Groups.class);
     ...
     *
     * @param groupUniqueId The resource ID
     * @param content the {@link com.google.groupssettings.model.Groups}
     * @return the request
     */
    public Patch patch(java.lang.String groupUniqueId, com.google.groupssettings.model.Groups content) throws java.io.IOException {
      Patch result = new Patch(groupUniqueId, content);
      initialize(result);
      return result;
    }

    public class Patch extends GroupssettingsRequest<com.google.groupssettings.model.Groups> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String groupUniqueId, com.google.groupssettings.model.Groups content) {
        super(Groupssettings.this, "PATCH", REST_PATH, content, com.google.groupssettings.model.Groups.class);
        this.groupUniqueId = com.google.api.client.util.Preconditions.checkNotNull(groupUniqueId, "Required parameter groupUniqueId must be specified.");
        set("alt", "json");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String groupUniqueId, com.google.groupssettings.model.Groups content) throws java.io.IOException {
      Update result = new Update(groupUniqueId, content);
      initialize(result);
      return result;
    }

    public class Update extends GroupssettingsRequest<com.google.groupssettings.model.Groups> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String groupUniqueId, com.google.groupssettings.model.Groups content) {
        super(Groupssettings.this, "PUT", REST_PATH, content, com.google.groupssettings.model.Groups.class);
        this.groupUniqueId = com.google.api.client.util.Preconditions.checkNotNull(groupUniqueId, "Required parameter groupUniqueId must be specified.");
        set("alt", "json");
      }
