...
public final class WireGroupList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<WireGroup> items;

  static {
    // hack to force ProGuard to consider WireGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(WireGroup.class);
  }
   ...
   */
  public WireGroupList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public WireGroupList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<WireGroup> getItems() {
    return items;
  }
   ...
   */
  public WireGroupList setItems(java.util.List<WireGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public WireGroupList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public WireGroupList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public WireGroupList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public WireGroupList set(String fieldName, Object value) {
    return (WireGroupList) super.set(fieldName, value);
  }

  @Override
  public WireGroupList clone() {
    return (WireGroupList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for WireGroupListWarningData.
     */
