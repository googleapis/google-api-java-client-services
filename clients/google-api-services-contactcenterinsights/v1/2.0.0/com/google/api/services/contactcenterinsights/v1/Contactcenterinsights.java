      ...
      public class QaQuestionTags {
        ...
        public class List extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1ListQaQuestionTagsResponse> {
         ...
         `next_page_token` in the response indicates that more data is available.
          ...
          /**
           * Optional. The value returned by the last `ListQaQuestionTagsResponse`. This value
           * indicates that this is a continuation of a prior `ListQaQuestionTags` call and that the
         ...
         this is a continuation of a prior `ListQaQuestionTags` call and that the system should return the
         next page of data.
           */
          public java.lang.String getPageToken() {
            return pageToken;
