...
public final class ExportResourcesRequest extends com.google.api.client.json.GenericJson {
   ...
   * `roles/storage.objectAdmin` Cloud IAM roles on the Cloud Storage location. The exported outputs
   * are organized by FHIR resource types. The server creates one object per resource type. Each
