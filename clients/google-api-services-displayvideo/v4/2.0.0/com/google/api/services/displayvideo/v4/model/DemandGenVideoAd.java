...
public final class DemandGenVideoAd extends com.google.api.client.json.GenericJson {
   ...
   * `LEARN_MORE` * `GET_QUOTE` * `APPLY_NOW` * `SIGN_UP` * `CONTACT_US` * `SUBSCRIBE` * `DOWNLOAD`
   * * `BOOK_NOW` * `SHOP_NOW` * `BUY_NOW` * `DONATE_NOW` * `ORDER_NOW` * `PLAY_NOW` * `SEE_MORE` *
   ...
   */
  public DemandGenVideoAd setBusinessName(java.lang.String businessName) {
   ...
   */
  public DemandGenVideoAd setCallToAction(java.lang.String callToAction) {
   ...
   */
  public DemandGenVideoAd setCompanionBanner(ImageAsset companionBanner) {
   ...
   */
  public DemandGenVideoAd setDescriptions(java.util.List<java.lang.String> descriptions) {
   ...
   */
  public DemandGenVideoAd setDisplayUrlBreadcrumb1(java.lang.String displayUrlBreadcrumb1) {
   ...
   */
  public DemandGenVideoAd setDisplayUrlBreadcrumb2(java.lang.String displayUrlBreadcrumb2) {
   ...
   */
  public DemandGenVideoAd setFinalMobileUrl(java.lang.String finalMobileUrl) {
   ...
   */
  public DemandGenVideoAd setFinalUrl(java.lang.String finalUrl) {
   ...
   */
  public DemandGenVideoAd setFinalUrlSuffix(java.lang.String finalUrlSuffix) {
   ...
   */
  public DemandGenVideoAd setHeadlines(java.util.List<java.lang.String> headlines) {
   ...
   */
  public DemandGenVideoAd setLogo(ImageAsset logo) {
    this.logo = logo;
    return this;
  }
   ...
   */
  public DemandGenVideoAd setTrackingUrl(java.lang.String trackingUrl) {
   ...
   */
  public DemandGenVideoAd setUserSpecifiedTrackingUrl(java.lang.String userSpecifiedTrackingUrl) {
   ...
   */
  public DemandGenVideoAd setVideos(java.util.List<YoutubeVideoDetails> videos) {
    this.videos = videos;
    return this;
  }

  @Override
  public DemandGenVideoAd set(String fieldName, Object value) {
    return (DemandGenVideoAd) super.set(fieldName, value);
  }

  @Override
  public DemandGenVideoAd clone() {
    return (DemandGenVideoAd) super.clone();
  }
