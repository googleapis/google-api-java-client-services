...
/**
 * Model definition for HaControllerStatusFailoverProgressLastFailoverAttempt.
 *
...
public final class HaControllerStatusFailoverProgressLastFailoverAttempt extends com.google.api.client.json.GenericJson {
   ...
   */
  public HaControllerStatusFailoverProgressLastFailoverAttempt setErrors(Errors errors) {
    this.errors = errors;
    return this;
  }
   ...
   */
  public HaControllerStatusFailoverProgressLastFailoverAttempt setTimestamp(String timestamp) {
    this.timestamp = timestamp;
    return this;
  }

  @Override
  public HaControllerStatusFailoverProgressLastFailoverAttempt set(String fieldName, Object value) {
    return (HaControllerStatusFailoverProgressLastFailoverAttempt) super.set(fieldName, value);
  }

  @Override
  public HaControllerStatusFailoverProgressLastFailoverAttempt clone() {
    return (HaControllerStatusFailoverProgressLastFailoverAttempt) super.clone();
  }
  ...
  public static final class Errors extends com.google.api.client.json.GenericJson {
     ...
     */
    @com.google.api.client.util.Key
    private java.util.List<HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors> errors;

    static {
      // hack to force ProGuard to consider HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors used, since otherwise it would be stripped out
      // see https://github.com/google/google-api-java-client/issues/543
      com.google.api.client.util.Data.nullOf(HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors.class);
    }
     ...
     * @return value or {@code null} for none
     */
    public java.util.List<HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors> getErrors() {
      return errors;
    }
     ...
     * @param errors errors or {@code null} for none
     */
    public Errors setErrors(java.util.List<HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors> errors) {
      this.errors = errors;
      return this;
    }
    ...
    public static final class HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors extends com.google.api.client.json.GenericJson {
       ...
       */
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors setCode(java.lang.String code) {
        this.code = code;
        return this;
      }
       ...
       */
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors setErrorDetails(java.util.List<ErrorDetails> errorDetails) {
       ...
       */
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors setLocation(java.lang.String location) {
       ...
       */
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors setMessage(java.lang.String message) {
        this.message = message;
        return this;
      }

      @Override
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors set(String fieldName, Object value) {
        return (HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors) super.set(fieldName, value);
      }

      @Override
      public HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors clone() {
        return (HaControllerStatusFailoverProgressLastFailoverAttemptErrorsErrors) super.clone();
      }
