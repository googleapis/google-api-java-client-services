...
package com.google.serviceusage.v1;
...
public class ServiceUsage extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Operations {
     ...
     * @param content the {@link com.google.serviceusage.v1.model.CancelOperationRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.serviceusage.v1.model.CancelOperationRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends ServiceUsageRequest<com.google.serviceusage.v1.model.Empty> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.serviceusage.v1.model.CancelOperationRequest content) {
        super(ServiceUsage.this, "POST", REST_PATH, content, com.google.serviceusage.v1.model.Empty.class);
    ...
    public class Delete extends ServiceUsageRequest<com.google.serviceusage.v1.model.Empty> {
      ...
      protected Delete(java.lang.String name) {
        super(ServiceUsage.this, "DELETE", REST_PATH, null, com.google.serviceusage.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Get extends ServiceUsageRequest<com.google.serviceusage.v1.model.Operation> {
      ...
      protected Get(java.lang.String name) {
        super(ServiceUsage.this, "GET", REST_PATH, null, com.google.serviceusage.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends ServiceUsageRequest<com.google.serviceusage.v1.model.ListOperationsResponse> {
       ...
       */
      protected List() {
        super(ServiceUsage.this, "GET", REST_PATH, null, com.google.serviceusage.v1.model.ListOperationsResponse.class);
      }
  ...
  public class Services {
     ...
     *        projects.
     * @param content the {@link com.google.serviceusage.v1.model.BatchEnableServicesRequest}
     * @return the request
     */
    public BatchEnable batchEnable(java.lang.String parent, com.google.serviceusage.v1.model.BatchEnableServicesRequest content) throws java.io.IOException {
      BatchEnable result = new BatchEnable(parent, content);
      initialize(result);
      return result;
    }

    public class BatchEnable extends ServiceUsageRequest<com.google.serviceusage.v1.model.Operation> {
     ...
     *        projects.
       ...
       * @since 1.13
       */
      protected BatchEnable(java.lang.String parent, com.google.serviceusage.v1.model.BatchEnableServicesRequest content) {
        super(ServiceUsage.this, "POST", REST_PATH, content, com.google.serviceusage.v1.model.Operation.class);
     ...
     *        project ID).
     * @param content the {@link com.google.serviceusage.v1.model.DisableServiceRequest}
     * @return the request
     */
    public Disable disable(java.lang.String name, com.google.serviceusage.v1.model.DisableServiceRequest content) throws java.io.IOException {
      Disable result = new Disable(name, content);
      initialize(result);
      return result;
    }

    public class Disable extends ServiceUsageRequest<com.google.serviceusage.v1.model.Operation> {
     ...
     *        project ID).
       ...
       * @since 1.13
       */
      protected Disable(java.lang.String name, com.google.serviceusage.v1.model.DisableServiceRequest content) {
        super(ServiceUsage.this, "POST", REST_PATH, content, com.google.serviceusage.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
    ...
    where `123` is the project number (not
     *        project ID).
     * @param content the {@link com.google.serviceusage.v1.model.EnableServiceRequest}
     * @return the request
     */
    public Enable enable(java.lang.String name, com.google.serviceusage.v1.model.EnableServiceRequest content) throws java.io.IOException {
      Enable result = new Enable(name, content);
      initialize(result);
      return result;
    }

    public class Enable extends ServiceUsageRequest<com.google.serviceusage.v1.model.Operation> {
     ...
     *        project ID).
       ...
       * @since 1.13
       */
      protected Enable(java.lang.String name, com.google.serviceusage.v1.model.EnableServiceRequest content) {
        super(ServiceUsage.this, "POST", REST_PATH, content, com.google.serviceusage.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
    ...
    public class Get extends ServiceUsageRequest<com.google.serviceusage.v1.model.GoogleApiServiceusageV1Service> {
     ...
     *        project ID).
       ...
       */
      protected Get(java.lang.String name) {
        super(ServiceUsage.this, "GET", REST_PATH, null, com.google.serviceusage.v1.model.GoogleApiServiceusageV1Service.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends ServiceUsageRequest<com.google.serviceusage.v1.model.ListServicesResponse> {
     ...
     *        project number (not project ID).
      ...
      protected List(java.lang.String parent) {
        super(ServiceUsage.this, "GET", REST_PATH, null, com.google.serviceusage.v1.model.ListServicesResponse.class);
        this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
              "Parameter parent must conform to the pattern " +
