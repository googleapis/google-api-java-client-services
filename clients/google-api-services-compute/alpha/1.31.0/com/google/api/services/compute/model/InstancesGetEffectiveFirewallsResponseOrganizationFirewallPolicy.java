...
public final class InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy extends com.google.api.client.json.GenericJson {
   ...
   */
  public InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy setRules(java.util.List<SecurityPolicyRule> rules) {
    this.rules = rules;
    return this;
  }

  @Override
  public InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy set(String fieldName, Object value) {
    return (InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy) super.set(fieldName, value);
  }

  @Override
  public InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy clone() {
    return (InstancesGetEffectiveFirewallsResponseOrganizationFirewallPolicy) super.clone();
  }
