...
public final class DisksScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public DisksScopedList setDisks(java.util.List<Disk> disks) {
    this.disks = disks;
    return this;
  }
   ...
   */
  public DisksScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public DisksScopedList set(String fieldName, Object value) {
    return (DisksScopedList) super.set(fieldName, value);
  }

  @Override
  public DisksScopedList clone() {
    return (DisksScopedList) super.clone();
  }
