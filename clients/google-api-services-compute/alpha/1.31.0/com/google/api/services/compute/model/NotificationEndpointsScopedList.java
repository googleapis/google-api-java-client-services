...
public final class NotificationEndpointsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NotificationEndpoint> resources;
   ...
   */
  public java.util.List<NotificationEndpoint> getResources() {
    return resources;
  }
   ...
   */
  public NotificationEndpointsScopedList setResources(java.util.List<NotificationEndpoint> resources) {
   ...
   */
  public NotificationEndpointsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NotificationEndpointsScopedList set(String fieldName, Object value) {
    return (NotificationEndpointsScopedList) super.set(fieldName, value);
  }

  @Override
  public NotificationEndpointsScopedList clone() {
    return (NotificationEndpointsScopedList) super.clone();
  }
