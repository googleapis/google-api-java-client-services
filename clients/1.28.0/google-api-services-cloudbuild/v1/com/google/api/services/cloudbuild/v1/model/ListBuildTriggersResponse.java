...
public final class ListBuildTriggersResponse extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<BuildTrigger> getTriggers() {
    return triggers;
  }
   ...
   */
  public ListBuildTriggersResponse setTriggers(java.util.List<BuildTrigger> triggers) {
    this.triggers = triggers;
    return this;
  }

  @Override
  public ListBuildTriggersResponse set(String fieldName, Object value) {
    return (ListBuildTriggersResponse) super.set(fieldName, value);
  }

  @Override
  public ListBuildTriggersResponse clone() {
    return (ListBuildTriggersResponse) super.clone();
  }
