...
public final class LoyaltyObject extends com.google.api.client.json.GenericJson {
   ...
   * object. If a user had saved this loyalty card, then these linked_object_ids would be
   ...
   */
  public LoyaltyObject setLinkedObjectIds(java.util.List<java.lang.String> linkedObjectIds) {
   ...
   */
  public LoyaltyObject setMerchantLocations(java.util.List<MerchantLocation> merchantLocations) {
   ...
   */
  public LoyaltyObject setNotifyPreference(java.lang.String notifyPreference) {
