...
public final class GoogleCloudVisionV1p3beta1Paragraph extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudVisionV1p3beta1Paragraph setBoundingBox(GoogleCloudVisionV1p3beta1BoundingPoly boundingBox) {
   ...
   */
  public GoogleCloudVisionV1p3beta1Paragraph setConfidence(java.lang.Float confidence) {
   ...
   */
  public GoogleCloudVisionV1p3beta1Paragraph setProperty(GoogleCloudVisionV1p3beta1TextAnnotationTextProperty property) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1Word> getWords() {
    return words;
  }
   ...
   */
  public GoogleCloudVisionV1p3beta1Paragraph setWords(java.util.List<GoogleCloudVisionV1p3beta1Word> words) {
    this.words = words;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p3beta1Paragraph set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p3beta1Paragraph) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p3beta1Paragraph clone() {
    return (GoogleCloudVisionV1p3beta1Paragraph) super.clone();
  }
