...
public final class BackendServiceHAPolicyLeader extends com.google.api.client.json.GenericJson {
   ...
   *
   * The leader's backendGroup must already be specified as a backend of this backend service.
   * Removing a backend that is designated as the leader's backendGroup is not permitted.
   ...
   * haPolicy.leader.backendGroup until the leader is updated with another network endpoint, or the
