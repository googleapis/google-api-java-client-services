...
public class ServiceConsumerManagement extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Services {
     ...
     * <pre>
     *   {@code ServiceConsumerManagement serviceconsumermanagement = new ServiceConsumerManagement(...);}
     *   {@code ServiceConsumerManagement.Properties.List request = serviceconsumermanagement.properties().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    public class Properties {
      ...
      /**
       * Creates a consumer property. If the property already exists, this method fails with an
       * ALREADY_EXISTS error. For this failure case, the Status details field will contain the existing
       * property's value.
       *
       ...
       * any optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param parent Required. Name of the property to create. An example name would be:
       *        `services/serviceconsumermanagement.googleapis.com/projects/123`
       * @param content the {@link com.google.api.services.serviceconsumermanagement.v1beta1.model.V1Beta1ConsumerProperty}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.serviceconsumermanagement.v1beta1.model.V1Beta1ConsumerProperty content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends ServiceConsumerManagementRequest<com.google.api.services.serviceconsumermanagement.v1beta1.model.V1Beta1ConsumerProperty> {

        private static final String REST_PATH = "v1beta1/{+parent}/properties";
       ...
       *        `services/serviceconsumermanagement.googleapis.com/projects/123`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.serviceconsumermanagement.v1beta1.model.V1Beta1ConsumerProperty content) {
          super(ServiceConsumerManagement.this, "POST", REST_PATH, content, com.google.api.services.serviceconsumermanagement.v1beta1.model.V1Beta1ConsumerProperty.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
