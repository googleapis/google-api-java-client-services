...
public final class GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride setBaseVersion(java.lang.String baseVersion) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride setTools(java.util.List<java.util.Map<String, java.lang.Object>> tools) {
    this.tools = tools;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride clone() {
    return (GoogleCloudDiscoveryengineV1alphaBAPConfigToolspecOverride) super.clone();
  }
