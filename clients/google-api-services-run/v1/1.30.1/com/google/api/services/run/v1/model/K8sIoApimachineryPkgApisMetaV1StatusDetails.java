...
public final class K8sIoApimachineryPkgApisMetaV1StatusDetails extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<K8sIoApimachineryPkgApisMetaV1StatusCause> causes;

  static {
    // hack to force ProGuard to consider K8sIoApimachineryPkgApisMetaV1StatusCause used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(K8sIoApimachineryPkgApisMetaV1StatusCause.class);
  }
   ...
   */
  public java.util.List<K8sIoApimachineryPkgApisMetaV1StatusCause> getCauses() {
    return causes;
  }
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setCauses(java.util.List<K8sIoApimachineryPkgApisMetaV1StatusCause> causes) {
    this.causes = causes;
    return this;
  }
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setGroup(java.lang.String group) {
    this.group = group;
    return this;
  }
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setRetryAfterSeconds(java.lang.Integer retryAfterSeconds) {
   ...
   */
  public K8sIoApimachineryPkgApisMetaV1StatusDetails setUid(java.lang.String uid) {
    this.uid = uid;
    return this;
  }

  @Override
  public K8sIoApimachineryPkgApisMetaV1StatusDetails set(String fieldName, Object value) {
    return (K8sIoApimachineryPkgApisMetaV1StatusDetails) super.set(fieldName, value);
  }

  @Override
  public K8sIoApimachineryPkgApisMetaV1StatusDetails clone() {
    return (K8sIoApimachineryPkgApisMetaV1StatusDetails) super.clone();
  }
