...
public final class DeleteLustreInstance extends com.google.api.client.json.GenericJson {
   ...
   */
  public DeleteLustreInstance setLustre(java.lang.String lustre) {
    this.lustre = lustre;
    return this;
  }

  @Override
  public DeleteLustreInstance set(String fieldName, Object value) {
    return (DeleteLustreInstance) super.set(fieldName, value);
  }

  @Override
  public DeleteLustreInstance clone() {
    return (DeleteLustreInstance) super.clone();
  }
