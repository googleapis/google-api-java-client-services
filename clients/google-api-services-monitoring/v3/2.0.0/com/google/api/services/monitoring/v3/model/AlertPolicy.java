...
public final class AlertPolicy extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The severity of an alert policy indicates how important alerts generated by that
   * policy are. The severity level, if specified, will be displayed on the Incident detail page and
   * in notifications.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
