...
public final class GoogleCloudServicebrokerV1alpha1Service extends com.google.api.client.json.GenericJson {
  ...
  private GoogleCloudServicebrokerV1alpha1DashboardClient dashboardClient;
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("instance_retrievable")
  private java.lang.Boolean instanceRetrievable;
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setBindable(java.lang.Boolean bindable) {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setBindingRetrievable(java.lang.Boolean bindingRetrievable) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudServicebrokerV1alpha1DashboardClient getDashboardClient() {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setDashboardClient(GoogleCloudServicebrokerV1alpha1DashboardClient dashboardClient) {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Boolean getInstanceRetrievable() {
    return instanceRetrievable;
  }

  /**
   * Whether the service provides an endpoint to get service instances.
   * @param instanceRetrievable instanceRetrievable or {@code null} for none
   */
  public GoogleCloudServicebrokerV1alpha1Service setInstanceRetrievable(java.lang.Boolean instanceRetrievable) {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setMetadata(java.util.Map<String, java.lang.Object> metadata) {
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setPlanUpdateable(java.lang.Boolean planUpdateable) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudServicebrokerV1alpha1Plan> getPlans() {
    return plans;
  }
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setPlans(java.util.List<GoogleCloudServicebrokerV1alpha1Plan> plans) {
    this.plans = plans;
    return this;
  }
   ...
   */
  public GoogleCloudServicebrokerV1alpha1Service setTags(java.util.List<java.lang.String> tags) {
    this.tags = tags;
    return this;
  }

  @Override
  public GoogleCloudServicebrokerV1alpha1Service set(String fieldName, Object value) {
    return (GoogleCloudServicebrokerV1alpha1Service) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudServicebrokerV1alpha1Service clone() {
    return (GoogleCloudServicebrokerV1alpha1Service) super.clone();
  }
