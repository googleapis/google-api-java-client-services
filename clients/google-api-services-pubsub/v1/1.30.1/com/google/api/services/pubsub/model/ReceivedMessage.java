...
public final class ReceivedMessage extends com.google.api.client.json.GenericJson {
   ...
   *
   * More precisely, this is 1 + (number of NACKs) + (number of ack_deadline exceeds) for this
   * message.
   *
   ...
   *
   * Upon the first delivery of a given message, `delivery_attempt` will have a value of 1. The
   * value is calculated at best effort and is approximate.
   *
