  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Jobs {
        ...
        public class GetIamPolicy extends BatchRequest<com.google.api.services.batch.v1.model.Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(Batch.this, "GET", REST_PATH, null, com.google.api.services.batch.v1.model.Policy.class);
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.batch.v1.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.batch.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends BatchRequest<com.google.api.services.batch.v1.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.batch.v1.model.SetIamPolicyRequest content) {
            super(Batch.this, "POST", REST_PATH, content, com.google.api.services.batch.v1.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.batch.v1.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.batch.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends BatchRequest<com.google.api.services.batch.v1.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.batch.v1.model.TestIamPermissionsRequest content) {
            super(Batch.this, "POST", REST_PATH, content, com.google.api.services.batch.v1.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
       ...
       * <pre>
       *   {@code Batch batch = new Batch(...);}
       *   {@code Batch.Nodes.List request = batch.nodes().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Nodes {
         ...
         * does not have a policy set.
         *
         * Create a request for the method "nodes.getIamPolicy".
         *
         * This request holds the parameters needed by the batch server.  After setting any optional
         * parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote operation.
         *
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "nodes.setIamPolicy".
         *
         * This request holds the parameters needed by the batch server.  After setting any optional
         * parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote operation.
         *
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "nodes.testIamPermissions".
         *
         * This request holds the parameters needed by the batch server.  After setting any optional
         * parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote operation.
         *
      ...
      public class Tasks {
        ...
        public class GetIamPolicy extends BatchRequest<com.google.api.services.batch.v1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/tasks/[^/]+$");
