 ...
 *
 * Note: when color equality needs to be decided, implementations, unless documented otherwise, will
 * treat two colors to be equal if all their red, green, blue and alpha values each differ by at
 * most 1e-5.
 *
 * Example (Java):
 *
