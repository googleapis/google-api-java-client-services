...
public final class ConnectorsLogConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ConnectorsLogConfig set(String fieldName, Object value) {
    return (ConnectorsLogConfig) super.set(fieldName, value);
  }

  @Override
  public ConnectorsLogConfig clone() {
    return (ConnectorsLogConfig) super.clone();
  }
