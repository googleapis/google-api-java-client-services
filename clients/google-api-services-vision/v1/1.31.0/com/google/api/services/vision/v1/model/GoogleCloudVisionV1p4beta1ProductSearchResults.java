...
public final class GoogleCloudVisionV1p4beta1ProductSearchResults extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult> productGroupedResults;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult> getProductGroupedResults() {
   ...
   */
  public GoogleCloudVisionV1p4beta1ProductSearchResults setProductGroupedResults(java.util.List<GoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult> productGroupedResults) {
   ...
   */
  public GoogleCloudVisionV1p4beta1ProductSearchResults setResults(java.util.List<GoogleCloudVisionV1p4beta1ProductSearchResultsResult> results) {
    this.results = results;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p4beta1ProductSearchResults set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p4beta1ProductSearchResults) super.set(fieldName, value);
  }
