...
public final class Aggregation extends com.google.api.client.json.GenericJson {
   ...
   * aligner can be applied to the data.The value must be at least 60 seconds, at most 104 weeks. If
   * a per-series aligner other than ALIGN_NONE is specified, this field is required or an error is
   * returned. If no per-series aligner is specified, or the aligner ALIGN_NONE is specified, then
   * this field is ignored.The maximum value of the alignment_period is 2 years, or 104 weeks.
