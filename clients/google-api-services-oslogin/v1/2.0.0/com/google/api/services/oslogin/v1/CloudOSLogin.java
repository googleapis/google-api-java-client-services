...
public class CloudOSLogin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Users {
    ...
    public class SshPublicKeys {
       ...
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.oslogin.v1.model.SshPublicKey content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudOSLoginRequest<com.google.api.services.oslogin.v1.model.SshPublicKey> {

        private static final String REST_PATH = "v1/{+parent}/sshPublicKeys";
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.oslogin.v1.model.SshPublicKey content) {
          super(CloudOSLogin.this, "POST", REST_PATH, content, com.google.api.services.oslogin.v1.model.SshPublicKey.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
