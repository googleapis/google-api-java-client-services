...
public final class Creative extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Click-through URL for backup image. Applicable to the following creative types: FLASH_INPAGE,
   * and HTML5_BANNER. Applicable to DISPLAY when the primary asset type is not HTML_IMAGE.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * VPAID and all INSTREAM_VIDEO with dynamicAssetSelection set to false.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
   ...
   * rendering in in-stream video ads developed with the VAST standard. Applicable to all creative
   * types.
   *
  ...
  /**
   * Third-party URLs for tracking in-stream video creative events. Applicable to the following
  ...
  /**
   * Description of the video ad. Applicable to the following creative types: all INSTREAM_VIDEO and
   * all VPAID.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Creative video duration in seconds. This is a read-only field. Applicable to the following
   * creative types: INSTREAM_VIDEO, all RICH_MEDIA, and all VPAID.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public Creative setBackupImageClickThroughUrl(java.lang.String backupImageClickThroughUrl) {
   ...
   * Description of the video ad. Applicable to the following creative types: all INSTREAM_VIDEO and
   * all VPAID.
   * @param videoDescription videoDescription or {@code null} for none
   */
  public Creative setVideoDescription(java.lang.String videoDescription) {
   ...
   */
  public Creative setVideoDuration(java.lang.Float videoDuration) {
