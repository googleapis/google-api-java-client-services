...
public final class GoogleIamV1ResourcePolicyMember extends com.google.api.client.json.GenericJson {
   ...
   * the same name, the binding will not be applicable to the new resourceExample:
   ...
   */
  public GoogleIamV1ResourcePolicyMember setIamPolicyNamePrincipal(java.lang.String iamPolicyNamePrincipal) {
   ...
   */
  public GoogleIamV1ResourcePolicyMember setIamPolicyUidPrincipal(java.lang.String iamPolicyUidPrincipal) {
    this.iamPolicyUidPrincipal = iamPolicyUidPrincipal;
    return this;
  }

  @Override
  public GoogleIamV1ResourcePolicyMember set(String fieldName, Object value) {
    return (GoogleIamV1ResourcePolicyMember) super.set(fieldName, value);
  }

  @Override
  public GoogleIamV1ResourcePolicyMember clone() {
    return (GoogleIamV1ResourcePolicyMember) super.clone();
  }
