 ...
 * "roles/viewer",       "members": ["user:sean@example.com"]     }   ] } YAML Example bindings: -
 ...
 * user:sean@example.com   role: roles/viewer For a description of IAM and its features, see the IAM
...
public final class Policy extends com.google.api.client.json.GenericJson {
   ...
   * value will be rejected.Policies with any conditional bindings must specify version 3. Policies
