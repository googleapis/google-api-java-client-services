...
public final class RemovePrewarmedArtifactResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public RemovePrewarmedArtifactResponse setPrewarmedArtifact(PrewarmedArtifact prewarmedArtifact) {
    this.prewarmedArtifact = prewarmedArtifact;
    return this;
  }

  @Override
  public RemovePrewarmedArtifactResponse set(String fieldName, Object value) {
    return (RemovePrewarmedArtifactResponse) super.set(fieldName, value);
  }

  @Override
  public RemovePrewarmedArtifactResponse clone() {
    return (RemovePrewarmedArtifactResponse) super.clone();
  }
