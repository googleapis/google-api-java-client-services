...
public final class PublicAdvertisedPrefixList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<PublicAdvertisedPrefix> items;

  static {
    // hack to force ProGuard to consider PublicAdvertisedPrefix used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(PublicAdvertisedPrefix.class);
  }
   ...
   */
  public PublicAdvertisedPrefixList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<PublicAdvertisedPrefix> getItems() {
    return items;
  }
   ...
   */
  public PublicAdvertisedPrefixList setItems(java.util.List<PublicAdvertisedPrefix> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public PublicAdvertisedPrefixList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public PublicAdvertisedPrefixList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public PublicAdvertisedPrefixList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public PublicAdvertisedPrefixList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PublicAdvertisedPrefixList set(String fieldName, Object value) {
    return (PublicAdvertisedPrefixList) super.set(fieldName, value);
  }

  @Override
  public PublicAdvertisedPrefixList clone() {
    return (PublicAdvertisedPrefixList) super.clone();
  }
