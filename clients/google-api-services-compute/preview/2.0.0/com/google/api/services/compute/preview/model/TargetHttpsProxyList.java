...
public final class TargetHttpsProxyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetHttpsProxy> items;

  static {
    // hack to force ProGuard to consider TargetHttpsProxy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetHttpsProxy.class);
  }

  /**
   * Output only. Type of resource. Always compute#targetHttpsProxyList for lists of target HTTPS
   * proxies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public TargetHttpsProxyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetHttpsProxy> getItems() {
    return items;
  }
   ...
   */
  public TargetHttpsProxyList setItems(java.util.List<TargetHttpsProxy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetHttpsProxyList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetHttpsProxyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetHttpsProxyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetHttpsProxyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetHttpsProxyList set(String fieldName, Object value) {
    return (TargetHttpsProxyList) super.set(fieldName, value);
  }

  @Override
  public TargetHttpsProxyList clone() {
    return (TargetHttpsProxyList) super.clone();
  }
