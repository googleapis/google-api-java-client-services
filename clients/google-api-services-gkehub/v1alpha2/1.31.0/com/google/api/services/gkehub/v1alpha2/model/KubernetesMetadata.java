...
/**
 * KubernetesMetadata provides informational metadata for Memberships that are created from
 * Kubernetes Endpoints (currently, these are equivalent to Kubernetes clusters).
 *
