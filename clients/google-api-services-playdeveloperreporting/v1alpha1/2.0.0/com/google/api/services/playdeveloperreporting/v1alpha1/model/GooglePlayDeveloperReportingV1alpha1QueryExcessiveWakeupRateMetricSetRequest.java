...
public final class GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest setDimensions(java.util.List<java.lang.String> dimensions) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest setMetrics(java.util.List<java.lang.String> metrics) {
  ...
  @Override
  public GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest clone() {
    return (GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest) super.clone();
  }
