# Cloud Deploy API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1-rev20240131-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-clouddeploy:v1-rev20240131-2.0.0'
}
```
