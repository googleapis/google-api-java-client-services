...
public class FirebaseDynamicLinks extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Firebase Dynamic Links API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class ManagedShortLinks {
     ...
     *
     * @param content the {@link com.google.firebasedynamiclinks.v1.model.CreateManagedShortLinkRequest}
     * @return the request
     */
    public Create create(com.google.firebasedynamiclinks.v1.model.CreateManagedShortLinkRequest content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends FirebaseDynamicLinksRequest<com.google.firebasedynamiclinks.v1.model.CreateManagedShortLinkResponse> {
       ...
       * @since 1.13
       */
      protected Create(com.google.firebasedynamiclinks.v1.model.CreateManagedShortLinkRequest content) {
        super(FirebaseDynamicLinks.this, "POST", REST_PATH, content, com.google.firebasedynamiclinks.v1.model.CreateManagedShortLinkResponse.class);
      }
  ...
  public class ShortLinks {
     ...
     * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.firebasedynamiclinks.v1.model.CreateShortDynamicLinkRequest}
     * @return the request
     */
    public Create create(com.google.firebasedynamiclinks.v1.model.CreateShortDynamicLinkRequest content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends FirebaseDynamicLinksRequest<com.google.firebasedynamiclinks.v1.model.CreateShortDynamicLinkResponse> {
       ...
       * @since 1.13
       */
      protected Create(com.google.firebasedynamiclinks.v1.model.CreateShortDynamicLinkRequest content) {
        super(FirebaseDynamicLinks.this, "POST", REST_PATH, content, com.google.firebasedynamiclinks.v1.model.CreateShortDynamicLinkResponse.class);
      }
  ...
  public class V1 {
    ...
    public class GetLinkStats extends FirebaseDynamicLinksRequest<com.google.firebasedynamiclinks.v1.model.DynamicLinkStats> {
      ...
      protected GetLinkStats(java.lang.String dynamicLink) {
        super(FirebaseDynamicLinks.this, "GET", REST_PATH, null, com.google.firebasedynamiclinks.v1.model.DynamicLinkStats.class);
     ...
     * operation.
     *
     * @param content the {@link com.google.firebasedynamiclinks.v1.model.GetIosPostInstallAttributionRequest}
     * @return the request
     */
    public InstallAttribution installAttribution(com.google.firebasedynamiclinks.v1.model.GetIosPostInstallAttributionRequest content) throws java.io.IOException {
      InstallAttribution result = new InstallAttribution(content);
      initialize(result);
      return result;
    }

    public class InstallAttribution extends FirebaseDynamicLinksRequest<com.google.firebasedynamiclinks.v1.model.GetIosPostInstallAttributionResponse> {
       ...
       * @since 1.13
       */
      protected InstallAttribution(com.google.firebasedynamiclinks.v1.model.GetIosPostInstallAttributionRequest content) {
        super(FirebaseDynamicLinks.this, "POST", REST_PATH, content, com.google.firebasedynamiclinks.v1.model.GetIosPostInstallAttributionResponse.class);
      }
     ...
     * operation.
     *
     * @param content the {@link com.google.firebasedynamiclinks.v1.model.GetIosReopenAttributionRequest}
     * @return the request
     */
    public ReopenAttribution reopenAttribution(com.google.firebasedynamiclinks.v1.model.GetIosReopenAttributionRequest content) throws java.io.IOException {
      ReopenAttribution result = new ReopenAttribution(content);
      initialize(result);
      return result;
    }

    public class ReopenAttribution extends FirebaseDynamicLinksRequest<com.google.firebasedynamiclinks.v1.model.GetIosReopenAttributionResponse> {
       ...
       * @since 1.13
       */
      protected ReopenAttribution(com.google.firebasedynamiclinks.v1.model.GetIosReopenAttributionRequest content) {
        super(FirebaseDynamicLinks.this, "POST", REST_PATH, content, com.google.firebasedynamiclinks.v1.model.GetIosReopenAttributionResponse.class);
      }
