...
public final class JobRun extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Name of the `JobRun`. Format is `projects/{project}/locations/{location}/deliveryPipe
   * lines/{deliveryPipeline}/releases/{releases}/rollouts/{rollouts}/jobRuns/{uuid}`.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
