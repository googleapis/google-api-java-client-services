...
public final class LocationMetadata extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<java.lang.String> locationFeatures;

  /**
   * List of supported features
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getLocationFeatures() {
    return locationFeatures;
  }

  /**
   * List of supported features
   * @param locationFeatures locationFeatures or {@code null} for none
   */
  public LocationMetadata setLocationFeatures(java.util.List<java.lang.String> locationFeatures) {
