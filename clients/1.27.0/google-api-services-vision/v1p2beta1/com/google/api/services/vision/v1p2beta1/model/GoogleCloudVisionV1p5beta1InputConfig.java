...
public final class GoogleCloudVisionV1p5beta1InputConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudVisionV1p5beta1InputConfig setContent(java.lang.String content) {
   ...
   * @since 1.14
   */
  public GoogleCloudVisionV1p5beta1InputConfig encodeContent(byte[] content) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudVisionV1p5beta1GcsSource getGcsSource() {
    return gcsSource;
  }
   ...
   */
  public GoogleCloudVisionV1p5beta1InputConfig setGcsSource(GoogleCloudVisionV1p5beta1GcsSource gcsSource) {
  ...
  @Override
  public GoogleCloudVisionV1p5beta1InputConfig set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p5beta1InputConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p5beta1InputConfig clone() {
    return (GoogleCloudVisionV1p5beta1InputConfig) super.clone();
  }
