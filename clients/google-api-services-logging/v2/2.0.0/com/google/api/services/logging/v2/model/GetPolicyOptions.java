...
public final class GetPolicyOptions extends com.google.api.client.json.GenericJson {
   ...
   * may specify any valid value or leave the field unset.The policy in the response might use the
   * policy version that you specified, or it might use a lower policy version. For example, if you
   * specify version 3, but the policy has no conditional role bindings, the response uses version
   * 1.To learn which resources support conditions in their IAM policies, see the IAM documentation
