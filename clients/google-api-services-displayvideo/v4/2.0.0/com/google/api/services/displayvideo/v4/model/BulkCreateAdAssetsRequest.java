...
public final class BulkCreateAdAssetsRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public BulkCreateAdAssetsRequest set(String fieldName, Object value) {
    return (BulkCreateAdAssetsRequest) super.set(fieldName, value);
  }

  @Override
  public BulkCreateAdAssetsRequest clone() {
    return (BulkCreateAdAssetsRequest) super.clone();
  }
