...
public final class GoogleCloudRetailV2betaServingConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setBoostControlIds(java.util.List<java.lang.String> boostControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setDisplayName(java.lang.String displayName) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setDoNotAssociateControlIds(java.util.List<java.lang.String> doNotAssociateControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setDynamicFacetSpec(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec dynamicFacetSpec) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setEnableCategoryFilterLevel(java.lang.String enableCategoryFilterLevel) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setFacetControlIds(java.util.List<java.lang.String> facetControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setFilterControlIds(java.util.List<java.lang.String> filterControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setIgnoreControlIds(java.util.List<java.lang.String> ignoreControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setOnewaySynonymsControlIds(java.util.List<java.lang.String> onewaySynonymsControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setRedirectControlIds(java.util.List<java.lang.String> redirectControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setReplacementControlIds(java.util.List<java.lang.String> replacementControlIds) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setSolutionTypes(java.util.List<java.lang.String> solutionTypes) {
   ...
   */
  public GoogleCloudRetailV2betaServingConfig setTwowaySynonymsControlIds(java.util.List<java.lang.String> twowaySynonymsControlIds) {
    this.twowaySynonymsControlIds = twowaySynonymsControlIds;
    return this;
  }

  @Override
  public GoogleCloudRetailV2betaServingConfig set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaServingConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaServingConfig clone() {
