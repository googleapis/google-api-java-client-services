  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
        ...
        public class Cancel extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(SecretManager.this, "POST", REST_PATH, null, com.google.api.services.secretmanager.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
