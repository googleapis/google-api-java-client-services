...
public final class ReservationSubBlocksListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ReservationSubBlock> items;

  static {
    // hack to force ProGuard to consider ReservationSubBlock used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ReservationSubBlock.class);
  }
   ...
   */
  public ReservationSubBlocksListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ReservationSubBlock> getItems() {
    return items;
  }
   ...
   */
  public ReservationSubBlocksListResponse setItems(java.util.List<ReservationSubBlock> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationSubBlocksListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ReservationSubBlocksListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationSubBlocksListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReservationSubBlocksListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationSubBlocksListResponse set(String fieldName, Object value) {
    return (ReservationSubBlocksListResponse) super.set(fieldName, value);
  }

  @Override
  public ReservationSubBlocksListResponse clone() {
    return (ReservationSubBlocksListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ReservationSubBlocksListResponseWarningData.
     */
