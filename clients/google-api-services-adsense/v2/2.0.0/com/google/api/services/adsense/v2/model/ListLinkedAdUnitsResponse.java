...
public final class ListLinkedAdUnitsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Continuation token used to page through ad units. To retrieve the next page of the results, set
   ...
   */
  public ListLinkedAdUnitsResponse setAdUnits(java.util.List<AdUnit> adUnits) {
   ...
   */
  public ListLinkedAdUnitsResponse setNextPageToken(java.lang.String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  @Override
  public ListLinkedAdUnitsResponse set(String fieldName, Object value) {
    return (ListLinkedAdUnitsResponse) super.set(fieldName, value);
  }

  @Override
  public ListLinkedAdUnitsResponse clone() {
    return (ListLinkedAdUnitsResponse) super.clone();
  }
