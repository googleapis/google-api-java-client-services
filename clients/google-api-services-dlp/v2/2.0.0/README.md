# Cloud Data Loss Prevention (DLP) API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v2-rev20221126-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-dlp:v2-rev20221126-2.0.0'
}
```
