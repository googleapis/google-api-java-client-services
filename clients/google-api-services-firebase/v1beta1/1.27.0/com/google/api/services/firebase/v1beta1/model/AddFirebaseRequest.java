...
public final class AddFirebaseRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Deprecated. Instead, call FinalizeDefaultLocation after you add Firebase services to your
   * project.
   *
   * The ID of the project's Cloud resource location. The location should be one of the AppEngine
   * locations defined here: https://cloud.google.com/appengine/docs/locations
