...
public final class ServiceAccount extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Email address of the service account. Defaults to `default`, which uses the compute service
  ...
  /**
   * List of scopes to be enabled for this service account on the VM. The following scopes are
