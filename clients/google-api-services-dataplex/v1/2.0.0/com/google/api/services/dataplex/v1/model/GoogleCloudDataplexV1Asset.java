...
public final class GoogleCloudDataplexV1Asset extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Specification of the discovery feature applied to data referenced by this asset. When
   * this spec is left unset, the asset will use the spec set on the parent zone.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudDataplexV1Asset setDiscoverySpec(GoogleCloudDataplexV1AssetDiscoverySpec discoverySpec) {
   ...
   */
  public GoogleCloudDataplexV1Asset setDiscoveryStatus(GoogleCloudDataplexV1AssetDiscoveryStatus discoveryStatus) {
   ...
   */
  public GoogleCloudDataplexV1Asset setResourceSpec(GoogleCloudDataplexV1AssetResourceSpec resourceSpec) {
   ...
   */
  public GoogleCloudDataplexV1Asset setResourceStatus(GoogleCloudDataplexV1AssetResourceStatus resourceStatus) {
   ...
   */
  public GoogleCloudDataplexV1Asset setSecurityStatus(GoogleCloudDataplexV1AssetSecurityStatus securityStatus) {
