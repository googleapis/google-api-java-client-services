...
public final class Instance extends com.google.api.client.json.GenericJson {
   ...
   *
   * If you are creating a new instance, this field will encrypt the local SSD and in-memory
   * contents of the instance during the suspend operation.
   *
   * If you do not provide an encryption key when creating the instance, then the local SSD and in-
   * memory contents will be encrypted using an automatically generated key during the suspend
   * operation.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   *
   * To create acustom machine type, provide a URL to a machine type in the following format, where
  ...
  /**
   * Specifies aminimum CPU platform for the VM instance. Applicable values are the friendly names
   ...
   * used to authenticate applications on the instance. SeeService Accounts for more information.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * modified by the setTags method. Each tag within the list must comply withRFC1035. Multiple tags
  ...
  /**
   * Output only. [Output Only] DEPRECATED: Please useresource_status.upcoming_maintenance instead.
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Long getPreservedStateSizeGb() {
    return preservedStateSizeGb;
  }

  /**
   * Output only. Total amount of preserved state for SUSPENDED instances. Read-only in the api.
   * @param preservedStateSizeGb preservedStateSizeGb or {@code null} for none
   */
  public Instance setPreservedStateSizeGb(java.lang.Long preservedStateSizeGb) {
   ...
   */
  public Instance setSelfLinkWithId(java.lang.String selfLinkWithId) {
