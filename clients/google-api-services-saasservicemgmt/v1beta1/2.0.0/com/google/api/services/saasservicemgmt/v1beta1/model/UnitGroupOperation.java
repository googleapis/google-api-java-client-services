...
public final class UnitGroupOperation extends com.google.api.client.json.GenericJson {
   ...
   */
  public UnitGroupOperation setAnnotations(java.util.Map<String, java.lang.String> annotations) {
   ...
   */
  public UnitGroupOperation setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public UnitGroupOperation setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public UnitGroupOperation setUid(java.lang.String uid) {
    this.uid = uid;
    return this;
  }
   ...
   */
  public UnitGroupOperation setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public UnitGroupOperation set(String fieldName, Object value) {
    return (UnitGroupOperation) super.set(fieldName, value);
  }

  @Override
  public UnitGroupOperation clone() {
    return (UnitGroupOperation) super.clone();
  }
