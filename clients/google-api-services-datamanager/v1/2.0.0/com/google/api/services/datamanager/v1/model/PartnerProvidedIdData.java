...
public final class PartnerProvidedIdData extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public PartnerProvidedIdData set(String fieldName, Object value) {
    return (PartnerProvidedIdData) super.set(fieldName, value);
  }

  @Override
  public PartnerProvidedIdData clone() {
    return (PartnerProvidedIdData) super.clone();
  }
