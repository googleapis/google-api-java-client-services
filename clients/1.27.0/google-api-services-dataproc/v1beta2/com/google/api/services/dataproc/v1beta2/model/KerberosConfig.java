...
public final class KerberosConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The GCS uri of a KMS encrypted file containing the shared password between the on-
   * cluster Kerberos realm and the remote trusted realm, in a cross realm trust relationship.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. The GCS uri of a KMS encrypted file containing the master key of the KDC database.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. The GCS uri of a KMS encrypted file containing the password to the user provided key.
  ...
  /**
   * Optional. The GCS uri of a KMS encrypted file containing the password to the user provided
  ...
  /**
   * Optional. The GCS uri of the keystore file used for SSL encryption. If not provided, Dataproc
  ...
  /**
   * Required. The GCS uri of a KMS encrypted file containing the root principal password.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. The GCS uri of the truststore file used for SSL encryption. If not provided, Dataproc
   * will provide a self-signed certificate.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
