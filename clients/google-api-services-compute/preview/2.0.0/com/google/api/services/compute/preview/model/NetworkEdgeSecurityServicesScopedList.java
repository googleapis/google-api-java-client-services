...
public final class NetworkEdgeSecurityServicesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NetworkEdgeSecurityService> networkEdgeSecurityServices;

  static {
    // hack to force ProGuard to consider NetworkEdgeSecurityService used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkEdgeSecurityService.class);
  }
   ...
   */
  public java.util.List<NetworkEdgeSecurityService> getNetworkEdgeSecurityServices() {
    return networkEdgeSecurityServices;
  }

  /**
   * A list of NetworkEdgeSecurityServices contained in this scope.
   * @param networkEdgeSecurityServices networkEdgeSecurityServices or {@code null} for none
   */
  public NetworkEdgeSecurityServicesScopedList setNetworkEdgeSecurityServices(java.util.List<NetworkEdgeSecurityService> networkEdgeSecurityServices) {
   ...
   */
  public NetworkEdgeSecurityServicesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkEdgeSecurityServicesScopedList set(String fieldName, Object value) {
    return (NetworkEdgeSecurityServicesScopedList) super.set(fieldName, value);
  }

  @Override
  public NetworkEdgeSecurityServicesScopedList clone() {
    return (NetworkEdgeSecurityServicesScopedList) super.clone();
  }
