...
public final class GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec setContainerConcurrency(java.lang.Integer containerConcurrency) {
   ...
   */
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec setPscInterfaceConfig(GoogleCloudAiplatformV1PscInterfaceConfig pscInterfaceConfig) {
   ...
   */
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec setResourceLimits(java.util.Map<String, java.lang.String> resourceLimits) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1SecretEnvVar> getSecretEnv() {
    return secretEnv;
  }
   ...
   */
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec setSecretEnv(java.util.List<GoogleCloudAiplatformV1SecretEnvVar> secretEnv) {
    this.secretEnv = secretEnv;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec clone() {
    return (GoogleCloudAiplatformV1ReasoningEngineSpecDeploymentSpec) super.clone();
  }
