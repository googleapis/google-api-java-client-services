...
public final class HealthCheckServicesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<HealthCheckService> resources;

  static {
    // hack to force ProGuard to consider HealthCheckService used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(HealthCheckService.class);
  }
   ...
   */
  public java.util.List<HealthCheckService> getResources() {
    return resources;
  }
   ...
   */
  public HealthCheckServicesScopedList setResources(java.util.List<HealthCheckService> resources) {
   ...
   */
  public HealthCheckServicesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthCheckServicesScopedList set(String fieldName, Object value) {
    return (HealthCheckServicesScopedList) super.set(fieldName, value);
  }

  @Override
  public HealthCheckServicesScopedList clone() {
    return (HealthCheckServicesScopedList) super.clone();
  }
