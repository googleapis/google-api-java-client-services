...
public final class GoogleCloudDiscoveryengineV1UserInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserInfo setTimeZone(java.lang.String timeZone) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserInfo setUserAgent(java.lang.String userAgent) {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserInfo setUserId(java.lang.String userId) {
    this.userId = userId;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserInfo set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1UserInfo) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserInfo clone() {
    return (GoogleCloudDiscoveryengineV1UserInfo) super.clone();
  }
