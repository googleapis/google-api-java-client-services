...
public final class LicenseParams extends com.google.api.client.json.GenericJson {

  /**
   * Input only. Resource manager tags to be bound to the license. Tag keys and values have the same
   ...
   */
  public LicenseParams setResourceManagerTags(java.util.Map<String, java.lang.String> resourceManagerTags) {
    this.resourceManagerTags = resourceManagerTags;
    return this;
  }

  @Override
  public LicenseParams set(String fieldName, Object value) {
    return (LicenseParams) super.set(fieldName, value);
  }

  @Override
  public LicenseParams clone() {
    return (LicenseParams) super.clone();
  }
