...
public final class V1Beta1ConsumerQuotaLimit extends com.google.api.client.json.GenericJson {
   ...
   *
   * An example name would be: `services/compute.googleapis.com/projects/123/quotas/metrics/compute.
   ...
   */
  public V1Beta1ConsumerQuotaLimit setIsPrecise(java.lang.Boolean isPrecise) {
   ...
   */
  public V1Beta1ConsumerQuotaLimit setMetric(java.lang.String metric) {
    this.metric = metric;
    return this;
  }
   ...
   */
  public V1Beta1ConsumerQuotaLimit setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<V1Beta1QuotaBucket> getQuotaBuckets() {
    return quotaBuckets;
  }
   ...
   */
  public V1Beta1ConsumerQuotaLimit setUnit(java.lang.String unit) {
    this.unit = unit;
    return this;
  }

  @Override
  public V1Beta1ConsumerQuotaLimit set(String fieldName, Object value) {
    return (V1Beta1ConsumerQuotaLimit) super.set(fieldName, value);
  }
