...
public final class HeldMailQuery extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public HeldMailQuery set(String fieldName, Object value) {
    return (HeldMailQuery) super.set(fieldName, value);
  }

  @Override
  public HeldMailQuery clone() {
    return (HeldMailQuery) super.clone();
  }
