...
/**
 * Basis describes the base image portion (Note) of the DockerImage relationship.  Linked
 * occurrences are derived from this or an equivalent image via:   FROM  Or an equivalent reference,
