...
public final class GoogleCloudPolicysimulatorV1alphaReplayResult extends com.google.api.client.json.GenericJson {
  ...
  private GoogleCloudPolicysimulatorV1alphaAccessTuple accessTuple;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudPolicysimulatorV1alphaReplayDiff diff;
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaAccessTuple getAccessTuple() {
    return accessTuple;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayResult setAccessTuple(GoogleCloudPolicysimulatorV1alphaAccessTuple accessTuple) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudPolicysimulatorV1alphaReplayDiff getDiff() {
    return diff;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayResult setDiff(GoogleCloudPolicysimulatorV1alphaReplayDiff diff) {
    this.diff = diff;
    return this;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayResult setError(GoogleRpcStatus error) {
    this.error = error;
    return this;
  }
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayResult setLastSeenDate(GoogleTypeDate lastSeenDate) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayResult setParent(java.lang.String parent) {
    this.parent = parent;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaReplayResult set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1alphaReplayResult) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaReplayResult clone() {
    return (GoogleCloudPolicysimulatorV1alphaReplayResult) super.clone();
  }
