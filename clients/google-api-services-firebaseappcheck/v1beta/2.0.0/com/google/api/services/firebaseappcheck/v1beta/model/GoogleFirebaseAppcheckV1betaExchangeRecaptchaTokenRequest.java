...
public final class GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest setRecaptchaToken(java.lang.String recaptchaToken) {
    this.recaptchaToken = recaptchaToken;
    return this;
  }

  @Override
  public GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest clone() {
    return (GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest) super.clone();
  }
