...
public final class VirtualMachineConfig extends com.google.api.client.json.GenericJson {
   ...
   * `projects/[project_id]/global/networks/default` Runtimes are managed resources inside Google
   ...
   * the range *name* if it's assigned. Example: managed-notebooks-range-c
   * PEERING_RANGE_NAME_3=managed-notebooks-range-c gcloud compute addresses create
   * $PEERING_RANGE_NAME_3 \ --global \ --prefix-length=24 \ --description="Google Cloud Managed
   * Notebooks Range 24 c" \ --network=$NETWORK \ --addresses=192.168.0.0 \ --purpose=VPC_PEERING
