...
public final class HttpRouteAction extends com.google.api.client.json.GenericJson {
   ...
   * with the global external HTTP(S) load balancer (classic). To see which load balancers support
   * fault injection, see Load balancing: Routing and traffic management features.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
