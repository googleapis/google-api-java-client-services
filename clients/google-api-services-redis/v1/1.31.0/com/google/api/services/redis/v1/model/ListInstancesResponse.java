...
public final class ListInstancesResponse extends com.google.api.client.json.GenericJson {
   ...
   * unavailable, a placeholder Redis entry is included in the response with the `name` field set to
   * a value of the form `projects/{project_id}/locations/{location_id}/instances/`- and the
