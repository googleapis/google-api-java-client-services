...
public final class ReservationAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public ReservationAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, ReservationsScopedList> getItems() {
    return items;
  }
   ...
   */
  public ReservationAggregatedList setItems(java.util.Map<String, ReservationsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationAggregatedList set(String fieldName, Object value) {
    return (ReservationAggregatedList) super.set(fieldName, value);
  }

  @Override
  public ReservationAggregatedList clone() {
    return (ReservationAggregatedList) super.clone();
  }
