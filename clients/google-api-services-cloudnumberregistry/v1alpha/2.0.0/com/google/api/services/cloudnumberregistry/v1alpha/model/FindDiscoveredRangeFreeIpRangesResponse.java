...
public final class FindDiscoveredRangeFreeIpRangesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public FindDiscoveredRangeFreeIpRangesResponse setFreeIpCidrRanges(java.util.List<java.lang.String> freeIpCidrRanges) {
    this.freeIpCidrRanges = freeIpCidrRanges;
    return this;
  }

  @Override
  public FindDiscoveredRangeFreeIpRangesResponse set(String fieldName, Object value) {
    return (FindDiscoveredRangeFreeIpRangesResponse) super.set(fieldName, value);
  }

  @Override
  public FindDiscoveredRangeFreeIpRangesResponse clone() {
    return (FindDiscoveredRangeFreeIpRangesResponse) super.clone();
  }
