...
public final class SecurityPoliciesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public SecurityPoliciesScopedList setSecurityPolicies(java.util.List<SecurityPolicy> securityPolicies) {
   ...
   */
  public SecurityPoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SecurityPoliciesScopedList set(String fieldName, Object value) {
    return (SecurityPoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public SecurityPoliciesScopedList clone() {
    return (SecurityPoliciesScopedList) super.clone();
  }
