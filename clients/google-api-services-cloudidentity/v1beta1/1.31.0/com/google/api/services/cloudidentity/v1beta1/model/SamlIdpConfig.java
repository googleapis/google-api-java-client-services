...
public final class SamlIdpConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Change password URL. Users will be sent to this URL when changing their passwords at
   * myaccount.google.com. This takes precedence over the customer-level change password URL. Must
   * use HTTPS.
  ...
  /**
   * Logout redirect URL/Sign-out page URL. When a user clicks the sign out link on a Google page,
   * they will be redirected to this URL. This is pure redirect with no attached SAML LogoutRequest
  ...
  /**
   * Required. SingleSignOnService endpoint location/Sign-in page URL. This is the URL where the
   * AuthnRequest will be sent. Must use HTTPS. Currently assumed to accept the HTTP-Redirect
   * binding.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
