...
/**
 * Model definition for DhcpOptionsConfigList.
 *
...
public final class DhcpOptionsConfigList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<DhcpOptionsConfig> items;

  static {
    // hack to force ProGuard to consider DhcpOptionsConfig used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(DhcpOptionsConfig.class);
  }

  /**
   * Output only. [Output Only] Type of the resource. Alwayscompute#dhcpOptionsConfigList for a list
   * of dhcp options configs.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public DhcpOptionsConfigList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public DhcpOptionsConfigList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<DhcpOptionsConfig> getItems() {
    return items;
  }
   ...
   */
  public DhcpOptionsConfigList setItems(java.util.List<DhcpOptionsConfig> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public DhcpOptionsConfigList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public DhcpOptionsConfigList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public DhcpOptionsConfigList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public DhcpOptionsConfigList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public DhcpOptionsConfigList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public DhcpOptionsConfigList set(String fieldName, Object value) {
    return (DhcpOptionsConfigList) super.set(fieldName, value);
  }

  @Override
  public DhcpOptionsConfigList clone() {
    return (DhcpOptionsConfigList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for DhcpOptionsConfigListWarningData.
     */
