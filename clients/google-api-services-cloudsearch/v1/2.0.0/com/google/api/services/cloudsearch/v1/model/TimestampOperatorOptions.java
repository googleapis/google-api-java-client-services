...
public final class TimestampOperatorOptions extends com.google.api.client.json.GenericJson {
   ...
   * the property's name is *closeDate*, then queries like *closedafter:* show results only where
   * the value of the property named *closeDate* is later than **. The operator name can only
   ...
   * like *closedon:* show results only where the value of the property named *closeDate* matches
