 ...
 * day values * A month and day, with a zero year (e.g., an anniversary) * A year on its own, with a
 * zero month and a zero day * A year and month, with a zero day (e.g., a credit card expiration
