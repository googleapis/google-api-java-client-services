 ...
 * Gregorian Calendar. This can represent: A full date, with non-zero year, month and day values A
 * month and day value, with a zero year, e.g. an anniversary A year on its own, with zero month and
 * day values A year and month value, with a zero day, e.g. a credit card expiration dateRelated
