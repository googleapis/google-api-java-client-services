...
public final class Binding extends com.google.api.client.json.GenericJson {
   ...
   * However, a different role binding might grant the same role to one or more of the principals in
   * this binding.
   *
   ...
   * with a Google account or a service account.    Does not include identities that come from
   * external identity providers    (IdPs) through identity federation.
   *
   * * `user:{emailid}`: An email address that represents a specific Google    account. For example,
   * `alice@example.com` .
   *
   * * `serviceAccount:{emailid}`: An email address that represents a Google    service account. For
   ...
   * [Kubernetes service    account](https://cloud.google.com/kubernetes-engine/docs/how-
   * to/kubernetes-service-accounts).    For example, `my-project.svc.id.goog[my-namespace/my-
   * kubernetes-sa]`.
   *
   ...
   *
   * * `principal://iam.googleapis.com/locations/global/workforcePools/{pool_id}/subject/{subject_at
   * tribute_value}`:   A single identity in a workforce identity pool.
   *
   * *
   * `principalSet://iam.googleapis.com/locations/global/workforcePools/{pool_id}/group/{group_id}`:
   * All workforce identities in a group.
   *
   * * `principalSet://iam.googleapis.com/locations/global/workforcePools/{pool_id}/attribute.{attri
   * bute_name}/{attribute_value}`:   All workforce identities with a specific attribute value.
   *
   * * `principalSet://iam.googleapis.com/locations/global/workforcePools/{pool_id}`:   All
   * identities in a workforce identity pool.
   *
   * * `principal://iam.googleapis.com/projects/{project_number}/locations/global/workloadIdentityPo
   * ols/{pool_id}/subject/{subject_attribute_value}`:   A single identity in a workload identity
   * pool.
   *
   * * `principalSet://iam.googleapis.com/projects/{project_number}/locations/global/workloadIdentit
   * yPools/{pool_id}/group/{group_id}`:   A workload identity pool group.
   *
   * * `principalSet://iam.googleapis.com/projects/{project_number}/locations/global/workloadIdentit
   * yPools/{pool_id}/attribute.{attribute_name}/{attribute_value}`:   All identities in a workload
   * identity pool with a certain attribute.
   *
   * * `principalSet://iam.googleapis.com/projects/{project_number}/locations/global/workloadIdentit
   * yPools/{pool_id}`:   All identities in a workload identity pool.
   *
   ...
   *
   * * `deleted:principal://iam.googleapis.com/locations/global/workforcePools/{pool_id}/subject/{su
   * bject_attribute_value}`:   Deleted single identity in a workforce identity pool. For example,
