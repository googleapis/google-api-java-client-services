...
public class Iam extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.9 of the Identity and Access Management (IAM) API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class IamPolicies {
     ...
     *
     * Successful calls to this method always return an HTTP `200 OK` status code, even if the linter
     * detects an issue in the IAM policy.
     *
  ...
  public class Organizations {
    ...
    public class Roles {
      ...
      *
       ...
       *
       * * The custom role is permanently deleted and cannot be recovered. * If an IAM policy contains a
  ...
  public class Projects {
    ...
    public class ServiceAccounts {
       ...
       *
       * **Warning:** After you delete a service account, you might not be able to undelete it. If you
       * know that you need to re-enable the service account in the future, use DisableServiceAccount
       * instead.
       *
       * If you delete a service account, IAM permanently removes the service account 30 days later.
       * Google Cloud cannot recover the service account after it is permanently removed, even if you file
       * a support request.
       *
       * To help avoid unplanned outages, we recommend that you disable the service account before you
       * delete it. Use DisableServiceAccount to disable the service account, then wait at least 24 hours
       * and watch for unintended consequences. If there are no unintended consequences, you can delete
       * the service account.
       *
      ...
      public class Delete extends IamRequest<com.google.api.services.iam.v1.model.Empty> {
         ...
         *
         * To help avoid unplanned outages, we recommend that you disable the service account before you
         * delete it. Use DisableServiceAccount to disable the service account, then wait at least 24
       ...
       *
       * If an application uses the service account to authenticate, that application can no longer call
       * Google APIs or access Google Cloud resources. Existing access tokens for the service account are
       * rejected, and requests for new access tokens will fail.
       *
       * To re-enable the service account, use EnableServiceAccount. After you re-enable the service
       * account, its existing access tokens will be accepted, and you can request new access tokens.
       *
       * To help avoid unplanned outages, we recommend that you disable the service account before you
       * delete it. Use this method to disable the service account, then wait at least 24 hours and watch
       * for unintended consequences. If there are no unintended consequences, you can delete the service
       * account with DeleteServiceAccount.
       *
      ...
      public class Disable extends IamRequest<com.google.api.services.iam.v1.model.Empty> {
         ...
         *
         * If an application uses the service account to authenticate, that application can no longer call
         * Google APIs or access Google Cloud resources. Existing access tokens for the service account
         ...
         *
         * To help avoid unplanned outages, we recommend that you disable the service account before you
         * delete it. Use this method to disable the service account, then wait at least 24 hours and
       ...
       *
       * If the service account was disabled by other means—for example, if Google disabled the service
       * account because it was compromised—you cannot use this method to enable the service account.
       *
       ...
       *
       * This method does not tell you whether the service account has been granted any roles on other
       * resources. To check whether a service account has role grants on a resource, use the
       * `getIamPolicy` method for that resource. For example, to view the role grants for a project, call
       * the Resource Manager API's [`projects.getIamPolicy`](https://cloud.google.com/resource-
      ...
      public class GetIamPolicy extends IamRequest<com.google.api.services.iam.v1.model.Policy> {
         ...
         * call the Resource Manager API's [`projects.getIamPolicy`](https://cloud.google.com/resource-
         * manager/reference/rest/v1/projects/getIamPolicy) method.
         *
         * Create a request for the method "serviceAccounts.getIamPolicy".
         *
      ...
      * `projects/-/serviceAccounts/{UNIQUE_ID}`
      ...
      response
       *        messages to contain misleading error codes. For example, if you
      try to get the service
       *        account
      `projects/-/serviceAccounts/fake@example.com`, which does not exist, the
      response
       *        contains an HTTP `403 Forbidden` error instead of a `404 Not
      Found` error.
      ...
      * `projects/-/serviceAccounts/{UNIQUE_ID}`
       ...
       * `projects/-/serviceAccounts/{EMAIL_ADDRESS}` * `projects/-/serviceAccounts/{UNIQUE_ID}`
       ...
       When possible, avoid using the `-` wildcard character, because it can cause response messages to
       contain misleading error codes. For example, if you try to get the service account
       `projects/-/serviceAccounts/fake@example.com`, which does not exist, the response contains an HTTP
       ...
       *
       * Use this method to grant or revoke access to the service account. For example, you could grant a
       * member the ability to impersonate the service account.
       *
       * This method does not enable the service account to access other resources. To grant roles to a
       * service account on a resource, follow these steps:
       *
       * 1. Call the resource's `getIamPolicy` method to get its current IAM policy. 2. Edit the policy so
       * that it binds the service account to an IAM role for the resource. 3. Call the resource's
       * `setIamPolicy` method to update its IAM policy.
       *
      ...
      public class SetIamPolicy extends IamRequest<com.google.api.services.iam.v1.model.Policy> {
         ...
         * Sets the IAM policy that is attached to a ServiceAccount.
         *
         * Use this method to grant or revoke access to the service account. For example, you could grant
         * a member the ability to impersonate the service account.
         *
         * This method does not enable the service account to access other resources. To grant roles to a
         * service account on a resource, follow these steps:
         *
         * 1. Call the resource's `getIamPolicy` method to get its current IAM policy. 2. Edit the policy
         * so that it binds the service account to an IAM role for the resource. 3. Call the resource's
         * `setIamPolicy` method to update its IAM policy.
         *
         * For detailed instructions, see [Granting roles to a service account for specific
         * resources](https://cloud.google.com/iam/help/service-accounts/granting-access-to-service-
       ...
       *
       * **Important:** It is not always possible to restore a deleted service account. Use this method
       * only as a last resort.
       *
       * After you delete a service account, IAM permanently removes the service account 30 days later.
