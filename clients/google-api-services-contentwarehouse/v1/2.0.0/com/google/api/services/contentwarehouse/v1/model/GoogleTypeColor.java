 ...
 * public static Color toProto(java.awt.Color color) { float red = (float) color.getRed(); float
 * green = (float) color.getGreen(); float blue = (float) color.getBlue(); float denominator =
...
public final class GoogleTypeColor extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleTypeColor setBlue(java.lang.Float blue) {
    this.blue = blue;
    return this;
  }
   ...
   */
  public GoogleTypeColor setGreen(java.lang.Float green) {
    this.green = green;
    return this;
  }
   ...
   */
  public GoogleTypeColor setRed(java.lang.Float red) {
    this.red = red;
    return this;
  }

  @Override
  public GoogleTypeColor set(String fieldName, Object value) {
    return (GoogleTypeColor) super.set(fieldName, value);
  }

  @Override
  public GoogleTypeColor clone() {
    return (GoogleTypeColor) super.clone();
  }
