...
public final class ListInstantSnapshotGroups extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InstantSnapshotGroup> items;

  static {
    // hack to force ProGuard to consider InstantSnapshotGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InstantSnapshotGroup.class);
  }
   ...
   */
  public ListInstantSnapshotGroups setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ListInstantSnapshotGroups setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InstantSnapshotGroup> getItems() {
    return items;
  }
   ...
   */
  public ListInstantSnapshotGroups setItems(java.util.List<InstantSnapshotGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ListInstantSnapshotGroups setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ListInstantSnapshotGroups setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ListInstantSnapshotGroups setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ListInstantSnapshotGroups setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public ListInstantSnapshotGroups setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ListInstantSnapshotGroups set(String fieldName, Object value) {
    return (ListInstantSnapshotGroups) super.set(fieldName, value);
  }

  @Override
  public ListInstantSnapshotGroups clone() {
    return (ListInstantSnapshotGroups) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ListInstantSnapshotGroupsWarningData.
     */
