...
/**
 * Model definition for InstantSnapshotsScopedList.
 *
...
public final class InstantSnapshotsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<InstantSnapshot> instantSnapshots;

  static {
    // hack to force ProGuard to consider InstantSnapshot used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InstantSnapshot.class);
  }
   ...
   */
  public java.util.List<InstantSnapshot> getInstantSnapshots() {
    return instantSnapshots;
  }

  /**
   * [Output Only] A list of instantSnapshots contained in this scope.
   * @param instantSnapshots instantSnapshots or {@code null} for none
   */
  public InstantSnapshotsScopedList setInstantSnapshots(java.util.List<InstantSnapshot> instantSnapshots) {
   ...
   */
  public InstantSnapshotsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstantSnapshotsScopedList set(String fieldName, Object value) {
    return (InstantSnapshotsScopedList) super.set(fieldName, value);
  }

  @Override
  public InstantSnapshotsScopedList clone() {
    return (InstantSnapshotsScopedList) super.clone();
  }

  /**
   * [Output Only] Informational warning which replaces the list of instantSnapshots when the list is
   * empty.
   */
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for InstantSnapshotsScopedListWarningData.
     */
