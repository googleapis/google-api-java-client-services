...
public final class GoogleApiServicecontrolV1Operation extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleApiServicecontrolV1Operation setLogEntries(java.util.List<LogEntry> logEntries) {
   ...
   */
  public GoogleApiServicecontrolV1Operation setMetricValueSets(java.util.List<MetricValueSet> metricValueSets) {
   ...
   */
  public GoogleApiServicecontrolV1Operation setQuotaProperties(QuotaProperties quotaProperties) {
   ...
   */
  public GoogleApiServicecontrolV1Operation setResources(java.util.List<ResourceInfo> resources) {
   ...
   */
  public GoogleApiServicecontrolV1Operation setTraceSpans(java.util.List<TraceSpan> traceSpans) {
