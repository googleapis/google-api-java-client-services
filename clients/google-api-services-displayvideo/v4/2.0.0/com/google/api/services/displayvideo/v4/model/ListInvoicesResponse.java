...
public final class ListInvoicesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public ListInvoicesResponse setInvoices(java.util.List<Invoice> invoices) {
  ...
  @Override
  public ListInvoicesResponse set(String fieldName, Object value) {
    return (ListInvoicesResponse) super.set(fieldName, value);
  }

  @Override
  public ListInvoicesResponse clone() {
    return (ListInvoicesResponse) super.clone();
  }
