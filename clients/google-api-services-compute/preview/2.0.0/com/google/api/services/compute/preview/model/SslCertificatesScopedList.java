...
public final class SslCertificatesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public SslCertificatesScopedList setSslCertificates(java.util.List<SslCertificate> sslCertificates) {
   ...
   */
  public SslCertificatesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SslCertificatesScopedList set(String fieldName, Object value) {
    return (SslCertificatesScopedList) super.set(fieldName, value);
  }

  @Override
  public SslCertificatesScopedList clone() {
    return (SslCertificatesScopedList) super.clone();
  }
