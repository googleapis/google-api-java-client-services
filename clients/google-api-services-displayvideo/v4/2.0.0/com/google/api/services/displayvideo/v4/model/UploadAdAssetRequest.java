...
public final class UploadAdAssetRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The filename of the ad asset, including the file extension. The filename must be
  ...
  @Override
  public UploadAdAssetRequest set(String fieldName, Object value) {
    return (UploadAdAssetRequest) super.set(fieldName, value);
  }

  @Override
  public UploadAdAssetRequest clone() {
    return (UploadAdAssetRequest) super.clone();
  }
