...
public final class ServicePattern extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider Modifier used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Modifier.class);
  }
   ...
   */
  public ServicePattern setModifiers(java.util.List<Modifier> modifiers) {
   ...
   */
  public ServicePattern setService(java.lang.String service) {
    this.service = service;
    return this;
  }

  @Override
  public ServicePattern set(String fieldName, Object value) {
    return (ServicePattern) super.set(fieldName, value);
  }

  @Override
  public ServicePattern clone() {
    return (ServicePattern) super.clone();
  }
