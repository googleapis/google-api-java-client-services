...
public final class InstancesRestoreBackupRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. By using this parameter, Cloud SQL overrides the instance settings existed at time of
   * backup with the instance settings that you want to restore. You can't change the Instance's
   * major database version and you can only increase the disk size. You can use this field to
