 ...
 * <pre>
  public static class MyRequestInitializer extends BigqueryRequestInitializer {
    ...
    {@literal @}Override
    public void initializeBigqueryRequest(BigqueryRequest{@literal <}?{@literal >} request)
        throws IOException {
      // custom logic
    }
  }
 ...
 * @since 1.12
 */
public class BigqueryRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public BigqueryRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeBigqueryRequest((BigqueryRequest<?>) request);
  }
   ...
   */
  protected void initializeBigqueryRequest(BigqueryRequest<?> request) throws java.io.IOException {
  }
}
