...
public final class ApigatewayOperation extends com.google.api.client.json.GenericJson {
   ...
   */
  public ApigatewayOperation setDone(java.lang.Boolean done) {
    this.done = done;
    return this;
  }
   ...
   */
  public ApigatewayOperation setError(ApigatewayStatus error) {
    this.error = error;
    return this;
  }
   ...
   */
  public ApigatewayOperation setMetadata(java.util.Map<String, java.lang.Object> metadata) {
   ...
   */
  public ApigatewayOperation setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public ApigatewayOperation setResponse(java.util.Map<String, java.lang.Object> response) {
    this.response = response;
    return this;
  }

  @Override
  public ApigatewayOperation set(String fieldName, Object value) {
    return (ApigatewayOperation) super.set(fieldName, value);
  }

  @Override
  public ApigatewayOperation clone() {
    return (ApigatewayOperation) super.clone();
  }
