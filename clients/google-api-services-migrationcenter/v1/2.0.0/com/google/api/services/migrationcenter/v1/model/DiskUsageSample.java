...
public final class DiskUsageSample extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Average IOPS sampled over a short window. Must be non-negative. If read or write are
   * set, the sum of read and write will override the value of the average_iops.
  ...
  /**
   * Optional. Average read IOPS sampled over a short window. Must be non-negative. If both read and
  ...
  /**
   * Optional. Average write IOPS sampled over a short window. Must be non-negative. If both read
