...
package com.google.api.services.cloudiap.v1beta1;
...
public class CloudIAP extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Cloud Identity-Aware Proxy API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class IapTunnel {
       ...
       * @param content the {@link com.google.api.services.cloudiap.v1beta1.model.GetIamPolicyRequest}
       * @return the request
       */
      public GetIamPolicy getIamPolicy(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.GetIamPolicyRequest content) throws java.io.IOException {
        GetIamPolicy result = new GetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class GetIamPolicy extends CloudIAPRequest<com.google.api.services.cloudiap.v1beta1.model.Policy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected GetIamPolicy(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.GetIamPolicyRequest content) {
          super(CloudIAP.this, "POST", REST_PATH, content, com.google.api.services.cloudiap.v1beta1.model.Policy.class);
      ...
      See the operation documentation for
       *        the appropriate value for this field.
       * @param content the {@link com.google.api.services.cloudiap.v1beta1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends CloudIAPRequest<com.google.api.services.cloudiap.v1beta1.model.Policy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.SetIamPolicyRequest content) {
          super(CloudIAP.this, "POST", REST_PATH, content, com.google.api.services.cloudiap.v1beta1.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
      ...
      See the operation
       *        documentation for the appropriate value for this field.
       * @param content the {@link com.google.api.services.cloudiap.v1beta1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends CloudIAPRequest<com.google.api.services.cloudiap.v1beta1.model.TestIamPermissionsResponse> {
       ...
       *        documentation for the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.api.services.cloudiap.v1beta1.model.TestIamPermissionsRequest content) {
          super(CloudIAP.this, "POST", REST_PATH, content, com.google.api.services.cloudiap.v1beta1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
