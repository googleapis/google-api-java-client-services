...
public final class GoogleCloudRetailV2alphaOutputConfigGcsDestination extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2alphaOutputConfigGcsDestination setOutputUriPrefix(java.lang.String outputUriPrefix) {
    this.outputUriPrefix = outputUriPrefix;
    return this;
  }

  @Override
  public GoogleCloudRetailV2alphaOutputConfigGcsDestination set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaOutputConfigGcsDestination) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaOutputConfigGcsDestination clone() {
    return (GoogleCloudRetailV2alphaOutputConfigGcsDestination) super.clone();
  }
