# Cloud Security Command Center API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1p1alpha1-rev20190603-1.30.1</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-securitycenter:v1p1alpha1-rev20190603-1.30.1'
}
```
