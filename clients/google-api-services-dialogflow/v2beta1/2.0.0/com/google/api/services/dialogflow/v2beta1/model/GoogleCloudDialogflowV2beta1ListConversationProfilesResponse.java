...
public final class GoogleCloudDialogflowV2beta1ListConversationProfilesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDialogflowV2beta1ConversationProfile> conversationProfiles;

  static {
    // hack to force ProGuard to consider GoogleCloudDialogflowV2beta1ConversationProfile used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDialogflowV2beta1ConversationProfile.class);
  }
  ...
  @Override
  public GoogleCloudDialogflowV2beta1ListConversationProfilesResponse set(String fieldName, Object value) {
    return (GoogleCloudDialogflowV2beta1ListConversationProfilesResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDialogflowV2beta1ListConversationProfilesResponse clone() {
    return (GoogleCloudDialogflowV2beta1ListConversationProfilesResponse) super.clone();
  }
