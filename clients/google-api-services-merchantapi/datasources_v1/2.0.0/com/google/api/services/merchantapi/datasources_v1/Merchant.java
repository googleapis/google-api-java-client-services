...
/**
 * Service definition for Merchant (datasources_v1).
 *
 * <p>
...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class DataSources {
       ...
       * @param content the {@link com.google.api.services.merchantapi.datasources_v1.model.DataSource}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.merchantapi.datasources_v1.model.DataSource content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.DataSource> {

        private static final String REST_PATH = "datasources/v1/{+parent}/dataSources";
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.merchantapi.datasources_v1.model.DataSource content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.datasources_v1.model.DataSource.class);
      ...
      public class Delete extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.Empty> {

        private static final String REST_PATH = "datasources/v1/{+name}";
       ...
       *        `accounts/{account}/dataSources/{datasource}`
        ...
        protected Delete(java.lang.String name) {
          super(Merchant.this, "DELETE", REST_PATH, null, com.google.api.services.merchantapi.datasources_v1.model.Empty.class);
       ...
       *        `accounts/{account}/dataSources/{datasource}`
       * @param content the {@link com.google.api.services.merchantapi.datasources_v1.model.FetchDataSourceRequest}
       * @return the request
       */
      public Fetch fetch(java.lang.String name, com.google.api.services.merchantapi.datasources_v1.model.FetchDataSourceRequest content) throws java.io.IOException {
        Fetch result = new Fetch(name, content);
        initialize(result);
        return result;
      }

      public class Fetch extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.Empty> {

        private static final String REST_PATH = "datasources/v1/{+name}:fetch";
       ...
       *        `accounts/{account}/dataSources/{datasource}`
         ...
         * @since 1.13
         */
        protected Fetch(java.lang.String name, com.google.api.services.merchantapi.datasources_v1.model.FetchDataSourceRequest content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.datasources_v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.DataSource> {
       ...
       *        `accounts/{account}/dataSources/{datasource}`
        ...
        protected Get(java.lang.String name) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.datasources_v1.model.DataSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.ListDataSourcesResponse> {
        ...
        protected List(java.lang.String parent) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.datasources_v1.model.ListDataSourcesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.merchantapi.datasources_v1.model.DataSource content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.DataSource> {
       ...
       *        `accounts/{account}/dataSources/{datasource}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.merchantapi.datasources_v1.model.DataSource content) {
          super(Merchant.this, "PATCH", REST_PATH, content, com.google.api.services.merchantapi.datasources_v1.model.DataSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       `accounts/{account}/dataSources/{datasource}`
         ...
         * Providing special "*" value for full data source replacement is not supported. For
         * example, If you insert `updateMask=displayName` in the request, it will only update the
      ...
      public class FileUploads {
        ...
        public class Get extends MerchantRequest<com.google.api.services.merchantapi.datasources_v1.model.FileUpload> {
         ...
         *        `accounts/{account}/dataSources/{datasource}/fileUploads/latest`
           ...
           */
          protected Get(java.lang.String name) {
            super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.datasources_v1.model.FileUpload.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
