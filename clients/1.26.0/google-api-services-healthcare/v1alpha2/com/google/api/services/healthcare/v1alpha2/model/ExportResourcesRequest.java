...
public final class ExportResourcesRequest extends com.google.api.client.json.GenericJson {
   ...
   *
   * The output will be one BigQuery table per resource type. The server implements a data-driven
   * FHIR-to-SQL schema mapping in support of analytics workloads with BigQuery. Incompatible
   * changes to the output schema may be introduced in the future as a result of continuous
   * collaboration with the FHIR community to refine the [desired SQL projection of FHIR
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudHealthcareV1alpha2FhirRestGcsDestination gcsDestination;
   ...
   */
  public ExportResourcesRequest setBigqueryDestination(GoogleCloudHealthcareV1alpha2FhirBigQueryDestination bigqueryDestination) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudHealthcareV1alpha2FhirRestGcsDestination getGcsDestination() {
   ...
   */
  public ExportResourcesRequest setGcsDestination(GoogleCloudHealthcareV1alpha2FhirRestGcsDestination gcsDestination) {
