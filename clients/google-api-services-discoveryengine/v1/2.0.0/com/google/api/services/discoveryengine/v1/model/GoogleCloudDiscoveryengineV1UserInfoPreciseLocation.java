...
public final class GoogleCloudDiscoveryengineV1UserInfoPreciseLocation extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1UserInfoPreciseLocation setPoint(GoogleTypeLatLng point) {
    this.point = point;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserInfoPreciseLocation set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1UserInfoPreciseLocation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1UserInfoPreciseLocation clone() {
    return (GoogleCloudDiscoveryengineV1UserInfoPreciseLocation) super.clone();
  }
