...
public final class AppsDynamiteStorageCardSection extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AppsDynamiteStorageWidget> widgets;
   ...
   */
  public AppsDynamiteStorageCardSection setCollapsible(java.lang.Boolean collapsible) {
   ...
   */
  public AppsDynamiteStorageCardSection setHeader(java.lang.String header) {
    this.header = header;
    return this;
  }
   ...
   */
  public AppsDynamiteStorageCardSection setUncollapsibleWidgetsCount(java.lang.Integer uncollapsibleWidgetsCount) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<AppsDynamiteStorageWidget> getWidgets() {
    return widgets;
  }
   ...
   */
  public AppsDynamiteStorageCardSection setWidgets(java.util.List<AppsDynamiteStorageWidget> widgets) {
    this.widgets = widgets;
    return this;
  }

  @Override
  public AppsDynamiteStorageCardSection set(String fieldName, Object value) {
    return (AppsDynamiteStorageCardSection) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteStorageCardSection clone() {
    return (AppsDynamiteStorageCardSection) super.clone();
  }
