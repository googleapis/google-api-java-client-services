...
public final class FileSearchResult extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public FileSearchResult set(String fieldName, Object value) {
    return (FileSearchResult) super.set(fieldName, value);
  }

  @Override
  public FileSearchResult clone() {
    return (FileSearchResult) super.clone();
  }
