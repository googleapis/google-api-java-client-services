 ...
 * <pre>
  public static class MyRequestInitializer extends WebfontsRequestInitializer {
    ...
    {@literal @}Override
    public void initializeWebfontsRequest(WebfontsRequest{@literal <}?{@literal >} request)
        throws IOException {
      // custom logic
    }
  }
 ...
 * @since 1.12
 */
public class WebfontsRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public WebfontsRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeWebfontsRequest((WebfontsRequest<?>) request);
  }
   ...
   */
  protected void initializeWebfontsRequest(WebfontsRequest<?> request) throws java.io.IOException {
  }
}
