...
public final class CommonRemoteRepository extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CommonRemoteRepository set(String fieldName, Object value) {
    return (CommonRemoteRepository) super.set(fieldName, value);
  }

  @Override
  public CommonRemoteRepository clone() {
    return (CommonRemoteRepository) super.clone();
  }
