...
public final class Aggregation extends com.google.api.client.json.GenericJson {
   ...
   * COUNT_UP_TO(2) AS property_1, COUNT_UP_TO(3) AS count_up_to_3, COUNT(*) AS property_2 OVER (
   * ... ); ``` Requires: * Must be unique across all aggregation aliases. * Conform to entity
