...
public final class GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus setErrorSamples(java.util.List<GoogleRpcStatus> errorSamples) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus clone() {
    return (GoogleCloudDiscoveryengineV1alphaDocumentIndexStatus) super.clone();
  }
