...
public final class PacketMirroringNetworkInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  public PacketMirroringNetworkInfo setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public PacketMirroringNetworkInfo set(String fieldName, Object value) {
    return (PacketMirroringNetworkInfo) super.set(fieldName, value);
  }

  @Override
  public PacketMirroringNetworkInfo clone() {
    return (PacketMirroringNetworkInfo) super.clone();
  }
