...
public final class ReservationBlock extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Type of the resource. Alwayscompute#reservationBlock for reservation
   * blocks.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] Obfuscated location where this reservation block physically resides
   * in format /CCCC/GGGG. This matches the tripod specified in the VM topology information.
   * Example: /USEAB1/0101/ is the location prefix in /USEAB1/0101/031/003
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The name of this reservation block generated by Google Compute
   * Engine. The name must be 1-63 characters long, and comply with RFC1035 @pattern
  ...
  /**
   * Output only. [Output Only] The number of reservation subBlocks associated with this reservation
   * block.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The number of in-use reservation subBlocks associated with this
   * reservation block. If at least one VM is running on a subBlock, it is considered in-use.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
