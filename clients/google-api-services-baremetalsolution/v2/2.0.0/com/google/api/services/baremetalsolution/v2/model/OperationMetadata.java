...
public final class OperationMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Identifies whether the user requested the cancellation of the operation.
   * Operations that have been successfully cancelled have Operation.error value with a
