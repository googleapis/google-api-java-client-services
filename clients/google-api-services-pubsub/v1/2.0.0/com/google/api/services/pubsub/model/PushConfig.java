...
public final class PushConfig extends com.google.api.client.json.GenericJson {
   ...
   * if the subscription was created without this attribute. The only supported values for the
   * `x-goog-version` attribute are: * `v1beta1`: uses the push format defined in the v1beta1
   * Pub/Sub API. * `v1` or `v1beta2`: uses the push format defined in the v1 Pub/Sub API. For
