  ...
  public class Folders {
    ...
    public class Locations {
      ...
      public class DbFindingSummaries {
        ...
        public class List extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbFindingSummariesResponse> {

          private static final String REST_PATH = "v1/{+parent}/dbFindingSummaries";
         ...
         *        organizations/{organization}/locations/{location}
          ...
          protected List(java.lang.String parent) {
            super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbFindingSummariesResponse.class);
      ...
      public class DbFrameworkComplianceReports {
        ...
        public class Aggregate extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1AggregateDbFrameworkComplianceReportResponse> {

          private static final String REST_PATH = "v1/{+name}:aggregate";
         ...
         *        nce_report}`
          ...
          protected Aggregate(java.lang.String name) {
            super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1AggregateDbFrameworkComplianceReportResponse.class);
        ...
        public class Fetch extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1FetchDbFrameworkComplianceReportResponse> {
          ...
          protected Fetch(java.lang.String name) {
            super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1FetchDbFrameworkComplianceReportResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class DbControlComplianceSummaries {
          ...
          public class List extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbControlComplianceSummariesResponse> {

            private static final String REST_PATH = "v1/{+parent}/dbControlComplianceSummaries";
           ...
           *        nce_report}
             ...
             */
            protected List(java.lang.String parent) {
              super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbControlComplianceSummariesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
      ...
      public class DbFrameworkComplianceSummaries {
        ...
        public class List extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbFrameworkComplianceSummariesResponse> {

          private static final String REST_PATH = "v1/{+parent}/dbFrameworkComplianceSummaries";
         ...
         *        projects/{project}/locations/{location}
           ...
           */
          protected List(java.lang.String parent) {
            super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1ListDbFrameworkComplianceSummariesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
  ...
  public class Organizations {
    ...
    public class Locations {
      ...
      public class Workloads {
        ...
        public class AnalyzeWorkloadMove extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1AnalyzeWorkloadMoveResponse> {
         ...
         *        example: "organizations/123/locations/us-east1/workloads/assured-workload-2"
          ...
          protected AnalyzeWorkloadMove(java.lang.String target) {
            super(Assuredworkloads.this, "GET", REST_PATH, null, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1AnalyzeWorkloadMoveResponse.class);
        ...
        public class Violations {
           ...
           * @param content the {@link com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest}
           * @return the request
           */
          public BatchAcknowledgeViolations batchAcknowledgeViolations(java.lang.String parent, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest content) throws java.io.IOException {
            BatchAcknowledgeViolations result = new BatchAcknowledgeViolations(parent, content);
            initialize(result);
            return result;
          }

          public class BatchAcknowledgeViolations extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse> {

            private static final String REST_PATH = "v1/{+parent}/violations:batchAcknowledgeViolations";
           ...
           *        organizations/{organization}/locations/{location}/workloads/{workload}
             ...
             * @since 1.13
             */
            protected BatchAcknowledgeViolations(java.lang.String parent, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsRequest content) {
              super(Assuredworkloads.this, "POST", REST_PATH, content, com.google.api.services.assuredworkloads.v1.model.GoogleCloudAssuredworkloadsV1BatchAcknowledgeViolationsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
