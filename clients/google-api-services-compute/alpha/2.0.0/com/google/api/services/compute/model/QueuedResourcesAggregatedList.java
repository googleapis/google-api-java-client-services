...
/**
 * Model definition for QueuedResourcesAggregatedList.
 *
...
public final class QueuedResourcesAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, QueuedResourcesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#queuedResourcesAggregatedList for
   * lists of QueuedResource.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public QueuedResourcesAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, QueuedResourcesScopedList> getItems() {
    return items;
  }
   ...
   */
  public QueuedResourcesAggregatedList setItems(java.util.Map<String, QueuedResourcesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public QueuedResourcesAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public QueuedResourcesAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public QueuedResourcesAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public QueuedResourcesAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public QueuedResourcesAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public QueuedResourcesAggregatedList set(String fieldName, Object value) {
    return (QueuedResourcesAggregatedList) super.set(fieldName, value);
  }

  @Override
  public QueuedResourcesAggregatedList clone() {
    return (QueuedResourcesAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for QueuedResourcesAggregatedListWarningData.
     */
