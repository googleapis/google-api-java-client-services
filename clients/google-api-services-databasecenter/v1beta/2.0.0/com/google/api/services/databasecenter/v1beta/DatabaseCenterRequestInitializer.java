...
/**
 * DatabaseCenter request initializer for setting properties like key and userIp.
 *
 * <p>
 ...
 * @since 1.12
 */
public class DatabaseCenterRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public DatabaseCenterRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public DatabaseCenterRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeDatabaseCenterRequest((DatabaseCenterRequest<?>) request);
  }
   ...
   */
  protected void initializeDatabaseCenterRequest(DatabaseCenterRequest<?> request) throws java.io.IOException {
  }
}
