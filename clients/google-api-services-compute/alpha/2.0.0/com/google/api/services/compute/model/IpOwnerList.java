...
public final class IpOwnerList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Type of resource. Always compute#ipOwnerList for lists of IP owners.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public IpOwnerList setUnreachables(java.util.List<java.lang.String> unreachables) {
