...
public final class ApigatewayAuditConfig extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<ApigatewayAuditLogConfig> auditLogConfigs;
   ...
   */
  public java.util.List<ApigatewayAuditLogConfig> getAuditLogConfigs() {
   ...
   */
  public ApigatewayAuditConfig setAuditLogConfigs(java.util.List<ApigatewayAuditLogConfig> auditLogConfigs) {
   ...
   */
  public ApigatewayAuditConfig setService(java.lang.String service) {
    this.service = service;
    return this;
  }

  @Override
  public ApigatewayAuditConfig set(String fieldName, Object value) {
    return (ApigatewayAuditConfig) super.set(fieldName, value);
  }

  @Override
  public ApigatewayAuditConfig clone() {
    return (ApigatewayAuditConfig) super.clone();
  }
