...
/**
 * Model definition for RegionInstanceGroupManagerResizeRequestsListResponse.
 *
...
public final class RegionInstanceGroupManagerResizeRequestsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InstanceGroupManagerResizeRequest> items;

  static {
    // hack to force ProGuard to consider InstanceGroupManagerResizeRequest used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InstanceGroupManagerResizeRequest.class);
  }
   ...
   */
  public RegionInstanceGroupManagerResizeRequestsListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InstanceGroupManagerResizeRequest> getItems() {
    return items;
  }
   ...
   */
  public RegionInstanceGroupManagerResizeRequestsListResponse setItems(java.util.List<InstanceGroupManagerResizeRequest> items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public RegionInstanceGroupManagerResizeRequestsListResponse set(String fieldName, Object value) {
    return (RegionInstanceGroupManagerResizeRequestsListResponse) super.set(fieldName, value);
  }

  @Override
  public RegionInstanceGroupManagerResizeRequestsListResponse clone() {
    return (RegionInstanceGroupManagerResizeRequestsListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RegionInstanceGroupManagerResizeRequestsListResponseWarningData.
     */
