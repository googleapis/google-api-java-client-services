...
public final class RemovePublicKeyMetadata extends com.google.api.client.json.GenericJson {

  @Override
  public RemovePublicKeyMetadata set(String fieldName, Object value) {
    return (RemovePublicKeyMetadata) super.set(fieldName, value);
  }

  @Override
  public RemovePublicKeyMetadata clone() {
    return (RemovePublicKeyMetadata) super.clone();
  }
