...
public final class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment extends com.google.api.client.json.GenericJson {
   ...
   * restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions). An object
   ...
   * If neither worker_region nor worker_zone is specified, defaults to the control plane region.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * If neither worker_region nor worker_zone is specified, a zone in the control plane region is
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setAdditionalExperiments(java.util.List<java.lang.String> additionalExperiments) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setAdditionalUserLabels(java.util.Map<String, java.lang.String> additionalUserLabels) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setEnableStreamingEngine(java.lang.Boolean enableStreamingEngine) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setFlexrsGoal(java.lang.String flexrsGoal) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setIpConfiguration(java.lang.String ipConfiguration) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setKmsKeyName(java.lang.String kmsKeyName) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setMachineType(java.lang.String machineType) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setMaxWorkers(java.lang.Integer maxWorkers) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setNetwork(java.lang.String network) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setNumWorkers(java.lang.Integer numWorkers) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setServiceAccountEmail(java.lang.String serviceAccountEmail) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setSubnetwork(java.lang.String subnetwork) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setTempLocation(java.lang.String tempLocation) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setWorkerRegion(java.lang.String workerRegion) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setWorkerZone(java.lang.String workerZone) {
   ...
   */
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment setZone(java.lang.String zone) {
    this.zone = zone;
    return this;
  }

  @Override
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment set(String fieldName, Object value) {
    return (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment clone() {
    return (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment) super.clone();
  }
