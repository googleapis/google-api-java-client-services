...
public class SQLAdmin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Connect {
    ...
    public class Resolve extends SQLAdminRequest<com.google.api.services.sqladmin.model.ConnectSettings> {
      ...
      private static final String REST_PATH = "v1/locations/{location}/dns/{dnsName}:resolveConnectSettings";
  ...
  public class Instances {
     ...
     *        ID.
      ...
      /**
       * Required. The ID of the Cloud SQL instance to be cloned (source). This does not include the
       * project ID.
       */
      @com.google.api.client.util.Key
      private java.lang.String instance;

      /** Required. The ID of the Cloud SQL instance to be cloned (source). This does not include the project
     ID.
       */
      public java.lang.String getInstance() {
        return instance;
