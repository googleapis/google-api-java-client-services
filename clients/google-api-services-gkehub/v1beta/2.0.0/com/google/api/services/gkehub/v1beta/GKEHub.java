  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class RolloutSequences {
         ...
         *        projects/{project}/locations/{location}/rolloutSequences/{rollout_sequence}
         * @param content the {@link com.google.api.services.gkehub.v1beta.model.UpgradeRolloutSequenceRequest}
         * @return the request
         */
        public Upgrade upgrade(java.lang.String name, com.google.api.services.gkehub.v1beta.model.UpgradeRolloutSequenceRequest content) throws java.io.IOException {
          Upgrade result = new Upgrade(name, content);
          initialize(result);
          return result;
        }

        public class Upgrade extends GKEHubRequest<com.google.api.services.gkehub.v1beta.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/rolloutSequences/{rollout_sequence}
           ...
           * @since 1.13
           */
          protected Upgrade(java.lang.String name, com.google.api.services.gkehub.v1beta.model.UpgradeRolloutSequenceRequest content) {
            super(GKEHub.this, "POST", REST_PATH, content, com.google.api.services.gkehub.v1beta.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Rollouts {
         ...
         * @param content the {@link com.google.api.services.gkehub.v1beta.model.CancelRolloutRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.gkehub.v1beta.model.CancelRolloutRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends GKEHubRequest<com.google.api.services.gkehub.v1beta.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/rollouts/{rollout}
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.gkehub.v1beta.model.CancelRolloutRequest content) {
            super(GKEHub.this, "POST", REST_PATH, content, com.google.api.services.gkehub.v1beta.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *        projects/{project}/locations/{location}/rollouts/{rollout}
         * @param content the {@link com.google.api.services.gkehub.v1beta.model.PauseRolloutRequest}
         * @return the request
         */
        public Pause pause(java.lang.String name, com.google.api.services.gkehub.v1beta.model.PauseRolloutRequest content) throws java.io.IOException {
          Pause result = new Pause(name, content);
          initialize(result);
          return result;
        }

        public class Pause extends GKEHubRequest<com.google.api.services.gkehub.v1beta.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/rollouts/{rollout}
           ...
           * @since 1.13
           */
          protected Pause(java.lang.String name, com.google.api.services.gkehub.v1beta.model.PauseRolloutRequest content) {
            super(GKEHub.this, "POST", REST_PATH, content, com.google.api.services.gkehub.v1beta.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *        projects/{project}/locations/{location}/rollouts/{rollout}
         * @param content the {@link com.google.api.services.gkehub.v1beta.model.ResumeRolloutRequest}
         * @return the request
         */
        public Resume resume(java.lang.String name, com.google.api.services.gkehub.v1beta.model.ResumeRolloutRequest content) throws java.io.IOException {
          Resume result = new Resume(name, content);
          initialize(result);
          return result;
        }

        public class Resume extends GKEHubRequest<com.google.api.services.gkehub.v1beta.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/rollouts/{rollout}
           ...
           * @since 1.13
           */
          protected Resume(java.lang.String name, com.google.api.services.gkehub.v1beta.model.ResumeRolloutRequest content) {
            super(GKEHub.this, "POST", REST_PATH, content, com.google.api.services.gkehub.v1beta.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
