...
public final class AnthosCluster extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Membership of the GKE Hub registered cluster that the Skaffold configuration should be applied
   * to. Format is `projects/{project}/locations/{location}/memberships/{membership_name}`.
