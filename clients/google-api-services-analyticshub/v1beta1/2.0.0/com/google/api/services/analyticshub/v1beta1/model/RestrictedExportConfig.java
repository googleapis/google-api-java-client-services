...
public final class RestrictedExportConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RestrictedExportConfig set(String fieldName, Object value) {
    return (RestrictedExportConfig) super.set(fieldName, value);
  }

  @Override
  public RestrictedExportConfig clone() {
    return (RestrictedExportConfig) super.clone();
  }
