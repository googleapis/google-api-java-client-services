...
public class DriveLabels extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Labels {
     ...
     * @param content the {@link com.google.api.services.drivelabels.v2beta.model.GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest}
     * @return the request
     */
    public UpdateLabelEnabledAppSettings updateLabelEnabledAppSettings(java.lang.String name, com.google.api.services.drivelabels.v2beta.model.GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest content) throws java.io.IOException {
      UpdateLabelEnabledAppSettings result = new UpdateLabelEnabledAppSettings(name, content);
      initialize(result);
      return result;
    }

    public class UpdateLabelEnabledAppSettings extends DriveLabelsRequest<com.google.api.services.drivelabels.v2beta.model.GoogleAppsDriveLabelsV2betaLabel> {

      private static final String REST_PATH = "v2beta/{+name}:updateLabelEnabledAppSettings";
       ...
       * @since 1.13
       */
      protected UpdateLabelEnabledAppSettings(java.lang.String name, com.google.api.services.drivelabels.v2beta.model.GoogleAppsDriveLabelsV2betaUpdateLabelEnabledAppSettingsRequest content) {
        super(DriveLabels.this, "POST", REST_PATH, content, com.google.api.services.drivelabels.v2beta.model.GoogleAppsDriveLabelsV2betaLabel.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
