 ...
 * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (e.g., 1024 for 1-1.5GB, 4096 for
 * 4-6GB). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung.
