...
public final class ResourcePolicySnapshotSchedulePolicyRetentionPolicy extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Specifies the behavior to apply to existing, scheduled snapshots snapshots if the policy is
   * changed.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.String onPolicySwitch;
