...
public final class GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsRequest extends com.google.api.client.json.GenericJson {
   ...
   * grammar: https://google.aip.dev/assets/misc/ebnf-filtering.txt. An error will be thrown if any
   * specified parameter is not supported. Currently, it can only be used by Youtube partners.
   * Allowed parameters are: - regionCodes - zipCode - eligibilityId - applicableProducts Multiple
   * parameters can be specified, for example: "regionCodes=US zipCode=94043
   * eligibilityId=2022H1Campaign", or "applicableProducts=partners/p1/products/product2"
