...
public final class GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest extends com.google.api.client.json.GenericJson {

  /**
   * Optional. * Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string):
   ...
   * `anonRssAndSwapMemoryUsageP75` (`google.type.Decimal`): 75th percentile of anon RSS and swap
   * memory usage. * `anonRssAndSwapMemoryUsageP90` (`google.type.Decimal`): 90th percentile of anon
   * RSS and swap memory usage. * `anonRssAndSwapMemoryUsageP95` (`google.type.Decimal`): 95th
   * percentile of anon RSS and swap memory usage. * `anonRssAndSwapMemoryUsageP99`
   ...
   * subsequent page. When paginating, all other parameters provided to the request must match the
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setDimensions(java.util.List<java.lang.String> dimensions) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setMetrics(java.util.List<java.lang.String> metrics) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setPageSize(java.lang.Integer pageSize) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setPageToken(java.lang.String pageToken) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setTimelineSpec(GooglePlayDeveloperReportingV1alpha1TimelineSpec timelineSpec) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest setUserCohort(java.lang.String userCohort) {
    this.userCohort = userCohort;
    return this;
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest clone() {
    return (GooglePlayDeveloperReportingV1alpha1QueryAnonRssAndSwapMemoryUsageMetricSetRequest) super.clone();
  }
