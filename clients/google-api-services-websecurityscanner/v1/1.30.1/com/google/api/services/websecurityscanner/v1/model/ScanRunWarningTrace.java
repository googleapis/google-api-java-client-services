...
/**
 * Output only. Defines a warning trace message for ScanRun. Warning traces provide customers with
 * useful information that helps make the scanning process more effective.
 *
...
public final class ScanRunWarningTrace extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ScanRunWarningTrace set(String fieldName, Object value) {
    return (ScanRunWarningTrace) super.set(fieldName, value);
  }

  @Override
  public ScanRunWarningTrace clone() {
    return (ScanRunWarningTrace) super.clone();
  }
