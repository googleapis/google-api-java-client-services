...
public final class KnowledgeAnswersTimeZoneType extends com.google.api.client.json.GenericJson {
   ...
   */
  public KnowledgeAnswersTimeZoneType setComponentSpecificContracts(NlpMeaningComponentSpecificContracts componentSpecificContracts) {
   ...
   */
  public KnowledgeAnswersTimeZoneType setRemodelings(NlpMeaningMeaningRemodelings remodelings) {
    this.remodelings = remodelings;
    return this;
  }

  @Override
  public KnowledgeAnswersTimeZoneType set(String fieldName, Object value) {
    return (KnowledgeAnswersTimeZoneType) super.set(fieldName, value);
  }

  @Override
  public KnowledgeAnswersTimeZoneType clone() {
    return (KnowledgeAnswersTimeZoneType) super.clone();
  }
