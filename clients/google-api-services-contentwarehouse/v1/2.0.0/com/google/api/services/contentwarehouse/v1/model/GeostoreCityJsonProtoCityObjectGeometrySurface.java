...
public final class GeostoreCityJsonProtoCityObjectGeometrySurface extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The materials this surface is made of. Either all or none of the Surface protos must have this
   * field set (even for 'null' references). Otherwise, this field must not be set. IMPORTANT: This
   * field must not contain more than one MaterialSpec unless CityJSON's material "theme" is
   * incorporated into CityJsonProto (see discussion in go/cityjson-for-hand-modeled-landmarks).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * the containing Geometry's `semantics` field. Either all or none of the Surface protos must have
   * this field set (even for 'null' references). Otherwise, this field must not be set.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
