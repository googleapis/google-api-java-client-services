...
public final class ExternalDataSources extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ExternalDataSources set(String fieldName, Object value) {
    return (ExternalDataSources) super.set(fieldName, value);
  }

  @Override
  public ExternalDataSources clone() {
    return (ExternalDataSources) super.clone();
  }
