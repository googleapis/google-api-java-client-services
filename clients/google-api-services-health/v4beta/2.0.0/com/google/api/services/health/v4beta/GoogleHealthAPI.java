...
/**
 * Service definition for GoogleHealthAPI (v4beta).
 *
 * <p>
...
public class GoogleHealthAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Subscribers {
       ...
       * @param content the {@link com.google.api.services.health.v4beta.model.CreateSubscriberPayload}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.health.v4beta.model.CreateSubscriberPayload content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Operation> {

        private static final String REST_PATH = "v4beta/{+parent}/subscribers";
       ...
       *        projects/{project_number} Example: projects/1234567890
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.health.v4beta.model.CreateSubscriberPayload content) {
          super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.Operation.class);
      ...
      public class Delete extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Operation> {

        private static final String REST_PATH = "v4beta/{+name}";
       ...
       *        if not provided during creation.
        ...
        protected Delete(java.lang.String name) {
          super(GoogleHealthAPI.this, "DELETE", REST_PATH, null, com.google.api.services.health.v4beta.model.Operation.class);
      ...
      public class List extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ListSubscribersResponse> {
        ...
        protected List(java.lang.String parent) {
          super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ListSubscribersResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @param content the {@link com.google.api.services.health.v4beta.model.Subscriber}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.health.v4beta.model.Subscriber content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Operation> {
       ...
       *        subscriber ID): projects/my-project/subscribers/a1b2c3d4-e5f6-7890-1234-567890abcdef
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.health.v4beta.model.Subscriber content) {
          super(GoogleHealthAPI.this, "PATCH", REST_PATH, content, com.google.api.services.health.v4beta.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Subscriptions {
         ...
         *        /[a-z]([a-z0-9-]{2,34}[a-z0-9])/) if provided during creation, or system-generated
         *        otherwise.
         * @param content the {@link com.google.api.services.health.v4beta.model.CreateSubscriptionPayload}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.health.v4beta.model.CreateSubscriptionPayload content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Subscription> {

          private static final String REST_PATH = "v4beta/{+parent}/subscriptions";
         ...
         *        otherwise.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.health.v4beta.model.CreateSubscriptionPayload content) {
            super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.Subscription.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Delete extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Empty> {
         ...
         *        /[a-z]([a-z0-9-]{2,34}[a-z0-9])/) or system-generated if not provided during creation.
           ...
           */
          protected Delete(java.lang.String name) {
            super(GoogleHealthAPI.this, "DELETE", REST_PATH, null, com.google.api.services.health.v4beta.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ListSubscriptionsResponse> {
         ...
         *        otherwise.
           ...
           */
          protected List(java.lang.String parent) {
            super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ListSubscriptionsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.health.v4beta.model.Subscription}
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.health.v4beta.model.Subscription content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Subscription> {
         ...
         *        (4-36 chars, matching /[a-z]([a-z0-9-]{2,34}[a-z0-9])/) or system-generated otherwise.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.health.v4beta.model.Subscription content) {
            super(GoogleHealthAPI.this, "PATCH", REST_PATH, content, com.google.api.services.health.v4beta.model.Subscription.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
  ...
  public class Shl {
    ...
    public class M {
       ...
       * @param content the {@link com.google.api.services.health.v4beta.model.ManifestParams}
       * @return the request
       */
      public GetShlManifest getShlManifest(java.lang.String externalShlId, com.google.api.services.health.v4beta.model.ManifestParams content) throws java.io.IOException {
        GetShlManifest result = new GetShlManifest(externalShlId, content);
        initialize(result);
        return result;
      }

      public class GetShlManifest extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.HttpBody> {

        private static final String REST_PATH = "v4beta/shl/m/{externalShlId}";
       ...
       *        ocument/d/1Pch20pxJHRbsaMxp0EYgs3ZU0Gu7QTUznk8LhvbQvfY/edit?tab=t.0#heading=h.17wg41voij6q
         ...
         * @since 1.13
         */
        protected GetShlManifest(java.lang.String externalShlId, com.google.api.services.health.v4beta.model.ManifestParams content) {
          super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.HttpBody.class);
    ...
    public class R {
      ...
      public class Get extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.HttpBody> {

        private static final String REST_PATH = "v4beta/shl/r/{externalShlId}/{resourceToken}";
       ...
       *        ocument/d/1Pch20pxJHRbsaMxp0EYgs3ZU0Gu7QTUznk8LhvbQvfY/edit?tab=t.0#heading=h.17wg41voij6q
        ...
        protected Get(java.lang.String externalShlId, java.lang.String resourceToken) {
          super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.HttpBody.class);
          this.externalShlId = com.google.api.client.util.Preconditions.checkNotNull(externalShlId, "Required parameter externalShlId must be specified.");
  ...
  public class Users {
    ...
    public class GetIdentity extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Identity> {
      ...
      protected GetIdentity(java.lang.String name) {
        super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.Identity.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class GetIrnProfile extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.IrnProfile> {
     ...
     *        authenticated user.
      ...
      protected GetIrnProfile(java.lang.String name) {
        super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.IrnProfile.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class GetProfile extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Profile> {
      ...
      protected GetProfile(java.lang.String name) {
        super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.Profile.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class GetSettings extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Settings> {
      ...
      protected GetSettings(java.lang.String name) {
        super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.Settings.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     *        uppercase letters, numbers, and hyphens. The literal `me` can also be used to refer to the
     *        authenticated user.
     * @param content the {@link com.google.api.services.health.v4beta.model.Profile}
     * @return the request
     */
    public UpdateProfile updateProfile(java.lang.String name, com.google.api.services.health.v4beta.model.Profile content) throws java.io.IOException {
      UpdateProfile result = new UpdateProfile(name, content);
      initialize(result);
      return result;
    }

    public class UpdateProfile extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Profile> {
     ...
     *        authenticated user.
       ...
       * @since 1.13
       */
      protected UpdateProfile(java.lang.String name, com.google.api.services.health.v4beta.model.Profile content) {
        super(GoogleHealthAPI.this, "PATCH", REST_PATH, content, com.google.api.services.health.v4beta.model.Profile.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     *        uppercase letters, numbers, and hyphens. The literal `me` can also be used to refer to the
     *        authenticated user.
     * @param content the {@link com.google.api.services.health.v4beta.model.Settings}
     * @return the request
     */
    public UpdateSettings updateSettings(java.lang.String name, com.google.api.services.health.v4beta.model.Settings content) throws java.io.IOException {
      UpdateSettings result = new UpdateSettings(name, content);
      initialize(result);
      return result;
    }

    public class UpdateSettings extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Settings> {
     ...
     *        authenticated user.
       ...
       * @since 1.13
       */
      protected UpdateSettings(java.lang.String name, com.google.api.services.health.v4beta.model.Settings content) {
        super(GoogleHealthAPI.this, "PATCH", REST_PATH, content, com.google.api.services.health.v4beta.model.Settings.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class DataTypes {
      ...
      public class DataPoints {
         ...
         * @return the request
         */
        public BatchDelete batchDelete(java.lang.String parent, com.google.api.services.health.v4beta.model.BatchDeleteDataPointsRequest content) throws java.io.IOException {
          BatchDelete result = new BatchDelete(parent, content);
          initialize(result);
          return result;
        }

        public class BatchDelete extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Operation> {

          private static final String REST_PATH = "v4beta/{+parent}/dataPoints:batchDelete";
         ...
         *        all of the data points specified in `names` must match this field.
           ...
           * @since 1.13
           */
          protected BatchDelete(java.lang.String parent, com.google.api.services.health.v4beta.model.BatchDeleteDataPointsRequest content) {
            super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.health.v4beta.model.DataPoint content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
        ...
        public class Create extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.Operation> {
          ...
          private static final String REST_PATH = "v4beta/{+parent}/dataPoints";
         ...
         *        `users/{user}/dataTypes/{data_type}`
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.health.v4beta.model.DataPoint content) {
            super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
         ...
         * @return the request
         */
        public DailyRollUp dailyRollUp(java.lang.String parent, com.google.api.services.health.v4beta.model.DailyRollUpDataPointsRequest content) throws java.io.IOException {
          DailyRollUp result = new DailyRollUp(parent, content);
          initialize(result);
          return result;
        }

        public class DailyRollUp extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.DailyRollUpDataPointsResponse> {

          private static final String REST_PATH = "v4beta/{+parent}/dataPoints:dailyRollUp";
         ...
         *        DailyRollupDataPoint value union field.
           ...
           * @since 1.13
           */
          protected DailyRollUp(java.lang.String parent, com.google.api.services.health.v4beta.model.DailyRollUpDataPointsRequest content) {
            super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.DailyRollUpDataPointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class ExportExerciseTcx extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ExportExerciseTcxResponse> {

          private static final String REST_PATH = "v4beta/{+name}:exportExerciseTcx";
         ...
         *        exercise ID, which is a long integer.
          ...
          protected ExportExerciseTcx(java.lang.String name) {
            super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ExportExerciseTcxResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.DataPoint> {
         ...
         *        examples and possible values.
          ...
          protected Get(java.lang.String name) {
            super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.DataPoint.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ListDataPointsResponse> {
         ...
         *        supported data types see the DataPoint data union field.
           ...
           */
          protected List(java.lang.String parent) {
            super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ListDataPointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.health.v4beta.model.DataPoint content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }
         ...
         *        be a string of 4-63 characters, containing only lowercase letters, numbers, and hyphens.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.health.v4beta.model.DataPoint content) {
            super(GoogleHealthAPI.this, "PATCH", REST_PATH, content, com.google.api.services.health.v4beta.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Reconcile extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ReconcileDataPointsResponse> {

          private static final String REST_PATH = "v4beta/{+parent}/dataPoints:reconcile";
         ...
         *        supported data types see the DataPoint data union field.
          ...
          protected Reconcile(java.lang.String parent) {
            super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ReconcileDataPointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public RollUp rollUp(java.lang.String parent, com.google.api.services.health.v4beta.model.RollUpDataPointsRequest content) throws java.io.IOException {
          RollUp result = new RollUp(parent, content);
          initialize(result);
          return result;
        }

        public class RollUp extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.RollUpDataPointsResponse> {

          private static final String REST_PATH = "v4beta/{+parent}/dataPoints:rollUp";
         ...
         *        RollupDataPoint value union field.
           ...
           * @since 1.13
           */
          protected RollUp(java.lang.String parent, com.google.api.services.health.v4beta.model.RollUpDataPointsRequest content) {
            super(GoogleHealthAPI.this, "POST", REST_PATH, content, com.google.api.services.health.v4beta.model.RollUpDataPointsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
    ...
    public class PairedDevices {
      ...
      public class Get extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.PairedDevice> {
         ...
         */
        protected Get(java.lang.String name) {
          super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.PairedDevice.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends GoogleHealthAPIRequest<com.google.api.services.health.v4beta.model.ListPairedDevicesResponse> {

        private static final String REST_PATH = "v4beta/{+parent}/pairedDevices";
         ...
         */
        protected List(java.lang.String parent) {
          super(GoogleHealthAPI.this, "GET", REST_PATH, null, com.google.api.services.health.v4beta.model.ListPairedDevicesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
