...
public final class RequestOptions extends com.google.api.client.json.GenericJson {
   ...
   * in search results are biased towards the specified language. The suggest API does not use this
   * parameter. Instead, suggest autocompletes only based on characters in the query.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
