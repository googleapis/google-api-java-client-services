...
public final class AppsDynamiteSharedCard extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<AppsDynamiteSharedCardCardAction> cardActions;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AppsDynamiteSharedCardSection> sections;
   ...
   */
  public java.util.List<AppsDynamiteSharedCardCardAction> getCardActions() {
    return cardActions;
  }
   ...
   */
  public AppsDynamiteSharedCard setCardActions(java.util.List<AppsDynamiteSharedCardCardAction> cardActions) {
   ...
   */
  public AppsDynamiteSharedCard setHeader(AppsDynamiteSharedCardCardHeader header) {
    this.header = header;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedCard setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<AppsDynamiteSharedCardSection> getSections() {
    return sections;
  }
   ...
   */
  public AppsDynamiteSharedCard setSections(java.util.List<AppsDynamiteSharedCardSection> sections) {
    this.sections = sections;
    return this;
  }

  @Override
  public AppsDynamiteSharedCard set(String fieldName, Object value) {
    return (AppsDynamiteSharedCard) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedCard clone() {
