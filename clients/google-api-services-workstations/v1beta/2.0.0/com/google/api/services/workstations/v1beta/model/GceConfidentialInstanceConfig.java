...
public final class GceConfidentialInstanceConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GceConfidentialInstanceConfig set(String fieldName, Object value) {
    return (GceConfidentialInstanceConfig) super.set(fieldName, value);
  }

  @Override
  public GceConfidentialInstanceConfig clone() {
    return (GceConfidentialInstanceConfig) super.clone();
  }
