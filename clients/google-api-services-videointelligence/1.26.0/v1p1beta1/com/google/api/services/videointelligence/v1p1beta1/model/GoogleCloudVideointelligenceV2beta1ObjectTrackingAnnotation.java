...
public final class GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV2beta1ObjectTrackingFrame> frames;
   ...
   */
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation setConfidence(java.lang.Float confidence) {
   ...
   */
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation setEntity(GoogleCloudVideointelligenceV2beta1Entity entity) {
    this.entity = entity;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV2beta1ObjectTrackingFrame> getFrames() {
    return frames;
  }
   ...
   */
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation setFrames(java.util.List<GoogleCloudVideointelligenceV2beta1ObjectTrackingFrame> frames) {
    this.frames = frames;
    return this;
  }
   ...
   */
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation setSegment(GoogleCloudVideointelligenceV2beta1VideoSegment segment) {
   ...
   */
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation setTrackId(java.lang.Long trackId) {
    this.trackId = trackId;
    return this;
  }

  @Override
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation set(String fieldName, Object value) {
    return (GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVideointelligenceV2beta1ObjectTrackingAnnotation clone() {
