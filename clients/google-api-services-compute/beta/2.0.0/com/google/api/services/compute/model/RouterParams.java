...
public final class RouterParams extends com.google.api.client.json.GenericJson {

  /**
   * Tag keys/values directly bound to this resource. The field is allowed for INSERT only. The
  ...
  @Override
  public RouterParams set(String fieldName, Object value) {
    return (RouterParams) super.set(fieldName, value);
  }

  @Override
  public RouterParams clone() {
    return (RouterParams) super.clone();
  }
