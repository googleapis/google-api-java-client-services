...
public class CloudSupport extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class CaseClassifications {
     ...
     * $(gcloud auth print-access-token)" \ 'https://cloudsupport.googleapis.com/v2beta/caseClassificati
     * ons:search?query=display_name:"*Compute%20Engine*"' ``` Python: ```python import
    ...
    public class Search extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SearchCaseClassificationsResponse> {
       ...
       * m/v2beta/caseClassifications:search?query=display_name:"*Compute%20Engine*"' ``` Python:
  ...
  public class Cases {
     ...
     * "https://cloudsupport.googleapis.com/v2beta/$case:close" ``` Python: ```python import
     ...
     * "priority": "P3" }' \ "https://cloudsupport.googleapis.com/v2beta/$parent/cases" ``` Python:
     ...
     * is a test escalation." } }' \ "https://cloudsupport.googleapis.com/v2beta/$case:escalate" ```
     * Python: ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
     * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
     * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
    ...
    public class Escalate extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.CloudSupportCase> {
       ...
       * "https://cloudsupport.googleapis.com/v2beta/$case:escalate" ``` Python: ```python import
       * googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version, discoveryServ
       * iceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", ) request
     ...
     * "https://cloudsupport.googleapis.com/v2beta/$case" ``` Python: ```python import
     * googleapiclient.discovery api_version = "v2beta" supportApiService =
     * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
     * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
     ...
     * token)" \ "https://cloudsupport.googleapis.com/v2beta/$parent/cases" ``` Python: ```python import
     * googleapiclient.discovery api_version = "v2beta" supportApiService =
     * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
     * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
    ...
    public class List extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.ListCasesResponse> {
       ...
       * print-access-token)" \ "https://cloudsupport.googleapis.com/v2beta/$parent/cases" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version, discoveryServ
       * iceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", ) request
     ...
     * \ "https://cloudsupport.googleapis.com/v2beta/$case?updateMask=priority" ``` Python: ```python
    ...
    public class Patch extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.CloudSupportCase> {
       ...
       * project/cases/43595344" curl \ --request PATCH \ --header "Authorization: Bearer $(gcloud auth
       * print-access-token)" \ --header "Content-Type: application/json" \ --data '{ "priority": "P1"
       * }' \ "https://cloudsupport.googleapis.com/v2beta/$case?updateMask=priority" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version, discoveryServ
       * iceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", ) request
     ...
     * --header "Authorization: Bearer $(gcloud auth print-access-token)" \
     * "https://cloudsupport.googleapis.com/v2beta/$parent/cases:search" ``` Python: ```python import
     * googleapiclient.discovery api_version = "v2beta" supportApiService =
     * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
     * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
    ...
    public class Attachments {
       ...
       * "https://cloudsupport.googleapis.com/v2beta/$attachment" ``` Python: ```python import
       * googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
       ...
       * print-access-token)" \ "https://cloudsupport.googleapis.com/v2beta/$case/attachments" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
      ...
      public class List extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.ListAttachmentsResponse> {
         ...
         * auth print-access-token)" \ "https://cloudsupport.googleapis.com/v2beta/$case/attachments" ```
         * Python: ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
         * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version, discoveryServ
         * iceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", ) request
    ...
    public class Comments {
       ...
       * "https://cloudsupport.googleapis.com/v2beta/$case/comments" ``` Python: ```python import
       * googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
       ...
       * print-access-token)" \ "https://cloudsupport.googleapis.com/v2beta/$comment" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
      ...
      public class List extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.ListCommentsResponse> {
         ...
         * token)" \ "https://cloudsupport.googleapis.com/v2beta/$case/comments" ``` Python: ```python
         * import googleapiclient.discovery api_version = "v2beta" supportApiService =
         * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version, discoveryServ
         * iceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", ) request
  ...
  public class Media {
     ...
     * "https://cloudsupport.googleapis.com/v2beta/$name:download?alt=media" ``` Python: ```python
     * import googleapiclient.discovery api_version = "v2beta" supportApiService =
     * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
     * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
     ...
     * _via_curl.txt" ``` Python: ```python import googleapiclient.discovery api_version = "v2beta"
  ...
  public class Organizations {
    ...
    public class SupportEventSubscriptions {
       ...
       * "https://cloudsupport.googleapis.com/v2beta/$parent/supportEventSubscriptions" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
      ...
      public class Create extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription> {

        private static final String REST_PATH = "v2beta/{+parent}/supportEventSubscriptions";
       ...
       *        organizations/{organization_id}
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription content) {
          super(CloudSupport.this, "POST", REST_PATH, content, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription" ``` Python: ```python
       * import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
      ...
      public class Delete extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription> {
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
        ...
        protected Delete(java.lang.String name) {
          super(CloudSupport.this, "DELETE", REST_PATH, null, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * support_event_subscription="organizations/123456789/supportEventSubscriptions/abcdef123456" curl
       * \ --request POST \ --header "Authorization: Bearer $(gcloud auth print-access-token)" \
       * "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription:expunge" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
       * @param content the {@link com.google.api.services.cloudsupport.v2beta.model.ExpungeSupportEventSubscriptionRequest}
       * @return the request
       */
      public Expunge expunge(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.ExpungeSupportEventSubscriptionRequest content) throws java.io.IOException {
        Expunge result = new Expunge(name, content);
        initialize(result);
        return result;
      }

      public class Expunge extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.Empty> {

        private static final String REST_PATH = "v2beta/{+name}:expunge";
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
         ...
         * @since 1.13
         */
        protected Expunge(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.ExpungeSupportEventSubscriptionRequest content) {
          super(CloudSupport.this, "POST", REST_PATH, content, com.google.api.services.cloudsupport.v2beta.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription> {
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudSupport.this, "GET", REST_PATH, null, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.ListSupportEventSubscriptionsResponse> {
       ...
       *        Format: organizations/{organization_id}
         ...
         */
        protected List(java.lang.String parent) {
          super(CloudSupport.this, "GET", REST_PATH, null, com.google.api.services.cloudsupport.v2beta.model.ListSupportEventSubscriptionsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription> {
         ...
         * project/topics/new-topic" }' \ "https://cloudsupport.googleapis.com/v2beta/$support_event_subsc
         * ription?updateMask=pub_sub_topic" ``` Python: ```python import googleapiclient.discovery
         * api_version = "v2beta" supportApiService = googleapiclient.discovery.build(
         * serviceName="cloudsupport", version=api_version, discoveryServiceUrl=f"https://cloudsupport.goo
         * gleapis.com/$discovery/rest?version={api_version}", ) request =
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription content) {
          super(CloudSupport.this, "PATCH", REST_PATH, content, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * support_event_subscription="organizations/123456789/supportEventSubscriptions/abcdef123456" curl
       * \ --request POST \ --header "Authorization: Bearer $(gcloud auth print-access-token)" \
       * "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription:undelete" ``` Python:
       * ```python import googleapiclient.discovery api_version = "v2beta" supportApiService =
       * googleapiclient.discovery.build( serviceName="cloudsupport", version=api_version,
       * discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
       * @param content the {@link com.google.api.services.cloudsupport.v2beta.model.UndeleteSupportEventSubscriptionRequest}
       * @return the request
       */
      public Undelete undelete(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.UndeleteSupportEventSubscriptionRequest content) throws java.io.IOException {
        Undelete result = new Undelete(name, content);
        initialize(result);
        return result;
      }

      public class Undelete extends CloudSupportRequest<com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription> {

        private static final String REST_PATH = "v2beta/{+name}:undelete";
       ...
       *        organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
         ...
         * @since 1.13
         */
        protected Undelete(java.lang.String name, com.google.api.services.cloudsupport.v2beta.model.UndeleteSupportEventSubscriptionRequest content) {
          super(CloudSupport.this, "POST", REST_PATH, content, com.google.api.services.cloudsupport.v2beta.model.SupportEventSubscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
