...
public final class NetworkPlacementsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NetworkPlacement> items;

  static {
    // hack to force ProGuard to consider NetworkPlacement used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkPlacement.class);
  }
   ...
   */
  public NetworkPlacementsListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public NetworkPlacementsListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkPlacement> getItems() {
    return items;
  }
   ...
   */
  public NetworkPlacementsListResponse setItems(java.util.List<NetworkPlacement> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkPlacementsListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkPlacementsListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkPlacementsListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkPlacementsListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NetworkPlacementsListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkPlacementsListResponse set(String fieldName, Object value) {
    return (NetworkPlacementsListResponse) super.set(fieldName, value);
  }

  @Override
  public NetworkPlacementsListResponse clone() {
    return (NetworkPlacementsListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkPlacementsListResponseWarningData.
     */
