...
public final class SubmitJobRequest extends com.google.api.client.json.GenericJson {
   ...
   * (https://cloud.google.com/dataproc/docs/reference/rpc/google.cloud.dataproc.v1#google.cloud.dat
   * aproc.v1.SubmitJobRequest)s with the same id, then the second request will be ignored and the
   * first Job created and stored in the backend is returned.It is recommended to always set this
   * value to a UUID (https://en.wikipedia.org/wiki/Universally_unique_identifier).The id must
