      ...
      public class Issues {
         ...
         *        received. Format: apps/{app}
         ...
         received. Format: apps/{app}
           ...
           * `errorIssueType = CRASH OR errorIssueType = ANR`. ** Supported operators:** *
           * Comparison operators: The only supported comparison operator is equality. The filtered
           * field must appear on the left hand side of the comparison. * Logical Operators: Logical
           * operators `AND` and `OR` can be used to build complex filters following a conjunctive
           * normal form (CNF), i.e., conjunctions of disjunctions. The `OR` operator takes
           * precedence over `AND` so the use of parenthesis is not necessary when building CNF. The
           * `OR` operator is only supported to build disjunctions that apply to the same field,
           * e.g., `versionCode = 123 OR errorIssueType = ANR` is not a valid filter. ** Examples **
         ...
         errorIssueType = ANR`. ** Supported operators:** * Comparison operators: The only supported
      ...
      public class Reports {
         ...
         *        Format: apps/{app}
         ...
         Format: apps/{app}
           ...
           * issue ids only. Example: `errorIssueId = 1234 OR errorIssueId = 4567`. ** Supported
           * operators:** * Comparison operators: The only supported comparison operator is
           * equality. The filtered field must appear on the left hand side of the comparison. *
         ...
         errorIssueId = 4567`. ** Supported operators:** * Comparison operators: The only supported
         comparison operator is equality. The filtered field must appear on the left hand side of the
         comparison. * Logical Operators: Logical operators `AND` and `OR` can be used to build complex
         filters following a conjunctive normal form (CNF), i.e., conjunctions of disjunctions. The `OR`
         operator takes precedence over `AND` so the use of parenthesis is not necessary when building CNF.
