...
public final class GoogleAppsDriveLabelsV2betaWriteControl extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleAppsDriveLabelsV2betaWriteControl setRequiredRevisionId(java.lang.String requiredRevisionId) {
    this.requiredRevisionId = requiredRevisionId;
    return this;
  }

  @Override
  public GoogleAppsDriveLabelsV2betaWriteControl set(String fieldName, Object value) {
    return (GoogleAppsDriveLabelsV2betaWriteControl) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsDriveLabelsV2betaWriteControl clone() {
    return (GoogleAppsDriveLabelsV2betaWriteControl) super.clone();
  }
