...
public final class GoogleCloudContactcenterinsightsV1alpha1QueryMetricsMetadata extends com.google.api.client.json.GenericJson {
  ...
  private java.lang.Boolean resultIsTruncated;

  /**
   * Whether the result rows were truncated because the result row size is too large to materialize.
   * @return value or {@code null} for none
   */
  public java.lang.Boolean getResultIsTruncated() {
    return resultIsTruncated;
  }

  /**
   * Whether the result rows were truncated because the result row size is too large to materialize.
   * @param resultIsTruncated resultIsTruncated or {@code null} for none
   */
  public GoogleCloudContactcenterinsightsV1alpha1QueryMetricsMetadata setResultIsTruncated(java.lang.Boolean resultIsTruncated) {
