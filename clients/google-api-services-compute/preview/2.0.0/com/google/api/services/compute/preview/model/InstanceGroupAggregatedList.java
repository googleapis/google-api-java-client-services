...
public final class InstanceGroupAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, InstanceGroupsScopedList> getItems() {
    return items;
  }
   ...
   */
  public InstanceGroupAggregatedList setItems(java.util.Map<String, InstanceGroupsScopedList> items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public InstanceGroupAggregatedList set(String fieldName, Object value) {
    return (InstanceGroupAggregatedList) super.set(fieldName, value);
  }

  @Override
  public InstanceGroupAggregatedList clone() {
    return (InstanceGroupAggregatedList) super.clone();
  }
