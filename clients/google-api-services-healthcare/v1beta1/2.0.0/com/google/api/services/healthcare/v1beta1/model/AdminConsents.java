...
public final class AdminConsents extends com.google.api.client.json.GenericJson {
   ...
   * istory/{version_id}`. For FHIR stores with `disable_resource_versioning=true`, the format is `p
   * rojects/{project_id}/locations/{location}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir
   * /Consent/{resource_id}`.
