...
public final class CommercialInfo extends com.google.api.client.json.GenericJson {
  ...
  private GoogleCloudMarketplaceInfo cloudMarketplace;
   ...
   */
  public CommercialInfo setCloudMarketplace(GoogleCloudMarketplaceInfo cloudMarketplace) {
    this.cloudMarketplace = cloudMarketplace;
    return this;
  }

  @Override
  public CommercialInfo set(String fieldName, Object value) {
    return (CommercialInfo) super.set(fieldName, value);
  }

  @Override
  public CommercialInfo clone() {
    return (CommercialInfo) super.clone();
  }
