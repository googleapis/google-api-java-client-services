...
public final class GoogleCloudDialogflowV2beta1Intent extends com.google.api.client.json.GenericJson {
   ...
   *
   * - If the supplied value is unspecified or 0, the service   translates the value to 500,000,
   * which corresponds to the   `Normal` priority in the console. - If the supplied value is
