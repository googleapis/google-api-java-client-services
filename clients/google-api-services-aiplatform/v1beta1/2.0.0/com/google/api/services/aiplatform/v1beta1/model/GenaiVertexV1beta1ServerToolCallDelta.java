...
/**
 * Model definition for GenaiVertexV1beta1ServerToolCallDelta.
 *
...
public final class GenaiVertexV1beta1ServerToolCallDelta extends com.google.api.client.json.GenericJson {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setCodeExecutionCall(GenaiVertexV1beta1CodeExecutionCallDelta codeExecutionCall) {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setFileSearchCall(GenaiVertexV1beta1FileSearchCallDelta fileSearchCall) {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setGoogleMapsCall(GenaiVertexV1beta1GoogleMapsCallDelta googleMapsCall) {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setGoogleSearchCall(GenaiVertexV1beta1GoogleSearchCallDelta googleSearchCall) {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setSignature(java.lang.String signature) {
   ...
   * @since 1.14
   */
  public GenaiVertexV1beta1ServerToolCallDelta encodeSignature(byte[] signature) {
   ...
   */
  public GenaiVertexV1beta1ServerToolCallDelta setUrlContextCall(GenaiVertexV1beta1UrlContextCallDelta urlContextCall) {
    this.urlContextCall = urlContextCall;
    return this;
  }

  @Override
  public GenaiVertexV1beta1ServerToolCallDelta set(String fieldName, Object value) {
    return (GenaiVertexV1beta1ServerToolCallDelta) super.set(fieldName, value);
  }

  @Override
  public GenaiVertexV1beta1ServerToolCallDelta clone() {
    return (GenaiVertexV1beta1ServerToolCallDelta) super.clone();
  }
