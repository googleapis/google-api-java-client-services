...
public final class ApigatewayApiConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Immutable. Gateway specific configuration. If not specified, backend authentication will be set
   * to use OIDC authentication using the default compute service account.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
