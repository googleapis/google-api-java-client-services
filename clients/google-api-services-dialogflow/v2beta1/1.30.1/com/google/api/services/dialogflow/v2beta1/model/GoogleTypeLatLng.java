...
public final class GoogleTypeLatLng extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleTypeLatLng set(String fieldName, Object value) {
    return (GoogleTypeLatLng) super.set(fieldName, value);
  }

  @Override
  public GoogleTypeLatLng clone() {
    return (GoogleTypeLatLng) super.clone();
  }
