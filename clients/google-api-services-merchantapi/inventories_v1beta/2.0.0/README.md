...
<project>
  <dependencies>
    <dependency>
      ...
      <version>inventories_v1beta-rev20250219-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:inventories_v1beta-rev20250219-2.0.0'
}
```
