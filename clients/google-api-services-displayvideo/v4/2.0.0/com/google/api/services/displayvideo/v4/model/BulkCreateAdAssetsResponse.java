...
public final class BulkCreateAdAssetsResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public BulkCreateAdAssetsResponse set(String fieldName, Object value) {
    return (BulkCreateAdAssetsResponse) super.set(fieldName, value);
  }

  @Override
  public BulkCreateAdAssetsResponse clone() {
    return (BulkCreateAdAssetsResponse) super.clone();
  }
