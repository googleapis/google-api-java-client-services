...
public final class RolloutStats extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Output only. Estimated number of units based. The estimation is computed upon
   * creation of the rollout.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long estimatedTotalUnitCount;
   ...
   */
  public java.lang.Long getEstimatedTotalUnitCount() {
    return estimatedTotalUnitCount;
  }

  /**
   * Optional. Output only. Estimated number of units based. The estimation is computed upon
   * creation of the rollout.
   * @param estimatedTotalUnitCount estimatedTotalUnitCount or {@code null} for none
   */
  public RolloutStats setEstimatedTotalUnitCount(java.lang.Long estimatedTotalUnitCount) {
