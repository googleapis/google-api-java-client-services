...
public final class InstanceTemplateAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, InstanceTemplatesScopedList> items;
   ...
   */
  public InstanceTemplateAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, InstanceTemplatesScopedList> getItems() {
    return items;
  }
   ...
   */
  public InstanceTemplateAggregatedList setItems(java.util.Map<String, InstanceTemplatesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstanceTemplateAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InstanceTemplateAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstanceTemplateAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InstanceTemplateAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceTemplateAggregatedList set(String fieldName, Object value) {
    return (InstanceTemplateAggregatedList) super.set(fieldName, value);
  }

  @Override
  public InstanceTemplateAggregatedList clone() {
    return (InstanceTemplateAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for InstanceTemplateAggregatedListWarningData.
     */
