...
public final class GoogleBigtableAdminV2TypeBytes extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleBigtableAdminV2TypeBytes set(String fieldName, Object value) {
    return (GoogleBigtableAdminV2TypeBytes) super.set(fieldName, value);
  }

  @Override
  public GoogleBigtableAdminV2TypeBytes clone() {
    return (GoogleBigtableAdminV2TypeBytes) super.clone();
  }
