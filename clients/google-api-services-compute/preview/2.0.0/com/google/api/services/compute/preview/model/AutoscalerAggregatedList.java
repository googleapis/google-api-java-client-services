...
public final class AutoscalerAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, AutoscalersScopedList> getItems() {
    return items;
  }
   ...
   */
  public AutoscalerAggregatedList setItems(java.util.Map<String, AutoscalersScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AutoscalerAggregatedList setWarning(Warning warning) {
