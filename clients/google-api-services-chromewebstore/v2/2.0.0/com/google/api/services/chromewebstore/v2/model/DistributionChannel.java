...
public final class DistributionChannel extends com.google.api.client.json.GenericJson {
   ...
   */
  public DistributionChannel setCrxVersion(java.lang.String crxVersion) {
   ...
   */
  public DistributionChannel setDeployPercentage(java.lang.Integer deployPercentage) {
    this.deployPercentage = deployPercentage;
    return this;
  }

  @Override
  public DistributionChannel set(String fieldName, Object value) {
    return (DistributionChannel) super.set(fieldName, value);
  }

  @Override
  public DistributionChannel clone() {
    return (DistributionChannel) super.clone();
  }
