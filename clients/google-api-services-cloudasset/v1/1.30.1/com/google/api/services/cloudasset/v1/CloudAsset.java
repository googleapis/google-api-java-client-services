...
public class CloudAsset extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class V1 {
     ...
     * is newline-delimited JSON. Each line represents a google.cloud.asset.v1.Asset in the JSON format.
     * This API implements the google.longrunning.Operation API allowing you to keep track of the
     * export. We recommend intervals of at least 2 seconds with exponential retry to poll the export
     * operation result. For regular-size resource parent, the export operation usually finishes within
     * 5 minutes.
     *
    ...
    public class ExportAssets extends CloudAssetRequest<com.google.api.services.cloudasset.v1.model.Operation> {
       ...
       * format is newline-delimited JSON. Each line represents a google.cloud.asset.v1.Asset in the
       * JSON format. This API implements the google.longrunning.Operation API allowing you to keep
    ...
    * organizations/{ORGANIZATION_NUMBER}
     ...
     * organization). Callers should have cloud.assets.SearchAllResources permission upon the requested
    ...
    * organizations/{ORGANIZATION_NUMBER}
     ...
     * projects/{PROJECT_ID} * projects/{PROJECT_NUMBER} * folders/{FOLDER_NUMBER} *
     ...
     types#searchable_asset_types).
       ...
       * Redundant space characters are ignored. Example: "location DESC, name". See [supported
       * resource metadata fields](https://cloud.google.com/asset-inventory/docs/searching-
       * resources#query_on_resource_metadata_fields) for more details.
       */
      @com.google.api.client.util.Key
     ...
     characters are ignored. Example: "location DESC, name". See [supported resource metadata
