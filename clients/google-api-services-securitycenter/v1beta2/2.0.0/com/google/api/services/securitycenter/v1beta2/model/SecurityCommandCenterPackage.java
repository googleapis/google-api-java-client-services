...
public final class SecurityCommandCenterPackage extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public SecurityCommandCenterPackage set(String fieldName, Object value) {
    return (SecurityCommandCenterPackage) super.set(fieldName, value);
  }

  @Override
  public SecurityCommandCenterPackage clone() {
    return (SecurityCommandCenterPackage) super.clone();
  }
