...
public class ContainerScopes {
  ...
  public static final String CONTAINER = "https://www.googleapis.com/auth/container";

  /** See your Google Kubernetes Engine data and the email address of your Google Account. */
  public static final String CONTAINER_READ_ONLY = "https://www.googleapis.com/auth/container.read-only";
  ...
  public static java.util.Set<String> all() {
    ...
    set.add(CONTAINER);
    set.add(CONTAINER_READ_ONLY);
    return java.util.Collections.unmodifiableSet(set);
  }

  private ContainerScopes() {
  }
}
