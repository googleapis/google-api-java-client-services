...
public final class PacketMirroringsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<PacketMirroring> packetMirrorings;
   ...
   */
  public java.util.List<PacketMirroring> getPacketMirrorings() {
    return packetMirrorings;
  }

  /**
   * A list of packetMirrorings contained in this scope.
   * @param packetMirrorings packetMirrorings or {@code null} for none
   */
  public PacketMirroringsScopedList setPacketMirrorings(java.util.List<PacketMirroring> packetMirrorings) {
   ...
   */
  public PacketMirroringsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PacketMirroringsScopedList set(String fieldName, Object value) {
    return (PacketMirroringsScopedList) super.set(fieldName, value);
  }

  @Override
  public PacketMirroringsScopedList clone() {
    return (PacketMirroringsScopedList) super.clone();
  }
