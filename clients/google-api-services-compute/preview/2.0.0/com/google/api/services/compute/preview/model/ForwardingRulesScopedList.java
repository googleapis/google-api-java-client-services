...
public final class ForwardingRulesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public ForwardingRulesScopedList setForwardingRules(java.util.List<ForwardingRule> forwardingRules) {
   ...
   */
  public ForwardingRulesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ForwardingRulesScopedList set(String fieldName, Object value) {
    return (ForwardingRulesScopedList) super.set(fieldName, value);
  }

  @Override
  public ForwardingRulesScopedList clone() {
    return (ForwardingRulesScopedList) super.clone();
  }
