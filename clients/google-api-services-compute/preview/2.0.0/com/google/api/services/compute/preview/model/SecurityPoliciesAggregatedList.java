...
public final class SecurityPoliciesAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, SecurityPoliciesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#securityPolicyAggregatedList for
   * lists of Security Policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public SecurityPoliciesAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public SecurityPoliciesAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, SecurityPoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public SecurityPoliciesAggregatedList setItems(java.util.Map<String, SecurityPoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SecurityPoliciesAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public SecurityPoliciesAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SecurityPoliciesAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public SecurityPoliciesAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public SecurityPoliciesAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SecurityPoliciesAggregatedList set(String fieldName, Object value) {
    return (SecurityPoliciesAggregatedList) super.set(fieldName, value);
  }

  @Override
  public SecurityPoliciesAggregatedList clone() {
    return (SecurityPoliciesAggregatedList) super.clone();
  }
