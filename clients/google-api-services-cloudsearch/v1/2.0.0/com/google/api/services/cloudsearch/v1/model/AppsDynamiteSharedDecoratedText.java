...
public final class AppsDynamiteSharedDecoratedText extends com.google.api.client.json.GenericJson {
   ...
   */
  public AppsDynamiteSharedDecoratedText setBottomLabel(java.lang.String bottomLabel) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setButton(AppsDynamiteSharedButton button) {
    this.button = button;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedDecoratedText setEndIcon(AppsDynamiteSharedIcon endIcon) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setIcon(AppsDynamiteSharedIcon icon) {
    this.icon = icon;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedDecoratedText setOnClick(AppsDynamiteSharedOnClick onClick) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setStartIcon(AppsDynamiteSharedIcon startIcon) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setSwitchControl(AppsDynamiteSharedDecoratedTextSwitchControl switchControl) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setText(java.lang.String text) {
    this.text = text;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedDecoratedText setTopLabel(java.lang.String topLabel) {
   ...
   */
  public AppsDynamiteSharedDecoratedText setWrapText(java.lang.Boolean wrapText) {
    this.wrapText = wrapText;
    return this;
  }

  @Override
  public AppsDynamiteSharedDecoratedText set(String fieldName, Object value) {
    return (AppsDynamiteSharedDecoratedText) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedDecoratedText clone() {
