...
public final class GoogleCloudChannelV1DateRange extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudChannelV1DateRange setInvoiceEndDate(GoogleTypeDate invoiceEndDate) {
   ...
   */
  public GoogleCloudChannelV1DateRange setInvoiceStartDate(GoogleTypeDate invoiceStartDate) {
   ...
   */
  public GoogleCloudChannelV1DateRange setUsageEndDateTime(GoogleTypeDateTime usageEndDateTime) {
   ...
   */
  public GoogleCloudChannelV1DateRange setUsageStartDateTime(GoogleTypeDateTime usageStartDateTime) {
    this.usageStartDateTime = usageStartDateTime;
    return this;
  }

  @Override
  public GoogleCloudChannelV1DateRange set(String fieldName, Object value) {
    return (GoogleCloudChannelV1DateRange) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudChannelV1DateRange clone() {
    return (GoogleCloudChannelV1DateRange) super.clone();
  }
