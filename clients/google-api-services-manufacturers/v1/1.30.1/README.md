# Manufacturer Center API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1-rev20200317-1.30.10</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-manufacturers:v1-rev20200317-1.30.10'
}
```
