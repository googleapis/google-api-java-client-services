...
public class Document extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
       ...
       * <pre>
       *   {@code Document documentai = new Document(...);}
       *   {@code Document.Schemas.List request = documentai.schemas().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Schemas {
         ...
         * parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The parent (project and location) under which to create the Schema. Format:
         *        `projects/{project}/locations/{location}`
         * @param content the {@link com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema> {
         ...
         *        `projects/{project}/locations/{location}`
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema content) {
            super(Document.this, "POST", REST_PATH, content, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Delete extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleLongrunningOperation> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/schemas/[^/]+$");
         ...
         *        `projects/{project}/locations/{location}/schemas/{schema}`
         ...
         `projects/{project}/locations/{location}/schemas/{schema}`
          ...
          /**
           * Optional. If set to true, any child resources of this Schema will also be deleted.
           * (Otherwise, the request will only work if the Schema has no child resources.)
           */
          @com.google.api.client.util.Key
          private java.lang.Boolean force;

          /** Optional. If set to true, any child resources of this Schema will also be deleted. (Otherwise, the
         request will only work if the Schema has no child resources.)
           */
        ...
        public class Get extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema> {
         ...
         *        `projects/{project}/locations/{location}/schemas/{schema}`
           ...
           */
          protected Get(java.lang.String name) {
            super(Document.this, "GET", REST_PATH, null, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1ListSchemasResponse> {
           ...
           */
          protected List(java.lang.String parent) {
            super(Document.this, "GET", REST_PATH, null, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1ListSchemasResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * Optional. The maximum number of schema groups to return. If unspecified, at most `10`
           * Schema will be returned. The maximum value is `20`. Values above `20` will be coerced
           * to `20`.
           */
          @com.google.api.client.util.Key
          private java.lang.Integer pageSize;

          /** Optional. The maximum number of schema groups to return. If unspecified, at most `10` Schema will
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema> {
         ...
         *        `projects/{project}/locations/{location}/schemas/{schema}`
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema content) {
            super(Document.this, "PATCH", REST_PATH, content, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1NextSchema.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        /**
         * An accessor for creating requests from the SchemaVersions collection.
         *
         * <p>The typical use is:</p>
         * <pre>
         *   {@code Document documentai = new Document(...);}
         *   {@code Document.SchemaVersions.List request = documentai.schemaVersions().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        public class SchemaVersions {
           ...
           *
           * Create a request for the method "schemaVersions.create".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link Create#execute()} method to invoke the remote operation.
           *
           * @param parent Required. The parent (project and location) under which to create the SchemaVersion. Format:
           *        `projects/{project}/locations/{location}/schemas/{schema}`
           * @param content the {@link com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion> {

            private static final String REST_PATH = "v1/{+parent}/schemaVersions";
           ...
           *        `projects/{project}/locations/{location}/schemas/{schema}`
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion content) {
              super(Document.this, "POST", REST_PATH, content, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
            ...
            /**
             * Required. The parent (project and location) under which to create the SchemaVersion.
           ...
           *
           * Create a request for the method "schemaVersions.delete".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
           *
          ...
          public class Delete extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleLongrunningOperation> {
            ...
            private final java.util.regex.Pattern NAME_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/schemas/[^/]+/schemaVersions/[^/]+$");
           ...
           *        `projects/{project}/locations/{location}/schemas/{schema}/schemaVersions/{schema_version}`
            ...
            /**
             * Required. The name of the SchemaVersion to delete. Format: `projects/{project}/locati
             * ons/{location}/schemas/{schema}/schemaVersions/{schema_version}`
             */
            @com.google.api.client.util.Key
            private java.lang.String name;
           ...
           *
           * Create a request for the method "schemaVersions.generate".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link Generate#execute()} method to invoke the remote operation.
           *
           * @param parent Required. The parent (project, location and schema) under which to generate the SchemaVersion.
           *        Format: `projects/{project}/locations/{location}/schemas/{schema}`
           * @param content the {@link com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1GenerateSchemaVersionRequest}
           * @return the request
           */
          public Generate generate(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1GenerateSchemaVersionRequest content) throws java.io.IOException {
            Generate result = new Generate(parent, content);
            initialize(result);
            return result;
          }

          public class Generate extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1GenerateSchemaVersionResponse> {

            private static final String REST_PATH = "v1/{+parent}/schemaVersions:generate";
           ...
           *        Format: `projects/{project}/locations/{location}/schemas/{schema}`
             ...
             * @since 1.13
             */
            protected Generate(java.lang.String parent, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1GenerateSchemaVersionRequest content) {
              super(Document.this, "POST", REST_PATH, content, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1GenerateSchemaVersionResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           *
           * Create a request for the method "schemaVersions.get".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link Get#execute()} method to invoke the remote operation.
           *
          ...
          public class Get extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion> {
           ...
           *        `projects/{project}/locations/{location}/schemas/{schema}/schemaVersions/{schema_version}`
             ...
             */
            protected Get(java.lang.String name) {
              super(Document.this, "GET", REST_PATH, null, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
            ...
            /**
             * Required. The name of the SchemaVersion to get. Format: `projects/{project}/locations
             * /{location}/schemas/{schema}/schemaVersions/{schema_version}`
             */
            @com.google.api.client.util.Key
            private java.lang.String name;
           ...
           *
           * Create a request for the method "schemaVersions.list".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link List#execute()} method to invoke the remote operation.
           *
           * @param parent Required. Format: `projects/{project}/locations/{location}/schemas/{schema}`
           * @return the request
           */
          public List list(java.lang.String parent) throws java.io.IOException {
            List result = new List(parent);
          ...
          public class List extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1ListSchemaVersionsResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(Document.this, "GET", REST_PATH, null, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1ListSchemaVersionsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
             ...
             * SchemaVersion will be returned. The maximum value is `20`. Values above `20` will be
             * coerced to `20`.
             */
            @com.google.api.client.util.Key
            private java.lang.Integer pageSize;

            /** Optional. The maximum number of SchemaVersion to return. If unspecified, at most `10` SchemaVersion
           will be returned. The maximum value is `20`. Values above `20` will be coerced to `20`.
             */
            public java.lang.Integer getPageSize() {
              return pageSize;
           ...
           *
           * Create a request for the method "schemaVersions.patch".
           *
           * This request holds the parameters needed by the documentai server.  After setting any optional
           * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
           *
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }

          public class Patch extends DocumentRequest<com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion> {
           ...
           *        `projects/{project}/locations/{location}/schemas/{schema}/schemaVersions/{schema_version}`
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion content) {
              super(Document.this, "PATCH", REST_PATH, content, com.google.api.services.documentai.v1.model.GoogleCloudDocumentaiV1SchemaVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
            ...
            /**
             * Identifier. The resource name of the SchemaVersion. Format: `projects/{project}/locat
             * ions/{location}/schemas/{schema}/schemaVersions/{schema_version}`
             */
            @com.google.api.client.util.Key
            private java.lang.String name;
