...
public final class JobProcessingOptions extends com.google.api.client.json.GenericJson {
   ...
   */
  public JobProcessingOptions setDisableStreetAddressResolution(java.lang.Boolean disableStreetAddressResolution) {
  ...
  @Override
  public JobProcessingOptions set(String fieldName, Object value) {
    return (JobProcessingOptions) super.set(fieldName, value);
  }

  @Override
  public JobProcessingOptions clone() {
    return (JobProcessingOptions) super.clone();
  }
