...
public final class PushCredentialsRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public PushCredentialsRequest set(String fieldName, Object value) {
    return (PushCredentialsRequest) super.set(fieldName, value);
  }

  @Override
  public PushCredentialsRequest clone() {
    return (PushCredentialsRequest) super.clone();
  }
