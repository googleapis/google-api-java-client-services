...
public final class ServiceAttachmentAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, ServiceAttachmentsScopedList> items;
   ...
   */
  public ServiceAttachmentAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, ServiceAttachmentsScopedList> getItems() {
    return items;
  }
   ...
   */
  public ServiceAttachmentAggregatedList setItems(java.util.Map<String, ServiceAttachmentsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ServiceAttachmentAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ServiceAttachmentAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ServiceAttachmentAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ServiceAttachmentAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public ServiceAttachmentAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ServiceAttachmentAggregatedList set(String fieldName, Object value) {
    return (ServiceAttachmentAggregatedList) super.set(fieldName, value);
  }

  @Override
  public ServiceAttachmentAggregatedList clone() {
    return (ServiceAttachmentAggregatedList) super.clone();
  }
