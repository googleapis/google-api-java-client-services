...
public final class HeldVoiceQuery extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public HeldVoiceQuery set(String fieldName, Object value) {
    return (HeldVoiceQuery) super.set(fieldName, value);
  }

  @Override
  public HeldVoiceQuery clone() {
    return (HeldVoiceQuery) super.clone();
  }
