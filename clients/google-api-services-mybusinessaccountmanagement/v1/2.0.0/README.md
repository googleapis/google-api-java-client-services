# My Business Account Management API Client Library for Java
...
dependencies {
  implementation 'com.google.apis:google-api-services-mybusinessaccountmanagement:v1-rev20250615-2.0.0'
}
```
