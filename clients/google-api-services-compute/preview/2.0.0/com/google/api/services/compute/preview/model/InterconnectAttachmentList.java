...
public final class InterconnectAttachmentList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InterconnectAttachment> items;

  static {
    // hack to force ProGuard to consider InterconnectAttachment used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InterconnectAttachment.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#interconnectAttachmentList for lists
   ...
   */
  public InterconnectAttachmentList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InterconnectAttachment> getItems() {
    return items;
  }
   ...
   */
  public InterconnectAttachmentList setItems(java.util.List<InterconnectAttachment> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InterconnectAttachmentList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InterconnectAttachmentList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InterconnectAttachmentList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InterconnectAttachmentList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectAttachmentList set(String fieldName, Object value) {
    return (InterconnectAttachmentList) super.set(fieldName, value);
  }

  @Override
  public InterconnectAttachmentList clone() {
    return (InterconnectAttachmentList) super.clone();
  }
