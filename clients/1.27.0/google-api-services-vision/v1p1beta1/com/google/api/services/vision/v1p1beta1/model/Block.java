...
public final class Block extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Paragraph> paragraphs;

  static {
    // hack to force ProGuard to consider Paragraph used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Paragraph.class);
  }
   ...
   */
  public Block setBlockType(java.lang.String blockType) {
   ...
   */
  public Block setConfidence(java.lang.Float confidence) {
   ...
   */
  public Block setParagraphs(java.util.List<Paragraph> paragraphs) {
   ...
   */
  public Block setProperty(TextProperty property) {
