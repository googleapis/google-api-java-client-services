...
public final class Cluster extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The rollback safe upgrade information of the cluster. This field is used when user
   * manually triggers a rollback safe upgrade.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public Cluster setGkeAutoUpgradeConfig(GkeAutoUpgradeConfig gkeAutoUpgradeConfig) {
