...
public final class GoogleCloudRecommenderV1beta1Recommendation extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudRecommenderV1beta1Impact> additionalImpact;

  static {
    // hack to force ProGuard to consider GoogleCloudRecommenderV1beta1Impact used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudRecommenderV1beta1Impact.class);
  }
   ...
   */
  public java.util.List<GoogleCloudRecommenderV1beta1Impact> getAdditionalImpact() {
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setContent(GoogleCloudRecommenderV1beta1RecommendationContent content) {
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setLastRefreshTime(String lastRefreshTime) {
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setPrimaryImpact(GoogleCloudRecommenderV1beta1Impact primaryImpact) {
   ...
   */
  public GoogleCloudRecommenderV1beta1Recommendation setPriority(java.lang.String priority) {
  ...
  @Override
  public GoogleCloudRecommenderV1beta1Recommendation set(String fieldName, Object value) {
    return (GoogleCloudRecommenderV1beta1Recommendation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRecommenderV1beta1Recommendation clone() {
    return (GoogleCloudRecommenderV1beta1Recommendation) super.clone();
  }
