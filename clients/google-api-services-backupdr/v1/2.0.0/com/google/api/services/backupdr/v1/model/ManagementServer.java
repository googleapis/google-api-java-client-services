...
public final class ManagementServer extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. The OAuth 2.0 client id is required to make API calls to the Backup and DR
   * instance API of this ManagementServer. This is the value that should be provided in the 'aud'
   * field of the OIDC ID Token (see openid specification https://openid.net/specs/openid-connect-
