...
public class AdMob extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.10 of the AdMob API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Accounts {
    ...
    public class Apps {
       ...
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
       * @param name Required. Resource name of the app to retrieve. Example:
      ...
      public class Get extends AdMobRequest<com.google.api.services.admob.v1.model.App> {
       ...
       *        accounts/pub-9876543210987654/apps/0123456789
         ...
         */
        protected Get(java.lang.String name) {
          super(AdMob.this, "GET", REST_PATH, null, com.google.api.services.admob.v1.model.App.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
        ...
        /**
         * Required. Resource name of the app to retrieve. Example:
         * accounts/pub-9876543210987654/apps/0123456789
         */
        @com.google.api.client.util.Key
        private java.lang.String name;
