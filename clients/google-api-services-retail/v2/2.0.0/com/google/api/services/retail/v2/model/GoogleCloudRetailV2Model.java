...
public final class GoogleCloudRetailV2Model extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2ModelServingConfigList> servingConfigLists;
   ...
   */
  public GoogleCloudRetailV2Model setCreateTime(String createTime) {
   ...
   */
  public GoogleCloudRetailV2Model setDataState(java.lang.String dataState) {
   ...
   */
  public GoogleCloudRetailV2Model setDisplayName(java.lang.String displayName) {
   ...
   */
  public GoogleCloudRetailV2Model setFilteringOption(java.lang.String filteringOption) {
   ...
   */
  public GoogleCloudRetailV2Model setLastTuneTime(String lastTuneTime) {
   ...
   */
  public GoogleCloudRetailV2Model setModelFeaturesConfig(GoogleCloudRetailV2ModelModelFeaturesConfig modelFeaturesConfig) {
   ...
   */
  public GoogleCloudRetailV2Model setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2Model setOptimizationObjective(java.lang.String optimizationObjective) {
   ...
   */
  public GoogleCloudRetailV2Model setPeriodicTuningState(java.lang.String periodicTuningState) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2ModelServingConfigList> getServingConfigLists() {
   ...
   */
  public GoogleCloudRetailV2Model setServingConfigLists(java.util.List<GoogleCloudRetailV2ModelServingConfigList> servingConfigLists) {
   ...
   */
  public GoogleCloudRetailV2Model setServingState(java.lang.String servingState) {
   ...
   */
  public GoogleCloudRetailV2Model setTrainingState(java.lang.String trainingState) {
   ...
   */
  public GoogleCloudRetailV2Model setTuningOperation(java.lang.String tuningOperation) {
   ...
   */
  public GoogleCloudRetailV2Model setType(java.lang.String type) {
    this.type = type;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2Model setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public GoogleCloudRetailV2Model set(String fieldName, Object value) {
    return (GoogleCloudRetailV2Model) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2Model clone() {
    return (GoogleCloudRetailV2Model) super.clone();
  }
