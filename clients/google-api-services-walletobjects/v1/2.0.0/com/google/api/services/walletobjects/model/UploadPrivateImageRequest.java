...
public final class UploadPrivateImageRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public UploadPrivateImageRequest setBlob(Media blob) {
    this.blob = blob;
    return this;
  }
   ...
   */
  public UploadPrivateImageRequest setMediaRequestInfo(MediaRequestInfo mediaRequestInfo) {
    this.mediaRequestInfo = mediaRequestInfo;
    return this;
  }

  @Override
  public UploadPrivateImageRequest set(String fieldName, Object value) {
    return (UploadPrivateImageRequest) super.set(fieldName, value);
  }

  @Override
  public UploadPrivateImageRequest clone() {
    return (UploadPrivateImageRequest) super.clone();
  }
