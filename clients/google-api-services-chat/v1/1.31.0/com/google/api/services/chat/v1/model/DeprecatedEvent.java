...
public final class DeprecatedEvent extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A secret value that Chat apps can use to verify if a request is from Google. The token is
   * randomly generated by Google, remains static, and can be obtained from the Google Chat API
