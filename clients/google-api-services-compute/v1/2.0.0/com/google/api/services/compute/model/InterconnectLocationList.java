...
public final class InterconnectLocationList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InterconnectLocation> items;

  static {
    // hack to force ProGuard to consider InterconnectLocation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InterconnectLocation.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#interconnectLocationList for lists
   ...
   */
  public InterconnectLocationList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InterconnectLocation> getItems() {
    return items;
  }
   ...
   */
  public InterconnectLocationList setItems(java.util.List<InterconnectLocation> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InterconnectLocationList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InterconnectLocationList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InterconnectLocationList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InterconnectLocationList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectLocationList set(String fieldName, Object value) {
    return (InterconnectLocationList) super.set(fieldName, value);
  }

  @Override
  public InterconnectLocationList clone() {
    return (InterconnectLocationList) super.clone();
  }
