...
public class MigrationCenterAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      /**
       * An accessor for creating requests from the AssetsExportJobs collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code MigrationCenterAPI migrationcenter = new MigrationCenterAPI(...);}
       *   {@code MigrationCenterAPI.AssetsExportJobs.List request = migrationcenter.assetsExportJobs().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public AssetsExportJobs assetsExportJobs() {
        return new AssetsExportJobs();
      }

      /**
       * The "assetsExportJobs" collection of methods.
       */
      public class AssetsExportJobs {

        /**
         * Creates a new assets export job.
         *
         * Create a request for the method "assetsExportJobs.create".
         *
         * This request holds the parameters needed by the migrationcenter server.  After setting any
         * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The parent resource where the assts export job will be created.
         * @param content the {@link com.google.api.services.migrationcenter.v1.model.AssetsExportJob}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.migrationcenter.v1.model.AssetsExportJob content) throws java.io.IOException {
        ...
        public class Create extends MigrationCenterAPIRequest<com.google.api.services.migrationcenter.v1.model.Operation> {
          ...
          private static final String REST_PATH = "v1/{+parent}/assetsExportJobs";
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.migrationcenter.v1.model.AssetsExportJob content) {
          ...
          @com.google.api.client.util.Key
          private java.lang.String assetsExportJobId;

          /** Required. The ID to use for the asset export job.
           */
          public java.lang.String getAssetsExportJobId() {
            return assetsExportJobId;
          }

          /** Required. The ID to use for the asset export job. */
          public Create setAssetsExportJobId(java.lang.String assetsExportJobId) {
         ...
         *
         * Create a request for the method "assetsExportJobs.delete".
         *
         * This request holds the parameters needed by the migrationcenter server.  After setting any
         * optional parameters, call the {@link Delete#execute()} method to invoke the remote operation.
         *
        ...
        public class Delete extends MigrationCenterAPIRequest<com.google.api.services.migrationcenter.v1.model.Operation> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/assetsExportJobs/[^/]+$");
         ...
         *
         * Create a request for the method "assetsExportJobs.get".
         *
         * This request holds the parameters needed by the migrationcenter server.  After setting any
         * optional parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
        ...
        public class Get extends MigrationCenterAPIRequest<com.google.api.services.migrationcenter.v1.model.AssetsExportJob> {
           ...
           */
          protected Get(java.lang.String name) {
            super(MigrationCenterAPI.this, "GET", REST_PATH, null, com.google.api.services.migrationcenter.v1.model.AssetsExportJob.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * Create a request for the method "assetsExportJobs.list".
         *
         * This request holds the parameters needed by the migrationcenter server.  After setting any
         * optional parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
        ...
        public class List extends MigrationCenterAPIRequest<com.google.api.services.migrationcenter.v1.model.ListAssetsExportJobsResponse> {
           ...
           */
          protected List(java.lang.String parent) {
            super(MigrationCenterAPI.this, "GET", REST_PATH, null, com.google.api.services.migrationcenter.v1.model.ListAssetsExportJobsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *
         * Create a request for the method "assetsExportJobs.run".
         *
         * This request holds the parameters needed by the migrationcenter server.  After setting any
         * optional parameters, call the {@link Run#execute()} method to invoke the remote operation.
         *
         * @param name Required. Name of the resource.
         * @param content the {@link com.google.api.services.migrationcenter.v1.model.RunAssetsExportJobRequest}
         * @return the request
         */
        public Run run(java.lang.String name, com.google.api.services.migrationcenter.v1.model.RunAssetsExportJobRequest content) throws java.io.IOException {
        ...
        public class Run extends MigrationCenterAPIRequest<com.google.api.services.migrationcenter.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Run(java.lang.String name, com.google.api.services.migrationcenter.v1.model.RunAssetsExportJobRequest content) {
            super(MigrationCenterAPI.this, "POST", REST_PATH, content, com.google.api.services.migrationcenter.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
