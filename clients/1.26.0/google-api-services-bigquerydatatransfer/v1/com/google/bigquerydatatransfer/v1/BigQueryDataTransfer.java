...
package com.google.bigquerydatatransfer.v1;
...
public class BigQueryDataTransfer extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the BigQuery Data Transfer API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class DataSources {
       ...
       * @param content the {@link com.google.bigquerydatatransfer.v1.model.CheckValidCredsRequest}
       * @return the request
       */
      public CheckValidCreds checkValidCreds(java.lang.String name, com.google.bigquerydatatransfer.v1.model.CheckValidCredsRequest content) throws java.io.IOException {
        CheckValidCreds result = new CheckValidCreds(name, content);
        initialize(result);
        return result;
      }

      public class CheckValidCreds extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.CheckValidCredsResponse> {
      ...
      `projects/{project_id}/dataSources/{data_source_id}`
         ...
         * @since 1.13
         */
        protected CheckValidCreds(java.lang.String name, com.google.bigquerydatatransfer.v1.model.CheckValidCredsRequest content) {
          super(BigQueryDataTransfer.this, "POST", REST_PATH, content, com.google.bigquerydatatransfer.v1.model.CheckValidCredsResponse.class);
      ...
      public class Get extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.DataSource> {
       ...
       *        `projects/{project_id}/dataSources/{data_source_id}`
        ...
        protected Get(java.lang.String name) {
          super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.DataSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ListDataSourcesResponse> {
       ...
       *        `projects/{project_id}`
        ...
        protected List(java.lang.String parent) {
          super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.ListDataSourcesResponse.class);
    ...
    public class Locations {
      ...
      public class Get extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.Location> {
         ...
         */
        protected Get(java.lang.String name) {
          super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.Location.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class TransferConfigs {
         ...
         *
         * @param parent The BigQuery project id where the transfer configuration should be created.
        Must be in the format
         *        projects/{project_id}/locations/{location_id}
        If specified location and location of the
         *        destination bigquery dataset
        do not match - the request will fail.
         * @param content the {@link com.google.bigquerydatatransfer.v1.model.TransferConfig}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.bigquerydatatransfer.v1.model.TransferConfig content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.TransferConfig> {
        ...
        do not match - the request will fail.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.bigquerydatatransfer.v1.model.TransferConfig content) {
            super(BigQueryDataTransfer.this, "POST", REST_PATH, content, com.google.bigquerydatatransfer.v1.model.TransferConfig.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * The BigQuery project id where the transfer configuration should be created. Must be in
           * the format projects/{project_id}/locations/{location_id} If specified location and
         ...
         projects/{project_id}/locations/{location_id} If specified location and location of the destination
         bigquery dataset do not match - the request will fail.
           */
          public java.lang.String getParent() {
            return parent;
          }
        ...
        public class Delete extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.Empty> {
         ...
         *        `projects/{project_id}/transferConfigs/{config_id}`
          ...
          protected Delete(java.lang.String name) {
            super(BigQueryDataTransfer.this, "DELETE", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.TransferConfig> {
         ...
         *        `projects/{project_id}/transferConfigs/{config_id}`
           ...
           */
          protected Get(java.lang.String name) {
            super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.TransferConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ListTransferConfigsResponse> {
        ...
        should be returned: `projects/{project_id}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.ListTransferConfigsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.bigquerydatatransfer.v1.model.TransferConfig content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.TransferConfig> {
        ...
        required, will be generated for config_id.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.bigquerydatatransfer.v1.model.TransferConfig content) {
            super(BigQueryDataTransfer.this, "PATCH", REST_PATH, content, com.google.bigquerydatatransfer.v1.model.TransferConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
          ...
          /** The resource name of the transfer config. Transfer config names have the form of
         `projects/{project_id}/location/{region}/transferConfigs/{config_id}`. The name is automatically
        ...
        `projects/{project_id}/transferConfigs/{config_id}`.
         * @param content the {@link com.google.bigquerydatatransfer.v1.model.ScheduleTransferRunsRequest}
         * @return the request
         */
        public ScheduleRuns scheduleRuns(java.lang.String parent, com.google.bigquerydatatransfer.v1.model.ScheduleTransferRunsRequest content) throws java.io.IOException {
          ScheduleRuns result = new ScheduleRuns(parent, content);
          initialize(result);
          return result;
        }

        public class ScheduleRuns extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ScheduleTransferRunsResponse> {
        ...
        `projects/{project_id}/transferConfigs/{config_id}`.
           ...
           * @since 1.13
           */
          protected ScheduleRuns(java.lang.String parent, com.google.bigquerydatatransfer.v1.model.ScheduleTransferRunsRequest content) {
            super(BigQueryDataTransfer.this, "POST", REST_PATH, content, com.google.bigquerydatatransfer.v1.model.ScheduleTransferRunsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Runs {
          ...
          public class Get extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.TransferRun> {
           ...
           *        `projects/{project_id}/transferConfigs/{config_id}/runs/{run_id}`
             ...
             */
            protected Get(java.lang.String name) {
              super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.TransferRun.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ListTransferRunsResponse> {
          ...
          `projects/{project_id}/transferConfigs/{config_id}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.ListTransferRunsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
            ...
            /**
             * Name of transfer configuration for which transfer runs should be retrieved. Format of
            ...
            /** Name of transfer configuration for which transfer runs should be retrieved. Format of transfer
           configuration resource name is: `projects/{project_id}/transferConfigs/{config_id}`.
             */
            public java.lang.String getParent() {
              return parent;
            }
          ...
          public class TransferLogs {
            ...
            public class List extends BigQueryDataTransferRequest<com.google.bigquerydatatransfer.v1.model.ListTransferLogsResponse> {
            ...
            `projects/{project_id}/transferConfigs/{config_Id}/runs/{run_id}`.
               ...
               */
              protected List(java.lang.String parent) {
                super(BigQueryDataTransfer.this, "GET", REST_PATH, null, com.google.bigquerydatatransfer.v1.model.ListTransferLogsResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
