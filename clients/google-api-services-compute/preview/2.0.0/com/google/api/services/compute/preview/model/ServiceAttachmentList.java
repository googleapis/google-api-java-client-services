...
public final class ServiceAttachmentList extends com.google.api.client.json.GenericJson {
   ...
   */
  public ServiceAttachmentList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ServiceAttachment> getItems() {
    return items;
  }
   ...
   */
  public ServiceAttachmentList setItems(java.util.List<ServiceAttachment> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ServiceAttachmentList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ServiceAttachmentList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ServiceAttachmentList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ServiceAttachmentList set(String fieldName, Object value) {
    return (ServiceAttachmentList) super.set(fieldName, value);
  }

  @Override
  public ServiceAttachmentList clone() {
    return (ServiceAttachmentList) super.clone();
  }
