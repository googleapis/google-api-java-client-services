...
public final class ListCommentsResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ListCommentsResponse set(String fieldName, Object value) {
    return (ListCommentsResponse) super.set(fieldName, value);
  }

  @Override
  public ListCommentsResponse clone() {
    return (ListCommentsResponse) super.clone();
  }
