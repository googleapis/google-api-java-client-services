...
public final class ListWorkstationsResponse extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Workstation> getWorkstations() {
    return workstations;
  }

  /**
   * The requested workstations.
   * @param workstations workstations or {@code null} for none
   */
  public ListWorkstationsResponse setWorkstations(java.util.List<Workstation> workstations) {
    this.workstations = workstations;
    return this;
  }

  @Override
  public ListWorkstationsResponse set(String fieldName, Object value) {
    return (ListWorkstationsResponse) super.set(fieldName, value);
  }

  @Override
  public ListWorkstationsResponse clone() {
    return (ListWorkstationsResponse) super.clone();
  }
