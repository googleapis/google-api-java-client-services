...
public final class GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails setRequireLicensed(java.lang.Boolean requireLicensed) {
    this.requireLicensed = requireLicensed;
    return this;
  }

  @Override
  public GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails clone() {
    return (GoogleFirebaseAppcheckV1betaPlayIntegrityConfigAccountDetails) super.clone();
  }
