...
public final class RemovePpidDataStatus extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public RemovePpidDataStatus set(String fieldName, Object value) {
    return (RemovePpidDataStatus) super.set(fieldName, value);
  }

  @Override
  public RemovePpidDataStatus clone() {
    return (RemovePpidDataStatus) super.clone();
  }
