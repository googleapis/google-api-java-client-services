...
public final class NetworkAddressList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NetworkAddress> addresses;
  ...
  @Override
  public NetworkAddressList set(String fieldName, Object value) {
    return (NetworkAddressList) super.set(fieldName, value);
  }

  @Override
  public NetworkAddressList clone() {
    return (NetworkAddressList) super.clone();
  }
