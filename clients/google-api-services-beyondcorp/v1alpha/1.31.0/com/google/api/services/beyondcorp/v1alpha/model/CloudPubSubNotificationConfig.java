...
public final class CloudPubSubNotificationConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public CloudPubSubNotificationConfig setPubsubSubscription(java.lang.String pubsubSubscription) {
    this.pubsubSubscription = pubsubSubscription;
    return this;
  }

  @Override
  public CloudPubSubNotificationConfig set(String fieldName, Object value) {
    return (CloudPubSubNotificationConfig) super.set(fieldName, value);
  }

  @Override
  public CloudPubSubNotificationConfig clone() {
    return (CloudPubSubNotificationConfig) super.clone();
  }
