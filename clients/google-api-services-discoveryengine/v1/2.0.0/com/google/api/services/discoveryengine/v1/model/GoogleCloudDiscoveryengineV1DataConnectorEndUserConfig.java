...
public final class GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1Tenant tenant;
   ...
   */
  public GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig setAdditionalParams(java.util.Map<String, java.lang.Object> additionalParams) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1Tenant getTenant() {
    return tenant;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig setTenant(GoogleCloudDiscoveryengineV1Tenant tenant) {
    this.tenant = tenant;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig clone() {
    return (GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig) super.clone();
  }
