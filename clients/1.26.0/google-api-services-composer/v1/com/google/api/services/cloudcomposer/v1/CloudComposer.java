  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Environments {
         ...
         * @param content the {@link com.google.api.services.cloudcomposer.v1.model.Environment}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.cloudcomposer.v1.model.Environment content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.cloudcomposer.v1.model.Environment content) {
            super(CloudComposer.this, "POST", REST_PATH, content, com.google.api.services.cloudcomposer.v1.model.Operation.class);
        ...
        public class Delete extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Operation> {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
          ...
          protected Delete(java.lang.String name) {
            super(CloudComposer.this, "DELETE", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.Operation.class);
        ...
        public class Get extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Environment> {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
          ...
          protected Get(java.lang.String name) {
            super(CloudComposer.this, "GET", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.Environment.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.ListEnvironmentsResponse> {
         ...
         *        "projects/{projectId}/locations/{locationId}"
          ...
          protected List(java.lang.String parent) {
            super(CloudComposer.this, "GET", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.ListEnvironmentsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.cloudcomposer.v1.model.Environment content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Operation> {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.cloudcomposer.v1.model.Environment content) {
            super(CloudComposer.this, "PATCH", REST_PATH, content, com.google.api.services.cloudcomposer.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Delete extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(CloudComposer.this, "DELETE", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudComposer.this, "GET", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudComposerRequest<com.google.api.services.cloudcomposer.v1.model.ListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(CloudComposer.this, "GET", REST_PATH, null, com.google.api.services.cloudcomposer.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
