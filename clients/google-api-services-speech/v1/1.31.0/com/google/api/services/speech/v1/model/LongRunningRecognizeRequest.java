...
public final class LongRunningRecognizeRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public LongRunningRecognizeRequest setAudio(RecognitionAudio audio) {
    this.audio = audio;
    return this;
  }
  ...
  @Override
  public LongRunningRecognizeRequest set(String fieldName, Object value) {
    return (LongRunningRecognizeRequest) super.set(fieldName, value);
  }
