      ...
      public class Environments {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
         ...
         "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
           ...
           * Only the following fields can be updated: * config.softwareConfig.pypiPackages *
           ...
           * Airflow config property name in the section named section, preserving other properties.
         ...
         labels. * labels.labelName * Set the label named labelName, while preserving other labels. To
         delete the label, include it in `updateMask` and omit its mapping in `environment.labels`. It is an
         ...
         environment's current WebServerNetworkAccessControl. * config.softwareConfig.airflowConfigOverrides
