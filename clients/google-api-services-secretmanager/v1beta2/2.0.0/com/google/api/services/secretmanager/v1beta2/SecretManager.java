...
package com.google.api.services.secretmanager.v1beta2;

/**
 * Service definition for SecretManager (v1beta2).
 *
 * <p>
...
public class SecretManager extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Location.class);
      ...
      public class List extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Cancel extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(SecretManager.this, "POST", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(SecretManager.this, "DELETE", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Secrets {
         ...
         * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.AddSecretVersionRequest}
         * @return the request
         */
        public AddVersion addVersion(java.lang.String parent, com.google.api.services.secretmanager.v1beta2.model.AddSecretVersionRequest content) throws java.io.IOException {
          AddVersion result = new AddVersion(parent, content);
          initialize(result);
          return result;
        }

        public class AddVersion extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.SecretVersion> {

          private static final String REST_PATH = "v1beta2/{+parent}:addVersion";
         ...
         *        `projects/secrets` or `projects/locations/secrets`.
           ...
           * @since 1.13
           */
          protected AddVersion(java.lang.String parent, com.google.api.services.secretmanager.v1beta2.model.AddSecretVersionRequest content) {
            super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.SecretVersion.class);
         ...
         *        `projects/locations`.
         * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.Secret}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.secretmanager.v1beta2.model.Secret content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Secret> {

          private static final String REST_PATH = "v1beta2/{+parent}/secrets";
         ...
         *        `projects/locations`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.secretmanager.v1beta2.model.Secret content) {
            super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.Secret.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Get extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Secret> {
         ...
         *        `projects/locations/secrets`.
           ...
           */
          protected Get(java.lang.String name) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Secret.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class GetIamPolicy extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.Policy.class);
        ...
        public class List extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.ListSecretsResponse> {
         ...
         *        `projects/locations`
          ...
          protected List(java.lang.String parent) {
            super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.ListSecretsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.Secret content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Secret> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.Secret content) {
            super(SecretManager.this, "PATCH", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.Secret.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.secretmanager.v1beta2.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.secretmanager.v1beta2.model.SetIamPolicyRequest content) {
            super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.secretmanager.v1beta2.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.secretmanager.v1beta2.model.TestIamPermissionsRequest content) {
            super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        public class Versions {
          ...
          public class Access extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.AccessSecretVersionResponse> {

            private static final String REST_PATH = "v1beta2/{+name}:access";
           ...
           *        SecretVersion.
            ...
            protected Access(java.lang.String name) {
              super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.AccessSecretVersionResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           *        `projects/secrets/versions` or `projects/locations/secrets/versions`.
           * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.DestroySecretVersionRequest}
           * @return the request
           */
          public Destroy destroy(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.DestroySecretVersionRequest content) throws java.io.IOException {
            Destroy result = new Destroy(name, content);
            initialize(result);
            return result;
          }

          public class Destroy extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.SecretVersion> {

            private static final String REST_PATH = "v1beta2/{+name}:destroy";
           ...
           *        `projects/secrets/versions` or `projects/locations/secrets/versions`.
             ...
             * @since 1.13
             */
            protected Destroy(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.DestroySecretVersionRequest content) {
              super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.SecretVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           *        `projects/secrets/versions` or `projects/locations/secrets/versions`.
           * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.DisableSecretVersionRequest}
           * @return the request
           */
          public Disable disable(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.DisableSecretVersionRequest content) throws java.io.IOException {
            Disable result = new Disable(name, content);
            initialize(result);
            return result;
          }

          public class Disable extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.SecretVersion> {

            private static final String REST_PATH = "v1beta2/{+name}:disable";
           ...
           *        `projects/secrets/versions` or `projects/locations/secrets/versions`.
             ...
             * @since 1.13
             */
            protected Disable(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.DisableSecretVersionRequest content) {
              super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.SecretVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           * @param content the {@link com.google.api.services.secretmanager.v1beta2.model.EnableSecretVersionRequest}
           * @return the request
           */
          public Enable enable(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.EnableSecretVersionRequest content) throws java.io.IOException {
            Enable result = new Enable(name, content);
            initialize(result);
            return result;
          }

          public class Enable extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.SecretVersion> {

            private static final String REST_PATH = "v1beta2/{+name}:enable";
           ...
           *        or `projects/locations/secrets/versions`.
             ...
             * @since 1.13
             */
            protected Enable(java.lang.String name, com.google.api.services.secretmanager.v1beta2.model.EnableSecretVersionRequest content) {
              super(SecretManager.this, "POST", REST_PATH, content, com.google.api.services.secretmanager.v1beta2.model.SecretVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
          ...
          public class Get extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.SecretVersion> {
           ...
           *        SecretVersion.
             ...
             */
            protected Get(java.lang.String name) {
              super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.SecretVersion.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends SecretManagerRequest<com.google.api.services.secretmanager.v1beta2.model.ListSecretVersionsResponse> {
           ...
           *        `projects/secrets` or `projects/locations/secrets`.
             ...
             */
            protected List(java.lang.String parent) {
              super(SecretManager.this, "GET", REST_PATH, null, com.google.api.services.secretmanager.v1beta2.model.ListSecretVersionsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
