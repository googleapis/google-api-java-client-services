...
/**
 * Request message for SendVerificationCode. At least one of (`ios_receipt` and `ios_secret`),
...
public final class GoogleCloudIdentitytoolkitV1SendVerificationCodeRequest extends com.google.api.client.json.GenericJson {
   ...
   * from the response of verifyIosClient. If present, the caller should also provide the
   * `ios_secret`, as well as a bundle ID in the `x-ios-bundle-identifier` header, which must match
   * the bundle ID from the verifyIosClient request.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * behalf of a real app and not an emulator. A Play Integrity Token can be generated via the
   * [PlayIntegrity API](https://developer.android.com/google/play/integrity) with applying SHA256
   ...
   * `recaptcha_token`, or `safety_net_token` must be specified to verify the verification code is
   * being sent on behalf of a real app and not an emulator. The recaptcha should be generated by
   * calling getRecaptchaParams and the recaptcha token will be generated on user completion of the
   * recaptcha challenge.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * SafetyNet Token can be generated via the [SafetyNet Android Attestation
