...
public class Container extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Kubernetes Engine API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Aggregated {
      ...
      public class UsableSubnetworks {
        ...
        public class List extends ContainerRequest<com.google.container.v1beta1.model.ListUsableSubnetworksResponse> {
        ...
        Specified in the format 'projects'.
          ...
          protected List(java.lang.String parent) {
            super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ListUsableSubnetworksResponse.class);
    ...
    public class Locations {
      ...
      public class GetServerConfig extends ContainerRequest<com.google.container.v1beta1.model.ServerConfig> {
       ...
       *        'projects/locations'.
        ...
        protected GetServerConfig(java.lang.String name) {
          super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ServerConfig.class);
      ...
      public class List extends ContainerRequest<com.google.container.v1beta1.model.ListLocationsResponse> {
      ...
      Specified in the format 'projects'.
         ...
         */
        protected List(java.lang.String parent) {
          super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ListLocationsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Clusters {
         ...
         * @param content the {@link com.google.container.v1beta1.model.CompleteIPRotationRequest}
         * @return the request
         */
        public CompleteIpRotation completeIpRotation(java.lang.String name, com.google.container.v1beta1.model.CompleteIPRotationRequest content) throws java.io.IOException {
          CompleteIpRotation result = new CompleteIpRotation(name, content);
          initialize(result);
          return result;
        }

        public class CompleteIpRotation extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        format 'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected CompleteIpRotation(java.lang.String name, com.google.container.v1beta1.model.CompleteIPRotationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        Specified in the format
         *        'projects/locations'.
         * @param content the {@link com.google.container.v1beta1.model.CreateClusterRequest}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.container.v1beta1.model.CreateClusterRequest content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations'.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.container.v1beta1.model.CreateClusterRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Delete extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
          ...
          protected Delete(java.lang.String name) {
            super(Container.this, "DELETE", REST_PATH, null, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends ContainerRequest<com.google.container.v1beta1.model.Cluster> {
         ...
         *        'projects/locations/clusters'.
          ...
          protected Get(java.lang.String name) {
            super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.Cluster.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends ContainerRequest<com.google.container.v1beta1.model.ListClustersResponse> {
        ...
        Location "-" matches all zones and all regions.
           ...
           */
          protected List(java.lang.String parent) {
            super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ListClustersResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetAddonsConfigRequest}
         * @return the request
         */
        public SetAddons setAddons(java.lang.String name, com.google.container.v1beta1.model.SetAddonsConfigRequest content) throws java.io.IOException {
          SetAddons result = new SetAddons(name, content);
          initialize(result);
          return result;
        }

        public class SetAddons extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetAddons(java.lang.String name, com.google.container.v1beta1.model.SetAddonsConfigRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetLegacyAbacRequest}
         * @return the request
         */
        public SetLegacyAbac setLegacyAbac(java.lang.String name, com.google.container.v1beta1.model.SetLegacyAbacRequest content) throws java.io.IOException {
          SetLegacyAbac result = new SetLegacyAbac(name, content);
          initialize(result);
          return result;
        }

        public class SetLegacyAbac extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetLegacyAbac(java.lang.String name, com.google.container.v1beta1.model.SetLegacyAbacRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetLocationsRequest}
         * @return the request
         */
        public SetLocations setLocations(java.lang.String name, com.google.container.v1beta1.model.SetLocationsRequest content) throws java.io.IOException {
          SetLocations result = new SetLocations(name, content);
          initialize(result);
          return result;
        }

        public class SetLocations extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetLocations(java.lang.String name, com.google.container.v1beta1.model.SetLocationsRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetLoggingServiceRequest}
         * @return the request
         */
        public SetLogging setLogging(java.lang.String name, com.google.container.v1beta1.model.SetLoggingServiceRequest content) throws java.io.IOException {
          SetLogging result = new SetLogging(name, content);
          initialize(result);
          return result;
        }

        public class SetLogging extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetLogging(java.lang.String name, com.google.container.v1beta1.model.SetLoggingServiceRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the
         *        format 'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetMaintenancePolicyRequest}
         * @return the request
         */
        public SetMaintenancePolicy setMaintenancePolicy(java.lang.String name, com.google.container.v1beta1.model.SetMaintenancePolicyRequest content) throws java.io.IOException {
          SetMaintenancePolicy result = new SetMaintenancePolicy(name, content);
          initialize(result);
          return result;
        }

        public class SetMaintenancePolicy extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        format 'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetMaintenancePolicy(java.lang.String name, com.google.container.v1beta1.model.SetMaintenancePolicyRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetMasterAuthRequest}
         * @return the request
         */
        public SetMasterAuth setMasterAuth(java.lang.String name, com.google.container.v1beta1.model.SetMasterAuthRequest content) throws java.io.IOException {
          SetMasterAuth result = new SetMasterAuth(name, content);
          initialize(result);
          return result;
        }

        public class SetMasterAuth extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetMasterAuth(java.lang.String name, com.google.container.v1beta1.model.SetMasterAuthRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetMonitoringServiceRequest}
         * @return the request
         */
        public SetMonitoring setMonitoring(java.lang.String name, com.google.container.v1beta1.model.SetMonitoringServiceRequest content) throws java.io.IOException {
          SetMonitoring result = new SetMonitoring(name, content);
          initialize(result);
          return result;
        }

        public class SetMonitoring extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetMonitoring(java.lang.String name, com.google.container.v1beta1.model.SetMonitoringServiceRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *        format 'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetNetworkPolicyRequest}
         * @return the request
         */
        public SetNetworkPolicy setNetworkPolicy(java.lang.String name, com.google.container.v1beta1.model.SetNetworkPolicyRequest content) throws java.io.IOException {
          SetNetworkPolicy result = new SetNetworkPolicy(name, content);
          initialize(result);
          return result;
        }

        public class SetNetworkPolicy extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        format 'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetNetworkPolicy(java.lang.String name, com.google.container.v1beta1.model.SetNetworkPolicyRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.SetLabelsRequest}
         * @return the request
         */
        public SetResourceLabels setResourceLabels(java.lang.String name, com.google.container.v1beta1.model.SetLabelsRequest content) throws java.io.IOException {
          SetResourceLabels result = new SetResourceLabels(name, content);
          initialize(result);
          return result;
        }

        public class SetResourceLabels extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected SetResourceLabels(java.lang.String name, com.google.container.v1beta1.model.SetLabelsRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        rotation. Specified in the
         *        format 'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.StartIPRotationRequest}
         * @return the request
         */
        public StartIpRotation startIpRotation(java.lang.String name, com.google.container.v1beta1.model.StartIPRotationRequest content) throws java.io.IOException {
          StartIpRotation result = new StartIpRotation(name, content);
          initialize(result);
          return result;
        }

        public class StartIpRotation extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        format 'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected StartIpRotation(java.lang.String name, com.google.container.v1beta1.model.StartIPRotationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.UpdateClusterRequest}
         * @return the request
         */
        public Update update(java.lang.String name, com.google.container.v1beta1.model.UpdateClusterRequest content) throws java.io.IOException {
          Update result = new Update(name, content);
          initialize(result);
          return result;
        }

        public class Update extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected Update(java.lang.String name, com.google.container.v1beta1.model.UpdateClusterRequest content) {
            super(Container.this, "PUT", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        Specified in the format
         *        'projects/locations/clusters'.
         * @param content the {@link com.google.container.v1beta1.model.UpdateMasterRequest}
         * @return the request
         */
        public UpdateMaster updateMaster(java.lang.String name, com.google.container.v1beta1.model.UpdateMasterRequest content) throws java.io.IOException {
          UpdateMaster result = new UpdateMaster(name, content);
          initialize(result);
          return result;
        }

        public class UpdateMaster extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/clusters'.
           ...
           * @since 1.13
           */
          protected UpdateMaster(java.lang.String name, com.google.container.v1beta1.model.UpdateMasterRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class NodePools {
           ...
           *        format
          'projects/locations/clusters'.
           * @param content the {@link com.google.container.v1beta1.model.CreateNodePoolRequest}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.container.v1beta1.model.CreateNodePoolRequest content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
          ...
          'projects/locations/clusters'.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.container.v1beta1.model.CreateNodePoolRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends ContainerRequest<com.google.container.v1beta1.model.NodePool> {
           ...
           *        'projects/locations/clusters/nodePools'.
             ...
             */
            protected Get(java.lang.String name) {
              super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.NodePool.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends ContainerRequest<com.google.container.v1beta1.model.ListNodePoolsResponse> {
           ...
           *        format 'projects/locations/clusters'.
             ...
             */
            protected List(java.lang.String parent) {
              super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ListNodePoolsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @param content the {@link com.google.container.v1beta1.model.RollbackNodePoolUpgradeRequest}
           * @return the request
           */
          public Rollback rollback(java.lang.String name, com.google.container.v1beta1.model.RollbackNodePoolUpgradeRequest content) throws java.io.IOException {
            Rollback result = new Rollback(name, content);
            initialize(result);
            return result;
          }

          public class Rollback extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
           ...
           *        in the format 'projects/locations/clusters/nodePools'.
             ...
             * @since 1.13
             */
            protected Rollback(java.lang.String name, com.google.container.v1beta1.model.RollbackNodePoolUpgradeRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           *        Specified in the format
          'projects/locations/clusters/nodePools'.
           * @param content the {@link com.google.container.v1beta1.model.SetNodePoolAutoscalingRequest}
           * @return the request
           */
          public SetAutoscaling setAutoscaling(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolAutoscalingRequest content) throws java.io.IOException {
            SetAutoscaling result = new SetAutoscaling(name, content);
            initialize(result);
            return result;
          }

          public class SetAutoscaling extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
          ...
          'projects/locations/clusters/nodePools'.
             ...
             * @since 1.13
             */
            protected SetAutoscaling(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolAutoscalingRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           *        Specified in the format
          'projects/locations/clusters/nodePools'.
           * @param content the {@link com.google.container.v1beta1.model.SetNodePoolManagementRequest}
           * @return the request
           */
          public SetManagement setManagement(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolManagementRequest content) throws java.io.IOException {
            SetManagement result = new SetManagement(name, content);
            initialize(result);
            return result;
          }

          public class SetManagement extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
          ...
          'projects/locations/clusters/nodePools'.
             ...
             * @since 1.13
             */
            protected SetManagement(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolManagementRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
          ...
          Specified in the
           *        format 'projects/locations/clusters/nodePools'.
           * @param content the {@link com.google.container.v1beta1.model.SetNodePoolSizeRequest}
           * @return the request
           */
          public SetSize setSize(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolSizeRequest content) throws java.io.IOException {
            SetSize result = new SetSize(name, content);
            initialize(result);
            return result;
          }

          public class SetSize extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
           ...
           *        format 'projects/locations/clusters/nodePools'.
             ...
             * @since 1.13
             */
            protected SetSize(java.lang.String name, com.google.container.v1beta1.model.SetNodePoolSizeRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
           ...
           *        'projects/locations/clusters/nodePools'.
           * @param content the {@link com.google.container.v1beta1.model.UpdateNodePoolRequest}
           * @return the request
           */
          public Update update(java.lang.String name, com.google.container.v1beta1.model.UpdateNodePoolRequest content) throws java.io.IOException {
            Update result = new Update(name, content);
            initialize(result);
            return result;
          }
           ...
           *        'projects/locations/clusters/nodePools'.
             ...
             * @since 1.13
             */
            protected Update(java.lang.String name, com.google.container.v1beta1.model.UpdateNodePoolRequest content) {
              super(Container.this, "PUT", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.container.v1beta1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.container.v1beta1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends ContainerRequest<com.google.container.v1beta1.model.Empty> {
         ...
         *        'projects/locations/operations'.
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.container.v1beta1.model.CancelOperationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        'projects/locations/operations'.
           ...
           */
          protected Get(java.lang.String name) {
            super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends ContainerRequest<com.google.container.v1beta1.model.ListOperationsResponse> {
        ...
        Location "-" matches all zones and all regions.
           ...
           */
          protected List(java.lang.String parent) {
            super(Container.this, "GET", REST_PATH, null, com.google.container.v1beta1.model.ListOperationsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
    ...
    public class Zones {
      ...
      public class Clusters {
         ...
         * @return the request
         */
        public Addons addons(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetAddonsConfigRequest content) throws java.io.IOException {
          Addons result = new Addons(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class Addons extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Addons(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetAddonsConfigRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
         ...
         * @return the request
         */
        public CompleteIpRotation completeIpRotation(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.CompleteIPRotationRequest content) throws java.io.IOException {
        ...
        This field has been deprecated and replaced by the name field.
           ...
           * @since 1.13
           */
          protected CompleteIpRotation(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.CompleteIPRotationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Create create(java.lang.String projectId, java.lang.String zone, com.google.container.v1beta1.model.CreateClusterRequest content) throws java.io.IOException {
        ...
        This field has been deprecated and replaced by the parent field.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String projectId, java.lang.String zone, com.google.container.v1beta1.model.CreateClusterRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
          }
         ...
         * @return the request
         */
        public LegacyAbac legacyAbac(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLegacyAbacRequest content) throws java.io.IOException {
          LegacyAbac result = new LegacyAbac(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class LegacyAbac extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected LegacyAbac(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLegacyAbacRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Locations locations(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLocationsRequest content) throws java.io.IOException {
          Locations result = new Locations(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class Locations extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Locations(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLocationsRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Logging logging(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLoggingServiceRequest content) throws java.io.IOException {
          Logging result = new Logging(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class Logging extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Logging(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLoggingServiceRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Master master(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.UpdateMasterRequest content) throws java.io.IOException {
          Master result = new Master(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class Master extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Master(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.UpdateMasterRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Monitoring monitoring(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMonitoringServiceRequest content) throws java.io.IOException {
          Monitoring result = new Monitoring(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class Monitoring extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Monitoring(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMonitoringServiceRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public ResourceLabels resourceLabels(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLabelsRequest content) throws java.io.IOException {
          ResourceLabels result = new ResourceLabels(projectId, zone, clusterId, content);
          initialize(result);
          return result;
        }

        public class ResourceLabels extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
        ...
        This field has been deprecated and replaced by the name field.
           ...
           * @since 1.13
           */
          protected ResourceLabels(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetLabelsRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public SetMaintenancePolicy setMaintenancePolicy(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMaintenancePolicyRequest content) throws java.io.IOException {
         ...
         *        resides.
           ...
           * @since 1.13
           */
          protected SetMaintenancePolicy(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMaintenancePolicyRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public SetMasterAuth setMasterAuth(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMasterAuthRequest content) throws java.io.IOException {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected SetMasterAuth(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetMasterAuthRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public SetNetworkPolicy setNetworkPolicy(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetNetworkPolicyRequest content) throws java.io.IOException {
        ...
        This field has been deprecated and replaced by the name field.
           ...
           * @since 1.13
           */
          protected SetNetworkPolicy(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.SetNetworkPolicyRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public StartIpRotation startIpRotation(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.StartIPRotationRequest content) throws java.io.IOException {
        ...
        This field has been deprecated and replaced by the name field.
           ...
           * @since 1.13
           */
          protected StartIpRotation(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.StartIPRotationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
         ...
         * @return the request
         */
        public Update update(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.UpdateClusterRequest content) throws java.io.IOException {
         ...
         *        name field.
           ...
           * @since 1.13
           */
          protected Update(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.UpdateClusterRequest content) {
            super(Container.this, "PUT", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
            this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
        ...
        public class NodePools {
           ...
           * @return the request
           */
          public Autoscaling autoscaling(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolAutoscalingRequest content) throws java.io.IOException {
            Autoscaling result = new Autoscaling(projectId, zone, clusterId, nodePoolId, content);
            initialize(result);
            return result;
          }

          public class Autoscaling extends ContainerRequest<com.google.container.v1beta1.model.Operation> {
           ...
           *        name field.
             ...
             * @since 1.13
             */
            protected Autoscaling(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolAutoscalingRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
           ...
           * @return the request
           */
          public Create create(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.CreateNodePoolRequest content) throws java.io.IOException {
           ...
           *        field.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, com.google.container.v1beta1.model.CreateNodePoolRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
           ...
           * @return the request
           */
          public Rollback rollback(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.RollbackNodePoolUpgradeRequest content) throws java.io.IOException {
           ...
           *        the name field.
             ...
             * @since 1.13
             */
            protected Rollback(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.RollbackNodePoolUpgradeRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
           ...
           * @return the request
           */
          public SetManagement setManagement(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolManagementRequest content) throws java.io.IOException {
           ...
           *        name field.
             ...
             * @since 1.13
             */
            protected SetManagement(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolManagementRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
           ...
           * @return the request
           */
          public SetSize setSize(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolSizeRequest content) throws java.io.IOException {
           ...
           *        name field.
             ...
             * @since 1.13
             */
            protected SetSize(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.SetNodePoolSizeRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
           ...
           * @return the request
           */
          public Update update(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.UpdateNodePoolRequest content) throws java.io.IOException {
           ...
           *        name field.
             ...
             * @since 1.13
             */
            protected Update(java.lang.String projectId, java.lang.String zone, java.lang.String clusterId, java.lang.String nodePoolId, com.google.container.v1beta1.model.UpdateNodePoolRequest content) {
              super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Operation.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
              this.clusterId = com.google.api.client.util.Preconditions.checkNotNull(clusterId, "Required parameter clusterId must be specified.");
      ...
      public class Operations {
         ...
         * @return the request
         */
        public Cancel cancel(java.lang.String projectId, java.lang.String zone, java.lang.String operationId, com.google.container.v1beta1.model.CancelOperationRequest content) throws java.io.IOException {
         ...
         *        by the name field.
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String projectId, java.lang.String zone, java.lang.String operationId, com.google.container.v1beta1.model.CancelOperationRequest content) {
            super(Container.this, "POST", REST_PATH, content, com.google.container.v1beta1.model.Empty.class);
            this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
            this.zone = com.google.api.client.util.Preconditions.checkNotNull(zone, "Required parameter zone must be specified.");
