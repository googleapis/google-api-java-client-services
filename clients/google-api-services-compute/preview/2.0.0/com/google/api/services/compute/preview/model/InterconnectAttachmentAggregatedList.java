...
public final class InterconnectAttachmentAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, InterconnectAttachmentsScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#interconnectAttachmentAggregatedList
   ...
   */
  public InterconnectAttachmentAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, InterconnectAttachmentsScopedList> getItems() {
    return items;
  }
   ...
   */
  public InterconnectAttachmentAggregatedList setItems(java.util.Map<String, InterconnectAttachmentsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InterconnectAttachmentAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InterconnectAttachmentAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InterconnectAttachmentAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InterconnectAttachmentAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public InterconnectAttachmentAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectAttachmentAggregatedList set(String fieldName, Object value) {
    return (InterconnectAttachmentAggregatedList) super.set(fieldName, value);
  }

  @Override
  public InterconnectAttachmentAggregatedList clone() {
    return (InterconnectAttachmentAggregatedList) super.clone();
  }
