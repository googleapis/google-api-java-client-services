...
public final class FileRemote extends com.google.api.client.json.GenericJson {
   ...
   */
  public FileRemote setSha256Checksum(java.lang.String sha256Checksum) {
   ...
   */
  public FileRemote setUri(java.lang.String uri) {
    this.uri = uri;
    return this;
  }

  @Override
  public FileRemote set(String fieldName, Object value) {
    return (FileRemote) super.set(fieldName, value);
  }

  @Override
  public FileRemote clone() {
    return (FileRemote) super.clone();
  }
