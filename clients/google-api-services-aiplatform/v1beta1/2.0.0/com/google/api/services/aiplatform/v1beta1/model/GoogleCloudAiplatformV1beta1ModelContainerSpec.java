...
public final class GoogleCloudAiplatformV1beta1ModelContainerSpec extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudAiplatformV1beta1Probe healthProbe;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1Port> ports;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudAiplatformV1beta1Probe startupProbe;
   ...
   */
  public GoogleCloudAiplatformV1beta1ModelContainerSpec setArgs(java.util.List<java.lang.String> args) {
    this.args = args;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1ModelContainerSpec setEnv(java.util.List<GoogleCloudAiplatformV1beta1EnvVar> env) {
    this.env = env;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1Port> getPorts() {
    return ports;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1ModelContainerSpec setPorts(java.util.List<GoogleCloudAiplatformV1beta1Port> ports) {
    this.ports = ports;
    return this;
  }
  ...
  @Override
  public GoogleCloudAiplatformV1beta1ModelContainerSpec set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1ModelContainerSpec) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1ModelContainerSpec clone() {
    return (GoogleCloudAiplatformV1beta1ModelContainerSpec) super.clone();
  }
