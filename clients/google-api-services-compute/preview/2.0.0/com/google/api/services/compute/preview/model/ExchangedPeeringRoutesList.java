...
public final class ExchangedPeeringRoutesList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ExchangedPeeringRoute> items;

  static {
    // hack to force ProGuard to consider ExchangedPeeringRoute used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ExchangedPeeringRoute.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#exchangedPeeringRoutesList for
   ...
   */
  public ExchangedPeeringRoutesList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ExchangedPeeringRoute> getItems() {
    return items;
  }
   ...
   */
  public ExchangedPeeringRoutesList setItems(java.util.List<ExchangedPeeringRoute> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ExchangedPeeringRoutesList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ExchangedPeeringRoutesList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ExchangedPeeringRoutesList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ExchangedPeeringRoutesList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ExchangedPeeringRoutesList set(String fieldName, Object value) {
    return (ExchangedPeeringRoutesList) super.set(fieldName, value);
  }

  @Override
  public ExchangedPeeringRoutesList clone() {
    return (ExchangedPeeringRoutesList) super.clone();
  }
