...
/**
 * Model definition for AcceleratorPodControllersListResponse.
 *
...
public final class AcceleratorPodControllersListResponse extends com.google.api.client.json.GenericJson {

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.util.List<AcceleratorPodController> items;

  static {
    // hack to force ProGuard to consider AcceleratorPodController used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(AcceleratorPodController.class);
  }
   ...
   */
  public java.util.List<AcceleratorPodController> getItems() {
    return items;
  }
   ...
   */
  public AcceleratorPodControllersListResponse setItems(java.util.List<AcceleratorPodController> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AcceleratorPodControllersListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public AcceleratorPodControllersListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public AcceleratorPodControllersListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public AcceleratorPodControllersListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AcceleratorPodControllersListResponse set(String fieldName, Object value) {
    return (AcceleratorPodControllersListResponse) super.set(fieldName, value);
  }

  @Override
  public AcceleratorPodControllersListResponse clone() {
    return (AcceleratorPodControllersListResponse) super.clone();
  }

  /**
   * Model definition for AcceleratorPodControllersListResponseWarning.
   */
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for AcceleratorPodControllersListResponseWarningData.
     */
