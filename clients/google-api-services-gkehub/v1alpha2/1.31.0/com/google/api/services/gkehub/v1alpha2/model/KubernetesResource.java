...
public final class KubernetesResource extends com.google.api.client.json.GenericJson {
   ...
   * present in the cluster during Create or Update, or leave this field empty if none exists. The
   * CR manifest is used to validate the cluster has not been registered with another Membership.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
