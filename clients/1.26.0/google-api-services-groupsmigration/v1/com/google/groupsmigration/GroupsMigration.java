...
public class GroupsMigration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Groups Migration API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Archive {
    ...
    public class Insert extends GroupsMigrationRequest<com.google.groupsmigration.model.Groups> {
      ...
      protected Insert(java.lang.String groupId) {
        super(GroupsMigration.this, "POST", REST_PATH, null, com.google.groupsmigration.model.Groups.class);
      ...
      protected Insert(java.lang.String groupId, com.google.api.client.http.AbstractInputStreamContent mediaContent) {
        super(GroupsMigration.this, "POST", "/upload/" + getServicePath() + REST_PATH, null, com.google.groupsmigration.model.Groups.class);
        this.groupId = com.google.api.client.util.Preconditions.checkNotNull(groupId, "Required parameter groupId must be specified.");
