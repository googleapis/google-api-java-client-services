...
public final class GoogleCloudFunctionsV2betaOperationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudFunctionsV2betaStage> stages;
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setApiVersion(java.lang.String apiVersion) {
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setCancelRequested(java.lang.Boolean cancelRequested) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudFunctionsV2betaStage> getStages() {
    return stages;
  }
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setStages(java.util.List<GoogleCloudFunctionsV2betaStage> stages) {
    this.stages = stages;
    return this;
  }
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setStatusDetail(java.lang.String statusDetail) {
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setTarget(java.lang.String target) {
    this.target = target;
    return this;
  }
   ...
   */
  public GoogleCloudFunctionsV2betaOperationMetadata setVerb(java.lang.String verb) {
    this.verb = verb;
    return this;
  }

  @Override
  public GoogleCloudFunctionsV2betaOperationMetadata set(String fieldName, Object value) {
    return (GoogleCloudFunctionsV2betaOperationMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudFunctionsV2betaOperationMetadata clone() {
    return (GoogleCloudFunctionsV2betaOperationMetadata) super.clone();
  }
