...
/**
 * Model definition for FirewallPoliciesScopedList.
 *
...
public final class FirewallPoliciesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<FirewallPolicy> firewallPolicies;
   ...
   */
  public java.util.List<FirewallPolicy> getFirewallPolicies() {
   ...
   */
  public FirewallPoliciesScopedList setFirewallPolicies(java.util.List<FirewallPolicy> firewallPolicies) {
   ...
   */
  public FirewallPoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public FirewallPoliciesScopedList set(String fieldName, Object value) {
    return (FirewallPoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public FirewallPoliciesScopedList clone() {
    return (FirewallPoliciesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for FirewallPoliciesScopedListWarningData.
     */
