...
public final class PageList extends com.google.api.client.json.GenericJson {
   ...
   */
  public PageList setItems(java.util.List<Page> items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public PageList set(String fieldName, Object value) {
    return (PageList) super.set(fieldName, value);
  }

  @Override
  public PageList clone() {
    return (PageList) super.clone();
  }
