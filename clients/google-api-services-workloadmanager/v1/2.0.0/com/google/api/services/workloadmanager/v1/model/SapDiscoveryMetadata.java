...
public final class SapDiscoveryMetadata extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public SapDiscoveryMetadata set(String fieldName, Object value) {
    return (SapDiscoveryMetadata) super.set(fieldName, value);
  }

  @Override
  public SapDiscoveryMetadata clone() {
    return (SapDiscoveryMetadata) super.clone();
  }
