...
public final class RegionAutoscalerList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Autoscaler> items;

  static {
    // hack to force ProGuard to consider Autoscaler used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Autoscaler.class);
  }
   ...
   */
  public RegionAutoscalerList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Autoscaler> getItems() {
    return items;
  }
   ...
   */
  public RegionAutoscalerList setItems(java.util.List<Autoscaler> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RegionAutoscalerList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RegionAutoscalerList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RegionAutoscalerList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RegionAutoscalerList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RegionAutoscalerList set(String fieldName, Object value) {
    return (RegionAutoscalerList) super.set(fieldName, value);
  }

  @Override
  public RegionAutoscalerList clone() {
    return (RegionAutoscalerList) super.clone();
  }
