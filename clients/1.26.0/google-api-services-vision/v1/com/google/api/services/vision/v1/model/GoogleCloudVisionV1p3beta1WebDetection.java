...
public final class GoogleCloudVisionV1p3beta1WebDetection extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebLabel> getBestGuessLabels() {
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setBestGuessLabels(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebLabel> bestGuessLabels) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> getFullMatchingImages() {
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setFullMatchingImages(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> fullMatchingImages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebPage> getPagesWithMatchingImages() {
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setPagesWithMatchingImages(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebPage> pagesWithMatchingImages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> getPartialMatchingImages() {
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setPartialMatchingImages(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> partialMatchingImages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> getVisuallySimilarImages() {
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setVisuallySimilarImages(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebImage> visuallySimilarImages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebEntity> getWebEntities() {
    return webEntities;
  }
   ...
   */
  public GoogleCloudVisionV1p3beta1WebDetection setWebEntities(java.util.List<GoogleCloudVisionV1p3beta1WebDetectionWebEntity> webEntities) {
    this.webEntities = webEntities;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p3beta1WebDetection set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p3beta1WebDetection) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p3beta1WebDetection clone() {
    return (GoogleCloudVisionV1p3beta1WebDetection) super.clone();
  }
