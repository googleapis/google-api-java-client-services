...
public final class GoogleFirestoreAdminV1FieldOperationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleFirestoreAdminV1IndexConfigDelta> indexConfigDeltas;
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setEndTime(String endTime) {
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setField(java.lang.String field) {
    this.field = field;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleFirestoreAdminV1IndexConfigDelta> getIndexConfigDeltas() {
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setIndexConfigDeltas(java.util.List<GoogleFirestoreAdminV1IndexConfigDelta> indexConfigDeltas) {
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setProgressBytes(GoogleFirestoreAdminV1Progress progressBytes) {
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setProgressDocuments(GoogleFirestoreAdminV1Progress progressDocuments) {
   ...
   */
  public GoogleFirestoreAdminV1FieldOperationMetadata setStartTime(String startTime) {
  ...
  @Override
  public GoogleFirestoreAdminV1FieldOperationMetadata set(String fieldName, Object value) {
    return (GoogleFirestoreAdminV1FieldOperationMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleFirestoreAdminV1FieldOperationMetadata clone() {
    return (GoogleFirestoreAdminV1FieldOperationMetadata) super.clone();
  }
