...
public final class UploadedGenericArtifact extends com.google.api.client.json.GenericJson {
  ...
  private FileHashes artifactFingerprint;
   ...
   */
  public FileHashes getArtifactFingerprint() {
   ...
   */
  public UploadedGenericArtifact setArtifactFingerprint(FileHashes artifactFingerprint) {
   ...
   */
  public UploadedGenericArtifact setArtifactRegistryPackage(java.lang.String artifactRegistryPackage) {
   ...
   */
  public UploadedGenericArtifact setFileHashes(java.util.Map<String, FileHashes> fileHashes) {
   ...
   */
  public UploadedGenericArtifact setPushTiming(TimeSpan pushTiming) {
   ...
   */
  public UploadedGenericArtifact setUri(java.lang.String uri) {
    this.uri = uri;
    return this;
  }

  @Override
  public UploadedGenericArtifact set(String fieldName, Object value) {
    return (UploadedGenericArtifact) super.set(fieldName, value);
  }

  @Override
  public UploadedGenericArtifact clone() {
    return (UploadedGenericArtifact) super.clone();
  }
