...
/**
 * Model definition for RoutersListNamedSets.
 *
...
public final class RoutersListNamedSets extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#routersListNamedSets for lists of
   * named sets.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NamedSet> result;

  static {
    // hack to force ProGuard to consider NamedSet used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NamedSet.class);
  }
   ...
   */
  public RoutersListNamedSets setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public RoutersListNamedSets setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public RoutersListNamedSets setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RoutersListNamedSets setNextPageToken(java.lang.String nextPageToken) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NamedSet> getResult() {
    return result;
  }
   ...
   */
  public RoutersListNamedSets setResult(java.util.List<NamedSet> result) {
    this.result = result;
    return this;
  }
   ...
   */
  public RoutersListNamedSets setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RoutersListNamedSets setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public RoutersListNamedSets setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RoutersListNamedSets set(String fieldName, Object value) {
    return (RoutersListNamedSets) super.set(fieldName, value);
  }

  @Override
  public RoutersListNamedSets clone() {
    return (RoutersListNamedSets) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RoutersListNamedSetsWarningData.
     */
