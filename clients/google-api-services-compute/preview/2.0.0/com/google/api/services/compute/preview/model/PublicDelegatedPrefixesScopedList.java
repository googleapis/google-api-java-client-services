...
public final class PublicDelegatedPrefixesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<PublicDelegatedPrefix> publicDelegatedPrefixes;

  static {
    // hack to force ProGuard to consider PublicDelegatedPrefix used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(PublicDelegatedPrefix.class);
  }

  /**
   * [Output Only] Informational warning which replaces the list of public delegated prefixes when
   * the list is empty.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public java.util.List<PublicDelegatedPrefix> getPublicDelegatedPrefixes() {
    return publicDelegatedPrefixes;
  }

  /**
   * [Output Only] A list of PublicDelegatedPrefixes contained in this scope.
   * @param publicDelegatedPrefixes publicDelegatedPrefixes or {@code null} for none
   */
  public PublicDelegatedPrefixesScopedList setPublicDelegatedPrefixes(java.util.List<PublicDelegatedPrefix> publicDelegatedPrefixes) {
   ...
   */
  public PublicDelegatedPrefixesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PublicDelegatedPrefixesScopedList set(String fieldName, Object value) {
    return (PublicDelegatedPrefixesScopedList) super.set(fieldName, value);
  }

  @Override
  public PublicDelegatedPrefixesScopedList clone() {
    return (PublicDelegatedPrefixesScopedList) super.clone();
  }

  /**
   * [Output Only] Informational warning which replaces the list of public delegated prefixes when the
   * list is empty.
   */
