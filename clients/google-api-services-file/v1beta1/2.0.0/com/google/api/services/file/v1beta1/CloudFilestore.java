...
package com.google.api.services.file.v1beta1;
...
public class CloudFilestore extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Location.class);
      ...
      public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Backups {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Backup content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
         ...
         *        Cloud regions, for example **us-west1**.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Backup content) {
           ...
           * `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to
        ...
        public class Delete extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
         ...
         *        `projects/{project_id}/locations/{location}/backups/{backup_id}`
          ...
          protected Delete(java.lang.String name) {
            super(CloudFilestore.this, "DELETE", REST_PATH, null, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Backup> {
         ...
         *        `projects/{project_id}/locations/{location}/backups/{backup_id}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Backup.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        `projects/{project_id}/locations/{location}`. In Filestore, backup locations map to Google
         *        Cloud regions, for example **us-west1**. To retrieve backup information for all locations,
        ...
        public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListBackupsResponse> {
         ...
         *        use "-" for the `{location}` value.
          ...
          protected List(java.lang.String parent) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListBackupsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
           ...
           * format `projects/{project_id}/locations/{location}`. In Filestore, backup locations map
           * to Google Cloud regions, for example **us-west1**. To retrieve backup information for
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Backup content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
         ...
         *        `projects/{project_id}/locations/{location_id}/backups/{backup_id}`.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Backup content) {
            super(CloudFilestore.this, "PATCH", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Instances {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Instance content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
         ...
         *        zones, for example **us-west1-b**.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Instance content) {
            super(CloudFilestore.this, "POST", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Instance> {
         ...
         *        `projects/{project_id}/locations/{location}/instances/{instance_id}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Instance.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListInstancesResponse> {
         ...
         *        locations, use "-" for the `{location}` value.
           ...
           */
          protected List(java.lang.String parent) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListInstancesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Instance content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }
         ...
         *        `projects/{project_id}/locations/{location_id}/instances/{instance_id}`.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Instance content) {
            super(CloudFilestore.this, "PATCH", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         * @return the request
         */
        public Restore restore(java.lang.String name, com.google.api.services.file.v1beta1.model.RestoreInstanceRequest content) throws java.io.IOException {
          Restore result = new Restore(name, content);
          initialize(result);
          return result;
        }

        public class Restore extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
         ...
         *        `projects/{project_id}/locations/{location_id}/instances/{instance_id}`.
           ...
           * @since 1.13
           */
          protected Restore(java.lang.String name, com.google.api.services.file.v1beta1.model.RestoreInstanceRequest content) {
            super(CloudFilestore.this, "POST", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        /**
         * An accessor for creating requests from the Shares collection.
         *
         * <p>The typical use is:</p>
         * <pre>
         *   {@code CloudFilestore file = new CloudFilestore(...);}
         *   {@code CloudFilestore.Shares.List request = file.shares().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        public class Shares {
           ...
           * Creates a share.
           *
           * Create a request for the method "shares.create".
           *
           * This request holds the parameters needed by the file server.  After setting any optional
           * parameters, call the {@link Create#execute()} method to invoke the remote operation.
           *
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}`
           * @param content the {@link com.google.api.services.file.v1beta1.model.Share}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Share content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
          ...
          public class Create extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
            ...
            private static final String REST_PATH = "v1beta1/{+parent}/shares";
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}`
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Share content) {
              super(CloudFilestore.this, "POST", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
           ...
           `projects/{project_id}/locations/{location}/instances/{instance_id}`
            ...
            /**
             * Required. The ID to use for the share. The ID must be unique within the specified
            ...
            /** Required. The ID to use for the share. The ID must be unique within the specified instance. This
           ...
           hyphens, and cannot end with a hyphen.
             ...
             * lowercase letters, numbers, or hyphens, and cannot end with a hyphen.
             */
            public Create setShareId(java.lang.String shareId) {
           ...
           * Deletes a share.
           *
           * Create a request for the method "shares.delete".
           *
           * This request holds the parameters needed by the file server.  After setting any optional
           * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
           *
          ...
          public class Delete extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
            ...
            private final java.util.regex.Pattern NAME_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/instances/[^/]+/shares/[^/]+$");
           ...
           *
           * Create a request for the method "shares.get".
           *
           * This request holds the parameters needed by the file server.  After setting any optional
           * parameters, call the {@link Get#execute()} method to invoke the remote operation.
           *
          ...
          public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Share> {
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}/shares/{share_id}`
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Share.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
            ...
            /**
             * Required. The share resource name, in the format `projects/{project_id}/locations/{lo
             * cation}/instances/{instance_id}/shares/{share_id}`
             */
            @com.google.api.client.util.Key
            private java.lang.String name;
           ...
           *
           * Create a request for the method "shares.list".
           *
           * This request holds the parameters needed by the file server.  After setting any optional
           * parameters, call the {@link List#execute()} method to invoke the remote operation.
           *
          ...
          public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListSharesResponse> {
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListSharesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           *
           * Create a request for the method "shares.patch".
           *
           * This request holds the parameters needed by the file server.  After setting any optional
           * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
           *
           * @param name Output only. The resource name of the share, in the format
           *        `projects/{project_id}/locations/{location_id}/instances/{instance_id}/shares/{share_id}`.
           * @param content the {@link com.google.api.services.file.v1beta1.model.Share}
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Share content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        `projects/{project_id}/locations/{location_id}/instances/{instance_id}/shares/{share_id}`.
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Share content) {
              super(CloudFilestore.this, "PATCH", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
            ...
            /**
             * Output only. The resource name of the share, in the format `projects/{project_id}/loc
             * ations/{location_id}/instances/{instance_id}/shares/{share_id}`.
             */
            @com.google.api.client.util.Key
            private java.lang.String name;
           ...
           `projects/{project_id}/locations/{location_id}/instances/{instance_id}/shares/{share_id}`.
            ...
            /** Required. Mask of fields to update. At least one path must be supplied in this field. The elements
           of the repeated paths field may only include these fields: * "description" * "capacity_gb" *
           "labels" * "nfs_export_options"
             */
            public String getUpdateMask() {
              return updateMask;
            }
        ...
        public class Snapshots {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Snapshot content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}`
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Snapshot content) {
              super(CloudFilestore.this, "POST", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Snapshot> {
           ...
           *        }`
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Snapshot.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListSnapshotsResponse> {
           ...
           *        `projects/{project_id}/locations/{location}/instances/{instance_id}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListSnapshotsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Snapshot content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        _id}`.
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.file.v1beta1.model.Snapshot content) {
              super(CloudFilestore.this, "PATCH", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.file.v1beta1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.file.v1beta1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.file.v1beta1.model.CancelOperationRequest content) {
        ...
        public class Delete extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(CloudFilestore.this, "DELETE", REST_PATH, null, com.google.api.services.file.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      /**
       * An accessor for creating requests from the VolumePools collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code CloudFilestore file = new CloudFilestore(...);}
       *   {@code CloudFilestore.VolumePools.List request = file.volumePools().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public VolumePools volumePools() {
        return new VolumePools();
      }

      /**
       * The "volumePools" collection of methods.
       */
      public class VolumePools {

        /**
         * Creates a volume pool.
         *
         * Create a request for the method "volumePools.create".
         *
         * This request holds the parameters needed by the file server.  After setting any optional
         * parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The project and location for which to create the volume pool, in the format
         *        `projects/{project}/locations/{location}`.
         * @param content the {@link com.google.api.services.file.v1beta1.model.VolumePool}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.VolumePool content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
        ...
        public class Create extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Operation> {
          ...
          private static final String REST_PATH = "v1beta1/{+parent}/volumePools";
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.VolumePool content) {
            super(CloudFilestore.this, "POST", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
         ...
         `projects/{project}/locations/{location}`.
          ...
          /**
           * Required. The ID to use for the volume pool, which will become the final component of
           * the volume pool's resource name.
           */
          @com.google.api.client.util.Key
          private java.lang.String volumePoolId;

          /** Required. The ID to use for the volume pool, which will become the final component of the volume
         pool's resource name.
           */
          public java.lang.String getVolumePoolId() {
            return volumePoolId;
          }
           ...
           * the volume pool's resource name.
           */
          public Create setVolumePoolId(java.lang.String volumePoolId) {
            this.volumePoolId = volumePoolId;
            return this;
          }
         ...
         *
         * Create a request for the method "volumePools.delete".
         *
         * This request holds the parameters needed by the file server.  After setting any optional
         * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
         *
         * @param name Required. The volume pool resource name, in the format
         ...
         *
         * Create a request for the method "volumePools.get".
         *
         * This request holds the parameters needed by the file server.  After setting any optional
         * parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
        ...
        public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.VolumePool> {
         ...
         *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.VolumePool.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * Create a request for the method "volumePools.list".
         *
         * This request holds the parameters needed by the file server.  After setting any optional
         * parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The project and location for which to retrieve volume pool information, in the format
        ...
        public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListVolumePoolsResponse> {
         ...
         *        locations, use "-" as the value of `{location}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListVolumePoolsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * Required. The project and location for which to retrieve volume pool information, in
           * the format `projects/{project}/locations/{location}`. To retrieve volume pool
         ...
         *
         * Create a request for the method "volumePools.patch".
         *
         * This request holds the parameters needed by the file server.  After setting any optional
         * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
         *
         * @param name Identifier. The resource name of the volume pool, in the format
         *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
         * @param content the {@link com.google.api.services.file.v1beta1.model.VolumePool}
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.file.v1beta1.model.VolumePool content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }
         ...
         *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.file.v1beta1.model.VolumePool content) {
            super(CloudFilestore.this, "PATCH", REST_PATH, content, com.google.api.services.file.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         * <pre>
         *   {@code CloudFilestore file = new CloudFilestore(...);}
         *   {@code CloudFilestore.Volumes.List request = file.volumes().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        public class Volumes {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Volume content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Volume> {
           ...
           *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.file.v1beta1.model.Volume content) {
          ...
          public class Get extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.Volume> {
           ...
           *        `projects/{project}/locations/{location}/volumePools/{volume_pool}/volumes/{volume}`.
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.Volume.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           * parameters, call the {@link List#execute()} method to invoke the remote operation.
           *
           * @param parent Required. The volume pool for which to retrieve volume information, in the format
           *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
           * @return the request
           */
          public List list(java.lang.String parent) throws java.io.IOException {
          ...
          public class List extends CloudFilestoreRequest<com.google.api.services.file.v1beta1.model.ListVolumesResponse> {
           ...
           *        `projects/{project}/locations/{location}/volumePools/{volume_pool}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudFilestore.this, "GET", REST_PATH, null, com.google.api.services.file.v1beta1.model.ListVolumesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
