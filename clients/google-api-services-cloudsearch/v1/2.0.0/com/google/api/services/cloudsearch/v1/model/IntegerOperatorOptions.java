...
public final class IntegerOperatorOptions extends com.google.api.client.json.GenericJson {
   ...
   * the property's name is *priorityVal*, then queries like *priorityabove:* show results only
   * where the value of the property named *priorityVal* is greater than **. The operator name can
   ...
   * property's name is *priorityVal*, then queries like *prioritybelow:* show results only where
   * the value of the property named *priorityVal* is less than **. The operator name can only
