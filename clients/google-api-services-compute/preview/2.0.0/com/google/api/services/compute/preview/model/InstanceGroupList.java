...
public final class InstanceGroupList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InstanceGroup> items;

  static {
    // hack to force ProGuard to consider InstanceGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InstanceGroup.class);
  }

  /**
   * Output only. [Output Only] The resource type, which is alwayscompute#instanceGroupList for
   ...
   */
  public InstanceGroupList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InstanceGroup> getItems() {
    return items;
  }
   ...
   */
  public InstanceGroupList setItems(java.util.List<InstanceGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstanceGroupList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InstanceGroupList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstanceGroupList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InstanceGroupList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceGroupList set(String fieldName, Object value) {
    return (InstanceGroupList) super.set(fieldName, value);
  }

  @Override
  public InstanceGroupList clone() {
    return (InstanceGroupList) super.clone();
  }
