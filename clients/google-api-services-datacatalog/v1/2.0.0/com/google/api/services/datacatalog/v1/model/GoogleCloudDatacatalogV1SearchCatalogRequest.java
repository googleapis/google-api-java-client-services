...
public final class GoogleCloudDatacatalogV1SearchCatalogRequest extends com.google.api.client.json.GenericJson {
   ...
   * to/search-reference). An empty query string returns all data assets (in the specified scope)
   * that you have access to. A query string can be a simple `xyz` or qualified by predicates: *
