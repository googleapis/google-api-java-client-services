...
public final class GoogleCloudRetailV2Condition extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2ConditionQueryTerm> queryTerms;

  /**
   * Range of time(s) specifying when Condition is active. Condition true if any time range matches.
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2ConditionTimeRange> getActiveTimeRange() {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2ConditionQueryTerm> getQueryTerms() {
    return queryTerms;
  }
   ...
   */
  public GoogleCloudRetailV2Condition setQueryTerms(java.util.List<GoogleCloudRetailV2ConditionQueryTerm> queryTerms) {
