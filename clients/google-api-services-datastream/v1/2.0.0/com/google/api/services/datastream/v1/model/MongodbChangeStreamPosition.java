...
public final class MongodbChangeStreamPosition extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public MongodbChangeStreamPosition set(String fieldName, Object value) {
    return (MongodbChangeStreamPosition) super.set(fieldName, value);
  }

  @Override
  public MongodbChangeStreamPosition clone() {
    return (MongodbChangeStreamPosition) super.clone();
  }
