...
public final class GoogleCloudDataplexV1ListTasksResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDataplexV1Task> tasks;
   ...
   */
  public GoogleCloudDataplexV1ListTasksResponse setTasks(java.util.List<GoogleCloudDataplexV1Task> tasks) {
    this.tasks = tasks;
    return this;
  }
   ...
   */
  public GoogleCloudDataplexV1ListTasksResponse setUnreachableLocations(java.util.List<java.lang.String> unreachableLocations) {
