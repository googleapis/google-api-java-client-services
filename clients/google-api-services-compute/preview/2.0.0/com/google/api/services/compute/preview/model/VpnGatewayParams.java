...
/**
 * Model definition for VpnGatewayParams.
 *
...
public final class VpnGatewayParams extends com.google.api.client.json.GenericJson {
   ...
   * "tagValues/444"} is invalid. * Inconsistent format is not supported. For instance:
   ...
   */
  public VpnGatewayParams setResourceManagerTags(java.util.Map<String, java.lang.String> resourceManagerTags) {
    this.resourceManagerTags = resourceManagerTags;
    return this;
  }

  @Override
  public VpnGatewayParams set(String fieldName, Object value) {
    return (VpnGatewayParams) super.set(fieldName, value);
  }

  @Override
  public VpnGatewayParams clone() {
    return (VpnGatewayParams) super.clone();
  }
