...
public class Safebrowsing extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Safe Browsing API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class EncodedFullHashes {
    ...
    public class Get extends SafebrowsingRequest<com.google.safebrowsing.model.FindFullHashesResponse> {
      ...
      protected Get(java.lang.String encodedRequest) {
        super(Safebrowsing.this, "GET", REST_PATH, null, com.google.safebrowsing.model.FindFullHashesResponse.class);
  ...
  public class EncodedUpdates {
    ...
    public class Get extends SafebrowsingRequest<com.google.safebrowsing.model.FetchThreatListUpdatesResponse> {
       ...
       */
      protected Get(java.lang.String encodedRequest) {
        super(Safebrowsing.this, "GET", REST_PATH, null, com.google.safebrowsing.model.FetchThreatListUpdatesResponse.class);
        this.encodedRequest = com.google.api.client.util.Preconditions.checkNotNull(encodedRequest, "Required parameter encodedRequest must be specified.");
      }
  ...
  public class FullHashes {
     ...
     *
     * @param content the {@link com.google.safebrowsing.model.FindFullHashesRequest}
     * @return the request
     */
    public Find find(com.google.safebrowsing.model.FindFullHashesRequest content) throws java.io.IOException {
      Find result = new Find(content);
      initialize(result);
      return result;
    }

    public class Find extends SafebrowsingRequest<com.google.safebrowsing.model.FindFullHashesResponse> {
       ...
       * @since 1.13
       */
      protected Find(com.google.safebrowsing.model.FindFullHashesRequest content) {
        super(Safebrowsing.this, "POST", REST_PATH, content, com.google.safebrowsing.model.FindFullHashesResponse.class);
      }
  ...
  public class ThreatHits {
     ...
     *
     * @param content the {@link com.google.safebrowsing.model.ThreatHit}
     * @return the request
     */
    public Create create(com.google.safebrowsing.model.ThreatHit content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends SafebrowsingRequest<com.google.safebrowsing.model.Empty> {
       ...
       * @since 1.13
       */
      protected Create(com.google.safebrowsing.model.ThreatHit content) {
        super(Safebrowsing.this, "POST", REST_PATH, content, com.google.safebrowsing.model.Empty.class);
      }
  ...
  public class ThreatListUpdates {
     ...
     *
     * @param content the {@link com.google.safebrowsing.model.FetchThreatListUpdatesRequest}
     * @return the request
     */
    public Fetch fetch(com.google.safebrowsing.model.FetchThreatListUpdatesRequest content) throws java.io.IOException {
      Fetch result = new Fetch(content);
      initialize(result);
      return result;
    }

    public class Fetch extends SafebrowsingRequest<com.google.safebrowsing.model.FetchThreatListUpdatesResponse> {
       ...
       * @since 1.13
       */
      protected Fetch(com.google.safebrowsing.model.FetchThreatListUpdatesRequest content) {
        super(Safebrowsing.this, "POST", REST_PATH, content, com.google.safebrowsing.model.FetchThreatListUpdatesResponse.class);
      }
  ...
  public class ThreatLists {
    ...
    public class List extends SafebrowsingRequest<com.google.safebrowsing.model.ListThreatListsResponse> {
       ...
       */
      protected List() {
        super(Safebrowsing.this, "GET", REST_PATH, null, com.google.safebrowsing.model.ListThreatListsResponse.class);
      }
  ...
  public class ThreatMatches {
     ...
     * parameters, call the {@link Find#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.safebrowsing.model.FindThreatMatchesRequest}
     * @return the request
     */
    public Find find(com.google.safebrowsing.model.FindThreatMatchesRequest content) throws java.io.IOException {
      Find result = new Find(content);
      initialize(result);
      return result;
    }

    public class Find extends SafebrowsingRequest<com.google.safebrowsing.model.FindThreatMatchesResponse> {
       ...
       * @since 1.13
       */
      protected Find(com.google.safebrowsing.model.FindThreatMatchesRequest content) {
        super(Safebrowsing.this, "POST", REST_PATH, content, com.google.safebrowsing.model.FindThreatMatchesResponse.class);
      }
