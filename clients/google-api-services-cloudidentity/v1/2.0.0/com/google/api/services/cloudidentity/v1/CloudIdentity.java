...
public class CloudIdentity extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Policies {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.cloudidentity.v1.model.Policy}
     * @return the request
     */
    public Create create(com.google.api.services.cloudidentity.v1.model.Policy content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends CloudIdentityRequest<com.google.api.services.cloudidentity.v1.model.Operation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.api.services.cloudidentity.v1.model.Policy content) {
        super(CloudIdentity.this, "POST", REST_PATH, content, com.google.api.services.cloudidentity.v1.model.Operation.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.api.services.cloudidentity.v1.model.Policy content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }
     ...
     *        the Policy. Format: policies/{policy}.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.api.services.cloudidentity.v1.model.Policy content) {
        super(CloudIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.cloudidentity.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
