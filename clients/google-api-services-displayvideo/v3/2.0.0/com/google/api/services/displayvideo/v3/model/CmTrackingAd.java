...
public final class CmTrackingAd extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CmTrackingAd set(String fieldName, Object value) {
    return (CmTrackingAd) super.set(fieldName, value);
  }

  @Override
  public CmTrackingAd clone() {
    return (CmTrackingAd) super.clone();
  }
