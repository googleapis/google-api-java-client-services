...
/**
 * Model definition for HealthSourceList.
 *
...
public final class HealthSourceList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HealthSource> items;
   ...
   */
  public HealthSourceList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public HealthSourceList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<HealthSource> getItems() {
    return items;
  }
   ...
   */
  public HealthSourceList setItems(java.util.List<HealthSource> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HealthSourceList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HealthSourceList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HealthSourceList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public HealthSourceList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthSourceList set(String fieldName, Object value) {
    return (HealthSourceList) super.set(fieldName, value);
  }

  @Override
  public HealthSourceList clone() {
    return (HealthSourceList) super.clone();
  }
