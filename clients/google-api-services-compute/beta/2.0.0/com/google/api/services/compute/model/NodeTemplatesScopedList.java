...
public final class NodeTemplatesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NodeTemplate> nodeTemplates;
   ...
   */
  public java.util.List<NodeTemplate> getNodeTemplates() {
    return nodeTemplates;
  }

  /**
   * [Output Only] A list of node templates contained in this scope.
   * @param nodeTemplates nodeTemplates or {@code null} for none
   */
  public NodeTemplatesScopedList setNodeTemplates(java.util.List<NodeTemplate> nodeTemplates) {
   ...
   */
  public NodeTemplatesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeTemplatesScopedList set(String fieldName, Object value) {
    return (NodeTemplatesScopedList) super.set(fieldName, value);
  }

  @Override
  public NodeTemplatesScopedList clone() {
    return (NodeTemplatesScopedList) super.clone();
  }
