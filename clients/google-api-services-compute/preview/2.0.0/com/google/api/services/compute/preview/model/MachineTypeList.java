...
public final class MachineTypeList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<MachineType> items;

  static {
    // hack to force ProGuard to consider MachineType used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(MachineType.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Always compute#machineTypeList for lists of
   * machine types.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public MachineTypeList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<MachineType> getItems() {
    return items;
  }
   ...
   */
  public MachineTypeList setItems(java.util.List<MachineType> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public MachineTypeList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public MachineTypeList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public MachineTypeList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public MachineTypeList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public MachineTypeList set(String fieldName, Object value) {
    return (MachineTypeList) super.set(fieldName, value);
  }

  @Override
  public MachineTypeList clone() {
    return (MachineTypeList) super.clone();
  }
