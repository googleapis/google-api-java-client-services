...
public final class ResourceSearchResult extends com.google.api.client.json.GenericJson {
   ...
   * included in this [list](https://cloud.google.com/asset-inventory/docs/legacy-
   * fields#resource_types_with_the_to_be_deprecated_kmskey_field) for backward compatible purpose.
   * To search against the `kms_key`: * Use a field query. Example: `kmsKey:key` * Use a free text
   * query. Example: `key`
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
