...
public final class TextOperatorOptions extends com.google.api.client.json.GenericJson {
   ...
   * like *subject:* show results only where the value of the property named *subjectLine* matches
   * **. By contrast, a search that uses the same ** without an operator returns all items where **
   * matches the value of any text properties or text within the content field for the item. The
