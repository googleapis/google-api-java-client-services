...
public final class ServiceManagementEnum extends com.google.api.client.json.GenericJson {
   ...
   */
  public ServiceManagementEnum setEnumvalue(java.util.List<EnumValue> enumvalue) {
   ...
   */
  public ServiceManagementEnum setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public ServiceManagementEnum setOptions(java.util.List<Option> options) {
   ...
   */
  public ServiceManagementEnum setSyntax(java.lang.String syntax) {
    this.syntax = syntax;
    return this;
  }

  @Override
  public ServiceManagementEnum set(String fieldName, Object value) {
    return (ServiceManagementEnum) super.set(fieldName, value);
  }

  @Override
  public ServiceManagementEnum clone() {
    return (ServiceManagementEnum) super.clone();
  }
