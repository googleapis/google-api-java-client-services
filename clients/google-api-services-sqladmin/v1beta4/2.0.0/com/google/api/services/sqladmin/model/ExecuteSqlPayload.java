...
public final class ExecuteSqlPayload extends com.google.api.client.json.GenericJson {
   ...
   * `projects/{project}/locations/{location}/secrets/{secret}/versions/{secret_version}`. This
   * field is used together with the `user` field. The secret resource name will not be stored.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
