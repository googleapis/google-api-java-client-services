...
public class Games extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.31.0 of the Google Play Game Services library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  /**
   * An accessor for creating requests from the SnapshotsExtended collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Games games = new Games(...);}
   *   {@code Games.SnapshotsExtended.List request = games.snapshotsExtended().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public SnapshotsExtended snapshotsExtended() {
    return new SnapshotsExtended();
  }

  /**
   * The "snapshotsExtended" collection of methods.
   */
  public class SnapshotsExtended {

    /**
     * Resolves any potential conflicts according to the resolution policy specified in the request and
     * returns the snapshot head after the resolution.
     *
     * Create a request for the method "snapshotsExtended.resolveSnapshotHead".
     *
     * This request holds the parameters needed by the games server.  After setting any optional
     * parameters, call the {@link ResolveSnapshotHead#execute()} method to invoke the remote operation.
     *
     * @param snapshotName Required. Name of the snapshot.
     * @param content the {@link com.google.api.services.games.model.ResolveSnapshotHeadRequest}
     * @return the request
     */
    public ResolveSnapshotHead resolveSnapshotHead(java.lang.String snapshotName, com.google.api.services.games.model.ResolveSnapshotHeadRequest content) throws java.io.IOException {
      ResolveSnapshotHead result = new ResolveSnapshotHead(snapshotName, content);
      initialize(result);
      return result;
    }

    public class ResolveSnapshotHead extends GamesRequest<com.google.api.services.games.model.ResolveSnapshotHeadResponse> {

      private static final String REST_PATH = "games/v1/snapshotsExtended/{snapshotName}:resolveHead";

      /**
       * Resolves any potential conflicts according to the resolution policy specified in the request
       * and returns the snapshot head after the resolution.
       *
       * Create a request for the method "snapshotsExtended.resolveSnapshotHead".
       *
       * This request holds the parameters needed by the the games server.  After setting any optional
       * parameters, call the {@link ResolveSnapshotHead#execute()} method to invoke the remote
       * operation. <p> {@link ResolveSnapshotHead#initialize(com.google.api.client.googleapis.services.
       ...
       * @since 1.13
       */
      protected ResolveSnapshotHead(java.lang.String snapshotName, com.google.api.services.games.model.ResolveSnapshotHeadRequest content) {
        super(Games.this, "POST", REST_PATH, content, com.google.api.services.games.model.ResolveSnapshotHeadResponse.class);
        this.snapshotName = com.google.api.client.util.Preconditions.checkNotNull(snapshotName, "Required parameter snapshotName must be specified.");
      }

      @Override
      public ResolveSnapshotHead set$Xgafv(java.lang.String $Xgafv) {
        return (ResolveSnapshotHead) super.set$Xgafv($Xgafv);
      }

      @Override
      public ResolveSnapshotHead setAccessToken(java.lang.String accessToken) {
        return (ResolveSnapshotHead) super.setAccessToken(accessToken);
      }

      @Override
      public ResolveSnapshotHead setAlt(java.lang.String alt) {
        return (ResolveSnapshotHead) super.setAlt(alt);
      }

      @Override
      public ResolveSnapshotHead setCallback(java.lang.String callback) {
        return (ResolveSnapshotHead) super.setCallback(callback);
      }

      @Override
      public ResolveSnapshotHead setFields(java.lang.String fields) {
        return (ResolveSnapshotHead) super.setFields(fields);
      }

      @Override
      public ResolveSnapshotHead setKey(java.lang.String key) {
        return (ResolveSnapshotHead) super.setKey(key);
      }

      @Override
      public ResolveSnapshotHead setOauthToken(java.lang.String oauthToken) {
        return (ResolveSnapshotHead) super.setOauthToken(oauthToken);
      }

      @Override
      public ResolveSnapshotHead setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (ResolveSnapshotHead) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public ResolveSnapshotHead setQuotaUser(java.lang.String quotaUser) {
        return (ResolveSnapshotHead) super.setQuotaUser(quotaUser);
      }

      @Override
      public ResolveSnapshotHead setUploadType(java.lang.String uploadType) {
        return (ResolveSnapshotHead) super.setUploadType(uploadType);
      }

      @Override
      public ResolveSnapshotHead setUploadProtocol(java.lang.String uploadProtocol) {
        return (ResolveSnapshotHead) super.setUploadProtocol(uploadProtocol);
      }
      ...
      /** Required. Name of the snapshot. */
      public ResolveSnapshotHead setSnapshotName(java.lang.String snapshotName) {
        this.snapshotName = snapshotName;
        return this;
      }

      @Override
      public ResolveSnapshotHead set(String parameterName, Object value) {
        return (ResolveSnapshotHead) super.set(parameterName, value);
      }
    }
