...
public final class ManagedInstanceCurrentActionDetails extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Details of the current action that the managed instance group has
   * scheduled for the instance. Contains trigger for the current action, and methodName in case it
   * was triggered by API call. Possible values for trigger:        - API Any API call.    -
   ...
   * REDISTRIBUTION The regional managed instance group is    moving instances between zones to
   * restore balance.    - STANDBY_REFILL The managed instance group is refilling    the Standby
   * Pool (stopped/suspended virtual machines) after scale    up.    - MAINTENANCE Manual
   * maintenance.    - FAILED_CREATION The managed instance group is handling    failed instance
   * creation.    - INSTANCE_FAILURE The managed instance group is handling    instance failure,
