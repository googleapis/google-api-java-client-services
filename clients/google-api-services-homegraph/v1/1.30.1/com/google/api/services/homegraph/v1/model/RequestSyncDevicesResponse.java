...
public final class RequestSyncDevicesResponse extends com.google.api.client.json.GenericJson {

  @Override
  public RequestSyncDevicesResponse set(String fieldName, Object value) {
    return (RequestSyncDevicesResponse) super.set(fieldName, value);
  }

  @Override
  public RequestSyncDevicesResponse clone() {
    return (RequestSyncDevicesResponse) super.clone();
  }
