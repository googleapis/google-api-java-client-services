...
public class AuthorizedBuyersMarketplace extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Bidders {
    ...
    public class FinalizedDeals {
       ...
       *        `bidders/{accountId}`.
       ...
       deal.flightStartTime * deal.flightEndTime * deal.eligibleSeatIds * dealServingStatus * readyToServe
         */
        public java.lang.String getFilter() {
          return filter;
        }
       ...
       * addition, bidders can use the URL path "/v1alpha/bidders/{accountId}/finalizedDeals/{dealId}" to
       * set ready to serve for the finalized deals belong to itself, its child seats and all their
      ...
      public class SetReadyToServe extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.FinalizedDeal> {
         ...
         * "/v1alpha/bidders/{accountId}/finalizedDeals/{dealId}" to set ready to serve for the finalized
         * deals belong to itself, its child seats and all their clients. This method only applies to
  ...
  public class Curators {
    ...
    public class CuratedPackages {
       ...
       * @param content the {@link com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ActivateCuratedPackageRequest}
       * @return the request
       */
      public Activate activate(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ActivateCuratedPackageRequest content) throws java.io.IOException {
        Activate result = new Activate(name, content);
        initialize(result);
        return result;
      }

      public class Activate extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage> {
       ...
       *        `curators/{accountId}/curatedPackages/{curatedPackageId}`
         ...
         * @since 1.13
         */
        protected Activate(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ActivateCuratedPackageRequest content) {
          super(AuthorizedBuyersMarketplace.this, "POST", REST_PATH, content, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        `curators/{accountId}`
       * @param content the {@link com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage> {

        private static final String REST_PATH = "v1alpha/{+parent}/curatedPackages";
       ...
       *        `curators/{accountId}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage content) {
          super(AuthorizedBuyersMarketplace.this, "POST", REST_PATH, content, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
       ...
       *        `curators/{accountId}/curatedPackages/{curatedPackageId}`
       * @param content the {@link com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.DeactivateCuratedPackageRequest}
       * @return the request
       */
      public Deactivate deactivate(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.DeactivateCuratedPackageRequest content) throws java.io.IOException {
        Deactivate result = new Deactivate(name, content);
        initialize(result);
        return result;
      }

      public class Deactivate extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage> {
       ...
       *        `curators/{accountId}/curatedPackages/{curatedPackageId}`
         ...
         * @since 1.13
         */
        protected Deactivate(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.DeactivateCuratedPackageRequest content) {
          super(AuthorizedBuyersMarketplace.this, "POST", REST_PATH, content, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Get extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage> {
       ...
       *        `curators/{accountId}/curatedPackages/{curatedPackageId}`
         ...
         */
        protected Get(java.lang.String name) {
          super(AuthorizedBuyersMarketplace.this, "GET", REST_PATH, null, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ListCuratedPackagesResponse> {
       ...
       *        `curators/{accountId}`
         ...
         */
        protected List(java.lang.String parent) {
          super(AuthorizedBuyersMarketplace.this, "GET", REST_PATH, null, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ListCuratedPackagesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage> {
       ...
       *        `curators/{accountId}/curatedPackages/{curatedPackageId}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage content) {
          super(AuthorizedBuyersMarketplace.this, "PATCH", REST_PATH, content, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.CuratedPackage.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
  ...
  public class MediaPlanners {
    ...
    public class List extends AuthorizedBuyersMarketplaceRequest<com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ListMediaPlannersResponse> {

      private static final String REST_PATH = "v1alpha/mediaPlanners";
       ...
       */
      protected List() {
        super(AuthorizedBuyersMarketplace.this, "GET", REST_PATH, null, com.google.api.services.authorizedbuyersmarketplace.v1alpha.model.ListMediaPlannersResponse.class);
      }
