...
public final class DeepLinkData extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<PackagingServiceClient> client;
   ...
   */
  public DeepLinkData setAppId(java.lang.Long appId) {
    this.appId = appId;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<PackagingServiceClient> getClient() {
    return client;
  }
   ...
   */
  public DeepLinkData setClient(java.util.List<PackagingServiceClient> client) {
    this.client = client;
    return this;
  }
   ...
   */
  public DeepLinkData setDeepLinkId(java.lang.String deepLinkId) {
   ...
   */
  public DeepLinkData setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public DeepLinkData set(String fieldName, Object value) {
    return (DeepLinkData) super.set(fieldName, value);
  }

  @Override
  public DeepLinkData clone() {
