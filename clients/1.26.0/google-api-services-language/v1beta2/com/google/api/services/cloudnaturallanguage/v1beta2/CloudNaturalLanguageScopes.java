...
package com.google.api.services.cloudnaturallanguage.v1beta2;
 ...
 * @since 1.4
 */
public class CloudNaturalLanguageScopes {
  ...
  public static java.util.Set<String> all() {
    ...
    set.add(CLOUD_LANGUAGE);
    set.add(CLOUD_PLATFORM);
    return java.util.Collections.unmodifiableSet(set);
  }

  private CloudNaturalLanguageScopes() {
  }
}
