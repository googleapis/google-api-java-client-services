...
public class Backupdr extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
       ...
       *
       * Create a request for the method "locations.getTrial".
       *
       * This request holds the parameters needed by the backupdr server.  After setting any optional
      ...
      public GetTrial getTrial(java.lang.String name) throws java.io.IOException {
        GetTrial result = new GetTrial(name);
        initialize(result);
        return result;
      }

      public class GetTrial extends BackupdrRequest<com.google.api.services.backupdr.v1.model.Trial> {

        private static final String REST_PATH = "v1/{+name}";

        private final java.util.regex.Pattern NAME_PATTERN =
            java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/trial$");
         ...
         *
         * This request holds the parameters needed by the the backupdr server.  After setting any
         * optional parameters, call the {@link GetTrial#execute()} method to invoke the remote operation.
         * <p> {@link
       ...
       *        projects/{project}/locations/{location} Supported Locations are - us, eu and asia.
        ...
        protected GetTrial(java.lang.String name) {
          super(Backupdr.this, "GET", REST_PATH, null, com.google.api.services.backupdr.v1.model.Trial.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
        ...
        @Override
        public GetTrial set$Xgafv(java.lang.String $Xgafv) {
          return (GetTrial) super.set$Xgafv($Xgafv);
        }

        @Override
        public GetTrial setAccessToken(java.lang.String accessToken) {
          return (GetTrial) super.setAccessToken(accessToken);
        }

        @Override
        public GetTrial setAlt(java.lang.String alt) {
          return (GetTrial) super.setAlt(alt);
        }

        @Override
        public GetTrial setCallback(java.lang.String callback) {
          return (GetTrial) super.setCallback(callback);
        }

        @Override
        public GetTrial setFields(java.lang.String fields) {
          return (GetTrial) super.setFields(fields);
        }

        @Override
        public GetTrial setKey(java.lang.String key) {
          return (GetTrial) super.setKey(key);
        }

        @Override
        public GetTrial setOauthToken(java.lang.String oauthToken) {
          return (GetTrial) super.setOauthToken(oauthToken);
        }

        @Override
        public GetTrial setPrettyPrint(java.lang.Boolean prettyPrint) {
          return (GetTrial) super.setPrettyPrint(prettyPrint);
        }

        @Override
        public GetTrial setQuotaUser(java.lang.String quotaUser) {
          return (GetTrial) super.setQuotaUser(quotaUser);
        }

        @Override
        public GetTrial setUploadType(java.lang.String uploadType) {
          return (GetTrial) super.setUploadType(uploadType);
        }

        @Override
        public GetTrial setUploadProtocol(java.lang.String uploadProtocol) {
       ...
       projects/{project}/locations/{location} Supported Locations are - us, eu and asia.
        ...
        @Override
        public GetTrial set(String parameterName, Object value) {
          return (GetTrial) super.set(parameterName, value);
        }
      }
      /**
      ...
      /**
       * An accessor for creating requests from the Trial collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code Backupdr backupdr = new Backupdr(...);}
       *   {@code Backupdr.Trial.List request = backupdr.trial().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Trial {
         ...
         *
         * Create a request for the method "trial.subscribe".
         *
         * This request holds the parameters needed by the backupdr server.  After setting any optional
         ...
         * @return the request
         */
        public Subscribe subscribe(java.lang.String parent, com.google.api.services.backupdr.v1.model.SubscribeTrialRequest content) throws java.io.IOException {
          Subscribe result = new Subscribe(parent, content);
          initialize(result);
          return result;
        }

        public class Subscribe extends BackupdrRequest<com.google.api.services.backupdr.v1.model.Trial> {

          private static final String REST_PATH = "v1/{+parent}/trial:subscribe";
         ...
         *        projects/{project}/locations/{location} Supported Locations are - us, eu and asia.
           ...
           * @since 1.13
           */
          protected Subscribe(java.lang.String parent, com.google.api.services.backupdr.v1.model.SubscribeTrialRequest content) {
            super(Backupdr.this, "POST", REST_PATH, content, com.google.api.services.backupdr.v1.model.Trial.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
