...
public final class HealthCheckList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HealthCheck> items;
   ...
   */
  public HealthCheckList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<HealthCheck> getItems() {
    return items;
  }
   ...
   */
  public HealthCheckList setItems(java.util.List<HealthCheck> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HealthCheckList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public HealthCheckList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HealthCheckList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HealthCheckList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthCheckList set(String fieldName, Object value) {
    return (HealthCheckList) super.set(fieldName, value);
  }

  @Override
  public HealthCheckList clone() {
    return (HealthCheckList) super.clone();
  }
