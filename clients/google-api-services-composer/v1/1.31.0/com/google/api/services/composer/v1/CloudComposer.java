...
public class CloudComposer extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.31.0 of the Cloud Composer API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
      ...
      public class Environments {
         ...
         *        "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
         ...
         "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
           ...
           * environment's current DatabaseConfig. config.webServerConfig Replace the environment's
           * current WebServerConfig. config.softwareConfig.airflowConfigOverrides Replace all
         ...
         DatabaseConfig. config.webServerConfig Replace the environment's current WebServerConfig.
         ...
         Airflow config property name in the section named section, preserving other properties. To delete
         the property override, include it in `updateMask` and omit its mapping in
