...
public final class SubnetworkAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public SubnetworkAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, SubnetworksScopedList> getItems() {
    return items;
  }
   ...
   */
  public SubnetworkAggregatedList setItems(java.util.Map<String, SubnetworksScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SubnetworkAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SubnetworkAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SubnetworkAggregatedList set(String fieldName, Object value) {
    return (SubnetworkAggregatedList) super.set(fieldName, value);
  }

  @Override
  public SubnetworkAggregatedList clone() {
    return (SubnetworkAggregatedList) super.clone();
  }
