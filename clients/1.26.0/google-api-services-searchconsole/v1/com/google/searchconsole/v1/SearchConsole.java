...
package com.google.searchconsole.v1;
...
public class SearchConsole extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google Search Console URL Testing Tools API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class UrlTestingTools {
    ...
    public class MobileFriendlyTest {
       ...
       *
       * @param content the {@link com.google.searchconsole.v1.model.RunMobileFriendlyTestRequest}
       * @return the request
       */
      public Run run(com.google.searchconsole.v1.model.RunMobileFriendlyTestRequest content) throws java.io.IOException {
        Run result = new Run(content);
        initialize(result);
        return result;
      }

      public class Run extends SearchConsoleRequest<com.google.searchconsole.v1.model.RunMobileFriendlyTestResponse> {
         ...
         * @since 1.13
         */
        protected Run(com.google.searchconsole.v1.model.RunMobileFriendlyTestRequest content) {
          super(SearchConsole.this, "POST", REST_PATH, content, com.google.searchconsole.v1.model.RunMobileFriendlyTestResponse.class);
        }
