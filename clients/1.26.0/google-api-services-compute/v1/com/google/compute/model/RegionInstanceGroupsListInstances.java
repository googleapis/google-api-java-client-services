...
public final class RegionInstanceGroupsListInstances extends com.google.api.client.json.GenericJson {
   ...
   */
  public RegionInstanceGroupsListInstances setItems(java.util.List<InstanceWithNamedPorts> items) {
    this.items = items;
    return this;
  }
  ...
  @Override
  public RegionInstanceGroupsListInstances set(String fieldName, Object value) {
    return (RegionInstanceGroupsListInstances) super.set(fieldName, value);
  }

  @Override
  public RegionInstanceGroupsListInstances clone() {
    return (RegionInstanceGroupsListInstances) super.clone();
  }
