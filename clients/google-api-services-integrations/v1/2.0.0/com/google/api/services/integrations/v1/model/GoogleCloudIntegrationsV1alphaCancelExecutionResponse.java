...
public final class GoogleCloudIntegrationsV1alphaCancelExecutionResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudIntegrationsV1alphaCancelExecutionResponse set(String fieldName, Object value) {
    return (GoogleCloudIntegrationsV1alphaCancelExecutionResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudIntegrationsV1alphaCancelExecutionResponse clone() {
    return (GoogleCloudIntegrationsV1alphaCancelExecutionResponse) super.clone();
  }
