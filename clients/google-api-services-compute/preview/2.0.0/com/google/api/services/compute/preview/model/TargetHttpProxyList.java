...
public final class TargetHttpProxyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetHttpProxy> items;

  static {
    // hack to force ProGuard to consider TargetHttpProxy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetHttpProxy.class);
  }

  /**
   * Output only. Type of resource. Always compute#targetHttpProxyList for lists of target HTTP
   * proxies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public TargetHttpProxyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetHttpProxy> getItems() {
    return items;
  }
   ...
   */
  public TargetHttpProxyList setItems(java.util.List<TargetHttpProxy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetHttpProxyList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetHttpProxyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetHttpProxyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetHttpProxyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetHttpProxyList set(String fieldName, Object value) {
    return (TargetHttpProxyList) super.set(fieldName, value);
  }

  @Override
  public TargetHttpProxyList clone() {
    return (TargetHttpProxyList) super.clone();
  }
