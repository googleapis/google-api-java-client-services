...
public final class GoogleCloudDiscoveryengineV1betaSearchRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Crowding specifications for improving result diversity. If multiple CrowdingSpecs are
   * specified, crowding will be evaluated on each unique combination of the `field` values, and
   * max_count will be the maximum value of `max_count` across all CrowdingSpecs. For example, if
   * the first CrowdingSpec has `field` = "color" and `max_count` = 3, and the second CrowdingSpec
   * has `field` = "size" and `max_count` = 2, then after 3 documents that share the same color AND
   * size have been returned, subsequent ones should be removed or demoted.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1betaSearchRequestCrowdingSpec> crowdingSpecs;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1betaSearchRequestCustomRankingParams customRankingParams;
   ...
   * PageInfo.page_category. This field is the equivalent of the query for browse (navigation)
   * queries. It's used by the browse model when the query is empty. If the field is empty, it will
   * not be used by the browse model. If the field contains more than one element, only the first
   * element will be used. To represent full path of a category, use '>' character to separate
   * different hierarchies. If '>' is part of the category name, replace it with other character(s).
   * For example, `Graphics Cards > RTX>4090 > Founders Edition` where "RTX > 4090" represents one
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1betaSearchRequestRelevanceFilterSpec relevanceFilterSpec;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1betaSearchRequestSearchAddonSpec searchAddonSpec;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1betaSearchRequestCrowdingSpec> getCrowdingSpecs() {
    return crowdingSpecs;
  }
   ...
   * has `field` = "size" and `max_count` = 2, then after 3 documents that share the same color AND
   * size have been returned, subsequent ones should be removed or demoted.
   * @param crowdingSpecs crowdingSpecs or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setCrowdingSpecs(java.util.List<GoogleCloudDiscoveryengineV1betaSearchRequestCrowdingSpec> crowdingSpecs) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequestCustomRankingParams getCustomRankingParams() {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setCustomRankingParams(GoogleCloudDiscoveryengineV1betaSearchRequestCustomRankingParams customRankingParams) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setEntity(java.lang.String entity) {
    this.entity = entity;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setNumResultsPerDataStore(java.lang.Integer numResultsPerDataStore) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequestRelevanceFilterSpec getRelevanceFilterSpec() {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setRelevanceFilterSpec(GoogleCloudDiscoveryengineV1betaSearchRequestRelevanceFilterSpec relevanceFilterSpec) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequestSearchAddonSpec getSearchAddonSpec() {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaSearchRequest setSearchAddonSpec(GoogleCloudDiscoveryengineV1betaSearchRequestSearchAddonSpec searchAddonSpec) {
