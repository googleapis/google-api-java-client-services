...
public final class StoragePoolParams extends com.google.api.client.json.GenericJson {

  /**
   * Input only. Resource manager tags to be bound to the storage pool. Tag keys and values have the
   ...
   */
  public StoragePoolParams setResourceManagerTags(java.util.Map<String, java.lang.String> resourceManagerTags) {
    this.resourceManagerTags = resourceManagerTags;
    return this;
  }

  @Override
  public StoragePoolParams set(String fieldName, Object value) {
    return (StoragePoolParams) super.set(fieldName, value);
  }

  @Override
  public StoragePoolParams clone() {
    return (StoragePoolParams) super.clone();
  }
