# Ad Exchange Buyer API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1.3-rev20191018-1.30.3</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-adexchangebuyer:v1.3-rev20191018-1.30.3'
}
```
