...
public final class ListLineItemAssignedTargetingOptionsResponse extends com.google.api.client.json.GenericJson {
   ...
   * in a subsequent ListLineItemAssignedTargetingOptionsRequest to fetch the next page of results.
   ...
   */
  public ListLineItemAssignedTargetingOptionsResponse setNextPageToken(java.lang.String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  @Override
  public ListLineItemAssignedTargetingOptionsResponse set(String fieldName, Object value) {
    return (ListLineItemAssignedTargetingOptionsResponse) super.set(fieldName, value);
  }

  @Override
  public ListLineItemAssignedTargetingOptionsResponse clone() {
    return (ListLineItemAssignedTargetingOptionsResponse) super.clone();
  }
