...
public final class GoogleCloudAiplatformV1beta1PublisherModelCallToAction extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setCreateApplication(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences createApplication) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setDeploy(GoogleCloudAiplatformV1beta1PublisherModelCallToActionDeploy deploy) {
    this.deploy = deploy;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setOpenEvaluationPipeline(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences openEvaluationPipeline) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setOpenFineTuningPipeline(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences openFineTuningPipeline) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setOpenGenerationAiStudio(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences openGenerationAiStudio) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setOpenGenie(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences openGenie) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setOpenPromptTuningPipeline(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences openPromptTuningPipeline) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setRequestAccess(GoogleCloudAiplatformV1beta1PublisherModelCallToActionRegionalResourceReferences requestAccess) {
   ...
   */
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction setViewRestApi(GoogleCloudAiplatformV1beta1PublisherModelCallToActionViewRestApi viewRestApi) {
    this.viewRestApi = viewRestApi;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1PublisherModelCallToAction) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1PublisherModelCallToAction clone() {
