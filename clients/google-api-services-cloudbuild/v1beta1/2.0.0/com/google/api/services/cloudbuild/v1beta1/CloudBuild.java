...
package com.google.api.services.cloudbuild.v1beta1;

/**
 * Service definition for CloudBuild (v1beta1).
 *
 * <p>
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.cloudbuild.v1beta1.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.cloudbuild.v1beta1.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.cloudbuild.v1beta1.model.CancelOperationRequest content) {
            super(CloudBuild.this, "POST", REST_PATH, content, com.google.api.services.cloudbuild.v1beta1.model.Empty.class);
        ...
        public class Get extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.Operation> {
          ...
          protected Get(java.lang.String name) {
            super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class WorkerPools {
        ...
        /**
         * Creates a `WorkerPool` to run the builds, and returns the new worker pool. NOTE: As of now, this
         * method returns an `Operation` that is always complete.
         *
         ...
         * @param content the {@link com.google.api.services.cloudbuild.v1beta1.model.WorkerPool}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.cloudbuild.v1beta1.model.WorkerPool content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.Operation> {

          private static final String REST_PATH = "v1beta1/{+parent}/workerPools";

          private final java.util.regex.Pattern PARENT_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+$");

          /**
           * Creates a `WorkerPool` to run the builds, and returns the new worker pool. NOTE: As of now,
           * this method returns an `Operation` that is always complete.
           *
           * Create a request for the method "workerPools.create".
           *
           * This request holds the parameters needed by the the cloudbuild server.  After setting any
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.cloudbuild.v1beta1.model.WorkerPool content) {
            super(CloudBuild.this, "POST", REST_PATH, content, com.google.api.services.cloudbuild.v1beta1.model.Operation.class);
        ...
        /**
         * Deletes a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always
         * complete.
         *
        ...
        public class Delete extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.Operation> {
         ...
         *        `projects/{project}/locations/{workerPool}/workerPools/{workerPool}`.
          ...
          protected Delete(java.lang.String name) {
            super(CloudBuild.this, "DELETE", REST_PATH, null, com.google.api.services.cloudbuild.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.WorkerPool> {
         ...
         *        `projects/{project}/locations/{location}/workerPools/{workerPool}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1beta1.model.WorkerPool.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.ListWorkerPoolsResponse> {
         ...
         *        `projects/{project}/locations/location`.
          ...
          protected List(java.lang.String parent) {
            super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1beta1.model.ListWorkerPoolsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        /**
         * Updates a `WorkerPool`. NOTE: As of now, this method returns an `Operation` that is always
         * complete.
         *
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.cloudbuild.v1beta1.model.WorkerPool content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudBuildRequest<com.google.api.services.cloudbuild.v1beta1.model.Operation> {
         ...
         *        value of `{location}` is determined by the endpoint accessed.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.cloudbuild.v1beta1.model.WorkerPool content) {
            super(CloudBuild.this, "PATCH", REST_PATH, content, com.google.api.services.cloudbuild.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
