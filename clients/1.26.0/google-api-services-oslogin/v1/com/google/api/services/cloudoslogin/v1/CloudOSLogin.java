...
package com.google.api.services.cloudoslogin.v1;
...
public class CloudOSLogin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Cloud OS Login API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Users {
    ...
    public class GetLoginProfile extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1.model.LoginProfile> {

      private static final String REST_PATH = "v1/{+name}/loginProfile";
      ...
      protected GetLoginProfile(java.lang.String name) {
        super(CloudOSLogin.this, "GET", REST_PATH, null, com.google.api.services.cloudoslogin.v1.model.LoginProfile.class);
     ...
     * @param content the {@link com.google.api.services.cloudoslogin.v1.model.SshPublicKey}
     * @return the request
     */
    public ImportSshPublicKey importSshPublicKey(java.lang.String parent, com.google.api.services.cloudoslogin.v1.model.SshPublicKey content) throws java.io.IOException {
      ImportSshPublicKey result = new ImportSshPublicKey(parent, content);
      initialize(result);
      return result;
    }

    public class ImportSshPublicKey extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1.model.ImportSshPublicKeyResponse> {

      private static final String REST_PATH = "v1/{+parent}:importSshPublicKey";
       ...
       * @since 1.13
       */
      protected ImportSshPublicKey(java.lang.String parent, com.google.api.services.cloudoslogin.v1.model.SshPublicKey content) {
        super(CloudOSLogin.this, "POST", REST_PATH, content, com.google.api.services.cloudoslogin.v1.model.ImportSshPublicKeyResponse.class);
    ...
    public class Projects {
      ...
      public class Delete extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1.model.Empty> {
       ...
       *        `users/{user}/projects/{project}`.
        ...
        protected Delete(java.lang.String name) {
          super(CloudOSLogin.this, "DELETE", REST_PATH, null, com.google.api.services.cloudoslogin.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class SshPublicKeys {
      ...
      public class Get extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1.model.SshPublicKey> {
       ...
       *        `users/{user}/sshPublicKeys/{fingerprint}`.
        ...
        protected Get(java.lang.String name) {
          super(CloudOSLogin.this, "GET", REST_PATH, null, com.google.api.services.cloudoslogin.v1.model.SshPublicKey.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.cloudoslogin.v1.model.SshPublicKey content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudOSLoginRequest<com.google.api.services.cloudoslogin.v1.model.SshPublicKey> {
       ...
       *        `users/{user}/sshPublicKeys/{fingerprint}`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.cloudoslogin.v1.model.SshPublicKey content) {
          super(CloudOSLogin.this, "PATCH", REST_PATH, content, com.google.api.services.cloudoslogin.v1.model.SshPublicKey.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
