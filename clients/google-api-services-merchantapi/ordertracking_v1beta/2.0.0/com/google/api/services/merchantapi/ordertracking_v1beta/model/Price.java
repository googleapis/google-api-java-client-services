...
public final class Price extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The price represented as a number in micros (1 million micros is an equivalent to one's
   * currency standard unit, for example, 1 USD = 1000000 micros).
   ...
   */
  public Price setAmountMicros(java.lang.Long amountMicros) {
