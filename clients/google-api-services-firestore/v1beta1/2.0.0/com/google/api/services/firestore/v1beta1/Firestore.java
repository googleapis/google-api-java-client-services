  ...
  public class Projects {
    ...
    public class Databases {
      ...
      public class Documents {
         ...
         * @param content the {@link com.google.api.services.firestore.v1beta1.model.ExecutePipelineRequest}
         * @return the request
         */
        public ExecutePipeline executePipeline(java.lang.String database, com.google.api.services.firestore.v1beta1.model.ExecutePipelineRequest content) throws java.io.IOException {
          ExecutePipeline result = new ExecutePipeline(database, content);
          initialize(result);
          return result;
        }

        public class ExecutePipeline extends FirestoreRequest<com.google.api.services.firestore.v1beta1.model.ExecutePipelineResponse> {

          private static final String REST_PATH = "v1beta1/{+database}/documents:executePipeline";
           ...
           * @since 1.13
           */
          protected ExecutePipeline(java.lang.String database, com.google.api.services.firestore.v1beta1.model.ExecutePipelineRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.api.services.firestore.v1beta1.model.ExecutePipelineResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
