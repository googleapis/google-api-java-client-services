...
public final class AddPublicKeyMetadata extends com.google.api.client.json.GenericJson {

  @Override
  public AddPublicKeyMetadata set(String fieldName, Object value) {
    return (AddPublicKeyMetadata) super.set(fieldName, value);
  }

  @Override
  public AddPublicKeyMetadata clone() {
    return (AddPublicKeyMetadata) super.clone();
  }
