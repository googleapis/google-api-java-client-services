...
public final class PublicDelegatedPrefixList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<PublicDelegatedPrefix> items;
   ...
   */
  public PublicDelegatedPrefixList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<PublicDelegatedPrefix> getItems() {
    return items;
  }
   ...
   */
  public PublicDelegatedPrefixList setItems(java.util.List<PublicDelegatedPrefix> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public PublicDelegatedPrefixList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public PublicDelegatedPrefixList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public PublicDelegatedPrefixList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PublicDelegatedPrefixList set(String fieldName, Object value) {
    return (PublicDelegatedPrefixList) super.set(fieldName, value);
  }

  @Override
  public PublicDelegatedPrefixList clone() {
    return (PublicDelegatedPrefixList) super.clone();
  }
