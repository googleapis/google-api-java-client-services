...
public final class VariantTargeting extends com.google.api.client.json.GenericJson {
   ...
   */
  public VariantTargeting setAbiTargeting(AbiTargeting abiTargeting) {
   ...
   */
  public VariantTargeting setMultiAbiTargeting(MultiAbiTargeting multiAbiTargeting) {
   ...
   */
  public VariantTargeting setScreenDensityTargeting(ScreenDensityTargeting screenDensityTargeting) {
   ...
   */
  public VariantTargeting setSdkVersionTargeting(SdkVersionTargeting sdkVersionTargeting) {
   ...
   */
  public VariantTargeting setTextureCompressionFormatTargeting(TextureCompressionFormatTargeting textureCompressionFormatTargeting) {
    this.textureCompressionFormatTargeting = textureCompressionFormatTargeting;
    return this;
  }

  @Override
  public VariantTargeting set(String fieldName, Object value) {
    return (VariantTargeting) super.set(fieldName, value);
  }

  @Override
  public VariantTargeting clone() {
    return (VariantTargeting) super.clone();
  }
