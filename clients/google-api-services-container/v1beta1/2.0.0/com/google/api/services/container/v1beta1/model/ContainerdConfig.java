...
public final class ContainerdConfig extends com.google.api.client.json.GenericJson {
   ...
   * PrivateRegistryAccessConfig is used to configure access configuration for private container
   * registries.
   * @param privateRegistryAccessConfig privateRegistryAccessConfig or {@code null} for none
   */
  ...
  @Override
  public ContainerdConfig set(String fieldName, Object value) {
    return (ContainerdConfig) super.set(fieldName, value);
  }

  @Override
  public ContainerdConfig clone() {
    return (ContainerdConfig) super.clone();
  }
