  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class AiApplications {
        ...
        public class GetIamPolicy extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(AgentRegistry.this, "GET", REST_PATH, null, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1Policy.class);
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1SetIamPolicyRequest content) {
            super(AgentRegistry.this, "POST", REST_PATH, content, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1TestIamPermissionsRequest content) {
            super(AgentRegistry.this, "POST", REST_PATH, content, com.google.api.services.agentregistry.v1alpha.model.GoogleIamV1TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
      ...
      public class Bindings {
         ...
         *        `projects/{project}/locations/{location}`.
         * @param content the {@link com.google.api.services.agentregistry.v1alpha.model.Binding}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.agentregistry.v1alpha.model.Binding content) throws java.io.IOException {
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.agentregistry.v1alpha.model.Binding content) {
        ...
        public class FetchAvailable extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.FetchAvailableBindingsResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}/bindings:fetchAvailable";
          ...
          protected FetchAvailable(java.lang.String parent) {
            super(AgentRegistry.this, "GET", REST_PATH, null, com.google.api.services.agentregistry.v1alpha.model.FetchAvailableBindingsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Get extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.Binding> {
         ...
         *        `projects/{project}/locations/{location}/bindings/{binding}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(AgentRegistry.this, "GET", REST_PATH, null, com.google.api.services.agentregistry.v1alpha.model.Binding.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AgentRegistryRequest<com.google.api.services.agentregistry.v1alpha.model.ListBindingsResponse> {
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(AgentRegistry.this, "GET", REST_PATH, null, com.google.api.services.agentregistry.v1alpha.model.ListBindingsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.agentregistry.v1alpha.model.Binding content) throws java.io.IOException {
         ...
         *        `projects/{project}/locations/{location}/bindings/{binding}`.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.agentregistry.v1alpha.model.Binding content) {
      ...
      public class Skills {
         ...
         * does not have a policy set.
         *
         * Create a request for the method "skills.getIamPolicy".
         *
         * This request holds the parameters needed by the agentregistry server.  After setting any optional
         * parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote operation.
         *
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "skills.setIamPolicy".
         *
         * This request holds the parameters needed by the agentregistry server.  After setting any optional
         * parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote operation.
         *
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "skills.testIamPermissions".
         *
         * This request holds the parameters needed by the agentregistry server.  After setting any optional
         * parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote operation.
         *
