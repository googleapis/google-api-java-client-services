...
public final class LinkableGitRepository extends com.google.api.client.json.GenericJson {
   ...
   */
  public LinkableGitRepository setCloneUri(java.lang.String cloneUri) {
    this.cloneUri = cloneUri;
    return this;
  }

  @Override
  public LinkableGitRepository set(String fieldName, Object value) {
    return (LinkableGitRepository) super.set(fieldName, value);
  }

  @Override
  public LinkableGitRepository clone() {
    return (LinkableGitRepository) super.clone();
  }
