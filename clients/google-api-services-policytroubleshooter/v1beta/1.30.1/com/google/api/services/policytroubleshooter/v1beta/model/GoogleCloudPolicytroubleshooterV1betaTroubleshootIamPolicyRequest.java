...
public final class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest set(String fieldName, Object value) {
    return (GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest clone() {
    return (GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest) super.clone();
  }
