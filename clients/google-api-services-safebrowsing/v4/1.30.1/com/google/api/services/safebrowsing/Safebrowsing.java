...
public class Safebrowsing extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.10 of the Safe Browsing API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class EncodedFullHashes {
    ...
    public class Get extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.FindFullHashesResponse> {
  ...
  public class EncodedUpdates {
    ...
    public class Get extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.FetchThreatListUpdatesResponse> {
  ...
  public class FullHashes {
    ...
    public class Find extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.FindFullHashesResponse> {
  ...
  public class ThreatHits {
    ...
    public class Create extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.Empty> {
  ...
  public class ThreatListUpdates {
    ...
    public class Fetch extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.FetchThreatListUpdatesResponse> {
  ...
  public class ThreatLists {
    ...
    public class List extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.ListThreatListsResponse> {
  ...
  public class ThreatMatches {
    ...
    public class Find extends SafebrowsingRequest<com.google.api.services.safebrowsing.model.FindThreatMatchesResponse> {
