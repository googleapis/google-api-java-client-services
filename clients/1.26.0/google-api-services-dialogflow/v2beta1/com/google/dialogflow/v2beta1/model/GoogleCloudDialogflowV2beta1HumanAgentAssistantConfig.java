...
public final class GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. ID of the agent assistant to use. Format: `projects//humanAgentAssistants/`.
   ...
   */
  public GoogleCloudDialogflowV2beta1HumanAgentAssistantConfig setName(java.lang.String name) {
    this.name = name;
    return this;
  }
