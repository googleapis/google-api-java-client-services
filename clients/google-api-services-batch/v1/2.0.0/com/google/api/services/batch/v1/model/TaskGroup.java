...
public final class TaskGroup extends com.google.api.client.json.GenericJson {
   ...
   * the BATCH_HOSTS_FILE environment variable to the path of that file. Defaults to false. The host
   * file supports up to 1000 VMs.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. If not set or set to false, Batch uses the root user to execute runnables. If set to
   * true, Batch runs the runnables using a non-root user. Currently, the non-root user Batch used
   * is generated by OS Login. For more information, see [About OS
