 ...
 *
 * * When an object located at `http(s)://hostname:port/` is transferred to a data sink, the name of
 * the object at the data sink is `/`.
 *
 * * If the specified size of an object does not match the actual size of the object fetched, the
