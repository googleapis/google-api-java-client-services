...
public class BinaryAuthorization extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Binary Authorization API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class GetPolicy extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Policy> {
    ...
    in the format `projects/policy`.
      ...
      protected GetPolicy(java.lang.String name) {
        super(BinaryAuthorization.this, "GET", REST_PATH, null, com.google.binaryauthorization.v1beta1.model.Policy.class);
     ...
     *        project.
     * @param content the {@link com.google.binaryauthorization.v1beta1.model.Policy}
     * @return the request
     */
    public UpdatePolicy updatePolicy(java.lang.String name, com.google.binaryauthorization.v1beta1.model.Policy content) throws java.io.IOException {
      UpdatePolicy result = new UpdatePolicy(name, content);
      initialize(result);
      return result;
    }

    public class UpdatePolicy extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Policy> {
     ...
     *        project.
       ...
       * @since 1.13
       */
      protected UpdatePolicy(java.lang.String name, com.google.binaryauthorization.v1beta1.model.Policy content) {
        super(BinaryAuthorization.this, "PUT", REST_PATH, content, com.google.binaryauthorization.v1beta1.model.Policy.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Attestors {
       ...
       * @param content the {@link com.google.binaryauthorization.v1beta1.model.Attestor}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.binaryauthorization.v1beta1.model.Attestor content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Attestor> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.binaryauthorization.v1beta1.model.Attestor content) {
          super(BinaryAuthorization.this, "POST", REST_PATH, content, com.google.binaryauthorization.v1beta1.model.Attestor.class);
      ...
      public class Delete extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Empty> {
      ...
      `projects/attestors`.
        ...
        protected Delete(java.lang.String name) {
          super(BinaryAuthorization.this, "DELETE", REST_PATH, null, com.google.binaryauthorization.v1beta1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Attestor> {
      ...
      `projects/attestors`.
        ...
        protected Get(java.lang.String name) {
          super(BinaryAuthorization.this, "GET", REST_PATH, null, com.google.binaryauthorization.v1beta1.model.Attestor.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class GetIamPolicy extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.IamPolicy> {
       ...
       *        the appropriate value for this field.
        ...
        protected GetIamPolicy(java.lang.String resource) {
          super(BinaryAuthorization.this, "GET", REST_PATH, null, com.google.binaryauthorization.v1beta1.model.IamPolicy.class);
      ...
      public class List extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.ListAttestorsResponse> {
      ...
      attestors, in the format `projects`.
        ...
        protected List(java.lang.String parent) {
          super(BinaryAuthorization.this, "GET", REST_PATH, null, com.google.binaryauthorization.v1beta1.model.ListAttestorsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      See the operation documentation for
       *        the appropriate value for this field.
       * @param content the {@link com.google.binaryauthorization.v1beta1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.binaryauthorization.v1beta1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.IamPolicy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.binaryauthorization.v1beta1.model.SetIamPolicyRequest content) {
          super(BinaryAuthorization.this, "POST", REST_PATH, content, com.google.binaryauthorization.v1beta1.model.IamPolicy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
      ...
      See the operation
       *        documentation for the appropriate value for this field.
       * @param content the {@link com.google.binaryauthorization.v1beta1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.binaryauthorization.v1beta1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.TestIamPermissionsResponse> {
       ...
       *        documentation for the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.binaryauthorization.v1beta1.model.TestIamPermissionsRequest content) {
          super(BinaryAuthorization.this, "POST", REST_PATH, content, com.google.binaryauthorization.v1beta1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
       ...
       * @return the request
       */
      public Update update(java.lang.String name, com.google.binaryauthorization.v1beta1.model.Attestor content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends BinaryAuthorizationRequest<com.google.binaryauthorization.v1beta1.model.Attestor> {
      ...
      `projects/attestors`. This field may not be updated.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.binaryauthorization.v1beta1.model.Attestor content) {
          super(BinaryAuthorization.this, "PUT", REST_PATH, content, com.google.binaryauthorization.v1beta1.model.Attestor.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
