...
public final class GoogleCloudAiplatformV1beta1CachedContent extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setContents(java.util.List<GoogleCloudAiplatformV1beta1Content> contents) {
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setExpireTime(String expireTime) {
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setModel(java.lang.String model) {
    this.model = model;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setSystemInstruction(GoogleCloudAiplatformV1beta1Content systemInstruction) {
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setToolConfig(GoogleCloudAiplatformV1beta1ToolConfig toolConfig) {
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setTools(java.util.List<GoogleCloudAiplatformV1beta1Tool> tools) {
    this.tools = tools;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1CachedContent setTtl(String ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  @Override
  public GoogleCloudAiplatformV1beta1CachedContent set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1CachedContent) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1CachedContent clone() {
    return (GoogleCloudAiplatformV1beta1CachedContent) super.clone();
  }
