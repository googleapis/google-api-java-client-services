...
public class Reseller extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Enterprise Apps Reseller API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Customers {
    ...
    public class Get extends ResellerRequest<com.google.reseller.model.Customer> {
     ...
     *        name for a customerId is changed, the Google system automatically updates.
      ...
      protected Get(java.lang.String customerId) {
        super(Reseller.this, "GET", REST_PATH, null, com.google.reseller.model.Customer.class);
     ...
     *
     * @param content the {@link com.google.reseller.model.Customer}
     * @return the request
     */
    public Insert insert(com.google.reseller.model.Customer content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends ResellerRequest<com.google.reseller.model.Customer> {
       ...
       * @since 1.13
       */
      protected Insert(com.google.reseller.model.Customer content) {
        super(Reseller.this, "POST", REST_PATH, content, com.google.reseller.model.Customer.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String customerId, com.google.reseller.model.Customer content) throws java.io.IOException {
      Patch result = new Patch(customerId, content);
      initialize(result);
      return result;
    }

    public class Patch extends ResellerRequest<com.google.reseller.model.Customer> {
     ...
     *        name for a customerId is changed, the Google system automatically updates.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String customerId, com.google.reseller.model.Customer content) {
        super(Reseller.this, "PATCH", REST_PATH, content, com.google.reseller.model.Customer.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String customerId, com.google.reseller.model.Customer content) throws java.io.IOException {
      Update result = new Update(customerId, content);
      initialize(result);
      return result;
    }

    public class Update extends ResellerRequest<com.google.reseller.model.Customer> {
     ...
     *        name for a customerId is changed, the Google system automatically updates.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String customerId, com.google.reseller.model.Customer content) {
        super(Reseller.this, "PUT", REST_PATH, content, com.google.reseller.model.Customer.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
      }
  ...
  public class Resellernotify {
    ...
    public class Getwatchdetails extends ResellerRequest<com.google.reseller.model.ResellernotifyGetwatchdetailsResponse> {
      ...
      protected Getwatchdetails() {
        super(Reseller.this, "GET", REST_PATH, null, com.google.reseller.model.ResellernotifyGetwatchdetailsResponse.class);
      }
    ...
    public class Register extends ResellerRequest<com.google.reseller.model.ResellernotifyResource> {
       ...
       */
      protected Register() {
        super(Reseller.this, "POST", REST_PATH, null, com.google.reseller.model.ResellernotifyResource.class);
      }
    ...
    public class Unregister extends ResellerRequest<com.google.reseller.model.ResellernotifyResource> {
  ...
  public class Subscriptions {
    ...
    public class Activate extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        the retrieve all reseller subscriptions method.
      ...
      protected Activate(java.lang.String customerId, java.lang.String subscriptionId) {
        super(Reseller.this, "POST", REST_PATH, null, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
     ...
     *        to not use this ID as a key for persistent data. And the subscriptionId can be found using
     *        the retrieve all reseller subscriptions method.
     * @param content the {@link com.google.reseller.model.ChangePlanRequest}
     * @return the request
     */
    public ChangePlan changePlan(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.ChangePlanRequest content) throws java.io.IOException {
      ChangePlan result = new ChangePlan(customerId, subscriptionId, content);
      initialize(result);
      return result;
    }

    public class ChangePlan extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        the retrieve all reseller subscriptions method.
       ...
       * @since 1.13
       */
      protected ChangePlan(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.ChangePlanRequest content) {
        super(Reseller.this, "POST", REST_PATH, content, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
        this.subscriptionId = com.google.api.client.util.Preconditions.checkNotNull(subscriptionId, "Required parameter subscriptionId must be specified.");
      }
     ...
     *        to not use this ID as a key for persistent data. And the subscriptionId can be found using
     *        the retrieve all reseller subscriptions method.
     * @param content the {@link com.google.reseller.model.RenewalSettings}
     * @return the request
     */
    public ChangeRenewalSettings changeRenewalSettings(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.RenewalSettings content) throws java.io.IOException {
      ChangeRenewalSettings result = new ChangeRenewalSettings(customerId, subscriptionId, content);
      initialize(result);
      return result;
    }

    public class ChangeRenewalSettings extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        the retrieve all reseller subscriptions method.
       ...
       * @since 1.13
       */
      protected ChangeRenewalSettings(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.RenewalSettings content) {
        super(Reseller.this, "POST", REST_PATH, content, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
        this.subscriptionId = com.google.api.client.util.Preconditions.checkNotNull(subscriptionId, "Required parameter subscriptionId must be specified.");
      }
     ...
     *        to not use this ID as a key for persistent data. And the subscriptionId can be found using
     *        the retrieve all reseller subscriptions method.
     * @param content the {@link com.google.reseller.model.Seats}
     * @return the request
     */
    public ChangeSeats changeSeats(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.Seats content) throws java.io.IOException {
      ChangeSeats result = new ChangeSeats(customerId, subscriptionId, content);
      initialize(result);
      return result;
    }

    public class ChangeSeats extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        the retrieve all reseller subscriptions method.
       ...
       * @since 1.13
       */
      protected ChangeSeats(java.lang.String customerId, java.lang.String subscriptionId, com.google.reseller.model.Seats content) {
        super(Reseller.this, "POST", REST_PATH, content, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
        this.subscriptionId = com.google.api.client.util.Preconditions.checkNotNull(subscriptionId, "Required parameter subscriptionId must be specified.");
      }
    ...
    public class Get extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        the retrieve all reseller subscriptions method.
      ...
      protected Get(java.lang.String customerId, java.lang.String subscriptionId) {
        super(Reseller.this, "GET", REST_PATH, null, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
        this.subscriptionId = com.google.api.client.util.Preconditions.checkNotNull(subscriptionId, "Required parameter subscriptionId must be specified.");
      }
     ...
     *        name, we do not recommend using a customerId as a key for persistent data. If the domain
     *        name for a customerId is changed, the Google system automatically updates.
     * @param content the {@link com.google.reseller.model.Subscription}
     * @return the request
     */
    public Insert insert(java.lang.String customerId, com.google.reseller.model.Subscription content) throws java.io.IOException {
      Insert result = new Insert(customerId, content);
      initialize(result);
      return result;
    }

    public class Insert extends ResellerRequest<com.google.reseller.model.Subscription> {
     ...
     *        name for a customerId is changed, the Google system automatically updates.
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String customerId, com.google.reseller.model.Subscription content) {
        super(Reseller.this, "POST", REST_PATH, content, com.google.reseller.model.Subscription.class);
        this.customerId = com.google.api.client.util.Preconditions.checkNotNull(customerId, "Required parameter customerId must be specified.");
      }
    ...
    public class List extends ResellerRequest<com.google.reseller.model.Subscriptions> {
       ...
       */
      protected List() {
        super(Reseller.this, "GET", REST_PATH, null, com.google.reseller.model.Subscriptions.class);
      }
    ...
    public class StartPaidService extends ResellerRequest<com.google.reseller.model.Subscription> {
    ...
    public class Suspend extends ResellerRequest<com.google.reseller.model.Subscription> {
