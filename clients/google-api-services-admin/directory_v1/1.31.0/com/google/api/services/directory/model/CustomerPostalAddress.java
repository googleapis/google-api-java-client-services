...
public final class CustomerPostalAddress extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The postal code. A postalCode example is a postal zip code such as `10009`. This is in
   * accordance with - http: //portablecontacts.net/draft-spec.html#address_element.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
