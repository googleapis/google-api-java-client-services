...
public final class GoogleCloudPolicytroubleshooterIamV3ConditionExplanation extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudPolicytroubleshooterIamV3ConditionExplanationEvaluationState> evaluationStates;
   ...
   */
  public GoogleCloudPolicytroubleshooterIamV3ConditionExplanation setErrors(java.util.List<GoogleRpcStatus> errors) {
    this.errors = errors;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudPolicytroubleshooterIamV3ConditionExplanationEvaluationState> getEvaluationStates() {
   ...
   */
  public GoogleCloudPolicytroubleshooterIamV3ConditionExplanation setEvaluationStates(java.util.List<GoogleCloudPolicytroubleshooterIamV3ConditionExplanationEvaluationState> evaluationStates) {
