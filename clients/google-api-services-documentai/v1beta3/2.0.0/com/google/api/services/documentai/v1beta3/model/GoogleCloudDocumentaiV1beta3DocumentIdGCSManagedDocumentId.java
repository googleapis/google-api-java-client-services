...
public final class GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId setGcsUri(java.lang.String gcsUri) {
    this.gcsUri = gcsUri;
    return this;
  }

  @Override
  public GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId clone() {
    return (GoogleCloudDocumentaiV1beta3DocumentIdGCSManagedDocumentId) super.clone();
  }
