...
public final class NetworkAttachmentAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, NetworkAttachmentsScopedList> items;
   ...
   */
  public NetworkAttachmentAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NetworkAttachmentsScopedList> getItems() {
    return items;
  }
   ...
   */
  public NetworkAttachmentAggregatedList setItems(java.util.Map<String, NetworkAttachmentsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkAttachmentAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkAttachmentAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkAttachmentAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkAttachmentAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkAttachmentAggregatedList set(String fieldName, Object value) {
    return (NetworkAttachmentAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NetworkAttachmentAggregatedList clone() {
    return (NetworkAttachmentAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkAttachmentAggregatedListWarningData.
     */
