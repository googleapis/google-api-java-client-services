...
/**
 * Model definition for ListVmExtensionsResponse.
 *
...
public final class ListVmExtensionsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<VmExtension> items;
   ...
   */
  public ListVmExtensionsResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ListVmExtensionsResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<VmExtension> getItems() {
    return items;
  }
   ...
   */
  public ListVmExtensionsResponse setItems(java.util.List<VmExtension> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ListVmExtensionsResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ListVmExtensionsResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ListVmExtensionsResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ListVmExtensionsResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public ListVmExtensionsResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ListVmExtensionsResponse set(String fieldName, Object value) {
    return (ListVmExtensionsResponse) super.set(fieldName, value);
  }

  @Override
  public ListVmExtensionsResponse clone() {
    return (ListVmExtensionsResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ListVmExtensionsResponseWarningData.
     */
