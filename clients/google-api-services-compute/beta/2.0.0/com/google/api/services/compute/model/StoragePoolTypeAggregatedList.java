...
/**
 * Model definition for StoragePoolTypeAggregatedList.
 *
...
public final class StoragePoolTypeAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public StoragePoolTypeAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, StoragePoolTypesScopedList> getItems() {
    return items;
  }
   ...
   */
  public StoragePoolTypeAggregatedList setItems(java.util.Map<String, StoragePoolTypesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public StoragePoolTypeAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public StoragePoolTypeAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolTypeAggregatedList set(String fieldName, Object value) {
    return (StoragePoolTypeAggregatedList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolTypeAggregatedList clone() {
    return (StoragePoolTypeAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolTypeAggregatedListWarningData.
     */
