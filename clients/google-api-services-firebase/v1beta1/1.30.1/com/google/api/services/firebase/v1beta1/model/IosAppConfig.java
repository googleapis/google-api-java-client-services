...
public final class IosAppConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public IosAppConfig setConfigFileContents(java.lang.String configFileContents) {
   ...
   * @since 1.14
   */
  public IosAppConfig encodeConfigFileContents(byte[] configFileContents) {
  ...
  @Override
  public IosAppConfig set(String fieldName, Object value) {
    return (IosAppConfig) super.set(fieldName, value);
  }

  @Override
  public IosAppConfig clone() {
