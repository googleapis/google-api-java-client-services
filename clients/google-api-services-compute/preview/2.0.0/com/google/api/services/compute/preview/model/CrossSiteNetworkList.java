...
public final class CrossSiteNetworkList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<CrossSiteNetwork> items;

  static {
    // hack to force ProGuard to consider CrossSiteNetwork used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(CrossSiteNetwork.class);
  }
   ...
   */
  public CrossSiteNetworkList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public CrossSiteNetworkList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<CrossSiteNetwork> getItems() {
    return items;
  }
   ...
   */
  public CrossSiteNetworkList setItems(java.util.List<CrossSiteNetwork> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public CrossSiteNetworkList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public CrossSiteNetworkList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public CrossSiteNetworkList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public CrossSiteNetworkList set(String fieldName, Object value) {
    return (CrossSiteNetworkList) super.set(fieldName, value);
  }

  @Override
  public CrossSiteNetworkList clone() {
    return (CrossSiteNetworkList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for CrossSiteNetworkListWarningData.
     */
