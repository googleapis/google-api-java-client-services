...
public final class GoogleCloudDataplexV1Environment extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDataplexV1Environment setEndpoints(GoogleCloudDataplexV1EnvironmentEndpoints endpoints) {
   ...
   */
  public GoogleCloudDataplexV1Environment setInfrastructureSpec(GoogleCloudDataplexV1EnvironmentInfrastructureSpec infrastructureSpec) {
   ...
   */
  public GoogleCloudDataplexV1Environment setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public GoogleCloudDataplexV1Environment setSessionSpec(GoogleCloudDataplexV1EnvironmentSessionSpec sessionSpec) {
   ...
   */
  public GoogleCloudDataplexV1Environment setSessionStatus(GoogleCloudDataplexV1EnvironmentSessionStatus sessionStatus) {
