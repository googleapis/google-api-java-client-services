 ...
 *
 * An Interconnect resource is a dedicated connection between the Google Cloud network and your on-
 * premises network. For more information, read the Dedicated Interconnect Overview.
 *
...
public final class Interconnect extends com.google.api.client.json.GenericJson {
   ...
   * of the following values:        - IF_MACSEC: If present, then the Interconnect connection is
   * provisioned on MACsec capable hardware ports. If not present, then the    Interconnect
   * connection is provisioned on non-MACsec capable ports. Any    attempt to enable MACsec will
   * fail.    - IF_CROSS_SITE_NETWORK: If present, then the Interconnect connection is
   * provisioned exclusively for Cross-Site Networking. Any attempt to configure    VLAN attachments
   * will fail. If not present, then the Interconnect    connection is not provisioned for Cross-
   * Site Networking. Any attempt to use    it for Cross-Site Networking will fail.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * internal maintenance. No attachments may be provisioned or updated on this Interconnect.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. This parameter can be provided only with Interconnect INSERT. It isn't valid for
   * Interconnect PATCH. List of features requested for this Interconnect connection, which can take
   * one of the following values:        - IF_MACSEC: If specified, then the connection is created
   * on MACsec    capable hardware ports. If not specified, non-MACsec capable ports will    also be
