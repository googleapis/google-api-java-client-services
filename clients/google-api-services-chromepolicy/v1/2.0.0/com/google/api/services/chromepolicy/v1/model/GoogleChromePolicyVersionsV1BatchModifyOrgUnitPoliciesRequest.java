...
public final class GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest> requests;
   ...
   */
  public java.util.List<GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest> getRequests() {
    return requests;
  }
   ...
   */
  public GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest setRequests(java.util.List<GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest> requests) {
    this.requests = requests;
    return this;
  }

  @Override
  public GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest set(String fieldName, Object value) {
    return (GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest clone() {
    return (GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest) super.clone();
  }
