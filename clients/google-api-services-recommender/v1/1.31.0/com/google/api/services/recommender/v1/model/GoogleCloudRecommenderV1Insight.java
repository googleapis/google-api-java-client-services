...
public final class GoogleCloudRecommenderV1Insight extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudRecommenderV1InsightRecommendationReference> associatedRecommendations;
   ...
   */
  public java.util.List<GoogleCloudRecommenderV1InsightRecommendationReference> getAssociatedRecommendations() {
   ...
   */
  public GoogleCloudRecommenderV1Insight setAssociatedRecommendations(java.util.List<GoogleCloudRecommenderV1InsightRecommendationReference> associatedRecommendations) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setCategory(java.lang.String category) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setContent(java.util.Map<String, java.lang.Object> content) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public GoogleCloudRecommenderV1Insight setInsightSubtype(java.lang.String insightSubtype) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setLastRefreshTime(String lastRefreshTime) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setStateInfo(GoogleCloudRecommenderV1InsightStateInfo stateInfo) {
   ...
   */
  public GoogleCloudRecommenderV1Insight setTargetResources(java.util.List<java.lang.String> targetResources) {
    this.targetResources = targetResources;
    return this;
  }

  @Override
  public GoogleCloudRecommenderV1Insight set(String fieldName, Object value) {
    return (GoogleCloudRecommenderV1Insight) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRecommenderV1Insight clone() {
    return (GoogleCloudRecommenderV1Insight) super.clone();
  }
