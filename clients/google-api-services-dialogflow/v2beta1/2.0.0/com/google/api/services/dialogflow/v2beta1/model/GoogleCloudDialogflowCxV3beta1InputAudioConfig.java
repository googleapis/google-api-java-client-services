...
public final class GoogleCloudDialogflowCxV3beta1InputAudioConfig extends com.google.api.client.json.GenericJson {
   ...
   * more details. If you specify a model, the following models typically have the best performance:
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setAudioEncoding(java.lang.String audioEncoding) {
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setBargeInConfig(GoogleCloudDialogflowCxV3beta1BargeInConfig bargeInConfig) {
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setEnableWordInfo(java.lang.Boolean enableWordInfo) {
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setModel(java.lang.String model) {
    this.model = model;
    return this;
  }
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setSampleRateHertz(java.lang.Integer sampleRateHertz) {
   ...
   */
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig setSingleUtterance(java.lang.Boolean singleUtterance) {
    this.singleUtterance = singleUtterance;
    return this;
  }

  @Override
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig set(String fieldName, Object value) {
    return (GoogleCloudDialogflowCxV3beta1InputAudioConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig clone() {
    return (GoogleCloudDialogflowCxV3beta1InputAudioConfig) super.clone();
  }
