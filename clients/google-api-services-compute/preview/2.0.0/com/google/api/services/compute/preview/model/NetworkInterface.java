...
public final class NetworkInterface extends com.google.api.client.json.GenericJson {
   ...
   * ONE_TO_ONE_NAT, is supported. If there are noaccessConfigs specified, then this instance will
   ...
   * fingerprint is not provided, or412 Precondition Failed if the fingerprint is out of date.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * the network interface uses the nicN naming format. Where N is a value between 0 and7. The
  ...
  /**
   * The URL of the Subnetwork resource for this instance. If the network resource is inlegacy mode,
   * do not specify this field. If the network is in auto subnet mode, specifying the subnetwork is
   * optional. If the network is in custom subnet mode, specifying the subnetwork is required. If
   * you specify this field, you can specify the subnetwork as a full or partial URL. For example,
