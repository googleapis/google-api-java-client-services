...
/**
 * Common Vulnerability Scoring System. This message is compatible with CVSS v2, v3, and v4. For
 * CVSS v2 details, see https://www.first.org/cvss/v2/guide CVSS v2 calculator:
 * https://nvd.nist.gov/vuln-metrics/cvss/v2-calculator For CVSS v3 details, see
 * https://www.first.org/cvss/specification-document CVSS v3 calculator: https://nvd.nist.gov/vuln-
 * metrics/cvss/v3-calculator For CVSS v4 details, see https://www.first.org/cvss/v4.0/user-guide
