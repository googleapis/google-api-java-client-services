...
package com.google.api.services.ftp.v1;
 ...
 *
 * <p>
 * This service uses {@link CloudFTPRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class CloudFTP extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "2.0.0 of the Cloud FTP API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://ftp.googleapis.com/";
   ...
   * @since 1.31
   */
  public static final String DEFAULT_MTLS_ROOT_URL = "https://ftp.mtls.googleapis.com/";
   ...
   * @since 1.7
   */
  public CloudFTP(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Location> {
         ...
         * Create a request for the method "locations.get".
         *
         * This request holds the parameters needed by the the ftp server.  After setting any optional
        ...
        protected Get(java.lang.String name) {
          super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.Location.class);
      ...
      public class List extends CloudFTPRequest<com.google.api.services.ftp.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Cancel extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.ftp.v1.model.CancelOperationRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(CloudFTP.this, "DELETE", REST_PATH, null, com.google.api.services.ftp.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFTPRequest<com.google.api.services.ftp.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Servers {
        ...
        public class Create extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {

          private static final String REST_PATH = "v1/{+parent}/servers";
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.ftp.v1.model.Server content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
         ...
         *
         * Create a request for the method "servers.delete".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
         *
        ...
        public class Delete extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {

          private static final String REST_PATH = "v1/{+name}";

          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/servers/[^/]+$");
           ...
           */
          protected Delete(java.lang.String name) {
            super(CloudFTP.this, "DELETE", REST_PATH, null, com.google.api.services.ftp.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * Create a request for the method "servers.get".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         * parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
        ...
        public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Server> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.Server.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * Create a request for the method "servers.list".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         * parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
        ...
        public class List extends CloudFTPRequest<com.google.api.services.ftp.v1.model.ListServersResponse> {
          ...
          protected List(java.lang.String parent) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.ListServersResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *
         * Create a request for the method "servers.patch".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.ftp.v1.model.Server content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.ftp.v1.model.Server content) {
            super(CloudFTP.this, "PATCH", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
          ...
          /**
           * Optional. Field mask is used to specify the fields to be overwritten in the Server
          ...
          /** Optional. Field mask is used to specify the fields to be overwritten in the Server resource by the
         ...
         *
         * Create a request for the method "servers.start".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         * parameters, call the {@link Start#execute()} method to invoke the remote operation.
         *
         * @param name Required. Name of the resource Format: `projects/{project}/locations/{location}/servers/{server}`
         * @param content the {@link com.google.api.services.ftp.v1.model.StartServerRequest}
         * @return the request
         */
        public Start start(java.lang.String name, com.google.api.services.ftp.v1.model.StartServerRequest content) throws java.io.IOException {
          Start result = new Start(name, content);
          initialize(result);
          return result;
        }

        public class Start extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Start(java.lang.String name, com.google.api.services.ftp.v1.model.StartServerRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * Create a request for the method "servers.stop".
         *
         * This request holds the parameters needed by the ftp server.  After setting any optional
         * parameters, call the {@link Stop#execute()} method to invoke the remote operation.
         *
         * @param name Required. Name of the resource. Format: `projects/{project}/locations/{location}/servers/{server}`
         * @param content the {@link com.google.api.services.ftp.v1.model.StopServerRequest}
         * @return the request
         */
        public Stop stop(java.lang.String name, com.google.api.services.ftp.v1.model.StopServerRequest content) throws java.io.IOException {
          Stop result = new Stop(name, content);
          initialize(result);
          return result;
        }

        public class Stop extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Stop(java.lang.String name, com.google.api.services.ftp.v1.model.StopServerRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Users {
          ...
          public class Create extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.ftp.v1.model.User content) {
              super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Delete extends CloudFTPRequest<com.google.api.services.ftp.v1.model.Operation> {
            ...
            private final java.util.regex.Pattern NAME_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/servers/[^/]+/users/[^/]+$");
          ...
          public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1.model.User> {
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.User.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudFTPRequest<com.google.api.services.ftp.v1.model.ListUsersResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1.model.ListUsersResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
             ...
             * maximum value is 1000; The default value is 50 if the field is omitted (or set to 0).
             */
            @com.google.api.client.util.Key
            private java.lang.Integer pageSize;

            /** Optional. Requested page size. User may return fewer items than requested. The maximum value is
           1000; The default value is 50 if the field is omitted (or set to 0).
             */
            public java.lang.Integer getPageSize() {
              return pageSize;
            }
           ...
           * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
           *
           * @param name Identifier. User-friendly name via which User will be identified.
           *        projects/{project}/locations/{location}/servers/{server}/users/{user}
           * @param content the {@link com.google.api.services.ftp.v1.model.User}
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.ftp.v1.model.User content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        projects/{project}/locations/{location}/servers/{server}/users/{user}
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.ftp.v1.model.User content) {
              super(CloudFTP.this, "PATCH", REST_PATH, content, com.google.api.services.ftp.v1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link CloudFTP}. */
    @Override
    public CloudFTP build() {
      return new CloudFTP(this);
    }
    ...
    /**
     * Set the {@link CloudFTPRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setCloudFTPRequestInitializer(
        CloudFTPRequestInitializer cloudftpRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(cloudftpRequestInitializer);
    }
