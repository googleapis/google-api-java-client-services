...
public final class GeminiClusterConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GeminiClusterConfig set(String fieldName, Object value) {
    return (GeminiClusterConfig) super.set(fieldName, value);
  }

  @Override
  public GeminiClusterConfig clone() {
    return (GeminiClusterConfig) super.clone();
  }
