...
public final class GoogleChromePolicyVersionsV1PolicySchemaFieldDescription extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleChromePolicyVersionsV1PolicySchemaFieldKnownValueDescription> knownValueDescriptions;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleChromePolicyVersionsV1PolicySchemaFieldDescription> nestedFieldDescriptions;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleChromePolicyVersionsV1PolicySchemaRequiredItems> requiredItems;
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setDefaultValue(java.lang.Object defaultValue) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setDescription(java.lang.String description) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setFieldDependencies(java.util.List<GoogleChromePolicyVersionsV1PolicySchemaFieldDependencies> fieldDependencies) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setFieldDescription(java.lang.String fieldDescription) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setInputConstraint(java.lang.String inputConstraint) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleChromePolicyVersionsV1PolicySchemaFieldKnownValueDescription> getKnownValueDescriptions() {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setKnownValueDescriptions(java.util.List<GoogleChromePolicyVersionsV1PolicySchemaFieldKnownValueDescription> knownValueDescriptions) {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleChromePolicyVersionsV1PolicySchemaRequiredItems> getRequiredItems() {
   ...
   */
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription setRequiredItems(java.util.List<GoogleChromePolicyVersionsV1PolicySchemaRequiredItems> requiredItems) {
    this.requiredItems = requiredItems;
    return this;
  }

  @Override
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription set(String fieldName, Object value) {
    return (GoogleChromePolicyVersionsV1PolicySchemaFieldDescription) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyVersionsV1PolicySchemaFieldDescription clone() {
