...
public final class GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The timestamp that corresponds to the version of the database that is being read to get the
   * list of documents to delete. This time can also be used as the timestamp of PITR in case of
   * disaster recovery (subject to PITR window limit).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setEndTime(String endTime) {
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setOperationState(java.lang.String operationState) {
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setProgressBytes(GoogleFirestoreAdminV1Progress progressBytes) {
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setProgressDocuments(GoogleFirestoreAdminV1Progress progressDocuments) {
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setSnapshotTime(String snapshotTime) {
   ...
   */
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata setStartTime(String startTime) {
    this.startTime = startTime;
    return this;
  }

  @Override
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata set(String fieldName, Object value) {
    return (GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata clone() {
    return (GoogleFirestoreAdminV1BulkDeleteDocumentsMetadata) super.clone();
  }
