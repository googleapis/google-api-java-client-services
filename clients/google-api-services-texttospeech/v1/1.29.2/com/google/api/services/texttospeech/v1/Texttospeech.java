...
package com.google.api.services.texttospeech.v1;
...
public class Texttospeech extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.29.2 of the Cloud Text-to-Speech API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Text {
     ...
     *
     * @param content the {@link com.google.api.services.texttospeech.v1.model.SynthesizeSpeechRequest}
     * @return the request
     */
    public Synthesize synthesize(com.google.api.services.texttospeech.v1.model.SynthesizeSpeechRequest content) throws java.io.IOException {
      Synthesize result = new Synthesize(content);
      initialize(result);
      return result;
    }

    public class Synthesize extends TexttospeechRequest<com.google.api.services.texttospeech.v1.model.SynthesizeSpeechResponse> {

      private static final String REST_PATH = "v1/text:synthesize";
       ...
       * @since 1.13
       */
      protected Synthesize(com.google.api.services.texttospeech.v1.model.SynthesizeSpeechRequest content) {
        super(Texttospeech.this, "POST", REST_PATH, content, com.google.api.services.texttospeech.v1.model.SynthesizeSpeechResponse.class);
      }
  ...
  public class Voices {
    ...
    public class List extends TexttospeechRequest<com.google.api.services.texttospeech.v1.model.ListVoicesResponse> {

      private static final String REST_PATH = "v1/voices";
       ...
       */
      protected List() {
        super(Texttospeech.this, "GET", REST_PATH, null, com.google.api.services.texttospeech.v1.model.ListVoicesResponse.class);
      }
      ...
      /**
       * Optional (but recommended) [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt) language
       * tag. If specified, the ListVoices call will only return voices that can be used to
       * synthesize this language_code. E.g. when specifying "en-NZ", you will get supported "en-*"
       * voices; when specifying "no", you will get supported "no-*" (Norwegian) and "nb-*"
       * (Norwegian Bokmal) voices; specifying "zh" will also get supported "cmn-*" voices;
       * specifying "zh-hk" will also get supported "yue-*" voices.
       */
      @com.google.api.client.util.Key
      private java.lang.String languageCode;

      /** Optional (but recommended) [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt) language tag. If
