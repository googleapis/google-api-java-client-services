...
package com.google.api.services.websecurityscanner.v1beta;

/**
 * Service definition for WebSecurityScanner (v1beta).
 *
 * <p>
...
public class WebSecurityScanner extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class ScanConfigs {
       ...
       * @param content the {@link com.google.api.services.websecurityscanner.v1beta.model.ScanConfig}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanConfig> {

        private static final String REST_PATH = "v1beta/{+parent}/scanConfigs";
       ...
       *        name in the format 'projects/{projectId}'.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig content) {
          super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig.class);
      ...
      public class Delete extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.Empty> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
        ...
        protected Delete(java.lang.String name) {
          super(WebSecurityScanner.this, "DELETE", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.Empty.class);
      ...
      public class Get extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanConfig> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
        ...
        protected Get(java.lang.String name) {
          super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ListScanConfigsResponse> {
       ...
       *        'projects/{projectId}'.
        ...
        protected List(java.lang.String parent) {
          super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ListScanConfigsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanConfig> {
       ...
       *        system.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig content) {
          super(WebSecurityScanner.this, "PATCH", REST_PATH, content, com.google.api.services.websecurityscanner.v1beta.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
       * @param content the {@link com.google.api.services.websecurityscanner.v1beta.model.StartScanRunRequest}
       * @return the request
       */
      public Start start(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.StartScanRunRequest content) throws java.io.IOException {
        Start result = new Start(name, content);
        initialize(result);
        return result;
      }

      public class Start extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanRun> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
         ...
         * @since 1.13
         */
        protected Start(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.StartScanRunRequest content) {
          super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.api.services.websecurityscanner.v1beta.model.ScanRun.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class ScanRuns {
        ...
        public class Get extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanRun> {
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
           ...
           */
          protected Get(java.lang.String name) {
            super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ScanRun.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ListScanRunsResponse> {

          private static final String REST_PATH = "v1beta/{+parent}/scanRuns";
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
           ...
           */
          protected List(java.lang.String parent) {
            super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ListScanRunsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
         * @param content the {@link com.google.api.services.websecurityscanner.v1beta.model.StopScanRunRequest}
         * @return the request
         */
        public Stop stop(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.StopScanRunRequest content) throws java.io.IOException {
          Stop result = new Stop(name, content);
          initialize(result);
          return result;
        }

        public class Stop extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ScanRun> {
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
           ...
           * @since 1.13
           */
          protected Stop(java.lang.String name, com.google.api.services.websecurityscanner.v1beta.model.StopScanRunRequest content) {
            super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.api.services.websecurityscanner.v1beta.model.ScanRun.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class CrawledUrls {
          ...
          public class List extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ListCrawledUrlsResponse> {

            private static final String REST_PATH = "v1beta/{+parent}/crawledUrls";
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ListCrawledUrlsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
        ...
        public class FindingTypeStats {
          ...
          public class List extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ListFindingTypeStatsResponse> {

            private static final String REST_PATH = "v1beta/{+parent}/findingTypeStats";
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ListFindingTypeStatsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
        ...
        public class Findings {
          ...
          public class Get extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.Finding> {
           ...
           *        '.
             ...
             */
            protected Get(java.lang.String name) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.Finding.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends WebSecurityScannerRequest<com.google.api.services.websecurityscanner.v1beta.model.ListFindingsResponse> {
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.api.services.websecurityscanner.v1beta.model.ListFindingsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
