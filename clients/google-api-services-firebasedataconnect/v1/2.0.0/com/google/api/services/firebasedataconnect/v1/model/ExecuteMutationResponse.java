...
public final class ExecuteMutationResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public ExecuteMutationResponse setData(java.util.Map<String, java.lang.Object> data) {
    this.data = data;
    return this;
  }
  ...
  @Override
  public ExecuteMutationResponse clone() {
    return (ExecuteMutationResponse) super.clone();
  }
