...
/**
 * A ParagraphElement representing a column break. A column break makes the subsequent text start at
...
public final class ColumnBreak extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The suggested insertion IDs. A ColumnBreak may have multiple insertion IDs if it is a nested
   ...
   */
  public ColumnBreak setSuggestedDeletionIds(java.util.List<java.lang.String> suggestedDeletionIds) {
   ...
   */
  public ColumnBreak setSuggestedInsertionIds(java.util.List<java.lang.String> suggestedInsertionIds) {
   ...
   */
  public ColumnBreak setSuggestedTextStyleChanges(java.util.Map<String, SuggestedTextStyle> suggestedTextStyleChanges) {
  ...
  @Override
  public ColumnBreak set(String fieldName, Object value) {
    return (ColumnBreak) super.set(fieldName, value);
  }

  @Override
  public ColumnBreak clone() {
    return (ColumnBreak) super.clone();
  }
