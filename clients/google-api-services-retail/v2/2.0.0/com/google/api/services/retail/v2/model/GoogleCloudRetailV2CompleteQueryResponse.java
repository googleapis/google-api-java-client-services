...
public final class GoogleCloudRetailV2CompleteQueryResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2CompleteQueryResponseCompletionResult> completionResults;
   ...
   */
  public GoogleCloudRetailV2CompleteQueryResponse setAttributionToken(java.lang.String attributionToken) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2CompleteQueryResponseCompletionResult> getCompletionResults() {
   ...
   */
  public GoogleCloudRetailV2CompleteQueryResponse setCompletionResults(java.util.List<GoogleCloudRetailV2CompleteQueryResponseCompletionResult> completionResults) {
  ...
  @Override
  public GoogleCloudRetailV2CompleteQueryResponse set(String fieldName, Object value) {
    return (GoogleCloudRetailV2CompleteQueryResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2CompleteQueryResponse clone() {
    return (GoogleCloudRetailV2CompleteQueryResponse) super.clone();
  }
