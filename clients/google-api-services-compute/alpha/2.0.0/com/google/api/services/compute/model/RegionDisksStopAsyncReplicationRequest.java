...
/**
 * Model definition for RegionDisksStopAsyncReplicationRequest.
 *
...
public final class RegionDisksStopAsyncReplicationRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public RegionDisksStopAsyncReplicationRequest setAsyncSecondaryDisk(java.lang.String asyncSecondaryDisk) {
    this.asyncSecondaryDisk = asyncSecondaryDisk;
    return this;
  }

  @Override
  public RegionDisksStopAsyncReplicationRequest set(String fieldName, Object value) {
    return (RegionDisksStopAsyncReplicationRequest) super.set(fieldName, value);
  }

  @Override
  public RegionDisksStopAsyncReplicationRequest clone() {
    return (RegionDisksStopAsyncReplicationRequest) super.clone();
  }
