...
public class Monitoring extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.27.0 of the Stackdriver Monitoring API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Operations {
     ...
     * @param content the {@link com.google.api.services.monitoring.v1.model.CancelOperationRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.api.services.monitoring.v1.model.CancelOperationRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends MonitoringRequest<com.google.api.services.monitoring.v1.model.Empty> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.api.services.monitoring.v1.model.CancelOperationRequest content) {
        super(Monitoring.this, "POST", REST_PATH, content, com.google.api.services.monitoring.v1.model.Empty.class);
    ...
    public class List extends MonitoringRequest<com.google.api.services.monitoring.v1.model.ListOperationsResponse> {
      ...
      protected List(java.lang.String name) {
        super(Monitoring.this, "GET", REST_PATH, null, com.google.api.services.monitoring.v1.model.ListOperationsResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
