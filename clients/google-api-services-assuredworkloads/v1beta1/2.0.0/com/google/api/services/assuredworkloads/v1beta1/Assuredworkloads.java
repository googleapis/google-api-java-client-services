...
public class Assuredworkloads extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class AssuredworkloadsOperations {
     ...
     * operation.
     *
     * @param content the {@link com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest}
     * @return the request
     */
    public ArchiveResourceEvents archiveResourceEvents(com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest content) throws java.io.IOException {
      ArchiveResourceEvents result = new ArchiveResourceEvents(content);
      initialize(result);
      return result;
    }

    public class ArchiveResourceEvents extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse> {

      private static final String REST_PATH = "v1beta1/assuredworkloads:archiveResourceEvents";
       ...
       * @since 1.13
       */
      protected ArchiveResourceEvents(com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest content) {
        super(Assuredworkloads.this, "POST", REST_PATH, content, com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse.class);
      }
     ...
     * remote operation.
     *
     * @param content the {@link com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest}
     * @return the request
     */
    public RevertArchivedResourceEvents revertArchivedResourceEvents(com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest content) throws java.io.IOException {
      RevertArchivedResourceEvents result = new RevertArchivedResourceEvents(content);
      initialize(result);
      return result;
    }

    public class RevertArchivedResourceEvents extends AssuredworkloadsRequest<com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse> {

      private static final String REST_PATH = "v1beta1/assuredworkloads:revertArchivedResourceEvents";
       ...
       * @since 1.13
       */
      protected RevertArchivedResourceEvents(com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest content) {
        super(Assuredworkloads.this, "POST", REST_PATH, content, com.google.api.services.assuredworkloads.v1beta1.model.GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse.class);
      }
