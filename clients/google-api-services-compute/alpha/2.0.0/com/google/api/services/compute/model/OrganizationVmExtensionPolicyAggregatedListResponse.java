...
/**
 * Model definition for OrganizationVmExtensionPolicyAggregatedListResponse.
 *
...
public final class OrganizationVmExtensionPolicyAggregatedListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, VmExtensionPoliciesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource.
   * Alwayscompute#OrganizationVmExtensionPolicyAggregatedList for lists of VmExtensionPolicies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, VmExtensionPoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setItems(java.util.Map<String, VmExtensionPoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public OrganizationVmExtensionPolicyAggregatedListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public OrganizationVmExtensionPolicyAggregatedListResponse set(String fieldName, Object value) {
    return (OrganizationVmExtensionPolicyAggregatedListResponse) super.set(fieldName, value);
  }

  @Override
  public OrganizationVmExtensionPolicyAggregatedListResponse clone() {
    return (OrganizationVmExtensionPolicyAggregatedListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for OrganizationVmExtensionPolicyAggregatedListResponseWarningData.
     */
