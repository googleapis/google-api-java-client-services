...
public final class SasPortalOperation extends com.google.api.client.json.GenericJson {
   ...
   */
  public SasPortalOperation setDone(java.lang.Boolean done) {
    this.done = done;
    return this;
  }
   ...
   */
  public SasPortalOperation setError(SasPortalStatus error) {
    this.error = error;
    return this;
  }
   ...
   */
  public SasPortalOperation setMetadata(java.util.Map<String, java.lang.Object> metadata) {
   ...
   */
  public SasPortalOperation setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public SasPortalOperation setResponse(java.util.Map<String, java.lang.Object> response) {
    this.response = response;
    return this;
  }

  @Override
  public SasPortalOperation set(String fieldName, Object value) {
    return (SasPortalOperation) super.set(fieldName, value);
  }

  @Override
  public SasPortalOperation clone() {
    return (SasPortalOperation) super.clone();
  }
