...
/**
 * CloudFTP request initializer for setting properties like key and userIp.
 *
 * <p>
 ...
 * @since 1.12
 */
public class CloudFTPRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {

  public CloudFTPRequestInitializer() {
    super();
  }
   ...
   */
  public CloudFTPRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public CloudFTPRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeCloudFTPRequest((CloudFTPRequest<?>) request);
  }

  /**
   * Initializes CloudFTP request.
   *
   * <p>
   ...
   */
  protected void initializeCloudFTPRequest(CloudFTPRequest<?> request) throws java.io.IOException {
  }
}
