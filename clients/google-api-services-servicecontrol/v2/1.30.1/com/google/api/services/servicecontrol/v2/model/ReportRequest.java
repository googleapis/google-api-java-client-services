...
public final class ReportRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Describes the list of operations to be reported. Each operation is represented as an
   * AttributeContext, and contains all attributes around an API access.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.util.List<AttributeContext> operations;

  static {
    // hack to force ProGuard to consider AttributeContext used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(AttributeContext.class);
  }
   ...
   */
  public java.util.List<AttributeContext> getOperations() {
    return operations;
  }
   ...
   */
  public ReportRequest setOperations(java.util.List<AttributeContext> operations) {
