  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Instances {
         ...
         *
         * Create a request for the method "instances.getTags".
         *
         * This request holds the parameters needed by the memcache server.  After setting any optional
        ...
        public class GetTags extends CloudMemorystoreforMemcachedRequest<com.google.api.services.memcache.v1.model.GetTagsResponse> {
          ...
          protected GetTags(java.lang.String name) {
            super(CloudMemorystoreforMemcached.this, "GET", REST_PATH, null, com.google.api.services.memcache.v1.model.GetTagsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * @param name Required. The full resource name of the service resource.
         * @param content the {@link com.google.api.services.memcache.v1.model.SetTagsRequest}
         * @return the request
         */
        public SetTags setTags(java.lang.String name, com.google.api.services.memcache.v1.model.SetTagsRequest content) throws java.io.IOException {
          SetTags result = new SetTags(name, content);
          initialize(result);
          return result;
        }

        public class SetTags extends CloudMemorystoreforMemcachedRequest<com.google.api.services.memcache.v1.model.SetTagsResponse> {
           ...
           * @since 1.13
           */
          protected SetTags(java.lang.String name, com.google.api.services.memcache.v1.model.SetTagsRequest content) {
            super(CloudMemorystoreforMemcached.this, "POST", REST_PATH, content, com.google.api.services.memcache.v1.model.SetTagsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
