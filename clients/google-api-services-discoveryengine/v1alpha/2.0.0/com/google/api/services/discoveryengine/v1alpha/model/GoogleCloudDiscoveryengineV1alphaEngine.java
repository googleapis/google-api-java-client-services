...
public final class GoogleCloudDiscoveryengineV1alphaEngine extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig knowledgeGraphConfig;
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setChatEngineConfig(GoogleCloudDiscoveryengineV1alphaEngineChatEngineConfig chatEngineConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setChatEngineMetadata(GoogleCloudDiscoveryengineV1alphaEngineChatEngineMetadata chatEngineMetadata) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setCmekConfig(GoogleCloudDiscoveryengineV1alphaCmekConfig cmekConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setCommonConfig(GoogleCloudDiscoveryengineV1alphaEngineCommonConfig commonConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setConnectorTenantInfo(java.util.Map<String, java.lang.String> connectorTenantInfo) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setCreateTime(String createTime) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setDisableAnalytics(java.lang.Boolean disableAnalytics) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig getKnowledgeGraphConfig() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setKnowledgeGraphConfig(GoogleCloudDiscoveryengineV1alphaEngineKnowledgeGraphConfig knowledgeGraphConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setMarketplaceAgentVisibility(java.lang.String marketplaceAgentVisibility) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setMediaRecommendationEngineConfig(GoogleCloudDiscoveryengineV1alphaEngineMediaRecommendationEngineConfig mediaRecommendationEngineConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setModelConfigs(java.util.Map<String, java.lang.String> modelConfigs) {
   ...
   * Output only. Additional information of a recommendation engine. Only applicable if
   * solution_type is SOLUTION_TYPE_RECOMMENDATION.
   * @param recommendationMetadata recommendationMetadata or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setRecommendationMetadata(GoogleCloudDiscoveryengineV1alphaEngineRecommendationMetadata recommendationMetadata) {
  ...
  /**
   * Additional config specs for a `similar-items` engine.
   * @param similarDocumentsConfig similarDocumentsConfig or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setSimilarDocumentsConfig(GoogleCloudDiscoveryengineV1alphaEngineSimilarDocumentsEngineConfig similarDocumentsConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setSolutionType(java.lang.String solutionType) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaEngine setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaEngine set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaEngine) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaEngine clone() {
