...
public final class ScheduleTransferRunsRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ScheduleTransferRunsRequest set(String fieldName, Object value) {
    return (ScheduleTransferRunsRequest) super.set(fieldName, value);
  }

  @Override
  public ScheduleTransferRunsRequest clone() {
    return (ScheduleTransferRunsRequest) super.clone();
  }
