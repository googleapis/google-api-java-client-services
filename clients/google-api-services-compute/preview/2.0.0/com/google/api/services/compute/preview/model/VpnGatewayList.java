...
public final class VpnGatewayList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<VpnGateway> items;

  static {
    // hack to force ProGuard to consider VpnGateway used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(VpnGateway.class);
  }
   ...
   */
  public VpnGatewayList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<VpnGateway> getItems() {
    return items;
  }
   ...
   */
  public VpnGatewayList setItems(java.util.List<VpnGateway> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public VpnGatewayList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public VpnGatewayList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public VpnGatewayList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public VpnGatewayList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VpnGatewayList set(String fieldName, Object value) {
    return (VpnGatewayList) super.set(fieldName, value);
  }

  @Override
  public VpnGatewayList clone() {
    return (VpnGatewayList) super.clone();
  }
