...
public final class HttpCallEvidence extends com.google.api.client.json.GenericJson {
   ...
   */
  public HttpCallEvidence setUrls(java.util.List<java.lang.String> urls) {
    this.urls = urls;
    return this;
  }

  @Override
  public HttpCallEvidence set(String fieldName, Object value) {
    return (HttpCallEvidence) super.set(fieldName, value);
  }

  @Override
  public HttpCallEvidence clone() {
    return (HttpCallEvidence) super.clone();
  }
