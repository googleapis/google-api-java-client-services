...
/**
 * Model definition for VmExtensionPoliciesScopedList.
 *
...
public final class VmExtensionPoliciesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<VmExtensionPolicy> vmExtensionPolicies;
   ...
   */
  public java.util.List<VmExtensionPolicy> getVmExtensionPolicies() {
    return vmExtensionPolicies;
  }

  /**
   * List of VmExtensionPolicy resources contained in this scope.
   * @param vmExtensionPolicies vmExtensionPolicies or {@code null} for none
   */
  public VmExtensionPoliciesScopedList setVmExtensionPolicies(java.util.List<VmExtensionPolicy> vmExtensionPolicies) {
    this.vmExtensionPolicies = vmExtensionPolicies;
    return this;
  }
   ...
   */
  public VmExtensionPoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VmExtensionPoliciesScopedList set(String fieldName, Object value) {
    return (VmExtensionPoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public VmExtensionPoliciesScopedList clone() {
    return (VmExtensionPoliciesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for VmExtensionPoliciesScopedListWarningData.
     */
