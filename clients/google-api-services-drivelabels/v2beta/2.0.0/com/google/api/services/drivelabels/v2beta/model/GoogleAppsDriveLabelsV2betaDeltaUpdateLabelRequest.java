...
public final class GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestRequest> requests;
   ...
   */
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest setLanguageCode(java.lang.String languageCode) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestRequest> getRequests() {
    return requests;
  }
   ...
   */
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest setRequests(java.util.List<GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestRequest> requests) {
   ...
   */
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest setView(java.lang.String view) {
    this.view = view;
    return this;
  }
   ...
   */
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest setWriteControl(GoogleAppsDriveLabelsV2betaWriteControl writeControl) {
    this.writeControl = writeControl;
    return this;
  }

  @Override
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest set(String fieldName, Object value) {
    return (GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest clone() {
    return (GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequest) super.clone();
  }
