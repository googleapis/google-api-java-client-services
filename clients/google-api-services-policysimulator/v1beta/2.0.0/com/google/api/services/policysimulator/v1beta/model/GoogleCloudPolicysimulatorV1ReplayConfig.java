...
public final class GoogleCloudPolicysimulatorV1ReplayConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudPolicysimulatorV1ReplayConfig setLogSource(java.lang.String logSource) {
   ...
   */
  public GoogleCloudPolicysimulatorV1ReplayConfig setPolicyOverlay(java.util.Map<String, GoogleIamV1Policy> policyOverlay) {
    this.policyOverlay = policyOverlay;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1ReplayConfig set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1ReplayConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1ReplayConfig clone() {
