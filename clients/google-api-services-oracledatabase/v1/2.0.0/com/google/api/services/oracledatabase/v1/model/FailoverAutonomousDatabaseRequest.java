...
public final class FailoverAutonomousDatabaseRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public FailoverAutonomousDatabaseRequest set(String fieldName, Object value) {
    return (FailoverAutonomousDatabaseRequest) super.set(fieldName, value);
  }

  @Override
  public FailoverAutonomousDatabaseRequest clone() {
    return (FailoverAutonomousDatabaseRequest) super.clone();
  }
