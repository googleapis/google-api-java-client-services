...
public final class CloudPubSubSourceSpec extends com.google.api.client.json.GenericJson {
   ...
   * omitted, defaults to same as the cluster. +optional
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Topic is the ID of the CloudPubSubSource Topic to Subscribe to. It must be in the form of the
   ...
   */
  public CloudPubSubSourceSpec setAckDeadline(java.lang.String ackDeadline) {
   ...
   */
  public CloudPubSubSourceSpec setCeOverrides(CloudEventOverrides ceOverrides) {
   ...
   */
  public CloudPubSubSourceSpec setProject(java.lang.String project) {
   ...
   */
  public CloudPubSubSourceSpec setPubsubSecret(SecretKeySelector pubsubSecret) {
   ...
   */
  public CloudPubSubSourceSpec setRetainAckedMessages(java.lang.Boolean retainAckedMessages) {
   ...
   */
  public CloudPubSubSourceSpec setRetentionDuration(java.lang.String retentionDuration) {
   ...
   */
  public CloudPubSubSourceSpec setSecret(SecretKeySelector secret) {
    this.secret = secret;
    return this;
  }
   ...
   */
  public CloudPubSubSourceSpec setSink(Destination sink) {
    this.sink = sink;
    return this;
  }
   ...
   */
  public CloudPubSubSourceSpec setTopic(java.lang.String topic) {
    this.topic = topic;
    return this;
  }

  @Override
  public CloudPubSubSourceSpec set(String fieldName, Object value) {
    return (CloudPubSubSourceSpec) super.set(fieldName, value);
  }

  @Override
  public CloudPubSubSourceSpec clone() {
    return (CloudPubSubSourceSpec) super.clone();
  }
