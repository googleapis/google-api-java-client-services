...
public class Classroom extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google Classroom API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Courses {
     ...
     *
     * @param content the {@link com.google.classroom.model.Course}
     * @return the request
     */
    public Create create(com.google.classroom.model.Course content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends ClassroomRequest<com.google.classroom.model.Course> {
       ...
       * @since 1.13
       */
      protected Create(com.google.classroom.model.Course content) {
        super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Course.class);
      }
    ...
    public class Delete extends ClassroomRequest<com.google.classroom.model.Empty> {
    ...
    alias.
      ...
      protected Delete(java.lang.String id) {
        super(Classroom.this, "DELETE", REST_PATH, null, com.google.classroom.model.Empty.class);
    ...
    public class Get extends ClassroomRequest<com.google.classroom.model.Course> {
    ...
    alias.
      ...
      protected Get(java.lang.String id) {
        super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Course.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class List extends ClassroomRequest<com.google.classroom.model.ListCoursesResponse> {
       ...
       */
      protected List() {
        super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListCoursesResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String id, com.google.classroom.model.Course content) throws java.io.IOException {
      Patch result = new Patch(id, content);
      initialize(result);
      return result;
    }

    public class Patch extends ClassroomRequest<com.google.classroom.model.Course> {
    ...
    alias.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String id, com.google.classroom.model.Course content) {
        super(Classroom.this, "PATCH", REST_PATH, content, com.google.classroom.model.Course.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String id, com.google.classroom.model.Course content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }

    public class Update extends ClassroomRequest<com.google.classroom.model.Course> {
    ...
    alias.
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, com.google.classroom.model.Course content) {
        super(Classroom.this, "PUT", REST_PATH, content, com.google.classroom.model.Course.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class Aliases {
       ...
       *        or an
      alias.
       * @param content the {@link com.google.classroom.model.CourseAlias}
       * @return the request
       */
      public Create create(java.lang.String courseId, com.google.classroom.model.CourseAlias content) throws java.io.IOException {
        Create result = new Create(courseId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.CourseAlias> {
      ...
      alias.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String courseId, com.google.classroom.model.CourseAlias content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.CourseAlias.class);
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListCourseAliasesResponse> {
       ...
       *        alias.
        ...
        protected List(java.lang.String courseId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListCourseAliasesResponse.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
    ...
    public class Announcements {
      ...
      This identifier can be either the Classroom-assigned identifier or an
       *        alias.
       * @param content the {@link com.google.classroom.model.Announcement}
       * @return the request
       */
      public Create create(java.lang.String courseId, com.google.classroom.model.Announcement content) throws java.io.IOException {
        Create result = new Create(courseId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.Announcement> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String courseId, com.google.classroom.model.Announcement content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Announcement.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.Announcement> {
       ...
       *        alias.
        ...
        protected Get(java.lang.String courseId, java.lang.String id) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Announcement.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListAnnouncementsResponse> {
       ...
       *        alias.
         ...
         */
        protected List(java.lang.String courseId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListAnnouncementsResponse.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
       ...
       *        alias.
       * @param id Identifier of the announcement.
       * @param content the {@link com.google.classroom.model.ModifyAnnouncementAssigneesRequest}
       * @return the request
       */
      public ModifyAssignees modifyAssignees(java.lang.String courseId, java.lang.String id, com.google.classroom.model.ModifyAnnouncementAssigneesRequest content) throws java.io.IOException {
        ModifyAssignees result = new ModifyAssignees(courseId, id, content);
        initialize(result);
        return result;
      }

      public class ModifyAssignees extends ClassroomRequest<com.google.classroom.model.Announcement> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected ModifyAssignees(java.lang.String courseId, java.lang.String id, com.google.classroom.model.ModifyAnnouncementAssigneesRequest content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Announcement.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
       ...
       * @return the request
       */
      public Patch patch(java.lang.String courseId, java.lang.String id, com.google.classroom.model.Announcement content) throws java.io.IOException {
        Patch result = new Patch(courseId, id, content);
        initialize(result);
        return result;
      }

      public class Patch extends ClassroomRequest<com.google.classroom.model.Announcement> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String courseId, java.lang.String id, com.google.classroom.model.Announcement content) {
          super(Classroom.this, "PATCH", REST_PATH, content, com.google.classroom.model.Announcement.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
    ...
    public class CourseWork {
      ...
      This identifier can be either the Classroom-assigned identifier or an
       *        alias.
       * @param content the {@link com.google.classroom.model.CourseWork}
       * @return the request
       */
      public Create create(java.lang.String courseId, com.google.classroom.model.CourseWork content) throws java.io.IOException {
        Create result = new Create(courseId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.CourseWork> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String courseId, com.google.classroom.model.CourseWork content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.CourseWork.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.CourseWork> {
       ...
       *        alias.
         ...
         */
        protected Get(java.lang.String courseId, java.lang.String id) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.CourseWork.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListCourseWorkResponse> {
       ...
       *        alias.
         ...
         */
        protected List(java.lang.String courseId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListCourseWorkResponse.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
       ...
       * @param content the {@link com.google.classroom.model.ModifyCourseWorkAssigneesRequest}
       * @return the request
       */
      public ModifyAssignees modifyAssignees(java.lang.String courseId, java.lang.String id, com.google.classroom.model.ModifyCourseWorkAssigneesRequest content) throws java.io.IOException {
        ModifyAssignees result = new ModifyAssignees(courseId, id, content);
        initialize(result);
        return result;
      }

      public class ModifyAssignees extends ClassroomRequest<com.google.classroom.model.CourseWork> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected ModifyAssignees(java.lang.String courseId, java.lang.String id, com.google.classroom.model.ModifyCourseWorkAssigneesRequest content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.CourseWork.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
       ...
       * @return the request
       */
      public Patch patch(java.lang.String courseId, java.lang.String id, com.google.classroom.model.CourseWork content) throws java.io.IOException {
        Patch result = new Patch(courseId, id, content);
        initialize(result);
        return result;
      }

      public class Patch extends ClassroomRequest<com.google.classroom.model.CourseWork> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String courseId, java.lang.String id, com.google.classroom.model.CourseWork content) {
          super(Classroom.this, "PATCH", REST_PATH, content, com.google.classroom.model.CourseWork.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
      ...
      public class StudentSubmissions {
        ...
        public class Get extends ClassroomRequest<com.google.classroom.model.StudentSubmission> {
         ...
         *        alias.
          ...
          protected Get(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id) {
            super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.StudentSubmission.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        ...
        public class List extends ClassroomRequest<com.google.classroom.model.ListStudentSubmissionsResponse> {
        ...
        all course work in the specified course.
          ...
          protected List(java.lang.String courseId, java.lang.String courseWorkId) {
            super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListStudentSubmissionsResponse.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
          }
         ...
         * @param courseWorkId Identifier of the course work.
         * @param id Identifier of the student submission.
         * @param content the {@link com.google.classroom.model.ModifyAttachmentsRequest}
         * @return the request
         */
        public ModifyAttachments modifyAttachments(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ModifyAttachmentsRequest content) throws java.io.IOException {
          ModifyAttachments result = new ModifyAttachments(courseId, courseWorkId, id, content);
          initialize(result);
          return result;
        }

        public class ModifyAttachments extends ClassroomRequest<com.google.classroom.model.StudentSubmission> {
         ...
         *        alias.
           ...
           * @since 1.13
           */
          protected ModifyAttachments(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ModifyAttachmentsRequest content) {
            super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.StudentSubmission.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
          }
         ...
         * @param courseWorkId Identifier of the course work.
         * @param id Identifier of the student submission.
         * @param content the {@link com.google.classroom.model.StudentSubmission}
         * @return the request
         */
        public Patch patch(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.StudentSubmission content) throws java.io.IOException {
          Patch result = new Patch(courseId, courseWorkId, id, content);
          initialize(result);
          return result;
        }

        public class Patch extends ClassroomRequest<com.google.classroom.model.StudentSubmission> {
         ...
         *        alias.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.StudentSubmission content) {
            super(Classroom.this, "PATCH", REST_PATH, content, com.google.classroom.model.StudentSubmission.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
          }
         ...
         * @param courseWorkId Identifier of the course work.
         * @param id Identifier of the student submission.
         * @param content the {@link com.google.classroom.model.ReclaimStudentSubmissionRequest}
         * @return the request
         */
        public Reclaim reclaim(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ReclaimStudentSubmissionRequest content) throws java.io.IOException {
          Reclaim result = new Reclaim(courseId, courseWorkId, id, content);
          initialize(result);
          return result;
        }

        public class Reclaim extends ClassroomRequest<com.google.classroom.model.Empty> {
         ...
         *        alias.
           ...
           * @since 1.13
           */
          protected Reclaim(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ReclaimStudentSubmissionRequest content) {
            super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Empty.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
          }
         ...
         * @param courseWorkId Identifier of the course work.
         * @param id Identifier of the student submission.
         * @param content the {@link com.google.classroom.model.ReturnStudentSubmissionRequest}
         * @return the request
         */
        public ClassroomReturn classroomReturn(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ReturnStudentSubmissionRequest content) throws java.io.IOException {
          ClassroomReturn result = new ClassroomReturn(courseId, courseWorkId, id, content);
          initialize(result);
          return result;
        }

        public class ClassroomReturn extends ClassroomRequest<com.google.classroom.model.Empty> {
         ...
         *        alias.
           ...
           * @since 1.13
           */
          protected ClassroomReturn(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.ReturnStudentSubmissionRequest content) {
            super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Empty.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
         ...
         * @param courseWorkId Identifier of the course work.
         * @param id Identifier of the student submission.
         * @param content the {@link com.google.classroom.model.TurnInStudentSubmissionRequest}
         * @return the request
         */
        public TurnIn turnIn(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.TurnInStudentSubmissionRequest content) throws java.io.IOException {
          TurnIn result = new TurnIn(courseId, courseWorkId, id, content);
          initialize(result);
          return result;
        }

        public class TurnIn extends ClassroomRequest<com.google.classroom.model.Empty> {
         ...
         *        alias.
           ...
           * @since 1.13
           */
          protected TurnIn(java.lang.String courseId, java.lang.String courseWorkId, java.lang.String id, com.google.classroom.model.TurnInStudentSubmissionRequest content) {
            super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Empty.class);
            this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
            this.courseWorkId = com.google.api.client.util.Preconditions.checkNotNull(courseWorkId, "Required parameter courseWorkId must be specified.");
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    ...
    public class Students {
       ...
       *        assigned identifier or an
      alias.
       * @param content the {@link com.google.classroom.model.Student}
       * @return the request
       */
      public Create create(java.lang.String courseId, com.google.classroom.model.Student content) throws java.io.IOException {
        Create result = new Create(courseId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.Student> {
      ...
      alias.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String courseId, com.google.classroom.model.Student content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Student.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
      ...
      * the string literal `"me"`,
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.Student> {
      ...
      * the string literal `"me"`,
       *        indicating the requesting user
        ...
        protected Get(java.lang.String courseId, java.lang.String userId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Student.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
        }
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListStudentsResponse> {
       ...
       *        alias.
         ...
         */
        protected List(java.lang.String courseId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListStudentsResponse.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
    ...
    public class Teachers {
      ...
      This identifier can be either the Classroom-assigned identifier or an
       *        alias.
       * @param content the {@link com.google.classroom.model.Teacher}
       * @return the request
       */
      public Create create(java.lang.String courseId, com.google.classroom.model.Teacher content) throws java.io.IOException {
        Create result = new Create(courseId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.Teacher> {
       ...
       *        alias.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String courseId, com.google.classroom.model.Teacher content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Teacher.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
      ...
      * the string literal `"me"`,
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.Teacher> {
      ...
      * the string literal `"me"`,
       *        indicating the requesting user
         ...
         */
        protected Get(java.lang.String courseId, java.lang.String userId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Teacher.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
        }
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListTeachersResponse> {
       ...
       *        alias.
         ...
         */
        protected List(java.lang.String courseId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListTeachersResponse.class);
          this.courseId = com.google.api.client.util.Preconditions.checkNotNull(courseId, "Required parameter courseId must be specified.");
        }
  ...
  public class Invitations {
    ...
    public class Accept extends ClassroomRequest<com.google.classroom.model.Empty> {
      ...
      protected Accept(java.lang.String id) {
        super(Classroom.this, "POST", REST_PATH, null, com.google.classroom.model.Empty.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.classroom.model.Invitation}
     * @return the request
     */
    public Create create(com.google.classroom.model.Invitation content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends ClassroomRequest<com.google.classroom.model.Invitation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.classroom.model.Invitation content) {
        super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Invitation.class);
      }
    ...
    public class Get extends ClassroomRequest<com.google.classroom.model.Invitation> {
       ...
       */
      protected Get(java.lang.String id) {
        super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Invitation.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class List extends ClassroomRequest<com.google.classroom.model.ListInvitationsResponse> {
       ...
       */
      protected List() {
        super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListInvitationsResponse.class);
      }
  ...
  public class Registrations {
     ...
     * parameters, call the {@link Create#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.classroom.model.Registration}
     * @return the request
     */
    public Create create(com.google.classroom.model.Registration content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends ClassroomRequest<com.google.classroom.model.Registration> {
       ...
       * @since 1.13
       */
      protected Create(com.google.classroom.model.Registration content) {
        super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.Registration.class);
      }
  ...
  public class UserProfiles {
    ...
    * the string literal `"me"`,
    ...
    public class Get extends ClassroomRequest<com.google.classroom.model.UserProfile> {
    ...
    * the string literal `"me"`,
     *        indicating the requesting user
      ...
      protected Get(java.lang.String userId) {
        super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.UserProfile.class);
        this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
      }
    ...
    public class GuardianInvitations {
       ...
       * @param content the {@link com.google.classroom.model.GuardianInvitation}
       * @return the request
       */
      public Create create(java.lang.String studentId, com.google.classroom.model.GuardianInvitation content) throws java.io.IOException {
        Create result = new Create(studentId, content);
        initialize(result);
        return result;
      }

      public class Create extends ClassroomRequest<com.google.classroom.model.GuardianInvitation> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String studentId, com.google.classroom.model.GuardianInvitation content) {
          super(Classroom.this, "POST", REST_PATH, content, com.google.classroom.model.GuardianInvitation.class);
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.GuardianInvitation> {
        ...
        protected Get(java.lang.String studentId, java.lang.String invitationId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.GuardianInvitation.class);
          this.studentId = com.google.api.client.util.Preconditions.checkNotNull(studentId, "Required parameter studentId must be specified.");
      ...
      * the string literal `"-"`,
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListGuardianInvitationsResponse> {
      ...
      * the string literal `"-"`,
       ...
       *        permitted to view guardian
        ...
        protected List(java.lang.String studentId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListGuardianInvitationsResponse.class);
          this.studentId = com.google.api.client.util.Preconditions.checkNotNull(studentId, "Required parameter studentId must be specified.");
        }
       ...
       * @return the request
       */
      public Patch patch(java.lang.String studentId, java.lang.String invitationId, com.google.classroom.model.GuardianInvitation content) throws java.io.IOException {
        Patch result = new Patch(studentId, invitationId, content);
        initialize(result);
        return result;
      }

      public class Patch extends ClassroomRequest<com.google.classroom.model.GuardianInvitation> {
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String studentId, java.lang.String invitationId, com.google.classroom.model.GuardianInvitation content) {
          super(Classroom.this, "PATCH", REST_PATH, content, com.google.classroom.model.GuardianInvitation.class);
          this.studentId = com.google.api.client.util.Preconditions.checkNotNull(studentId, "Required parameter studentId must be specified.");
          this.invitationId = com.google.api.client.util.Preconditions.checkNotNull(invitationId, "Required parameter invitationId must be specified.");
        }
    ...
    public class Guardians {
      ...
      * the string literal `"me"`, indicating the
      ...
      public class Get extends ClassroomRequest<com.google.classroom.model.Guardian> {
      ...
      * the string literal `"me"`, indicating the
       *        requesting user
        ...
        protected Get(java.lang.String studentId, java.lang.String guardianId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.Guardian.class);
          this.studentId = com.google.api.client.util.Preconditions.checkNotNull(studentId, "Required parameter studentId must be specified.");
          this.guardianId = com.google.api.client.util.Preconditions.checkNotNull(guardianId, "Required parameter guardianId must be specified.");
        }
      ...
      * the string literal `"-"`,
      ...
      public class List extends ClassroomRequest<com.google.classroom.model.ListGuardiansResponse> {
      ...
      * the string literal `"-"`,
       ...
       *        access to view.
         ...
         */
        protected List(java.lang.String studentId) {
          super(Classroom.this, "GET", REST_PATH, null, com.google.classroom.model.ListGuardiansResponse.class);
          this.studentId = com.google.api.client.util.Preconditions.checkNotNull(studentId, "Required parameter studentId must be specified.");
        }
