...
public class AndroidManagement extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Android Management API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Enterprises {
     ...
     *
     * @param content the {@link com.google.androidmanagement.v1.model.Enterprise}
     * @return the request
     */
    public Create create(com.google.androidmanagement.v1.model.Enterprise content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Enterprise> {
       ...
       * @since 1.13
       */
      protected Create(com.google.androidmanagement.v1.model.Enterprise content) {
        super(AndroidManagement.this, "POST", REST_PATH, content, com.google.androidmanagement.v1.model.Enterprise.class);
      }
    ...
    public class Get extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Enterprise> {
      ...
      protected Get(java.lang.String name) {
        super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.Enterprise.class);
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.androidmanagement.v1.model.Enterprise content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }

    public class Patch extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Enterprise> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.androidmanagement.v1.model.Enterprise content) {
        super(AndroidManagement.this, "PATCH", REST_PATH, content, com.google.androidmanagement.v1.model.Enterprise.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Applications {
      ...
      public class Get extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Application> {
         ...
         */
        protected Get(java.lang.String name) {
          super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.Application.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class Devices {
      ...
      public class Delete extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Empty> {
        ...
        protected Delete(java.lang.String name) {
          super(AndroidManagement.this, "DELETE", REST_PATH, null, com.google.androidmanagement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Device> {
         ...
         */
        protected Get(java.lang.String name) {
          super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.Device.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *
       * @param name The name of the device in the form enterprises/{enterpriseId}/devices/{deviceId}.
       * @param content the {@link com.google.androidmanagement.v1.model.Command}
       * @return the request
       */
      public IssueCommand issueCommand(java.lang.String name, com.google.androidmanagement.v1.model.Command content) throws java.io.IOException {
        IssueCommand result = new IssueCommand(name, content);
        initialize(result);
        return result;
      }

      public class IssueCommand extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Operation> {
         ...
         * @since 1.13
         */
        protected IssueCommand(java.lang.String name, com.google.androidmanagement.v1.model.Command content) {
          super(AndroidManagement.this, "POST", REST_PATH, content, com.google.androidmanagement.v1.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AndroidManagementRequest<com.google.androidmanagement.v1.model.ListDevicesResponse> {
        ...
        protected List(java.lang.String parent) {
          super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.ListDevicesResponse.class);
       ...
       *
       * @param name The name of the device in the form enterprises/{enterpriseId}/devices/{deviceId}.
       * @param content the {@link com.google.androidmanagement.v1.model.Device}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.androidmanagement.v1.model.Device content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Device> {
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.androidmanagement.v1.model.Device content) {
          super(AndroidManagement.this, "PATCH", REST_PATH, content, com.google.androidmanagement.v1.model.Device.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Cancel extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(AndroidManagement.this, "POST", REST_PATH, null, com.google.androidmanagement.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AndroidManagementRequest<com.google.androidmanagement.v1.model.ListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
    ...
    public class EnrollmentTokens {
       ...
       *
       * @param parent The name of the enterprise in the form enterprises/{enterpriseId}.
       * @param content the {@link com.google.androidmanagement.v1.model.EnrollmentToken}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.androidmanagement.v1.model.EnrollmentToken content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends AndroidManagementRequest<com.google.androidmanagement.v1.model.EnrollmentToken> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.androidmanagement.v1.model.EnrollmentToken content) {
          super(AndroidManagement.this, "POST", REST_PATH, content, com.google.androidmanagement.v1.model.EnrollmentToken.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
    ...
    public class Policies {
      ...
      public class Get extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Policy> {
         ...
         */
        protected Get(java.lang.String name) {
          super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.Policy.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AndroidManagementRequest<com.google.androidmanagement.v1.model.ListPoliciesResponse> {
         ...
         */
        protected List(java.lang.String parent) {
          super(AndroidManagement.this, "GET", REST_PATH, null, com.google.androidmanagement.v1.model.ListPoliciesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *
       * @param name The name of the policy in the form enterprises/{enterpriseId}/policies/{policyId}.
       * @param content the {@link com.google.androidmanagement.v1.model.Policy}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.androidmanagement.v1.model.Policy content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends AndroidManagementRequest<com.google.androidmanagement.v1.model.Policy> {
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.androidmanagement.v1.model.Policy content) {
          super(AndroidManagement.this, "PATCH", REST_PATH, content, com.google.androidmanagement.v1.model.Policy.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class WebTokens {
       ...
       *
       * @param parent The name of the enterprise in the form enterprises/{enterpriseId}.
       * @param content the {@link com.google.androidmanagement.v1.model.WebToken}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.androidmanagement.v1.model.WebToken content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends AndroidManagementRequest<com.google.androidmanagement.v1.model.WebToken> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.androidmanagement.v1.model.WebToken content) {
          super(AndroidManagement.this, "POST", REST_PATH, content, com.google.androidmanagement.v1.model.WebToken.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
  ...
  public class SignupUrls {
    ...
    public class Create extends AndroidManagementRequest<com.google.androidmanagement.v1.model.SignupUrl> {
       ...
       */
      protected Create() {
        super(AndroidManagement.this, "POST", REST_PATH, null, com.google.androidmanagement.v1.model.SignupUrl.class);
      }
