...
public final class Statefile extends com.google.api.client.json.GenericJson {
   ...
   */
  public Statefile setSignedUri(java.lang.String signedUri) {
    this.signedUri = signedUri;
    return this;
  }

  @Override
  public Statefile set(String fieldName, Object value) {
    return (Statefile) super.set(fieldName, value);
  }

  @Override
  public Statefile clone() {
    return (Statefile) super.clone();
  }
