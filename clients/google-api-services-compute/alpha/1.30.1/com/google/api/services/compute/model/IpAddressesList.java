...
public final class IpAddressesList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InternalIpAddress> items;

  static {
    // hack to force ProGuard to consider InternalIpAddress used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InternalIpAddress.class);
  }
   ...
   */
  public IpAddressesList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InternalIpAddress> getItems() {
    return items;
  }
   ...
   */
  public IpAddressesList setItems(java.util.List<InternalIpAddress> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public IpAddressesList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public IpAddressesList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public IpAddressesList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public IpAddressesList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public IpAddressesList set(String fieldName, Object value) {
    return (IpAddressesList) super.set(fieldName, value);
  }

  @Override
  public IpAddressesList clone() {
    return (IpAddressesList) super.clone();
  }
