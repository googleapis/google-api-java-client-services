...
public final class FindSalesPartnerManagedClientsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public FindSalesPartnerManagedClientsResponse setClientData(java.util.List<ClientData> clientData) {
    this.clientData = clientData;
    return this;
  }

  @Override
  public FindSalesPartnerManagedClientsResponse set(String fieldName, Object value) {
    return (FindSalesPartnerManagedClientsResponse) super.set(fieldName, value);
  }

  @Override
  public FindSalesPartnerManagedClientsResponse clone() {
    return (FindSalesPartnerManagedClientsResponse) super.clone();
  }
