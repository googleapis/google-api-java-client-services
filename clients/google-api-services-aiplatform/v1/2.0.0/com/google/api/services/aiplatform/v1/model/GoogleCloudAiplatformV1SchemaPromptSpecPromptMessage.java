...
/**
 * The prompt message that aligns with the prompt message in
...
public final class GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider GoogleCloudAiplatformV1SafetySetting used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAiplatformV1SafetySetting.class);
  }
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setContents(java.util.List<GoogleCloudAiplatformV1Content> contents) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setGenerationConfig(GoogleCloudAiplatformV1GenerationConfig generationConfig) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setModel(java.lang.String model) {
    this.model = model;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1SafetySetting> getSafetySettings() {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setSafetySettings(java.util.List<GoogleCloudAiplatformV1SafetySetting> safetySettings) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setSystemInstruction(GoogleCloudAiplatformV1Content systemInstruction) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setToolConfig(GoogleCloudAiplatformV1ToolConfig toolConfig) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage setTools(java.util.List<GoogleCloudAiplatformV1Tool> tools) {
    this.tools = tools;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage clone() {
    return (GoogleCloudAiplatformV1SchemaPromptSpecPromptMessage) super.clone();
  }
