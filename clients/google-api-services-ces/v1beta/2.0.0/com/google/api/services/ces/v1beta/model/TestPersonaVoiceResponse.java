...
public final class TestPersonaVoiceResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public TestPersonaVoiceResponse setAudio(java.lang.String audio) {
    this.audio = audio;
    return this;
  }
   ...
   * @since 1.14
   */
  public TestPersonaVoiceResponse encodeAudio(byte[] audio) {
    this.audio = com.google.api.client.util.Base64.encodeBase64URLSafeString(audio);
    return this;
  }

  @Override
  public TestPersonaVoiceResponse set(String fieldName, Object value) {
    return (TestPersonaVoiceResponse) super.set(fieldName, value);
  }

  @Override
  public TestPersonaVoiceResponse clone() {
    return (TestPersonaVoiceResponse) super.clone();
  }
