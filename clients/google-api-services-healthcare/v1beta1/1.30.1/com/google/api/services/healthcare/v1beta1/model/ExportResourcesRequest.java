...
public final class ExportResourcesRequest extends com.google.api.client.json.GenericJson {
   ...
   * `roles/storage.objectAdmin` Cloud IAM role. The exported outputs are organized by FHIR resource
   * types. The server creates one object per resource type. Each object contains newline delimited
