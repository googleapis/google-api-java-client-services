...
public final class GoogleCloudAiplatformV1NotebookSoftwareConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1NotebookSoftwareConfig setEnv(java.util.List<GoogleCloudAiplatformV1EnvVar> env) {
    this.env = env;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudAiplatformV1PostStartupScriptConfig getPostStartupScriptConfig() {
   ...
   */
  public GoogleCloudAiplatformV1NotebookSoftwareConfig setPostStartupScriptConfig(GoogleCloudAiplatformV1PostStartupScriptConfig postStartupScriptConfig) {
    this.postStartupScriptConfig = postStartupScriptConfig;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1NotebookSoftwareConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1NotebookSoftwareConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1NotebookSoftwareConfig clone() {
    return (GoogleCloudAiplatformV1NotebookSoftwareConfig) super.clone();
  }
