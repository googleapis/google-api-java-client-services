...
public final class BulkListAdGroupAssignedTargetingOptionsResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<AdGroupAssignedTargetingOption> adGroupAssignedTargetingOptions;

  static {
    // hack to force ProGuard to consider AdGroupAssignedTargetingOption used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(AdGroupAssignedTargetingOption.class);
  }
   ...
   */
  public java.util.List<AdGroupAssignedTargetingOption> getAdGroupAssignedTargetingOptions() {
   ...
   * The list of wrapper objects, each providing an assigned targeting option and the ad group it is
   * assigned to. This list will be absent if empty.
   * @param adGroupAssignedTargetingOptions adGroupAssignedTargetingOptions or {@code null} for none
   */
  public BulkListAdGroupAssignedTargetingOptionsResponse setAdGroupAssignedTargetingOptions(java.util.List<AdGroupAssignedTargetingOption> adGroupAssignedTargetingOptions) {
