...
public final class VpnTunnelAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, VpnTunnelsScopedList> items;
   ...
   */
  public VpnTunnelAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, VpnTunnelsScopedList> getItems() {
    return items;
  }
   ...
   */
  public VpnTunnelAggregatedList setItems(java.util.Map<String, VpnTunnelsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public VpnTunnelAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public VpnTunnelAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public VpnTunnelAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public VpnTunnelAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public VpnTunnelAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VpnTunnelAggregatedList set(String fieldName, Object value) {
    return (VpnTunnelAggregatedList) super.set(fieldName, value);
  }

  @Override
  public VpnTunnelAggregatedList clone() {
    return (VpnTunnelAggregatedList) super.clone();
  }
