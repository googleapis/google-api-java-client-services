...
public final class ClientEvent extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. A unique identifier, generated by the client application. This `event_id` is used to
   * establish the relationship between different events (see parent_event_id).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. The event_id of an event that resulted in the current event. For example, a Job view
   * event usually follows a parent impression event: A job seeker first does a search where a list
   * of jobs appears (impression). The job seeker then selects a result and views the description of
   * a particular job (Job view).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
