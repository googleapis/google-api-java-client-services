...
public final class IamPolicyAnalysisResult extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudAssetV1p4beta1AccessControlList> accessControlLists;

  static {
    // hack to force ProGuard to consider GoogleCloudAssetV1p4beta1AccessControlList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAssetV1p4beta1AccessControlList.class);
  }
   ...
   */
  public java.util.List<GoogleCloudAssetV1p4beta1AccessControlList> getAccessControlLists() {
   ...
   */
  public IamPolicyAnalysisResult setAccessControlLists(java.util.List<GoogleCloudAssetV1p4beta1AccessControlList> accessControlLists) {
   ...
   */
  public IamPolicyAnalysisResult setIdentityList(GoogleCloudAssetV1p4beta1IdentityList identityList) {
