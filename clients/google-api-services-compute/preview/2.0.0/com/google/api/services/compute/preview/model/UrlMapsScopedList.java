...
public final class UrlMapsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<UrlMap> urlMaps;
   ...
   */
  public java.util.List<UrlMap> getUrlMaps() {
    return urlMaps;
  }

  /**
   * A list of UrlMaps contained in this scope.
   * @param urlMaps urlMaps or {@code null} for none
   */
  public UrlMapsScopedList setUrlMaps(java.util.List<UrlMap> urlMaps) {
   ...
   */
  public UrlMapsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public UrlMapsScopedList set(String fieldName, Object value) {
    return (UrlMapsScopedList) super.set(fieldName, value);
  }

  @Override
  public UrlMapsScopedList clone() {
    return (UrlMapsScopedList) super.clone();
  }
