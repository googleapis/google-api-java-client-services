...
public final class GoogleApiServicecontrolV1MetricValue extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleApiServicecontrolV1Distribution distributionValue;
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setBoolValue(java.lang.Boolean boolValue) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleApiServicecontrolV1Distribution getDistributionValue() {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setDistributionValue(GoogleApiServicecontrolV1Distribution distributionValue) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setDoubleValue(java.lang.Double doubleValue) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setEndTime(String endTime) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setInt64Value(java.lang.Long int64Value) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setMoneyValue(Money moneyValue) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setStartTime(String startTime) {
   ...
   */
  public GoogleApiServicecontrolV1MetricValue setStringValue(java.lang.String stringValue) {
    this.stringValue = stringValue;
    return this;
  }

  @Override
  public GoogleApiServicecontrolV1MetricValue set(String fieldName, Object value) {
    return (GoogleApiServicecontrolV1MetricValue) super.set(fieldName, value);
  }

  @Override
  public GoogleApiServicecontrolV1MetricValue clone() {
    return (GoogleApiServicecontrolV1MetricValue) super.clone();
  }
