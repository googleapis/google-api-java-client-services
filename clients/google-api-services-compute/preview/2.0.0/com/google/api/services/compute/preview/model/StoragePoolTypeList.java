...
public final class StoragePoolTypeList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<StoragePoolType> items;

  static {
    // hack to force ProGuard to consider StoragePoolType used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(StoragePoolType.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#storagePoolTypeList for storage pool
   * types.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public StoragePoolTypeList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<StoragePoolType> getItems() {
    return items;
  }
   ...
   */
  public StoragePoolTypeList setItems(java.util.List<StoragePoolType> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public StoragePoolTypeList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public StoragePoolTypeList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public StoragePoolTypeList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public StoragePoolTypeList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolTypeList set(String fieldName, Object value) {
    return (StoragePoolTypeList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolTypeList clone() {
    return (StoragePoolTypeList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolTypeListWarningData.
     */
