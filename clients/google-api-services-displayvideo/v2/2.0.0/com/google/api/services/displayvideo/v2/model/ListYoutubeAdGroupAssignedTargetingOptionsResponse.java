...
public final class ListYoutubeAdGroupAssignedTargetingOptionsResponse extends com.google.api.client.json.GenericJson {
   ...
   * in a subsequent ListYoutubeAdGroupAssignedTargetingOptionsRequest to fetch the next page of
   ...
   */
  public ListYoutubeAdGroupAssignedTargetingOptionsResponse setAssignedTargetingOptions(java.util.List<AssignedTargetingOption> assignedTargetingOptions) {
   ...
   */
  public ListYoutubeAdGroupAssignedTargetingOptionsResponse setNextPageToken(java.lang.String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  @Override
  public ListYoutubeAdGroupAssignedTargetingOptionsResponse set(String fieldName, Object value) {
    return (ListYoutubeAdGroupAssignedTargetingOptionsResponse) super.set(fieldName, value);
  }

  @Override
  public ListYoutubeAdGroupAssignedTargetingOptionsResponse clone() {
    return (ListYoutubeAdGroupAssignedTargetingOptionsResponse) super.clone();
  }
