...
public final class Policy extends com.google.api.client.json.GenericJson {
   ...
   * 'setIamPolicy' will not fail even if either of incoming or stored policy does not meet the
   ...
   * conditional binding from the stored conditional policy. Operations on non-conditional policies
   * may specify any valid value or leave the field unset.If no etag is provided in the call to
   * setIamPolicy, any version compliance checks on the incoming and/or stored policy is skipped.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
