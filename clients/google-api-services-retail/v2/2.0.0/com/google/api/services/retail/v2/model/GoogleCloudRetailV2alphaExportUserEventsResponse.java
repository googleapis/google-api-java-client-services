...
public final class GoogleCloudRetailV2alphaExportUserEventsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2alphaExportUserEventsResponse setErrorSamples(java.util.List<GoogleRpcStatus> errorSamples) {
  ...
  @Override
  public GoogleCloudRetailV2alphaExportUserEventsResponse set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaExportUserEventsResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaExportUserEventsResponse clone() {
