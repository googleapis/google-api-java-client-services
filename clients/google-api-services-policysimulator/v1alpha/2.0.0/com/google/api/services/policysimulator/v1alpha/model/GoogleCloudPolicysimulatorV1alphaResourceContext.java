...
public final class GoogleCloudPolicysimulatorV1alphaResourceContext extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaResourceContext setAssetType(java.lang.String assetType) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaResourceContext setResource(java.lang.String resource) {
    this.resource = resource;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaResourceContext set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1alphaResourceContext) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaResourceContext clone() {
    return (GoogleCloudPolicysimulatorV1alphaResourceContext) super.clone();
  }
