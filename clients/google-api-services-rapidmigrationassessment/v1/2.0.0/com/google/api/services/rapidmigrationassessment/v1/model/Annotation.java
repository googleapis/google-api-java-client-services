...
public final class Annotation extends com.google.api.client.json.GenericJson {
   ...
   */
  public Annotation setCreateTime(String createTime) {
   ...
   */
  public Annotation setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public Annotation setUpdateTime(String updateTime) {
