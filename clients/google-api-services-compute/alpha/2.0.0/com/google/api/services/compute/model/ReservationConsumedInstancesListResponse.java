...
public final class ReservationConsumedInstancesListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ReservationConsumedInstance> items;

  static {
    // hack to force ProGuard to consider ReservationConsumedInstance used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ReservationConsumedInstance.class);
  }
   ...
   */
  public ReservationConsumedInstancesListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ReservationConsumedInstance> getItems() {
    return items;
  }
   ...
   */
  public ReservationConsumedInstancesListResponse setItems(java.util.List<ReservationConsumedInstance> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationConsumedInstancesListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ReservationConsumedInstancesListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationConsumedInstancesListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReservationConsumedInstancesListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationConsumedInstancesListResponse set(String fieldName, Object value) {
    return (ReservationConsumedInstancesListResponse) super.set(fieldName, value);
  }

  @Override
  public ReservationConsumedInstancesListResponse clone() {
    return (ReservationConsumedInstancesListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ReservationConsumedInstancesListResponseWarningData.
     */
