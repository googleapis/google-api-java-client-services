...
public final class GoogleFirestoreAdminV1beta2ExportDocumentsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirestoreAdminV1beta2ExportDocumentsRequest setCollectionIds(java.util.List<java.lang.String> collectionIds) {
   ...
   */
  public GoogleFirestoreAdminV1beta2ExportDocumentsRequest setOutputUriPrefix(java.lang.String outputUriPrefix) {
    this.outputUriPrefix = outputUriPrefix;
    return this;
  }

  @Override
  public GoogleFirestoreAdminV1beta2ExportDocumentsRequest set(String fieldName, Object value) {
    return (GoogleFirestoreAdminV1beta2ExportDocumentsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirestoreAdminV1beta2ExportDocumentsRequest clone() {
    return (GoogleFirestoreAdminV1beta2ExportDocumentsRequest) super.clone();
  }
