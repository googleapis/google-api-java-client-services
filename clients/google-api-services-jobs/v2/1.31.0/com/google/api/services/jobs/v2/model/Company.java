...
public final class Company extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Deprecated. Do not use this field. Optional. This field is no longer used. Any value set to it
   * is ignored.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * billing purposes. Recommended practice is to use the distributor_company_id. Defaults to same
   * value as distributor_company_id when a value is not provided.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * for each distinct brand displayed. The maximum number of allowed characters is 255.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * and typically to be displayed in all roles. The maximum number of allowed characters is 500.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Optional. Set to true if it is the hiring agency that post jobs for other employers. Defaults
   ...
   * squared at 80x80 pixels. The url must be a Google Photos or Google Album url. Only images in
   * these Google sub-domains are accepted.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Deprecated. Use keyword_searchable_custom_attributes instead. Optional. A list of filterable
   * custom fields that should be used in keyword search. The jobs of this company are returned if
   * any of these custom fields matches the search keyword. Custom field values with parenthesis,
   * brackets and special symbols might not be properly searchable, and those keyword queries need
  ...
  /**
   * Deprecated. Use display_name instead. Required. The name of the employer to be displayed with
