...
/**
 * A ParagraphElement representing a page break. A page break makes the subsequent text start at the
...
public final class PageBreak extends com.google.api.client.json.GenericJson {
   ...
   */
  public PageBreak setSuggestedDeletionIds(java.util.List<java.lang.String> suggestedDeletionIds) {
   ...
   */
  public PageBreak setSuggestedInsertionIds(java.util.List<java.lang.String> suggestedInsertionIds) {
   ...
   */
  public PageBreak setSuggestedTextStyleChanges(java.util.Map<String, SuggestedTextStyle> suggestedTextStyleChanges) {
  ...
  @Override
  public PageBreak set(String fieldName, Object value) {
    return (PageBreak) super.set(fieldName, value);
  }
