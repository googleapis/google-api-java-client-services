...
public final class GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership set(String fieldName, Object value) {
    return (GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership clone() {
    return (GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership) super.clone();
  }
