...
public final class GoogleCloudVideointelligenceV1p3beta1TimestampedObject extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1p3beta1DetectedLandmark> landmarks;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1p3beta1DetectedLandmark used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1p3beta1DetectedLandmark.class);
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1p3beta1DetectedLandmark> getLandmarks() {
    return landmarks;
  }
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1TimestampedObject setLandmarks(java.util.List<GoogleCloudVideointelligenceV1p3beta1DetectedLandmark> landmarks) {
