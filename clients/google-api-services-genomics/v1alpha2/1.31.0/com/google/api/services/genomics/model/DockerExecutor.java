...
public final class DockerExecutor extends com.google.api.client.json.GenericJson {
   ...
   * within a bash shell. If the command exits with a non-zero exit code, output parameter de-
   * localization will be skipped and the pipeline operation's `error` field will be populated.
