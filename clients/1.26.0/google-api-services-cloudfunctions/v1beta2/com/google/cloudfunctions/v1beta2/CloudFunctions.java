...
package com.google.cloudfunctions.v1beta2;
...
public class CloudFunctions extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Functions API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Operations {
    ...
    public class Get extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.Operation> {
      ...
      protected Get(java.lang.String name) {
        super(CloudFunctions.this, "GET", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.Operation.class);
    ...
    public class List extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.ListOperationsResponse> {
       ...
       */
      protected List() {
        super(CloudFunctions.this, "GET", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.ListOperationsResponse.class);
      }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class List extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudFunctions.this, "GET", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Functions {
         ...
         * @param content the {@link com.google.cloudfunctions.v1beta2.model.CallFunctionRequest}
         * @return the request
         */
        public Call call(java.lang.String name, com.google.cloudfunctions.v1beta2.model.CallFunctionRequest content) throws java.io.IOException {
          Call result = new Call(name, content);
          initialize(result);
          return result;
        }

        public class Call extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.CallFunctionResponse> {
           ...
           * @since 1.13
           */
          protected Call(java.lang.String name, com.google.cloudfunctions.v1beta2.model.CallFunctionRequest content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.cloudfunctions.v1beta2.model.CallFunctionResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        in the format
         *        `projects/locations`
         * @param content the {@link com.google.cloudfunctions.v1beta2.model.CloudFunction}
         * @return the request
         */
        public Create create(java.lang.String location, com.google.cloudfunctions.v1beta2.model.CloudFunction content) throws java.io.IOException {
          Create result = new Create(location, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.Operation> {
         ...
         *        `projects/locations`
           ...
           * @since 1.13
           */
          protected Create(java.lang.String location, com.google.cloudfunctions.v1beta2.model.CloudFunction content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.cloudfunctions.v1beta2.model.Operation.class);
        ...
        public class Delete extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.Operation> {
          ...
          protected Delete(java.lang.String name) {
            super(CloudFunctions.this, "DELETE", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.cloudfunctions.v1beta2.model.GenerateDownloadUrlRequest}
         * @return the request
         */
        public GenerateDownloadUrl generateDownloadUrl(java.lang.String name, com.google.cloudfunctions.v1beta2.model.GenerateDownloadUrlRequest content) throws java.io.IOException {
          GenerateDownloadUrl result = new GenerateDownloadUrl(name, content);
          initialize(result);
          return result;
        }

        public class GenerateDownloadUrl extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.GenerateDownloadUrlResponse> {
        ...
        URL should be generated.
           ...
           * @since 1.13
           */
          protected GenerateDownloadUrl(java.lang.String name, com.google.cloudfunctions.v1beta2.model.GenerateDownloadUrlRequest content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.cloudfunctions.v1beta2.model.GenerateDownloadUrlResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.cloudfunctions.v1beta2.model.GenerateUploadUrlRequest}
         * @return the request
         */
        public GenerateUploadUrl generateUploadUrl(java.lang.String parent, com.google.cloudfunctions.v1beta2.model.GenerateUploadUrlRequest content) throws java.io.IOException {
          GenerateUploadUrl result = new GenerateUploadUrl(parent, content);
          initialize(result);
          return result;
        }

        public class GenerateUploadUrl extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.GenerateUploadUrlResponse> {
         ...
         *        in the format `projects/locations`.
           ...
           * @since 1.13
           */
          protected GenerateUploadUrl(java.lang.String parent, com.google.cloudfunctions.v1beta2.model.GenerateUploadUrlRequest content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.cloudfunctions.v1beta2.model.GenerateUploadUrlResponse.class);
        ...
        public class Get extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.CloudFunction> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFunctions.this, "GET", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.CloudFunction.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.ListFunctionsResponse> {
         ...
         *        location.
          ...
          protected List(java.lang.String location) {
            super(CloudFunctions.this, "GET", REST_PATH, null, com.google.cloudfunctions.v1beta2.model.ListFunctionsResponse.class);
            this.location = com.google.api.client.util.Preconditions.checkNotNull(location, "Required parameter location must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(LOCATION_PATTERN.matcher(location).matches(),
                  "Parameter location must conform to the pattern " +
         ...
         * @return the request
         */
        public Update update(java.lang.String name, com.google.cloudfunctions.v1beta2.model.CloudFunction content) throws java.io.IOException {
          Update result = new Update(name, content);
          initialize(result);
          return result;
        }

        public class Update extends CloudFunctionsRequest<com.google.cloudfunctions.v1beta2.model.Operation> {
           ...
           * @since 1.13
           */
          protected Update(java.lang.String name, com.google.cloudfunctions.v1beta2.model.CloudFunction content) {
            super(CloudFunctions.this, "PUT", REST_PATH, content, com.google.cloudfunctions.v1beta2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
