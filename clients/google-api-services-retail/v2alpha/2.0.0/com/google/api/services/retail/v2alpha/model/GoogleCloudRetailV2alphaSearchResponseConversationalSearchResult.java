...
public final class GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultAdditionalFilter> additionalFilters;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultSuggestedAnswer> suggestedAnswers;
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setAdditionalFilter(GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultAdditionalFilter additionalFilter) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultAdditionalFilter> getAdditionalFilters() {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setAdditionalFilters(java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultAdditionalFilter> additionalFilters) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setConversationId(java.lang.String conversationId) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setFollowupQuestion(java.lang.String followupQuestion) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setRefinedQuery(java.lang.String refinedQuery) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultSuggestedAnswer> getSuggestedAnswers() {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult setSuggestedAnswers(java.util.List<GoogleCloudRetailV2alphaSearchResponseConversationalSearchResultSuggestedAnswer> suggestedAnswers) {
    this.suggestedAnswers = suggestedAnswers;
    return this;
  }

  @Override
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaSearchResponseConversationalSearchResult clone() {
