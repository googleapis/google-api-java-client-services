  ...
  public class Organizations {
    ...
    public class Locations {
      ...
      public class Customers {
         ...
         * @param content the {@link com.google.api.services.cloudcontrolspartner.v1beta.model.Customer}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudControlsPartnerServiceRequest<com.google.api.services.cloudcontrolspartner.v1beta.model.Customer> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer content) {
            super(CloudControlsPartnerService.this, "POST", REST_PATH, content, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer.class);
           ...
           * component of the customer's resource name. The specified value must be a valid Google
           * cloud organization id.
           */
          @com.google.api.client.util.Key
          private java.lang.String customerId;

          /** Required. The customer id to use for the customer, which will become the final component of the
         customer's resource name. The specified value must be a valid Google cloud organization id.
           */
         ...
         *
         * @param name Required. name of the resource to be deleted format: name=organizations/locations/customers
         * @return the request
         */
        ...
        public class Delete extends CloudControlsPartnerServiceRequest<com.google.api.services.cloudcontrolspartner.v1beta.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(CloudControlsPartnerService.this, "DELETE", REST_PATH, null, com.google.api.services.cloudcontrolspartner.v1beta.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *
         * @param name Identifier. Format: `organizations/{organization}/locations/{location}/customers/{customer}`
         * @param content the {@link com.google.api.services.cloudcontrolspartner.v1beta.model.Customer}
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudControlsPartnerServiceRequest<com.google.api.services.cloudcontrolspartner.v1beta.model.Customer> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer content) {
            super(CloudControlsPartnerService.this, "PATCH", REST_PATH, content, com.google.api.services.cloudcontrolspartner.v1beta.model.Customer.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
