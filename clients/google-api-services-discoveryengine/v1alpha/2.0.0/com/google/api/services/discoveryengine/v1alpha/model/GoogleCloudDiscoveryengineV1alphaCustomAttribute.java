...
public final class GoogleCloudDiscoveryengineV1alphaCustomAttribute extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaCustomAttribute setNumbers(java.util.List<java.lang.Double> numbers) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaCustomAttribute setText(java.util.List<java.lang.String> text) {
    this.text = text;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaCustomAttribute set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaCustomAttribute) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaCustomAttribute clone() {
    return (GoogleCloudDiscoveryengineV1alphaCustomAttribute) super.clone();
  }
