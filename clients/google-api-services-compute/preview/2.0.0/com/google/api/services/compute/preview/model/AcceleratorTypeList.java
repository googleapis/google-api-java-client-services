...
public final class AcceleratorTypeList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AcceleratorType> items;
   ...
   */
  public AcceleratorTypeList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<AcceleratorType> getItems() {
    return items;
  }
   ...
   */
  public AcceleratorTypeList setItems(java.util.List<AcceleratorType> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AcceleratorTypeList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public AcceleratorTypeList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AcceleratorTypeList set(String fieldName, Object value) {
    return (AcceleratorTypeList) super.set(fieldName, value);
  }

  @Override
  public AcceleratorTypeList clone() {
    return (AcceleratorTypeList) super.clone();
  }
