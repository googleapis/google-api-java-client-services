...
public final class GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest setContinueUri(java.lang.String continueUri) {
   ...
   */
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest setForceRefreshToken(java.lang.String forceRefreshToken) {
   ...
   */
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest setScopes(java.util.List<java.lang.String> scopes) {
    this.scopes = scopes;
    return this;
  }
   ...
   */
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest setUserId(java.lang.String userId) {
    this.userId = userId;
    return this;
  }

  @Override
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest set(String fieldName, Object value) {
    return (GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest clone() {
    return (GoogleCloudAgentidentitycredentialsV1alphaRetrieveCredentialsRequest) super.clone();
  }
