...
public final class GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest extends com.google.api.client.json.GenericJson {
   ...
   * user's device model. * `deviceBrand` (string): unique identifier of the user's device brand. *
   ...
   * count of distinct users for the day. * `slowRenderingRate20Fps28dUserWeighted`
   * (`google.type.Decimal`): Rolling average value of `slowRenderingRate20Fps` in the last 28 days.
   * The daily values are weighted by the count of distinct users for the day. *
   * `slowRenderingRate30Fps` (`google.type.Decimal`): Percentage of distinct users in the
   * aggregation period that had a slow rendering. * `slowRenderingRate30Fps7dUserWeighted`
   * (`google.type.Decimal`): Rolling average value of `slowRenderingRate30Fps` in the last 7 days.
   * The daily values are weighted by the count of distinct users for the day. *
   * `slowRenderingRate30Fps28dUserWeighted` (`google.type.Decimal`): Rolling average value of
   * `slowRenderingRate30Fps` in the last 28 days. The daily values are weighted by the count of
   ...
   * their app was launched in the device. Care must be taken not to aggregate this count further,
   * as it may result in users being counted multiple times. The value is rounded to the nearest
   * multiple of 10, 100, 1,000 or 1,000,000, depending on the magnitude of the value.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest setDimensions(java.util.List<java.lang.String> dimensions) {
   ...
   */
  public GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
   ...
   */
  public GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest setMetrics(java.util.List<java.lang.String> metrics) {
  ...
  @Override
  public GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest clone() {
    return (GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest) super.clone();
  }
