...
public final class GoogleIdentityStsV1betaExchangeTokenRequest extends com.google.api.client.json.GenericJson {
   ...
   * "https://sts.amazonaws.com?Action=GetCallerIdentity&Version=2011-06-15" } ``` You can also use
   * a Google-issued OAuth 2.0 access token with this field to obtain an access token with new
   ...
   * `urn:ietf:params:oauth:token-type:id_token`, `urn:ietf:params:aws:token-type:aws4_request`, and
