...
public final class GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest set(String fieldName, Object value) {
    return (GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest clone() {
    return (GoogleCloudDialogflowV2CreateConversationModelEvaluationRequest) super.clone();
  }
