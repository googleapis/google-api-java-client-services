...
public class Webmasters extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Search Console API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Searchanalytics {
     ...
     * @param content the {@link com.google.webmasters.model.SearchAnalyticsQueryRequest}
     * @return the request
     */
    public Query query(java.lang.String siteUrl, com.google.webmasters.model.SearchAnalyticsQueryRequest content) throws java.io.IOException {
      Query result = new Query(siteUrl, content);
      initialize(result);
      return result;
    }

    public class Query extends WebmastersRequest<com.google.webmasters.model.SearchAnalyticsQueryResponse> {
       ...
       * @since 1.13
       */
      protected Query(java.lang.String siteUrl, com.google.webmasters.model.SearchAnalyticsQueryRequest content) {
        super(Webmasters.this, "POST", REST_PATH, content, com.google.webmasters.model.SearchAnalyticsQueryResponse.class);
  ...
  public class Sitemaps {
    ...
    public class Get extends WebmastersRequest<com.google.webmasters.model.WmxSitemap> {
      ...
      protected Get(java.lang.String siteUrl, java.lang.String feedpath) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.WmxSitemap.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
        this.feedpath = com.google.api.client.util.Preconditions.checkNotNull(feedpath, "Required parameter feedpath must be specified.");
      }
    ...
    public class List extends WebmastersRequest<com.google.webmasters.model.SitemapsListResponse> {
      ...
      protected List(java.lang.String siteUrl) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.SitemapsListResponse.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
      }
  ...
  public class Sites {
    ...
    public class Get extends WebmastersRequest<com.google.webmasters.model.WmxSite> {
     ...
     *        used in Search Console URLs.
      ...
      protected Get(java.lang.String siteUrl) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.WmxSite.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
      }
    ...
    public class List extends WebmastersRequest<com.google.webmasters.model.SitesListResponse> {
       ...
       */
      protected List() {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.SitesListResponse.class);
      }
  ...
  public class Urlcrawlerrorscounts {
    ...
    public class Query extends WebmastersRequest<com.google.webmasters.model.UrlCrawlErrorsCountsQueryResponse> {
      ...
      protected Query(java.lang.String siteUrl) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.UrlCrawlErrorsCountsQueryResponse.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
      }
  ...
  public class Urlcrawlerrorssamples {
    ...
    public class Get extends WebmastersRequest<com.google.webmasters.model.UrlCrawlErrorsSample> {
     ...
     *        https://www.example.com/, the url value is pagename
      ...
      protected Get(java.lang.String siteUrl, java.lang.String url, java.lang.String category, java.lang.String platform) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.UrlCrawlErrorsSample.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
    ...
    public class List extends WebmastersRequest<com.google.webmasters.model.UrlCrawlErrorsSamplesListResponse> {
      ...
      protected List(java.lang.String siteUrl, java.lang.String category, java.lang.String platform) {
        super(Webmasters.this, "GET", REST_PATH, null, com.google.webmasters.model.UrlCrawlErrorsSamplesListResponse.class);
        this.siteUrl = com.google.api.client.util.Preconditions.checkNotNull(siteUrl, "Required parameter siteUrl must be specified.");
        this.category = com.google.api.client.util.Preconditions.checkNotNull(category, "Required parameter category must be specified.");
        this.platform = com.google.api.client.util.Preconditions.checkNotNull(platform, "Required parameter platform must be specified.");
      }
