...
public class HomeGraphService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Devices {
    ...
    /**
     * Sends an account linking suggestion to users associated with any potential Cast devices detected
     * by third-party devices. This request must be authorized using service account credentials from
     * your Actions console project.
     *
     * Create a request for the method "devices.requestLink".
     *
     * This request holds the parameters needed by the homegraph server.  After setting any optional
     * parameters, call the {@link RequestLink#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.google.api.services.homegraph.v1.model.RequestLinkRequest}
     * @return the request
     */
    public RequestLink requestLink(com.google.api.services.homegraph.v1.model.RequestLinkRequest content) throws java.io.IOException {
      RequestLink result = new RequestLink(content);
      initialize(result);
      return result;
    }

    public class RequestLink extends HomeGraphServiceRequest<com.google.api.services.homegraph.v1.model.Empty> {

      private static final String REST_PATH = "v1/devices:requestLink";

      /**
       * Sends an account linking suggestion to users associated with any potential Cast devices
       * detected by third-party devices. This request must be authorized using service account
       * credentials from your Actions console project.
       *
       * Create a request for the method "devices.requestLink".
       *
       * This request holds the parameters needed by the the homegraph server.  After setting any
       * optional parameters, call the {@link RequestLink#execute()} method to invoke the remote
       * operation. <p> {@link
       * RequestLink#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @param content the {@link com.google.api.services.homegraph.v1.model.RequestLinkRequest}
       * @since 1.13
       */
      protected RequestLink(com.google.api.services.homegraph.v1.model.RequestLinkRequest content) {
        super(HomeGraphService.this, "POST", REST_PATH, content, com.google.api.services.homegraph.v1.model.Empty.class);
      }

      @Override
      public RequestLink set$Xgafv(java.lang.String $Xgafv) {
        return (RequestLink) super.set$Xgafv($Xgafv);
      }

      @Override
      public RequestLink setAccessToken(java.lang.String accessToken) {
        return (RequestLink) super.setAccessToken(accessToken);
      }

      @Override
      public RequestLink setAlt(java.lang.String alt) {
        return (RequestLink) super.setAlt(alt);
      }

      @Override
      public RequestLink setCallback(java.lang.String callback) {
        return (RequestLink) super.setCallback(callback);
      }

      @Override
      public RequestLink setFields(java.lang.String fields) {
        return (RequestLink) super.setFields(fields);
      }

      @Override
      public RequestLink setKey(java.lang.String key) {
        return (RequestLink) super.setKey(key);
      }

      @Override
      public RequestLink setOauthToken(java.lang.String oauthToken) {
        return (RequestLink) super.setOauthToken(oauthToken);
      }

      @Override
      public RequestLink setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (RequestLink) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public RequestLink setQuotaUser(java.lang.String quotaUser) {
        return (RequestLink) super.setQuotaUser(quotaUser);
      }

      @Override
      public RequestLink setUploadType(java.lang.String uploadType) {
        return (RequestLink) super.setUploadType(uploadType);
      }

      @Override
      public RequestLink setUploadProtocol(java.lang.String uploadProtocol) {
        return (RequestLink) super.setUploadProtocol(uploadProtocol);
      }

      @Override
      public RequestLink set(String parameterName, Object value) {
        return (RequestLink) super.set(parameterName, value);
      }
    }
    /**
