...
/**
 * Model definition for NetworkAttachmentList.
 *
...
public final class NetworkAttachmentList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NetworkAttachment> items;
   ...
   */
  public NetworkAttachmentList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkAttachment> getItems() {
    return items;
  }
   ...
   */
  public NetworkAttachmentList setItems(java.util.List<NetworkAttachment> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkAttachmentList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkAttachmentList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkAttachmentList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkAttachmentList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkAttachmentList set(String fieldName, Object value) {
    return (NetworkAttachmentList) super.set(fieldName, value);
  }

  @Override
  public NetworkAttachmentList clone() {
    return (NetworkAttachmentList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkAttachmentListWarningData.
     */
