 ...
 *
 * Rather than storing the altitudes directly, we store the diffs between them as integers at some
 * requested level of precision to take advantage of integer packing. The actual altitude values a[]
 * can be reconstructed using the scale and each row's first_altitude and altitude_diff fields.
 *
