...
public final class NodeGroupOperationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public NodeGroupOperationMetadata setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public NodeGroupOperationMetadata setStatusHistory(java.util.List<ClusterOperationStatus> statusHistory) {
   ...
   */
  public NodeGroupOperationMetadata setWarnings(java.util.List<java.lang.String> warnings) {
