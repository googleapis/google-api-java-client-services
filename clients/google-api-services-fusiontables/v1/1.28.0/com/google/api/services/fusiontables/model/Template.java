...
public final class Template extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Type name: a template for the info window contents. The template can either include an HTML
   * body or a list of columns from which the template is computed automatically.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
