...
public final class VpcFlowLogsConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The value of the field must be in [0, 1]. The sampling rate of VPC flow logs within
   * the subnetwork where 1.0 means all collected logs are reported and 0.0 means no logs are
   * reported. Default value is 1.0.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * Format: projects/{project_id}/networks/{name}
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
