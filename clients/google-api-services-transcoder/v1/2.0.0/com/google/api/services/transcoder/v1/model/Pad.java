...
/**
 * Pad filter configuration for the input video. The padded input video is scaled after padding with
 * black to match the output resolution.
 *
...
public final class Pad extends com.google.api.client.json.GenericJson {
   ...
   */
  public Pad setBottomPixels(java.lang.Integer bottomPixels) {
   ...
   */
  public Pad setLeftPixels(java.lang.Integer leftPixels) {
   ...
   */
  public Pad setRightPixels(java.lang.Integer rightPixels) {
   ...
   */
  public Pad setTopPixels(java.lang.Integer topPixels) {
    this.topPixels = topPixels;
    return this;
  }

  @Override
  public Pad set(String fieldName, Object value) {
    return (Pad) super.set(fieldName, value);
  }

  @Override
  public Pad clone() {
    return (Pad) super.clone();
  }
