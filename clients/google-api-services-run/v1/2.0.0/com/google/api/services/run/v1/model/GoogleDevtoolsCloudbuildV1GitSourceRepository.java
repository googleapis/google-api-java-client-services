...
public final class GoogleDevtoolsCloudbuildV1GitSourceRepository extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleDevtoolsCloudbuildV1GitSourceRepository setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public GoogleDevtoolsCloudbuildV1GitSourceRepository set(String fieldName, Object value) {
    return (GoogleDevtoolsCloudbuildV1GitSourceRepository) super.set(fieldName, value);
  }

  @Override
  public GoogleDevtoolsCloudbuildV1GitSourceRepository clone() {
    return (GoogleDevtoolsCloudbuildV1GitSourceRepository) super.clone();
  }
