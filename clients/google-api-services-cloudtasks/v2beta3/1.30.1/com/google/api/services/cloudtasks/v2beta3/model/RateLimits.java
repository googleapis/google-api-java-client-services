...
public final class RateLimits extends com.google.api.client.json.GenericJson {
   ...
   * `max_burst_size` based on the value of max_dispatches_per_second. For App Engine queues that
   * were created or updated using `queue.yaml/xml`, `max_burst_size` is equal to [bucket_size](http
   * s://cloud.google.com/appengine/docs/standard/python/config/queueref#bucket_size). Since
