  ...
  public class Projects {
    ...
    public class Services {
      ...
      public class ResourcePolicies {
         ...
         * @param content the {@link com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesRequest}
         * @return the request
         */
        public BatchUpdate batchUpdate(java.lang.String parent, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesRequest content) throws java.io.IOException {
          BatchUpdate result = new BatchUpdate(parent, content);
          initialize(result);
          return result;
        }

        public class BatchUpdate extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesResponse> {

          private static final String REST_PATH = "v1/{+parent}/resourcePolicies:batchUpdate";
         ...
         *        this field, or the entire batch fails.
           ...
           * @since 1.13
           */
          protected BatchUpdate(java.lang.String parent, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesRequest content) {
            super(Firebaseappcheck.this, "POST", REST_PATH, content, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1BatchUpdateResourcePoliciesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy> {

          private static final String REST_PATH = "v1/{+parent}/resourcePolicies";
         ...
         *        following service IDs are supported: * `oauth2.googleapis.com` (Google Identity for iOS)
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy content) {
            super(Firebaseappcheck.this, "POST", REST_PATH, content, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Get extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy> {
         ...
         *        following service IDs are supported: * `oauth2.googleapis.com` (Google Identity for iOS)
           ...
           */
          protected Get(java.lang.String name) {
            super(Firebaseappcheck.this, "GET", REST_PATH, null, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ListResourcePoliciesResponse> {
         ...
         *        following service IDs are supported: * `oauth2.googleapis.com` (Google Identity for iOS)
           ...
           */
          protected List(java.lang.String parent) {
            super(Firebaseappcheck.this, "GET", REST_PATH, null, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ListResourcePoliciesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy> {
         ...
         *        `resource_policy_id` is a system-generated UID.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy content) {
            super(Firebaseappcheck.this, "PATCH", REST_PATH, content, com.google.api.services.firebaseappcheck.v1.model.GoogleFirebaseAppcheckV1ResourcePolicy.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
