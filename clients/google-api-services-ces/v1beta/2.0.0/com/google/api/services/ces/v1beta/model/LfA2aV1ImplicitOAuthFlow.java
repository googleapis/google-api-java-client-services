...
public final class LfA2aV1ImplicitOAuthFlow extends com.google.api.client.json.GenericJson {
   ...
   */
  public LfA2aV1ImplicitOAuthFlow setAuthorizationUrl(java.lang.String authorizationUrl) {
   ...
   */
  public LfA2aV1ImplicitOAuthFlow setRefreshUrl(java.lang.String refreshUrl) {
   ...
   */
  public LfA2aV1ImplicitOAuthFlow setScopes(java.util.Map<String, java.lang.String> scopes) {
    this.scopes = scopes;
    return this;
  }

  @Override
  public LfA2aV1ImplicitOAuthFlow set(String fieldName, Object value) {
    return (LfA2aV1ImplicitOAuthFlow) super.set(fieldName, value);
  }

  @Override
  public LfA2aV1ImplicitOAuthFlow clone() {
    return (LfA2aV1ImplicitOAuthFlow) super.clone();
  }
