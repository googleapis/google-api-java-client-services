...
public class CloudFunctions extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class List extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudFunctions.this, "GET", REST_PATH, null, com.google.api.services.cloudfunctions.v2.model.ListLocationsResponse.class);
      ...
      public class Functions {
        ...
        public class GetIamPolicy extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(CloudFunctions.this, "GET", REST_PATH, null, com.google.api.services.cloudfunctions.v2.model.Policy.class);
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.cloudfunctions.v2.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.cloudfunctions.v2.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.cloudfunctions.v2.model.SetIamPolicyRequest content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.api.services.cloudfunctions.v2.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.cloudfunctions.v2.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.cloudfunctions.v2.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.cloudfunctions.v2.model.TestIamPermissionsRequest content) {
            super(CloudFunctions.this, "POST", REST_PATH, content, com.google.api.services.cloudfunctions.v2.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Get extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFunctions.this, "GET", REST_PATH, null, com.google.api.services.cloudfunctions.v2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFunctionsRequest<com.google.api.services.cloudfunctions.v2.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(CloudFunctions.this, "GET", REST_PATH, null, com.google.api.services.cloudfunctions.v2.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
