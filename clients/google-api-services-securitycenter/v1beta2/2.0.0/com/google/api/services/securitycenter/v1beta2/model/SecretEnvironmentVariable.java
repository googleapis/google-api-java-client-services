...
public final class SecretEnvironmentVariable extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public SecretEnvironmentVariable set(String fieldName, Object value) {
    return (SecretEnvironmentVariable) super.set(fieldName, value);
  }

  @Override
  public SecretEnvironmentVariable clone() {
    return (SecretEnvironmentVariable) super.clone();
  }
