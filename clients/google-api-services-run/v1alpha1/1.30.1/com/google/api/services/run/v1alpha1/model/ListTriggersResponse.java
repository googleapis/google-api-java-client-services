...
public final class ListTriggersResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Trigger> items;
   ...
   */
  public ListTriggersResponse setApiVersion(java.lang.String apiVersion) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Trigger> getItems() {
    return items;
  }
   ...
   */
  public ListTriggersResponse setItems(java.util.List<Trigger> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ListTriggersResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
