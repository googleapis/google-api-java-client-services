...
/**
 * Auto scaling settings and current situation. System will create a dedicated FLEX capacity
 * commitment to hold the slots for auto-scale. Users won't be able to manage it,to avoid conflicts.
 * Scale-up will happen, if there are always pending tasks for the past 10 minutes. Scale-down will
 * happen, if the system knows that scale-up won't be triggered again. Note this is an alpha
 * feature.
 *
