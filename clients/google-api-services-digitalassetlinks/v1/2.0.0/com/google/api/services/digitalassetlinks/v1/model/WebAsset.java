...
public final class WebAsset extends com.google.api.client.json.GenericJson {
   ...
   * decimal number, and they must be omitted if the standard port numbers are used: 80 for http and
   * 443 for https. We call this limited URL the "site". All URLs that share the same scheme,
   * hostname and port are considered to be a part of the site and thus belong to the web asset.
   ...
   * `http://www.google.com/` (wrong scheme) * `https://google.com/` (hostname does not match) *
