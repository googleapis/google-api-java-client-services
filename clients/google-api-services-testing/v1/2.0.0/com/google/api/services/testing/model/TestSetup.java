...
public final class TestSetup extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Systrace configuration for the run. Deprecated: Systrace used Python 2 which was sunsetted on
   * 2020-01-01. Systrace is no longer supported in the Cloud Testing API, and no Systrace file will
