    ...
    public class Locations {
      ...
      public class Global {
        ...
        public class Features {
           ...
           *
           * @param name The Feature resource name in the format `projects/locations/global/features`.
           * @return the request
           */
          ...
          public class Delete extends GKEHubRequest<com.google.api.services.gkehub.v1beta.model.Operation> {
            ...
            private final java.util.regex.Pattern NAME_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/global/features/[^/]+$");
            ...
            /**
             * If set to true, the delete will ignore any outstanding resources for this Feature
             * (that is, `FeatureState.has_resources` is set to true). These resources will NOT be
           ...
           *        `projects/locations/global`.
           ...
           `projects/locations/global`.
             ...
             * https://google.aip.dev/160. Examples: - Feature with the name "servicemesh" in
             * project "foo-proj": name = "projects/foo-proj/locations/global/features/servicemesh"
             * - Features that have a label called `foo`: labels.foo:* - Features that have a label
