...
/**
 * Model definition for StoragePoolsScopedList.
 *
...
public final class StoragePoolsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<StoragePool> storagePools;
   ...
   */
  public java.util.List<StoragePool> getStoragePools() {
    return storagePools;
  }
   ...
   */
  public StoragePoolsScopedList setStoragePools(java.util.List<StoragePool> storagePools) {
   ...
   */
  public StoragePoolsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolsScopedList set(String fieldName, Object value) {
    return (StoragePoolsScopedList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolsScopedList clone() {
    return (StoragePoolsScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolsScopedListWarningData.
     */
