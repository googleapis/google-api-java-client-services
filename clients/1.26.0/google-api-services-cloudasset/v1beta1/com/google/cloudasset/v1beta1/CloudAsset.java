...
public class CloudAsset extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Asset API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Organizations {
    ...
    public class BatchGetAssetsHistory extends CloudAssetRequest<com.google.cloudasset.v1beta1.model.BatchGetAssetsHistoryResponse> {
     ...
     *        number (such as "projects/12345").
      ...
      protected BatchGetAssetsHistory(java.lang.String parent) {
        super(CloudAsset.this, "GET", REST_PATH, null, com.google.cloudasset.v1beta1.model.BatchGetAssetsHistoryResponse.class);
     ...
     * @param content the {@link com.google.cloudasset.v1beta1.model.ExportAssetsRequest}
     * @return the request
     */
    public ExportAssets exportAssets(java.lang.String parent, com.google.cloudasset.v1beta1.model.ExportAssetsRequest content) throws java.io.IOException {
      ExportAssets result = new ExportAssets(parent, content);
      initialize(result);
      return result;
    }

    public class ExportAssets extends CloudAssetRequest<com.google.cloudasset.v1beta1.model.Operation> {
     ...
     *        (such as "projects/12345").
       ...
       * @since 1.13
       */
      protected ExportAssets(java.lang.String parent, com.google.cloudasset.v1beta1.model.ExportAssetsRequest content) {
        super(CloudAsset.this, "POST", REST_PATH, content, com.google.cloudasset.v1beta1.model.Operation.class);
        this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
              "Parameter parent must conform to the pattern " +
    ...
    public class Operations {
      ...
      public class Get extends CloudAssetRequest<com.google.cloudasset.v1beta1.model.Operation> {
        ...
        protected Get(java.lang.String name) {
          super(CloudAsset.this, "GET", REST_PATH, null, com.google.cloudasset.v1beta1.model.Operation.class);
