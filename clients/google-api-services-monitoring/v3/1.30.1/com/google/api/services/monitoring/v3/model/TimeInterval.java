 ...
 * after the  end time of the previous interval because intervals are closed. If the  start time of
 * a new interval is the same as the end time of the previous  interval, then data written at the
