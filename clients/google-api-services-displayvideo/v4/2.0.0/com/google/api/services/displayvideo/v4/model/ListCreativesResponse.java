...
/**
 * Model definition for ListCreativesResponse.
 *
...
public final class ListCreativesResponse extends com.google.api.client.json.GenericJson {
   ...
   * subsequent call to `ListCreativesRequest` method to retrieve the next page of results. If this
   * field is null, it means this is the last page.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
