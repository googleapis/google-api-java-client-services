...
public final class InPlaceSnapshotList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InPlaceSnapshot> items;

  static {
    // hack to force ProGuard to consider InPlaceSnapshot used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InPlaceSnapshot.class);
  }
   ...
   */
  public InPlaceSnapshotList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InPlaceSnapshot> getItems() {
    return items;
  }
   ...
   */
  public InPlaceSnapshotList setItems(java.util.List<InPlaceSnapshot> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InPlaceSnapshotList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InPlaceSnapshotList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InPlaceSnapshotList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InPlaceSnapshotList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InPlaceSnapshotList set(String fieldName, Object value) {
    return (InPlaceSnapshotList) super.set(fieldName, value);
  }

  @Override
  public InPlaceSnapshotList clone() {
    return (InPlaceSnapshotList) super.clone();
  }
