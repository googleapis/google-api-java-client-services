...
public final class ForwardingRuleList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ForwardingRule> items;

  static {
    // hack to force ProGuard to consider ForwardingRule used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ForwardingRule.class);
  }
   ...
   */
  public ForwardingRuleList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ForwardingRule> getItems() {
    return items;
  }
   ...
   */
  public ForwardingRuleList setItems(java.util.List<ForwardingRule> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ForwardingRuleList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ForwardingRuleList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ForwardingRuleList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ForwardingRuleList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ForwardingRuleList set(String fieldName, Object value) {
    return (ForwardingRuleList) super.set(fieldName, value);
  }

  @Override
  public ForwardingRuleList clone() {
    return (ForwardingRuleList) super.clone();
  }
