...
public final class ScheduleTransferRunsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<TransferRun> getRuns() {
    return runs;
  }
   ...
   */
  public ScheduleTransferRunsResponse setRuns(java.util.List<TransferRun> runs) {
    this.runs = runs;
    return this;
  }

  @Override
  public ScheduleTransferRunsResponse set(String fieldName, Object value) {
    return (ScheduleTransferRunsResponse) super.set(fieldName, value);
  }

  @Override
  public ScheduleTransferRunsResponse clone() {
    return (ScheduleTransferRunsResponse) super.clone();
  }
