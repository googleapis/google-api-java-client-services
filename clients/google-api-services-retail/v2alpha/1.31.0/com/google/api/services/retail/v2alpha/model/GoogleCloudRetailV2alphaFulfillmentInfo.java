...
public final class GoogleCloudRetailV2alphaFulfillmentInfo extends com.google.api.client.json.GenericJson {

  /**
   * The IDs for this type, such as the store IDs for FulfillmentInfo.type.pickup-in-store or the
   * region IDs for FulfillmentInfo.type.same-day-delivery. A maximum of 2000 values are allowed.
   * Each value must be a string with a length limit of 10 characters, matching the pattern
   ...
   */
  public GoogleCloudRetailV2alphaFulfillmentInfo setPlaceIds(java.util.List<java.lang.String> placeIds) {
   ...
   */
  public GoogleCloudRetailV2alphaFulfillmentInfo setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public GoogleCloudRetailV2alphaFulfillmentInfo set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaFulfillmentInfo) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaFulfillmentInfo clone() {
    return (GoogleCloudRetailV2alphaFulfillmentInfo) super.clone();
  }
