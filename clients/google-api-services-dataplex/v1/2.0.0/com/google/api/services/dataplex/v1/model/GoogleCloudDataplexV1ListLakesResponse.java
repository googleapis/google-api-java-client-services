...
public final class GoogleCloudDataplexV1ListLakesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDataplexV1Lake> lakes;

  static {
    // hack to force ProGuard to consider GoogleCloudDataplexV1Lake used, since otherwise it would be stripped out
   ...
   */
  public GoogleCloudDataplexV1ListLakesResponse setLakes(java.util.List<GoogleCloudDataplexV1Lake> lakes) {
    this.lakes = lakes;
    return this;
  }
   ...
   */
  public GoogleCloudDataplexV1ListLakesResponse setUnreachableLocations(java.util.List<java.lang.String> unreachableLocations) {
