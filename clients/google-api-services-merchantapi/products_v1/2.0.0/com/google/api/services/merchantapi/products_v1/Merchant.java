...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class ProductInputs {
       ...
       *        be the base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full resource
       *        name for the product would be `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain
       ...
       *        the two formats.
         ...
         * of the product identifier (like `offer_id`) contains characters such as `/`, `%`, or `~`.
         * * Example: To represent the product ID `en~US~sku/123`, the `{productInput}` segment must
         * be the base64url encoding of this string, which is `ZW5-VVN-c2t1LzEyMw`. The full
         * resource name for the product would be `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`.
       ...
       would be `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{productInput}`
       ...
       *        `accounts/123/productInputs/ZW5-VVN-c2t1LzEyMw`. 2. **Plain Format**: The `{productinput}`
