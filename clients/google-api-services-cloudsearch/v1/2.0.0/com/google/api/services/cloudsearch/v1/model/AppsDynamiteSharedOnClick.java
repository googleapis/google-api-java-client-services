...
/**
 * Model definition for AppsDynamiteSharedOnClick.
 *
...
public final class AppsDynamiteSharedOnClick extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private AppsDynamiteSharedAction openDynamicLinkAction;
   ...
   */
  @com.google.api.client.util.Key
  private AppsDynamiteSharedOpenLink openLink;

  /**
   * If specified, an action is triggered by this onClick.
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedAction getAction() {
    return action;
  }
   ...
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedAction getOpenDynamicLinkAction() {
   ...
   */
  public AppsDynamiteSharedOnClick setOpenDynamicLinkAction(AppsDynamiteSharedAction openDynamicLinkAction) {
   ...
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedOpenLink getOpenLink() {
    return openLink;
  }
   ...
   */
  public AppsDynamiteSharedOnClick setOpenLink(AppsDynamiteSharedOpenLink openLink) {
    this.openLink = openLink;
    return this;
  }

  @Override
  public AppsDynamiteSharedOnClick set(String fieldName, Object value) {
    return (AppsDynamiteSharedOnClick) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedOnClick clone() {
    return (AppsDynamiteSharedOnClick) super.clone();
  }
