...
public final class WebSecurityScannerSettings extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public WebSecurityScannerSettings set(String fieldName, Object value) {
    return (WebSecurityScannerSettings) super.set(fieldName, value);
  }

  @Override
  public WebSecurityScannerSettings clone() {
    return (WebSecurityScannerSettings) super.clone();
  }
