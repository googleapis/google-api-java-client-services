...
public final class GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse setErrorConfig(GoogleCloudDiscoveryengineV1alphaImportErrorConfig errorConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse setErrorSamples(java.util.List<GoogleRpcStatus> errorSamples) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse setJoinedEventsCount(java.lang.Long joinedEventsCount) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse setUnjoinedEventsCount(java.lang.Long unjoinedEventsCount) {
    this.unjoinedEventsCount = unjoinedEventsCount;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse clone() {
    return (GoogleCloudDiscoveryengineV1alphaImportUserEventsResponse) super.clone();
  }
