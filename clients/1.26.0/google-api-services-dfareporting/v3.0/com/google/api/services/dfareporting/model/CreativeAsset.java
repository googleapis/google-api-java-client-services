...
public final class CreativeAsset extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Whether the video asset is active. This is a read-only field for VPAID_NON_LINEAR_VIDEO assets.
   ...
   * types: INSTREAM_VIDEO and VPAID_LINEAR_VIDEO. Value must be greater than or equal to 1.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Detected MIME type for video asset. This is a read-only field. Applicable to the following
   * creative types: INSTREAM_VIDEO and all VPAID.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Detected video duration for video asset. This is a read-only field. Applicable to the following
   * creative types: INSTREAM_VIDEO and all VPAID.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.Float videoDuration;
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Float getVideoDuration() {
   ...
   */
  public CreativeAsset setVideoDuration(java.lang.Float videoDuration) {
