...
public final class ListResourcesResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A token to request the next page of resources from the 'ListResources' method. The value of an
   ...
   */
  public ListResourcesResponse setUnreachable(java.util.List<java.lang.String> unreachable) {
