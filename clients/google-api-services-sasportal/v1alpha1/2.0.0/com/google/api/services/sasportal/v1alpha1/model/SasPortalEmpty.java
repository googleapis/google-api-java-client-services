...
public final class SasPortalEmpty extends com.google.api.client.json.GenericJson {

  @Override
  public SasPortalEmpty set(String fieldName, Object value) {
    return (SasPortalEmpty) super.set(fieldName, value);
  }

  @Override
  public SasPortalEmpty clone() {
    return (SasPortalEmpty) super.clone();
  }
