...
public final class GoogleApiMonitoredResource extends com.google.api.client.json.GenericJson {
   ...
   * `gce_instance`. Some descriptors include the service name in the type; for example, the type of
   * a Datastream stream is `datastream.googleapis.com/Stream`.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleApiMonitoredResource setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public GoogleApiMonitoredResource setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public GoogleApiMonitoredResource set(String fieldName, Object value) {
    return (GoogleApiMonitoredResource) super.set(fieldName, value);
  }

  @Override
  public GoogleApiMonitoredResource clone() {
    return (GoogleApiMonitoredResource) super.clone();
  }
