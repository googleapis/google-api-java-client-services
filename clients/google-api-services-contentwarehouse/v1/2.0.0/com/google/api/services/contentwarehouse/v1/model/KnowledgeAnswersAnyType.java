...
/**
 * Accepts any non-empty value. This is meant for special cases allowing any value or any
 * composition to be valid in a slot. If you are thinking of using this, please contact mrf-team@.
 *
...
public final class KnowledgeAnswersAnyType extends com.google.api.client.json.GenericJson {
   ...
   */
  public KnowledgeAnswersAnyType setComponentSpecificContracts(NlpMeaningComponentSpecificContracts componentSpecificContracts) {
   ...
   */
  public KnowledgeAnswersAnyType setRemodelings(NlpMeaningMeaningRemodelings remodelings) {
    this.remodelings = remodelings;
    return this;
  }

  @Override
  public KnowledgeAnswersAnyType set(String fieldName, Object value) {
    return (KnowledgeAnswersAnyType) super.set(fieldName, value);
  }

  @Override
  public KnowledgeAnswersAnyType clone() {
    return (KnowledgeAnswersAnyType) super.clone();
  }
