...
public final class HttpRequest extends com.google.api.client.json.GenericJson {
   ...
   * is prefixed with "X-Google-Cloud-Tasks-" will be treated as service header. Service headers
   ...
   * Tasks. * User-Agent: This will be set to `"Google-Cloud-Tasks"`. * `X-Google-*`: Google use
