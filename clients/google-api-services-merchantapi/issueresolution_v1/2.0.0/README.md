...
<project>
  <dependencies>
    <dependency>
      ...
      <version>issueresolution_v1-rev20260118-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:issueresolution_v1-rev20260118-2.0.0'
}
```
