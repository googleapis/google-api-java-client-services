...
public final class GoogleCloudDataplexV1ListActionsResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDataplexV1Action> actions;

  static {
    // hack to force ProGuard to consider GoogleCloudDataplexV1Action used, since otherwise it would be stripped out
   ...
   */
  public GoogleCloudDataplexV1ListActionsResponse setActions(java.util.List<GoogleCloudDataplexV1Action> actions) {
