...
public final class SSOProfileCreatedEvent extends com.google.api.client.json.GenericJson {
   ...
   */
  public SSOProfileCreatedEvent setInboundSsoProfileName(java.lang.String inboundSsoProfileName) {
    this.inboundSsoProfileName = inboundSsoProfileName;
    return this;
  }

  @Override
  public SSOProfileCreatedEvent set(String fieldName, Object value) {
    return (SSOProfileCreatedEvent) super.set(fieldName, value);
  }

  @Override
  public SSOProfileCreatedEvent clone() {
    return (SSOProfileCreatedEvent) super.clone();
  }
