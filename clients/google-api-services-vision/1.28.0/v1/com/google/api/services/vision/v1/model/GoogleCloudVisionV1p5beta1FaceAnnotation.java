...
public final class GoogleCloudVisionV1p5beta1FaceAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudVisionV1p5beta1BoundingPoly boundingPoly;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudVisionV1p5beta1BoundingPoly fdBoundingPoly;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVisionV1p5beta1FaceAnnotationLandmark> landmarks;
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setAngerLikelihood(java.lang.String angerLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setBlurredLikelihood(java.lang.String blurredLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setBoundingPoly(GoogleCloudVisionV1p5beta1BoundingPoly boundingPoly) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setDetectionConfidence(java.lang.Float detectionConfidence) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudVisionV1p5beta1BoundingPoly getFdBoundingPoly() {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setFdBoundingPoly(GoogleCloudVisionV1p5beta1BoundingPoly fdBoundingPoly) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setHeadwearLikelihood(java.lang.String headwearLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setJoyLikelihood(java.lang.String joyLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setLandmarkingConfidence(java.lang.Float landmarkingConfidence) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p5beta1FaceAnnotationLandmark> getLandmarks() {
    return landmarks;
  }
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setLandmarks(java.util.List<GoogleCloudVisionV1p5beta1FaceAnnotationLandmark> landmarks) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setPanAngle(java.lang.Float panAngle) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setRollAngle(java.lang.Float rollAngle) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setSorrowLikelihood(java.lang.String sorrowLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setSurpriseLikelihood(java.lang.String surpriseLikelihood) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setTiltAngle(java.lang.Float tiltAngle) {
   ...
   */
  public GoogleCloudVisionV1p5beta1FaceAnnotation setUnderExposedLikelihood(java.lang.String underExposedLikelihood) {
    this.underExposedLikelihood = underExposedLikelihood;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p5beta1FaceAnnotation set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p5beta1FaceAnnotation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p5beta1FaceAnnotation clone() {
    return (GoogleCloudVisionV1p5beta1FaceAnnotation) super.clone();
  }
