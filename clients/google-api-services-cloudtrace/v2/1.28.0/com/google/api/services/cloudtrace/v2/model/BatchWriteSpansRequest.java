...
public final class BatchWriteSpansRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public BatchWriteSpansRequest setSpans(java.util.List<Span> spans) {
    this.spans = spans;
    return this;
  }

  @Override
  public BatchWriteSpansRequest set(String fieldName, Object value) {
    return (BatchWriteSpansRequest) super.set(fieldName, value);
  }

  @Override
  public BatchWriteSpansRequest clone() {
    return (BatchWriteSpansRequest) super.clone();
  }
