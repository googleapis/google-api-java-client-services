 ...
 * to the endpoint group, but does not enable intercept by itself. To enable intercept, the user
 * must also create a network firewall policy containing intercept rules and associate it with the
 * network.
 *
