...
public class Firestore extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Databases {
       ...
       * @param content the {@link com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ExportDocumentsRequest}
       * @return the request
       */
      public ExportDocuments exportDocuments(java.lang.String name, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ExportDocumentsRequest content) throws java.io.IOException {
        ExportDocuments result = new ExportDocuments(name, content);
        initialize(result);
        return result;
      }

      public class ExportDocuments extends FirestoreRequest<com.google.firestore.v1beta1.model.GoogleLongrunningOperation> {
      ...
      `projects/{project_id}/databases/{database_id}`.
         ...
         * @since 1.13
         */
        protected ExportDocuments(java.lang.String name, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ExportDocumentsRequest content) {
          super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.GoogleLongrunningOperation.class);
      ...
      `projects/{project_id}/databases/{database_id}`.
       * @param content the {@link com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ImportDocumentsRequest}
       * @return the request
       */
      public ImportDocuments importDocuments(java.lang.String name, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ImportDocumentsRequest content) throws java.io.IOException {
        ImportDocuments result = new ImportDocuments(name, content);
        initialize(result);
        return result;
      }

      public class ImportDocuments extends FirestoreRequest<com.google.firestore.v1beta1.model.GoogleLongrunningOperation> {
      ...
      `projects/{project_id}/databases/{database_id}`.
         ...
         * @since 1.13
         */
        protected ImportDocuments(java.lang.String name, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ImportDocumentsRequest content) {
          super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.GoogleLongrunningOperation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Documents {
        ...
        `projects/{project_id}/databases/{database_id}`.
         * @param content the {@link com.google.firestore.v1beta1.model.BatchGetDocumentsRequest}
         * @return the request
         */
        public BatchGet batchGet(java.lang.String database, com.google.firestore.v1beta1.model.BatchGetDocumentsRequest content) throws java.io.IOException {
          BatchGet result = new BatchGet(database, content);
          initialize(result);
          return result;
        }

        public class BatchGet extends FirestoreRequest<com.google.firestore.v1beta1.model.BatchGetDocumentsResponse> {
        ...
        `projects/{project_id}/databases/{database_id}`.
           ...
           * @since 1.13
           */
          protected BatchGet(java.lang.String database, com.google.firestore.v1beta1.model.BatchGetDocumentsRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.BatchGetDocumentsResponse.class);
         ...
         * @param database The database name. In the format:
        `projects/{project_id}/databases/{database_id}`.
         * @param content the {@link com.google.firestore.v1beta1.model.BeginTransactionRequest}
         * @return the request
         */
        public BeginTransaction beginTransaction(java.lang.String database, com.google.firestore.v1beta1.model.BeginTransactionRequest content) throws java.io.IOException {
          BeginTransaction result = new BeginTransaction(database, content);
          initialize(result);
          return result;
        }

        public class BeginTransaction extends FirestoreRequest<com.google.firestore.v1beta1.model.BeginTransactionResponse> {
        ...
        `projects/{project_id}/databases/{database_id}`.
           ...
           * @since 1.13
           */
          protected BeginTransaction(java.lang.String database, com.google.firestore.v1beta1.model.BeginTransactionRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.BeginTransactionResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
         ...
         * @param database The database name. In the format:
        `projects/{project_id}/databases/{database_id}`.
         * @param content the {@link com.google.firestore.v1beta1.model.CommitRequest}
         * @return the request
         */
        public Commit commit(java.lang.String database, com.google.firestore.v1beta1.model.CommitRequest content) throws java.io.IOException {
          Commit result = new Commit(database, content);
          initialize(result);
          return result;
        }

        public class Commit extends FirestoreRequest<com.google.firestore.v1beta1.model.CommitResponse> {
        ...
        `projects/{project_id}/databases/{database_id}`.
           ...
           * @since 1.13
           */
          protected Commit(java.lang.String database, com.google.firestore.v1beta1.model.CommitRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.CommitResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
         ...
         * @param content the {@link com.google.firestore.v1beta1.model.Document}
         * @return the request
         */
        public CreateDocument createDocument(java.lang.String parent, java.lang.String collectionId, com.google.firestore.v1beta1.model.Document content) throws java.io.IOException {
          CreateDocument result = new CreateDocument(parent, collectionId, content);
          initialize(result);
          return result;
        }

        public class CreateDocument extends FirestoreRequest<com.google.firestore.v1beta1.model.Document> {
         ...
         *        `projects/{project_id}/databases/{database_id}/documents/chatrooms/{chatroom_id}`
           ...
           * @since 1.13
           */
          protected CreateDocument(java.lang.String parent, java.lang.String collectionId, com.google.firestore.v1beta1.model.Document content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.Document.class);
        ...
        public class Delete extends FirestoreRequest<com.google.firestore.v1beta1.model.Empty> {
         ...
         *        `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
          ...
          protected Delete(java.lang.String name) {
            super(Firestore.this, "DELETE", REST_PATH, null, com.google.firestore.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends FirestoreRequest<com.google.firestore.v1beta1.model.Document> {
         ...
         *        `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
          ...
          protected Get(java.lang.String name) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1beta1.model.Document.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends FirestoreRequest<com.google.firestore.v1beta1.model.ListDocumentsResponse> {
        ...
        or `messages`.
          ...
          protected List(java.lang.String parent, java.lang.String collectionId) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1beta1.model.ListDocumentsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @param content the {@link com.google.firestore.v1beta1.model.ListCollectionIdsRequest}
         * @return the request
         */
        public ListCollectionIds listCollectionIds(java.lang.String parent, com.google.firestore.v1beta1.model.ListCollectionIdsRequest content) throws java.io.IOException {
          ListCollectionIds result = new ListCollectionIds(parent, content);
          initialize(result);
          return result;
        }

        public class ListCollectionIds extends FirestoreRequest<com.google.firestore.v1beta1.model.ListCollectionIdsResponse> {
         ...
         *        `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`
           ...
           * @since 1.13
           */
          protected ListCollectionIds(java.lang.String parent, com.google.firestore.v1beta1.model.ListCollectionIdsRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.ListCollectionIdsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @param database The database name. In the format:
        `projects/{project_id}/databases/{database_id}`.
         * @param content the {@link com.google.firestore.v1beta1.model.ListenRequest}
         * @return the request
         */
        public Listen listen(java.lang.String database, com.google.firestore.v1beta1.model.ListenRequest content) throws java.io.IOException {
          Listen result = new Listen(database, content);
          initialize(result);
          return result;
        }

        public class Listen extends FirestoreRequest<com.google.firestore.v1beta1.model.ListenResponse> {
        ...
        `projects/{project_id}/databases/{database_id}`.
           ...
           * @since 1.13
           */
          protected Listen(java.lang.String database, com.google.firestore.v1beta1.model.ListenRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.ListenResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.firestore.v1beta1.model.Document content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends FirestoreRequest<com.google.firestore.v1beta1.model.Document> {
         ...
         *        `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.firestore.v1beta1.model.Document content) {
            super(Firestore.this, "PATCH", REST_PATH, content, com.google.firestore.v1beta1.model.Document.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param database The database name. In the format:
        `projects/{project_id}/databases/{database_id}`.
         * @param content the {@link com.google.firestore.v1beta1.model.RollbackRequest}
         * @return the request
         */
        public Rollback rollback(java.lang.String database, com.google.firestore.v1beta1.model.RollbackRequest content) throws java.io.IOException {
          Rollback result = new Rollback(database, content);
          initialize(result);
          return result;
        }

        public class Rollback extends FirestoreRequest<com.google.firestore.v1beta1.model.Empty> {
        ...
        `projects/{project_id}/databases/{database_id}`.
           ...
           * @since 1.13
           */
          protected Rollback(java.lang.String database, com.google.firestore.v1beta1.model.RollbackRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.Empty.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
        ...
        `projects/my-project/databases
         *        /my-database/documents/chatrooms/my-chatroom`
         * @param content the {@link com.google.firestore.v1beta1.model.RunQueryRequest}
         * @return the request
         */
        public RunQuery runQuery(java.lang.String parent, com.google.firestore.v1beta1.model.RunQueryRequest content) throws java.io.IOException {
          RunQuery result = new RunQuery(parent, content);
          initialize(result);
          return result;
        }

        public class RunQuery extends FirestoreRequest<com.google.firestore.v1beta1.model.RunQueryResponse> {
         ...
         *        /my-database/documents/chatrooms/my-chatroom`
           ...
           * @since 1.13
           */
          protected RunQuery(java.lang.String parent, com.google.firestore.v1beta1.model.RunQueryRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.RunQueryResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @param content the {@link com.google.firestore.v1beta1.model.WriteRequest}
         * @return the request
         */
        public Write write(java.lang.String database, com.google.firestore.v1beta1.model.WriteRequest content) throws java.io.IOException {
          Write result = new Write(database, content);
          initialize(result);
          return result;
        }

        public class Write extends FirestoreRequest<com.google.firestore.v1beta1.model.WriteResponse> {
         ...
         *        required in the first message.
           ...
           * @since 1.13
           */
          protected Write(java.lang.String database, com.google.firestore.v1beta1.model.WriteRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.WriteResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
      ...
      public class Indexes {
         ...
         *        `projects/{project_id}/databases/{database_id}`
         * @param content the {@link com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1Index}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1Index content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends FirestoreRequest<com.google.firestore.v1beta1.model.GoogleLongrunningOperation> {
         ...
         *        `projects/{project_id}/databases/{database_id}`
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1Index content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1beta1.model.GoogleLongrunningOperation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends FirestoreRequest<com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1Index> {
         ...
         *        `projects/{project_id}/databases/{database_id}/indexes/{index_id}`
           ...
           */
          protected Get(java.lang.String name) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1Index.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends FirestoreRequest<com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ListIndexesResponse> {
        ...
        `projects/{project_id}/databases/{database_id}`
          ...
          protected List(java.lang.String parent) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1beta1.model.GoogleFirestoreAdminV1beta1ListIndexesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
