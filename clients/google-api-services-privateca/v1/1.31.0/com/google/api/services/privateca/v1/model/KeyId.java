...
public final class KeyId extends com.google.api.client.json.GenericJson {
   ...
   */
  public KeyId setKeyId(java.lang.String keyId) {
    this.keyId = keyId;
    return this;
  }

  @Override
  public KeyId set(String fieldName, Object value) {
    return (KeyId) super.set(fieldName, value);
  }

  @Override
  public KeyId clone() {
    return (KeyId) super.clone();
  }
