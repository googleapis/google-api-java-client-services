...
public final class GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setStructuredDataSize(java.lang.Long structuredDataSize) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setStructuredDataUpdateTime(String structuredDataUpdateTime) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setUnstructuredDataSize(java.lang.Long unstructuredDataSize) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setUnstructuredDataUpdateTime(String unstructuredDataUpdateTime) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setWebsiteDataSize(java.lang.Long websiteDataSize) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation setWebsiteDataUpdateTime(String websiteDataUpdateTime) {
    this.websiteDataUpdateTime = websiteDataUpdateTime;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation clone() {
    return (GoogleCloudDiscoveryengineV1alphaDataStoreBillingEstimation) super.clone();
  }
