...
public final class GoogleCloudDocumentaiV1beta3DocumentEntity extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDocumentaiV1beta3DocumentEntity> properties;
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setConfidence(java.lang.Float confidence) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setMentionId(java.lang.String mentionId) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setNonPresent(java.lang.Boolean nonPresent) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setPageAnchor(GoogleCloudDocumentaiV1beta3DocumentPageAnchor pageAnchor) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDocumentaiV1beta3DocumentEntity> getProperties() {
    return properties;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setProperties(java.util.List<GoogleCloudDocumentaiV1beta3DocumentEntity> properties) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setProvenance(GoogleCloudDocumentaiV1beta3DocumentProvenance provenance) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setRedacted(java.lang.Boolean redacted) {
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentEntity setTextAnchor(GoogleCloudDocumentaiV1beta3DocumentTextAnchor textAnchor) {
  ...
  @Override
  public GoogleCloudDocumentaiV1beta3DocumentEntity set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta3DocumentEntity) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta3DocumentEntity clone() {
    return (GoogleCloudDocumentaiV1beta3DocumentEntity) super.clone();
  }
