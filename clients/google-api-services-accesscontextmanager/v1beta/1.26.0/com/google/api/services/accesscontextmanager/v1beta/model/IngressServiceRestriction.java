...
public final class IngressServiceRestriction extends com.google.api.client.json.GenericJson {

  /**
   * The list of APIs usable with a valid Access Level. Must be empty unless 'enable_restriction' is
   * True.
   ...
   */
  public IngressServiceRestriction setAllowedServices(java.util.List<java.lang.String> allowedServices) {
   ...
   */
  public IngressServiceRestriction setEnableRestriction(java.lang.Boolean enableRestriction) {
    this.enableRestriction = enableRestriction;
    return this;
  }

  @Override
  public IngressServiceRestriction set(String fieldName, Object value) {
    return (IngressServiceRestriction) super.set(fieldName, value);
  }

  @Override
  public IngressServiceRestriction clone() {
    return (IngressServiceRestriction) super.clone();
  }
