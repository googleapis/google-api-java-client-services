...
public final class GoogleCloudDialogflowV2beta1QueryResult extends com.google.api.client.json.GenericJson {
   ...
   * MapValue type: - If parameter's entity type is a composite entity: map - Else: depending on
   * parameter value type, could be one of string, number, boolean, null, list or map - MapValue
   * value: - If parameter's entity type is a composite entity: map from composite entity property
