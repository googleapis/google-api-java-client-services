...
public final class GoogleCloudHealthcareV1alpha2FhirRestGcsSource extends com.google.api.client.json.GenericJson {
   ...
   * directory and       its sub-directories. For example,       `gs://my-bucket/my-directory*.dcm`
   * imports all files with .dcm       extensions in `my-directory/` and its sub-directories.  '?'
