...
public final class NetworkEndpointGroupAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public NetworkEndpointGroupAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NetworkEndpointGroupsScopedList> getItems() {
    return items;
  }
   ...
   */
  public NetworkEndpointGroupAggregatedList setItems(java.util.Map<String, NetworkEndpointGroupsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkEndpointGroupAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkEndpointGroupAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkEndpointGroupAggregatedList set(String fieldName, Object value) {
    return (NetworkEndpointGroupAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NetworkEndpointGroupAggregatedList clone() {
    return (NetworkEndpointGroupAggregatedList) super.clone();
  }
