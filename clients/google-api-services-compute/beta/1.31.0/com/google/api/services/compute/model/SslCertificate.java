 ...
 * [Regional](/compute/docs/reference/rest/beta/regionSslCertificates) The sslCertificates are used
 * by: - external HTTPS load balancers - SSL proxy load balancers The regionSslCertificates are used
 * by internal HTTPS load balancers. Optionally, certificate file contents that you upload can
 * contain a set of up to five PEM-encoded certificates. The API call creates an object
