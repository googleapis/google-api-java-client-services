...
public final class DataAccessOptions extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public DataAccessOptions set(String fieldName, Object value) {
    return (DataAccessOptions) super.set(fieldName, value);
  }

  @Override
  public DataAccessOptions clone() {
    return (DataAccessOptions) super.clone();
  }
