...
public abstract class DoubleclicksearchRequest<T> extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<T> {
   ...
   */
  public DoubleclicksearchRequest(
      Doubleclicksearch client, String method, String uriTemplate, Object content, Class<T> responseClass) {
    super(
        client,
        method,
        uriTemplate,
  ...
  /** V1 error format. */
  public DoubleclicksearchRequest<T> set$Xgafv(java.lang.String $Xgafv) {
    this.$Xgafv = $Xgafv;
    return this;
  }
  ...
  /** OAuth access token. */
  public DoubleclicksearchRequest<T> setAccessToken(java.lang.String accessToken) {
  ...
  /** JSONP */
  public DoubleclicksearchRequest<T> setCallback(java.lang.String callback) {
   ...
   * reports. Required unless you provide an OAuth 2.0 token.
   */
  public DoubleclicksearchRequest<T> setKey(java.lang.String key) {
    this.key = key;
    return this;
  }
  ...
  /** Returns response with indentations and line breaks. */
  public DoubleclicksearchRequest<T> setPrettyPrint(java.lang.Boolean prettyPrint) {
   ...
   * assigned to a user, but should not exceed 40 characters.
   */
  public DoubleclicksearchRequest<T> setQuotaUser(java.lang.String quotaUser) {
  ...
  /** Legacy upload protocol for media (e.g. "media", "multipart"). */
  public DoubleclicksearchRequest<T> setUploadType(java.lang.String uploadType) {
  ...
  /** Upload protocol for media (e.g. "raw", "multipart"). */
  public DoubleclicksearchRequest<T> setUploadProtocol(java.lang.String uploadProtocol) {
    this.uploadProtocol = uploadProtocol;
    return this;
  }

  @Override
  public final Doubleclicksearch getAbstractGoogleClient() {
    return (Doubleclicksearch) super.getAbstractGoogleClient();
  }
  ...
  @Override
  public DoubleclicksearchRequest<T> setRequestHeaders(com.google.api.client.http.HttpHeaders headers) {
    return (DoubleclicksearchRequest<T>) super.setRequestHeaders(headers);
  }

  @Override
  public DoubleclicksearchRequest<T> set(String parameterName, Object value) {
    return (DoubleclicksearchRequest<T>) super.set(parameterName, value);
  }
}
