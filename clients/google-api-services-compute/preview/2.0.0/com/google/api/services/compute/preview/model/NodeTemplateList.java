...
public final class NodeTemplateList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NodeTemplate> items;

  static {
    // hack to force ProGuard to consider NodeTemplate used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NodeTemplate.class);
  }
   ...
   */
  public NodeTemplateList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NodeTemplate> getItems() {
    return items;
  }
   ...
   */
  public NodeTemplateList setItems(java.util.List<NodeTemplate> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NodeTemplateList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NodeTemplateList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeTemplateList set(String fieldName, Object value) {
    return (NodeTemplateList) super.set(fieldName, value);
  }

  @Override
  public NodeTemplateList clone() {
    return (NodeTemplateList) super.clone();
  }
