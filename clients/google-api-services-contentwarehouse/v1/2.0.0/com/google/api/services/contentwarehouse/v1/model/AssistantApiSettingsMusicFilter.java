...
public final class AssistantApiSettingsMusicFilter extends com.google.api.client.json.GenericJson {
   ...
   */
  public AssistantApiSettingsMusicFilter setAvailableProviders(java.util.List<java.lang.String> availableProviders) {
   ...
   */
  public AssistantApiSettingsMusicFilter setProviderFilterState(java.lang.String providerFilterState) {
   ...
   */
  public AssistantApiSettingsMusicFilter setState(java.lang.String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public AssistantApiSettingsMusicFilter setWhitelistedProviders(java.util.List<java.lang.String> whitelistedProviders) {
    this.whitelistedProviders = whitelistedProviders;
    return this;
  }

  @Override
  public AssistantApiSettingsMusicFilter set(String fieldName, Object value) {
    return (AssistantApiSettingsMusicFilter) super.set(fieldName, value);
  }

  @Override
  public AssistantApiSettingsMusicFilter clone() {
    return (AssistantApiSettingsMusicFilter) super.clone();
  }
