...
public final class ApigatewayPolicy extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<ApigatewayAuditConfig> auditConfigs;

  static {
    // hack to force ProGuard to consider ApigatewayAuditConfig used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ApigatewayAuditConfig.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ApigatewayBinding> bindings;

  static {
    // hack to force ProGuard to consider ApigatewayBinding used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ApigatewayBinding.class);
  }
   ...
   */
  public java.util.List<ApigatewayAuditConfig> getAuditConfigs() {
    return auditConfigs;
  }
   ...
   */
  public ApigatewayPolicy setAuditConfigs(java.util.List<ApigatewayAuditConfig> auditConfigs) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ApigatewayBinding> getBindings() {
    return bindings;
  }
   ...
   */
  public ApigatewayPolicy setBindings(java.util.List<ApigatewayBinding> bindings) {
   ...
   */
  public ApigatewayPolicy setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @since 1.14
   */
  public ApigatewayPolicy encodeEtag(byte[] etag) {
   ...
   */
  public ApigatewayPolicy setVersion(java.lang.Integer version) {
    this.version = version;
    return this;
  }

  @Override
  public ApigatewayPolicy set(String fieldName, Object value) {
    return (ApigatewayPolicy) super.set(fieldName, value);
  }

  @Override
  public ApigatewayPolicy clone() {
    return (ApigatewayPolicy) super.clone();
  }
