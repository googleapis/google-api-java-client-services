...
public final class LustreReference extends com.google.api.client.json.GenericJson {
   ...
   */
  public LustreReference setLustre(java.lang.String lustre) {
    this.lustre = lustre;
    return this;
  }

  @Override
  public LustreReference set(String fieldName, Object value) {
    return (LustreReference) super.set(fieldName, value);
  }

  @Override
  public LustreReference clone() {
    return (LustreReference) super.clone();
  }
