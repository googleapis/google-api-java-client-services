...
public final class GoogleCloudDocumentaiV1beta1DocumentPageToken extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageToken setDetectedBreak(GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreak detectedBreak) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageToken setDetectedLanguages(java.util.List<GoogleCloudDocumentaiV1beta1DocumentPageDetectedLanguage> detectedLanguages) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageToken setLayout(GoogleCloudDocumentaiV1beta1DocumentPageLayout layout) {
    this.layout = layout;
    return this;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageToken setProvenance(GoogleCloudDocumentaiV1beta1DocumentProvenance provenance) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageToken setStyleInfo(GoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo styleInfo) {
    this.styleInfo = styleInfo;
    return this;
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentPageToken set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta1DocumentPageToken) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentPageToken clone() {
