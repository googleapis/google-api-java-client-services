...
public final class GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest setGroupIds(java.util.List<java.lang.String> groupIds) {
   ...
   */
  public GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest setPolicyNamespace(java.lang.String policyNamespace) {
   ...
   */
  public GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest setPolicyTargetKey(GoogleChromePolicyV1PolicyTargetKey policyTargetKey) {
    this.policyTargetKey = policyTargetKey;
    return this;
  }

  @Override
  public GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest set(String fieldName, Object value) {
    return (GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest clone() {
    return (GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest) super.clone();
  }
