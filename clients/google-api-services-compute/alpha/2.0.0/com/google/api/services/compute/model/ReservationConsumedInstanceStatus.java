...
public final class ReservationConsumedInstanceStatus extends com.google.api.client.json.GenericJson {
  ...
  private LinkageErrors linkageErrors;

  /**
   * A list of issues related to this instance's linkage to the reservation.
   * @return value or {@code null} for none
   */
  public LinkageErrors getLinkageErrors() {
    return linkageErrors;
  }

  /**
   * A list of issues related to this instance's linkage to the reservation.
   * @param linkageErrors linkageErrors or {@code null} for none
   */
  public ReservationConsumedInstanceStatus setLinkageErrors(LinkageErrors linkageErrors) {
    this.linkageErrors = linkageErrors;
    return this;
  }

  @Override
  public ReservationConsumedInstanceStatus set(String fieldName, Object value) {
    return (ReservationConsumedInstanceStatus) super.set(fieldName, value);
  }

  @Override
  public ReservationConsumedInstanceStatus clone() {
    return (ReservationConsumedInstanceStatus) super.clone();
  }

  /**
   * A list of issues related to this instance's linkage to the reservation.
   */
  public static final class LinkageErrors extends com.google.api.client.json.GenericJson {
     ...
     */
    public LinkageErrors setErrors(java.util.List<Errors> errors) {
      this.errors = errors;
      return this;
    }

    @Override
    public LinkageErrors set(String fieldName, Object value) {
      return (LinkageErrors) super.set(fieldName, value);
    }

    @Override
    public LinkageErrors clone() {
      return (LinkageErrors) super.clone();
    }
