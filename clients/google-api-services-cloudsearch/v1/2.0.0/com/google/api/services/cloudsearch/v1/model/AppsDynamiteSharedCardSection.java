...
public final class AppsDynamiteSharedCardSection extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AppsDynamiteSharedWidget> widgets;
   ...
   */
  public AppsDynamiteSharedCardSection setCollapsible(java.lang.Boolean collapsible) {
   ...
   */
  public AppsDynamiteSharedCardSection setHeader(java.lang.String header) {
    this.header = header;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedCardSection setUncollapsibleWidgetsCount(java.lang.Integer uncollapsibleWidgetsCount) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<AppsDynamiteSharedWidget> getWidgets() {
    return widgets;
  }
   ...
   */
  public AppsDynamiteSharedCardSection setWidgets(java.util.List<AppsDynamiteSharedWidget> widgets) {
    this.widgets = widgets;
    return this;
  }

  @Override
  public AppsDynamiteSharedCardSection set(String fieldName, Object value) {
    return (AppsDynamiteSharedCardSection) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedCardSection clone() {
    return (AppsDynamiteSharedCardSection) super.clone();
  }
