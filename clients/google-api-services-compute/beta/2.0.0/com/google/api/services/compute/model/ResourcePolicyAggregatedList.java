...
public final class ResourcePolicyAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, ResourcePoliciesScopedList> items;

  static {
    // hack to force ProGuard to consider ResourcePoliciesScopedList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ResourcePoliciesScopedList.class);
  }
   ...
   */
  public ResourcePolicyAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ResourcePolicyAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, ResourcePoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public ResourcePolicyAggregatedList setItems(java.util.Map<String, ResourcePoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ResourcePolicyAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ResourcePolicyAggregatedList setNextPageToken(java.lang.String nextPageToken) {
  ...
  @Override
  public ResourcePolicyAggregatedList set(String fieldName, Object value) {
    return (ResourcePolicyAggregatedList) super.set(fieldName, value);
  }
