...
/**
 * Model definition for RecoverableSnapshotAggregatedList.
 *
...
public final class RecoverableSnapshotAggregatedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] Type of resource. Always compute#recoverableSnapshotAggregatedList for aggregated
   ...
   */
  public RecoverableSnapshotAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public RecoverableSnapshotAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, RecoverableSnapshotsScopedList> getItems() {
    return items;
  }
   ...
   */
  public RecoverableSnapshotAggregatedList setItems(java.util.Map<String, RecoverableSnapshotsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RecoverableSnapshotAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RecoverableSnapshotAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RecoverableSnapshotAggregatedList set(String fieldName, Object value) {
    return (RecoverableSnapshotAggregatedList) super.set(fieldName, value);
  }

  @Override
  public RecoverableSnapshotAggregatedList clone() {
    return (RecoverableSnapshotAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RecoverableSnapshotAggregatedListWarningData.
     */
