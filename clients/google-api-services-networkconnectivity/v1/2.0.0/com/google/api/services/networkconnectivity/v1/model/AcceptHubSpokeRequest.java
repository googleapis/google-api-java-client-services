...
public final class AcceptHubSpokeRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public AcceptHubSpokeRequest setSpokeUri(java.lang.String spokeUri) {
    this.spokeUri = spokeUri;
    return this;
  }

  @Override
  public AcceptHubSpokeRequest set(String fieldName, Object value) {
    return (AcceptHubSpokeRequest) super.set(fieldName, value);
  }

  @Override
  public AcceptHubSpokeRequest clone() {
    return (AcceptHubSpokeRequest) super.clone();
  }
