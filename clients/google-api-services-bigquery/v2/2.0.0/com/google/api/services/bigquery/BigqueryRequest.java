...
public abstract class BigqueryRequest<T> extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<T> {
   ...
   */
  public BigqueryRequest(
      Bigquery client, String method, String uriTemplate, Object content, Class<T> responseClass) {
    super(
        client,
        method,
        uriTemplate,
  ...
  /** Selector specifying which fields to include in a partial response. */
  public BigqueryRequest<T> setFields(java.lang.String fields) {
    this.fields = fields;
    return this;
  }
   ...
   * reports. Required unless you provide an OAuth 2.0 token.
   */
  public BigqueryRequest<T> setKey(java.lang.String key) {
    this.key = key;
    return this;
  }
  ...
  /** OAuth 2.0 token for the current user. */
  public BigqueryRequest<T> setOauthToken(java.lang.String oauthToken) {
  ...
  /** Returns response with indentations and line breaks. */
  public BigqueryRequest<T> setPrettyPrint(java.lang.Boolean prettyPrint) {
  ...
  public final Bigquery getAbstractGoogleClient() {
    return (Bigquery) super.getAbstractGoogleClient();
  }

  @Override
  public BigqueryRequest<T> setDisableGZipContent(boolean disableGZipContent) {
    return (BigqueryRequest<T>) super.setDisableGZipContent(disableGZipContent);
  }

  @Override
  public BigqueryRequest<T> setRequestHeaders(com.google.api.client.http.HttpHeaders headers) {
    return (BigqueryRequest<T>) super.setRequestHeaders(headers);
  }

  @Override
  public BigqueryRequest<T> set(String parameterName, Object value) {
    return (BigqueryRequest<T>) super.set(parameterName, value);
  }
}
