...
public final class EnrolledService extends com.google.api.client.json.GenericJson {
   ...
   * Google Kubernetes Engine * Organization Policy Serivice * Persistent Disk * Resource Manager *
   * Speaker ID Note: These values are supported as input for legacy purposes, but will not be
   * returned from the API. * all * ga-only * appengine.googleapis.com * bigquery.googleapis.com *
