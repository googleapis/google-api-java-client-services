...
public final class UploadItemRef extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public UploadItemRef set(String fieldName, Object value) {
    return (UploadItemRef) super.set(fieldName, value);
  }

  @Override
  public UploadItemRef clone() {
    return (UploadItemRef) super.clone();
  }
