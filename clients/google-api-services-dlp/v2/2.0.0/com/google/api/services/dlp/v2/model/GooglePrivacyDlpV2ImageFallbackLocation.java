...
public final class GooglePrivacyDlpV2ImageFallbackLocation extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GooglePrivacyDlpV2ImageFallbackLocation set(String fieldName, Object value) {
    return (GooglePrivacyDlpV2ImageFallbackLocation) super.set(fieldName, value);
  }

  @Override
  public GooglePrivacyDlpV2ImageFallbackLocation clone() {
    return (GooglePrivacyDlpV2ImageFallbackLocation) super.clone();
  }
