...
public class ServiceDirectory extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.Location.class);
      ...
      public class List extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Namespaces {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Namespace content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Namespace> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Namespace content) {
            super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Namespace.class);
        ...
        public class Delete extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(ServiceDirectory.this, "DELETE", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Namespace> {
           ...
           */
          protected Get(java.lang.String name) {
            super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.Namespace.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        this field.
         * @param content the {@link com.google.api.services.servicedirectory.v1beta1.model.GetIamPolicyRequest}
         * @return the request
         */
        public GetIamPolicy getIamPolicy(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.GetIamPolicyRequest content) throws java.io.IOException {
          GetIamPolicy result = new GetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class GetIamPolicy extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected GetIamPolicy(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.GetIamPolicyRequest content) {
            super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Policy.class);
        ...
        public class List extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ListNamespacesResponse> {
          ...
          protected List(java.lang.String parent) {
            super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.ListNamespacesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
           ...
           * be `name`, `labels.` for map field, or `attributes.` for attributes field * `` can be
           * `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same
           * as `=` * `` must be the same data type as field * `` can be `AND`, `OR`, `NOT` Examples
           * of valid filters: * `labels.owner` returns namespaces that have a label with the key
           * `owner`, this is the same as `labels:owner` * `labels.owner=sd` returns namespaces that
           * have key/value `owner=sd` * `name>projects/my-project/locations/us-
           * east1/namespaces/namespace-c` returns namespaces that have name that is alphabetically
           * later than the string, so "namespace-e" is returned but "namespace-a" is not *
           * `labels.owner!=sd AND labels.foo=bar` returns namespaces that have `owner` in label key
           * but value is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an
           * empty list. Note that namespace doesn't have a field called "doesnotexist". Since the
           * filter does not match any namespaces, it returns no results *
           * `attributes.managed_registration=true` returns namespaces that are managed by a GCP
         ...
         `labels.` for map field, or `attributes.` for attributes field * `` can be `<`, `>`, `<=`, `>=`,
         `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same as `=` * `` must be the same data
         type as field * `` can be `AND`, `OR`, `NOT` Examples of valid filters: * `labels.owner` returns
         namespaces that have a label with the key `owner`, this is the same as `labels:owner` *
         `labels.owner=sd` returns namespaces that have key/value `owner=sd` * `name>projects/my-
         project/locations/us-east1/namespaces/namespace-c` returns namespaces that have name that is
         alphabetically later than the string, so "namespace-e" is returned but "namespace-a" is not *
         `labels.owner!=sd AND labels.foo=bar` returns namespaces that have `owner` in label key but value
         is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note that
         namespace doesn't have a field called "doesnotexist". Since the filter does not match any
         namespaces, it returns no results * `attributes.managed_registration=true` returns namespaces that
         are managed by a GCP product or service For more information about filtering, see [API
         Filtering](https://aip.dev/160).
           */
          public java.lang.String getFilter() {
            return filter;
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Namespace content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Namespace> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Namespace content) {
            super(ServiceDirectory.this, "PATCH", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Namespace.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.servicedirectory.v1beta1.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.SetIamPolicyRequest content) {
            super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.servicedirectory.v1beta1.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.servicedirectory.v1beta1.model.TestIamPermissionsRequest content) {
            super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        /**
         * An accessor for creating requests from the ServiceWorkloads collection.
         *
         * <p>The typical use is:</p>
         * <pre>
         *   {@code ServiceDirectory servicedirectory = new ServiceDirectory(...);}
         *   {@code ServiceDirectory.ServiceWorkloads.List request = servicedirectory.serviceWorkloads().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        /**
         * The "serviceWorkloads" collection of methods.
         */
        public class ServiceWorkloads {
           ...
           * Gets the IAM Policy for a resource
           *
           * Create a request for the method "serviceWorkloads.getIamPolicy".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
           * operation.
          ...
          public class GetIamPolicy extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Policy> {
            ...
            private final java.util.regex.Pattern RESOURCE_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/namespaces/[^/]+/serviceWorkloads/[^/]+$");
           ...
           * Sets the IAM Policy for a resource
           *
           * Create a request for the method "serviceWorkloads.setIamPolicy".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
           * operation.
           ...
           * Tests IAM permissions for a resource (namespace, service or service workload only).
           *
           * Create a request for the method "serviceWorkloads.testIamPermissions".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
           * operation.
        ...
        public class Services {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Service content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Service> {
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Service content) {
              super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Service.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
          ...
          public class Get extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Service> {
             ...
             */
            protected Get(java.lang.String name) {
              super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.Service.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ListServicesResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.ListServicesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
             ...
             * a GCP product or service For more information about filtering, see [API
             * Filtering](https://aip.dev/160).
             */
            @com.google.api.client.util.Key
            private java.lang.String filter;
            ...
            /** Optional. The filter to list results by. General `filter` string syntax: ` ()` * `` can be `name`
           or `metadata.` for map field * `` can be `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means
           `HAS`, and is roughly the same as `=` * `` must be the same data type as field * `` can be `AND`,
           `OR`, `NOT` Examples of valid filters: * `metadata.owner` returns services that have a metadata
           with the key `owner`, this is the same as `metadata:owner` * `metadata.protocol=gRPC` returns
           services that have key/value `protocol=gRPC` * `name>projects/my-project/locations/us-
           east1/namespaces/my-namespace/services/service-c` returns services that have name that is
           alphabetically later than the string, so "service-e" is returned but "service-a" is not *
           `metadata.owner!=sd AND metadata.foo=bar` returns services that have `owner` in metadata key but
           value is not `sd` AND have key/value `foo=bar` * `doesnotexist.foo=bar` returns an empty list. Note
           that service doesn't have a field called "doesnotexist". Since the filter does not match any
           services, it returns no results * `attributes.managed_registration=true` returns services that are
           managed by a GCP product or service For more information about filtering, see [API
           Filtering](https://aip.dev/160).
             */
            public java.lang.String getFilter() {
              return filter;
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Service content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }

          public class Patch extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Service> {
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Service content) {
              super(ServiceDirectory.this, "PATCH", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Service.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           * @param content the {@link com.google.api.services.servicedirectory.v1beta1.model.ResolveServiceRequest}
           * @return the request
           */
          public Resolve resolve(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.ResolveServiceRequest content) throws java.io.IOException {
            Resolve result = new Resolve(name, content);
            initialize(result);
            return result;
          }

          public class Resolve extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ResolveServiceResponse> {
             ...
             * @since 1.13
             */
            protected Resolve(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.ResolveServiceRequest content) {
              super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.ResolveServiceResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class Endpoints {
             ...
             * @return the request
             */
            public Create create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Endpoint content) throws java.io.IOException {
              Create result = new Create(parent, content);
              initialize(result);
              return result;
            }

            public class Create extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Endpoint> {
               ...
               * @since 1.13
               */
              protected Create(java.lang.String parent, com.google.api.services.servicedirectory.v1beta1.model.Endpoint content) {
                super(ServiceDirectory.this, "POST", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Endpoint.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
            ...
            public class Get extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Endpoint> {
               ...
               */
              protected Get(java.lang.String name) {
                super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.Endpoint.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
            ...
            public class List extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.ListEndpointsResponse> {
               ...
               */
              protected List(java.lang.String parent) {
                super(ServiceDirectory.this, "GET", REST_PATH, null, com.google.api.services.servicedirectory.v1beta1.model.ListEndpointsResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
              ...
              /**
               * Optional. The filter to list results by. General `filter` string syntax: ` ()` * ``
               * can be `name`, `address`, `port`, `metadata.` for map field, or `attributes.` for
               * attributes field * `` can be `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:`
               ...
               * is not * `metadata.owner!=sd AND metadata.foo=bar` returns endpoints that have
               ...
               * endpoints with the corresponding kubernetes_resource_type For more information
              ...
              /** Optional. The filter to list results by. General `filter` string syntax: ` ()` * `` can be `name`,
             `address`, `port`, `metadata.` for map field, or `attributes.` for attributes field * `` can be
             `<`, `>`, `<=`, `>=`, `!=`, `=`, `:`. Of which `:` means `HAS`, and is roughly the same as `=` * ``
             must be the same data type as field * `` can be `AND`, `OR`, `NOT` Examples of valid filters: *
             ...
             * @return the request
             */
            public Patch patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Endpoint content) throws java.io.IOException {
              Patch result = new Patch(name, content);
              initialize(result);
              return result;
            }

            public class Patch extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Endpoint> {
             ...
             *        `projects/locations/namespaces/services/endpoints`.
               ...
               * @since 1.13
               */
              protected Patch(java.lang.String name, com.google.api.services.servicedirectory.v1beta1.model.Endpoint content) {
                super(ServiceDirectory.this, "PATCH", REST_PATH, content, com.google.api.services.servicedirectory.v1beta1.model.Endpoint.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
         ...
         * <pre>
         *   {@code ServiceDirectory servicedirectory = new ServiceDirectory(...);}
         *   {@code ServiceDirectory.Workloads.List request = servicedirectory.workloads().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        public class Workloads {
           ...
           * Gets the IAM Policy for a resource
           *
           * Create a request for the method "workloads.getIamPolicy".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
           * operation.
          ...
          public class GetIamPolicy extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Policy> {
            ...
            private final java.util.regex.Pattern RESOURCE_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/namespaces/[^/]+/workloads/[^/]+$");
           ...
           * Sets the IAM Policy for a resource
           *
           * Create a request for the method "workloads.setIamPolicy".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
           * operation.
           ...
           * Tests IAM permissions for a resource (namespace, service or service workload only).
           *
           * Create a request for the method "workloads.testIamPermissions".
           *
           * This request holds the parameters needed by the servicedirectory server.  After setting any
           * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
           * operation.
      ...
      /**
       * An accessor for creating requests from the RegistrationPolicies collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code ServiceDirectory servicedirectory = new ServiceDirectory(...);}
       *   {@code ServiceDirectory.RegistrationPolicies.List request = servicedirectory.registrationPolicies().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      /**
       * The "registrationPolicies" collection of methods.
       */
      public class RegistrationPolicies {
         ...
         * Gets the IAM Policy for a resource
         *
         * Create a request for the method "registrationPolicies.getIamPolicy".
         *
         * This request holds the parameters needed by the servicedirectory server.  After setting any
         * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
         * operation.
        ...
        public class GetIamPolicy extends ServiceDirectoryRequest<com.google.api.services.servicedirectory.v1beta1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/registrationPolicies/[^/]+$");
         ...
         * Sets the IAM Policy for a resource
         *
         * Create a request for the method "registrationPolicies.setIamPolicy".
         *
         * This request holds the parameters needed by the servicedirectory server.  After setting any
         * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
         * operation.
         ...
         * Tests IAM permissions for a resource (namespace, service or service workload only).
         *
         * Create a request for the method "registrationPolicies.testIamPermissions".
         *
         * This request holds the parameters needed by the servicedirectory server.  After setting any
         * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
         * operation.
