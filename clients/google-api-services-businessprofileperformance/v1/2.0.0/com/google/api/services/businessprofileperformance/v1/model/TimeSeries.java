...
public final class TimeSeries extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<DatedValue> datedValues;

  static {
    // hack to force ProGuard to consider DatedValue used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(DatedValue.class);
  }
   ...
   */
  public java.util.List<DatedValue> getDatedValues() {
    return datedValues;
  }

  /**
   * List of datapoints in the timeseries, where each datapoint is a date-value pair.
   * @param datedValues datedValues or {@code null} for none
   */
  public TimeSeries setDatedValues(java.util.List<DatedValue> datedValues) {
