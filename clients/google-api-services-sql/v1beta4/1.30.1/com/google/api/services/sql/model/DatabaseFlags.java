...
public final class DatabaseFlags extends com.google.api.client.json.GenericJson {
   ...
   * options and system variables for MySQL. Flags are specified with underscores, not hyphens. For
   * more information, see Configuring Database Flags in the Cloud SQL documentation.
  ...
  /**
   * The value of the flag. Booleans are set to on for true and off for false. This field must be
