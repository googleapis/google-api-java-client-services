...
public final class GoogleApiServicecontrolV1ExplicitBuckets extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleApiServicecontrolV1ExplicitBuckets setBounds(java.util.List<java.lang.Double> bounds) {
    this.bounds = bounds;
    return this;
  }

  @Override
  public GoogleApiServicecontrolV1ExplicitBuckets set(String fieldName, Object value) {
    return (GoogleApiServicecontrolV1ExplicitBuckets) super.set(fieldName, value);
  }

  @Override
  public GoogleApiServicecontrolV1ExplicitBuckets clone() {
    return (GoogleApiServicecontrolV1ExplicitBuckets) super.clone();
  }
