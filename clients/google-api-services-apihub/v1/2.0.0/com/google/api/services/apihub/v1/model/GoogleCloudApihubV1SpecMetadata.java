...
public final class GoogleCloudApihubV1SpecMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The spec resource to be pushed to Hub's collect layer. The ID of the spec will be
   * generated by Hub.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudApihubV1SpecMetadata setOriginalCreateTime(String originalCreateTime) {
   ...
   */
  public GoogleCloudApihubV1SpecMetadata setOriginalId(java.lang.String originalId) {
   ...
   */
  public GoogleCloudApihubV1SpecMetadata setOriginalUpdateTime(String originalUpdateTime) {
   ...
   */
  public GoogleCloudApihubV1SpecMetadata setSpec(GoogleCloudApihubV1Spec spec) {
    this.spec = spec;
    return this;
  }

  @Override
  public GoogleCloudApihubV1SpecMetadata set(String fieldName, Object value) {
    return (GoogleCloudApihubV1SpecMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudApihubV1SpecMetadata clone() {
    return (GoogleCloudApihubV1SpecMetadata) super.clone();
  }
