...
public final class BatchRejectPublisherConnectionsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public BatchRejectPublisherConnectionsRequest setNames(java.util.List<java.lang.String> names) {
    this.names = names;
    return this;
  }

  @Override
  public BatchRejectPublisherConnectionsRequest set(String fieldName, Object value) {
    return (BatchRejectPublisherConnectionsRequest) super.set(fieldName, value);
  }

  @Override
  public BatchRejectPublisherConnectionsRequest clone() {
    return (BatchRejectPublisherConnectionsRequest) super.clone();
  }
