 ...
 * @since 1.4
 */
public class AgentRegistryScopes {

  /** See your Google Cloud Agent Registry data and the email address of your Google Account. */
  public static final String AGENTREGISTRY_READ_ONLY = "https://www.googleapis.com/auth/agentregistry.read-only";

  /** See, edit, configure, and delete your Google Cloud Agent Registry data and see the email address for your Google Account. */
  public static final String AGENTREGISTRY_READ_WRITE = "https://www.googleapis.com/auth/agentregistry.read-write";
  ...
  public static java.util.Set<String> all() {
    ...
    set.add(AGENTREGISTRY_READ_ONLY);
    set.add(AGENTREGISTRY_READ_WRITE);
    set.add(CLOUD_PLATFORM);
    set.add(CLOUD_PLATFORM_READ_ONLY);
    return java.util.Collections.unmodifiableSet(set);
  }

  private AgentRegistryScopes() {
  }
}
