...
public final class ReservationSlotsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ReservationSlot> items;

  static {
    // hack to force ProGuard to consider ReservationSlot used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ReservationSlot.class);
  }
   ...
   * results is larger thanmaxResults, use the nextPageToken as a value for the query parameter
   ...
   */
  public ReservationSlotsListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ReservationSlot> getItems() {
    return items;
  }
   ...
   */
  public ReservationSlotsListResponse setItems(java.util.List<ReservationSlot> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationSlotsListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ReservationSlotsListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationSlotsListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReservationSlotsListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationSlotsListResponse set(String fieldName, Object value) {
    return (ReservationSlotsListResponse) super.set(fieldName, value);
  }

  @Override
  public ReservationSlotsListResponse clone() {
    return (ReservationSlotsListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ReservationSlotsListResponseWarningData.
     */
