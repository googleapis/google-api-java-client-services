...
public final class ContextualDeidConfig extends com.google.api.client.json.GenericJson {

  @Override
  public ContextualDeidConfig set(String fieldName, Object value) {
    return (ContextualDeidConfig) super.set(fieldName, value);
  }

  @Override
  public ContextualDeidConfig clone() {
    return (ContextualDeidConfig) super.clone();
  }
