...
public final class ReliabilityRisk extends com.google.api.client.json.GenericJson {
   ...
   */
  public ReliabilityRisk setDescription(java.lang.String description) {
   ...
   */
  public ReliabilityRisk setDetails(RiskDetails details) {
   ...
   */
  public ReliabilityRisk setId(java.math.BigInteger id) {
    this.id = id;
    return this;
  }
   ...
   */
  public ReliabilityRisk setRecommendation(RiskRecommendation recommendation) {
  ...
  @Override
  public ReliabilityRisk set(String fieldName, Object value) {
    return (ReliabilityRisk) super.set(fieldName, value);
  }

  @Override
  public ReliabilityRisk clone() {
    return (ReliabilityRisk) super.clone();
  }
