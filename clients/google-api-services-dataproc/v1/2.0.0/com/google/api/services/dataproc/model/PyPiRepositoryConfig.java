...
public final class PyPiRepositoryConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public PyPiRepositoryConfig set(String fieldName, Object value) {
    return (PyPiRepositoryConfig) super.set(fieldName, value);
  }

  @Override
  public PyPiRepositoryConfig clone() {
    return (PyPiRepositoryConfig) super.clone();
  }
