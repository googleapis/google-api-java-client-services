...
public final class GoogleCloudAiplatformV1beta1ImportDataConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1ImportDataConfig setAnnotationLabels(java.util.Map<String, java.lang.String> annotationLabels) {
   ...
   */
  public GoogleCloudAiplatformV1beta1ImportDataConfig setDataItemLabels(java.util.Map<String, java.lang.String> dataItemLabels) {
   ...
   */
  public GoogleCloudAiplatformV1beta1ImportDataConfig setGcsSource(GoogleCloudAiplatformV1beta1GcsSource gcsSource) {
   ...
   */
  public GoogleCloudAiplatformV1beta1ImportDataConfig setImportSchemaUri(java.lang.String importSchemaUri) {
    this.importSchemaUri = importSchemaUri;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1ImportDataConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1ImportDataConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1ImportDataConfig clone() {
    return (GoogleCloudAiplatformV1beta1ImportDataConfig) super.clone();
  }
