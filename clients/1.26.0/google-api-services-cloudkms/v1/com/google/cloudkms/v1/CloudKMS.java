...
public class CloudKMS extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Key Management Service (KMS) API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudKMSRequest<com.google.cloudkms.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.Location.class);
      ...
      public class List extends CloudKMSRequest<com.google.cloudkms.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class KeyRings {
         ...
         *        `projects/locations`.
         * @param content the {@link com.google.cloudkms.v1.model.KeyRing}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.cloudkms.v1.model.KeyRing content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudKMSRequest<com.google.cloudkms.v1.model.KeyRing> {
         ...
         *        `projects/locations`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.cloudkms.v1.model.KeyRing content) {
            super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.KeyRing.class);
        ...
        public class Get extends CloudKMSRequest<com.google.cloudkms.v1.model.KeyRing> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.KeyRing.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class GetIamPolicy extends CloudKMSRequest<com.google.cloudkms.v1.model.Policy> {
         ...
         *        the appropriate value for this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.Policy.class);
        ...
        public class List extends CloudKMSRequest<com.google.cloudkms.v1.model.ListKeyRingsResponse> {
         ...
         *        `projects/locations`.
          ...
          protected List(java.lang.String parent) {
            super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.ListKeyRingsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        See the operation documentation for
         *        the appropriate value for this field.
         * @param content the {@link com.google.cloudkms.v1.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.cloudkms.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends CloudKMSRequest<com.google.cloudkms.v1.model.Policy> {
         ...
         *        the appropriate value for this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.cloudkms.v1.model.SetIamPolicyRequest content) {
            super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        See the operation
         *        documentation for the appropriate value for this field.
         * @param content the {@link com.google.cloudkms.v1.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.cloudkms.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends CloudKMSRequest<com.google.cloudkms.v1.model.TestIamPermissionsResponse> {
         ...
         *        documentation for the appropriate value for this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.cloudkms.v1.model.TestIamPermissionsRequest content) {
            super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        public class CryptoKeys {
          ...
          CryptoKeys.
           * @param content the {@link com.google.cloudkms.v1.model.CryptoKey}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.cloudkms.v1.model.CryptoKey content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKey> {
          ...
          CryptoKeys.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.cloudkms.v1.model.CryptoKey content) {
              super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKey.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           *        appropriate version.
           * @param content the {@link com.google.cloudkms.v1.model.DecryptRequest}
           * @return the request
           */
          public Decrypt decrypt(java.lang.String name, com.google.cloudkms.v1.model.DecryptRequest content) throws java.io.IOException {
            Decrypt result = new Decrypt(name, content);
            initialize(result);
            return result;
          }

          public class Decrypt extends CloudKMSRequest<com.google.cloudkms.v1.model.DecryptResponse> {
           ...
           *        appropriate version.
             ...
             * @since 1.13
             */
            protected Decrypt(java.lang.String name, com.google.cloudkms.v1.model.DecryptRequest content) {
              super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.DecryptResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          primary version.
           * @param content the {@link com.google.cloudkms.v1.model.EncryptRequest}
           * @return the request
           */
          public Encrypt encrypt(java.lang.String name, com.google.cloudkms.v1.model.EncryptRequest content) throws java.io.IOException {
            Encrypt result = new Encrypt(name, content);
            initialize(result);
            return result;
          }

          public class Encrypt extends CloudKMSRequest<com.google.cloudkms.v1.model.EncryptResponse> {
          ...
          primary version.
             ...
             * @since 1.13
             */
            protected Encrypt(java.lang.String name, com.google.cloudkms.v1.model.EncryptRequest content) {
              super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.EncryptResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class Get extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKey> {
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.CryptoKey.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudKMSRequest<com.google.cloudkms.v1.model.ListCryptoKeysResponse> {
          ...
          `projects/locations/keyRings`.
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.ListCryptoKeysResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.cloudkms.v1.model.CryptoKey content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }

          public class Patch extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKey> {
           ...
           *        `projects/locations/keyRings/cryptoKeys`.
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.cloudkms.v1.model.CryptoKey content) {
              super(CloudKMS.this, "PATCH", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKey.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           * @param content the {@link com.google.cloudkms.v1.model.UpdateCryptoKeyPrimaryVersionRequest}
           * @return the request
           */
          public UpdatePrimaryVersion updatePrimaryVersion(java.lang.String name, com.google.cloudkms.v1.model.UpdateCryptoKeyPrimaryVersionRequest content) throws java.io.IOException {
            UpdatePrimaryVersion result = new UpdatePrimaryVersion(name, content);
            initialize(result);
            return result;
          }

          public class UpdatePrimaryVersion extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKey> {
             ...
             * @since 1.13
             */
            protected UpdatePrimaryVersion(java.lang.String name, com.google.cloudkms.v1.model.UpdateCryptoKeyPrimaryVersionRequest content) {
              super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKey.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
          ...
          public class CryptoKeyVersions {
            ...
            decryption.
             * @param content the {@link com.google.cloudkms.v1.model.AsymmetricDecryptRequest}
             * @return the request
             */
            public AsymmetricDecrypt asymmetricDecrypt(java.lang.String name, com.google.cloudkms.v1.model.AsymmetricDecryptRequest content) throws java.io.IOException {
              AsymmetricDecrypt result = new AsymmetricDecrypt(name, content);
              initialize(result);
              return result;
            }

            public class AsymmetricDecrypt extends CloudKMSRequest<com.google.cloudkms.v1.model.AsymmetricDecryptResponse> {
            ...
            decryption.
               ...
               * @since 1.13
               */
              protected AsymmetricDecrypt(java.lang.String name, com.google.cloudkms.v1.model.AsymmetricDecryptRequest content) {
                super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.AsymmetricDecryptResponse.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
             ...
             * @param content the {@link com.google.cloudkms.v1.model.AsymmetricSignRequest}
             * @return the request
             */
            public AsymmetricSign asymmetricSign(java.lang.String name, com.google.cloudkms.v1.model.AsymmetricSignRequest content) throws java.io.IOException {
              AsymmetricSign result = new AsymmetricSign(name, content);
              initialize(result);
              return result;
            }

            public class AsymmetricSign extends CloudKMSRequest<com.google.cloudkms.v1.model.AsymmetricSignResponse> {
               ...
               * @since 1.13
               */
              protected AsymmetricSign(java.lang.String name, com.google.cloudkms.v1.model.AsymmetricSignRequest content) {
                super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.AsymmetricSignResponse.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
             ...
             * @param content the {@link com.google.cloudkms.v1.model.CryptoKeyVersion}
             * @return the request
             */
            public Create create(java.lang.String parent, com.google.cloudkms.v1.model.CryptoKeyVersion content) throws java.io.IOException {
              Create result = new Create(parent, content);
              initialize(result);
              return result;
            }

            public class Create extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKeyVersion> {
            ...
            the CryptoKeyVersions.
               ...
               * @since 1.13
               */
              protected Create(java.lang.String parent, com.google.cloudkms.v1.model.CryptoKeyVersion content) {
                super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKeyVersion.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
             ...
             * @param content the {@link com.google.cloudkms.v1.model.DestroyCryptoKeyVersionRequest}
             * @return the request
             */
            public Destroy destroy(java.lang.String name, com.google.cloudkms.v1.model.DestroyCryptoKeyVersionRequest content) throws java.io.IOException {
              Destroy result = new Destroy(name, content);
              initialize(result);
              return result;
            }

            public class Destroy extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKeyVersion> {
               ...
               * @since 1.13
               */
              protected Destroy(java.lang.String name, com.google.cloudkms.v1.model.DestroyCryptoKeyVersionRequest content) {
                super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKeyVersion.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
            ...
            public class Get extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKeyVersion> {
               ...
               */
              protected Get(java.lang.String name) {
                super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.CryptoKeyVersion.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
            ...
            public class GetPublicKey extends CloudKMSRequest<com.google.cloudkms.v1.model.PublicKey> {
            ...
            get.
              ...
              protected GetPublicKey(java.lang.String name) {
                super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.PublicKey.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
            ...
            public class List extends CloudKMSRequest<com.google.cloudkms.v1.model.ListCryptoKeyVersionsResponse> {
             ...
             *        `projects/locations/keyRings/cryptoKeys`.
               ...
               */
              protected List(java.lang.String parent) {
                super(CloudKMS.this, "GET", REST_PATH, null, com.google.cloudkms.v1.model.ListCryptoKeyVersionsResponse.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                      "Parameter parent must conform to the pattern " +
             ...
             * @return the request
             */
            public Patch patch(java.lang.String name, com.google.cloudkms.v1.model.CryptoKeyVersion content) throws java.io.IOException {
              Patch result = new Patch(name, content);
              initialize(result);
              return result;
            }

            public class Patch extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKeyVersion> {
             ...
             *        `projects/locations/keyRings/cryptoKeys/cryptoKeyVersions`.
               ...
               * @since 1.13
               */
              protected Patch(java.lang.String name, com.google.cloudkms.v1.model.CryptoKeyVersion content) {
                super(CloudKMS.this, "PATCH", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKeyVersion.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                      "Parameter name must conform to the pattern " +
             ...
             * @param content the {@link com.google.cloudkms.v1.model.RestoreCryptoKeyVersionRequest}
             * @return the request
             */
            public Restore restore(java.lang.String name, com.google.cloudkms.v1.model.RestoreCryptoKeyVersionRequest content) throws java.io.IOException {
              Restore result = new Restore(name, content);
              initialize(result);
              return result;
            }

            public class Restore extends CloudKMSRequest<com.google.cloudkms.v1.model.CryptoKeyVersion> {
               ...
               * @since 1.13
               */
              protected Restore(java.lang.String name, com.google.cloudkms.v1.model.RestoreCryptoKeyVersionRequest content) {
                super(CloudKMS.this, "POST", REST_PATH, content, com.google.cloudkms.v1.model.CryptoKeyVersion.class);
                this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
