...
public final class GoogleAppsDriveLabelsV2UserInfo extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleAppsDriveLabelsV2UserInfo set(String fieldName, Object value) {
    return (GoogleAppsDriveLabelsV2UserInfo) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsDriveLabelsV2UserInfo clone() {
    return (GoogleAppsDriveLabelsV2UserInfo) super.clone();
  }
