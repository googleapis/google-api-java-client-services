...
public final class GoogleCloudDiscoveryengineV1CheckGroundingRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1GroundingFact> facts;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1CheckGroundingSpec groundingSpec;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1GroundingFact> getFacts() {
    return facts;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1CheckGroundingRequest setFacts(java.util.List<GoogleCloudDiscoveryengineV1GroundingFact> facts) {
    this.facts = facts;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1CheckGroundingSpec getGroundingSpec() {
   ...
   */
  public GoogleCloudDiscoveryengineV1CheckGroundingRequest setGroundingSpec(GoogleCloudDiscoveryengineV1CheckGroundingSpec groundingSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1CheckGroundingRequest setUserLabels(java.util.Map<String, java.lang.String> userLabels) {
    this.userLabels = userLabels;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1CheckGroundingRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1CheckGroundingRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1CheckGroundingRequest clone() {
    return (GoogleCloudDiscoveryengineV1CheckGroundingRequest) super.clone();
  }
