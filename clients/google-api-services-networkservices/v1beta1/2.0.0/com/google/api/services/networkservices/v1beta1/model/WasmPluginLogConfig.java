...
/**
 * Specifies the logging options for the activity performed by this `WasmPlugin`. If logging is
 * enabled, plugin logs are exported to Cloud Logging.
 *
...
public final class WasmPluginLogConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Specifies whether to enable logging for activity by this `WasmPlugin`. Defaults to
   * `false`.
   ...
   * code. This field is can be set only if logging is enabled for the `WasmPlugin` resource. If the
   * field is not provided when logging is enabled, it is set to `INFO` by default.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
