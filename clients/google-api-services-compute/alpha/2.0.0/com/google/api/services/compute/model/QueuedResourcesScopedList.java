...
/**
 * Model definition for QueuedResourcesScopedList.
 *
...
public final class QueuedResourcesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<QueuedResource> queuedResources;

  static {
    // hack to force ProGuard to consider QueuedResource used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(QueuedResource.class);
  }
   ...
   */
  public java.util.List<QueuedResource> getQueuedResources() {
    return queuedResources;
  }

  /**
   * List of QueuedResources contained in this scope.
   * @param queuedResources queuedResources or {@code null} for none
   */
  public QueuedResourcesScopedList setQueuedResources(java.util.List<QueuedResource> queuedResources) {
   ...
   */
  public QueuedResourcesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public QueuedResourcesScopedList set(String fieldName, Object value) {
    return (QueuedResourcesScopedList) super.set(fieldName, value);
  }

  @Override
  public QueuedResourcesScopedList clone() {
    return (QueuedResourcesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for QueuedResourcesScopedListWarningData.
     */
