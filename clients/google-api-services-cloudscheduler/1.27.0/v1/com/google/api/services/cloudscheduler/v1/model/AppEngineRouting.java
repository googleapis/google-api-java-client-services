...
public final class AppEngineRouting extends com.google.api.client.json.GenericJson {
   ...
   * associated with the   job's project ID.
   *
   * * `service =` service
   *
   * * `version =` version
   ...
   *
   * If service is empty, then the job will be sent to the service which is the default service when
   * the job is attempted.
   *
   * If version is empty, then the job will be sent to the version which is the default version when
   * the job is attempted.
   *
   * If instance is empty, then the job will be sent to an instance which is available when the job
   * is attempted.
   *
   * If service, version, or instance is invalid, then the job will be sent to the default version
   ...
   * App service.
   *
   * By default, the job is sent to the service which is the default service when the job is
   * attempted.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * App version.
   *
   * By default, the job is sent to the version which is the default version when the job is
   * attempted.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
