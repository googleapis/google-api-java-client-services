...
public final class ReportsConfiguration extends com.google.api.client.json.GenericJson {
   ...
   * - "16" for "America/Asuncion"  - "17" for "America/Chicago"  - "18" for "America/Denver"  -
   * "19" for "America/St_Johns"  - "20" for "Asia/Dhaka"  - "21" for "Asia/Jakarta"  - "22" for
   * "Asia/Kabul"  - "23" for "Asia/Karachi"  - "24" for "Asia/Calcutta"  - "25" for
