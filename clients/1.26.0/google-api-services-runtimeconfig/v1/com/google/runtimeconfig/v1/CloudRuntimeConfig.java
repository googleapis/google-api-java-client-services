...
public class CloudRuntimeConfig extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Operations {
     ...
     * @param content the {@link com.google.runtimeconfig.v1.model.CancelOperationRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.runtimeconfig.v1.model.CancelOperationRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends CloudRuntimeConfigRequest<com.google.runtimeconfig.v1.model.Empty> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.runtimeconfig.v1.model.CancelOperationRequest content) {
        super(CloudRuntimeConfig.this, "POST", REST_PATH, content, com.google.runtimeconfig.v1.model.Empty.class);
    ...
    public class Delete extends CloudRuntimeConfigRequest<com.google.runtimeconfig.v1.model.Empty> {
      ...
      protected Delete(java.lang.String name) {
        super(CloudRuntimeConfig.this, "DELETE", REST_PATH, null, com.google.runtimeconfig.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudRuntimeConfigRequest<com.google.runtimeconfig.v1.model.ListOperationsResponse> {
      ...
      protected List(java.lang.String name) {
        super(CloudRuntimeConfig.this, "GET", REST_PATH, null, com.google.runtimeconfig.v1.model.ListOperationsResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
