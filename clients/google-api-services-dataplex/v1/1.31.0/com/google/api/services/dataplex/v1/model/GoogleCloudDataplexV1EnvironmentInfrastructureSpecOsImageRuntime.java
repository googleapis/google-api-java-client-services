...
public final class GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.lang.String> javaLibraries;

  /**
   * Optional. Spark properties to provide configuration for use in sessions created for this
   * environment. The properties to set on daemon config files. Property keys are specified in
   ...
   */
  public GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime setJavaLibraries(java.util.List<java.lang.String> javaLibraries) {
   ...
   */
  public GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime setProperties(java.util.Map<String, java.lang.String> properties) {
   ...
   */
  public GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime setPythonPackages(java.util.List<java.lang.String> pythonPackages) {
    this.pythonPackages = pythonPackages;
    return this;
  }

  @Override
  public GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime set(String fieldName, Object value) {
    return (GoogleCloudDataplexV1EnvironmentInfrastructureSpecOsImageRuntime) super.set(fieldName, value);
  }
