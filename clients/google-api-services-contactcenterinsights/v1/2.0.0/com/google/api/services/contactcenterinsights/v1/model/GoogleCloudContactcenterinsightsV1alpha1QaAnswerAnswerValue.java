...
/**
 * Message for holding the value of the answer. QaQuestion.AnswerChoice defines the possible answer
...
public final class GoogleCloudContactcenterinsightsV1alpha1QaAnswerAnswerValue extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Normalized score of the questions. Calculated as score / potential_score iff
   * potential_score != 0 else 0
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
