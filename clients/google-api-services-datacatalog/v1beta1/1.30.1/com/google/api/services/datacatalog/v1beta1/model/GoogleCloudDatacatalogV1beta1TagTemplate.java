...
/**
 * A tag template defines the schema of the tags used to attach to Data Catalog resources. It
 * defines the mapping of accepted field names and types that can be used within the tag. The tag
 * template also controls the access to the tag.
 *
