...
public class Games extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the GameStats collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Games games = new Games(...);}
  ...
  public class GameStats {
    ...
    public class BatchRecordEvents extends GamesRequest<com.google.api.services.games.model.BatchRecordEventsResponse> {
      ...
      private static final String REST_PATH = "games/v1/players/{playerId}/gameStats:batchRecordEvents";
