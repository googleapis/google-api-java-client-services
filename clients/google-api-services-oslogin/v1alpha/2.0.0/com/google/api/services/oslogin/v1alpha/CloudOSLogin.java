...
public class CloudOSLogin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Users {
    ...
    public class ImportSshPublicKey extends CloudOSLoginRequest<com.google.api.services.oslogin.v1alpha.model.ImportSshPublicKeyResponse> {
      ...
      /**
       * Optional. The regions to wait for a POSIX account to be written to before returning a
       * response. If unspecified, defaults to all regions. Regions are listed at
    ...
    public class SshPublicKeys {
       ...
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.oslogin.v1alpha.model.SshPublicKey content) throws java.io.IOException {
      ...
      public class Create extends CloudOSLoginRequest<com.google.api.services.oslogin.v1alpha.model.SshPublicKey> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.oslogin.v1alpha.model.SshPublicKey content) {
          super(CloudOSLogin.this, "POST", REST_PATH, content, com.google.api.services.oslogin.v1alpha.model.SshPublicKey.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
