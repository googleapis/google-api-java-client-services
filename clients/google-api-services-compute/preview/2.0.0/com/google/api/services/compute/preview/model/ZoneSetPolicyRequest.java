...
public final class ZoneSetPolicyRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public ZoneSetPolicyRequest setBindings(java.util.List<Binding> bindings) {
   ...
   */
  public ZoneSetPolicyRequest setPolicy(Policy policy) {
    this.policy = policy;
    return this;
  }

  @Override
  public ZoneSetPolicyRequest set(String fieldName, Object value) {
    return (ZoneSetPolicyRequest) super.set(fieldName, value);
  }

  @Override
  public ZoneSetPolicyRequest clone() {
    return (ZoneSetPolicyRequest) super.clone();
  }
