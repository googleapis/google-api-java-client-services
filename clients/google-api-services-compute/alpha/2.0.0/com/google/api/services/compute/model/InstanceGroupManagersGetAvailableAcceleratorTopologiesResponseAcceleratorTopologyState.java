...
public final class InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState extends com.google.api.client.json.GenericJson {
   ...
   * the topology. This is set in ConfigureAcceleratorTopologies. If it is provided on activating
   * the sub-slice it will have to be provided on deactivating as well. This identifier is cleared
   * on successful deform of a sub-slice.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState setCurrentState(java.lang.String currentState) {
   ...
   */
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState setError(Error error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Timestamp when the last error happened
   * @param errorTimestamp errorTimestamp or {@code null} for none
   */
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState setErrorTimestamp(String errorTimestamp) {
   ...
   */
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState setExternalId(java.lang.String externalId) {
    this.externalId = externalId;
    return this;
  }

  @Override
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState set(String fieldName, Object value) {
    return (InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState) super.set(fieldName, value);
  }

  @Override
  public InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState clone() {
    return (InstanceGroupManagersGetAvailableAcceleratorTopologiesResponseAcceleratorTopologyState) super.clone();
  }
