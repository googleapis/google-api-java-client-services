...
public final class HttpsTrigger extends com.google.api.client.json.GenericJson {
   ...
   */
  public HttpsTrigger setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public HttpsTrigger set(String fieldName, Object value) {
    return (HttpsTrigger) super.set(fieldName, value);
  }

  @Override
  public HttpsTrigger clone() {
    return (HttpsTrigger) super.clone();
  }
