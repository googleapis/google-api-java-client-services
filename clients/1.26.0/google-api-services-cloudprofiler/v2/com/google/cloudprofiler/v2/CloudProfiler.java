...
package com.google.cloudprofiler.v2;
...
public class CloudProfiler extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Stackdriver Profiler API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Profiles {
       ...
       * @param content the {@link com.google.cloudprofiler.v2.model.CreateProfileRequest}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.cloudprofiler.v2.model.CreateProfileRequest content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudProfilerRequest<com.google.cloudprofiler.v2.model.Profile> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.cloudprofiler.v2.model.CreateProfileRequest content) {
          super(CloudProfiler.this, "POST", REST_PATH, content, com.google.cloudprofiler.v2.model.Profile.class);
       ...
       *
       * @param parent Parent project to create the profile in.
       * @param content the {@link com.google.cloudprofiler.v2.model.Profile}
       * @return the request
       */
      public CreateOffline createOffline(java.lang.String parent, com.google.cloudprofiler.v2.model.Profile content) throws java.io.IOException {
        CreateOffline result = new CreateOffline(parent, content);
        initialize(result);
        return result;
      }

      public class CreateOffline extends CloudProfilerRequest<com.google.cloudprofiler.v2.model.Profile> {
         ...
         * @since 1.13
         */
        protected CreateOffline(java.lang.String parent, com.google.cloudprofiler.v2.model.Profile content) {
          super(CloudProfiler.this, "POST", REST_PATH, content, com.google.cloudprofiler.v2.model.Profile.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.cloudprofiler.v2.model.Profile content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudProfilerRequest<com.google.cloudprofiler.v2.model.Profile> {
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.cloudprofiler.v2.model.Profile content) {
          super(CloudProfiler.this, "PATCH", REST_PATH, content, com.google.cloudprofiler.v2.model.Profile.class);
