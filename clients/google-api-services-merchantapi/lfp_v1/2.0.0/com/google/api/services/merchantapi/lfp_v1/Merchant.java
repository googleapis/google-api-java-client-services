...
package com.google.api.services.merchantapi.lfp_v1;

/**
 * Service definition for Merchant (lfp_v1).
 *
 * <p>
...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class LfpInventories {
       ...
       * @param content the {@link com.google.api.services.merchantapi.lfp_v1.model.LfpInventory}
       * @return the request
       */
      public Insert insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpInventory content) throws java.io.IOException {
        Insert result = new Insert(parent, content);
        initialize(result);
        return result;
      }

      public class Insert extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.LfpInventory> {

        private static final String REST_PATH = "lfp/v1/{+parent}/lfpInventories:insert";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpInventory content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.lfp_v1.model.LfpInventory.class);
    ...
    public class LfpMerchantStates {
      ...
      public class Get extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.LfpMerchantState> {

        private static final String REST_PATH = "lfp/v1/{+name}";
       ...
       *        `accounts/123456/lfpMerchantStates/567890`.
        ...
        protected Get(java.lang.String name) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.lfp_v1.model.LfpMerchantState.class);
    ...
    public class LfpSales {
       ...
       * @param content the {@link com.google.api.services.merchantapi.lfp_v1.model.LfpSale}
       * @return the request
       */
      public Insert insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpSale content) throws java.io.IOException {
        Insert result = new Insert(parent, content);
        initialize(result);
        return result;
      }

      public class Insert extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.LfpSale> {

        private static final String REST_PATH = "lfp/v1/{+parent}/lfpSales:insert";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpSale content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.lfp_v1.model.LfpSale.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
    ...
    public class LfpStores {
      ...
      public class Delete extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.Empty> {
       ...
       *        `accounts/{account}/lfpStores/{target_merchant}~{store_code}`
        ...
        protected Delete(java.lang.String name) {
          super(Merchant.this, "DELETE", REST_PATH, null, com.google.api.services.merchantapi.lfp_v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.LfpStore> {
       ...
       *        `accounts/{account}/lfpStores/{target_merchant}~{store_code}`
         ...
         */
        protected Get(java.lang.String name) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.lfp_v1.model.LfpStore.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *
       * @param parent Required. The LFP provider account Format: `accounts/{account}`
       * @param content the {@link com.google.api.services.merchantapi.lfp_v1.model.LfpStore}
       * @return the request
       */
      public Insert insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpStore content) throws java.io.IOException {
        Insert result = new Insert(parent, content);
        initialize(result);
        return result;
      }

      public class Insert extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.LfpStore> {

        private static final String REST_PATH = "lfp/v1/{+parent}/lfpStores:insert";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String parent, com.google.api.services.merchantapi.lfp_v1.model.LfpStore content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.lfp_v1.model.LfpStore.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class List extends MerchantRequest<com.google.api.services.merchantapi.lfp_v1.model.ListLfpStoresResponse> {

        private static final String REST_PATH = "lfp/v1/{+parent}/lfpStores";
        ...
        protected List(java.lang.String parent) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.lfp_v1.model.ListLfpStoresResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
