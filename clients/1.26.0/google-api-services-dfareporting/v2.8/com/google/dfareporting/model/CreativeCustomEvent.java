...
public final class CreativeCustomEvent extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.lang.String exitUrl;
   ...
   * @return value or {@code null} for none
   */
  public java.lang.String getExitUrl() {
    return exitUrl;
  }

  /**
   * Exit URL of the event. This field is used only for exit events.
   * @param exitUrl exitUrl or {@code null} for none
   */
  public CreativeCustomEvent setExitUrl(java.lang.String exitUrl) {
