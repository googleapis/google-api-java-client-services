...
/**
 * For a `SelectionInput` widget that uses a multiselect menu, a data source from a Google Workspace
 * application. The data source populates selection items for the multiselect menu. [Google Chat
