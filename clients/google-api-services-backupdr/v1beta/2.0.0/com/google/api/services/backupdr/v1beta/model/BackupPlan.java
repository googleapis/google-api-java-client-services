...
public final class BackupPlan extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Defines optional properties specific to backups of compute instance based resources,
   * such as Compute Engine Instances. This includes settings like whether to perform a guest flush.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
