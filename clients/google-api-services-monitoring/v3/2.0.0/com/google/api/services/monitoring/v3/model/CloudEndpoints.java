...
public final class CloudEndpoints extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CloudEndpoints set(String fieldName, Object value) {
    return (CloudEndpoints) super.set(fieldName, value);
  }

  @Override
  public CloudEndpoints clone() {
    return (CloudEndpoints) super.clone();
  }
