...
public final class ListAttachmentsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The token to retrieve the next page of attachments, or empty if there are no more attachments
   * to return.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  @Override
  public ListAttachmentsResponse set(String fieldName, Object value) {
    return (ListAttachmentsResponse) super.set(fieldName, value);
  }

  @Override
  public ListAttachmentsResponse clone() {
    return (ListAttachmentsResponse) super.clone();
  }
