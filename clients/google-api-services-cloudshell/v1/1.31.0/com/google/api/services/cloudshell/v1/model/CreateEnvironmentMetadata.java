...
public final class CreateEnvironmentMetadata extends com.google.api.client.json.GenericJson {

  @Override
  public CreateEnvironmentMetadata set(String fieldName, Object value) {
    return (CreateEnvironmentMetadata) super.set(fieldName, value);
  }

  @Override
  public CreateEnvironmentMetadata clone() {
    return (CreateEnvironmentMetadata) super.clone();
  }
