...
public class Networkconnectivity extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Network Connectivity API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      /**
       * An accessor for creating requests from the ServiceConnectPolicies collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code Networkconnectivity networkconnectivity = new Networkconnectivity(...);}
       *   {@code Networkconnectivity.ServiceConnectPolicies.List request = networkconnectivity.serviceConnectPolicies().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public ServiceConnectPolicies serviceConnectPolicies() {
        return new ServiceConnectPolicies();
      }

      /**
       * The "serviceConnectPolicies" collection of methods.
       */
      public class ServiceConnectPolicies {

        /**
         * Gets the access control policy for a resource. Returns an empty policy if the resource exists and
         * does not have a policy set.
         *
         * Create a request for the method "serviceConnectPolicies.getIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
         * operation.
        ...
        public class GetIamPolicy extends NetworkconnectivityRequest<com.google.api.services.networkconnectivity.v1alpha1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/serviceConnectPolicies/[^/]+$");
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "serviceConnectPolicies.setIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
         * operation.
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "serviceConnectPolicies.testIamPermissions".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
         * operation.
       ...
       * <pre>
       *   {@code Networkconnectivity networkconnectivity = new Networkconnectivity(...);}
       *   {@code Networkconnectivity.ServiceInstances.List request = networkconnectivity.serviceInstances().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      /**
       * The "serviceInstances" collection of methods.
       */
      public class ServiceInstances {
         ...
         * does not have a policy set.
         *
         * Create a request for the method "serviceInstances.getIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
         * operation.
        ...
        public class GetIamPolicy extends NetworkconnectivityRequest<com.google.api.services.networkconnectivity.v1alpha1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/serviceInstances/[^/]+$");
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "serviceInstances.setIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
         * operation.
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "serviceInstances.testIamPermissions".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
         * operation.
