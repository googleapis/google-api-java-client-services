...
public class Fitness extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Fitness library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Users {
    ...
    public class DataSources {
       ...
       * @param content the {@link com.google.fitness.model.DataSource}
       * @return the request
       */
      public Create create(java.lang.String userId, com.google.fitness.model.DataSource content) throws java.io.IOException {
        Create result = new Create(userId, content);
        initialize(result);
        return result;
      }

      public class Create extends FitnessRequest<com.google.fitness.model.DataSource> {
       ...
       *        is supported at this time.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String userId, com.google.fitness.model.DataSource content) {
          super(Fitness.this, "POST", REST_PATH, content, com.google.fitness.model.DataSource.class);
      ...
      public class Delete extends FitnessRequest<com.google.fitness.model.DataSource> {
       ...
       *        is supported at this time.
        ...
        protected Delete(java.lang.String userId, java.lang.String dataSourceId) {
          super(Fitness.this, "DELETE", REST_PATH, null, com.google.fitness.model.DataSource.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
      ...
      public class Get extends FitnessRequest<com.google.fitness.model.DataSource> {
       ...
       *        is supported at this time.
        ...
        protected Get(java.lang.String userId, java.lang.String dataSourceId) {
          super(Fitness.this, "GET", REST_PATH, null, com.google.fitness.model.DataSource.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
          this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
        }
      ...
      public class List extends FitnessRequest<com.google.fitness.model.ListDataSourcesResponse> {
       ...
       *        supported at this time.
        ...
        protected List(java.lang.String userId) {
          super(Fitness.this, "GET", REST_PATH, null, com.google.fitness.model.ListDataSourcesResponse.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
        }
       ...
       * @return the request
       */
      public Patch patch(java.lang.String userId, java.lang.String dataSourceId, com.google.fitness.model.DataSource content) throws java.io.IOException {
        Patch result = new Patch(userId, dataSourceId, content);
        initialize(result);
        return result;
      }

      public class Patch extends FitnessRequest<com.google.fitness.model.DataSource> {
       ...
       *        is supported at this time.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String userId, java.lang.String dataSourceId, com.google.fitness.model.DataSource content) {
          super(Fitness.this, "PATCH", REST_PATH, content, com.google.fitness.model.DataSource.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
          this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
        }
       ...
       * @return the request
       */
      public Update update(java.lang.String userId, java.lang.String dataSourceId, com.google.fitness.model.DataSource content) throws java.io.IOException {
        Update result = new Update(userId, dataSourceId, content);
        initialize(result);
        return result;
      }

      public class Update extends FitnessRequest<com.google.fitness.model.DataSource> {
       ...
       *        is supported at this time.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String userId, java.lang.String dataSourceId, com.google.fitness.model.DataSource content) {
          super(Fitness.this, "PUT", REST_PATH, content, com.google.fitness.model.DataSource.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
          this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
          checkRequiredParameter(content, "content");
      ...
      public class DataPointChanges {
        ...
        public class List extends FitnessRequest<com.google.fitness.model.ListDataPointChangesResponse> {
         ...
         *        supported at this time.
          ...
          protected List(java.lang.String userId, java.lang.String dataSourceId) {
            super(Fitness.this, "GET", REST_PATH, null, com.google.fitness.model.ListDataPointChangesResponse.class);
            this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
            this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
          }
      ...
      public class Datasets {
        ...
        public class Get extends FitnessRequest<com.google.fitness.model.Dataset> {
         ...
         *        endTime" where startTime and endTime are 64 bit integers.
          ...
          protected Get(java.lang.String userId, java.lang.String dataSourceId, java.lang.String datasetId) {
            super(Fitness.this, "GET", REST_PATH, null, com.google.fitness.model.Dataset.class);
            this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
            this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
            this.datasetId = com.google.api.client.util.Preconditions.checkNotNull(datasetId, "Required parameter datasetId must be specified.");
          }
         ...
         *        end time represented as nanoseconds from the epoch. The ID is formatted like: "startTime-
         *        endTime" where startTime and endTime are 64 bit integers.
         * @param content the {@link com.google.fitness.model.Dataset}
         * @return the request
         */
        public Patch patch(java.lang.String userId, java.lang.String dataSourceId, java.lang.String datasetId, com.google.fitness.model.Dataset content) throws java.io.IOException {
          Patch result = new Patch(userId, dataSourceId, datasetId, content);
          initialize(result);
          return result;
        }

        public class Patch extends FitnessRequest<com.google.fitness.model.Dataset> {
         ...
         *        endTime" where startTime and endTime are 64 bit integers.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String userId, java.lang.String dataSourceId, java.lang.String datasetId, com.google.fitness.model.Dataset content) {
            super(Fitness.this, "PATCH", REST_PATH, content, com.google.fitness.model.Dataset.class);
            this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
            this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
            this.datasetId = com.google.api.client.util.Preconditions.checkNotNull(datasetId, "Required parameter datasetId must be specified.");
            checkRequiredParameter(content, "content");
    ...
    public class Dataset {
       ...
       *        supported at this time.
       * @param content the {@link com.google.fitness.model.AggregateRequest}
       * @return the request
       */
      public Aggregate aggregate(java.lang.String userId, com.google.fitness.model.AggregateRequest content) throws java.io.IOException {
        Aggregate result = new Aggregate(userId, content);
        initialize(result);
        return result;
      }

      public class Aggregate extends FitnessRequest<com.google.fitness.model.AggregateResponse> {
       ...
       *        supported at this time.
         ...
         * @since 1.13
         */
        protected Aggregate(java.lang.String userId, com.google.fitness.model.AggregateRequest content) {
          super(Fitness.this, "POST", REST_PATH, content, com.google.fitness.model.AggregateResponse.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
        }
    ...
    public class Sessions {
      ...
      public class List extends FitnessRequest<com.google.fitness.model.ListSessionsResponse> {
       ...
       *        supported at this time.
         ...
         */
        protected List(java.lang.String userId) {
          super(Fitness.this, "GET", REST_PATH, null, com.google.fitness.model.ListSessionsResponse.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
        }
       ...
       * @param content the {@link com.google.fitness.model.Session}
       * @return the request
       */
      public Update update(java.lang.String userId, java.lang.String sessionId, com.google.fitness.model.Session content) throws java.io.IOException {
        Update result = new Update(userId, sessionId, content);
        initialize(result);
        return result;
      }

      public class Update extends FitnessRequest<com.google.fitness.model.Session> {
       ...
       *        supported at this time.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String userId, java.lang.String sessionId, com.google.fitness.model.Session content) {
          super(Fitness.this, "PUT", REST_PATH, content, com.google.fitness.model.Session.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
          this.sessionId = com.google.api.client.util.Preconditions.checkNotNull(sessionId, "Required parameter sessionId must be specified.");
          checkRequiredParameter(content, "content");
