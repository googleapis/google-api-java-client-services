...
public final class GooglePlayDeveloperReportingV1alpha1Anomaly extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GooglePlayDeveloperReportingV1alpha1DimensionValue> dimensions;
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1Anomaly setDimensions(java.util.List<GooglePlayDeveloperReportingV1alpha1DimensionValue> dimensions) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1Anomaly setMetric(GooglePlayDeveloperReportingV1alpha1MetricValue metric) {
    this.metric = metric;
    return this;
  }
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1Anomaly setMetricSet(java.lang.String metricSet) {
   ...
   */
  public GooglePlayDeveloperReportingV1alpha1Anomaly setTimelineSpec(GooglePlayDeveloperReportingV1alpha1TimelineSpec timelineSpec) {
    this.timelineSpec = timelineSpec;
    return this;
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1Anomaly set(String fieldName, Object value) {
    return (GooglePlayDeveloperReportingV1alpha1Anomaly) super.set(fieldName, value);
  }

  @Override
  public GooglePlayDeveloperReportingV1alpha1Anomaly clone() {
    return (GooglePlayDeveloperReportingV1alpha1Anomaly) super.clone();
  }
