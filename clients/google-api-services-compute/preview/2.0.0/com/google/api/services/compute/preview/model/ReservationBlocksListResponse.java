...
public final class ReservationBlocksListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ReservationBlock> items;

  static {
    // hack to force ProGuard to consider ReservationBlock used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ReservationBlock.class);
  }
   ...
   */
  public ReservationBlocksListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ReservationBlock> getItems() {
    return items;
  }
   ...
   */
  public ReservationBlocksListResponse setItems(java.util.List<ReservationBlock> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationBlocksListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ReservationBlocksListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationBlocksListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReservationBlocksListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationBlocksListResponse set(String fieldName, Object value) {
    return (ReservationBlocksListResponse) super.set(fieldName, value);
  }

  @Override
  public ReservationBlocksListResponse clone() {
    return (ReservationBlocksListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ReservationBlocksListResponseWarningData.
     */
