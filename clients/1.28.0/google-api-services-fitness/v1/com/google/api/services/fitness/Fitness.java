...
public class Fitness extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Users {
    ...
    public class DataSources {
       ...
       * @return the request
       */
      public Patch patch(java.lang.String userId, java.lang.String dataSourceId, com.google.api.services.fitness.model.DataSource content) throws java.io.IOException {
        Patch result = new Patch(userId, dataSourceId, content);
        initialize(result);
        return result;
      }

      public class Patch extends FitnessRequest<com.google.api.services.fitness.model.DataSource> {
       ...
       *        is supported at this time.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String userId, java.lang.String dataSourceId, com.google.api.services.fitness.model.DataSource content) {
          super(Fitness.this, "PATCH", REST_PATH, content, com.google.api.services.fitness.model.DataSource.class);
          this.userId = com.google.api.client.util.Preconditions.checkNotNull(userId, "Required parameter userId must be specified.");
          this.dataSourceId = com.google.api.client.util.Preconditions.checkNotNull(dataSourceId, "Required parameter dataSourceId must be specified.");
        }
