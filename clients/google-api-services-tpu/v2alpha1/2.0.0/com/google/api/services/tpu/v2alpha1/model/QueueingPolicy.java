...
public final class QueueingPolicy extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A relative time after which resources should not be created. If the request cannot be fulfilled
  ...
  /**
   * An absolute time after which resources should not be created. If the request cannot be
