 ...
 * <pre>
  public static class MyRequestInitializer extends CommentAnalyzerRequestInitializer {
    ...
    {@literal @}Override
    public void initializeCommentAnalyzerRequest(CommentAnalyzerRequest{@literal <}?{@literal >} request)
        throws IOException {
      // custom logic
    }
  }
 ...
 * @since 1.12
 */
public class CommentAnalyzerRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {

  public CommentAnalyzerRequestInitializer() {
    super();
  }
   ...
   */
  public CommentAnalyzerRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public CommentAnalyzerRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeCommentAnalyzerRequest((CommentAnalyzerRequest<?>) request);
  }

  /**
   * Initializes CommentAnalyzer request.
   *
   * <p>
   ...
   */
  protected void initializeCommentAnalyzerRequest(CommentAnalyzerRequest<?> request) throws java.io.IOException {
  }
}
