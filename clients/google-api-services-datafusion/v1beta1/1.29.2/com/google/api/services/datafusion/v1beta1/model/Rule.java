...
public final class Rule extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<LogConfig> logConfig;
   ...
   */
  public Rule setIn(java.util.List<java.lang.String> in) {
    this.in = in;
    return this;
  }
   ...
   */
  public Rule setNotIn(java.util.List<java.lang.String> notIn) {
    this.notIn = notIn;
    return this;
  }
