...
/**
 * Model definition for ManagedRulesetList.
 *
...
public final class ManagedRulesetList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ManagedRuleset> items;

  static {
    // hack to force ProGuard to consider ManagedRuleset used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ManagedRuleset.class);
  }
   ...
   */
  public ManagedRulesetList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public ManagedRulesetList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ManagedRulesetList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ManagedRulesetList set(String fieldName, Object value) {
    return (ManagedRulesetList) super.set(fieldName, value);
  }

  @Override
  public ManagedRulesetList clone() {
    return (ManagedRulesetList) super.clone();
  }

  /**
   * Model definition for ManagedRulesetListWarning.
   */
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ManagedRulesetListWarningData.
     */
