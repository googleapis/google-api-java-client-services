...
public final class Split extends com.google.api.client.json.GenericJson {
   ...
   * @since 1.14
   */
  public Split encodeKey(byte[] key) {
    this.key = com.google.api.client.util.Base64.encodeBase64URLSafeString(key);
    return this;
  }

  @Override
  public Split set(String fieldName, Object value) {
    return (Split) super.set(fieldName, value);
  }
