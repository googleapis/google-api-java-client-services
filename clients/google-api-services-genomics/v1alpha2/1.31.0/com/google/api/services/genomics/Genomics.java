...
public class Genomics extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Pipelines {
     ...
     * can be used to run the pipeline. Caller must have WRITE permission to the project.
     *
    ...
    public class Create extends GenomicsRequest<com.google.api.services.genomics.model.Pipeline> {
       ...
       * This id can be used to run the pipeline. Caller must have WRITE permission to the project.
       *
       * Create a request for the method "pipelines.create".
       *
       * This request holds the parameters needed by the the genomics server.  After setting any
     ...
     * `ephemeralPipeline` is specified, then run that pipeline once without saving a copy. The caller
     * must have READ permission to the project where the pipeline is stored and WRITE permission to the
     * project where the pipeline will be run, as VMs will be created and storage will be used. If a
    ...
    public class Run extends GenomicsRequest<com.google.api.services.genomics.model.Operation> {
       ...
       * Runs a pipeline. If `pipelineId` is specified in the request, then run a saved pipeline. If
       * `ephemeralPipeline` is specified, then run that pipeline once without saving a copy. The caller
       * must have READ permission to the project where the pipeline is stored and WRITE permission to
       * the project where the pipeline will be run, as VMs will be created and storage will be used. If
       * a pipeline operation is still running after 6 days, it will be canceled.
       *
       * Create a request for the method "pipelines.run".
       *
       * This request holds the parameters needed by the the genomics server.  After setting any
