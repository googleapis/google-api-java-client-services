...
public final class ServiceAccount extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The list of scopes to be made available for this service account. If empty, access to all Cloud
   * APIs will be allowed.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public ServiceAccount setScope(java.util.List<java.lang.String> scope) {
    this.scope = scope;
    return this;
  }
