...
public final class GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest setArtifact(java.lang.String artifact) {
   ...
   * @since 1.14
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest encodeArtifact(byte[] artifact) {
   ...
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest setAssertion(java.lang.String assertion) {
   ...
   * @since 1.14
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest encodeAssertion(byte[] assertion) {
   ...
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest setChallenge(java.lang.String challenge) {
   ...
   * @since 1.14
   */
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest encodeChallenge(byte[] challenge) {
  ...
  @Override
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest clone() {
