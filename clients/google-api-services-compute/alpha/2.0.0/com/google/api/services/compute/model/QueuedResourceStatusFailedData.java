...
/**
 * Model definition for QueuedResourceStatusFailedData.
 *
...
public final class QueuedResourceStatusFailedData extends com.google.api.client.json.GenericJson {
   ...
   */
  public QueuedResourceStatusFailedData setError(Error error) {
    this.error = error;
    return this;
  }

  @Override
  public QueuedResourceStatusFailedData set(String fieldName, Object value) {
    return (QueuedResourceStatusFailedData) super.set(fieldName, value);
  }

  @Override
  public QueuedResourceStatusFailedData clone() {
    return (QueuedResourceStatusFailedData) super.clone();
  }

  /**
   * Model definition for QueuedResourceStatusFailedDataError.
   */
  public static final class Error extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for QueuedResourceStatusFailedDataErrorErrors.
     */
    public static final class Errors extends com.google.api.client.json.GenericJson {
      ...
      /**
       * Model definition for QueuedResourceStatusFailedDataErrorErrorsErrorDetails.
       */
