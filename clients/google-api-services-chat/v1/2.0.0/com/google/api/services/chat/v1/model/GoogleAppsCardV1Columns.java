 ...
 * each column; the widgets appear in the order that they are specified. The height of each column
 * is determined by the taller column. For example, if the first column is taller than the second
