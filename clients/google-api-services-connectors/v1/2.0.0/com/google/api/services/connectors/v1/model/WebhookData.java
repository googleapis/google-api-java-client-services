...
public final class WebhookData extends com.google.api.client.json.GenericJson {
   ...
   */
  public WebhookData setAdditionalVariables(java.util.List<ConfigVariable> additionalVariables) {
   ...
   */
  public WebhookData setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public WebhookData setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public WebhookData setNextRefreshTime(String nextRefreshTime) {
   ...
   */
  public WebhookData setUpdateTime(String updateTime) {
    this.updateTime = updateTime;
    return this;
  }

  @Override
  public WebhookData set(String fieldName, Object value) {
    return (WebhookData) super.set(fieldName, value);
  }

  @Override
  public WebhookData clone() {
    return (WebhookData) super.clone();
  }
