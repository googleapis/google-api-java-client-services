...
public final class GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig extends com.google.api.client.json.GenericJson {
   ...
   * set outside of this range will be clipped. Note: For best results, follow the default
   ...
   * detections. If not set, it's set to 0.3 by default. The valid range for this threshold is [0.1,
   * 0.9]. Any value set outside of this range will be clipped. Note: For best results, follow the
   * default threshold. We will update the default threshold everytime when we release a new model.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig setFrameConfidenceThreshold(java.lang.Float frameConfidenceThreshold) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig setLabelDetectionMode(java.lang.String labelDetectionMode) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig setModel(java.lang.String model) {
    this.model = model;
    return this;
  }
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig setStationaryCamera(java.lang.Boolean stationaryCamera) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig setVideoConfidenceThreshold(java.lang.Float videoConfidenceThreshold) {
    this.videoConfidenceThreshold = videoConfidenceThreshold;
    return this;
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig set(String fieldName, Object value) {
    return (GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig clone() {
    return (GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig) super.clone();
  }
