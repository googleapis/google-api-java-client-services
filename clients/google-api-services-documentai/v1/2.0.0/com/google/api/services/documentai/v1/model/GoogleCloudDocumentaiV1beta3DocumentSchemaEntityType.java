...
public final class GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty> properties;
   ...
   */
  public GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType setEnumValues(GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValues enumValues) {
  ...
  @Override
  public GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType clone() {
