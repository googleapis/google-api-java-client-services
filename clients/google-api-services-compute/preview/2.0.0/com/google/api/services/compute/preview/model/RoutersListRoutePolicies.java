...
/**
 * Model definition for RoutersListRoutePolicies.
 *
...
public final class RoutersListRoutePolicies extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<RoutePolicy> result;

  static {
    // hack to force ProGuard to consider RoutePolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(RoutePolicy.class);
  }
   ...
   */
  public RoutersListRoutePolicies setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public RoutersListRoutePolicies setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public RoutersListRoutePolicies setNextPageToken(java.lang.String nextPageToken) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RoutePolicy> getResult() {
    return result;
  }
   ...
   */
  public RoutersListRoutePolicies setResult(java.util.List<RoutePolicy> result) {
    this.result = result;
    return this;
  }
   ...
   */
  public RoutersListRoutePolicies setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RoutersListRoutePolicies set(String fieldName, Object value) {
    return (RoutersListRoutePolicies) super.set(fieldName, value);
  }

  @Override
  public RoutersListRoutePolicies clone() {
    return (RoutersListRoutePolicies) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RoutersListRoutePoliciesWarningData.
     */
