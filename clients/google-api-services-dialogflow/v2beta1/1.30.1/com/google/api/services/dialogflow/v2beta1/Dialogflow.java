...
public class Dialogflow extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.9 of the Dialogflow API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
        ...
        public class Users {
          ...
          public class Sessions {
            ...
            public class Contexts {
              ...
              The following context names are
               *        reserved for internal use by Dialogflow.
              You should not use these contexts or create
              ...
              *
               *        `*_dialog_params_size`
               ...
               The following context names are reserved for internal use by Dialogflow. You should not use these
               contexts or create contexts with these names:
    ...
    public class Locations {
      ...
      public class Agent {
         ...
         * Updates the fulfillment.
         *
         * Create a request for the method "agent.fulfillment".
         *
         * This request holds the parameters needed by the dialogflow server.  After setting any optional
         * parameters, call the {@link Fulfillment#execute()} method to invoke the remote operation.
         *
         * @param name Required. The unique identifier of the fulfillment.
        Format: `projects//agent/fulfillment`.
         * @param content the {@link com.google.api.services.dialogflow.v2beta1.model.GoogleCloudDialogflowV2beta1Fulfillment}
         * @return the request
         */
        public Fulfillment fulfillment(java.lang.String name, com.google.api.services.dialogflow.v2beta1.model.GoogleCloudDialogflowV2beta1Fulfillment content) throws java.io.IOException {
          Fulfillment result = new Fulfillment(name, content);
          initialize(result);
          return result;
        }

        public class Fulfillment extends DialogflowRequest<com.google.api.services.dialogflow.v2beta1.model.GoogleCloudDialogflowV2beta1Fulfillment> {
           ...
           *
           * This request holds the parameters needed by the the dialogflow server.  After setting any
           * optional parameters, call the {@link Fulfillment#execute()} method to invoke the remote
           * operation. <p> {@link
           * Fulfillment#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
           * must be called to initialize this instance immediately after invoking the constructor. </p>
           *
           * @param name Required. The unique identifier of the fulfillment.
        Format: `projects//agent/fulfillment`.
           ...
           * @since 1.13
           */
          protected Fulfillment(java.lang.String name, com.google.api.services.dialogflow.v2beta1.model.GoogleCloudDialogflowV2beta1Fulfillment content) {
            super(Dialogflow.this, "POST", REST_PATH, content, com.google.api.services.dialogflow.v2beta1.model.GoogleCloudDialogflowV2beta1Fulfillment.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
          ...
          @Override
          public Fulfillment set$Xgafv(java.lang.String $Xgafv) {
            return (Fulfillment) super.set$Xgafv($Xgafv);
          }

          @Override
          public Fulfillment setAccessToken(java.lang.String accessToken) {
            return (Fulfillment) super.setAccessToken(accessToken);
          }

          @Override
          public Fulfillment setAlt(java.lang.String alt) {
            return (Fulfillment) super.setAlt(alt);
          }

          @Override
          public Fulfillment setCallback(java.lang.String callback) {
            return (Fulfillment) super.setCallback(callback);
          }

          @Override
          public Fulfillment setFields(java.lang.String fields) {
            return (Fulfillment) super.setFields(fields);
          }

          @Override
          public Fulfillment setKey(java.lang.String key) {
            return (Fulfillment) super.setKey(key);
          }

          @Override
          public Fulfillment setOauthToken(java.lang.String oauthToken) {
            return (Fulfillment) super.setOauthToken(oauthToken);
          }

          @Override
          public Fulfillment setPrettyPrint(java.lang.Boolean prettyPrint) {
            return (Fulfillment) super.setPrettyPrint(prettyPrint);
          }

          @Override
          public Fulfillment setQuotaUser(java.lang.String quotaUser) {
            return (Fulfillment) super.setQuotaUser(quotaUser);
          }

          @Override
          public Fulfillment setUploadType(java.lang.String uploadType) {
            return (Fulfillment) super.setUploadType(uploadType);
          }

          @Override
          public Fulfillment setUploadProtocol(java.lang.String uploadProtocol) {
            return (Fulfillment) super.setUploadProtocol(uploadProtocol);
          }
           ...
           * `projects//agent/fulfillment`.
           */
          public Fulfillment setName(java.lang.String name) {
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
                  "^projects/[^/]+/locations/[^/]+/agent/fulfillment$");
         ...
         be updated.
           ...
           * fields will be updated.
           */
          public Fulfillment setUpdateMask(String updateMask) {
            this.updateMask = updateMask;
            return this;
          }

          @Override
          public Fulfillment set(String parameterName, Object value) {
            return (Fulfillment) super.set(parameterName, value);
          }
        }
        /**
         * Retrieves the fulfillment.
