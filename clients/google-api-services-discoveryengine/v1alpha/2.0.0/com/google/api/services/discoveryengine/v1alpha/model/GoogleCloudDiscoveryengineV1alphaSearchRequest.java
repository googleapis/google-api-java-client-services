...
public final class GoogleCloudDiscoveryengineV1alphaSearchRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestCrowdingSpec> crowdingSpecs;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpec> facetSpecs;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1alphaSearchRequestSessionSpec sessionSpec;
  ...
  /**
   * Uses the Engine, ServingConfig and Control freshly read from the database. Note: this skips
   * config cache and introduces dependency on databases, which could significantly increase the API
   * latency. It should only be used for testing, but not serving end users.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.Boolean useLatestData;
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setBranch(java.lang.String branch) {
    this.branch = branch;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setCanonicalFilter(java.lang.String canonicalFilter) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestCrowdingSpec> getCrowdingSpecs() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setCrowdingSpecs(java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestCrowdingSpec> crowdingSpecs) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpec> getFacetSpecs() {
    return facetSpecs;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setFacetSpecs(java.util.List<GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpec> facetSpecs) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setImageQuery(GoogleCloudDiscoveryengineV1alphaSearchRequestImageQuery imageQuery) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setOneBoxPageSize(java.lang.Integer oneBoxPageSize) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setPageCategories(java.util.List<java.lang.String> pageCategories) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setPageSize(java.lang.Integer pageSize) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setPageToken(java.lang.String pageToken) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setPersonalizationSpec(GoogleCloudDiscoveryengineV1alphaSearchRequestPersonalizationSpec personalizationSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setQuery(java.lang.String query) {
    this.query = query;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setQueryExpansionSpec(GoogleCloudDiscoveryengineV1alphaSearchRequestQueryExpansionSpec queryExpansionSpec) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestSessionSpec getSessionSpec() {
    return sessionSpec;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setSessionSpec(GoogleCloudDiscoveryengineV1alphaSearchRequestSessionSpec sessionSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setSpellCorrectionSpec(GoogleCloudDiscoveryengineV1alphaSearchRequestSpellCorrectionSpec spellCorrectionSpec) {
   ...
   * @return value or {@code null} for none
   */
  public java.lang.Boolean getUseLatestData() {
    return useLatestData;
  }
   ...
   * config cache and introduces dependency on databases, which could significantly increase the API
   * latency. It should only be used for testing, but not serving end users.
   * @param useLatestData useLatestData or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setUseLatestData(java.lang.Boolean useLatestData) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequest setUserLabels(java.util.Map<String, java.lang.String> userLabels) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1alphaSearchRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaSearchRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaSearchRequest clone() {
    return (GoogleCloudDiscoveryengineV1alphaSearchRequest) super.clone();
  }
