...
/**
 * Model definition for RequestAccessData.
 *
...
public final class RequestAccessData extends com.google.api.client.json.GenericJson {
   ...
   */
  public RequestAccessData setConcurrentAccess(ConcurrentAccessRestriction concurrentAccess) {
   ...
   */
  public RequestAccessData setDownloadAccess(DownloadAccessRestriction downloadAccess) {
   ...
   */
  public RequestAccessData setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }

  @Override
  public RequestAccessData set(String fieldName, Object value) {
    return (RequestAccessData) super.set(fieldName, value);
  }

  @Override
  public RequestAccessData clone() {
