...
public final class GeostoreCityJsonProtoAppearanceMaterial extends com.google.api.client.json.GenericJson {
  ...
  /**
   * is_null=true is used to represent 'null' material references. There may only be one
   * is_null=true Material per CityJsonProto, and it must not have any other fields set.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GeostoreCityJsonProtoAppearanceMaterial setIsNull(java.lang.Boolean isNull) {
    this.isNull = isNull;
    return this;
  }
