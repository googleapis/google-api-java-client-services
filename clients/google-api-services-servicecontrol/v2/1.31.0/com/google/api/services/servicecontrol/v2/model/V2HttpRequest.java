...
public final class V2HttpRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public V2HttpRequest setCacheFillBytes(java.lang.Long cacheFillBytes) {
   ...
   */
  public V2HttpRequest setCacheHit(java.lang.Boolean cacheHit) {
   ...
   */
  public V2HttpRequest setCacheLookup(java.lang.Boolean cacheLookup) {
   ...
   */
  public V2HttpRequest setCacheValidatedWithOriginServer(java.lang.Boolean cacheValidatedWithOriginServer) {
   ...
   */
  public V2HttpRequest setLatency(String latency) {
   ...
   */
  public V2HttpRequest setProtocol(java.lang.String protocol) {
   ...
   */
  public V2HttpRequest setRemoteIp(java.lang.String remoteIp) {
   ...
   */
  public V2HttpRequest setRequestMethod(java.lang.String requestMethod) {
   ...
   */
  public V2HttpRequest setRequestSize(java.lang.Long requestSize) {
   ...
   */
  public V2HttpRequest setRequestUrl(java.lang.String requestUrl) {
   ...
   */
  public V2HttpRequest setResponseSize(java.lang.Long responseSize) {
   ...
   */
  public V2HttpRequest setServerIp(java.lang.String serverIp) {
   ...
   */
  public V2HttpRequest setStatus(java.lang.Integer status) {
    this.status = status;
    return this;
  }
   ...
   */
  public V2HttpRequest setUserAgent(java.lang.String userAgent) {
    this.userAgent = userAgent;
    return this;
  }

  @Override
  public V2HttpRequest set(String fieldName, Object value) {
    return (V2HttpRequest) super.set(fieldName, value);
  }

  @Override
  public V2HttpRequest clone() {
    return (V2HttpRequest) super.clone();
  }
