...
public final class EvictLunRequest extends com.google.api.client.json.GenericJson {

  @Override
  public EvictLunRequest set(String fieldName, Object value) {
    return (EvictLunRequest) super.set(fieldName, value);
  }

  @Override
  public EvictLunRequest clone() {
    return (EvictLunRequest) super.clone();
  }
