...
public final class NodeTemplateAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, NodeTemplatesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource.Alwayscompute#nodeTemplateAggregatedList for
   ...
   */
  public NodeTemplateAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NodeTemplatesScopedList> getItems() {
    return items;
  }
   ...
   */
  public NodeTemplateAggregatedList setItems(java.util.Map<String, NodeTemplatesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NodeTemplateAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NodeTemplateAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NodeTemplateAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NodeTemplateAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NodeTemplateAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeTemplateAggregatedList set(String fieldName, Object value) {
    return (NodeTemplateAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NodeTemplateAggregatedList clone() {
    return (NodeTemplateAggregatedList) super.clone();
  }
