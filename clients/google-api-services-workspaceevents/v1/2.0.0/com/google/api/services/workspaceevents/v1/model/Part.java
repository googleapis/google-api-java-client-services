...
/**
 * Part represents a container for a section of communication content. Parts can be purely textual,
 * some sort of file (image, video, etc) or a structured data blob (i.e. JSON).
 *
...
public final class Part extends com.google.api.client.json.GenericJson {
   ...
   */
  public Part setFile(FilePart file) {
    this.file = file;
    return this;
  }
   ...
   */
  public Part setMetadata(java.util.Map<String, java.lang.Object> metadata) {
