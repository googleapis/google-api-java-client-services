 ...
 * when the build is created: - $PROJECT_ID: the project ID of the build. - $BUILD_ID: the
...
public final class Build extends com.google.api.client.json.GenericJson {
   ...
   * fetch source. If the build does not specify source or images, these keys will not be included.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
