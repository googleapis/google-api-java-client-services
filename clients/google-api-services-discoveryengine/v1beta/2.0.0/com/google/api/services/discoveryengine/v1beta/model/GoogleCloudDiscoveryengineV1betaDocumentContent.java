...
public final class GoogleCloudDiscoveryengineV1betaDocumentContent extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaDocumentContent setMimeType(java.lang.String mimeType) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaDocumentContent setRawBytes(java.lang.String rawBytes) {
   ...
   * @since 1.14
   */
  public GoogleCloudDiscoveryengineV1betaDocumentContent encodeRawBytes(byte[] rawBytes) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1betaDocumentContent set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaDocumentContent) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaDocumentContent clone() {
    return (GoogleCloudDiscoveryengineV1betaDocumentContent) super.clone();
  }
