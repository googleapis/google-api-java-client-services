...
public final class FormSettings extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Settings related to quiz forms and grading.
   * @param quizSettings quizSettings or {@code null} for none
   */
  ...
  @Override
  public FormSettings set(String fieldName, Object value) {
    return (FormSettings) super.set(fieldName, value);
  }
