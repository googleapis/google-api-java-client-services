...
/**
 * Model definition for TargetTcpProxyAggregatedList.
 *
...
public final class TargetTcpProxyAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, TargetTcpProxiesScopedList> items;

  static {
    // hack to force ProGuard to consider TargetTcpProxiesScopedList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetTcpProxiesScopedList.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#targetTcpProxyAggregatedList for
   * lists of Target TCP Proxies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public TargetTcpProxyAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, TargetTcpProxiesScopedList> getItems() {
    return items;
  }
   ...
   */
  public TargetTcpProxyAggregatedList setItems(java.util.Map<String, TargetTcpProxiesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetTcpProxyAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetTcpProxyAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetTcpProxyAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetTcpProxyAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public TargetTcpProxyAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetTcpProxyAggregatedList set(String fieldName, Object value) {
    return (TargetTcpProxyAggregatedList) super.set(fieldName, value);
  }

  @Override
  public TargetTcpProxyAggregatedList clone() {
    return (TargetTcpProxyAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for TargetTcpProxyAggregatedListWarningData.
     */
