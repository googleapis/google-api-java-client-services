...
public final class ListClientUsersResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<ClientUser> clientUsers;
   ...
   * ListClientUsersRequest.pageToken field in the subsequent call to the list method to retrieve
   ...
   */
  public java.util.List<ClientUser> getClientUsers() {
    return clientUsers;
  }

  /**
   * The returned list of client users.
   * @param clientUsers clientUsers or {@code null} for none
   */
  public ListClientUsersResponse setClientUsers(java.util.List<ClientUser> clientUsers) {
