...
public final class TargetVpnGatewayAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, TargetVpnGatewaysScopedList> items;
   ...
   */
  public TargetVpnGatewayAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, TargetVpnGatewaysScopedList> getItems() {
    return items;
  }
   ...
   */
  public TargetVpnGatewayAggregatedList setItems(java.util.Map<String, TargetVpnGatewaysScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetVpnGatewayAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetVpnGatewayAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetVpnGatewayAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetVpnGatewayAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public TargetVpnGatewayAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetVpnGatewayAggregatedList set(String fieldName, Object value) {
    return (TargetVpnGatewayAggregatedList) super.set(fieldName, value);
  }

  @Override
  public TargetVpnGatewayAggregatedList clone() {
    return (TargetVpnGatewayAggregatedList) super.clone();
  }
