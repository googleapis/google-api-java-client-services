...
public final class GoogleCloudDataplexV1ListEntryTypesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDataplexV1EntryType> entryTypes;

  static {
    // hack to force ProGuard to consider GoogleCloudDataplexV1EntryType used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDataplexV1EntryType.class);
  }
   ...
   */
  public GoogleCloudDataplexV1ListEntryTypesResponse setNextPageToken(java.lang.String nextPageToken) {
  ...
  @Override
  public GoogleCloudDataplexV1ListEntryTypesResponse set(String fieldName, Object value) {
    return (GoogleCloudDataplexV1ListEntryTypesResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDataplexV1ListEntryTypesResponse clone() {
    return (GoogleCloudDataplexV1ListEntryTypesResponse) super.clone();
  }
