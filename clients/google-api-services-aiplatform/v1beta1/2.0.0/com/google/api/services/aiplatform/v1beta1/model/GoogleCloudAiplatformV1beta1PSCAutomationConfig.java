...
public final class GoogleCloudAiplatformV1beta1PSCAutomationConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1PSCAutomationConfig setNetwork(java.lang.String network) {
  ...
  @Override
  public GoogleCloudAiplatformV1beta1PSCAutomationConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1PSCAutomationConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1PSCAutomationConfig clone() {
    return (GoogleCloudAiplatformV1beta1PSCAutomationConfig) super.clone();
  }
