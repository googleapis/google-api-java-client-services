...
public final class MachineTypesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<MachineType> machineTypes;
   ...
   */
  public java.util.List<MachineType> getMachineTypes() {
    return machineTypes;
  }
   ...
   */
  public MachineTypesScopedList setMachineTypes(java.util.List<MachineType> machineTypes) {
   ...
   */
  public MachineTypesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public MachineTypesScopedList set(String fieldName, Object value) {
    return (MachineTypesScopedList) super.set(fieldName, value);
  }

  @Override
  public MachineTypesScopedList clone() {
    return (MachineTypesScopedList) super.clone();
  }
