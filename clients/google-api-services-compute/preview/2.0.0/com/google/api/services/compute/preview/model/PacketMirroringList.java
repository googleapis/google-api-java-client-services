...
public final class PacketMirroringList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<PacketMirroring> items;

  static {
    // hack to force ProGuard to consider PacketMirroring used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(PacketMirroring.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Always compute#packetMirroring for
   * packetMirrorings.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public PacketMirroringList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<PacketMirroring> getItems() {
    return items;
  }
   ...
   */
  public PacketMirroringList setItems(java.util.List<PacketMirroring> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public PacketMirroringList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public PacketMirroringList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public PacketMirroringList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public PacketMirroringList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PacketMirroringList set(String fieldName, Object value) {
    return (PacketMirroringList) super.set(fieldName, value);
  }

  @Override
  public PacketMirroringList clone() {
    return (PacketMirroringList) super.clone();
  }
