...
public final class GlobalVmExtensionPolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GlobalVmExtensionPolicy> items;

  static {
    // hack to force ProGuard to consider GlobalVmExtensionPolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GlobalVmExtensionPolicy.class);
  }
   ...
   */
  public GlobalVmExtensionPolicyList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public GlobalVmExtensionPolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GlobalVmExtensionPolicy> getItems() {
    return items;
  }
   ...
   */
  public GlobalVmExtensionPolicyList setItems(java.util.List<GlobalVmExtensionPolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public GlobalVmExtensionPolicyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public GlobalVmExtensionPolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public GlobalVmExtensionPolicyList set(String fieldName, Object value) {
    return (GlobalVmExtensionPolicyList) super.set(fieldName, value);
  }

  @Override
  public GlobalVmExtensionPolicyList clone() {
    return (GlobalVmExtensionPolicyList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for GlobalVmExtensionPolicyListWarningData.
     */
