...
package com.google.websecurityscanner.v1alpha;
...
public class WebSecurityScanner extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Web Security Scanner API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class ScanConfigs {
       ...
       * @param content the {@link com.google.websecurityscanner.v1alpha.model.ScanConfig}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.websecurityscanner.v1alpha.model.ScanConfig content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanConfig> {
       ...
       *        name in the format 'projects/{projectId}'.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.websecurityscanner.v1alpha.model.ScanConfig content) {
          super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.websecurityscanner.v1alpha.model.ScanConfig.class);
      ...
      public class Delete extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.Empty> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
        ...
        protected Delete(java.lang.String name) {
          super(WebSecurityScanner.this, "DELETE", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.Empty.class);
      ...
      public class Get extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanConfig> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
        ...
        protected Get(java.lang.String name) {
          super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ListScanConfigsResponse> {
       ...
       *        'projects/{projectId}'.
        ...
        protected List(java.lang.String parent) {
          super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ListScanConfigsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.websecurityscanner.v1alpha.model.ScanConfig content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanConfig> {
       ...
       *        system.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.websecurityscanner.v1alpha.model.ScanConfig content) {
          super(WebSecurityScanner.this, "PATCH", REST_PATH, content, com.google.websecurityscanner.v1alpha.model.ScanConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      format of
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
       * @param content the {@link com.google.websecurityscanner.v1alpha.model.StartScanRunRequest}
       * @return the request
       */
      public Start start(java.lang.String name, com.google.websecurityscanner.v1alpha.model.StartScanRunRequest content) throws java.io.IOException {
        Start result = new Start(name, content);
        initialize(result);
        return result;
      }

      public class Start extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanRun> {
       ...
       *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
         ...
         * @since 1.13
         */
        protected Start(java.lang.String name, com.google.websecurityscanner.v1alpha.model.StartScanRunRequest content) {
          super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.websecurityscanner.v1alpha.model.ScanRun.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class ScanRuns {
        ...
        public class Get extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanRun> {
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
           ...
           */
          protected Get(java.lang.String name) {
            super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ScanRun.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ListScanRunsResponse> {
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}'.
           ...
           */
          protected List(java.lang.String parent) {
            super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ListScanRunsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        format of
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
         * @param content the {@link com.google.websecurityscanner.v1alpha.model.StopScanRunRequest}
         * @return the request
         */
        public Stop stop(java.lang.String name, com.google.websecurityscanner.v1alpha.model.StopScanRunRequest content) throws java.io.IOException {
          Stop result = new Stop(name, content);
          initialize(result);
          return result;
        }

        public class Stop extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ScanRun> {
         ...
         *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
           ...
           * @since 1.13
           */
          protected Stop(java.lang.String name, com.google.websecurityscanner.v1alpha.model.StopScanRunRequest content) {
            super(WebSecurityScanner.this, "POST", REST_PATH, content, com.google.websecurityscanner.v1alpha.model.ScanRun.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class CrawledUrls {
          ...
          public class List extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ListCrawledUrlsResponse> {
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ListCrawledUrlsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
        ...
        public class FindingTypeStats {
          ...
          public class List extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ListFindingTypeStatsResponse> {
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ListFindingTypeStatsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
        ...
        public class Findings {
          ...
          public class Get extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.Finding> {
           ...
           *        '.
             ...
             */
            protected Get(java.lang.String name) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.Finding.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends WebSecurityScannerRequest<com.google.websecurityscanner.v1alpha.model.ListFindingsResponse> {
           ...
           *        'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
             ...
             */
            protected List(java.lang.String parent) {
              super(WebSecurityScanner.this, "GET", REST_PATH, null, com.google.websecurityscanner.v1alpha.model.ListFindingsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
