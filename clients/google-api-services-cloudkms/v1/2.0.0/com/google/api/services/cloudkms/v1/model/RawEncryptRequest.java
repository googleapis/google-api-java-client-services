...
public final class RawEncryptRequest extends com.google.api.client.json.GenericJson {

  /**
   * Optional. Optional data that, if specified, must also be provided during decryption through
   * RawDecryptRequest.additional_authenticated_data. This field may only be used in conjunction
   * with an algorithm that accepts additional authenticated data (for example, AES-GCM). The
   * maximum size depends on the key version's protection_level. For SOFTWARE keys, the plaintext
  ...
  /**
   * Optional. A customer-supplied initialization vector that will be used for encryption. If it is
   * not provided for AES-CBC and AES-CTR, one will be generated. It will be returned in
  ...
  /**
   * Optional. An optional CRC32C checksum of the RawEncryptRequest.initialization_vector. If
  ...
  /**
   * Optional. An optional CRC32C checksum of the RawEncryptRequest.plaintext. If specified,
   * KeyManagementService will verify the integrity of the received plaintext using this checksum.
   * KeyManagementService will report an error if the checksum verification fails. If you receive a
   * checksum error, your client should verify that CRC32C(plaintext) is equal to plaintext_crc32c,
   * and if so, perform a limited number of retries. A persistent mismatch may indicate an issue in
   * your computation of the CRC32C checksum. Note: This field is defined as int64 for reasons of
   * compatibility across different languages. However, it is a non-negative integer, which will
   * never exceed 2^32-1, and can be safely downconverted to uint32 in languages that support this
   ...
   */
  public RawEncryptRequest setAdditionalAuthenticatedData(java.lang.String additionalAuthenticatedData) {
   ...
   * @since 1.14
   */
  public RawEncryptRequest encodeAdditionalAuthenticatedData(byte[] additionalAuthenticatedData) {
   ...
   */
  public RawEncryptRequest setAdditionalAuthenticatedDataCrc32c(java.lang.Long additionalAuthenticatedDataCrc32c) {
   ...
   */
  public RawEncryptRequest setInitializationVector(java.lang.String initializationVector) {
   ...
   * @since 1.14
   */
  public RawEncryptRequest encodeInitializationVector(byte[] initializationVector) {
   ...
   */
  public RawEncryptRequest setInitializationVectorCrc32c(java.lang.Long initializationVectorCrc32c) {
   ...
   */
  public RawEncryptRequest setPlaintext(java.lang.String plaintext) {
   ...
   * @since 1.14
   */
  public RawEncryptRequest encodePlaintext(byte[] plaintext) {
   ...
   */
  public RawEncryptRequest setPlaintextCrc32c(java.lang.Long plaintextCrc32c) {
    this.plaintextCrc32c = plaintextCrc32c;
    return this;
  }

  @Override
  public RawEncryptRequest set(String fieldName, Object value) {
    return (RawEncryptRequest) super.set(fieldName, value);
  }

  @Override
  public RawEncryptRequest clone() {
    return (RawEncryptRequest) super.clone();
  }
