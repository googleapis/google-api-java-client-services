...
public final class TargetHttpsProxyAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, TargetHttpsProxiesScopedList> items;

  static {
    // hack to force ProGuard to consider TargetHttpsProxiesScopedList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetHttpsProxiesScopedList.class);
  }

  /**
   * [Output Only] Type of resource. Alwayscompute#targetHttpsProxyAggregatedList for lists of
   * Target HTTP Proxies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public TargetHttpsProxyAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, TargetHttpsProxiesScopedList> getItems() {
    return items;
  }
   ...
   */
  public TargetHttpsProxyAggregatedList setItems(java.util.Map<String, TargetHttpsProxiesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetHttpsProxyAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetHttpsProxyAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetHttpsProxyAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetHttpsProxyAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public TargetHttpsProxyAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetHttpsProxyAggregatedList set(String fieldName, Object value) {
    return (TargetHttpsProxyAggregatedList) super.set(fieldName, value);
  }

  @Override
  public TargetHttpsProxyAggregatedList clone() {
    return (TargetHttpsProxyAggregatedList) super.clone();
  }
