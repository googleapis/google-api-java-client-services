...
public final class UserOwnedGrafeasNote extends com.google.api.client.json.GenericJson {
   ...
   * the format: `projects/notes`. This field may not be updated.
   *
   * An attestation by this attestor is stored as a Grafeas Attestation.Authority Occurrence that
   * names a container image and that links to this Note. Grafeas is an external dependency.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
