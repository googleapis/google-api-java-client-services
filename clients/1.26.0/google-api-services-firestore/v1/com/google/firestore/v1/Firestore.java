  ...
  public class Projects {
    ...
    public class Databases {
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.firestore.v1.model.GoogleLongrunningCancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.firestore.v1.model.GoogleLongrunningCancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends FirestoreRequest<com.google.firestore.v1.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.firestore.v1.model.GoogleLongrunningCancelOperationRequest content) {
            super(Firestore.this, "POST", REST_PATH, content, com.google.firestore.v1.model.Empty.class);
        ...
        public class Delete extends FirestoreRequest<com.google.firestore.v1.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(Firestore.this, "DELETE", REST_PATH, null, com.google.firestore.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends FirestoreRequest<com.google.firestore.v1.model.GoogleLongrunningOperation> {
          ...
          protected Get(java.lang.String name) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1.model.GoogleLongrunningOperation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends FirestoreRequest<com.google.firestore.v1.model.GoogleLongrunningListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1.model.GoogleLongrunningListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
    ...
    public class Locations {
      ...
      public class Get extends FirestoreRequest<com.google.firestore.v1.model.Location> {
         ...
         */
        protected Get(java.lang.String name) {
          super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1.model.Location.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends FirestoreRequest<com.google.firestore.v1.model.ListLocationsResponse> {
         ...
         */
        protected List(java.lang.String name) {
          super(Firestore.this, "GET", REST_PATH, null, com.google.firestore.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
