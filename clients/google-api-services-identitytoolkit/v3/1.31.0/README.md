# Google Identity Toolkit API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v3-rev20180723-1.31.5</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  compile 'com.google.apis:google-api-services-identitytoolkit:v3-rev20180723-1.31.5'
}
```
