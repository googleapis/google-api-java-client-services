...
public final class PublishItemResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public PublishItemResponse setItemId(java.lang.String itemId) {
    this.itemId = itemId;
    return this;
  }
   ...
   */
  public PublishItemResponse setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  @Override
  public PublishItemResponse clone() {
    return (PublishItemResponse) super.clone();
  }
