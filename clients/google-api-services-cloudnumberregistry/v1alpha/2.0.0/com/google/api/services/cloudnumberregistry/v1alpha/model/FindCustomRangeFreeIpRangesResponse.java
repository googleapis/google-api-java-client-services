...
public final class FindCustomRangeFreeIpRangesResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public FindCustomRangeFreeIpRangesResponse set(String fieldName, Object value) {
    return (FindCustomRangeFreeIpRangesResponse) super.set(fieldName, value);
  }

  @Override
  public FindCustomRangeFreeIpRangesResponse clone() {
    return (FindCustomRangeFreeIpRangesResponse) super.clone();
  }
