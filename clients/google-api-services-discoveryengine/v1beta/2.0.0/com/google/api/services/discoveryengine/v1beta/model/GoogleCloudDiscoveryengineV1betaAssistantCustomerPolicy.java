...
public final class GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicyBannedPhrase> getBannedPhrases() {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy setDataProtectionPolicy(GoogleCloudDiscoveryengineV1betaDataProtectionPolicy dataProtectionPolicy) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy clone() {
    return (GoogleCloudDiscoveryengineV1betaAssistantCustomerPolicy) super.clone();
  }
