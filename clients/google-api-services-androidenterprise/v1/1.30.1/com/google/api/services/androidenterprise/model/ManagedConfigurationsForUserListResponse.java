...
public final class ManagedConfigurationsForUserListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ManagedConfiguration> managedConfigurationForUser;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ManagedConfiguration> getManagedConfigurationForUser() {
    return managedConfigurationForUser;
  }

  /**
   * A managed configuration for an app for a specific user.
   * @param managedConfigurationForUser managedConfigurationForUser or {@code null} for none
   */
  public ManagedConfigurationsForUserListResponse setManagedConfigurationForUser(java.util.List<ManagedConfiguration> managedConfigurationForUser) {
    this.managedConfigurationForUser = managedConfigurationForUser;
    return this;
  }

  @Override
  public ManagedConfigurationsForUserListResponse set(String fieldName, Object value) {
