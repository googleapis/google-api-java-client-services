...
public final class NodeGroupList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NodeGroup> items;

  static {
    // hack to force ProGuard to consider NodeGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NodeGroup.class);
  }
   ...
   */
  public NodeGroupList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NodeGroup> getItems() {
    return items;
  }
   ...
   */
  public NodeGroupList setItems(java.util.List<NodeGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NodeGroupList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NodeGroupList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeGroupList set(String fieldName, Object value) {
    return (NodeGroupList) super.set(fieldName, value);
  }

  @Override
  public NodeGroupList clone() {
    return (NodeGroupList) super.clone();
  }
