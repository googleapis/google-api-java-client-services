...
public final class ReservationList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Reservation> items;

  static {
    // hack to force ProGuard to consider Reservation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Reservation.class);
  }

  /**
   * Output only. [Output Only] Type of resource.Always compute#reservationsList for listsof
   * reservations
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public ReservationList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Reservation> getItems() {
    return items;
  }
   ...
   */
  public ReservationList setItems(java.util.List<Reservation> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ReservationList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ReservationList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ReservationList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ReservationList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ReservationList set(String fieldName, Object value) {
    return (ReservationList) super.set(fieldName, value);
  }

  @Override
  public ReservationList clone() {
    return (ReservationList) super.clone();
  }
