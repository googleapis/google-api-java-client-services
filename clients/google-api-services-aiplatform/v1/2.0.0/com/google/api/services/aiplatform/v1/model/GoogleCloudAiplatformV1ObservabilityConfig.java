...
public final class GoogleCloudAiplatformV1ObservabilityConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1ObservabilityConfig setObservabilityEnabled(java.lang.Boolean observabilityEnabled) {
   ...
   */
  public GoogleCloudAiplatformV1ObservabilityConfig setSensitiveLoggingEnabled(java.lang.Boolean sensitiveLoggingEnabled) {
    this.sensitiveLoggingEnabled = sensitiveLoggingEnabled;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1ObservabilityConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1ObservabilityConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1ObservabilityConfig clone() {
    return (GoogleCloudAiplatformV1ObservabilityConfig) super.clone();
  }
