...
public class AppState extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google App State API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class States {
    ...
    public class Clear extends AppStateRequest<com.google.appstate.model.WriteResult> {
    ...
    [maximum: 3]
      ...
      protected Clear(java.lang.Integer stateKey) {
        super(AppState.this, "POST", REST_PATH, null, com.google.appstate.model.WriteResult.class);
    ...
    public class Get extends AppStateRequest<com.google.appstate.model.GetResponse> {
    ...
    [maximum: 3]
      ...
      protected Get(java.lang.Integer stateKey) {
        super(AppState.this, "GET", REST_PATH, null, com.google.appstate.model.GetResponse.class);
        this.stateKey = com.google.api.client.util.Preconditions.checkNotNull(stateKey, "Required parameter stateKey must be specified.");
      }
    ...
    public class List extends AppStateRequest<com.google.appstate.model.ListResponse> {
       ...
       */
      protected List() {
        super(AppState.this, "GET", REST_PATH, null, com.google.appstate.model.ListResponse.class);
      }
    ...
    [minimum: 0]
    [maximum: 3]
     * @param content the {@link com.google.appstate.model.UpdateRequest}
     * @return the request
     */
    public Update update(java.lang.Integer stateKey, com.google.appstate.model.UpdateRequest content) throws java.io.IOException {
      Update result = new Update(stateKey, content);
      initialize(result);
      return result;
    }

    public class Update extends AppStateRequest<com.google.appstate.model.WriteResult> {
    ...
    [maximum: 3]
       ...
       * @since 1.13
       */
      protected Update(java.lang.Integer stateKey, com.google.appstate.model.UpdateRequest content) {
        super(AppState.this, "PUT", REST_PATH, content, com.google.appstate.model.WriteResult.class);
        this.stateKey = com.google.api.client.util.Preconditions.checkNotNull(stateKey, "Required parameter stateKey must be specified.");
      }
