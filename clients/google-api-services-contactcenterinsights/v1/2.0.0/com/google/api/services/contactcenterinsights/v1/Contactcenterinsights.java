...
public class Contactcenterinsights extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      /**
       * An accessor for creating requests from the AuthorizedViewSet collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code Contactcenterinsights contactcenterinsights = new Contactcenterinsights(...);}
       *   {@code Contactcenterinsights.AuthorizedViewSet.List request = contactcenterinsights.authorizedViewSet().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public AuthorizedViewSet authorizedViewSet() {
        return new AuthorizedViewSet();
      }

      /**
       * The "authorizedViewSet" collection of methods.
       */
      public class AuthorizedViewSet {

        /**
         * An accessor for creating requests from the AuthorizedView collection.
         *
         * <p>The typical use is:</p>
         * <pre>
         *   {@code Contactcenterinsights contactcenterinsights = new Contactcenterinsights(...);}
         *   {@code Contactcenterinsights.AuthorizedView.List request = contactcenterinsights.authorizedView().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        public AuthorizedView authorizedView() {
         ...
         */
        public class AuthorizedView {

          /**
           * Gets conversation statistics.
           *
           * Create a request for the method "authorizedView.calculateStats".
           *
           * This request holds the parameters needed by the contactcenterinsights server.  After setting any
          ...
          public class CalculateStats extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1CalculateStatsResponse> {
            ...
            private static final String REST_PATH = "v1/{+location}:calculateStats";

            private final java.util.regex.Pattern LOCATION_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/authorizedViewSet/[^/]+/authorizedView/[^/]+$");
           ...
           * Query metrics.
           *
           * Create a request for the method "authorizedView.queryMetrics".
           *
           * This request holds the parameters needed by the contactcenterinsights server.  After setting any
           * optional parameters, call the {@link QueryMetrics#execute()} method to invoke the remote
           * operation.
          ...
          public class Conversations {
            ...
            public class FeedbackLabels {
              ...
              public class Create extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1FeedbackLabel> {
                ...
                private final java.util.regex.Pattern PARENT_PATTERN =
                    java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/authorizedViewSet/[^/]+/authorizedViews/[^/]+/conversations/[^/]+$");
              ...
              public class Delete extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleProtobufEmpty> {
                ...
                private final java.util.regex.Pattern NAME_PATTERN =
                    java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/authorizedViewSet/[^/]+/authorizedViews/[^/]+/conversations/[^/]+/feedbackLabels/[^/]+$");
        ...
        public class AuthorizedViews {
          ...
          public class Conversations {
            ...
            public class Create extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1Conversation> {
              ...
              /**
               * A unique ID for the new conversation. This ID will become the final component of
               * the conversation's resource name. If no ID is specified, a server-generated ID will
             ...
             * @return the request
             */
            public Upload upload(java.lang.String parent, com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1Conversation content) throws java.io.IOException {
            ...
            public class Upload extends ContactcenterinsightsRequest<com.google.api.services.contactcenterinsights.v1.model.GoogleLongrunningOperation> {
               ...
               * @since 1.13
               */
              protected Upload(java.lang.String parent, com.google.api.services.contactcenterinsights.v1.model.GoogleCloudContactcenterinsightsV1Conversation content) {
                super(Contactcenterinsights.this, "POST", REST_PATH, content, com.google.api.services.contactcenterinsights.v1.model.GoogleLongrunningOperation.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
             ...
             conversation's resource name. If no ID is specified, a server-generated ID will be used. This value
             ...
             characters are `a-z-`
               ...
               * regular expression `^[a-z0-9-]{4,64}$`. Valid characters are `a-z-`
               */
              public Upload setConversationId(java.lang.String conversationId) {
                this.conversationId = conversationId;
                return this;
              }
               ...
               */
              @com.google.api.client.util.Key("redactionConfig.deidentifyTemplate")
              private java.lang.String redactionConfigDeidentifyTemplate;

              /** The fully-qualified DLP deidentify template resource name. Format:
             `projects/{project}/deidentifyTemplates/{template}`
               */
              public java.lang.String getRedactionConfigDeidentifyTemplate() {
                return redactionConfigDeidentifyTemplate;
              }
               ...
               * `projects/{project}/deidentifyTemplates/{template}`
               */
              public Upload setRedactionConfigDeidentifyTemplate(java.lang.String redactionConfigDeidentifyTemplate) {
                this.redactionConfigDeidentifyTemplate = redactionConfigDeidentifyTemplate;
                return this;
              }
               ...
               */
              @com.google.api.client.util.Key("redactionConfig.inspectTemplate")
              private java.lang.String redactionConfigInspectTemplate;

              /** The fully-qualified DLP inspect template resource name. Format:
             `projects/{project}/locations/{location}/inspectTemplates/{template}`
               */
              public java.lang.String getRedactionConfigInspectTemplate() {
                return redactionConfigInspectTemplate;
              }
               ...
               * `projects/{project}/locations/{location}/inspectTemplates/{template}`
               */
              public Upload setRedactionConfigInspectTemplate(java.lang.String redactionConfigInspectTemplate) {
                this.redactionConfigInspectTemplate = redactionConfigInspectTemplate;
                return this;
              }
               ...
               */
              @com.google.api.client.util.Key("speechConfig.speechRecognizer")
              private java.lang.String speechConfigSpeechRecognizer;

              /** The fully-qualified Speech Recognizer resource name. Format:
             `projects/{project_id}/locations/{location}/recognizer/{recognizer}`
               */
              public java.lang.String getSpeechConfigSpeechRecognizer() {
                return speechConfigSpeechRecognizer;
              }
               ...
               * `projects/{project_id}/locations/{location}/recognizer/{recognizer}`
               */
              public Upload setSpeechConfigSpeechRecognizer(java.lang.String speechConfigSpeechRecognizer) {
                this.speechConfigSpeechRecognizer = speechConfigSpeechRecognizer;
                return this;
              }
