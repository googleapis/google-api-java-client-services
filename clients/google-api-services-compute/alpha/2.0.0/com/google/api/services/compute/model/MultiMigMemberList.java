...
/**
 * Model definition for MultiMigMemberList.
 *
...
public final class MultiMigMemberList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<MultiMigMember> items;

  static {
    // hack to force ProGuard to consider MultiMigMember used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(MultiMigMember.class);
  }
   ...
   * results is larger than maxResults, use the nextPageToken as a value for the query parameter
   ...
   */
  public MultiMigMemberList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<MultiMigMember> getItems() {
    return items;
  }
   ...
   */
  public MultiMigMemberList setItems(java.util.List<MultiMigMember> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public MultiMigMemberList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public MultiMigMemberList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public MultiMigMemberList set(String fieldName, Object value) {
    return (MultiMigMemberList) super.set(fieldName, value);
  }

  @Override
  public MultiMigMemberList clone() {
    return (MultiMigMemberList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for MultiMigMemberListWarningData.
     */
