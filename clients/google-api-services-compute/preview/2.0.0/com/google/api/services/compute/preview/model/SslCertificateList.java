...
public final class SslCertificateList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<SslCertificate> items;

  static {
    // hack to force ProGuard to consider SslCertificate used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(SslCertificate.class);
  }
   ...
   */
  public SslCertificateList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<SslCertificate> getItems() {
    return items;
  }
   ...
   */
  public SslCertificateList setItems(java.util.List<SslCertificate> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SslCertificateList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public SslCertificateList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SslCertificateList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public SslCertificateList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SslCertificateList set(String fieldName, Object value) {
    return (SslCertificateList) super.set(fieldName, value);
  }

  @Override
  public SslCertificateList clone() {
    return (SslCertificateList) super.clone();
  }
