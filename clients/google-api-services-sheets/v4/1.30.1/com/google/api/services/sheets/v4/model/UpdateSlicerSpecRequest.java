...
public final class UpdateSlicerSpecRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public UpdateSlicerSpecRequest setSlicerId(java.lang.Integer slicerId) {
   ...
   */
  public UpdateSlicerSpecRequest setSpec(SlicerSpec spec) {
    this.spec = spec;
    return this;
  }

  @Override
  public UpdateSlicerSpecRequest set(String fieldName, Object value) {
    return (UpdateSlicerSpecRequest) super.set(fieldName, value);
  }
