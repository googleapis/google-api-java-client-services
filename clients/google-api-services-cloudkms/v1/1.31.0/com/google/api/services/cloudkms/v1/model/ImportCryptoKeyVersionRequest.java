...
public final class ImportCryptoKeyVersionRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. This field has the same meaning as wrapped_key. Prefer to use that field in new work.
   * Either that field or this field (but not both) must be specified.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * (RSA_OAEP_3072_SHA1_AES_256 or RSA_OAEP_4096_SHA1_AES_256 or RSA_OAEP_3072_SHA256_AES_256 or
   * RSA_OAEP_4096_SHA256_AES_256), this field must contain the concatenation of: 1. An ephemeral
   * AES-256 wrapping key wrapped with the public_key using RSAES-OAEP with SHA-1/SHA-256, MGF1 with
   * SHA-1/SHA-256, and an empty label. 2. The formatted key to be imported, wrapped with the
   * ephemeral AES-256 key using AES-KWP (RFC 5649). This format is the same as the format produced
   * by PKCS#11 mechanism CKM_RSA_AES_KEY_WRAP. When wrapping with import methods
   * (RSA_OAEP_3072_SHA256 or RSA_OAEP_4096_SHA256), this field must contain the formatted key to be
   * imported, wrapped with the public_key using RSAES-OAEP with SHA-256, MGF1 with SHA-256, and an
   * empty label.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
