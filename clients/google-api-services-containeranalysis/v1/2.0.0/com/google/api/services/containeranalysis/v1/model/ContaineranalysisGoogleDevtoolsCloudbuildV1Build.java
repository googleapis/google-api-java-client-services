...
public final class ContaineranalysisGoogleDevtoolsCloudbuildV1Build extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1Secret> secrets;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep> steps;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan> timing;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning> warnings;
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setApproval(ContaineranalysisGoogleDevtoolsCloudbuildV1BuildApproval approval) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setArtifacts(ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts artifacts) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setAvailableSecrets(ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets availableSecrets) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setBuildTriggerId(java.lang.String buildTriggerId) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setFailureInfo(ContaineranalysisGoogleDevtoolsCloudbuildV1BuildFailureInfo failureInfo) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setImages(java.util.List<java.lang.String> images) {
    this.images = images;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setLogUrl(java.lang.String logUrl) {
    this.logUrl = logUrl;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setLogsBucket(java.lang.String logsBucket) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setOptions(ContaineranalysisGoogleDevtoolsCloudbuildV1BuildOptions options) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setProjectId(java.lang.String projectId) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setQueueTtl(String queueTtl) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setResults(ContaineranalysisGoogleDevtoolsCloudbuildV1Results results) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setServiceAccount(java.lang.String serviceAccount) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setSourceProvenance(ContaineranalysisGoogleDevtoolsCloudbuildV1SourceProvenance sourceProvenance) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setStartTime(String startTime) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setStatus(java.lang.String status) {
    this.status = status;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setStatusDetail(java.lang.String statusDetail) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep> getSteps() {
    return steps;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setSteps(java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep> steps) {
    this.steps = steps;
    return this;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setSubstitutions(java.util.Map<String, java.lang.String> substitutions) {
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setTags(java.util.List<java.lang.String> tags) {
    this.tags = tags;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan> getTiming() {
    return timing;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setTiming(java.util.Map<String, ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan> timing) {
    this.timing = timing;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning> getWarnings() {
    return warnings;
  }
   ...
   */
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build setWarnings(java.util.List<ContaineranalysisGoogleDevtoolsCloudbuildV1BuildWarning> warnings) {
    this.warnings = warnings;
    return this;
  }

  @Override
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build set(String fieldName, Object value) {
    return (ContaineranalysisGoogleDevtoolsCloudbuildV1Build) super.set(fieldName, value);
  }

  @Override
  public ContaineranalysisGoogleDevtoolsCloudbuildV1Build clone() {
