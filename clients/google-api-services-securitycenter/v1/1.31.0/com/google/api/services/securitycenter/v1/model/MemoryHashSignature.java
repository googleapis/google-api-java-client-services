...
public final class MemoryHashSignature extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider Detection used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Detection.class);
  }
  ...
  @Override
  public MemoryHashSignature set(String fieldName, Object value) {
    return (MemoryHashSignature) super.set(fieldName, value);
  }

  @Override
  public MemoryHashSignature clone() {
    return (MemoryHashSignature) super.clone();
  }
