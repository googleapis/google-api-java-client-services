...
public final class ImageParams extends com.google.api.client.json.GenericJson {

  /**
   * Input only. Resource manager tags to be bound to the image. Tag keys and values have the same
  ...
  @Override
  public ImageParams set(String fieldName, Object value) {
    return (ImageParams) super.set(fieldName, value);
  }

  @Override
  public ImageParams clone() {
    return (ImageParams) super.clone();
  }
