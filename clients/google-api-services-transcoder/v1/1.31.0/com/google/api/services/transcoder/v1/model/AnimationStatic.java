...
public final class AnimationStatic extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public AnimationStatic set(String fieldName, Object value) {
    return (AnimationStatic) super.set(fieldName, value);
  }

  @Override
  public AnimationStatic clone() {
    return (AnimationStatic) super.clone();
  }
