...
public class CloudScheduler extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Operations {
     ...
     * @param content the {@link com.google.api.services.cloudscheduler.v1.model.CancelOperationRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.CancelOperationRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Empty> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.api.services.cloudscheduler.v1.model.CancelOperationRequest content) {
        super(CloudScheduler.this, "POST", REST_PATH, content, com.google.api.services.cloudscheduler.v1.model.Empty.class);
    ...
    public class Get extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.Operation> {
      ...
      protected Get(java.lang.String name) {
        super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudSchedulerRequest<com.google.api.services.cloudscheduler.v1.model.ListOperationsResponse> {
      ...
      protected List(java.lang.String name) {
        super(CloudScheduler.this, "GET", REST_PATH, null, com.google.api.services.cloudscheduler.v1.model.ListOperationsResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
