...
public class CertificateAuthorityService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      /**
       * An accessor for creating requests from the ManagedPkis collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code CertificateAuthorityService privateca = new CertificateAuthorityService(...);}
       *   {@code CertificateAuthorityService.ManagedPkis.List request = privateca.managedPkis().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public ManagedPkis managedPkis() {
        return new ManagedPkis();
      }

      /**
       * The "managedPkis" collection of methods.
       */
      public class ManagedPkis {

        /**
         * Gets the access control policy for a resource. Returns an empty policy if the resource exists and
         * does not have a policy set.
         *
         * Create a request for the method "managedPkis.getIamPolicy".
         *
         * This request holds the parameters needed by the privateca server.  After setting any optional
         * parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote operation.
         *
        ...
        public class GetIamPolicy extends CertificateAuthorityServiceRequest<com.google.api.services.privateca.v1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/managedPkis/[^/]+$");
