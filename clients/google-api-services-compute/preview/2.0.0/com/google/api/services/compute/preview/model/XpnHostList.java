...
public final class XpnHostList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Type of resource. Always compute#xpnHostList for lists of shared VPC
   * hosts.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public XpnHostList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public XpnHostList setItems(java.util.List<Project> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public XpnHostList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public XpnHostList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public XpnHostList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public XpnHostList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public XpnHostList set(String fieldName, Object value) {
    return (XpnHostList) super.set(fieldName, value);
  }

  @Override
  public XpnHostList clone() {
    return (XpnHostList) super.clone();
  }
