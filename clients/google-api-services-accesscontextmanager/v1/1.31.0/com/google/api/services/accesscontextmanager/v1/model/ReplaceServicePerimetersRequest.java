...
/**
 * A request to replace all existing Service Perimeters in an Access Policy with the Service
...
public final class ReplaceServicePerimetersRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The desired Service Perimeters that should replace all existing Service Perimeters in
   * the Access Policy.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public ReplaceServicePerimetersRequest setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ReplaceServicePerimetersRequest setServicePerimeters(java.util.List<ServicePerimeter> servicePerimeters) {
    this.servicePerimeters = servicePerimeters;
    return this;
  }

  @Override
  public ReplaceServicePerimetersRequest set(String fieldName, Object value) {
    return (ReplaceServicePerimetersRequest) super.set(fieldName, value);
  }

  @Override
  public ReplaceServicePerimetersRequest clone() {
    return (ReplaceServicePerimetersRequest) super.clone();
  }
