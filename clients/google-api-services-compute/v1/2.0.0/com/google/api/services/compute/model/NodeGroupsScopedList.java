...
public final class NodeGroupsScopedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] A list of node groups contained in this scope.
   * @param nodeGroups nodeGroups or {@code null} for none
   */
  public NodeGroupsScopedList setNodeGroups(java.util.List<NodeGroup> nodeGroups) {
   ...
   */
  public NodeGroupsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeGroupsScopedList set(String fieldName, Object value) {
    return (NodeGroupsScopedList) super.set(fieldName, value);
  }

  @Override
  public NodeGroupsScopedList clone() {
    return (NodeGroupsScopedList) super.clone();
  }
