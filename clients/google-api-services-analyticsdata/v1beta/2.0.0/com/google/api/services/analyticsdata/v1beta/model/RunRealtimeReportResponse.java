...
public final class RunRealtimeReportResponse extends com.google.api.client.json.GenericJson {
   ...
   * returned in the response and the `limit` request parameter. For example if a query returns 175
   * rows and includes `limit` of 50 in the API request, the response will contain `rowCount` of 175
   * but only 50 rows.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public RunRealtimeReportResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
