...
public final class ZoneList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Zone> items;

  static {
    // hack to force ProGuard to consider Zone used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Zone.class);
  }
   ...
   */
  public ZoneList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Zone> getItems() {
    return items;
  }
   ...
   */
  public ZoneList setItems(java.util.List<Zone> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ZoneList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ZoneList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ZoneList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ZoneList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ZoneList set(String fieldName, Object value) {
    return (ZoneList) super.set(fieldName, value);
  }

  @Override
  public ZoneList clone() {
    return (ZoneList) super.clone();
  }
