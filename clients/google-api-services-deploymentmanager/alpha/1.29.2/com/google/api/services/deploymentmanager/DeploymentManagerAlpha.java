...
/**
 * Service definition for DeploymentManagerAlpha (alpha).
 *
 * <p>
 ...
 *
 * <p>
 * This service uses {@link DeploymentManagerAlphaRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class DeploymentManagerAlpha extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.29.2 of the Google Cloud Deployment Manager Alpha API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "deploymentmanager/alpha/projects/";
   ...
   * @since 1.23
   */
  public static final String DEFAULT_BATCH_PATH = "batch/deploymentmanager/alpha";
   ...
   * @since 1.7
   */
  public DeploymentManagerAlpha(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  DeploymentManagerAlpha(Builder builder) {
    super(builder);
  }
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.CompositeTypes.List request = deploymentmanager.compositeTypes().list(parameters ...)}
   * </pre>
   *
  ...
  public class CompositeTypes {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.CompositeType> {
      ...
      protected Get(java.lang.String project, java.lang.String compositeType) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.CompositeType.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.CompositeTypesListResponse> {
      ...
      protected List(java.lang.String project) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.CompositeTypesListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.Deployments.List request = deploymentmanager.deployments().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Deployments {
    ...
    public class CancelPreview extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Operation> {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Deployment> {
      ...
      protected Get(java.lang.String project, java.lang.String deployment) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Deployment.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class GetIamPolicy extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Policy> {
      ...
      protected GetIamPolicy(java.lang.String project, java.lang.String resource) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Policy.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.DeploymentsListResponse> {
       ...
       */
      protected List(java.lang.String project) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.DeploymentsListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class SetIamPolicy extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Policy> {
      ...
      protected SetIamPolicy(java.lang.String project, java.lang.String resource, com.google.api.services.deploymentmanager.model.GlobalSetPolicyRequest content) {
        super(DeploymentManagerAlpha.this, "POST", REST_PATH, content, com.google.api.services.deploymentmanager.model.Policy.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class Stop extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Operation> {
    ...
    public class TestIamPermissions extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TestPermissionsResponse> {
      ...
      protected TestIamPermissions(java.lang.String project, java.lang.String resource, com.google.api.services.deploymentmanager.model.TestPermissionsRequest content) {
        super(DeploymentManagerAlpha.this, "POST", REST_PATH, content, com.google.api.services.deploymentmanager.model.TestPermissionsResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.Manifests.List request = deploymentmanager.manifests().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Manifests {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Manifest> {
      ...
      protected Get(java.lang.String project, java.lang.String deployment, java.lang.String manifest) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Manifest.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.ManifestsListResponse> {
      ...
      protected List(java.lang.String project, java.lang.String deployment) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.ManifestsListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.Operations.List request = deploymentmanager.operations().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Operations {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Operation> {
      ...
      protected Get(java.lang.String project, java.lang.String operation) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Operation.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.OperationsListResponse> {
       ...
       */
      protected List(java.lang.String project) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.OperationsListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.Resources.List request = deploymentmanager.resources().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Resources {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Resource> {
      ...
      protected Get(java.lang.String project, java.lang.String deployment, java.lang.String resource) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Resource.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.ResourcesListResponse> {
       ...
       */
      protected List(java.lang.String project, java.lang.String deployment) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.ResourcesListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.TypeProviders.List request = deploymentmanager.typeProviders().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class TypeProviders {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TypeProvider> {
      ...
      protected Get(java.lang.String project, java.lang.String typeProvider) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.TypeProvider.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class GetType extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TypeInfo> {
      ...
      protected GetType(java.lang.String project, java.lang.String typeProvider, java.lang.String type) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.TypeInfo.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TypeProvidersListResponse> {
       ...
       */
      protected List(java.lang.String project) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.TypeProvidersListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class ListTypes extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TypeProvidersListTypesResponse> {
      ...
      protected ListTypes(java.lang.String project, java.lang.String typeProvider) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.TypeProvidersListTypesResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
   ...
   * <pre>
   *   {@code DeploymentManagerAlpha deploymentmanager = new DeploymentManagerAlpha(...);}
   *   {@code DeploymentManagerAlpha.Types.List request = deploymentmanager.types().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Types {
    ...
    public class Get extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.Type> {
      ...
      protected Get(java.lang.String project, java.lang.String type) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.Type.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
    ...
    public class List extends DeploymentManagerAlphaRequest<com.google.api.services.deploymentmanager.model.TypesListResponse> {
       ...
       */
      protected List(java.lang.String project) {
        super(DeploymentManagerAlpha.this, "GET", REST_PATH, null, com.google.api.services.deploymentmanager.model.TypesListResponse.class);
        this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
              "Parameter project must conform to the pattern " +
  ...
  /**
   * Builder for {@link DeploymentManagerAlpha}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link DeploymentManagerAlpha}. */
    @Override
    public DeploymentManagerAlpha build() {
      return new DeploymentManagerAlpha(this);
    }
    ...
    /**
     * Set the {@link DeploymentManagerAlphaRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setDeploymentManagerAlphaRequestInitializer(
        DeploymentManagerAlphaRequestInitializer deploymentmanageralphaRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(deploymentmanageralphaRequestInitializer);
    }
