...
/**
 * Model definition for RecoverableSnapshotList.
 *
...
public final class RecoverableSnapshotList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<RecoverableSnapshot> items;
  ...
  /**
   * [Output Only] Type of resource. Always compute#recoverableSnapshotList for lists of
   ...
   */
  public RecoverableSnapshotList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public RecoverableSnapshotList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RecoverableSnapshot> getItems() {
    return items;
  }
   ...
   */
  public RecoverableSnapshotList setItems(java.util.List<RecoverableSnapshot> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RecoverableSnapshotList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RecoverableSnapshotList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RecoverableSnapshotList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RecoverableSnapshotList set(String fieldName, Object value) {
    return (RecoverableSnapshotList) super.set(fieldName, value);
  }

  @Override
  public RecoverableSnapshotList clone() {
    return (RecoverableSnapshotList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RecoverableSnapshotListWarningData.
     */
