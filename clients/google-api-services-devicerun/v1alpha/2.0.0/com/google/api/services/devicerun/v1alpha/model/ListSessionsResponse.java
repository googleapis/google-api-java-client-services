...
public final class ListSessionsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Token to receive the next page of sessions. This will be absent if the end of the response list
   * has been reached.
   ...
   */
  public ListSessionsResponse setUnreachable(java.util.List<java.lang.String> unreachable) {
