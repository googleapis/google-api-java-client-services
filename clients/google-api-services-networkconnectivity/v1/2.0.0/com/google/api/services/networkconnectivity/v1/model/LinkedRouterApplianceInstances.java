...
public final class LinkedRouterApplianceInstances extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RouterApplianceInstance> getInstances() {
    return instances;
  }
   ...
   */
  public LinkedRouterApplianceInstances setInstances(java.util.List<RouterApplianceInstance> instances) {
  ...
  @Override
  public LinkedRouterApplianceInstances set(String fieldName, Object value) {
    return (LinkedRouterApplianceInstances) super.set(fieldName, value);
  }

  @Override
  public LinkedRouterApplianceInstances clone() {
    return (LinkedRouterApplianceInstances) super.clone();
  }
