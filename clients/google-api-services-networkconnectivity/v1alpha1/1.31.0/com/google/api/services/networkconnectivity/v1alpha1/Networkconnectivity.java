 ...
 * <a href="https://cloud.google.com/network-connectivity/docs" target="_blank">API Documentation</a>
 * </p>
 *
 * <p>
...
public class Networkconnectivity extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.31.0 of the Network Connectivity API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
    ...
    public class Locations {
      ...
      public class PolicyBasedRoutes {
        ...
        public class GetIamPolicy extends NetworkconnectivityRequest<com.google.api.services.networkconnectivity.v1alpha1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/policyBasedRoutes/[^/]+$");
      ...
      /**
       * An accessor for creating requests from the PrivateRanges collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code Networkconnectivity networkconnectivity = new Networkconnectivity(...);}
       *   {@code Networkconnectivity.PrivateRanges.List request = networkconnectivity.privateRanges().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public PrivateRanges privateRanges() {
        return new PrivateRanges();
      }

      /**
       * The "privateRanges" collection of methods.
       */
      public class PrivateRanges {

        /**
         * Gets the access control policy for a resource. Returns an empty policy if the resource exists and
         * does not have a policy set.
         *
         * Create a request for the method "privateRanges.getIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote
         * operation.
        ...
        public class GetIamPolicy extends NetworkconnectivityRequest<com.google.api.services.networkconnectivity.v1alpha1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/privateRanges/[^/]+$");
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "privateRanges.setIamPolicy".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote
         * operation.
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "privateRanges.testIamPermissions".
         *
         * This request holds the parameters needed by the networkconnectivity server.  After setting any
         * optional parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote
         * operation.
