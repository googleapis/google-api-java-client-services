...
public final class CutoverJob extends com.google.api.client.json.GenericJson {
   ...
   */
  public CutoverJob setComputeEngineVmDetails(TargetVMDetails computeEngineVmDetails) {
   ...
   */
  public CutoverJob setProgress(java.lang.Integer progress) {
   ...
   */
  public CutoverJob setTargetDetails(TargetVMDetails targetDetails) {
