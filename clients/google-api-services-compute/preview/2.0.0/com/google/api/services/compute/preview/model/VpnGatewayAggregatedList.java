...
public final class VpnGatewayAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, VpnGatewaysScopedList> items;
   ...
   */
  public VpnGatewayAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, VpnGatewaysScopedList> getItems() {
    return items;
  }
   ...
   */
  public VpnGatewayAggregatedList setItems(java.util.Map<String, VpnGatewaysScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public VpnGatewayAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public VpnGatewayAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public VpnGatewayAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public VpnGatewayAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public VpnGatewayAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VpnGatewayAggregatedList set(String fieldName, Object value) {
    return (VpnGatewayAggregatedList) super.set(fieldName, value);
  }

  @Override
  public VpnGatewayAggregatedList clone() {
    return (VpnGatewayAggregatedList) super.clone();
  }
