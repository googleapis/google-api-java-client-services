...
public final class ProductVisibility extends com.google.api.client.json.GenericJson {

  /**
   * The product ID to make visible to the user. Required for each item in the productVisibility
   * list.
   ...
   */
  public ProductVisibility setProductId(java.lang.String productId) {
  ...
  @Override
  public ProductVisibility set(String fieldName, Object value) {
