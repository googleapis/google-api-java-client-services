...
public final class ObjectMeta extends com.google.api.client.json.GenericJson {
   ...
   * disabled`: Service. * `run.googleapis.com/description`: Service. * `run.googleapis.com
   * /encryption-key-shutdown-hours`: Revision * `run.googleapis.com/encryption-key`: Revision,
   ...
   * (ALPHA) * `run.googleapis.com/network-interfaces`: Revision, Execution. * `run.googleapis.com
   * /post-key-revocation-action-type`: Revision. * `run.googleapis.com/secrets`: Revision,
