...
/**
 * Model definition for AddOrderDealsResponse.
 *
...
public final class AddOrderDealsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public AddOrderDealsResponse setDeals(java.util.List<MarketplaceDeal> deals) {
    this.deals = deals;
    return this;
  }
   ...
   */
  public AddOrderDealsResponse setProposalRevisionNumber(java.lang.Long proposalRevisionNumber) {
    this.proposalRevisionNumber = proposalRevisionNumber;
    return this;
  }

  @Override
  public AddOrderDealsResponse set(String fieldName, Object value) {
    return (AddOrderDealsResponse) super.set(fieldName, value);
  }

  @Override
  public AddOrderDealsResponse clone() {
    return (AddOrderDealsResponse) super.clone();
  }
