...
public final class SslCertsInsertRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * User supplied name. Must be a distinct name from the other certificates for this instance. New
   * certificates will not be usable until the instance is restarted.
  ...
  @Override
  public SslCertsInsertRequest set(String fieldName, Object value) {
    return (SslCertsInsertRequest) super.set(fieldName, value);
  }
