...
public final class ListRevisionsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A token to request the next page of resources from the 'ListRevisions' method. The value of an
   ...
   */
  public ListRevisionsResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ListRevisionsResponse setRevisions(java.util.List<Revision> revisions) {
