...
public final class NotificationEndpointList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NotificationEndpoint> items;

  static {
    // hack to force ProGuard to consider NotificationEndpoint used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NotificationEndpoint.class);
  }
   ...
   */
  public NotificationEndpointList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NotificationEndpoint> getItems() {
    return items;
  }
   ...
   */
  public NotificationEndpointList setItems(java.util.List<NotificationEndpoint> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NotificationEndpointList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NotificationEndpointList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NotificationEndpointList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NotificationEndpointList set(String fieldName, Object value) {
    return (NotificationEndpointList) super.set(fieldName, value);
  }

  @Override
  public NotificationEndpointList clone() {
    return (NotificationEndpointList) super.clone();
  }
