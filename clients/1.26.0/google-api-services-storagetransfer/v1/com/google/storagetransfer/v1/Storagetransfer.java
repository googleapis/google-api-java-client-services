...
package com.google.storagetransfer.v1;
 ...
 * <a href="https://cloud.google.com/storage/transfer" target="_blank">API Documentation</a>
 * </p>
 *
 * <p>
...
public class Storagetransfer extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Storage Transfer API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GoogleServiceAccounts {
     ...
     *
     * @param projectId The ID of the Google Cloud Platform Console project that the Google service
    ...
    public class Get extends StoragetransferRequest<com.google.storagetransfer.v1.model.GoogleServiceAccount> {
    ...
    Required.
      ...
      protected Get(java.lang.String projectId) {
        super(Storagetransfer.this, "GET", REST_PATH, null, com.google.storagetransfer.v1.model.GoogleServiceAccount.class);
      ...
      /**
       * The ID of the Google Cloud Platform Console project that the Google service account is
       * associated with. Required.
       */
      @com.google.api.client.util.Key
      private java.lang.String projectId;

      /** The ID of the Google Cloud Platform Console project that the Google service account is associated
     with. Required.
       */
  ...
  public class TransferJobs {
     ...
     *
     * @param content the {@link com.google.storagetransfer.v1.model.TransferJob}
     * @return the request
     */
    public Create create(com.google.storagetransfer.v1.model.TransferJob content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends StoragetransferRequest<com.google.storagetransfer.v1.model.TransferJob> {
       ...
       * @since 1.13
       */
      protected Create(com.google.storagetransfer.v1.model.TransferJob content) {
        super(Storagetransfer.this, "POST", REST_PATH, content, com.google.storagetransfer.v1.model.TransferJob.class);
      }
    ...
    public class Get extends StoragetransferRequest<com.google.storagetransfer.v1.model.TransferJob> {
    ...
    Required.
      ...
      protected Get(java.lang.String jobName) {
        super(Storagetransfer.this, "GET", REST_PATH, null, com.google.storagetransfer.v1.model.TransferJob.class);
    ...
    public class List extends StoragetransferRequest<com.google.storagetransfer.v1.model.ListTransferJobsResponse> {
       ...
       */
      protected List() {
        super(Storagetransfer.this, "GET", REST_PATH, null, com.google.storagetransfer.v1.model.ListTransferJobsResponse.class);
      }
      ...
      /** A list of query parameters specified as JSON text in the form of {"project_id":"my_project_id",
     "job_names":["jobid1","jobid2",...], "job_statuses":["status1","status2",...]}. Since `job_names`
     and `job_statuses` support multiple values, their values must be specified with array notation.
     `project_id` is required. `job_names` and `job_statuses` are optional.  The valid values for
    ...
    Required.
     * @param content the {@link com.google.storagetransfer.v1.model.UpdateTransferJobRequest}
     * @return the request
     */
    public Patch patch(java.lang.String jobName, com.google.storagetransfer.v1.model.UpdateTransferJobRequest content) throws java.io.IOException {
      Patch result = new Patch(jobName, content);
      initialize(result);
      return result;
    }

    public class Patch extends StoragetransferRequest<com.google.storagetransfer.v1.model.TransferJob> {
    ...
    Required.
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String jobName, com.google.storagetransfer.v1.model.UpdateTransferJobRequest content) {
        super(Storagetransfer.this, "PATCH", REST_PATH, content, com.google.storagetransfer.v1.model.TransferJob.class);
        this.jobName = com.google.api.client.util.Preconditions.checkNotNull(jobName, "Required parameter jobName must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(JOB_NAME_PATTERN.matcher(jobName).matches(),
              "Parameter jobName must conform to the pattern " +
  ...
  public class TransferOperations {
    ...
    public class Cancel extends StoragetransferRequest<com.google.storagetransfer.v1.model.Empty> {
      ...
      protected Cancel(java.lang.String name) {
        super(Storagetransfer.this, "POST", REST_PATH, null, com.google.storagetransfer.v1.model.Empty.class);
    ...
    public class Delete extends StoragetransferRequest<com.google.storagetransfer.v1.model.Empty> {
      ...
      protected Delete(java.lang.String name) {
        super(Storagetransfer.this, "DELETE", REST_PATH, null, com.google.storagetransfer.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Get extends StoragetransferRequest<com.google.storagetransfer.v1.model.Operation> {
      ...
      protected Get(java.lang.String name) {
        super(Storagetransfer.this, "GET", REST_PATH, null, com.google.storagetransfer.v1.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends StoragetransferRequest<com.google.storagetransfer.v1.model.ListOperationsResponse> {
      ...
      protected List(java.lang.String name) {
        super(Storagetransfer.this, "GET", REST_PATH, null, com.google.storagetransfer.v1.model.ListOperationsResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
       ...
       * [\"opid1\", \"opid2\",...], \"transfer_statuses\":[\"status1\", \"status2\",...]}. Since
       * `job_names`, `operation_names`, and `transfer_statuses` support multiple values, they must
       * be specified with array notation. `job_names`, `operation_names`, and `transfer_statuses`
       * are optional.
       */
      @com.google.api.client.util.Key
      private java.lang.String filter;
     ...
     `operation_names`, and `transfer_statuses` support multiple values, they must be specified with
     array notation. `job_names`, `operation_names`, and `transfer_statuses` are optional.
       */
      public java.lang.String getFilter() {
        return filter;
      }
    ...
    Required.
     * @param content the {@link com.google.storagetransfer.v1.model.PauseTransferOperationRequest}
     * @return the request
     */
    public Pause pause(java.lang.String name, com.google.storagetransfer.v1.model.PauseTransferOperationRequest content) throws java.io.IOException {
      Pause result = new Pause(name, content);
      initialize(result);
      return result;
    }

    public class Pause extends StoragetransferRequest<com.google.storagetransfer.v1.model.Empty> {
    ...
    Required.
       ...
       * @since 1.13
       */
      protected Pause(java.lang.String name, com.google.storagetransfer.v1.model.PauseTransferOperationRequest content) {
        super(Storagetransfer.this, "POST", REST_PATH, content, com.google.storagetransfer.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     * @param name The name of the transfer operation.
    Required.
     * @param content the {@link com.google.storagetransfer.v1.model.ResumeTransferOperationRequest}
     * @return the request
     */
    public Resume resume(java.lang.String name, com.google.storagetransfer.v1.model.ResumeTransferOperationRequest content) throws java.io.IOException {
      Resume result = new Resume(name, content);
      initialize(result);
      return result;
    }

    public class Resume extends StoragetransferRequest<com.google.storagetransfer.v1.model.Empty> {
    ...
    Required.
       ...
       * @since 1.13
       */
      protected Resume(java.lang.String name, com.google.storagetransfer.v1.model.ResumeTransferOperationRequest content) {
        super(Storagetransfer.this, "POST", REST_PATH, content, com.google.storagetransfer.v1.model.Empty.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
