...
public final class ManagedZoneForwardingConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ManagedZoneForwardingConfig set(String fieldName, Object value) {
    return (ManagedZoneForwardingConfig) super.set(fieldName, value);
  }

  @Override
  public ManagedZoneForwardingConfig clone() {
    return (ManagedZoneForwardingConfig) super.clone();
  }
