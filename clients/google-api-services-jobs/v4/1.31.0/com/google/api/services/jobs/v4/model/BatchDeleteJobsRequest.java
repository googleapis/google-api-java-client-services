...
public final class BatchDeleteJobsRequest extends com.google.api.client.json.GenericJson {
   ...
   * "projects/foo/tenants/bar/jobs/baz". A maximum of 200 jobs can be deleted in a batch.
   ...
   */
  public BatchDeleteJobsRequest setNames(java.util.List<java.lang.String> names) {
    this.names = names;
    return this;
  }
