...
public class Playcustomapp extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google Play Custom App Publishing API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Accounts {
    ...
    public class CustomApps {
       ...
       * @param content the {@link com.google.playcustomapp.model.CustomApp}
       * @return the request
       */
      public Create create(java.lang.Long account, com.google.playcustomapp.model.CustomApp content) throws java.io.IOException {
       ...
       *
       * @param account Developer account ID.
       * @param content the {@link com.google.playcustomapp.model.CustomApp} media metadata or {@code null} if none
       * @param mediaContent The media HTTP content or {@code null} if none.
       * @return the request
       * @throws java.io.IOException if the initialization of the request fails
       */
      public Create create(java.lang.Long account, com.google.playcustomapp.model.CustomApp content, com.google.api.client.http.AbstractInputStreamContent mediaContent) throws java.io.IOException {
        Create result = new Create(account, content, mediaContent);
        initialize(result);
        return result;
      }

      public class Create extends PlaycustomappRequest<com.google.playcustomapp.model.CustomApp> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.Long account, com.google.playcustomapp.model.CustomApp content) {
          super(Playcustomapp.this, "POST", REST_PATH, content, com.google.playcustomapp.model.CustomApp.class);
         ...
         * @since 1.13
         */
        protected Create(java.lang.Long account, com.google.playcustomapp.model.CustomApp content, com.google.api.client.http.AbstractInputStreamContent mediaContent) {
          super(Playcustomapp.this, "POST", "/upload/" + getServicePath() + REST_PATH, content, com.google.playcustomapp.model.CustomApp.class);
          this.account = com.google.api.client.util.Preconditions.checkNotNull(account, "Required parameter account must be specified.");
