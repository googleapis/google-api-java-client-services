...
public class Fitness extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.3 of the Fitness library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Users {
    ...
    public class DataSources {
       ...
       * data source.
       *
       * Data sources are addressed using a string generated by the server, based on the contents of the
       * source being created.
       *
       * Creates a new data source that is unique across all data sources belonging to this user. The
       * dataStreamId field should be excluded. This will be automatically generated by the server with
       * the correct format. If a dataStreamId is included, it must match the format that the server would
       * generate. This format is a combination of some fields from the data source, and has a specific
       * order. If it doesn't match, the request will fail with an error.
       *
       * In addition to the data source fields reflected into the data source ID, the developer project
      ...
      public class Create extends FitnessRequest<com.google.api.services.fitness.model.DataSource> {
         ...
         * Creates a new data source that is unique across all data sources belonging to this user. The
         * dataStreamId field should be excluded. This will be automatically generated by the server with
         * the correct format. If a dataStreamId is included, it must match the format that the server
         * would generate. This format is a combination of some fields from the data source, and has a
         * specific order. If it doesn't match, the request will fail with an error.
         *
         * In addition to the data source fields reflected into the data source ID, the developer project
         * number that is authenticated when creating the data source is included. This developer project
         * number is obfuscated when read by any other developer reading public data types.
