...
public final class InstantSnapshotParams extends com.google.api.client.json.GenericJson {

  /**
   * Input only. Resource manager tags to be bound to the instant snapshot. Tag keys and values have
   ...
   */
  public InstantSnapshotParams setResourceManagerTags(java.util.Map<String, java.lang.String> resourceManagerTags) {
    this.resourceManagerTags = resourceManagerTags;
    return this;
  }

  @Override
  public InstantSnapshotParams set(String fieldName, Object value) {
    return (InstantSnapshotParams) super.set(fieldName, value);
  }

  @Override
  public InstantSnapshotParams clone() {
    return (InstantSnapshotParams) super.clone();
  }
