...
public final class GoogleCloudPolicysimulatorV1alphaReplayConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayConfig setLogSource(java.lang.String logSource) {
   ...
   */
  public GoogleCloudPolicysimulatorV1alphaReplayConfig setPolicyOverlay(java.util.Map<String, GoogleIamV1Policy> policyOverlay) {
    this.policyOverlay = policyOverlay;
    return this;
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaReplayConfig set(String fieldName, Object value) {
    return (GoogleCloudPolicysimulatorV1alphaReplayConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudPolicysimulatorV1alphaReplayConfig clone() {
    return (GoogleCloudPolicysimulatorV1alphaReplayConfig) super.clone();
  }
