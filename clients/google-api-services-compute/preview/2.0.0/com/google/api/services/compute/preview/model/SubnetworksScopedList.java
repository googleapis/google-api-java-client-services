...
public final class SubnetworksScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Subnetwork> subnetworks;
   ...
   */
  public java.util.List<Subnetwork> getSubnetworks() {
    return subnetworks;
  }
   ...
   */
  public SubnetworksScopedList setSubnetworks(java.util.List<Subnetwork> subnetworks) {
   ...
   */
  public SubnetworksScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SubnetworksScopedList set(String fieldName, Object value) {
    return (SubnetworksScopedList) super.set(fieldName, value);
  }

  @Override
  public SubnetworksScopedList clone() {
    return (SubnetworksScopedList) super.clone();
  }
