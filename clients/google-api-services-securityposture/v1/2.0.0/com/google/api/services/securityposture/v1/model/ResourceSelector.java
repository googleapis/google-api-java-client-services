...
public final class ResourceSelector extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The resource types to run the detector on. Each custom module can specify up to 5
   * resource types.
   ...
   */
  public ResourceSelector setResourceTypes(java.util.List<java.lang.String> resourceTypes) {
