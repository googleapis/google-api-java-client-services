...
public final class SchemaConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The depth for all recursive structures in the output analytics schema. For example, concept in
   * the CodeSystem resource is a recursive structure; when the depth is 2, the CodeSystem table
