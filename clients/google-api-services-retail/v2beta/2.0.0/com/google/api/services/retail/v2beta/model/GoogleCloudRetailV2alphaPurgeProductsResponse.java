...
public final class GoogleCloudRetailV2alphaPurgeProductsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2alphaPurgeProductsResponse setPurgeCount(java.lang.Long purgeCount) {
   ...
   */
  public GoogleCloudRetailV2alphaPurgeProductsResponse setPurgeSample(java.util.List<java.lang.String> purgeSample) {
    this.purgeSample = purgeSample;
    return this;
  }

  @Override
  public GoogleCloudRetailV2alphaPurgeProductsResponse set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaPurgeProductsResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaPurgeProductsResponse clone() {
    return (GoogleCloudRetailV2alphaPurgeProductsResponse) super.clone();
  }
