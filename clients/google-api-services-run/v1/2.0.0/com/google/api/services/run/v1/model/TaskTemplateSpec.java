...
public final class TaskTemplateSpec extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public TaskTemplateSpec set(String fieldName, Object value) {
    return (TaskTemplateSpec) super.set(fieldName, value);
  }

  @Override
  public TaskTemplateSpec clone() {
    return (TaskTemplateSpec) super.clone();
  }
