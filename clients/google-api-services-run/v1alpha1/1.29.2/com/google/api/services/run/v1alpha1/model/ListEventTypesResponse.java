...
public final class ListEventTypesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<EventType> items;
   ...
   */
  public ListEventTypesResponse setApiVersion(java.lang.String apiVersion) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<EventType> getItems() {
    return items;
  }
   ...
   */
  public ListEventTypesResponse setItems(java.util.List<EventType> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ListEventTypesResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ListEventTypesResponse setMetadata(ListMeta metadata) {
   ...
   */
  public ListEventTypesResponse setUnreachable(java.util.List<java.lang.String> unreachable) {
