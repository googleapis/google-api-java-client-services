...
public class Cloudbilling extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * <pre>
   *   {@code Cloudbilling cloudbilling = new Cloudbilling(...);}
   *   {@code Cloudbilling.Message.List request = cloudbilling.message().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Message {
     ...
     *
     * @param content the {@link com.google.api.services.cloudbilling.model.SendMessageRequest}
     * @return the request
     */
    public Send send(com.google.api.services.cloudbilling.model.SendMessageRequest content) throws java.io.IOException {
      Send result = new Send(content);
      initialize(result);
      return result;
    }

    public class Send extends CloudbillingRequest<com.google.api.services.cloudbilling.model.SendMessageResponse> {

      private static final String REST_PATH = "v1/message:send";
       ...
       * @since 1.13
       */
      protected Send(com.google.api.services.cloudbilling.model.SendMessageRequest content) {
        super(Cloudbilling.this, "POST", REST_PATH, content, com.google.api.services.cloudbilling.model.SendMessageResponse.class);
      }
     ...
     * @return the request
     */
    public Stream stream(com.google.api.services.cloudbilling.model.SendMessageRequest content) throws java.io.IOException {
      Stream result = new Stream(content);
      initialize(result);
      return result;
    }

    public class Stream extends CloudbillingRequest<com.google.api.services.cloudbilling.model.StreamResponse> {

      private static final String REST_PATH = "v1/message:stream";
       ...
       * @since 1.13
       */
      protected Stream(com.google.api.services.cloudbilling.model.SendMessageRequest content) {
        super(Cloudbilling.this, "POST", REST_PATH, content, com.google.api.services.cloudbilling.model.StreamResponse.class);
      }
   ...
   * <pre>
   *   {@code Cloudbilling cloudbilling = new Cloudbilling(...);}
   *   {@code Cloudbilling.Tasks.List request = cloudbilling.tasks().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Tasks {
     ...
     * @param content the {@link com.google.api.services.cloudbilling.model.CancelTaskRequest}
     * @return the request
     */
    public Cancel cancel(java.lang.String name, com.google.api.services.cloudbilling.model.CancelTaskRequest content) throws java.io.IOException {
      Cancel result = new Cancel(name, content);
      initialize(result);
      return result;
    }

    public class Cancel extends CloudbillingRequest<com.google.api.services.cloudbilling.model.Task> {
       ...
       * @since 1.13
       */
      protected Cancel(java.lang.String name, com.google.api.services.cloudbilling.model.CancelTaskRequest content) {
        super(Cloudbilling.this, "POST", REST_PATH, content, com.google.api.services.cloudbilling.model.Task.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Get extends CloudbillingRequest<com.google.api.services.cloudbilling.model.Task> {
       ...
       */
      protected Get(java.lang.String name) {
        super(Cloudbilling.this, "GET", REST_PATH, null, com.google.api.services.cloudbilling.model.Task.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     * @return the request
     */
    public Subscribe subscribe(java.lang.String name) throws java.io.IOException {
      Subscribe result = new Subscribe(name);
      initialize(result);
      return result;
    }

    public class Subscribe extends CloudbillingRequest<com.google.api.services.cloudbilling.model.StreamResponse> {
       ...
       * @since 1.13
       */
      protected Subscribe(java.lang.String name) {
        super(Cloudbilling.this, "GET", REST_PATH, null, com.google.api.services.cloudbilling.model.StreamResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     * <pre>
     *   {@code Cloudbilling cloudbilling = new Cloudbilling(...);}
     *   {@code Cloudbilling.PushNotificationConfigs.List request = cloudbilling.pushNotificationConfigs().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    public class PushNotificationConfigs {
       ...
       * @param content the {@link com.google.api.services.cloudbilling.model.TaskPushNotificationConfig}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.cloudbilling.model.TaskPushNotificationConfig content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudbillingRequest<com.google.api.services.cloudbilling.model.TaskPushNotificationConfig> {
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.cloudbilling.model.TaskPushNotificationConfig content) {
          super(Cloudbilling.this, "POST", REST_PATH, content, com.google.api.services.cloudbilling.model.TaskPushNotificationConfig.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Delete extends CloudbillingRequest<com.google.api.services.cloudbilling.model.Empty> {
       ...
       *        tasks/{task_id}/pushNotificationConfigs/{config_id}
        ...
        protected Delete(java.lang.String name) {
          super(Cloudbilling.this, "DELETE", REST_PATH, null, com.google.api.services.cloudbilling.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends CloudbillingRequest<com.google.api.services.cloudbilling.model.TaskPushNotificationConfig> {
       ...
       *        tasks/{task_id}/pushNotificationConfigs/{config_id}
         ...
         */
        protected Get(java.lang.String name) {
          super(Cloudbilling.this, "GET", REST_PATH, null, com.google.api.services.cloudbilling.model.TaskPushNotificationConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudbillingRequest<com.google.api.services.cloudbilling.model.ListTaskPushNotificationConfigResponse> {

        private static final String REST_PATH = "v1/{+parent}/pushNotificationConfigs";
         ...
         */
        protected List(java.lang.String parent) {
          super(Cloudbilling.this, "GET", REST_PATH, null, com.google.api.services.cloudbilling.model.ListTaskPushNotificationConfigResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
        ...
        /**
         * For AIP-158 these fields are present. Usually not used/needed. The maximum number of
         * configurations to return. If unspecified, all configs will be returned.
         */
        @com.google.api.client.util.Key
        private java.lang.Integer pageSize;
       ...
       to return. If unspecified, all configs will be returned.
        ...
        /**
         * A page token received from a previous ListTaskPushNotificationConfigRequest call. Provide
   ...
   * <pre>
   *   {@code Cloudbilling cloudbilling = new Cloudbilling(...);}
   *   {@code Cloudbilling.V1.List request = cloudbilling.v1().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class V1 {
     ...
     *
     * This request holds the parameters needed by the cloudbilling server.  After setting any optional
     * parameters, call the {@link GetCard#execute()} method to invoke the remote operation.
     *
     * @return the request
     */
    ...
    public class GetCard extends CloudbillingRequest<com.google.api.services.cloudbilling.model.AgentCard> {
       ...
       */
      protected GetCard() {
        super(Cloudbilling.this, "GET", REST_PATH, null, com.google.api.services.cloudbilling.model.AgentCard.class);
      }
