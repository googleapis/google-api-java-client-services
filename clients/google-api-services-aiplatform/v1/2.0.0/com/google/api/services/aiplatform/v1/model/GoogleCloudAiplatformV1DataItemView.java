...
public final class GoogleCloudAiplatformV1DataItemView extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudAiplatformV1Annotation> annotations;

  static {
    // hack to force ProGuard to consider GoogleCloudAiplatformV1Annotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAiplatformV1Annotation.class);
  }
   ...
   */
  public java.util.List<GoogleCloudAiplatformV1Annotation> getAnnotations() {
    return annotations;
  }
   ...
   */
  public GoogleCloudAiplatformV1DataItemView setAnnotations(java.util.List<GoogleCloudAiplatformV1Annotation> annotations) {
   ...
   */
  public GoogleCloudAiplatformV1DataItemView setDataItem(GoogleCloudAiplatformV1DataItem dataItem) {
   ...
   */
  public GoogleCloudAiplatformV1DataItemView setHasTruncatedAnnotations(java.lang.Boolean hasTruncatedAnnotations) {
    this.hasTruncatedAnnotations = hasTruncatedAnnotations;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1DataItemView set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1DataItemView) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1DataItemView clone() {
