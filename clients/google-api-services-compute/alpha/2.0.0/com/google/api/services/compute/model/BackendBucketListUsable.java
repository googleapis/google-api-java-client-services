...
/**
 * Model definition for BackendBucketListUsable.
 *
...
public final class BackendBucketListUsable extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<BackendBucket> items;

  static {
    // hack to force ProGuard to consider BackendBucket used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(BackendBucket.class);
  }

  /**
   * [Output Only] Type of resource. Always compute#usableBackendBucketList for lists of usable
   * backend buckets.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public BackendBucketListUsable setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<BackendBucket> getItems() {
    return items;
  }
   ...
   */
  public BackendBucketListUsable setItems(java.util.List<BackendBucket> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public BackendBucketListUsable setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public BackendBucketListUsable setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendBucketListUsable set(String fieldName, Object value) {
    return (BackendBucketListUsable) super.set(fieldName, value);
  }

  @Override
  public BackendBucketListUsable clone() {
    return (BackendBucketListUsable) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for BackendBucketListUsableWarningData.
     */
