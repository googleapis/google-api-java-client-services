...
public final class StoreEnvironmentStateResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public StoreEnvironmentStateResponse set(String fieldName, Object value) {
    return (StoreEnvironmentStateResponse) super.set(fieldName, value);
  }

  @Override
  public StoreEnvironmentStateResponse clone() {
    return (StoreEnvironmentStateResponse) super.clone();
  }
