...
public final class SecurityPolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<SecurityPolicy> items;

  static {
    // hack to force ProGuard to consider SecurityPolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(SecurityPolicy.class);
  }
   ...
   */
  public SecurityPolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<SecurityPolicy> getItems() {
    return items;
  }
   ...
   */
  public SecurityPolicyList setItems(java.util.List<SecurityPolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SecurityPolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SecurityPolicyList set(String fieldName, Object value) {
    return (SecurityPolicyList) super.set(fieldName, value);
  }

  @Override
  public SecurityPolicyList clone() {
    return (SecurityPolicyList) super.clone();
  }
