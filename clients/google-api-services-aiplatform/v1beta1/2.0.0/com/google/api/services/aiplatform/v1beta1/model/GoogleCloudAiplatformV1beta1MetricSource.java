...
public final class GoogleCloudAiplatformV1beta1MetricSource extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1MetricSource setMetric(GoogleCloudAiplatformV1beta1Metric metric) {
    this.metric = metric;
    return this;
  }
  ...
  @Override
  public GoogleCloudAiplatformV1beta1MetricSource set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1MetricSource) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1MetricSource clone() {
    return (GoogleCloudAiplatformV1beta1MetricSource) super.clone();
  }
