...
public final class GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetricsQuantileMetricsEntry> quantileMetrics;
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setMeanAbsoluteError(java.lang.Float meanAbsoluteError) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setMeanAbsolutePercentageError(java.lang.Float meanAbsolutePercentageError) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetricsQuantileMetricsEntry> getQuantileMetrics() {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setQuantileMetrics(java.util.List<GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetricsQuantileMetricsEntry> quantileMetrics) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setRSquared(java.lang.Float rSquared) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setRootMeanSquaredError(java.lang.Float rootMeanSquaredError) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setRootMeanSquaredLogError(java.lang.Float rootMeanSquaredLogError) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setRootMeanSquaredPercentageError(java.lang.Float rootMeanSquaredPercentageError) {
   ...
   */
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics setWeightedAbsolutePercentageError(java.lang.Float weightedAbsolutePercentageError) {
    this.weightedAbsolutePercentageError = weightedAbsolutePercentageError;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1SchemaModelevaluationMetricsForecastingEvaluationMetrics clone() {
