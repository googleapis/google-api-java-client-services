...
public final class GoogleCloudDiscoveryengineV1alphaChunk extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaChunk setAnnotationContents(java.util.List<java.lang.String> annotationContents) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaChunk setContent(java.lang.String content) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaChunk setDataUrls(java.util.List<java.lang.String> dataUrls) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaChunk setDerivedStructData(java.util.Map<String, java.lang.Object> derivedStructData) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaChunkDocumentMetadata getDocumentMetadata() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaChunk setDocumentMetadata(GoogleCloudDiscoveryengineV1alphaChunkDocumentMetadata documentMetadata) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1alphaChunk set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaChunk) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaChunk clone() {
    return (GoogleCloudDiscoveryengineV1alphaChunk) super.clone();
  }
