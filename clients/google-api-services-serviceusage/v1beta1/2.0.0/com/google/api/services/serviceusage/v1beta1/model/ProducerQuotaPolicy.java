...
public final class ProducerQuotaPolicy extends com.google.api.client.json.GenericJson {
   ...
   * not a valid key; the API does not support quota policies that apply only to a specific user. *
   ...
   * taMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerQuotaPolicies/4a3f2c
   * 1d`
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public ProducerQuotaPolicy setContainer(java.lang.String container) {
   ...
   */
  public ProducerQuotaPolicy setDimensions(java.util.Map<String, java.lang.String> dimensions) {
   ...
   */
  public ProducerQuotaPolicy setMetric(java.lang.String metric) {
    this.metric = metric;
    return this;
  }
   ...
   */
  public ProducerQuotaPolicy setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public ProducerQuotaPolicy setPolicyValue(java.lang.Long policyValue) {
   ...
   */
  public ProducerQuotaPolicy setUnit(java.lang.String unit) {
    this.unit = unit;
    return this;
  }

  @Override
  public ProducerQuotaPolicy set(String fieldName, Object value) {
    return (ProducerQuotaPolicy) super.set(fieldName, value);
  }

  @Override
  public ProducerQuotaPolicy clone() {
    return (ProducerQuotaPolicy) super.clone();
  }
