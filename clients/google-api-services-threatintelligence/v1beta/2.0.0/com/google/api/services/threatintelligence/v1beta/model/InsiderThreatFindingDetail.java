...
public final class InsiderThreatFindingDetail extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. Reference to the match score of the InsiderThreat finding. This is a float value
   * greater than 0 and less than or equal to 1 calculated by the matching engine based on the
  ...
  /**
   * Required. The severity of the InsiderThreat finding. This indicates the potential impact of the
   * threat.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public InsiderThreatFindingDetail setMatchScore(java.lang.Float matchScore) {
   ...
   */
  public InsiderThreatFindingDetail setSeverity(java.lang.String severity) {
    this.severity = severity;
    return this;
  }

  @Override
  public InsiderThreatFindingDetail set(String fieldName, Object value) {
    return (InsiderThreatFindingDetail) super.set(fieldName, value);
  }

  @Override
  public InsiderThreatFindingDetail clone() {
    return (InsiderThreatFindingDetail) super.clone();
  }
