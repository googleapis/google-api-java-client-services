...
/**
 * Model definition for HealthAggregationPoliciesScopedList.
 *
...
public final class HealthAggregationPoliciesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<HealthAggregationPolicy> healthAggregationPolicies;

  /**
   * Informational warning which replaces the list of health aggregation policies when the list is
   * empty.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public java.util.List<HealthAggregationPolicy> getHealthAggregationPolicies() {
    return healthAggregationPolicies;
  }

  /**
   * A list of HealthAggregationPolicys contained in this scope.
   * @param healthAggregationPolicies healthAggregationPolicies or {@code null} for none
   */
  public HealthAggregationPoliciesScopedList setHealthAggregationPolicies(java.util.List<HealthAggregationPolicy> healthAggregationPolicies) {
   ...
   */
  public HealthAggregationPoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthAggregationPoliciesScopedList set(String fieldName, Object value) {
    return (HealthAggregationPoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public HealthAggregationPoliciesScopedList clone() {
    return (HealthAggregationPoliciesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for HealthAggregationPoliciesScopedListWarningData.
     */
