...
public class BackupdrScopes {
  ...
  public static java.util.Set<String> all() {
    ...
    set.add(CLOUD_BACKUPDR);
    set.add(CLOUD_PLATFORM);
    return java.util.Collections.unmodifiableSet(set);
  }

  private BackupdrScopes() {
  }
}
