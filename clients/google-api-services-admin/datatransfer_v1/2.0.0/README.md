...
<project>
  <dependencies>
    <dependency>
      ...
      <version>datatransfer_v1-rev20221108-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-admin-datatransfer:datatransfer_v1-rev20221108-2.0.0'
}
```
