...
public final class GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestEndUserSpec endUserSpec;
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setAnswerGenerationSpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestAnswerGenerationSpec answerGenerationSpec) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestEndUserSpec getEndUserSpec() {
    return endUserSpec;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setEndUserSpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestEndUserSpec endUserSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setQuery(GoogleCloudDiscoveryengineV1alphaQuery query) {
    this.query = query;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setQueryUnderstandingSpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestQueryUnderstandingSpec queryUnderstandingSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setRelatedQuestionsSpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestRelatedQuestionsSpec relatedQuestionsSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setSafetySpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestSafetySpec safetySpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setSearchSpec(GoogleCloudDiscoveryengineV1alphaAnswerQueryRequestSearchSpec searchSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest setUserPseudoId(java.lang.String userPseudoId) {
    this.userPseudoId = userPseudoId;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaAnswerQueryRequest clone() {
