...
public final class LocationMetadata extends com.google.api.client.json.GenericJson {
  ...
  private java.lang.Boolean logAnalyticsEnabled;

  /**
   * Indicates whether or not Log Analytics features are supported in the given location.
   * @return value or {@code null} for none
   */
  public java.lang.Boolean getLogAnalyticsEnabled() {
    return logAnalyticsEnabled;
  }

  /**
   * Indicates whether or not Log Analytics features are supported in the given location.
   * @param logAnalyticsEnabled logAnalyticsEnabled or {@code null} for none
   */
  public LocationMetadata setLogAnalyticsEnabled(java.lang.Boolean logAnalyticsEnabled) {
