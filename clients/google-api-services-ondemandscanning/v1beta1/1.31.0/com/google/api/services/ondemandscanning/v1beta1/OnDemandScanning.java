...
package com.google.api.services.ondemandscanning.v1beta1;
...
public class OnDemandScanning extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.31.5 of the On-Demand Scanning API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
        ...
        public class Cancel extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(OnDemandScanning.this, "POST", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.Empty.class);
        ...
        public class Delete extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(OnDemandScanning.this, "DELETE", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.Operation> {
          ...
          protected Get(java.lang.String name) {
            super(OnDemandScanning.this, "GET", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.ListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(OnDemandScanning.this, "GET", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Wait extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.Operation> {
          ...
          protected Wait(java.lang.String name) {
            super(OnDemandScanning.this, "POST", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Scans {
         ...
         * @param content the {@link com.google.api.services.ondemandscanning.v1beta1.model.AnalyzePackagesRequest}
         * @return the request
         */
        public AnalyzePackages analyzePackages(java.lang.String parent, com.google.api.services.ondemandscanning.v1beta1.model.AnalyzePackagesRequest content) throws java.io.IOException {
          AnalyzePackages result = new AnalyzePackages(parent, content);
          initialize(result);
          return result;
        }

        public class AnalyzePackages extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.Operation> {

          private static final String REST_PATH = "v1beta1/{+parent}/scans:analyzePackages";
         ...
         *        projects/[project_name]/locations/[location]
           ...
           * @since 1.13
           */
          protected AnalyzePackages(java.lang.String parent, com.google.api.services.ondemandscanning.v1beta1.model.AnalyzePackagesRequest content) {
            super(OnDemandScanning.this, "POST", REST_PATH, content, com.google.api.services.ondemandscanning.v1beta1.model.Operation.class);
        ...
        public class Vulnerabilities {
          ...
          public class List extends OnDemandScanningRequest<com.google.api.services.ondemandscanning.v1beta1.model.ListVulnerabilitiesResponse> {

            private static final String REST_PATH = "v1beta1/{+parent}/vulnerabilities";
           ...
           *        projects/[project_name]/locations/[location]/scans/[scan_id]
            ...
            protected List(java.lang.String parent) {
              super(OnDemandScanning.this, "GET", REST_PATH, null, com.google.api.services.ondemandscanning.v1beta1.model.ListVulnerabilitiesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
