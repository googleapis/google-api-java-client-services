...
public final class CropHintsAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<CropHint> getCropHints() {
    return cropHints;
  }
   ...
   */
  public CropHintsAnnotation setCropHints(java.util.List<CropHint> cropHints) {
    this.cropHints = cropHints;
    return this;
  }

  @Override
  public CropHintsAnnotation set(String fieldName, Object value) {
    return (CropHintsAnnotation) super.set(fieldName, value);
  }
