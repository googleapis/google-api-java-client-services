...
public final class GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. Config parameters which are required for the integration template. These config
   * parameters would be requested by users while creating integration.
   ...
   */
  public GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate setConfigParameters(java.util.List<GoogleCloudIntegrationsV1alphaIntegrationConfigParameter> configParameters) {
