...
public final class CloudFunctionEndpoint extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CloudFunctionEndpoint set(String fieldName, Object value) {
    return (CloudFunctionEndpoint) super.set(fieldName, value);
  }

  @Override
  public CloudFunctionEndpoint clone() {
    return (CloudFunctionEndpoint) super.clone();
  }
