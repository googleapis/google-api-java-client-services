...
package com.google.cloudtasks.v2beta2;
...
public class CloudTasks extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Tasks API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.Location.class);
      ...
      public class List extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Queues {
        ...
        ListLocations.
         * @param content the {@link com.google.cloudtasks.v2beta2.model.Queue}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.cloudtasks.v2beta2.model.Queue content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
        ...
        ListLocations.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.cloudtasks.v2beta2.model.Queue content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Queue.class);
        ...
        public class Delete extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Empty> {
        ...
        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
          ...
          protected Delete(java.lang.String name) {
            super(CloudTasks.this, "DELETE", REST_PATH, null, com.google.cloudtasks.v2beta2.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
         ...
         *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.Queue.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.cloudtasks.v2beta2.model.GetIamPolicyRequest}
         * @return the request
         */
        public GetIamPolicy getIamPolicy(java.lang.String resource, com.google.cloudtasks.v2beta2.model.GetIamPolicyRequest content) throws java.io.IOException {
          GetIamPolicy result = new GetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class GetIamPolicy extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Policy> {
         ...
         *        the appropriate value for this field.
           ...
           * @since 1.13
           */
          protected GetIamPolicy(java.lang.String resource, com.google.cloudtasks.v2beta2.model.GetIamPolicyRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Policy.class);
        ...
        public class List extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.ListQueuesResponse> {
        ...
        For example: `projects/PROJECT_ID/locations/LOCATION_ID`
          ...
          protected List(java.lang.String parent) {
            super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.ListQueuesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        * `QUEUE_ID` can contain letters ([A-Za-z]),
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.cloudtasks.v2beta2.model.Queue content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
        ...
        * `QUEUE_ID` can contain letters ([A-Za-z]),
         *        numbers ([0-9]), or
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.cloudtasks.v2beta2.model.Queue content) {
            super(CloudTasks.this, "PATCH", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Queue.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.cloudtasks.v2beta2.model.PauseQueueRequest}
         * @return the request
         */
        public Pause pause(java.lang.String name, com.google.cloudtasks.v2beta2.model.PauseQueueRequest content) throws java.io.IOException {
          Pause result = new Pause(name, content);
          initialize(result);
          return result;
        }

        public class Pause extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
        ...
        `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`
           ...
           * @since 1.13
           */
          protected Pause(java.lang.String name, com.google.cloudtasks.v2beta2.model.PauseQueueRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Queue.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        The queue name. For example:
        `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`
         * @param content the {@link com.google.cloudtasks.v2beta2.model.PurgeQueueRequest}
         * @return the request
         */
        public Purge purge(java.lang.String name, com.google.cloudtasks.v2beta2.model.PurgeQueueRequest content) throws java.io.IOException {
          Purge result = new Purge(name, content);
          initialize(result);
          return result;
        }

        public class Purge extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
        ...
        `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`
           ...
           * @since 1.13
           */
          protected Purge(java.lang.String name, com.google.cloudtasks.v2beta2.model.PurgeQueueRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Queue.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        The queue name. For example:
        `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`
         * @param content the {@link com.google.cloudtasks.v2beta2.model.ResumeQueueRequest}
         * @return the request
         */
        public Resume resume(java.lang.String name, com.google.cloudtasks.v2beta2.model.ResumeQueueRequest content) throws java.io.IOException {
          Resume result = new Resume(name, content);
          initialize(result);
          return result;
        }

        public class Resume extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Queue> {
        ...
        `projects/PROJECT_ID/location/LOCATION_ID/queues/QUEUE_ID`
           ...
           * @since 1.13
           */
          protected Resume(java.lang.String name, com.google.cloudtasks.v2beta2.model.ResumeQueueRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Queue.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        See the operation documentation for
         *        the appropriate value for this field.
         * @param content the {@link com.google.cloudtasks.v2beta2.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.cloudtasks.v2beta2.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Policy> {
         ...
         *        the appropriate value for this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.cloudtasks.v2beta2.model.SetIamPolicyRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
        ...
        See the operation
         *        documentation for the appropriate value for this field.
         * @param content the {@link com.google.cloudtasks.v2beta2.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.cloudtasks.v2beta2.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.TestIamPermissionsResponse> {
         ...
         *        documentation for the appropriate value for this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.cloudtasks.v2beta2.model.TestIamPermissionsRequest content) {
            super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        public class Tasks {
           ...
           *
           * The worker, that is, the entity that leased this task must call this method to indicate that the
           * work associated with the task has finished.
           *
           ...
           * @param content the {@link com.google.cloudtasks.v2beta2.model.AcknowledgeTaskRequest}
           * @return the request
           */
          public Acknowledge acknowledge(java.lang.String name, com.google.cloudtasks.v2beta2.model.AcknowledgeTaskRequest content) throws java.io.IOException {
            Acknowledge result = new Acknowledge(name, content);
            initialize(result);
            return result;
          }

          public class Acknowledge extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Empty> {
             ...
             * Acknowledges a pull task.
             *
             * The worker, that is, the entity that leased this task must call this method to indicate that
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
             ...
             * @since 1.13
             */
            protected Acknowledge(java.lang.String name, com.google.cloudtasks.v2beta2.model.AcknowledgeTaskRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Empty.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           *
           * The worker can use this method to cancel a task's lease by setting its schedule_time to now. This
           * will make the task available to be leased to the next caller of LeaseTasks.
           *
          ...
          The task name. For example:
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
           * @param content the {@link com.google.cloudtasks.v2beta2.model.CancelLeaseRequest}
           * @return the request
           */
          public CancelLease cancelLease(java.lang.String name, com.google.cloudtasks.v2beta2.model.CancelLeaseRequest content) throws java.io.IOException {
            CancelLease result = new CancelLease(name, content);
            initialize(result);
            return result;
          }

          public class CancelLease extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Task> {
             ...
             * This will make the task available to be leased to the next caller of LeaseTasks.
             *
             * Create a request for the method "tasks.cancelLease".
             *
             * This request holds the parameters needed by the the cloudtasks server.  After setting any
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
             ...
             * @since 1.13
             */
            protected CancelLease(java.lang.String name, com.google.cloudtasks.v2beta2.model.CancelLeaseRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Task.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           * @param content the {@link com.google.cloudtasks.v2beta2.model.CreateTaskRequest}
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.cloudtasks.v2beta2.model.CreateTaskRequest content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }

          public class Create extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Task> {
           ...
           *        The queue must already exist.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.cloudtasks.v2beta2.model.CreateTaskRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Task.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Task> {
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.Task.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           *
           * The payload is intended to store data that the worker needs to perform the work associated with
           * the task. To return the payloads in the response, set response_view to FULL.
           *
           * A maximum of 10 qps of LeaseTasks requests are allowed per queue. RESOURCE_EXHAUSTED is returned
          ...
          The queue name. For example:
          `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
           * @param content the {@link com.google.cloudtasks.v2beta2.model.LeaseTasksRequest}
           * @return the request
           */
          public Lease lease(java.lang.String parent, com.google.cloudtasks.v2beta2.model.LeaseTasksRequest content) throws java.io.IOException {
            Lease result = new Lease(parent, content);
            initialize(result);
            return result;
          }

          public class Lease extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.LeaseTasksResponse> {
             ...
             * via AcknowledgeTask after they have performed the work associated with the task.
             *
             * The payload is intended to store data that the worker needs to perform the work associated with
             * the task. To return the payloads in the response, set response_view to FULL.
             *
             * A maximum of 10 qps of LeaseTasks requests are allowed per queue. RESOURCE_EXHAUSTED is
             * returned when this limit is exceeded. RESOURCE_EXHAUSTED is also returned when
             * max_tasks_dispatched_per_second is exceeded.
             *
             * Create a request for the method "tasks.lease".
             *
          ...
          `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
             ...
             * @since 1.13
             */
            protected Lease(java.lang.String parent, com.google.cloudtasks.v2beta2.model.LeaseTasksRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.LeaseTasksResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
             ...
             * `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
             */
            public Lease setParent(java.lang.String parent) {
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
                    "^projects/[^/]+/locations/[^/]+/queues/[^/]+$");
          ...
          public class List extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.ListTasksResponse> {
          ...
          `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudTasks.this, "GET", REST_PATH, null, com.google.cloudtasks.v2beta2.model.ListTasksResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
          ...
          The task name. For example:
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
           * @param content the {@link com.google.cloudtasks.v2beta2.model.RenewLeaseRequest}
           * @return the request
           */
          public RenewLease renewLease(java.lang.String name, com.google.cloudtasks.v2beta2.model.RenewLeaseRequest content) throws java.io.IOException {
            RenewLease result = new RenewLease(name, content);
            initialize(result);
            return result;
          }

          public class RenewLease extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Task> {
             ...
             * new task lease will be returned in the task's schedule_time.
             *
             * Create a request for the method "tasks.renewLease".
             *
             * This request holds the parameters needed by the the cloudtasks server.  After setting any
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
             ...
             * @since 1.13
             */
            protected RenewLease(java.lang.String name, com.google.cloudtasks.v2beta2.model.RenewLeaseRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Task.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
          ...
          The task name. For example:
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
           * @param content the {@link com.google.cloudtasks.v2beta2.model.RunTaskRequest}
           * @return the request
           */
          public Run run(java.lang.String name, com.google.cloudtasks.v2beta2.model.RunTaskRequest content) throws java.io.IOException {
            Run result = new Run(name, content);
            initialize(result);
            return result;
          }

          public class Run extends CloudTasksRequest<com.google.cloudtasks.v2beta2.model.Task> {
           ...
           *        `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID/tasks/TASK_ID`
             ...
             * @since 1.13
             */
            protected Run(java.lang.String name, com.google.cloudtasks.v2beta2.model.RunTaskRequest content) {
              super(CloudTasks.this, "POST", REST_PATH, content, com.google.cloudtasks.v2beta2.model.Task.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
