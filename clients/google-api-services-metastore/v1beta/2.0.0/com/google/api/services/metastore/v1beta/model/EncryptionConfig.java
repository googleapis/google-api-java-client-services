...
public final class EncryptionConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The list of fully qualified customer provided Cloud KMS key names for the multi-
   * regional service. Each key must be in the following format:projects/{project_number}/locations/
   ...
   */
  public EncryptionConfig setKmsKeys(java.util.List<java.lang.String> kmsKeys) {
