...
public final class TextOperatorOptions extends com.google.api.client.json.GenericJson {
   ...
   * like *subject:value* show results only where the value of the property named *subjectLine*
   * matches *value*. By contrast, a search that uses the same *value* without an operator returns
   * all items where *value* matches the value of any text properties or text within the content
