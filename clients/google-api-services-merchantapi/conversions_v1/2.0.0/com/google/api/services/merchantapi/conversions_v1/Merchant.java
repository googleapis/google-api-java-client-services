...
package com.google.api.services.merchantapi.conversions_v1;

/**
 * Service definition for Merchant (conversions_v1).
 *
 * <p>
...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class ConversionSources {
       ...
       * @param content the {@link com.google.api.services.merchantapi.conversions_v1.model.ConversionSource}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.ConversionSource> {

        private static final String REST_PATH = "conversions/v1/{+parent}/conversionSources";
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource.class);
      ...
      public class Delete extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.Empty> {

        private static final String REST_PATH = "conversions/v1/{+name}";
       ...
       *        `accounts/{account}/conversionSources/{conversion_source}`
        ...
        protected Delete(java.lang.String name) {
          super(Merchant.this, "DELETE", REST_PATH, null, com.google.api.services.merchantapi.conversions_v1.model.Empty.class);
      ...
      public class Get extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.ConversionSource> {
       ...
       *        `accounts/{account}/conversionSources/{conversion_source}`
        ...
        protected Get(java.lang.String name) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.ListConversionSourcesResponse> {
       ...
       *        `accounts/{account}`
        ...
        protected List(java.lang.String parent) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.conversions_v1.model.ListConversionSourcesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.ConversionSource> {
       ...
       *        GoogleAnalyticsLink sources. * `mcdn`: For MerchantCenterDestination sources.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource content) {
          super(Merchant.this, "PATCH", REST_PATH, content, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        `accounts/{account}/conversionSources/{conversion_source}`
       * @param content the {@link com.google.api.services.merchantapi.conversions_v1.model.UndeleteConversionSourceRequest}
       * @return the request
       */
      public Undelete undelete(java.lang.String name, com.google.api.services.merchantapi.conversions_v1.model.UndeleteConversionSourceRequest content) throws java.io.IOException {
        Undelete result = new Undelete(name, content);
        initialize(result);
        return result;
      }

      public class Undelete extends MerchantRequest<com.google.api.services.merchantapi.conversions_v1.model.ConversionSource> {

        private static final String REST_PATH = "conversions/v1/{+name}:undelete";
       ...
       *        `accounts/{account}/conversionSources/{conversion_source}`
         ...
         * @since 1.13
         */
        protected Undelete(java.lang.String name, com.google.api.services.merchantapi.conversions_v1.model.UndeleteConversionSourceRequest content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.conversions_v1.model.ConversionSource.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
