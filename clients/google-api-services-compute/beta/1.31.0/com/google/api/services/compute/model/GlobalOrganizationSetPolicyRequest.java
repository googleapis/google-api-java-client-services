...
public final class GlobalOrganizationSetPolicyRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GlobalOrganizationSetPolicyRequest setBindings(java.util.List<Binding> bindings) {
   ...
   */
  public GlobalOrganizationSetPolicyRequest setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @since 1.14
   */
  public GlobalOrganizationSetPolicyRequest encodeEtag(byte[] etag) {
   ...
   */
  public GlobalOrganizationSetPolicyRequest setPolicy(Policy policy) {
    this.policy = policy;
    return this;
  }

  @Override
  public GlobalOrganizationSetPolicyRequest set(String fieldName, Object value) {
    return (GlobalOrganizationSetPolicyRequest) super.set(fieldName, value);
  }

  @Override
  public GlobalOrganizationSetPolicyRequest clone() {
    return (GlobalOrganizationSetPolicyRequest) super.clone();
  }
