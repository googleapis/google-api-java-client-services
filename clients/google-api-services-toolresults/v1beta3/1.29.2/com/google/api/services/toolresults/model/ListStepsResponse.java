...
public final class ListStepsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public ListStepsResponse setSteps(java.util.List<Step> steps) {
    this.steps = steps;
    return this;
  }

  @Override
  public ListStepsResponse set(String fieldName, Object value) {
    return (ListStepsResponse) super.set(fieldName, value);
  }

  @Override
  public ListStepsResponse clone() {
    return (ListStepsResponse) super.clone();
  }
