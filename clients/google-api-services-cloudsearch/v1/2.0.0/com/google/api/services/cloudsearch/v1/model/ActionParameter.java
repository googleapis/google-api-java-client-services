...
/**
 * List of string parameters that developers can specify when the above action method (in apps
 * script) is invoked. An example use case is for 3 snooze buttons: snooze now, snooze 1 day, snooze
 * next week. Developers can have action method = snooze() and pass the snooze type and snooze time
 * in list of string parameters.
 *
