...
public final class DeleteEnvironmentMetadata extends com.google.api.client.json.GenericJson {

  @Override
  public DeleteEnvironmentMetadata set(String fieldName, Object value) {
    return (DeleteEnvironmentMetadata) super.set(fieldName, value);
  }

  @Override
  public DeleteEnvironmentMetadata clone() {
    return (DeleteEnvironmentMetadata) super.clone();
  }
