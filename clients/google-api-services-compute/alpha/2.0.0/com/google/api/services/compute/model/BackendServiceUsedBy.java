...
/**
 * Model definition for BackendServiceUsedBy.
 *
...
public final class BackendServiceUsedBy extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public BackendServiceUsedBy set(String fieldName, Object value) {
    return (BackendServiceUsedBy) super.set(fieldName, value);
  }

  @Override
  public BackendServiceUsedBy clone() {
    return (BackendServiceUsedBy) super.clone();
  }
