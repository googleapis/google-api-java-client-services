...
public final class ShareSettingsFolderConfig extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ShareSettingsFolderConfig set(String fieldName, Object value) {
    return (ShareSettingsFolderConfig) super.set(fieldName, value);
  }

  @Override
  public ShareSettingsFolderConfig clone() {
    return (ShareSettingsFolderConfig) super.clone();
  }
