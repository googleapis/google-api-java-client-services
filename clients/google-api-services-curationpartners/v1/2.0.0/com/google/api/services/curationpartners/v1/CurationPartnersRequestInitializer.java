...
/**
 * CurationPartners request initializer for setting properties like key and userIp.
 *
 * <p>
 ...
 * @since 1.12
 */
public class CurationPartnersRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public CurationPartnersRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public CurationPartnersRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeCurationPartnersRequest((CurationPartnersRequest<?>) request);
  }

  /**
   * Initializes CurationPartners request.
   *
   * <p>
   ...
   */
  protected void initializeCurationPartnersRequest(CurationPartnersRequest<?> request) throws java.io.IOException {
  }
}
