...
public final class AcceleratorTypeAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public AcceleratorTypeAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, AcceleratorTypesScopedList> getItems() {
    return items;
  }
   ...
   */
  public AcceleratorTypeAggregatedList setItems(java.util.Map<String, AcceleratorTypesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AcceleratorTypeAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public AcceleratorTypeAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AcceleratorTypeAggregatedList set(String fieldName, Object value) {
    return (AcceleratorTypeAggregatedList) super.set(fieldName, value);
  }

  @Override
  public AcceleratorTypeAggregatedList clone() {
    return (AcceleratorTypeAggregatedList) super.clone();
  }
