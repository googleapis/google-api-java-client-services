...
public final class Queue extends com.google.api.client.json.GenericJson {
   ...
   * this queue. Http tasks are not affected. If set, `app_engine_routing_override` is used for all
   * App Engine tasks in the queue, no matter what the setting is for the task-level
   * app_engine_routing.
