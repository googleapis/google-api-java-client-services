...
public final class GoldengateConnection extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The GCP Oracle zone where Oracle GoldengateConnection is hosted. Example: us-
  ...
  /**
   * Optional. The name of the OdbSubnet associated with the GoldengateConnection for IP allocation.
   * Format:
   ...
   */
  @com.google.api.client.util.Key
  private GoldengateConnectionProperties properties;
   ...
   */
  public GoldengateConnection setCreateTime(String createTime) {
   ...
   */
  public GoldengateConnection setEntitlementId(java.lang.String entitlementId) {
   ...
   */
  public GoldengateConnection setGcpOracleZone(java.lang.String gcpOracleZone) {
   ...
   */
  public GoldengateConnection setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public GoldengateConnection setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoldengateConnection setOciUrl(java.lang.String ociUrl) {
    this.ociUrl = ociUrl;
    return this;
  }
   ...
   */
  public GoldengateConnection setOdbNetwork(java.lang.String odbNetwork) {
   ...
   */
  public GoldengateConnection setOdbSubnet(java.lang.String odbSubnet) {
   ...
   */
  public GoldengateConnection setProperties(GoldengateConnectionProperties properties) {
    this.properties = properties;
    return this;
  }

  @Override
  public GoldengateConnection set(String fieldName, Object value) {
    return (GoldengateConnection) super.set(fieldName, value);
  }

  @Override
  public GoldengateConnection clone() {
    return (GoldengateConnection) super.clone();
  }
