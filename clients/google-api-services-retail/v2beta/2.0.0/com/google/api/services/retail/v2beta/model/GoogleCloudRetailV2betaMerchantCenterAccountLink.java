...
public final class GoogleCloudRetailV2betaMerchantCenterAccountLink extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter> feedFilters;
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setBranchId(java.lang.String branchId) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter> getFeedFilters() {
    return feedFilters;
  }
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setFeedFilters(java.util.List<GoogleCloudRetailV2betaMerchantCenterAccountLinkMerchantCenterFeedFilter> feedFilters) {
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setFeedLabel(java.lang.String feedLabel) {
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setLanguageCode(java.lang.String languageCode) {
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setMerchantCenterAccountId(java.lang.Long merchantCenterAccountId) {
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2betaMerchantCenterAccountLink setState(java.lang.String state) {
    this.state = state;
    return this;
  }

  @Override
  public GoogleCloudRetailV2betaMerchantCenterAccountLink set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaMerchantCenterAccountLink) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaMerchantCenterAccountLink clone() {
    return (GoogleCloudRetailV2betaMerchantCenterAccountLink) super.clone();
  }
