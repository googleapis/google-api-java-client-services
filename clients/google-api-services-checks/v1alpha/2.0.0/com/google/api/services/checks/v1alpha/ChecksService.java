...
public class ChecksService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the Privacypolicy collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code ChecksService checks = new ChecksService(...);}
   *   {@code ChecksService.Privacypolicy.List request = checks.privacypolicy().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  public class Privacypolicy {
     ...
     *
     * @param content the {@link com.google.api.services.checks.v1alpha.model.AnalyzePrivacyPolicyRequest}
     * @return the request
     */
    public Analyze analyze(com.google.api.services.checks.v1alpha.model.AnalyzePrivacyPolicyRequest content) throws java.io.IOException {
      Analyze result = new Analyze(content);
      initialize(result);
      return result;
    }

    public class Analyze extends ChecksServiceRequest<com.google.api.services.checks.v1alpha.model.AnalyzePrivacyPolicyResponse> {
       ...
       *
       * This request holds the parameters needed by the the checks server.  After setting any optional
       * parameters, call the {@link Analyze#execute()} method to invoke the remote operation. <p>
       * {@link
       ...
       * @since 1.13
       */
      protected Analyze(com.google.api.services.checks.v1alpha.model.AnalyzePrivacyPolicyRequest content) {
        super(ChecksService.this, "POST", REST_PATH, content, com.google.api.services.checks.v1alpha.model.AnalyzePrivacyPolicyResponse.class);
      }
   ...
   * <pre>
   *   {@code ChecksService checks = new ChecksService(...);}
   *   {@code ChecksService.Projects.List request = checks.projects().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
    ...
    public class Privacypolicy {
      ...
      public class Operations {
        ...
        public class Cancel extends ChecksServiceRequest<com.google.api.services.checks.v1alpha.model.Empty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/privacypolicy/operations/[^/]+$");
          ...
          protected Cancel(java.lang.String name) {
            super(ChecksService.this, "POST", REST_PATH, null, com.google.api.services.checks.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
                  "^projects/[^/]+/privacypolicy/operations/[^/]+$");
            }
          }
        ...
        public class List extends ChecksServiceRequest<com.google.api.services.checks.v1alpha.model.ListOperationsResponse> {
          ...
          private static final String REST_PATH = "v1alpha/{+name}/privacypolicy/operations";
        ...
        public class Wait extends ChecksServiceRequest<com.google.api.services.checks.v1alpha.model.Operation> {
          ...
          protected Wait(java.lang.String name) {
            super(ChecksService.this, "POST", REST_PATH, null, com.google.api.services.checks.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
