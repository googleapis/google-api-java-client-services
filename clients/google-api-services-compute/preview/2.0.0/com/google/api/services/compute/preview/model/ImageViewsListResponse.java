...
public final class ImageViewsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ImageView> items;

  static {
    // hack to force ProGuard to consider ImageView used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ImageView.class);
  }
   ...
   */
  public ImageViewsListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ImageViewsListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ImageView> getItems() {
    return items;
  }
   ...
   */
  public ImageViewsListResponse setItems(java.util.List<ImageView> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ImageViewsListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ImageViewsListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ImageViewsListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public ImageViewsListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public ImageViewsListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ImageViewsListResponse set(String fieldName, Object value) {
    return (ImageViewsListResponse) super.set(fieldName, value);
  }

  @Override
  public ImageViewsListResponse clone() {
    return (ImageViewsListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for ImageViewsListResponseWarningData.
     */
