...
public final class ListReportsResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A token to retrieve next page of results. Pass this value in the ListReportsRequest.page_token
   * field in the subsequent call to `ListReports` method to retrieve the next page of results.
