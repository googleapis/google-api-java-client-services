...
/**
 * A Compute Engine Instance tag, identical to the tags on the corresponding Compute Engine Instance
 * resource.
 *
...
public final class Tag extends com.google.api.client.json.GenericJson {
   ...
   */
  public Tag setItems(java.util.List<java.lang.String> items) {
    this.items = items;
    return this;
  }
