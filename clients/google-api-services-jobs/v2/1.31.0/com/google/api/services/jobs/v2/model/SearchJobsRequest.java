...
public final class SearchJobsRequest extends com.google.api.client.json.GenericJson {
   ...
   * positions from the search results of a search for "CEO". Disabling relevance thresholding
   ...
   * non-sequential search results page. Enabling this flag may adversely impact performance.
   * Defaults to false.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Deprecated. Use query instead. Optional. Restrictions on the scope of the search request, such
   * as filtering by location.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * considered if page_token is unset. For example, 0 means to return results starting from the
   * first matching job, and 10 means to return from the 11th job. This can be used for pagination,
   * (for example, pageSize = 10 and offset = 10 means to return from the second page).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Deprecated. Use sort_by instead. Optional. The criteria determining how search results are
