...
public final class Comment extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A comment from a developer.
   * @param developerComment developerComment or {@code null} for none
   */
  public Comment setDeveloperComment(DeveloperComment developerComment) {
   ...
   */
  public Comment setUserComment(UserComment userComment) {
