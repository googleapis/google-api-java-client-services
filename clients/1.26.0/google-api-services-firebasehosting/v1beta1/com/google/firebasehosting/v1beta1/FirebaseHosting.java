...
public class FirebaseHosting extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Firebase Hosting API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Sites {
    ...
    public class Domains {
      ...
      sites/site-name
       * @param content the {@link com.google.firebasehosting.v1beta1.model.Domain}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Domain content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Domain> {
      ...
      sites/site-name
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Domain content) {
          super(FirebaseHosting.this, "POST", REST_PATH, content, com.google.firebasehosting.v1beta1.model.Domain.class);
      ...
      public class Delete extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Empty> {
        ...
        protected Delete(java.lang.String name) {
          super(FirebaseHosting.this, "DELETE", REST_PATH, null, com.google.firebasehosting.v1beta1.model.Empty.class);
      ...
      public class Get extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Domain> {
        ...
        protected Get(java.lang.String name) {
          super(FirebaseHosting.this, "GET", REST_PATH, null, com.google.firebasehosting.v1beta1.model.Domain.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.ListDomainsResponse> {
      ...
      sites/site-name
        ...
        protected List(java.lang.String parent) {
          super(FirebaseHosting.this, "GET", REST_PATH, null, com.google.firebasehosting.v1beta1.model.ListDomainsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Update update(java.lang.String name, com.google.firebasehosting.v1beta1.model.Domain content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Domain> {
       ...
       *        exist.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.firebasehosting.v1beta1.model.Domain content) {
          super(FirebaseHosting.this, "PUT", REST_PATH, content, com.google.firebasehosting.v1beta1.model.Domain.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class Releases {
      ...
      sites/site-name
       * @param content the {@link com.google.firebasehosting.v1beta1.model.Release}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Release content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Release> {
      ...
      sites/site-name
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Release content) {
          super(FirebaseHosting.this, "POST", REST_PATH, content, com.google.firebasehosting.v1beta1.model.Release.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class List extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.ListReleasesResponse> {
      ...
      sites/site-name
         ...
         */
        protected List(java.lang.String parent) {
          super(FirebaseHosting.this, "GET", REST_PATH, null, com.google.firebasehosting.v1beta1.model.ListReleasesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
    ...
    public class Versions {
      ...
      sites/site-name
       * @param content the {@link com.google.firebasehosting.v1beta1.model.Version}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Version content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Version> {
      ...
      sites/site-name
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.firebasehosting.v1beta1.model.Version content) {
          super(FirebaseHosting.this, "POST", REST_PATH, content, com.google.firebasehosting.v1beta1.model.Version.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.firebasehosting.v1beta1.model.Version content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.Version> {
       ...
       *        [`CreateVersion`](../sites.versions/create) endpoint.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.firebasehosting.v1beta1.model.Version content) {
          super(FirebaseHosting.this, "PATCH", REST_PATH, content, com.google.firebasehosting.v1beta1.model.Version.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      sites/site-name/versions/versionID
       * @param content the {@link com.google.firebasehosting.v1beta1.model.PopulateVersionFilesRequest}
       * @return the request
       */
      public PopulateFiles populateFiles(java.lang.String parent, com.google.firebasehosting.v1beta1.model.PopulateVersionFilesRequest content) throws java.io.IOException {
        PopulateFiles result = new PopulateFiles(parent, content);
        initialize(result);
        return result;
      }

      public class PopulateFiles extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.PopulateVersionFilesResponse> {
      ...
      sites/site-name/versions/versionID
         ...
         * @since 1.13
         */
        protected PopulateFiles(java.lang.String parent, com.google.firebasehosting.v1beta1.model.PopulateVersionFilesRequest content) {
          super(FirebaseHosting.this, "POST", REST_PATH, content, com.google.firebasehosting.v1beta1.model.PopulateVersionFilesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Files {
        ...
        public class List extends FirebaseHostingRequest<com.google.firebasehosting.v1beta1.model.ListVersionFilesResponse> {
        ...
        sites/site-name/versions/versionID
           ...
           */
          protected List(java.lang.String parent) {
            super(FirebaseHosting.this, "GET", REST_PATH, null, com.google.firebasehosting.v1beta1.model.ListVersionFilesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
