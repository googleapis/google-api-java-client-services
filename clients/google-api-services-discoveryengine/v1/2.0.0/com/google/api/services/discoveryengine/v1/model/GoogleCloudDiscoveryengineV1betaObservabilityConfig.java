...
public final class GoogleCloudDiscoveryengineV1betaObservabilityConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaObservabilityConfig setObservabilityEnabled(java.lang.Boolean observabilityEnabled) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaObservabilityConfig setSensitiveLoggingEnabled(java.lang.Boolean sensitiveLoggingEnabled) {
    this.sensitiveLoggingEnabled = sensitiveLoggingEnabled;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaObservabilityConfig set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaObservabilityConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaObservabilityConfig clone() {
    return (GoogleCloudDiscoveryengineV1betaObservabilityConfig) super.clone();
  }
