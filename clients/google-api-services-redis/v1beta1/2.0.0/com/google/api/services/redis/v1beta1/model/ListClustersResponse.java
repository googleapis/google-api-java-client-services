...
public final class ListClustersResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A list of Redis clusters in the project in the specified location, or across all locations. If
   ...
   * a value of the form `projects/{project_id}/locations/{location_id}/clusters/`- and the `status`
   * field set to ERROR and `status_message` field set to "location not available for ListClusters".
