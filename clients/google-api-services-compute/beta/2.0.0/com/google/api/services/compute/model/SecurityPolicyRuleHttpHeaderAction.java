...
public final class SecurityPolicyRuleHttpHeaderAction extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public SecurityPolicyRuleHttpHeaderAction set(String fieldName, Object value) {
    return (SecurityPolicyRuleHttpHeaderAction) super.set(fieldName, value);
  }

  @Override
  public SecurityPolicyRuleHttpHeaderAction clone() {
    return (SecurityPolicyRuleHttpHeaderAction) super.clone();
  }
