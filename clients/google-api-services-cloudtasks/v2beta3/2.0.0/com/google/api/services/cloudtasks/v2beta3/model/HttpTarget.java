...
public final class HttpTarget extends com.google.api.client.json.GenericJson {
   ...
   * predefined headers, prefixed with "X-Google-Cloud-Tasks-", can be used to define properties of
   * the task. * Host: This will be computed by Cloud Tasks and derived from HttpRequest.url. *
   * Content-Length: This will be computed by Cloud Tasks. `Content-Type` won't be set by Cloud
   * Tasks. You can explicitly set `Content-Type` to a media type when the task is created. For
