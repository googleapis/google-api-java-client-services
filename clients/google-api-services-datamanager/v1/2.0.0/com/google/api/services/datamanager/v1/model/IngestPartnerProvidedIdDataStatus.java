...
public final class IngestPartnerProvidedIdDataStatus extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public IngestPartnerProvidedIdDataStatus set(String fieldName, Object value) {
    return (IngestPartnerProvidedIdDataStatus) super.set(fieldName, value);
  }

  @Override
  public IngestPartnerProvidedIdDataStatus clone() {
    return (IngestPartnerProvidedIdDataStatus) super.clone();
  }
