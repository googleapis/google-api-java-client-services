...
public final class VpnTunnelList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<VpnTunnel> items;
   ...
   */
  public VpnTunnelList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<VpnTunnel> getItems() {
    return items;
  }
   ...
   */
  public VpnTunnelList setItems(java.util.List<VpnTunnel> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public VpnTunnelList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public VpnTunnelList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public VpnTunnelList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public VpnTunnelList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VpnTunnelList set(String fieldName, Object value) {
    return (VpnTunnelList) super.set(fieldName, value);
  }

  @Override
  public VpnTunnelList clone() {
    return (VpnTunnelList) super.clone();
  }
