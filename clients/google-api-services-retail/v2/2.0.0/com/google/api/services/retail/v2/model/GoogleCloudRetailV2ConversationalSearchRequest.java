...
public final class GoogleCloudRetailV2ConversationalSearchRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudRetailV2ConversationalSearchRequestConversationalFilteringSpec conversationalFilteringSpec;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRetailV2SafetySetting> safetySettings;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudRetailV2ConversationalSearchRequestSearchParams searchParams;
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setBranch(java.lang.String branch) {
    this.branch = branch;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setConversationId(java.lang.String conversationId) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudRetailV2ConversationalSearchRequestConversationalFilteringSpec getConversationalFilteringSpec() {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setConversationalFilteringSpec(GoogleCloudRetailV2ConversationalSearchRequestConversationalFilteringSpec conversationalFilteringSpec) {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setPageCategories(java.util.List<java.lang.String> pageCategories) {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setQuery(java.lang.String query) {
    this.query = query;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRetailV2SafetySetting> getSafetySettings() {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setSafetySettings(java.util.List<GoogleCloudRetailV2SafetySetting> safetySettings) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudRetailV2ConversationalSearchRequestSearchParams getSearchParams() {
    return searchParams;
  }
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setSearchParams(GoogleCloudRetailV2ConversationalSearchRequestSearchParams searchParams) {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setUserInfo(GoogleCloudRetailV2UserInfo userInfo) {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setUserLabels(java.util.Map<String, java.lang.String> userLabels) {
   ...
   */
  public GoogleCloudRetailV2ConversationalSearchRequest setVisitorId(java.lang.String visitorId) {
    this.visitorId = visitorId;
    return this;
  }

  @Override
  public GoogleCloudRetailV2ConversationalSearchRequest set(String fieldName, Object value) {
    return (GoogleCloudRetailV2ConversationalSearchRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2ConversationalSearchRequest clone() {
    return (GoogleCloudRetailV2ConversationalSearchRequest) super.clone();
  }
