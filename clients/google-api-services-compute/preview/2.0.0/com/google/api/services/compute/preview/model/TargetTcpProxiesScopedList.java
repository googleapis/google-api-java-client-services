...
/**
 * Model definition for TargetTcpProxiesScopedList.
 *
...
public final class TargetTcpProxiesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<TargetTcpProxy> targetTcpProxies;
   ...
   */
  public java.util.List<TargetTcpProxy> getTargetTcpProxies() {
    return targetTcpProxies;
  }

  /**
   * A list of TargetTcpProxies contained in this scope.
   * @param targetTcpProxies targetTcpProxies or {@code null} for none
   */
  public TargetTcpProxiesScopedList setTargetTcpProxies(java.util.List<TargetTcpProxy> targetTcpProxies) {
   ...
   */
  public TargetTcpProxiesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetTcpProxiesScopedList set(String fieldName, Object value) {
    return (TargetTcpProxiesScopedList) super.set(fieldName, value);
  }

  @Override
  public TargetTcpProxiesScopedList clone() {
    return (TargetTcpProxiesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for TargetTcpProxiesScopedListWarningData.
     */
