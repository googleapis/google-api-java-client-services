...
public final class GoogleCloudAiplatformV1EvaluationInstanceAgentData extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudAiplatformV1EvaluationInstanceAgentDataTools tools;
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceAgentData setAgentConfig(GoogleCloudAiplatformV1EvaluationInstanceAgentConfig agentConfig) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudAiplatformV1EvaluationInstanceAgentDataEvents getEvents() {
    return events;
  }
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceAgentData setEvents(GoogleCloudAiplatformV1EvaluationInstanceAgentDataEvents events) {
    this.events = events;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudAiplatformV1EvaluationInstanceAgentDataTools getTools() {
    return tools;
  }
   ...
   */
  public GoogleCloudAiplatformV1EvaluationInstanceAgentData setTools(GoogleCloudAiplatformV1EvaluationInstanceAgentDataTools tools) {
    this.tools = tools;
    return this;
  }
  ...
  @Override
  public GoogleCloudAiplatformV1EvaluationInstanceAgentData set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1EvaluationInstanceAgentData) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1EvaluationInstanceAgentData clone() {
    return (GoogleCloudAiplatformV1EvaluationInstanceAgentData) super.clone();
  }
