...
public final class BackendBucketList extends com.google.api.client.json.GenericJson {
   ...
   */
  public BackendBucketList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public BackendBucketList setItems(java.util.List<BackendBucket> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public BackendBucketList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public BackendBucketList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendBucketList set(String fieldName, Object value) {
    return (BackendBucketList) super.set(fieldName, value);
  }

  @Override
  public BackendBucketList clone() {
    return (BackendBucketList) super.clone();
  }
