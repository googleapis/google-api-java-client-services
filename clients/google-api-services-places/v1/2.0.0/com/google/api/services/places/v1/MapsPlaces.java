...
public class MapsPlaces extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *   {@code MapsPlaces.Text.List request = places.text().list(parameters ...)}
   * </pre>
   *
  ...
  public class Text {
     ...
     *
     * Create a request for the method "Text.search".
     *
     ...
     * @return the request
     */
    public Search search(com.google.api.services.places.v1.model.GoogleMapsPlacesV1SearchTextRequest content) throws java.io.IOException {
      Search result = new Search(content);
      initialize(result);
      return result;
    }

    public class Search extends MapsPlacesRequest<com.google.api.services.places.v1.model.GoogleMapsPlacesV1SearchTextResponse> {

      private static final String REST_PATH = "v1/Text:search";
       ...
       * @since 1.13
       */
      protected Search(com.google.api.services.places.v1.model.GoogleMapsPlacesV1SearchTextRequest content) {
