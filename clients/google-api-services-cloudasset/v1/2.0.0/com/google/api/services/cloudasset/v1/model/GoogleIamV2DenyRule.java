...
public final class GoogleIamV2DenyRule extends com.google.api.client.json.GenericJson {
   ...
   * /my-service-account@iam.gserviceaccount.com`. * `deleted:principal://iam.googleapis.com/project
   * s/-/serviceAccounts/{service_account_id}?uid={uid}`: A Google Cloud service account that was
   * deleted recently. For example,
   ...
   */
  public GoogleIamV2DenyRule setDenialCondition(Expr denialCondition) {
   ...
   */
  public GoogleIamV2DenyRule setDeniedPermissions(java.util.List<java.lang.String> deniedPermissions) {
   ...
   */
  public GoogleIamV2DenyRule setDeniedPrincipals(java.util.List<java.lang.String> deniedPrincipals) {
   ...
   */
  public GoogleIamV2DenyRule setExceptionPermissions(java.util.List<java.lang.String> exceptionPermissions) {
   ...
   */
  public GoogleIamV2DenyRule setExceptionPrincipals(java.util.List<java.lang.String> exceptionPrincipals) {
