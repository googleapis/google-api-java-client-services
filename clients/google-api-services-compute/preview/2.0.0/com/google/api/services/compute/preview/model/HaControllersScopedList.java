...
/**
 * Model definition for HaControllersScopedList.
 *
...
public final class HaControllersScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<HaController> haControllers;

  static {
    // hack to force ProGuard to consider HaController used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(HaController.class);
  }
   ...
   */
  public java.util.List<HaController> getHaControllers() {
    return haControllers;
  }

  /**
   * List of HaControllers contained in this scope.
   * @param haControllers haControllers or {@code null} for none
   */
  public HaControllersScopedList setHaControllers(java.util.List<HaController> haControllers) {
    this.haControllers = haControllers;
    return this;
  }
   ...
   */
  public HaControllersScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HaControllersScopedList set(String fieldName, Object value) {
    return (HaControllersScopedList) super.set(fieldName, value);
  }

  @Override
  public HaControllersScopedList clone() {
    return (HaControllersScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for HaControllersScopedListWarningData.
     */
