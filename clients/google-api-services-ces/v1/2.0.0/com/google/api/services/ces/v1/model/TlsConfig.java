...
public final class TlsConfig extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<TlsConfigCaCert> caCerts;

  /**
   * Required. Specifies a list of allowed custom CA certificates for HTTPS verification.
   * @return value or {@code null} for none
   */
  public java.util.List<TlsConfigCaCert> getCaCerts() {
    return caCerts;
  }
   ...
   */
  public TlsConfig setCaCerts(java.util.List<TlsConfigCaCert> caCerts) {
