...
<project>
  <dependencies>
    <dependency>
      ...
      <version>datasources_v1beta-rev20241022-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:datasources_v1beta-rev20241022-2.0.0'
}
```
