...
public class DLP extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "2.0.0 of the Sensitive Data Protection (DLP) library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.31
   */
  public static final String DEFAULT_MTLS_ROOT_URL = "https://dlp.mtls.googleapis.com/";
    ...
    public class DeidentifyTemplates {
       ...
       *        project/locations/europe-west3
       ...
       processing data: parent=projects/example-project/locations/europe-west3
         ...
         * `update_time`: corresponds to the time the template was last updated. - `name`:
         * corresponds to the template's name. - `display_name`: corresponds to the template's
         * display name.
         */
        @com.google.api.client.util.Key
       ...
       corresponds to the template's display name.
        ...
        /**
         * Size of the page. This value can be limited by the server. If zero server returns a page
         * of max size 100.
         */
        @com.google.api.client.util.Key
    ...
    public class Locations {
      ...
      public class DeidentifyTemplates {
         ...
         *        project/locations/europe-west3
         ...
         corresponds to the template's display name.
          ...
          /**
           * Size of the page. This value can be limited by the server. If zero server returns a
      ...
      public class JobTriggers {
        ...
        public class Delete extends DLPRequest<com.google.api.services.dlp.v2.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^organizations/[^/]+/locations/[^/]+/jobTriggers/[^/]+$");
         ...
         *        project/jobTriggers/53234423`.
          ...
          /**
           * Required. Resource name of the project and the triggeredJob, for example `projects/dlp-
         ...
         *        /example-project/locations/europe-west3
         ...
         than 500 characters.
           ...
           * JobTrigger was created. - `update_time`: corresponds to the time the JobTrigger was
           * last updated. - `last_run_time`: corresponds to the last time the JobTrigger ran. -
           * `name`: corresponds to the JobTrigger's name. - `display_name`: corresponds to the
    ...
    public class StoredInfoTypes {
       ...
       *        project/locations/europe-west3
       ...
       processing data: parent=projects/example-project/locations/europe-west3
         ...
         * the resource was created. - `state`: corresponds to the state of the resource. - `name`:
         * corresponds to resource name. - `display_name`: corresponds to info type's display name.
         */
        @com.google.api.client.util.Key
        private java.lang.String orderBy;
    ...
    public class Locations {
      ...
      public class DeidentifyTemplates {
        ...
        public class Delete extends DLPRequest<com.google.api.services.dlp.v2.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/deidentifyTemplates/[^/]+$");
      ...
      public class InspectTemplates {
        ...
        public class Delete extends DLPRequest<com.google.api.services.dlp.v2.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/inspectTemplates/[^/]+$");
      ...
      public class StoredInfoTypes {
        ...
        public class Delete extends DLPRequest<com.google.api.services.dlp.v2.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/storedInfoTypes/[^/]+$");
