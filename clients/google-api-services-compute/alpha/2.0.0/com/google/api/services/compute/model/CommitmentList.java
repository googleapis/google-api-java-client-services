...
public final class CommitmentList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Commitment> items;
  ...
  /**
   * Output only. [Output Only] Type of resource. Always compute#commitmentList for lists of
   * commitments.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public CommitmentList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Commitment> getItems() {
    return items;
  }
   ...
   */
  public CommitmentList setItems(java.util.List<Commitment> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public CommitmentList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public CommitmentList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public CommitmentList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public CommitmentList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public CommitmentList set(String fieldName, Object value) {
    return (CommitmentList) super.set(fieldName, value);
  }

  @Override
  public CommitmentList clone() {
    return (CommitmentList) super.clone();
  }
