...
public final class TargetPoolAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, TargetPoolsScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#targetPoolAggregatedList for
   ...
   */
  public TargetPoolAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, TargetPoolsScopedList> getItems() {
    return items;
  }
   ...
   */
  public TargetPoolAggregatedList setItems(java.util.Map<String, TargetPoolsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetPoolAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetPoolAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetPoolAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetPoolAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public TargetPoolAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetPoolAggregatedList set(String fieldName, Object value) {
    return (TargetPoolAggregatedList) super.set(fieldName, value);
  }

  @Override
  public TargetPoolAggregatedList clone() {
    return (TargetPoolAggregatedList) super.clone();
  }
