...
public final class DiskTypesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<DiskType> diskTypes;
   ...
   */
  public java.util.List<DiskType> getDiskTypes() {
    return diskTypes;
  }

  /**
   * [Output Only] A list of disk types contained in this scope.
   * @param diskTypes diskTypes or {@code null} for none
   */
  public DiskTypesScopedList setDiskTypes(java.util.List<DiskType> diskTypes) {
   ...
   */
  public DiskTypesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public DiskTypesScopedList set(String fieldName, Object value) {
    return (DiskTypesScopedList) super.set(fieldName, value);
  }

  @Override
  public DiskTypesScopedList clone() {
    return (DiskTypesScopedList) super.clone();
  }
