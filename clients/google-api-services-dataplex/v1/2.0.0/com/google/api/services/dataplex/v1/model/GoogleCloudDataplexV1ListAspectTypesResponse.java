...
public final class GoogleCloudDataplexV1ListAspectTypesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudDataplexV1AspectType> aspectTypes;

  static {
    // hack to force ProGuard to consider GoogleCloudDataplexV1AspectType used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDataplexV1AspectType.class);
  }
   ...
   */
  public GoogleCloudDataplexV1ListAspectTypesResponse setNextPageToken(java.lang.String nextPageToken) {
  ...
  @Override
  public GoogleCloudDataplexV1ListAspectTypesResponse set(String fieldName, Object value) {
    return (GoogleCloudDataplexV1ListAspectTypesResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDataplexV1ListAspectTypesResponse clone() {
    return (GoogleCloudDataplexV1ListAspectTypesResponse) super.clone();
  }
