...
/**
 * Model definition for CompositeHealthCheckList.
 *
...
public final class CompositeHealthCheckList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<CompositeHealthCheck> items;

  static {
    // hack to force ProGuard to consider CompositeHealthCheck used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(CompositeHealthCheck.class);
  }
   ...
   */
  public CompositeHealthCheckList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<CompositeHealthCheck> getItems() {
    return items;
  }
   ...
   */
  public CompositeHealthCheckList setItems(java.util.List<CompositeHealthCheck> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public CompositeHealthCheckList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public CompositeHealthCheckList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public CompositeHealthCheckList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public CompositeHealthCheckList set(String fieldName, Object value) {
    return (CompositeHealthCheckList) super.set(fieldName, value);
  }

  @Override
  public CompositeHealthCheckList clone() {
    return (CompositeHealthCheckList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for CompositeHealthCheckListWarningData.
     */
