...
public final class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1p3beta1SpeechContext> speechContexts;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1p3beta1SpeechContext used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1p3beta1SpeechContext.class);
  }
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setAudioTracks(java.util.List<java.lang.Integer> audioTracks) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setDiarizationSpeakerCount(java.lang.Integer diarizationSpeakerCount) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setEnableAutomaticPunctuation(java.lang.Boolean enableAutomaticPunctuation) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setEnableSpeakerDiarization(java.lang.Boolean enableSpeakerDiarization) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setEnableWordConfidence(java.lang.Boolean enableWordConfidence) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setFilterProfanity(java.lang.Boolean filterProfanity) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setLanguageCode(java.lang.String languageCode) {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setMaxAlternatives(java.lang.Integer maxAlternatives) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1p3beta1SpeechContext> getSpeechContexts() {
   ...
   */
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig setSpeechContexts(java.util.List<GoogleCloudVideointelligenceV1p3beta1SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
    return this;
  }

  @Override
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig set(String fieldName, Object value) {
    return (GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig clone() {
    return (GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig) super.clone();
  }
