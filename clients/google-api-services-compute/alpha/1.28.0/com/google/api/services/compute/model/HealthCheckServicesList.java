...
public final class HealthCheckServicesList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HealthCheckService> items;
  ...
  /**
   * [Output Only] Type of the resource. Always compute#healthCheckServicesList for lists of
   * HealthCheckServices.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public HealthCheckServicesList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthCheckServicesList set(String fieldName, Object value) {
    return (HealthCheckServicesList) super.set(fieldName, value);
  }

  @Override
  public HealthCheckServicesList clone() {
    return (HealthCheckServicesList) super.clone();
  }
