...
package com.google.api.services.apphub.v1alpha;
...
public class AppHub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
       ...
       * @param content the {@link com.google.api.services.apphub.v1alpha.model.DetachServiceProjectAttachmentRequest}
       * @return the request
       */
      public DetachServiceProjectAttachment detachServiceProjectAttachment(java.lang.String name, com.google.api.services.apphub.v1alpha.model.DetachServiceProjectAttachmentRequest content) throws java.io.IOException {
        DetachServiceProjectAttachment result = new DetachServiceProjectAttachment(name, content);
        initialize(result);
        return result;
      }

      public class DetachServiceProjectAttachment extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.DetachServiceProjectAttachmentResponse> {

        private static final String REST_PATH = "v1alpha/{+name}:detachServiceProjectAttachment";
       ...
       *        supported. Expected format: `projects/{project}/locations/{location}`.
         ...
         * @since 1.13
         */
        protected DetachServiceProjectAttachment(java.lang.String name, com.google.api.services.apphub.v1alpha.model.DetachServiceProjectAttachmentRequest content) {
          super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.DetachServiceProjectAttachmentResponse.class);
      ...
      public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Location.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class GetBoundary extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Boundary> {
       ...
       *        `projects/{project}/locations/{location}/boundary`.
        ...
        protected GetBoundary(java.lang.String name) {
          super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Boundary.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class LookupServiceProjectAttachment extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.LookupServiceProjectAttachmentResponse> {

        private static final String REST_PATH = "v1alpha/{+name}:lookupServiceProjectAttachment";
       ...
       *        location is supported. Expected format: `projects/{project}/locations/{location}`.
        ...
        protected LookupServiceProjectAttachment(java.lang.String name) {
          super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.LookupServiceProjectAttachmentResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        "projects/{project}/locations/{location}/boundary"
       * @param content the {@link com.google.api.services.apphub.v1alpha.model.Boundary}
       * @return the request
       */
      public UpdateBoundary updateBoundary(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Boundary content) throws java.io.IOException {
        UpdateBoundary result = new UpdateBoundary(name, content);
        initialize(result);
        return result;
      }

      public class UpdateBoundary extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
       ...
       *        "projects/{project}/locations/{location}/boundary"
         ...
         * @since 1.13
         */
        protected UpdateBoundary(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Boundary content) {
          super(AppHub.this, "PATCH", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Applications {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Application content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Application content) {
            super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
        ...
        public class Delete extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
         ...
         *        `projects/{project}/locations/{location}/applications/{application}`.
          ...
          protected Delete(java.lang.String name) {
            super(AppHub.this, "DELETE", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Application> {
         ...
         *        `projects/{project}/locations/{location}/applications/{application}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Application.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class GetIamPolicy extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Policy.class);
        ...
        public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListApplicationsResponse> {
         ...
         *        `projects/{project}/locations/{location}`.
          ...
          protected List(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListApplicationsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Application content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
         ...
         *        id}/locations/{location}/applications/{application-id}"`
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Application content) {
            super(AppHub.this, "PATCH", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.apphub.v1alpha.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.apphub.v1alpha.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.apphub.v1alpha.model.SetIamPolicyRequest content) {
            super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.apphub.v1alpha.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.apphub.v1alpha.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.apphub.v1alpha.model.TestIamPermissionsRequest content) {
            super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
        ...
        public class Services {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Service content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
           ...
           *        `projects/{project}/locations/{location}/applications/{application}`.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Service content) {
              super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Service> {
           ...
           *        `projects/{project}/locations/{location}/applications/{application}/services/{service}`.
             ...
             */
            protected Get(java.lang.String name) {
              super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Service.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListServicesResponse> {
           ...
           *        `projects/{project}/locations/{location}/applications/{application}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListServicesResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Service content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        id}/locations/{location}/applications/{application-id}/services/{service-id}"`
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Service content) {
              super(AppHub.this, "PATCH", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Workloads {
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Workload content) throws java.io.IOException {
            Create result = new Create(parent, content);
            initialize(result);
            return result;
          }
          ...
          public class Create extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
            ...
            private static final String REST_PATH = "v1alpha/{+parent}/workloads";
           ...
           *        `projects/{project}/locations/{location}/applications/{application}`.
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.Workload content) {
              super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Workload> {
           ...
           *        `projects/{project}/locations/{location}/applications/{application}/workloads/{workload}`.
             ...
             */
            protected Get(java.lang.String name) {
              super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Workload.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListWorkloadsResponse> {
           ...
           *        `projects/{project}/locations/{location}/applications/{application}`.
             ...
             */
            protected List(java.lang.String parent) {
              super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListWorkloadsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Workload content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        id}/locations/{location}/applications/{application-id}/workloads/{workload-id}"`
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.apphub.v1alpha.model.Workload content) {
              super(AppHub.this, "PATCH", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class DiscoveredServices {
         ...
         *
         * This request holds the parameters needed by the apphub server.  After setting any optional
         * parameters, call the {@link FindUnregistered#execute()} method to invoke the remote operation.
         *
         * @param parent Required. Project and location to find unregistered Discovered Services on. Expected format:
         *        `projects/{project}/locations/{location}`.
         * @return the request
         */
        public FindUnregistered findUnregistered(java.lang.String parent) throws java.io.IOException {
          FindUnregistered result = new FindUnregistered(parent);
          initialize(result);
          return result;
        }

        public class FindUnregistered extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.FindUnregisteredServicesResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}/discoveredServices:findUnregistered";
           ...
           * This request holds the parameters needed by the the apphub server.  After setting any optional
           * parameters, call the {@link FindUnregistered#execute()} method to invoke the remote operation.
           * <p> {@link FindUnregistered#initialize(com.google.api.client.googleapis.services.AbstractGoogle
         ...
         *        `projects/{project}/locations/{location}`.
           * @since 1.13
           */
          protected FindUnregistered(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.FindUnregisteredServicesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          @Override
          public FindUnregistered set$Xgafv(java.lang.String $Xgafv) {
            return (FindUnregistered) super.set$Xgafv($Xgafv);
          }

          @Override
          public FindUnregistered setAccessToken(java.lang.String accessToken) {
            return (FindUnregistered) super.setAccessToken(accessToken);
          }

          @Override
          public FindUnregistered setAlt(java.lang.String alt) {
            return (FindUnregistered) super.setAlt(alt);
          }

          @Override
          public FindUnregistered setCallback(java.lang.String callback) {
            return (FindUnregistered) super.setCallback(callback);
          }

          @Override
          public FindUnregistered setFields(java.lang.String fields) {
            return (FindUnregistered) super.setFields(fields);
          }

          @Override
          public FindUnregistered setKey(java.lang.String key) {
            return (FindUnregistered) super.setKey(key);
          }

          @Override
          public FindUnregistered setOauthToken(java.lang.String oauthToken) {
            return (FindUnregistered) super.setOauthToken(oauthToken);
          }

          @Override
          public FindUnregistered setPrettyPrint(java.lang.Boolean prettyPrint) {
            return (FindUnregistered) super.setPrettyPrint(prettyPrint);
          }

          @Override
          public FindUnregistered setQuotaUser(java.lang.String quotaUser) {
            return (FindUnregistered) super.setQuotaUser(quotaUser);
          }

          @Override
          public FindUnregistered setUploadType(java.lang.String uploadType) {
            return (FindUnregistered) super.setUploadType(uploadType);
          }

          @Override
          public FindUnregistered setUploadProtocol(java.lang.String uploadProtocol) {
            return (FindUnregistered) super.setUploadProtocol(uploadProtocol);
          }

          /**
           * Required. Project and location to find unregistered Discovered Services on. Expected
         ...
         `projects/{project}/locations/{location}`.
           ...
           * format: `projects/{project}/locations/{location}`.
           */
          public FindUnregistered setParent(java.lang.String parent) {
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
                  "^projects/[^/]+/locations/[^/]+$");
          ...
          /** Optional. Filtering results. */
          public FindUnregistered setFilter(java.lang.String filter) {
            this.filter = filter;
            return this;
          }
          ...
          /** Optional. Hint for how to order the results. */
          public FindUnregistered setOrderBy(java.lang.String orderBy) {
            this.orderBy = orderBy;
            return this;
          }
         ...
         will pick an appropriate default.
           ...
           * unspecified, server will pick an appropriate default.
           */
          public FindUnregistered setPageSize(java.lang.Integer pageSize) {
            this.pageSize = pageSize;
            return this;
          }
          ...
          /** Optional. A token identifying a page of results the server should return. */
          public FindUnregistered setPageToken(java.lang.String pageToken) {
            this.pageToken = pageToken;
            return this;
          }

          @Override
          public FindUnregistered set(String parameterName, Object value) {
            return (FindUnregistered) super.set(parameterName, value);
          }
        }
        /**
        ...
        public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.DiscoveredService> {
         ...
         *        `projects/{project}/locations/{location}/discoveredServices/{discoveredService}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.DiscoveredService.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListDiscoveredServicesResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}/discoveredServices";
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListDiscoveredServicesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
      ...
      public class DiscoveredWorkloads {
         ...
         *
         * Create a request for the method "discoveredWorkloads.findUnregistered".
         *
         * This request holds the parameters needed by the apphub server.  After setting any optional
         * parameters, call the {@link FindUnregistered#execute()} method to invoke the remote operation.
         *
         * @param parent Required. Project and location to find unregistered Discovered Workloads on. Expected format:
         *        `projects/{project}/locations/{location}`.
         * @return the request
         */
        public FindUnregistered findUnregistered(java.lang.String parent) throws java.io.IOException {
        ...
        public class FindUnregistered extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.FindUnregisteredWorkloadsResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}/discoveredWorkloads:findUnregistered";
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           */
          protected FindUnregistered(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.FindUnregisteredWorkloadsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * Required. Project and location to find unregistered Discovered Workloads on. Expected
           * format: `projects/{project}/locations/{location}`.
           */
          @com.google.api.client.util.Key
          private java.lang.String parent;
        ...
        public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.DiscoveredWorkload> {
         ...
         *        `projects/{project}/locations/{location}/discoveredWorkloads/{discoveredWorkload}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.DiscoveredWorkload.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListDiscoveredWorkloadsResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}/discoveredWorkloads";
         ...
         *        `projects/{project}/locations/{location}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListDiscoveredWorkloadsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.apphub.v1alpha.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.apphub.v1alpha.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.apphub.v1alpha.model.CancelOperationRequest content) {
            super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(AppHub.this, "DELETE", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class ServiceProjectAttachments {
         ...
         *        location is supported. Expected format: `projects/{project}/locations/{location}`.
         * @param content the {@link com.google.api.services.apphub.v1alpha.model.ServiceProjectAttachment}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.ServiceProjectAttachment content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
        ...
        public class Create extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.Operation> {
          ...
          private static final String REST_PATH = "v1alpha/{+parent}/serviceProjectAttachments";
         ...
         *        location is supported. Expected format: `projects/{project}/locations/{location}`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.apphub.v1alpha.model.ServiceProjectAttachment content) {
            super(AppHub.this, "POST", REST_PATH, content, com.google.api.services.apphub.v1alpha.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class Get extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ServiceProjectAttachment> {
         ...
         *        nt}`.
           ...
           */
          protected Get(java.lang.String name) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ServiceProjectAttachment.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AppHubRequest<com.google.api.services.apphub.v1alpha.model.ListServiceProjectAttachmentsResponse> {
         ...
         *        supported. Expected format: `projects/{project}/locations/{location}`.
           ...
           */
          protected List(java.lang.String parent) {
            super(AppHub.this, "GET", REST_PATH, null, com.google.api.services.apphub.v1alpha.model.ListServiceProjectAttachmentsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
