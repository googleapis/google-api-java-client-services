...
public final class AttestorPublicKey extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A raw PKIX SubjectPublicKeyInfo format public key. NOTE: `id` may be explicitly provided by the
   * caller when using this type of public key, but it MUST be a valid RFC3986 URI. If `id` is left
