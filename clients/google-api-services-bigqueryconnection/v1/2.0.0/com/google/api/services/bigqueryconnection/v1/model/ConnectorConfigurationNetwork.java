...
public final class ConnectorConfigurationNetwork extends com.google.api.client.json.GenericJson {
   ...
   */
  public ConnectorConfigurationNetwork setPrivateServiceConnect(ConnectorConfigurationPrivateServiceConnect privateServiceConnect) {
    this.privateServiceConnect = privateServiceConnect;
    return this;
  }

  @Override
  public ConnectorConfigurationNetwork set(String fieldName, Object value) {
    return (ConnectorConfigurationNetwork) super.set(fieldName, value);
  }

  @Override
  public ConnectorConfigurationNetwork clone() {
