...
public final class GoogleIamV1GetPolicyOptions extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleIamV1GetPolicyOptions setRequestedPolicyVersion(java.lang.Integer requestedPolicyVersion) {
    this.requestedPolicyVersion = requestedPolicyVersion;
    return this;
  }

  @Override
  public GoogleIamV1GetPolicyOptions set(String fieldName, Object value) {
    return (GoogleIamV1GetPolicyOptions) super.set(fieldName, value);
  }

  @Override
  public GoogleIamV1GetPolicyOptions clone() {
    return (GoogleIamV1GetPolicyOptions) super.clone();
  }
