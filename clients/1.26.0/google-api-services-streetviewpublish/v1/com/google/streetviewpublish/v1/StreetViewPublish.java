...
package com.google.streetviewpublish.v1;
...
public class StreetViewPublish extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Street View Publish API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Photo {
     ...
     *
     * @param content the {@link com.google.streetviewpublish.v1.model.Photo}
     * @return the request
     */
    public Create create(com.google.streetviewpublish.v1.model.Photo content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.Photo> {
       ...
       * @since 1.13
       */
      protected Create(com.google.streetviewpublish.v1.model.Photo content) {
        super(StreetViewPublish.this, "POST", REST_PATH, content, com.google.streetviewpublish.v1.model.Photo.class);
      }
    ...
    public class Delete extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.Empty> {
      ...
      protected Delete(java.lang.String photoId) {
        super(StreetViewPublish.this, "DELETE", REST_PATH, null, com.google.streetviewpublish.v1.model.Empty.class);
    ...
    public class Get extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.Photo> {
      ...
      protected Get(java.lang.String photoId) {
        super(StreetViewPublish.this, "GET", REST_PATH, null, com.google.streetviewpublish.v1.model.Photo.class);
        this.photoId = com.google.api.client.util.Preconditions.checkNotNull(photoId, "Required parameter photoId must be specified.");
      }
     ...
     * operation.
     *
     * @param content the {@link com.google.streetviewpublish.v1.model.Empty}
     * @return the request
     */
    public StartUpload startUpload(com.google.streetviewpublish.v1.model.Empty content) throws java.io.IOException {
      StartUpload result = new StartUpload(content);
      initialize(result);
      return result;
    }

    public class StartUpload extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.UploadRef> {
       ...
       * @since 1.13
       */
      protected StartUpload(com.google.streetviewpublish.v1.model.Empty content) {
        super(StreetViewPublish.this, "POST", REST_PATH, content, com.google.streetviewpublish.v1.model.UploadRef.class);
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String id, com.google.streetviewpublish.v1.model.Photo content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }

    public class Update extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.Photo> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, com.google.streetviewpublish.v1.model.Photo content) {
        super(StreetViewPublish.this, "PUT", REST_PATH, content, com.google.streetviewpublish.v1.model.Photo.class);
  ...
  public class Photos {
     ...
     * operation.
     *
     * @param content the {@link com.google.streetviewpublish.v1.model.BatchDeletePhotosRequest}
     * @return the request
     */
    public BatchDelete batchDelete(com.google.streetviewpublish.v1.model.BatchDeletePhotosRequest content) throws java.io.IOException {
      BatchDelete result = new BatchDelete(content);
      initialize(result);
      return result;
    }

    public class BatchDelete extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.BatchDeletePhotosResponse> {
       ...
       * @since 1.13
       */
      protected BatchDelete(com.google.streetviewpublish.v1.model.BatchDeletePhotosRequest content) {
        super(StreetViewPublish.this, "POST", REST_PATH, content, com.google.streetviewpublish.v1.model.BatchDeletePhotosResponse.class);
      }
    ...
    public class BatchGet extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.BatchGetPhotosResponse> {
       ...
       */
      protected BatchGet() {
        super(StreetViewPublish.this, "GET", REST_PATH, null, com.google.streetviewpublish.v1.model.BatchGetPhotosResponse.class);
      }
     ...
     * operation.
     *
     * @param content the {@link com.google.streetviewpublish.v1.model.BatchUpdatePhotosRequest}
     * @return the request
     */
    public BatchUpdate batchUpdate(com.google.streetviewpublish.v1.model.BatchUpdatePhotosRequest content) throws java.io.IOException {
      BatchUpdate result = new BatchUpdate(content);
      initialize(result);
      return result;
    }

    public class BatchUpdate extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.BatchUpdatePhotosResponse> {
       ...
       * @since 1.13
       */
      protected BatchUpdate(com.google.streetviewpublish.v1.model.BatchUpdatePhotosRequest content) {
        super(StreetViewPublish.this, "POST", REST_PATH, content, com.google.streetviewpublish.v1.model.BatchUpdatePhotosResponse.class);
      }
    ...
    public class List extends StreetViewPublishRequest<com.google.streetviewpublish.v1.model.ListPhotosResponse> {
       ...
       */
      protected List() {
        super(StreetViewPublish.this, "GET", REST_PATH, null, com.google.streetviewpublish.v1.model.ListPhotosResponse.class);
      }
