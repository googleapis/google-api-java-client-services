 ...
 * user's device model. * `deviceType` (string): the type (also known as form factor) of the user's
 * device. * `countryCode` (string): the country or region of the user's device based on their IP
