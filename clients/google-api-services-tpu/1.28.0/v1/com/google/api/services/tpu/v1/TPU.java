...
package com.google.api.services.tpu.v1;
...
public class TPU extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.28.0 of the Cloud TPU API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends TPURequest<com.google.api.services.tpu.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.Location.class);
      ...
      public class List extends TPURequest<com.google.api.services.tpu.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class AcceleratorTypes {
        ...
        public class Get extends TPURequest<com.google.api.services.tpu.v1.model.AcceleratorType> {
           ...
           */
          protected Get(java.lang.String name) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.AcceleratorType.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TPURequest<com.google.api.services.tpu.v1.model.ListAcceleratorTypesResponse> {

          private static final String REST_PATH = "v1/{+parent}/acceleratorTypes";
          ...
          protected List(java.lang.String parent) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.ListAcceleratorTypesResponse.class);
      ...
      public class Nodes {
         ...
         *
         * @param parent The parent resource name.
         * @param content the {@link com.google.api.services.tpu.v1.model.Node}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.tpu.v1.model.Node content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.tpu.v1.model.Node content) {
            super(TPU.this, "POST", REST_PATH, content, com.google.api.services.tpu.v1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Delete extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {
          ...
          protected Delete(java.lang.String name) {
            super(TPU.this, "DELETE", REST_PATH, null, com.google.api.services.tpu.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends TPURequest<com.google.api.services.tpu.v1.model.Node> {
           ...
           */
          protected Get(java.lang.String name) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.Node.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TPURequest<com.google.api.services.tpu.v1.model.ListNodesResponse> {
           ...
           */
          protected List(java.lang.String parent) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.ListNodesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *
         * @param name The resource name.
         * @param content the {@link com.google.api.services.tpu.v1.model.ReimageNodeRequest}
         * @return the request
         */
        public Reimage reimage(java.lang.String name, com.google.api.services.tpu.v1.model.ReimageNodeRequest content) throws java.io.IOException {
          Reimage result = new Reimage(name, content);
          initialize(result);
          return result;
        }

        public class Reimage extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {

          private static final String REST_PATH = "v1/{+name}:reimage";
           ...
           * @since 1.13
           */
          protected Reimage(java.lang.String name, com.google.api.services.tpu.v1.model.ReimageNodeRequest content) {
            super(TPU.this, "POST", REST_PATH, content, com.google.api.services.tpu.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * @param name The resource name.
         * @param content the {@link com.google.api.services.tpu.v1.model.StartNodeRequest}
         * @return the request
         */
        public Start start(java.lang.String name, com.google.api.services.tpu.v1.model.StartNodeRequest content) throws java.io.IOException {
          Start result = new Start(name, content);
          initialize(result);
          return result;
        }

        public class Start extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Start(java.lang.String name, com.google.api.services.tpu.v1.model.StartNodeRequest content) {
            super(TPU.this, "POST", REST_PATH, content, com.google.api.services.tpu.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * @param name The resource name.
         * @param content the {@link com.google.api.services.tpu.v1.model.StopNodeRequest}
         * @return the request
         */
        public Stop stop(java.lang.String name, com.google.api.services.tpu.v1.model.StopNodeRequest content) throws java.io.IOException {
          Stop result = new Stop(name, content);
          initialize(result);
          return result;
        }

        public class Stop extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected Stop(java.lang.String name, com.google.api.services.tpu.v1.model.StopNodeRequest content) {
            super(TPU.this, "POST", REST_PATH, content, com.google.api.services.tpu.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Operations {
        ...
        public class Cancel extends TPURequest<com.google.api.services.tpu.v1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(TPU.this, "POST", REST_PATH, null, com.google.api.services.tpu.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends TPURequest<com.google.api.services.tpu.v1.model.Empty> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(TPU.this, "DELETE", REST_PATH, null, com.google.api.services.tpu.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends TPURequest<com.google.api.services.tpu.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TPURequest<com.google.api.services.tpu.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class TensorflowVersions {
        ...
        public class Get extends TPURequest<com.google.api.services.tpu.v1.model.TensorFlowVersion> {
           ...
           */
          protected Get(java.lang.String name) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.TensorFlowVersion.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends TPURequest<com.google.api.services.tpu.v1.model.ListTensorFlowVersionsResponse> {

          private static final String REST_PATH = "v1/{+parent}/tensorflowVersions";
           ...
           */
          protected List(java.lang.String parent) {
            super(TPU.this, "GET", REST_PATH, null, com.google.api.services.tpu.v1.model.ListTensorFlowVersionsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
