...
public final class MachineSeries extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public MachineSeries set(String fieldName, Object value) {
    return (MachineSeries) super.set(fieldName, value);
  }

  @Override
  public MachineSeries clone() {
    return (MachineSeries) super.clone();
  }
