...
public final class GoogleCloudDiscoveryengineV1Chunk extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1ChunkChunkMetadata chunkMetadata;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1ChunkDocumentMetadata documentMetadata;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1ChunkPageSpan pageSpan;
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1ChunkChunkMetadata getChunkMetadata() {
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setChunkMetadata(GoogleCloudDiscoveryengineV1ChunkChunkMetadata chunkMetadata) {
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setDerivedStructData(java.util.Map<String, java.lang.Object> derivedStructData) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata getDocumentMetadata() {
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setDocumentMetadata(GoogleCloudDiscoveryengineV1ChunkDocumentMetadata documentMetadata) {
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1ChunkPageSpan getPageSpan() {
    return pageSpan;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1Chunk setPageSpan(GoogleCloudDiscoveryengineV1ChunkPageSpan pageSpan) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1Chunk set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1Chunk) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1Chunk clone() {
    return (GoogleCloudDiscoveryengineV1Chunk) super.clone();
  }
