...
public final class InstanceGroup extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] The creation timestamp for this instance group inRFC3339 text
   * format.
  ...
  /**
   * Output only. [Output Only] The fingerprint of the named ports. The system uses this fingerprint
  ...
  /**
   * Output only. [Output Only] A unique identifier for this instance group, generated by the
   * server.
   * The value may be {@code null}.
   */
  ...
  /**
   * Output only. [Output Only] The resource type, which is alwayscompute#instanceGroup for instance
   * groups.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The URL of theregion where the instance group is located (for
   * regional resources).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The URL of the subnetwork to which all instances in the instance
   * group belong. If your instance has multiple network interfaces, then the network and subnetwork
   * fields only refer to the network and subnet used by your primary interface (nic0).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. [Output Only] The URL of thezone where the instance group is located (for zonal
   * resources).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
