...
/**
 * Model definition for BackendBucketsScopedList.
 *
...
public final class BackendBucketsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<BackendBucket> backendBuckets;
   ...
   */
  public java.util.List<BackendBucket> getBackendBuckets() {
    return backendBuckets;
  }

  /**
   * A list of BackendBuckets contained in this scope.
   * @param backendBuckets backendBuckets or {@code null} for none
   */
  public BackendBucketsScopedList setBackendBuckets(java.util.List<BackendBucket> backendBuckets) {
   ...
   */
  public BackendBucketsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendBucketsScopedList set(String fieldName, Object value) {
    return (BackendBucketsScopedList) super.set(fieldName, value);
  }

  @Override
  public BackendBucketsScopedList clone() {
    return (BackendBucketsScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for BackendBucketsScopedListWarningData.
     */
