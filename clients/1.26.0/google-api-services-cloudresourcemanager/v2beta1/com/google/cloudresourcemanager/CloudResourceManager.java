...
public class CloudResourceManager extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Folders {
     ...
     *
     * @param content the {@link com.google.cloudresourcemanager.model.Folder}
     * @return the request
     */
    public Create create(com.google.cloudresourcemanager.model.Folder content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Operation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.cloudresourcemanager.model.Folder content) {
        super(CloudResourceManager.this, "POST", REST_PATH, content, com.google.cloudresourcemanager.model.Operation.class);
      }
    ...
    public class Delete extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Folder> {
    ...
    Must be of the form `folders/{folder_id}`.
      ...
      protected Delete(java.lang.String name) {
        super(CloudResourceManager.this, "DELETE", REST_PATH, null, com.google.cloudresourcemanager.model.Folder.class);
    ...
    public class Get extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Folder> {
    ...
    Must be of the form `folders/{folder_id}`.
      ...
      protected Get(java.lang.String name) {
        super(CloudResourceManager.this, "GET", REST_PATH, null, com.google.cloudresourcemanager.model.Folder.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.ListFoldersResponse> {
       ...
       */
      protected List() {
        super(CloudResourceManager.this, "GET", REST_PATH, null, com.google.cloudresourcemanager.model.ListFoldersResponse.class);
      }
    ...
    Must be of the form folders/{folder_id}
     * @param content the {@link com.google.cloudresourcemanager.model.MoveFolderRequest}
     * @return the request
     */
    public Move move(java.lang.String name, com.google.cloudresourcemanager.model.MoveFolderRequest content) throws java.io.IOException {
      Move result = new Move(name, content);
      initialize(result);
      return result;
    }

    public class Move extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Operation> {
    ...
    Must be of the form folders/{folder_id}
       ...
       * @since 1.13
       */
      protected Move(java.lang.String name, com.google.cloudresourcemanager.model.MoveFolderRequest content) {
        super(CloudResourceManager.this, "POST", REST_PATH, content, com.google.cloudresourcemanager.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.cloudresourcemanager.model.Folder content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }

    public class Patch extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Folder> {
     ...
     *        "folders/1234".
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.cloudresourcemanager.model.Folder content) {
        super(CloudResourceManager.this, "PATCH", REST_PATH, content, com.google.cloudresourcemanager.model.Folder.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
     ...
     *
     * @param content the {@link com.google.cloudresourcemanager.model.SearchFoldersRequest}
     * @return the request
     */
    public Search search(com.google.cloudresourcemanager.model.SearchFoldersRequest content) throws java.io.IOException {
      Search result = new Search(content);
      initialize(result);
      return result;
    }

    public class Search extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.SearchFoldersResponse> {
       ...
       * @since 1.13
       */
      protected Search(com.google.cloudresourcemanager.model.SearchFoldersRequest content) {
        super(CloudResourceManager.this, "POST", REST_PATH, content, com.google.cloudresourcemanager.model.SearchFoldersResponse.class);
      }
    ...
    Must be of the form `folders/{folder_id}`.
     * @param content the {@link com.google.cloudresourcemanager.model.UndeleteFolderRequest}
     * @return the request
     */
    public Undelete undelete(java.lang.String name, com.google.cloudresourcemanager.model.UndeleteFolderRequest content) throws java.io.IOException {
      Undelete result = new Undelete(name, content);
      initialize(result);
      return result;
    }

    public class Undelete extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Folder> {
    ...
    Must be of the form `folders/{folder_id}`.
       ...
       * @since 1.13
       */
      protected Undelete(java.lang.String name, com.google.cloudresourcemanager.model.UndeleteFolderRequest content) {
        super(CloudResourceManager.this, "POST", REST_PATH, content, com.google.cloudresourcemanager.model.Folder.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
  ...
  public class Operations {
    ...
    public class Get extends CloudResourceManagerRequest<com.google.cloudresourcemanager.model.Operation> {
       ...
       */
      protected Get(java.lang.String name) {
        super(CloudResourceManager.this, "GET", REST_PATH, null, com.google.cloudresourcemanager.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
