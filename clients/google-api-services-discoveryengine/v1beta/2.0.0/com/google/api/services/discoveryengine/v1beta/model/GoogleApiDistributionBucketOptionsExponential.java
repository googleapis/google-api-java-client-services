...
public final class GoogleApiDistributionBucketOptionsExponential extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleApiDistributionBucketOptionsExponential setGrowthFactor(java.lang.Double growthFactor) {
   ...
   */
  public GoogleApiDistributionBucketOptionsExponential setNumFiniteBuckets(java.lang.Integer numFiniteBuckets) {
   ...
   */
  public GoogleApiDistributionBucketOptionsExponential setScale(java.lang.Double scale) {
    this.scale = scale;
    return this;
  }

  @Override
  public GoogleApiDistributionBucketOptionsExponential set(String fieldName, Object value) {
    return (GoogleApiDistributionBucketOptionsExponential) super.set(fieldName, value);
  }

  @Override
  public GoogleApiDistributionBucketOptionsExponential clone() {
    return (GoogleApiDistributionBucketOptionsExponential) super.clone();
  }
