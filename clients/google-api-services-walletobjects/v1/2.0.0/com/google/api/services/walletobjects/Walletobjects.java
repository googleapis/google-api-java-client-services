  ...
  public class WalletobjectsOperations {
    ...
    public class V1 {
      ...
      public class PrivateContent {
         ...
         *
         * Create a request for the method "privateContent.uploadPrivateData".
         *
         * This request holds the parameters needed by the walletobjects server.  After setting any optional
         * parameters, call the {@link UploadPrivateData#execute()} method to invoke the remote operation.
         *
         * @param content the {@link com.google.api.services.walletobjects.model.UploadPrivateDataRequest}
         * @return the request
         */
        public UploadPrivateData uploadPrivateData(com.google.api.services.walletobjects.model.UploadPrivateDataRequest content) throws java.io.IOException {
          UploadPrivateData result = new UploadPrivateData(content);
          initialize(result);
          return result;
        }

        public class UploadPrivateData extends WalletobjectsRequest<com.google.api.services.walletobjects.model.UploadPrivateDataResponse> {

          private static final String REST_PATH = "walletobjects/v1/privateContent/uploadPrivateData";
           ...
           *
           * This request holds the parameters needed by the the walletobjects server.  After setting any
           * optional parameters, call the {@link UploadPrivateData#execute()} method to invoke the remote
           * operation. <p> {@link UploadPrivateData#initialize(com.google.api.client.googleapis.services.Ab
           ...
           * @since 1.13
           */
          protected UploadPrivateData(com.google.api.services.walletobjects.model.UploadPrivateDataRequest content) {
            super(Walletobjects.this, "POST", REST_PATH, content, com.google.api.services.walletobjects.model.UploadPrivateDataResponse.class);
          }

          @Override
          public UploadPrivateData set$Xgafv(java.lang.String $Xgafv) {
            return (UploadPrivateData) super.set$Xgafv($Xgafv);
          }

          @Override
          public UploadPrivateData setAccessToken(java.lang.String accessToken) {
            return (UploadPrivateData) super.setAccessToken(accessToken);
          }

          @Override
          public UploadPrivateData setAlt(java.lang.String alt) {
            return (UploadPrivateData) super.setAlt(alt);
          }

          @Override
          public UploadPrivateData setCallback(java.lang.String callback) {
            return (UploadPrivateData) super.setCallback(callback);
          }

          @Override
          public UploadPrivateData setFields(java.lang.String fields) {
            return (UploadPrivateData) super.setFields(fields);
          }

          @Override
          public UploadPrivateData setKey(java.lang.String key) {
            return (UploadPrivateData) super.setKey(key);
          }

          @Override
          public UploadPrivateData setOauthToken(java.lang.String oauthToken) {
            return (UploadPrivateData) super.setOauthToken(oauthToken);
          }

          @Override
          public UploadPrivateData setPrettyPrint(java.lang.Boolean prettyPrint) {
            return (UploadPrivateData) super.setPrettyPrint(prettyPrint);
          }

          @Override
          public UploadPrivateData setQuotaUser(java.lang.String quotaUser) {
            return (UploadPrivateData) super.setQuotaUser(quotaUser);
          }

          @Override
          public UploadPrivateData setUploadType(java.lang.String uploadType) {
            return (UploadPrivateData) super.setUploadType(uploadType);
          }

          @Override
          public UploadPrivateData setUploadProtocol(java.lang.String uploadProtocol) {
            return (UploadPrivateData) super.setUploadProtocol(uploadProtocol);
          }

          @Override
          public UploadPrivateData set(String parameterName, Object value) {
            return (UploadPrivateData) super.set(parameterName, value);
          }
        }
