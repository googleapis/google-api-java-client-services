...
public final class GoogleDevicesandservicesHealthV4User extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleDevicesandservicesHealthV4User setName(java.lang.String name) {
    this.name = name;
    return this;
  }

  @Override
  public GoogleDevicesandservicesHealthV4User set(String fieldName, Object value) {
    return (GoogleDevicesandservicesHealthV4User) super.set(fieldName, value);
  }

  @Override
  public GoogleDevicesandservicesHealthV4User clone() {
    return (GoogleDevicesandservicesHealthV4User) super.clone();
  }
