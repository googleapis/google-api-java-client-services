...
package com.google.iamcredentials.v1;
...
public class IAMCredentials extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the IAM Service Account Credentials API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class ServiceAccounts {
       ...
       * @return the request
       */
      public GenerateAccessToken generateAccessToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateAccessTokenRequest content) throws java.io.IOException {
        GenerateAccessToken result = new GenerateAccessToken(name, content);
        initialize(result);
        return result;
      }

      public class GenerateAccessToken extends IAMCredentialsRequest<com.google.iamcredentials.v1.model.GenerateAccessTokenResponse> {
      ...
      the account.
         ...
         * @since 1.13
         */
        protected GenerateAccessToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateAccessTokenRequest content) {
          super(IAMCredentials.this, "POST", REST_PATH, content, com.google.iamcredentials.v1.model.GenerateAccessTokenResponse.class);
       ...
       * @return the request
       */
      public GenerateIdToken generateIdToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateIdTokenRequest content) throws java.io.IOException {
        GenerateIdToken result = new GenerateIdToken(name, content);
        initialize(result);
        return result;
      }

      public class GenerateIdToken extends IAMCredentialsRequest<com.google.iamcredentials.v1.model.GenerateIdTokenResponse> {
      ...
      the account.
         ...
         * @since 1.13
         */
        protected GenerateIdToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateIdTokenRequest content) {
          super(IAMCredentials.this, "POST", REST_PATH, content, com.google.iamcredentials.v1.model.GenerateIdTokenResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public GenerateIdentityBindingAccessToken generateIdentityBindingAccessToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateIdentityBindingAccessTokenRequest content) throws java.io.IOException {
        GenerateIdentityBindingAccessToken result = new GenerateIdentityBindingAccessToken(name, content);
        initialize(result);
        return result;
      }

      public class GenerateIdentityBindingAccessToken extends IAMCredentialsRequest<com.google.iamcredentials.v1.model.GenerateIdentityBindingAccessTokenResponse> {
      ...
      the account.
         ...
         * @since 1.13
         */
        protected GenerateIdentityBindingAccessToken(java.lang.String name, com.google.iamcredentials.v1.model.GenerateIdentityBindingAccessTokenRequest content) {
          super(IAMCredentials.this, "POST", REST_PATH, content, com.google.iamcredentials.v1.model.GenerateIdentityBindingAccessTokenResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public SignBlob signBlob(java.lang.String name, com.google.iamcredentials.v1.model.SignBlobRequest content) throws java.io.IOException {
        SignBlob result = new SignBlob(name, content);
        initialize(result);
        return result;
      }

      public class SignBlob extends IAMCredentialsRequest<com.google.iamcredentials.v1.model.SignBlobResponse> {
      ...
      the account.
         ...
         * @since 1.13
         */
        protected SignBlob(java.lang.String name, com.google.iamcredentials.v1.model.SignBlobRequest content) {
          super(IAMCredentials.this, "POST", REST_PATH, content, com.google.iamcredentials.v1.model.SignBlobResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public SignJwt signJwt(java.lang.String name, com.google.iamcredentials.v1.model.SignJwtRequest content) throws java.io.IOException {
        SignJwt result = new SignJwt(name, content);
        initialize(result);
        return result;
      }

      public class SignJwt extends IAMCredentialsRequest<com.google.iamcredentials.v1.model.SignJwtResponse> {
      ...
      the account.
         ...
         * @since 1.13
         */
        protected SignJwt(java.lang.String name, com.google.iamcredentials.v1.model.SignJwtRequest content) {
          super(IAMCredentials.this, "POST", REST_PATH, content, com.google.iamcredentials.v1.model.SignJwtResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
