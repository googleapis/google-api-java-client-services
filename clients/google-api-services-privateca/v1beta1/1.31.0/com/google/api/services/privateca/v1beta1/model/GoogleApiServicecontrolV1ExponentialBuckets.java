...
public final class GoogleApiServicecontrolV1ExponentialBuckets extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleApiServicecontrolV1ExponentialBuckets setGrowthFactor(java.lang.Double growthFactor) {
   ...
   */
  public GoogleApiServicecontrolV1ExponentialBuckets setNumFiniteBuckets(java.lang.Integer numFiniteBuckets) {
   ...
   */
  public GoogleApiServicecontrolV1ExponentialBuckets setScale(java.lang.Double scale) {
    this.scale = scale;
    return this;
  }

  @Override
  public GoogleApiServicecontrolV1ExponentialBuckets set(String fieldName, Object value) {
    return (GoogleApiServicecontrolV1ExponentialBuckets) super.set(fieldName, value);
  }

  @Override
  public GoogleApiServicecontrolV1ExponentialBuckets clone() {
    return (GoogleApiServicecontrolV1ExponentialBuckets) super.clone();
  }
