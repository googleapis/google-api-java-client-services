...
public final class BackendServicesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<BackendService> backendServices;
   ...
   */
  public java.util.List<BackendService> getBackendServices() {
   ...
   */
  public BackendServicesScopedList setBackendServices(java.util.List<BackendService> backendServices) {
   ...
   */
  public BackendServicesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendServicesScopedList set(String fieldName, Object value) {
    return (BackendServicesScopedList) super.set(fieldName, value);
  }

  @Override
  public BackendServicesScopedList clone() {
    return (BackendServicesScopedList) super.clone();
  }
