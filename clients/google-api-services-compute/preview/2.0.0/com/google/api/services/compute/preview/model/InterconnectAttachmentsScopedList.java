...
public final class InterconnectAttachmentsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<InterconnectAttachment> interconnectAttachments;
   ...
   */
  public java.util.List<InterconnectAttachment> getInterconnectAttachments() {
   ...
   */
  public InterconnectAttachmentsScopedList setInterconnectAttachments(java.util.List<InterconnectAttachment> interconnectAttachments) {
   ...
   */
  public InterconnectAttachmentsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectAttachmentsScopedList set(String fieldName, Object value) {
    return (InterconnectAttachmentsScopedList) super.set(fieldName, value);
  }

  @Override
  public InterconnectAttachmentsScopedList clone() {
    return (InterconnectAttachmentsScopedList) super.clone();
  }
