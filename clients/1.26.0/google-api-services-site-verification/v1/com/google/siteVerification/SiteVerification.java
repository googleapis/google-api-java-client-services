...
package com.google.siteVerification;
...
public class SiteVerification extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Google Site Verification API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class WebResource {
    ...
    public class Get extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceResource> {
      ...
      protected Get(java.lang.String id) {
        super(SiteVerification.this, "GET", REST_PATH, null, com.google.siteVerification.model.SiteVerificationWebResourceResource.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     *
     * @param content the {@link com.google.siteVerification.model.SiteVerificationWebResourceGettokenRequest}
     * @return the request
     */
    public GetToken getToken(com.google.siteVerification.model.SiteVerificationWebResourceGettokenRequest content) throws java.io.IOException {
      GetToken result = new GetToken(content);
      initialize(result);
      return result;
    }

    public class GetToken extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceGettokenResponse> {
       ...
       * @since 1.13
       */
      protected GetToken(com.google.siteVerification.model.SiteVerificationWebResourceGettokenRequest content) {
        super(SiteVerification.this, "POST", REST_PATH, content, com.google.siteVerification.model.SiteVerificationWebResourceGettokenResponse.class);
      }
     ...
     * @param content the {@link com.google.siteVerification.model.SiteVerificationWebResourceResource}
     * @return the request
     */
    public Insert insert(java.lang.String verificationMethod, com.google.siteVerification.model.SiteVerificationWebResourceResource content) throws java.io.IOException {
      Insert result = new Insert(verificationMethod, content);
      initialize(result);
      return result;
    }

    public class Insert extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceResource> {
       ...
       * @since 1.13
       */
      protected Insert(java.lang.String verificationMethod, com.google.siteVerification.model.SiteVerificationWebResourceResource content) {
        super(SiteVerification.this, "POST", REST_PATH, content, com.google.siteVerification.model.SiteVerificationWebResourceResource.class);
    ...
    public class List extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceListResponse> {
       ...
       */
      protected List() {
        super(SiteVerification.this, "GET", REST_PATH, null, com.google.siteVerification.model.SiteVerificationWebResourceListResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String id, com.google.siteVerification.model.SiteVerificationWebResourceResource content) throws java.io.IOException {
      Patch result = new Patch(id, content);
      initialize(result);
      return result;
    }

    public class Patch extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceResource> {
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String id, com.google.siteVerification.model.SiteVerificationWebResourceResource content) {
        super(SiteVerification.this, "PATCH", REST_PATH, content, com.google.siteVerification.model.SiteVerificationWebResourceResource.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String id, com.google.siteVerification.model.SiteVerificationWebResourceResource content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }

    public class Update extends SiteVerificationRequest<com.google.siteVerification.model.SiteVerificationWebResourceResource> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, com.google.siteVerification.model.SiteVerificationWebResourceResource content) {
        super(SiteVerification.this, "PUT", REST_PATH, content, com.google.siteVerification.model.SiteVerificationWebResourceResource.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
