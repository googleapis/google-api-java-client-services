...
public final class GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanation extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership> memberships;
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership> getMemberships() {
    return memberships;
  }
   ...
   */
  public GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanation setMemberships(java.util.Map<String, GoogleCloudPolicytroubleshooterIamV3betaAllowBindingExplanationAnnotatedAllowMembership> memberships) {
