...
public final class ForwardInfo extends com.google.api.client.json.GenericJson {
   ...
   */
  public ForwardInfo setIpAddress(java.lang.String ipAddress) {
   ...
   */
  public ForwardInfo setTarget(java.lang.String target) {
    this.target = target;
    return this;
  }

  @Override
  public ForwardInfo set(String fieldName, Object value) {
    return (ForwardInfo) super.set(fieldName, value);
  }

  @Override
  public ForwardInfo clone() {
    return (ForwardInfo) super.clone();
  }
