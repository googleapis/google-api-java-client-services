...
public final class Environment extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public Timestamp getAuthorizationTimestamp() {
    return authorizationTimestamp;
  }

  /**
   * The last update time-stamp for the authorization code.
   * @param authorizationTimestamp authorizationTimestamp or {@code null} for none
   */
  public Environment setAuthorizationTimestamp(Timestamp authorizationTimestamp) {
   ...
   */
  public Environment setPath(java.lang.String path) {
    this.path = path;
    return this;
  }
   ...
   */
  public Environment setTagManagerUrl(java.lang.String tagManagerUrl) {
   ...
   */
  public Environment setWorkspaceId(java.lang.String workspaceId) {
