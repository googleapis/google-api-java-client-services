...
public final class UserList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<SingleUser> values;

  static {
    // hack to force ProGuard to consider SingleUser used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(SingleUser.class);
  }
   ...
   */
  public java.util.List<SingleUser> getValues() {
    return values;
  }
   ...
   */
  public UserList setValues(java.util.List<SingleUser> values) {
    this.values = values;
    return this;
  }
