...
public final class GoogleCloudContactcenterinsightsV1alpha1InitializeEncryptionSpecMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Partial errors during initialising operation that might cause the operation output to be
   * incomplete.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudContactcenterinsightsV1alpha1InitializeEncryptionSpecMetadata setPartialErrors(java.util.List<GoogleRpcStatus> partialErrors) {
