...
public class SQLAdmin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class BlueGreenDeployments {
     ...
     * synchronized green environment (target instance) from a blue production environment (source
     * instance), facilitating updates like major version upgrades on the green instance without
     * impacting the blue instance.
     *
    ...
    public class Create extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/{+parent}/blueGreenDeployments";

      private final java.util.regex.Pattern PARENT_PATTERN =
          java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+$");

      /**
       * Creates a blue-green deployment under a given project and location. This deployment provisions
       * a synchronized green environment (target instance) from a blue production environment (source
       * instance), facilitating updates like major version upgrades on the green instance without
       * impacting the blue instance.
       *
       * Create a request for the method "blueGreenDeployments.create".
    ...
    /**
     * Deletes a blue-green deployment, including metadata and underlying resources based on the
     * deployment state. If issued before switchover, this deletes the green instance. If issued after
     * switchover, this deletes the old blue instance (source instance) if the `delete_old_source` field
     * in the request is set to true. All blue-green deployment metadata is permanently deleted.
     * Resources deleted as a result of this operation are no longer accessible and can't be restored.
     *
    ...
    public class Delete extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
       ...
       * Deletes a blue-green deployment, including metadata and underlying resources based on the
       * deployment state. If issued before switchover, this deletes the green instance. If issued after
       * switchover, this deletes the old blue instance (source instance) if the `delete_old_source`
       * field in the request is set to true. All blue-green deployment metadata is permanently deleted.
       * Resources deleted as a result of this operation are no longer accessible and can't be restored.
       *
       * Create a request for the method "blueGreenDeployments.delete".
       *
    ...
    public class Switchover extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/{+name}:switchover";
  ...
  public class Instances {
    ...
    public class ListEntraIdCertificates extends SQLAdminRequest<com.google.api.services.sqladmin.model.InstancesListEntraIdCertificatesResponse> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/listEntraIdCertificates";
    ...
    public class RotateEntraIdCertificate extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/rotateEntraIdCertificate";
    ...
    public class AddEntraIdCertificate extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/addEntraIdCertificate";
  ...
  public class WorkloadCaptures {
    ...
    public class List extends SQLAdminRequest<com.google.api.services.sqladmin.model.WorkloadCapturesListResponse> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures";
    ...
    public class Start extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:start";
    ...
    public class StartReplay extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:startReplay";
    ...
    public class Stop extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:stop";
    ...
    public class StopReplay extends SQLAdminRequest<com.google.api.services.sqladmin.model.Operation> {
      ...
      private static final String REST_PATH = "sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:stopReplay";
