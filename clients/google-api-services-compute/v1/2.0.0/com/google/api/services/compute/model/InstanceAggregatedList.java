...
public final class InstanceAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, InstancesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#instanceAggregatedList for
   ...
   */
  public InstanceAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public InstanceAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InstanceAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstanceAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InstanceAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public InstanceAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceAggregatedList set(String fieldName, Object value) {
    return (InstanceAggregatedList) super.set(fieldName, value);
  }

  @Override
  public InstanceAggregatedList clone() {
    return (InstanceAggregatedList) super.clone();
  }
