...
public final class GoogleCloudDiscoveryengineV1alphaSearchRequest extends com.google.api.client.json.GenericJson {
   ...
   * boosted based on the location provided. * `search_type`: double. Default empty. Enables non-
   * webpage searching depending on the value. The only valid non-default value is 1, which enables
   * image searching.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
