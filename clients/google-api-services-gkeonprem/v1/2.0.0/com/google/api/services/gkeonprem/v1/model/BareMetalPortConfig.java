...
public final class BareMetalPortConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public BareMetalPortConfig setControlPlaneLoadBalancerPort(java.lang.Integer controlPlaneLoadBalancerPort) {
    this.controlPlaneLoadBalancerPort = controlPlaneLoadBalancerPort;
    return this;
  }

  @Override
  public BareMetalPortConfig set(String fieldName, Object value) {
    return (BareMetalPortConfig) super.set(fieldName, value);
  }

  @Override
  public BareMetalPortConfig clone() {
    return (BareMetalPortConfig) super.clone();
  }
