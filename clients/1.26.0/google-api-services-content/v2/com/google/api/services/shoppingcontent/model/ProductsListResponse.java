...
public final class ProductsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Product> resources;
   ...
   */
  public ProductsListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Product> getResources() {
    return resources;
  }
   ...
   */
  public ProductsListResponse setResources(java.util.List<Product> resources) {
