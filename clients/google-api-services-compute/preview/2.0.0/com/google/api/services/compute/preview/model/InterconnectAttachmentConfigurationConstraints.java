...
public final class InterconnectAttachmentConfigurationConstraints extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Whether the attachment's BGP session requires/allows/disallows BGP
   * MD5 authentication. This can take one of the following values: MD5_OPTIONAL, MD5_REQUIRED,
   * MD5_UNSUPPORTED.
   *
   * For example, a Cross-Cloud Interconnect connection to a remote cloud provider that requires BGP
   * MD5 authentication has the interconnectRemoteLocation
  ...
  /**
   * Output only. [Output Only] List of ASN ranges that the remote location is known to support.
   * Formatted as an array of inclusive ranges {min: min-value, max: max-value}. For example, [{min:
   * 123, max: 123}, {min: 64512, max: 65534}] allows the peer ASN to be 123 or anything in the
   * range 64512-65534.
   *
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InterconnectAttachmentConfigurationConstraintsBgpPeerASNRange> getBgpPeerAsnRanges() {
