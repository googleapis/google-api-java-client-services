...
public final class AddressAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, AddressesScopedList> items;
   ...
   */
  public AddressAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, AddressesScopedList> getItems() {
    return items;
  }
   ...
   */
  public AddressAggregatedList setItems(java.util.Map<String, AddressesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public AddressAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public AddressAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public AddressAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AddressAggregatedList set(String fieldName, Object value) {
    return (AddressAggregatedList) super.set(fieldName, value);
  }

  @Override
  public AddressAggregatedList clone() {
    return (AddressAggregatedList) super.clone();
  }
