...
package com.google.api.services.hangoutschat.v1;
...
public class HangoutsChat extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0 of the Hangouts Chat API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Spaces {
    ...
    public class Get extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Space> {
    ...
    Example: spaces/AAAAMpdlehY
      ...
      protected Get(java.lang.String name) {
        super(HangoutsChat.this, "GET", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.Space.class);
    ...
    public class List extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.ListSpacesResponse> {
       ...
       */
      protected List() {
        super(HangoutsChat.this, "GET", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.ListSpacesResponse.class);
      }
    ...
    public class Members {
      ...
      public class Get extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Membership> {
       ...
       *        spaces/AAAAMpdlehY/members/105115627578887013105
         ...
         */
        protected Get(java.lang.String name) {
          super(HangoutsChat.this, "GET", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.Membership.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.ListMembershipsResponse> {
      ...
      Example: spaces/AAAAMpdlehY
        ...
        protected List(java.lang.String parent) {
          super(HangoutsChat.this, "GET", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.ListMembershipsResponse.class);
    ...
    public class Messages {
      ...
      Example: spaces/AAAAMpdlehY
       * @param content the {@link com.google.api.services.hangoutschat.v1.model.Message}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.hangoutschat.v1.model.Message content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Message> {
      ...
      Example: spaces/AAAAMpdlehY
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.hangoutschat.v1.model.Message content) {
          super(HangoutsChat.this, "POST", REST_PATH, content, com.google.api.services.hangoutschat.v1.model.Message.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Delete extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Empty> {
       ...
       *        spaces/AAAAMpdlehY/messages/UMxbHmzDlr4.UMxbHmzDlr4
        ...
        protected Delete(java.lang.String name) {
          super(HangoutsChat.this, "DELETE", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Message> {
       ...
       *        spaces/AAAAMpdlehY/messages/UMxbHmzDlr4.UMxbHmzDlr4
         ...
         */
        protected Get(java.lang.String name) {
          super(HangoutsChat.this, "GET", REST_PATH, null, com.google.api.services.hangoutschat.v1.model.Message.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @return the request
       */
      public Update update(java.lang.String name, com.google.api.services.hangoutschat.v1.model.Message content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends HangoutsChatRequest<com.google.api.services.hangoutschat.v1.model.Message> {
       ...
       *        spaces/AAAAMpdlehY/messages/UMxbHmzDlr4.UMxbHmzDlr4
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.api.services.hangoutschat.v1.model.Message content) {
          super(HangoutsChat.this, "PUT", REST_PATH, content, com.google.api.services.hangoutschat.v1.model.Message.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
