...
public final class TargetGrpcProxyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetGrpcProxy> items;

  static {
    // hack to force ProGuard to consider TargetGrpcProxy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetGrpcProxy.class);
  }
   ...
   */
  public TargetGrpcProxyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetGrpcProxy> getItems() {
    return items;
  }
   ...
   */
  public TargetGrpcProxyList setItems(java.util.List<TargetGrpcProxy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetGrpcProxyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetGrpcProxyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetGrpcProxyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetGrpcProxyList set(String fieldName, Object value) {
    return (TargetGrpcProxyList) super.set(fieldName, value);
  }

  @Override
  public TargetGrpcProxyList clone() {
    return (TargetGrpcProxyList) super.clone();
  }
