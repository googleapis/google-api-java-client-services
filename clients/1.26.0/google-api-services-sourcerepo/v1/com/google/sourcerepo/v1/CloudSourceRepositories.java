...
package com.google.sourcerepo.v1;
...
public class CloudSourceRepositories extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Source Repositories API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class GetConfig extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.ProjectConfig> {
    ...
    `projects/`.
      ...
      protected GetConfig(java.lang.String name) {
        super(CloudSourceRepositories.this, "GET", REST_PATH, null, com.google.sourcerepo.v1.model.ProjectConfig.class);
     ...
     * @param name The name of the requested project. Values are of the form
    `projects/`.
     * @param content the {@link com.google.sourcerepo.v1.model.UpdateProjectConfigRequest}
     * @return the request
     */
    public UpdateConfig updateConfig(java.lang.String name, com.google.sourcerepo.v1.model.UpdateProjectConfigRequest content) throws java.io.IOException {
      UpdateConfig result = new UpdateConfig(name, content);
      initialize(result);
      return result;
    }

    public class UpdateConfig extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.ProjectConfig> {
    ...
    `projects/`.
       ...
       * @since 1.13
       */
      protected UpdateConfig(java.lang.String name, com.google.sourcerepo.v1.model.UpdateProjectConfigRequest content) {
        super(CloudSourceRepositories.this, "PATCH", REST_PATH, content, com.google.sourcerepo.v1.model.ProjectConfig.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class Repos {
      ...
      `projects/`.
       * @param content the {@link com.google.sourcerepo.v1.model.Repo}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.sourcerepo.v1.model.Repo content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Repo> {
      ...
      `projects/`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.sourcerepo.v1.model.Repo content) {
          super(CloudSourceRepositories.this, "POST", REST_PATH, content, com.google.sourcerepo.v1.model.Repo.class);
      ...
      public class Delete extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Empty> {
      ...
      `projects//repos/`.
        ...
        protected Delete(java.lang.String name) {
          super(CloudSourceRepositories.this, "DELETE", REST_PATH, null, com.google.sourcerepo.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Repo> {
      ...
      `projects//repos/`.
        ...
        protected Get(java.lang.String name) {
          super(CloudSourceRepositories.this, "GET", REST_PATH, null, com.google.sourcerepo.v1.model.Repo.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class GetIamPolicy extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Policy> {
       ...
       *        the appropriate value for this field.
        ...
        protected GetIamPolicy(java.lang.String resource) {
          super(CloudSourceRepositories.this, "GET", REST_PATH, null, com.google.sourcerepo.v1.model.Policy.class);
      ...
      public class List extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.ListReposResponse> {
      ...
      `projects/`.
        ...
        protected List(java.lang.String name) {
          super(CloudSourceRepositories.this, "GET", REST_PATH, null, com.google.sourcerepo.v1.model.ListReposResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param name The name of the requested repository. Values are of the form
      `projects//repos/`.
       * @param content the {@link com.google.sourcerepo.v1.model.UpdateRepoRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.sourcerepo.v1.model.UpdateRepoRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Repo> {
      ...
      `projects//repos/`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.sourcerepo.v1.model.UpdateRepoRequest content) {
          super(CloudSourceRepositories.this, "PATCH", REST_PATH, content, com.google.sourcerepo.v1.model.Repo.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      See the operation documentation for
       *        the appropriate value for this field.
       * @param content the {@link com.google.sourcerepo.v1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.sourcerepo.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.Policy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.sourcerepo.v1.model.SetIamPolicyRequest content) {
          super(CloudSourceRepositories.this, "POST", REST_PATH, content, com.google.sourcerepo.v1.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
      ...
      See the operation
       *        documentation for the appropriate value for this field.
       * @param content the {@link com.google.sourcerepo.v1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.sourcerepo.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends CloudSourceRepositoriesRequest<com.google.sourcerepo.v1.model.TestIamPermissionsResponse> {
       ...
       *        documentation for the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.sourcerepo.v1.model.TestIamPermissionsRequest content) {
          super(CloudSourceRepositories.this, "POST", REST_PATH, content, com.google.sourcerepo.v1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
