...
public final class GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest setErrorConfig(GoogleCloudDiscoveryengineV1alphaImportErrorConfig errorConfig) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest clone() {
    return (GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest) super.clone();
  }
