...
public final class GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest setPlayIntegrityToken(java.lang.String playIntegrityToken) {
    this.playIntegrityToken = playIntegrityToken;
    return this;
  }

  @Override
  public GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest clone() {
    return (GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest) super.clone();
  }
