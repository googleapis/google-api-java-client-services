    ...
    public class Locations {
      ...
      public class AuthProviders {
        ...
        public class Credentials {
          ...
          public class Finalize extends AgentIdentityCredentialsRequest<com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1FinalizeCredentialsResponse> {

            private static final String REST_PATH = "v1/{+authProvider}/credentials:finalize";
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
             ...
             * @since 1.13
             */
            protected Finalize(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1FinalizeCredentialsRequest content) {
              super(AgentIdentityCredentials.this, "POST", REST_PATH, content, com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1FinalizeCredentialsResponse.class);
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
           * @param content the {@link com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1RetrieveCredentialsRequest}
           * @return the request
           */
          public Retrieve retrieve(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1RetrieveCredentialsRequest content) throws java.io.IOException {
            Retrieve result = new Retrieve(authProvider, content);
            initialize(result);
            return result;
          }

          public class Retrieve extends AgentIdentityCredentialsRequest<com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1RetrieveCredentialsResponse> {

            private static final String REST_PATH = "v1/{+authProvider}/credentials:retrieve";
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
             ...
             * @since 1.13
             */
            protected Retrieve(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1RetrieveCredentialsRequest content) {
              super(AgentIdentityCredentials.this, "POST", REST_PATH, content, com.google.api.services.agentidentitycredentials.v1.model.GoogleCloudAgentidentitycredentialsV1RetrieveCredentialsResponse.class);
              this.authProvider = com.google.api.client.util.Preconditions.checkNotNull(authProvider, "Required parameter authProvider must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(AUTH_PROVIDER_PATTERN.matcher(authProvider).matches(),
                    "Parameter authProvider must conform to the pattern " +
