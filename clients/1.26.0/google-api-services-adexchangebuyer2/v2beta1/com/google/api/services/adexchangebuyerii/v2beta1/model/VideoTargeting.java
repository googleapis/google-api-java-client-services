...
public final class VideoTargeting extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A list of video positions to be excluded. Position types can either be included or excluded
   * (XOR).
  ...
  /**
   * A list of video positions to be included. When the included list is present, the excluded list
   * must be empty. When the excluded list is present, the included list must be empty.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
