...
public final class GoogleCloudAiplatformV1beta1Trial extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1Measurement> measurements;

  static {
    // hack to force ProGuard to consider GoogleCloudAiplatformV1beta1Measurement used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAiplatformV1beta1Measurement.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1TrialParameter> parameters;
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setClientId(java.lang.String clientId) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setCustomJob(java.lang.String customJob) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setEndTime(String endTime) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setFinalMeasurement(GoogleCloudAiplatformV1beta1Measurement finalMeasurement) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setInfeasibleReason(java.lang.String infeasibleReason) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1Measurement> getMeasurements() {
    return measurements;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setMeasurements(java.util.List<GoogleCloudAiplatformV1beta1Measurement> measurements) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1TrialParameter> getParameters() {
    return parameters;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setParameters(java.util.List<GoogleCloudAiplatformV1beta1TrialParameter> parameters) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setStartTime(String startTime) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setState(java.lang.String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1Trial setWebAccessUris(java.util.Map<String, java.lang.String> webAccessUris) {
    this.webAccessUris = webAccessUris;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1Trial set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1Trial) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1Trial clone() {
