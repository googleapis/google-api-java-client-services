...
public final class ConferenceParameters extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Additional add-on specific data.
   * @param addOnParameters addOnParameters or {@code null} for none
   */
  public ConferenceParameters setAddOnParameters(ConferenceParametersAddOnParameters addOnParameters) {
    this.addOnParameters = addOnParameters;
    return this;
  }

  @Override
  public ConferenceParameters set(String fieldName, Object value) {
    return (ConferenceParameters) super.set(fieldName, value);
  }
