...
/**
 * Model definition for BackendBucketUsedBy.
 *
...
public final class BackendBucketUsedBy extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public BackendBucketUsedBy set(String fieldName, Object value) {
    return (BackendBucketUsedBy) super.set(fieldName, value);
  }

  @Override
  public BackendBucketUsedBy clone() {
    return (BackendBucketUsedBy) super.clone();
  }
