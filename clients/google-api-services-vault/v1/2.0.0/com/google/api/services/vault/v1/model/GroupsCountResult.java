...
public final class GroupsCountResult extends com.google.api.client.json.GenericJson {
   ...
   */
  public GroupsCountResult setAccountCountErrors(java.util.List<AccountCountError> accountCountErrors) {
   ...
   */
  public GroupsCountResult setAccountCounts(java.util.List<AccountCount> accountCounts) {
   ...
   */
  public GroupsCountResult setMatchingAccountsCount(java.lang.Long matchingAccountsCount) {
   ...
   */
  public GroupsCountResult setQueriedAccountsCount(java.lang.Long queriedAccountsCount) {
    this.queriedAccountsCount = queriedAccountsCount;
    return this;
  }

  @Override
  public GroupsCountResult set(String fieldName, Object value) {
    return (GroupsCountResult) super.set(fieldName, value);
  }

  @Override
  public GroupsCountResult clone() {
    return (GroupsCountResult) super.clone();
  }
