...
public final class NetworkProfilesListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NetworkProfile> items;

  static {
    // hack to force ProGuard to consider NetworkProfile used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkProfile.class);
  }

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#networkProfileList for network
   * profiles.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NetworkProfilesListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public NetworkProfilesListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkProfile> getItems() {
    return items;
  }
   ...
   */
  public NetworkProfilesListResponse setItems(java.util.List<NetworkProfile> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkProfilesListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkProfilesListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkProfilesListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkProfilesListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NetworkProfilesListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkProfilesListResponse set(String fieldName, Object value) {
    return (NetworkProfilesListResponse) super.set(fieldName, value);
  }

  @Override
  public NetworkProfilesListResponse clone() {
    return (NetworkProfilesListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkProfilesListResponseWarningData.
     */
