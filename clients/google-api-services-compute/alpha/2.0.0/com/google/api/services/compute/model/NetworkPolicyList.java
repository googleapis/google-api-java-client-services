...
/**
 * Model definition for NetworkPolicyList.
 *
...
public final class NetworkPolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NetworkPolicy> items;

  static {
    // hack to force ProGuard to consider NetworkPolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkPolicy.class);
  }

  /**
   * [Output Only] Type of resource. Always compute#networkPolicyList for lists of network policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NetworkPolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NetworkPolicy> getItems() {
    return items;
  }
   ...
   */
  public NetworkPolicyList setItems(java.util.List<NetworkPolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkPolicyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkPolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkPolicyList set(String fieldName, Object value) {
    return (NetworkPolicyList) super.set(fieldName, value);
  }

  @Override
  public NetworkPolicyList clone() {
    return (NetworkPolicyList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkPolicyListWarningData.
     */
