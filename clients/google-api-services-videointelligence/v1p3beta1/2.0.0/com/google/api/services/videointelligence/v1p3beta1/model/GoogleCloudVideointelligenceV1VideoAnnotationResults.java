...
public final class GoogleCloudVideointelligenceV1VideoAnnotationResults extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1FaceAnnotation> faceAnnotations;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1FaceAnnotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1FaceAnnotation.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1FaceDetectionAnnotation> faceDetectionAnnotations;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1FaceDetectionAnnotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1FaceDetectionAnnotation.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1LogoRecognitionAnnotation> logoRecognitionAnnotations;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1LogoRecognitionAnnotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1LogoRecognitionAnnotation.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1PersonDetectionAnnotation> personDetectionAnnotations;

  static {
    // hack to force ProGuard to consider GoogleCloudVideointelligenceV1PersonDetectionAnnotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVideointelligenceV1PersonDetectionAnnotation.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> segmentPresenceLabelAnnotations;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> shotPresenceLabelAnnotations;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1FaceAnnotation> getFaceAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setFaceAnnotations(java.util.List<GoogleCloudVideointelligenceV1FaceAnnotation> faceAnnotations) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1FaceDetectionAnnotation> getFaceDetectionAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setFaceDetectionAnnotations(java.util.List<GoogleCloudVideointelligenceV1FaceDetectionAnnotation> faceDetectionAnnotations) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1LogoRecognitionAnnotation> getLogoRecognitionAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setLogoRecognitionAnnotations(java.util.List<GoogleCloudVideointelligenceV1LogoRecognitionAnnotation> logoRecognitionAnnotations) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1PersonDetectionAnnotation> getPersonDetectionAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setPersonDetectionAnnotations(java.util.List<GoogleCloudVideointelligenceV1PersonDetectionAnnotation> personDetectionAnnotations) {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setSegment(GoogleCloudVideointelligenceV1VideoSegment segment) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> getSegmentPresenceLabelAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setSegmentPresenceLabelAnnotations(java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> segmentPresenceLabelAnnotations) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> getShotPresenceLabelAnnotations() {
   ...
   */
  public GoogleCloudVideointelligenceV1VideoAnnotationResults setShotPresenceLabelAnnotations(java.util.List<GoogleCloudVideointelligenceV1LabelAnnotation> shotPresenceLabelAnnotations) {
