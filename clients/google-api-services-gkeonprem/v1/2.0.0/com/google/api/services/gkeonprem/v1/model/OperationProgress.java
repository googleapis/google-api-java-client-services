...
public final class OperationProgress extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<OperationStage> stages;

  /**
   * The stages of the operation.
   * @return value or {@code null} for none
   */
  public java.util.List<OperationStage> getStages() {
    return stages;
  }
   ...
   */
  public OperationProgress setStages(java.util.List<OperationStage> stages) {
    this.stages = stages;
    return this;
  }
