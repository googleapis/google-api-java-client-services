...
public final class GoogleCloudDocumentaiV1beta1DocumentPageLine extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageLine setDetectedLanguages(java.util.List<GoogleCloudDocumentaiV1beta1DocumentPageDetectedLanguage> detectedLanguages) {
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageLine setLayout(GoogleCloudDocumentaiV1beta1DocumentPageLayout layout) {
    this.layout = layout;
    return this;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta1DocumentPageLine setProvenance(GoogleCloudDocumentaiV1beta1DocumentProvenance provenance) {
    this.provenance = provenance;
    return this;
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentPageLine set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta1DocumentPageLine) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta1DocumentPageLine clone() {
    return (GoogleCloudDocumentaiV1beta1DocumentPageLine) super.clone();
  }
