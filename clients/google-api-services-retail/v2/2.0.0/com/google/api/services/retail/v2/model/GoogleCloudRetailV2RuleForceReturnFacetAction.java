...
public final class GoogleCloudRetailV2RuleForceReturnFacetAction extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment> facetPositionAdjustments;
  ...
  @Override
  public GoogleCloudRetailV2RuleForceReturnFacetAction set(String fieldName, Object value) {
    return (GoogleCloudRetailV2RuleForceReturnFacetAction) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2RuleForceReturnFacetAction clone() {
    return (GoogleCloudRetailV2RuleForceReturnFacetAction) super.clone();
  }
