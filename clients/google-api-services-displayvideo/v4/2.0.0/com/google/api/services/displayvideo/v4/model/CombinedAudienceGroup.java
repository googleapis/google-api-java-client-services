...
/**
 * Details of combined audience group. All combined audience targeting settings are logically ‘OR’
 * of each other.
 *
...
public final class CombinedAudienceGroup extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<CombinedAudienceTargetingSetting> settings;
  ...
  @Override
  public CombinedAudienceGroup set(String fieldName, Object value) {
    return (CombinedAudienceGroup) super.set(fieldName, value);
  }

  @Override
  public CombinedAudienceGroup clone() {
    return (CombinedAudienceGroup) super.clone();
  }
