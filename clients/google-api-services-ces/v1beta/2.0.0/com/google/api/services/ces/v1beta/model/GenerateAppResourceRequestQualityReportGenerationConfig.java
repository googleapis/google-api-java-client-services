...
public final class GenerateAppResourceRequestQualityReportGenerationConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GenerateAppResourceRequestQualityReportGenerationConfig setEvaluationRun(java.lang.String evaluationRun) {
    this.evaluationRun = evaluationRun;
    return this;
  }

  @Override
  public GenerateAppResourceRequestQualityReportGenerationConfig set(String fieldName, Object value) {
    return (GenerateAppResourceRequestQualityReportGenerationConfig) super.set(fieldName, value);
  }

  @Override
  public GenerateAppResourceRequestQualityReportGenerationConfig clone() {
    return (GenerateAppResourceRequestQualityReportGenerationConfig) super.clone();
  }
