...
public final class NetworkList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Network> items;

  static {
    // hack to force ProGuard to consider Network used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Network.class);
  }
   ...
   */
  public NetworkList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Network> getItems() {
    return items;
  }
   ...
   */
  public NetworkList setItems(java.util.List<Network> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NetworkList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NetworkList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkList set(String fieldName, Object value) {
    return (NetworkList) super.set(fieldName, value);
  }

  @Override
  public NetworkList clone() {
    return (NetworkList) super.clone();
  }
