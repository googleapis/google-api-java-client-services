# App Engine Admin API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1alpha-rev20240218-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-appengine:v1alpha-rev20240218-2.0.0'
}
```
