...
public class CloudTasks extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class GetCmekConfig extends CloudTasksRequest<com.google.api.services.cloudtasks.v2beta3.model.CmekConfig> {
       ...
       *        projects/PROJECT_ID/locations/LOCATION_ID/cmekConfig`
        ...
        protected GetCmekConfig(java.lang.String name) {
          super(CloudTasks.this, "GET", REST_PATH, null, com.google.api.services.cloudtasks.v2beta3.model.CmekConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param content the {@link com.google.api.services.cloudtasks.v2beta3.model.CmekConfig}
       * @return the request
       */
      public UpdateCmekConfig updateCmekConfig(java.lang.String name, com.google.api.services.cloudtasks.v2beta3.model.CmekConfig content) throws java.io.IOException {
        UpdateCmekConfig result = new UpdateCmekConfig(name, content);
        initialize(result);
        return result;
      }

      public class UpdateCmekConfig extends CloudTasksRequest<com.google.api.services.cloudtasks.v2beta3.model.CmekConfig> {
       ...
       *        'cmekConfig', in the format projects/PROJECT_ID/locations/LOCATION_ID/cmekConfig`
         ...
         * @since 1.13
         */
        protected UpdateCmekConfig(java.lang.String name, com.google.api.services.cloudtasks.v2beta3.model.CmekConfig content) {
          super(CloudTasks.this, "PATCH", REST_PATH, content, com.google.api.services.cloudtasks.v2beta3.model.CmekConfig.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Get extends CloudTasksRequest<com.google.api.services.cloudtasks.v2beta3.model.Operation> {
      ...
      public class Queues {
        ...
        public class Tasks {
          ...
          public class BatchCreate extends CloudTasksRequest<com.google.api.services.cloudtasks.v2beta3.model.Operation> {
          ...
          public class BatchDelete extends CloudTasksRequest<com.google.api.services.cloudtasks.v2beta3.model.Operation> {
