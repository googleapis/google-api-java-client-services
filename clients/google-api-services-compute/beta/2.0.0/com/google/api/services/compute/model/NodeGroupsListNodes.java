...
public final class NodeGroupsListNodes extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<NodeGroupNode> items;

  static {
    // hack to force ProGuard to consider NodeGroupNode used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NodeGroupNode.class);
  }

  /**
   * Output only. [Output Only] The resource type, which is alwayscompute.nodeGroupsListNodes for
   * the list of nodes in the specified node group.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NodeGroupsListNodes setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<NodeGroupNode> getItems() {
    return items;
  }
   ...
   */
  public NodeGroupsListNodes setItems(java.util.List<NodeGroupNode> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NodeGroupsListNodes setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NodeGroupsListNodes setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NodeGroupsListNodes setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NodeGroupsListNodes setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeGroupsListNodes set(String fieldName, Object value) {
    return (NodeGroupsListNodes) super.set(fieldName, value);
  }

  @Override
  public NodeGroupsListNodes clone() {
    return (NodeGroupsListNodes) super.clone();
  }
