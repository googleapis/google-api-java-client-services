...
public final class MachineImageList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<MachineImage> items;

  static {
    // hack to force ProGuard to consider MachineImage used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(MachineImage.class);
  }

  /**
   * [Output Only] The resource type, which is always compute#machineImagesListResponse for machine
   * image lists.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public MachineImageList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<MachineImage> getItems() {
    return items;
  }
   ...
   */
  public MachineImageList setItems(java.util.List<MachineImage> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public MachineImageList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public MachineImageList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public MachineImageList set(String fieldName, Object value) {
    return (MachineImageList) super.set(fieldName, value);
  }

  @Override
  public MachineImageList clone() {
    return (MachineImageList) super.clone();
  }
