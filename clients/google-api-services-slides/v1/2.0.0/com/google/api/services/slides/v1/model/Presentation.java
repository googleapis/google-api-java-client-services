...
public final class Presentation extends com.google.api.client.json.GenericJson {
   ...
   * has edit access to the presentation. The revision ID is not a sequential number but a nebulous
   * string. The format of the revision ID may change over time, so it should be treated opaquely. A
