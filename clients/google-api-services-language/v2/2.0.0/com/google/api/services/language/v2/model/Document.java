...
public final class Document extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The language of the document (if not specified, the language is automatically
   * detected). Both ISO and BCP-47 language codes are accepted. [Language
   ...
   */
  public Document setLanguageCode(java.lang.String languageCode) {
