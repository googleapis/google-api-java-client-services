...
public class CloudBuild extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Builds {
      ...
      /**
       * Cancels a build in progress. Note: This method only cancels builds in the "global" region when
       * using the legacy resource path projects/{project_id}/builds/{id}:cancel. For all regions, use the
      ...
      public class Cancel extends CloudBuildRequest<com.google.api.services.cloudbuild.v1.model.Build> {
        ...
        /**
         * Cancels a build in progress. Note: This method only cancels builds in the "global" region when
         * using the legacy resource path projects/{project_id}/builds/{id}:cancel. For all regions, use
         * the regional resource path: `projects/{project_id}/locations/{location}/builds/{id}:cancel`.
         *
         * Create a request for the method "builds.cancel".
         *
         * This request holds the parameters needed by the the cloudbuild server.  After setting any
       ...
       * as `SUCCESS` or `FAILURE`). Note: This method only creates builds in the "global" region when
       * using the legacy resource path projects/{project_id}/builds. For all regions, use the regional
      ...
      public class Create extends CloudBuildRequest<com.google.api.services.cloudbuild.v1.model.Operation> {
         ...
         * build status (such as `SUCCESS` or `FAILURE`). Note: This method only creates builds in the
         * "global" region when using the legacy resource path projects/{project_id}/builds. For all
         * regions, use the regional resource path: `projects/{project_id}/locations/{location}/builds`.
         *
         * Create a request for the method "builds.create".
         *
         * This request holds the parameters needed by the the cloudbuild server.  After setting any
       ...
       * only gets builds in the "global" region when using the legacy resource path
       * projects/{project_id}/builds/{id}. For all regions, use the regional resource path:
      ...
      public class Get extends CloudBuildRequest<com.google.api.services.cloudbuild.v1.model.Build> {
         ...
         * method only gets builds in the "global" region when using the legacy resource path
         * projects/{project_id}/builds/{id}. For all regions, use the regional resource path:
         * `projects/{project_id}/locations/{location}/builds/{id}`.
         *
         * Create a request for the method "builds.get".
       ...
       * have finished successfully or unsuccessfully. Note: This method only lists builds in the "global"
       * region when using the legacy resource path projects/{project_id}/builds. For all regions, use the
      ...
      public class List extends CloudBuildRequest<com.google.api.services.cloudbuild.v1.model.ListBuildsResponse> {
        ...
        /**
         * Lists previously requested builds. Previously requested builds may still be in-progress, or may
         * have finished successfully or unsuccessfully. Note: This method only lists builds in the
         * "global" region when using the legacy resource path projects/{project_id}/builds. For all
         * regions, use the regional resource path: `projects/{project_id}/locations/{location}/builds`.
         *
         * Create a request for the method "builds.list".
      ...
      /**
       * Creates a new build based on the specified build. Note: This method only creates builds in the
       * "global" region when using the legacy resource path projects/{project_id}/builds/{id}:retry. For
       * all regions, use the regional resource path:
      ...
      public class Retry extends CloudBuildRequest<com.google.api.services.cloudbuild.v1.model.Operation> {
        ...
        /**
         * Creates a new build based on the specified build. Note: This method only creates builds in the
         * "global" region when using the legacy resource path projects/{project_id}/builds/{id}:retry.
         * For all regions, use the regional resource path:
         * `projects/{project_id}/locations/{location}/builds/{id}:retry`. This method creates a new build
         * using the original build request, which may or may not result in an identical build. For
         * triggered builds: * Triggered builds resolve to a precise revision; therefore a retry of a
