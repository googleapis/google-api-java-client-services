...
/**
 * Service definition for DisplayVideo (v1beta).
 *
 * <p>
...
public class DisplayVideo extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.10 of the Display & Video 360 API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Media {
    ...
    public class Download extends DisplayVideoRequest<com.google.api.services.displayvideo.v1beta.model.GoogleBytestreamMedia> {
      ...
      protected Download(java.lang.String resourceName) {
        super(DisplayVideo.this, "GET", REST_PATH, null, com.google.api.services.displayvideo.v1beta.model.GoogleBytestreamMedia.class);
  ...
  /**
   * An accessor for creating requests from the Sdfdownloadtask collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code DisplayVideo displayvideo = new DisplayVideo(...);}
   *   {@code DisplayVideo.Sdfdownloadtask.List request = displayvideo.sdfdownloadtask().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  public Sdfdownloadtask sdfdownloadtask() {
    return new Sdfdownloadtask();
  }

  /**
   * The "sdfdownloadtask" collection of methods.
   */
  public class Sdfdownloadtask {
    ...
    public class Operations {
      ...
      public class Get extends DisplayVideoRequest<com.google.api.services.displayvideo.v1beta.model.Operation> {

        private static final String REST_PATH = "v1beta/{+name}";

        private final java.util.regex.Pattern NAME_PATTERN =
            java.util.regex.Pattern.compile("^sdfdownloadtask/operations/[^/]+$");
        ...
        protected Get(java.lang.String name) {
          super(DisplayVideo.this, "GET", REST_PATH, null, com.google.api.services.displayvideo.v1beta.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
                "^sdfdownloadtask/operations/[^/]+$");
          }
        }
