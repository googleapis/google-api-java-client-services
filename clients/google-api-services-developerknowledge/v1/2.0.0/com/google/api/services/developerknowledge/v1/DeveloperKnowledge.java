...
package com.google.api.services.developerknowledge.v1;
...
public class DeveloperKnowledge extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Documents {
    ...
    public class BatchGet extends DeveloperKnowledgeRequest<com.google.api.services.developerknowledge.v1.model.BatchGetDocumentsResponse> {

      private static final String REST_PATH = "v1/documents:batchGet";
       ...
       */
      protected BatchGet() {
        super(DeveloperKnowledge.this, "GET", REST_PATH, null, com.google.api.services.developerknowledge.v1.model.BatchGetDocumentsResponse.class);
      }
    ...
    public class Get extends DeveloperKnowledgeRequest<com.google.api.services.developerknowledge.v1.model.Document> {
     ...
     *        `INVALID_ARGUMENT` error.
      ...
      protected Get(java.lang.String name) {
        super(DeveloperKnowledge.this, "GET", REST_PATH, null, com.google.api.services.developerknowledge.v1.model.Document.class);
    ...
    public class SearchDocumentChunks extends DeveloperKnowledgeRequest<com.google.api.services.developerknowledge.v1.model.SearchDocumentChunksResponse> {

      private static final String REST_PATH = "v1/documents:searchDocumentChunks";
      ...
      protected SearchDocumentChunks() {
        super(DeveloperKnowledge.this, "GET", REST_PATH, null, com.google.api.services.developerknowledge.v1.model.SearchDocumentChunksResponse.class);
      }
       ...
       * operators. Timestamps must be in RFC-3339 format, e.g., `"2025-01-01T00:00:00Z"`. Note:
       * Field names must be in `snake_case` (e.g., `data_source`). Values on the right-hand side of
       * filtering expressions must be string literals enclosed in double quotes (e.g.,
       * `"docs.cloud.google.com"`). You can combine expressions using `AND`, `OR`, and `NOT` (or
       * `-`) logical operators. `OR` has higher precedence than `AND`. Use parentheses for explicit
       * precedence grouping. Examples: * Filter by `Document.content_length_bytes`:
     ...
     * `data_source` (STRING): The source of the document, e.g. `docs.cloud.google.com`. See
     ...
     format, e.g., `"2025-01-01T00:00:00Z"`. Note: Field names must be in `snake_case` (e.g.,
     `data_source`). Values on the right-hand side of filtering expressions must be string literals
     enclosed in double quotes (e.g., `"docs.cloud.google.com"`). You can combine expressions using
     `AND`, `OR`, and `NOT` (or `-`) logical operators. `OR` has higher precedence than `AND`. Use
