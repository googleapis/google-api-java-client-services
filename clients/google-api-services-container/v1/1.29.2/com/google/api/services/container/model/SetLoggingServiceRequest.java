...
public final class SetLoggingServiceRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The logging service the cluster should use to write metrics. Currently available
   * options:
   *
   * * "logging.googleapis.com" - the Google Cloud Logging service * "none" - no metrics will be
   ...
   */
  public SetLoggingServiceRequest setLoggingService(java.lang.String loggingService) {
   ...
   */
  public SetLoggingServiceRequest setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public SetLoggingServiceRequest setProjectId(java.lang.String projectId) {
  ...
  @Override
  public SetLoggingServiceRequest set(String fieldName, Object value) {
    return (SetLoggingServiceRequest) super.set(fieldName, value);
  }

  @Override
  public SetLoggingServiceRequest clone() {
    return (SetLoggingServiceRequest) super.clone();
  }
