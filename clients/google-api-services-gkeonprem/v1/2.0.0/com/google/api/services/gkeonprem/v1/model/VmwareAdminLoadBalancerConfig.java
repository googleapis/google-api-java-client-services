...
public final class VmwareAdminLoadBalancerConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public VmwareAdminLoadBalancerConfig setF5Config(VmwareAdminF5BigIpConfig f5Config) {
   ...
   */
  public VmwareAdminLoadBalancerConfig setManualLbConfig(VmwareAdminManualLbConfig manualLbConfig) {
   ...
   */
  public VmwareAdminLoadBalancerConfig setMetalLbConfig(VmwareAdminMetalLbConfig metalLbConfig) {
   ...
   */
  public VmwareAdminLoadBalancerConfig setSeesawConfig(VmwareAdminSeesawConfig seesawConfig) {
   ...
   */
  public VmwareAdminLoadBalancerConfig setVipConfig(VmwareAdminVipConfig vipConfig) {
    this.vipConfig = vipConfig;
    return this;
  }

  @Override
  public VmwareAdminLoadBalancerConfig set(String fieldName, Object value) {
    return (VmwareAdminLoadBalancerConfig) super.set(fieldName, value);
  }

  @Override
  public VmwareAdminLoadBalancerConfig clone() {
