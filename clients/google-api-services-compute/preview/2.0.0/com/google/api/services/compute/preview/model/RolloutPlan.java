...
public final class RolloutPlan extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The location scope of the rollout plan. If not specified, the location scope is considered as
   * ZONAL.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private java.lang.String locationScope;
   ...
   */
  public RolloutPlan setDescription(java.lang.String description) {
   ...
   * The location scope of the rollout plan. If not specified, the location scope is considered as
   * ZONAL.
   * @param locationScope locationScope or {@code null} for none
   */
  public RolloutPlan setLocationScope(java.lang.String locationScope) {
   ...
   */
  public RolloutPlan setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RolloutPlanWave> getWaves() {
    return waves;
  }
   ...
   */
  public RolloutPlan setWaves(java.util.List<RolloutPlanWave> waves) {
    this.waves = waves;
    return this;
  }

  @Override
  public RolloutPlan set(String fieldName, Object value) {
    return (RolloutPlan) super.set(fieldName, value);
  }

  @Override
  public RolloutPlan clone() {
    return (RolloutPlan) super.clone();
  }
