...
public final class SecurityPolicyRuleMatcher extends com.google.api.client.json.GenericJson {
   ...
   * `evaluateThreatIntelligence` require a Cloud Armor Enterprise subscription and are not
   * supported in Edge Policies nor in Regional Policies. Expressions containing
   * `evaluatePreconfiguredExpr('sourceiplist-*')` require a Cloud Armor Enterprise subscription and
   * are only supported in Global Security Policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private Expr expr;
