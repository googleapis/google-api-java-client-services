...
public final class EscalateCaseRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public EscalateCaseRequest set(String fieldName, Object value) {
    return (EscalateCaseRequest) super.set(fieldName, value);
  }

  @Override
  public EscalateCaseRequest clone() {
    return (EscalateCaseRequest) super.clone();
  }
