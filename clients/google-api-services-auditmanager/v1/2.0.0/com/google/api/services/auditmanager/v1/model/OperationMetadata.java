...
public final class OperationMetadata extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. Whether you requested that the operation be cancelled. Operations that were
   * cancelled successfully have an Operation.error value with a status code Code.CANCELLED.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
