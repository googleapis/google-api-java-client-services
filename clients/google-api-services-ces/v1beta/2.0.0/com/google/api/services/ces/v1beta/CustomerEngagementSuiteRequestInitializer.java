...
/**
 * CustomerEngagementSuite request initializer for setting properties like key and userIp.
 *
 * <p>
 ...
 * @since 1.12
 */
public class CustomerEngagementSuiteRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public CustomerEngagementSuiteRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public CustomerEngagementSuiteRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeCustomerEngagementSuiteRequest((CustomerEngagementSuiteRequest<?>) request);
  }

  /**
   * Initializes CustomerEngagementSuite request.
   *
   * <p>
   ...
   */
  protected void initializeCustomerEngagementSuiteRequest(CustomerEngagementSuiteRequest<?> request) throws java.io.IOException {
  }
}
