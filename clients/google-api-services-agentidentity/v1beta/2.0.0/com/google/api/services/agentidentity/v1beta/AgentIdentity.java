...
package com.google.api.services.agentidentity.v1beta;

/**
 * Service definition for AgentIdentity (v1beta).
 *
 * <p>
 * 
 * </p>
...
public class AgentIdentity extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.Location.class);
      ...
      public class List extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class AccessSummaries {
        ...
        public class Get extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AccessSummary> {
           ...
           */
          protected Get(java.lang.String name) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.AccessSummary.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.ListAccessSummariesResponse> {

          private static final String REST_PATH = "v1beta/{+parent}/accessSummaries";
         ...
         *        projects/{project}/locations/{location}
          ...
          protected List(java.lang.String parent) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.ListAccessSummariesResponse.class);
      ...
      public class AuthProviders {
        ...
        public class Create extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {

          private static final String REST_PATH = "v1beta/{+parent}/authProviders";
         ...
         *        projects/{project}/locations/{location}
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.agentidentity.v1beta.model.AuthProvider content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Delete extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(AgentIdentity.this, "DELETE", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.DisableAuthProviderRequest}
         * @return the request
         */
        public Disable disable(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.DisableAuthProviderRequest content) throws java.io.IOException {
          Disable result = new Disable(name, content);
          initialize(result);
          return result;
        }

        public class Disable extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
           ...
           * @since 1.13
           */
          protected Disable(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.DisableAuthProviderRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         * @param name Required. Name of the resource Format:
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.EnableAuthProviderRequest}
         * @return the request
         */
        public Enable enable(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.EnableAuthProviderRequest content) throws java.io.IOException {
          Enable result = new Enable(name, content);
          initialize(result);
          return result;
        }

        public class Enable extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {

          private static final String REST_PATH = "v1beta/{+name}:enable";
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
           ...
           * @since 1.13
           */
          protected Enable(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.EnableAuthProviderRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Get extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {
           ...
           */
          protected Get(java.lang.String name) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class GetIamPolicy extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.Policy> {
         ...
         *        this field.
          ...
          protected GetIamPolicy(java.lang.String resource) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.Policy.class);
        ...
        public class List extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.ListAuthProvidersResponse> {
         ...
         *        projects/{project}/locations/{location}
           ...
           */
          protected List(java.lang.String parent) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.ListAuthProvidersResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.AuthProvider content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.AuthProvider content) {
            super(AgentIdentity.this, "PATCH", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Query extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.QueryAuthProvidersResponse> {

          private static final String REST_PATH = "v1beta/{+parent}/authProviders:query";
         ...
         *        projects/{project}/locations/{location}
          ...
          protected Query(java.lang.String parent) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.QueryAuthProvidersResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class QueryWorkloads extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.QueryWorkloadsResponse> {

          private static final String REST_PATH = "v1beta/{+name}:queryWorkloads";
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
          ...
          protected QueryWorkloads(java.lang.String name) {
            super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.QueryWorkloadsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.RevokeAuthorizationRequest}
         * @return the request
         */
        public RevokeAuthorization revokeAuthorization(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.RevokeAuthorizationRequest content) throws java.io.IOException {
          RevokeAuthorization result = new RevokeAuthorization(name, content);
          initialize(result);
          return result;
        }

        public class RevokeAuthorization extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.RevokeAuthorizationResponse> {

          private static final String REST_PATH = "v1beta/{+name}:revokeAuthorization";
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
           ...
           * @since 1.13
           */
          protected RevokeAuthorization(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.RevokeAuthorizationRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.RevokeAuthorizationResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.SetIamPolicyRequest}
         * @return the request
         */
        public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.agentidentity.v1beta.model.SetIamPolicyRequest content) throws java.io.IOException {
          SetIamPolicy result = new SetIamPolicy(resource, content);
          initialize(result);
          return result;
        }

        public class SetIamPolicy extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.Policy> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected SetIamPolicy(java.lang.String resource, com.google.api.services.agentidentity.v1beta.model.SetIamPolicyRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.Policy.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
         *        this field.
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.TestIamPermissionsRequest}
         * @return the request
         */
        public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.agentidentity.v1beta.model.TestIamPermissionsRequest content) throws java.io.IOException {
          TestIamPermissions result = new TestIamPermissions(resource, content);
          initialize(result);
          return result;
        }

        public class TestIamPermissions extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.TestIamPermissionsResponse> {
         ...
         *        this field.
           ...
           * @since 1.13
           */
          protected TestIamPermissions(java.lang.String resource, com.google.api.services.agentidentity.v1beta.model.TestIamPermissionsRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.TestIamPermissionsResponse.class);
            this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                  "Parameter resource must conform to the pattern " +
         ...
         * @param name Required. Name of the resource Format:
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
         * @param content the {@link com.google.api.services.agentidentity.v1beta.model.UndeleteAuthProviderRequest}
         * @return the request
         */
        public Undelete undelete(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.UndeleteAuthProviderRequest content) throws java.io.IOException {
          Undelete result = new Undelete(name, content);
          initialize(result);
          return result;
        }

        public class Undelete extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.AuthProvider> {
         ...
         *        projects/{project}/locations/{location}/authProviders/{auth_provider}
           ...
           * @since 1.13
           */
          protected Undelete(java.lang.String name, com.google.api.services.agentidentity.v1beta.model.UndeleteAuthProviderRequest content) {
            super(AgentIdentity.this, "POST", REST_PATH, content, com.google.api.services.agentidentity.v1beta.model.AuthProvider.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Authorizations {
          ...
          public class Get extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.Authorization> {
             ...
             */
            protected Get(java.lang.String name) {
              super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.Authorization.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends AgentIdentityRequest<com.google.api.services.agentidentity.v1beta.model.ListAuthorizationsResponse> {

            private static final String REST_PATH = "v1beta/{+parent}/authorizations";
           ...
           *        projects/{project}/locations/{location}/authProviders/{auth_provider}
             ...
             */
            protected List(java.lang.String parent) {
              super(AgentIdentity.this, "GET", REST_PATH, null, com.google.api.services.agentidentity.v1beta.model.ListAuthorizationsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
