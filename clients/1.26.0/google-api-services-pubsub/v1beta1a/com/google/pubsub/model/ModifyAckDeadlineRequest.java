...
public final class ModifyAckDeadlineRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The new ack deadline with respect to the time this request was sent to the Pub/Sub system. Must
   * be >= 0. For example, if the value is 10, the new ack deadline will expire 10 seconds after the
   * ModifyAckDeadline call was made. Specifying zero may immediately make the message available for
   ...
   */
  public ModifyAckDeadlineRequest setAckId(java.lang.String ackId) {
    this.ackId = ackId;
    return this;
  }
   ...
   */
  public ModifyAckDeadlineRequest setSubscription(java.lang.String subscription) {
