...
public class CloudSupport extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Cases {
    ...
    public class Attachments {
      ...
      public class Get extends CloudSupportRequest<com.google.api.services.cloudsupport.v2.model.Attachment> {
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudSupport.this, "GET", REST_PATH, null, com.google.api.services.cloudsupport.v2.model.Attachment.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class Comments {
      ...
      public class Get extends CloudSupportRequest<com.google.api.services.cloudsupport.v2.model.Comment> {
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudSupport.this, "GET", REST_PATH, null, com.google.api.services.cloudsupport.v2.model.Comment.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
  ...
  public class Media {
     ...
     * "https://cloudsupport.googleapis.com/upload/v2/$case/attachments?attachment.filename=uploaded_via
     * _curl.txt" ``` Python: ```python import googleapiclient.discovery api_version = "v2"
    ...
    public class Upload extends CloudSupportRequest<com.google.api.services.cloudsupport.v2.model.Attachment> {
       ...
       * @"./example_file.txt" \ "https://cloudsupport.googleapis.com/upload/v2/$case/attachments?attach
       * ment.filename=uploaded_via_curl.txt" ``` Python: ```python import googleapiclient.discovery
