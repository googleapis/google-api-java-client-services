...
public final class InitialAccessBrokerFindingDetail extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. Reference to the match score of the IAB finding. This is a float value between 0 and
   * 1 calculated by the matching engine based on the similarity of the document and the user
   ...
   */
  public InitialAccessBrokerFindingDetail setMatchScore(java.lang.Float matchScore) {
   ...
   */
  public InitialAccessBrokerFindingDetail setSeverity(java.lang.String severity) {
    this.severity = severity;
    return this;
  }

  @Override
  public InitialAccessBrokerFindingDetail set(String fieldName, Object value) {
    return (InitialAccessBrokerFindingDetail) super.set(fieldName, value);
  }

  @Override
  public InitialAccessBrokerFindingDetail clone() {
    return (InitialAccessBrokerFindingDetail) super.clone();
  }
