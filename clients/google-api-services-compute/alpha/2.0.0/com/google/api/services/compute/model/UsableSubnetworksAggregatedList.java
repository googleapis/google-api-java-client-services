...
public final class UsableSubnetworksAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<UsableSubnetwork> items;
   ...
   */
  public UsableSubnetworksAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<UsableSubnetwork> getItems() {
    return items;
  }
   ...
   */
  public UsableSubnetworksAggregatedList setItems(java.util.List<UsableSubnetwork> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public UsableSubnetworksAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public UsableSubnetworksAggregatedList set(String fieldName, Object value) {
    return (UsableSubnetworksAggregatedList) super.set(fieldName, value);
  }

  @Override
  public UsableSubnetworksAggregatedList clone() {
    return (UsableSubnetworksAggregatedList) super.clone();
  }
