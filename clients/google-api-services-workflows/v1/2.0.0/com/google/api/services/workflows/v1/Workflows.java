...
public class Workflows extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.Location.class);
      ...
      public class List extends WorkflowsRequest<com.google.api.services.workflows.v1.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Delete extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(Workflows.this, "DELETE", REST_PATH, null, com.google.api.services.workflows.v1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends WorkflowsRequest<com.google.api.services.workflows.v1.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class WorkflowsOperations {
         ...
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.workflows.v1.model.Workflow content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Operation> {
         ...
         *        projects/{project}/locations/{location}
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.workflows.v1.model.Workflow content) {
            super(Workflows.this, "POST", REST_PATH, content, com.google.api.services.workflows.v1.model.Operation.class);
        ...
        public class Delete extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/workflows/{workflow}
           ...
           */
          protected Delete(java.lang.String name) {
            super(Workflows.this, "DELETE", REST_PATH, null, com.google.api.services.workflows.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Workflow> {
         ...
         *        projects/{project}/locations/{location}/workflows/{workflow}
           ...
           */
          protected Get(java.lang.String name) {
            super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.Workflow.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         projects/{project}/locations/{location}/workflows/{workflow}
          ...
          /**
           * Optional. The revision of the workflow to retrieve. If the revision_id is empty, the
           * latest revision is retrieved. The format is "000001-a4d", where the first six
           * characters define the zero-padded decimal revision number. They are followed by a
           * hyphen and three hexadecimal characters.
           */
          @com.google.api.client.util.Key
          private java.lang.String revisionId;

          /** Optional. The revision of the workflow to retrieve. If the revision_id is empty, the latest
         revision is retrieved. The format is "000001-a4d", where the first six characters define the zero-
         padded decimal revision number. They are followed by a hyphen and three hexadecimal characters.
           */
        ...
        public class List extends WorkflowsRequest<com.google.api.services.workflows.v1.model.ListWorkflowsResponse> {
         ...
         *        projects/{project}/locations/{location}
          ...
          protected List(java.lang.String parent) {
            super(Workflows.this, "GET", REST_PATH, null, com.google.api.services.workflows.v1.model.ListWorkflowsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         *
         * @param name Required. Workflow from which the revisions should be listed. Format:
         *        projects/{project}/locations/{location}/workflows/{workflow}
         * @return the request
         */
         ...
         *        projects/{project}/locations/{location}/workflows/{workflow}
         ...
         projects/{project}/locations/{location}/workflows/{workflow}
           ...
           * default value of 20 is used. The maximum permitted value is 100 and values greater than
           * 100 coerced down to 100.
           */
          @com.google.api.client.util.Key
          private java.lang.Integer pageSize;

          /** The maximum number of revisions to return per page. If a value is not specified, a default value of
         20 is used. The maximum permitted value is 100 and values greater than 100 coerced down to 100.
           */
          public java.lang.Integer getPageSize() {
            return pageSize;
          }
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.workflows.v1.model.Workflow content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends WorkflowsRequest<com.google.api.services.workflows.v1.model.Operation> {
         ...
         *        projects/{project}/locations/{location}/workflows/{workflow}
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.workflows.v1.model.Workflow content) {
            super(Workflows.this, "PATCH", REST_PATH, content, com.google.api.services.workflows.v1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
