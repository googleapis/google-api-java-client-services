...
/**
 * Model definition for SnapshotAggregatedList.
 *
...
public final class SnapshotAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, SnapshotsScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#snapshotAggregatedList for
   ...
   */
  public SnapshotAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public SnapshotAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, SnapshotsScopedList> getItems() {
    return items;
  }
   ...
   */
  public SnapshotAggregatedList setItems(java.util.Map<String, SnapshotsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public SnapshotAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public SnapshotAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public SnapshotAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public SnapshotAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public SnapshotAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SnapshotAggregatedList set(String fieldName, Object value) {
    return (SnapshotAggregatedList) super.set(fieldName, value);
  }

  @Override
  public SnapshotAggregatedList clone() {
    return (SnapshotAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for SnapshotAggregatedListWarningData.
     */
