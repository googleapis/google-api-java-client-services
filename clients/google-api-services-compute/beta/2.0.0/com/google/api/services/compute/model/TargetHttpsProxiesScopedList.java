...
public final class TargetHttpsProxiesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<TargetHttpsProxy> targetHttpsProxies;
   ...
   */
  public java.util.List<TargetHttpsProxy> getTargetHttpsProxies() {
    return targetHttpsProxies;
  }

  /**
   * A list of TargetHttpsProxies contained in this scope.
   * @param targetHttpsProxies targetHttpsProxies or {@code null} for none
   */
  public TargetHttpsProxiesScopedList setTargetHttpsProxies(java.util.List<TargetHttpsProxy> targetHttpsProxies) {
   ...
   */
  public TargetHttpsProxiesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetHttpsProxiesScopedList set(String fieldName, Object value) {
    return (TargetHttpsProxiesScopedList) super.set(fieldName, value);
  }

  @Override
  public TargetHttpsProxiesScopedList clone() {
    return (TargetHttpsProxiesScopedList) super.clone();
  }
