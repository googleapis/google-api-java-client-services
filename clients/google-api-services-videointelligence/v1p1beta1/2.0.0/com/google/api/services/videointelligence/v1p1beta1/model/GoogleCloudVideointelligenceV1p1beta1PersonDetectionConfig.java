...
public final class GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig setIncludeAttributes(java.lang.Boolean includeAttributes) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig setIncludeBoundingBoxes(java.lang.Boolean includeBoundingBoxes) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig setIncludePoseLandmarks(java.lang.Boolean includePoseLandmarks) {
    this.includePoseLandmarks = includePoseLandmarks;
    return this;
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig set(String fieldName, Object value) {
    return (GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig clone() {
    return (GoogleCloudVideointelligenceV1p1beta1PersonDetectionConfig) super.clone();
  }
