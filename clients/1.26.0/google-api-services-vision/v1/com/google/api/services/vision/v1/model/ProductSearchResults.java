...
public final class ProductSearchResults extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GroupedResult> getProductGroupedResults() {
   ...
   */
  public ProductSearchResults setProductGroupedResults(java.util.List<GroupedResult> productGroupedResults) {
   ...
   */
  public ProductSearchResults setResults(java.util.List<Result> results) {
    this.results = results;
    return this;
  }

  @Override
  public ProductSearchResults set(String fieldName, Object value) {
    return (ProductSearchResults) super.set(fieldName, value);
  }
