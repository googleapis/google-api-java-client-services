...
public final class TargetTcpProxyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetTcpProxy> items;

  static {
    // hack to force ProGuard to consider TargetTcpProxy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetTcpProxy.class);
  }
   ...
   */
  public TargetTcpProxyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetTcpProxy> getItems() {
    return items;
  }
   ...
   */
  public TargetTcpProxyList setItems(java.util.List<TargetTcpProxy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetTcpProxyList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetTcpProxyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetTcpProxyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetTcpProxyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetTcpProxyList set(String fieldName, Object value) {
    return (TargetTcpProxyList) super.set(fieldName, value);
  }

  @Override
  public TargetTcpProxyList clone() {
    return (TargetTcpProxyList) super.clone();
  }
