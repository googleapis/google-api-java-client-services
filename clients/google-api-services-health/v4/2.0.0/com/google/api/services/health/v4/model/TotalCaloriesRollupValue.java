...
public final class TotalCaloriesRollupValue extends com.google.api.client.json.GenericJson {
   ...
   */
  public TotalCaloriesRollupValue setKcalSum(java.lang.Double kcalSum) {
    this.kcalSum = kcalSum;
    return this;
  }

  @Override
  public TotalCaloriesRollupValue set(String fieldName, Object value) {
    return (TotalCaloriesRollupValue) super.set(fieldName, value);
  }

  @Override
  public TotalCaloriesRollupValue clone() {
    return (TotalCaloriesRollupValue) super.clone();
  }
