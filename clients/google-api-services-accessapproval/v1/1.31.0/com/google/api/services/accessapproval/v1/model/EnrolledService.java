...
public final class EnrolledService extends com.google.api.client.json.GenericJson {
   ...
   * Google Kubernetes Engine * Persistent Disk * Speaker ID Note: These values are supported as
   * input for legacy purposes, but will not be returned from the API. * all * ga-only *
   ...
   * speakerid.googleapis.com * storage.googleapis.com Calls to UpdateAccessApprovalSettings using
