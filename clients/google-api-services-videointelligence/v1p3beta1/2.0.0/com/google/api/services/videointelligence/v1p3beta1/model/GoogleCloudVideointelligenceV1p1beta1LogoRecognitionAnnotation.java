...
public final class GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation setEntity(GoogleCloudVideointelligenceV1p1beta1Entity entity) {
    this.entity = entity;
    return this;
  }
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation setSegments(java.util.List<GoogleCloudVideointelligenceV1p1beta1VideoSegment> segments) {
   ...
   */
  public GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation setTracks(java.util.List<GoogleCloudVideointelligenceV1p1beta1Track> tracks) {
    this.tracks = tracks;
    return this;
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation set(String fieldName, Object value) {
    return (GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation clone() {
    return (GoogleCloudVideointelligenceV1p1beta1LogoRecognitionAnnotation) super.clone();
  }
