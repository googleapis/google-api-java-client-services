...
/**
 * Model definition for InstanceTemplatesScopedList.
 *
...
public final class InstanceTemplatesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<InstanceTemplate> instanceTemplates;
   ...
   */
  public java.util.List<InstanceTemplate> getInstanceTemplates() {
   ...
   * [Output Only] A list of instance templates that are contained within the specified project and
   * zone.
   * @param instanceTemplates instanceTemplates or {@code null} for none
   */
  public InstanceTemplatesScopedList setInstanceTemplates(java.util.List<InstanceTemplate> instanceTemplates) {
   ...
   */
  public InstanceTemplatesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceTemplatesScopedList set(String fieldName, Object value) {
    return (InstanceTemplatesScopedList) super.set(fieldName, value);
  }

  @Override
  public InstanceTemplatesScopedList clone() {
    return (InstanceTemplatesScopedList) super.clone();
  }

  /**
   * [Output Only] An informational warning that replaces the list of instance templates when the list
   * is empty.
   */
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for InstanceTemplatesScopedListWarningData.
     */
