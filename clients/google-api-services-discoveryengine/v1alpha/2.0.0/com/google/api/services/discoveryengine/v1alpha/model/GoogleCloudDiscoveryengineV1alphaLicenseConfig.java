...
public final class GoogleCloudDiscoveryengineV1alphaLicenseConfig extends com.google.api.client.json.GenericJson {
  ...
  private GoogleCloudDiscoveryengineV1alphaAlertPolicyResourceConfig alertPolicyResourceConfig;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1alphaLicenseConfigScheduledUpdate scheduledUpdate;
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaAlertPolicyResourceConfig getAlertPolicyResourceConfig() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setAlertPolicyResourceConfig(GoogleCloudDiscoveryengineV1alphaAlertPolicyResourceConfig alertPolicyResourceConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setEndDate(GoogleTypeDate endDate) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setLicenseCount(java.lang.Long licenseCount) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfigScheduledUpdate getScheduledUpdate() {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setScheduledUpdate(GoogleCloudDiscoveryengineV1alphaLicenseConfigScheduledUpdate scheduledUpdate) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setStartDate(GoogleTypeDate startDate) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setState(java.lang.String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setSubscriptionTerm(java.lang.String subscriptionTerm) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig setSubscriptionTier(java.lang.String subscriptionTier) {
    this.subscriptionTier = subscriptionTier;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaLicenseConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaLicenseConfig clone() {
    return (GoogleCloudDiscoveryengineV1alphaLicenseConfig) super.clone();
  }
