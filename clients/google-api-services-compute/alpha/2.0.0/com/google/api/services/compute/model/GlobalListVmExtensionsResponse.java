...
/**
 * Model definition for GlobalListVmExtensionsResponse.
 *
...
public final class GlobalListVmExtensionsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GlobalVmExtension> items;
   ...
   */
  public GlobalListVmExtensionsResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public GlobalListVmExtensionsResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GlobalVmExtension> getItems() {
    return items;
  }
   ...
   */
  public GlobalListVmExtensionsResponse setItems(java.util.List<GlobalVmExtension> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public GlobalListVmExtensionsResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public GlobalListVmExtensionsResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public GlobalListVmExtensionsResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public GlobalListVmExtensionsResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public GlobalListVmExtensionsResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public GlobalListVmExtensionsResponse set(String fieldName, Object value) {
    return (GlobalListVmExtensionsResponse) super.set(fieldName, value);
  }

  @Override
  public GlobalListVmExtensionsResponse clone() {
    return (GlobalListVmExtensionsResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for GlobalListVmExtensionsResponseWarningData.
     */
