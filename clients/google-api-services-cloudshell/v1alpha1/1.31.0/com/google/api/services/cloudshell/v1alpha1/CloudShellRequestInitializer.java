 ...
 * <pre>
  public static class MyRequestInitializer extends CloudShellRequestInitializer {
    ...
    {@literal @}Override
    public void initializeCloudShellRequest(CloudShellRequest{@literal <}?{@literal >} request)
        throws IOException {
      // custom logic
    }
  }
 ...
 * @since 1.12
 */
public class CloudShellRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {

  public CloudShellRequestInitializer() {
    super();
  }
   ...
   */
  public CloudShellRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public CloudShellRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeCloudShellRequest((CloudShellRequest<?>) request);
  }
   ...
   */
  protected void initializeCloudShellRequest(CloudShellRequest<?> request) throws java.io.IOException {
  }
}
