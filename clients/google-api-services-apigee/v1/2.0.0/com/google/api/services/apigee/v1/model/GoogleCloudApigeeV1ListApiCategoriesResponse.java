...
public final class GoogleCloudApigeeV1ListApiCategoriesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GoogleCloudApigeeV1ApiCategoryData> data;

  static {
    // hack to force ProGuard to consider GoogleCloudApigeeV1ApiCategoryData used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudApigeeV1ApiCategoryData.class);
  }
   ...
   */
  public java.util.List<GoogleCloudApigeeV1ApiCategoryData> getData() {
    return data;
  }
   ...
   */
  public GoogleCloudApigeeV1ListApiCategoriesResponse setData(java.util.List<GoogleCloudApigeeV1ApiCategoryData> data) {
    this.data = data;
    return this;
  }
