...
public final class GoogleDevtoolsCloudbuildV1Results extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleDevtoolsCloudbuildV1BuiltImage> images;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleDevtoolsCloudbuildV1UploadedMavenArtifact> mavenArtifacts;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleDevtoolsCloudbuildV1UploadedNpmPackage> npmPackages;
   ...
   */
  public GoogleDevtoolsCloudbuildV1Results setBuildStepImages(java.util.List<java.lang.String> buildStepImages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleDevtoolsCloudbuildV1BuiltImage> getImages() {
    return images;
  }
   ...
   */
  public GoogleDevtoolsCloudbuildV1Results setImages(java.util.List<GoogleDevtoolsCloudbuildV1BuiltImage> images) {
    this.images = images;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleDevtoolsCloudbuildV1UploadedMavenArtifact> getMavenArtifacts() {
   ...
   */
  public GoogleDevtoolsCloudbuildV1Results setMavenArtifacts(java.util.List<GoogleDevtoolsCloudbuildV1UploadedMavenArtifact> mavenArtifacts) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleDevtoolsCloudbuildV1UploadedNpmPackage> getNpmPackages() {
    return npmPackages;
  }
   ...
   */
  public GoogleDevtoolsCloudbuildV1Results setNpmPackages(java.util.List<GoogleDevtoolsCloudbuildV1UploadedNpmPackage> npmPackages) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleDevtoolsCloudbuildV1UploadedPythonPackage> getPythonPackages() {
