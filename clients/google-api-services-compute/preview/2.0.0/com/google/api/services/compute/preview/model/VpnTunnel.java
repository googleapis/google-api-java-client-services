...
public final class VpnTunnel extends com.google.api.client.json.GenericJson {
   ...
   * - NEGOTIATION_FAILURE: Handshake failed.    - DEPROVISIONING: Resources are being deallocated
   * for the VPN    tunnel.     - FAILED: Tunnel creation has failed and the tunnel is not    ready
   * to be used.     - NO_INCOMING_PACKETS: No incoming packets from    peer.     - REJECTED: Tunnel
   ...
   * STOPPED: Tunnel is stopped due to its Forwarding Rules being deleted    for Classic VPN tunnels
   * or the project is in frozen state.    - PEER_IDENTITY_MISMATCH: Peer identity does not match
   * peer IP,    probably behind NAT.     - TS_NARROWING_NOT_ALLOWED: Traffic selector    narrowing
