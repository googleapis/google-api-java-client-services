...
public final class AutoscalersScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Autoscaler> autoscalers;
   ...
   */
  public java.util.List<Autoscaler> getAutoscalers() {
    return autoscalers;
  }

  /**
   * [Output Only] A list of autoscalers contained in this scope.
   * @param autoscalers autoscalers or {@code null} for none
   */
  public AutoscalersScopedList setAutoscalers(java.util.List<Autoscaler> autoscalers) {
   ...
   */
  public AutoscalersScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AutoscalersScopedList set(String fieldName, Object value) {
    return (AutoscalersScopedList) super.set(fieldName, value);
  }

  @Override
  public AutoscalersScopedList clone() {
    return (AutoscalersScopedList) super.clone();
  }
