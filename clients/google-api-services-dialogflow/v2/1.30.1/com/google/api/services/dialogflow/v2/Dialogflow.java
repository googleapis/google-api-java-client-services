...
public class Dialogflow extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
     ...
     * @return the request
     */
    public SetAgent setAgent(java.lang.String parent, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Agent content) throws java.io.IOException {
      SetAgent result = new SetAgent(parent, content);
      initialize(result);
      return result;
    }

    public class SetAgent extends DialogflowRequest<com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Agent> {
    ...
    Format: `projects/`.
       ...
       * @since 1.13
       */
      protected SetAgent(java.lang.String parent, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Agent content) {
    ...
    public class Agent {
      ...
      public class GetFulfillment extends DialogflowRequest<com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment> {
      ...
      Format: `projects//agent/fulfillment`.
        ...
        protected GetFulfillment(java.lang.String name) {
          super(Dialogflow.this, "GET", REST_PATH, null, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment.class);
      ...
      public class GetValidationResult extends DialogflowRequest<com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2ValidationResult> {
      ...
      Format: `projects/`.
        ...
        protected GetValidationResult(java.lang.String parent) {
          super(Dialogflow.this, "GET", REST_PATH, null, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2ValidationResult.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      Format: `projects//agent/fulfillment`.
       * @param content the {@link com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment}
       * @return the request
       */
      public UpdateFulfillment updateFulfillment(java.lang.String name, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment content) throws java.io.IOException {
        UpdateFulfillment result = new UpdateFulfillment(name, content);
        initialize(result);
        return result;
      }

      public class UpdateFulfillment extends DialogflowRequest<com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment> {
      ...
      Format: `projects//agent/fulfillment`.
         ...
         * @since 1.13
         */
        protected UpdateFulfillment(java.lang.String name, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment content) {
          super(Dialogflow.this, "PATCH", REST_PATH, content, com.google.api.services.dialogflow.v2.model.GoogleCloudDialogflowV2Fulfillment.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Sessions {
        ...
        public class Contexts {
          ...
          The following context names are reserved
           *        for internal use by Dialogflow.
          You should not use these contexts or create contexts with
           *        these names:
          * `__system_counters__`
          * `*_id_dialog_context`
          * `*_dialog_params_size`
