  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Clusters {
         ...
         * operation.
         *
         * @param name Required. The name (project, location, cluster) of the cluster to complete upgrade. Specified in the
         *        format `projects/locations/clusters`.
         * @param content the {@link com.google.api.services.container.model.CompleteControlPlaneUpgradeRequest}
         * @return the request
         */
        public CompleteControlPlaneUpgrade completeControlPlaneUpgrade(java.lang.String name, com.google.api.services.container.model.CompleteControlPlaneUpgradeRequest content) throws java.io.IOException {
          CompleteControlPlaneUpgrade result = new CompleteControlPlaneUpgrade(name, content);
          initialize(result);
          return result;
        }

        public class CompleteControlPlaneUpgrade extends ContainerRequest<com.google.api.services.container.model.Operation> {

          private static final String REST_PATH = "v1/{+name}:completeControlPlaneUpgrade";
         ...
         *        format `projects/locations/clusters`.
           ...
           * @since 1.13
           */
          protected CompleteControlPlaneUpgrade(java.lang.String name, com.google.api.services.container.model.CompleteControlPlaneUpgradeRequest content) {
          ...
          /**
           * Required. The name (project, location, cluster) of the cluster to complete upgrade.
