...
/**
 * Service definition for CloudBuild (v1alpha2).
 *
 * <p>
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Operations {
         ...
         * @param content the {@link com.google.api.services.cloudbuild.v1alpha2.model.CancelOperationRequest}
         * @return the request
         */
        public Cancel cancel(java.lang.String name, com.google.api.services.cloudbuild.v1alpha2.model.CancelOperationRequest content) throws java.io.IOException {
          Cancel result = new Cancel(name, content);
          initialize(result);
          return result;
        }

        public class Cancel extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.cloudbuild.v1alpha2.model.CancelOperationRequest content) {
            super(CloudBuild.this, "POST", REST_PATH, content, com.google.api.services.cloudbuild.v1alpha2.model.Empty.class);
        ...
        public class Get extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.Operation> {
          ...
          protected Get(java.lang.String name) {
            super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1alpha2.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.ListOperationsResponse> {
          ...
          protected List(java.lang.String name) {
            super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1alpha2.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
    ...
    public class WorkerPools {
       ...
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool> {
      ...
      Format: projects/{project}
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool content) {
          super(CloudBuild.this, "POST", REST_PATH, content, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool.class);
      ...
      public class Delete extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.Empty> {
       ...
       *        projects/{project}/workerPools/{workerPool}
        ...
        protected Delete(java.lang.String name) {
          super(CloudBuild.this, "DELETE", REST_PATH, null, com.google.api.services.cloudbuild.v1alpha2.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool> {
       ...
       *        projects/{project}/workerPools/{workerPool}
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.ListWorkerPoolsResponse> {
      ...
      Format: projects/{project}
        ...
        protected List(java.lang.String parent) {
          super(CloudBuild.this, "GET", REST_PATH, null, com.google.api.services.cloudbuild.v1alpha2.model.ListWorkerPoolsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudBuildRequest<com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool> {
      ...
      request.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool content) {
          super(CloudBuild.this, "PATCH", REST_PATH, content, com.google.api.services.cloudbuild.v1alpha2.model.WorkerPool.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
