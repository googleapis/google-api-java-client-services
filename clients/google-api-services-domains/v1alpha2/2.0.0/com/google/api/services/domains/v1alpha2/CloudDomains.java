  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Registrations {
         ...
         *        `projects/locations/registrations`.
         * @param content the {@link com.google.api.services.domains.v1alpha2.model.InitiatePushTransferRequest}
         * @return the request
         */
        public InitiatePushTransfer initiatePushTransfer(java.lang.String registration, com.google.api.services.domains.v1alpha2.model.InitiatePushTransferRequest content) throws java.io.IOException {
          InitiatePushTransfer result = new InitiatePushTransfer(registration, content);
          initialize(result);
          return result;
        }

        public class InitiatePushTransfer extends CloudDomainsRequest<com.google.api.services.domains.v1alpha2.model.Operation> {

          private static final String REST_PATH = "v1alpha2/{+registration}:initiatePushTransfer";
         ...
         *        `projects/locations/registrations`.
           ...
           * @since 1.13
           */
          protected InitiatePushTransfer(java.lang.String registration, com.google.api.services.domains.v1alpha2.model.InitiatePushTransferRequest content) {
            super(CloudDomains.this, "POST", REST_PATH, content, com.google.api.services.domains.v1alpha2.model.Operation.class);
            this.registration = com.google.api.client.util.Preconditions.checkNotNull(registration, "Required parameter registration must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(REGISTRATION_PATTERN.matcher(registration).matches(),
         ...
         *        `projects/locations/registrations`.
         * @param content the {@link com.google.api.services.domains.v1alpha2.model.RenewDomainRequest}
         * @return the request
         */
        public RenewDomain renewDomain(java.lang.String registration, com.google.api.services.domains.v1alpha2.model.RenewDomainRequest content) throws java.io.IOException {
          RenewDomain result = new RenewDomain(registration, content);
          initialize(result);
          return result;
        }

        public class RenewDomain extends CloudDomainsRequest<com.google.api.services.domains.v1alpha2.model.Operation> {

          private static final String REST_PATH = "v1alpha2/{+registration}:renewDomain";
         ...
         *        `projects/locations/registrations`.
           ...
           * @since 1.13
           */
          protected RenewDomain(java.lang.String registration, com.google.api.services.domains.v1alpha2.model.RenewDomainRequest content) {
            super(CloudDomains.this, "POST", REST_PATH, content, com.google.api.services.domains.v1alpha2.model.Operation.class);
            this.registration = com.google.api.client.util.Preconditions.checkNotNull(registration, "Required parameter registration must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(REGISTRATION_PATTERN.matcher(registration).matches(),
        ...
        public class RetrieveGoogleDomainsDnsRecords extends CloudDomainsRequest<com.google.api.services.domains.v1alpha2.model.RetrieveGoogleDomainsDnsRecordsResponse> {

          private static final String REST_PATH = "v1alpha2/{+registration}:retrieveGoogleDomainsDnsRecords";
         ...
         *        retrieving, in the format `projects/locations/registrations`.
          ...
          protected RetrieveGoogleDomainsDnsRecords(java.lang.String registration) {
            super(CloudDomains.this, "GET", REST_PATH, null, com.google.api.services.domains.v1alpha2.model.RetrieveGoogleDomainsDnsRecordsResponse.class);
            this.registration = com.google.api.client.util.Preconditions.checkNotNull(registration, "Required parameter registration must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(REGISTRATION_PATTERN.matcher(registration).matches(),
                  "Parameter registration must conform to the pattern " +
        ...
        public class RetrieveGoogleDomainsForwardingConfig extends CloudDomainsRequest<com.google.api.services.domains.v1alpha2.model.RetrieveGoogleDomainsForwardingConfigResponse> {

          private static final String REST_PATH = "v1alpha2/{+registration}:retrieveGoogleDomainsForwardingConfig";
         ...
         *        being retrieved, in the format `projects/locations/registrations`.
          ...
          protected RetrieveGoogleDomainsForwardingConfig(java.lang.String registration) {
            super(CloudDomains.this, "GET", REST_PATH, null, com.google.api.services.domains.v1alpha2.model.RetrieveGoogleDomainsForwardingConfigResponse.class);
            this.registration = com.google.api.client.util.Preconditions.checkNotNull(registration, "Required parameter registration must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(REGISTRATION_PATTERN.matcher(registration).matches(),
                  "Parameter registration must conform to the pattern " +
