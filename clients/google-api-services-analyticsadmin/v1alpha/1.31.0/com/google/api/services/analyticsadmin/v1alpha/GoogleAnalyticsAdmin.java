...
public class GoogleAnalyticsAdmin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Properties {
    ...
    public class AndroidAppDataStreams {
      ...
      /**
       * Creates an Android app stream with the specified location and attributes. Note that an Android
       * app stream must be linked to a Firebase app to receive traffic. To create a working app stream,
       * make sure your property is linked to a Firebase project. Then, use the Firebase API to create a
       * Firebase app, which will also create an appropriate data stream in Analytics (may take up to 24
       * hours).
       *
    ...
    public class IosAppDataStreams {
      ...
      /**
       * Creates an iOS app stream with the specified location and attributes. Note that an iOS app stream
       * must be linked to a Firebase app to receive traffic. To create a working app stream, make sure
       * your property is linked to a Firebase project. Then, use the Firebase API to create a Firebase
       * app, which will also create an appropriate data stream in Analytics (may take up to 24 hours).
       *
      ...
      public class Create extends GoogleAnalyticsAdminRequest<com.google.api.services.analyticsadmin.v1alpha.model.GoogleAnalyticsAdminV1alphaIosAppDataStream> {
        ...
        /**
         * Creates an iOS app stream with the specified location and attributes. Note that an iOS app
         * stream must be linked to a Firebase app to receive traffic. To create a working app stream,
         * make sure your property is linked to a Firebase project. Then, use the Firebase API to create a
         * Firebase app, which will also create an appropriate data stream in Analytics (may take up to 24
         * hours).
         *
