# Migrate to Virtual Machines API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1alpha1-rev20221126-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-vmmigration:v1alpha1-rev20221126-2.0.0'
}
```
