...
public final class NodeTypeAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, NodeTypesScopedList> items;

  /**
   * Output only. [Output Only] Type of resource.Alwayscompute#nodeTypeAggregatedList for aggregated
   * lists of node types.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NodeTypeAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NodeTypesScopedList> getItems() {
    return items;
  }
   ...
   */
  public NodeTypeAggregatedList setItems(java.util.Map<String, NodeTypesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NodeTypeAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public NodeTypeAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NodeTypeAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public NodeTypeAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public NodeTypeAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NodeTypeAggregatedList set(String fieldName, Object value) {
    return (NodeTypeAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NodeTypeAggregatedList clone() {
    return (NodeTypeAggregatedList) super.clone();
  }
