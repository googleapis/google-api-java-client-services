  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Catalogs {
        ...
        public class GetConversationalSearchCustomizationConfig extends CloudRetailRequest<com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig> {

          private static final String REST_PATH = "v2/{+name}/conversationalSearchCustomizationConfig";
         ...
         *        projects/{project}/locations/{location}/catalogs/{catalog}
          ...
          protected GetConversationalSearchCustomizationConfig(java.lang.String name) {
            super(CloudRetail.this, "GET", REST_PATH, null, com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        projects/{project}/locations/{location}/catalogs/{catalog}
         * @param content the {@link com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig}
         * @return the request
         */
        public UpdateConversationalSearchCustomizationConfig updateConversationalSearchCustomizationConfig(java.lang.String catalog, com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig content) throws java.io.IOException {
          UpdateConversationalSearchCustomizationConfig result = new UpdateConversationalSearchCustomizationConfig(catalog, content);
          initialize(result);
          return result;
        }

        public class UpdateConversationalSearchCustomizationConfig extends CloudRetailRequest<com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig> {

          private static final String REST_PATH = "v2/{+catalog}/conversationalSearchCustomizationConfig";
         ...
         *        projects/{project}/locations/{location}/catalogs/{catalog}
           ...
           * @since 1.13
           */
          protected UpdateConversationalSearchCustomizationConfig(java.lang.String catalog, com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig content) {
            super(CloudRetail.this, "PATCH", REST_PATH, content, com.google.api.services.retail.v2.model.GoogleCloudRetailV2ConversationalSearchCustomizationConfig.class);
            this.catalog = com.google.api.client.util.Preconditions.checkNotNull(catalog, "Required parameter catalog must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(CATALOG_PATTERN.matcher(catalog).matches(),
                  "Parameter catalog must conform to the pattern " +
