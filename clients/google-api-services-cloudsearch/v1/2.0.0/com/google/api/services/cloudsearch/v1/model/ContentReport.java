...
/**
 * Model definition for ContentReport.
 *
...
public final class ContentReport extends com.google.api.client.json.GenericJson {
   ...
   */
  public ContentReport setReportCreateTimestamp(String reportCreateTimestamp) {
   ...
   */
  public ContentReport setReportJustification(ContentReportJustification reportJustification) {
   ...
   */
  public ContentReport setReportType(AppsDynamiteSharedContentReportType reportType) {
   ...
   */
  public ContentReport setReporterUserId(UserId reporterUserId) {
   ...
   */
  public ContentReport setRevisionCreateTimestamp(String revisionCreateTimestamp) {
    this.revisionCreateTimestamp = revisionCreateTimestamp;
    return this;
  }

  @Override
  public ContentReport set(String fieldName, Object value) {
    return (ContentReport) super.set(fieldName, value);
  }
