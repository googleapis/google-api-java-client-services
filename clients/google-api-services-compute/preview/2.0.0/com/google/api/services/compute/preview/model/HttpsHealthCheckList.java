...
public final class HttpsHealthCheckList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HttpsHealthCheck> items;

  static {
    // hack to force ProGuard to consider HttpsHealthCheck used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(HttpsHealthCheck.class);
  }
   ...
   */
  public HttpsHealthCheckList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<HttpsHealthCheck> getItems() {
    return items;
  }
   ...
   */
  public HttpsHealthCheckList setItems(java.util.List<HttpsHealthCheck> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HttpsHealthCheckList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public HttpsHealthCheckList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HttpsHealthCheckList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HttpsHealthCheckList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HttpsHealthCheckList set(String fieldName, Object value) {
    return (HttpsHealthCheckList) super.set(fieldName, value);
  }

  @Override
  public HttpsHealthCheckList clone() {
    return (HttpsHealthCheckList) super.clone();
  }
