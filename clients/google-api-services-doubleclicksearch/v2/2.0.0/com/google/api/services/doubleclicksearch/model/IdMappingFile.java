...
public final class IdMappingFile extends com.google.api.client.json.GenericJson {

  @Override
  public IdMappingFile set(String fieldName, Object value) {
    return (IdMappingFile) super.set(fieldName, value);
  }

  @Override
  public IdMappingFile clone() {
    return (IdMappingFile) super.clone();
  }
