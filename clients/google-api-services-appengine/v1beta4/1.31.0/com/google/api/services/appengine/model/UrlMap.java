...
public final class UrlMap extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Serves the entire contents of a directory as static files.This attribute is deprecated. You can
   * mimic the behavior of static directories using static files.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private StaticDirectoryHandler staticDirectory;
  ...
  /**
   * A URL prefix. Uses regular expression syntax, which means regexp special characters must be
   ...
   * @return value or {@code null} for none
   */
  public StaticDirectoryHandler getStaticDirectory() {
   ...
   * Serves the entire contents of a directory as static files.This attribute is deprecated. You can
   * mimic the behavior of static directories using static files.
   * @param staticDirectory staticDirectory or {@code null} for none
   */
  public UrlMap setStaticDirectory(StaticDirectoryHandler staticDirectory) {
