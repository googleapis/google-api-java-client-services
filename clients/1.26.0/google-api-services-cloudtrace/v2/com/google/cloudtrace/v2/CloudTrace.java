...
public class CloudTrace extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Stackdriver Trace API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Traces {
      ...
      `projects/[PROJECT_ID]`.
       * @param content the {@link com.google.cloudtrace.v2.model.BatchWriteSpansRequest}
       * @return the request
       */
      public BatchWrite batchWrite(java.lang.String name, com.google.cloudtrace.v2.model.BatchWriteSpansRequest content) throws java.io.IOException {
        BatchWrite result = new BatchWrite(name, content);
        initialize(result);
        return result;
      }

      public class BatchWrite extends CloudTraceRequest<com.google.cloudtrace.v2.model.Empty> {
      ...
      `projects/[PROJECT_ID]`.
         ...
         * @since 1.13
         */
        protected BatchWrite(java.lang.String name, com.google.cloudtrace.v2.model.BatchWriteSpansRequest content) {
          super(CloudTrace.this, "POST", REST_PATH, content, com.google.cloudtrace.v2.model.Empty.class);
      ...
      public class Spans {
         ...
         * @param content the {@link com.google.cloudtrace.v2.model.Span}
         * @return the request
         */
        public CreateSpan createSpan(java.lang.String name, com.google.cloudtrace.v2.model.Span content) throws java.io.IOException {
          CreateSpan result = new CreateSpan(name, content);
          initialize(result);
          return result;
        }

        public class CreateSpan extends CloudTraceRequest<com.google.cloudtrace.v2.model.Span> {
         ...
         *        encoding of an 8-byte array.
           ...
           * @since 1.13
           */
          protected CreateSpan(java.lang.String name, com.google.cloudtrace.v2.model.Span content) {
            super(CloudTrace.this, "POST", REST_PATH, content, com.google.cloudtrace.v2.model.Span.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
