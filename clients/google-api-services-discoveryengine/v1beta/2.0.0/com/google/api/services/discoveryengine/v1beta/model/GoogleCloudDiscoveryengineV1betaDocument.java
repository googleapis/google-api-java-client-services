...
public final class GoogleCloudDiscoveryengineV1betaDocument extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaDocument setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1betaDocument setParentDocumentId(java.lang.String parentDocumentId) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1betaDocument set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaDocument) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaDocument clone() {
    return (GoogleCloudDiscoveryengineV1betaDocument) super.clone();
  }
