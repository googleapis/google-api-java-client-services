...
public final class InsertionOrder extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The key performance indicator (KPI) of the insertion order. This is represented as
   * referred to as the "Goal" in the Display & Video 360 interface.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private Kpi kpi;
   ...
   * Required. The key performance indicator (KPI) of the insertion order. This is represented as
   * referred to as the "Goal" in the Display & Video 360 interface.
   * @param kpi kpi or {@code null} for none
   */
  public InsertionOrder setKpi(Kpi kpi) {
    this.kpi = kpi;
    return this;
  }
