...
/**
 * A filter collection lists filters created by users in an Analytics account. Each resource in the
 * collection corresponds to a filter.
 *
...
public final class Filters extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Filter> items;
   ...
   */
  public java.util.List<Filter> getItems() {
    return items;
  }
   ...
   */
  public Filters setItems(java.util.List<Filter> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public Filters setItemsPerPage(java.lang.Integer itemsPerPage) {
   ...
   */
  public Filters setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public Filters setNextLink(java.lang.String nextLink) {
   ...
   */
  public Filters setPreviousLink(java.lang.String previousLink) {
   ...
   */
  public Filters setStartIndex(java.lang.Integer startIndex) {
   ...
   */
  public Filters setTotalResults(java.lang.Integer totalResults) {
   ...
   */
  public Filters setUsername(java.lang.String username) {
