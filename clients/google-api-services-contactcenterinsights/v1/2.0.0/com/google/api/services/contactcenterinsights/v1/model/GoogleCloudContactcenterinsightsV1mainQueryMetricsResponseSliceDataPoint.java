...
public final class GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPointConversationMeasure getConversationMeasure() {
   ...
   */
  public GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint setInterval(GoogleTypeInterval interval) {
    this.interval = interval;
    return this;
  }

  @Override
  public GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint set(String fieldName, Object value) {
    return (GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint clone() {
    return (GoogleCloudContactcenterinsightsV1mainQueryMetricsResponseSliceDataPoint) super.clone();
  }
