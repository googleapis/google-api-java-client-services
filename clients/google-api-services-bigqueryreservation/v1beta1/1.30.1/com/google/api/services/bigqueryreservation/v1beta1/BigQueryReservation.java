...
public class BigQueryReservation extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
       ...
       * instead of   projects/locationsreservations. Wildcard "-" can be used for projects in
       * SearchAssignmentsRequest.parent. Note "-" cannot be used for projects nor locations.
       *
      ...
      public class SearchAssignments extends BigQueryReservationRequest<com.google.api.services.bigqueryreservation.v1beta1.model.SearchAssignmentsResponse> {
         ...
         * projects/locations, instead of   projects/locationsreservations. Wildcard "-" can be used for
         * projects in SearchAssignmentsRequest.parent. Note "-" cannot be used for projects nor
         * locations.
         *
         * Create a request for the method "locations.searchAssignments".
         *
      ...
      public class Operations {
        ...
        public class Cancel extends BigQueryReservationRequest<com.google.api.services.bigqueryreservation.v1beta1.model.Empty> {
          ...
          protected Cancel(java.lang.String name) {
            super(BigQueryReservation.this, "POST", REST_PATH, null, com.google.api.services.bigqueryreservation.v1beta1.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends BigQueryReservationRequest<com.google.api.services.bigqueryreservation.v1beta1.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(BigQueryReservation.this, "GET", REST_PATH, null, com.google.api.services.bigqueryreservation.v1beta1.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Reservations {
        ...
        public class Assignments {
           ...
           *        projects/myproject/location/US/reservations/-
            ...
            /**
             * The parent resource name e.g.: projects/myproject/location/US/reservations/team1-prod
             * Or: projects/myproject/location/US/reservations/-
             */
            @com.google.api.client.util.Key
            private java.lang.String parent;

            /** The parent resource name e.g.: projects/myproject/location/US/reservations/team1-prod Or:
           projects/myproject/location/US/reservations/-
             */
            public java.lang.String getParent() {
              return parent;
           ...
           * @return the request
           */
          public Move move(java.lang.String name) throws java.io.IOException {
            Move result = new Move(name);
            initialize(result);
            return result;
          }
           ...
           *        projects/myproject/locations/US/reservations/team1-prod/assignments/123
             * @since 1.13
             */
            protected Move(java.lang.String name) {
              super(BigQueryReservation.this, "POST", REST_PATH, null, com.google.api.services.bigqueryreservation.v1beta1.model.Assignment.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
           ...
           projects/myproject/locations/US/reservations/team1-prod/assignments/123
             ...
             * projects/myotherproject/locations/US/reservations/team2-prod
             */
            public Move setDestinationId(java.lang.String destinationId) {
