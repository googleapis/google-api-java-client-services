...
public final class AcceleratorTypesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public AcceleratorTypesScopedList setAcceleratorTypes(java.util.List<AcceleratorType> acceleratorTypes) {
   ...
   */
  public AcceleratorTypesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AcceleratorTypesScopedList set(String fieldName, Object value) {
    return (AcceleratorTypesScopedList) super.set(fieldName, value);
  }

  @Override
  public AcceleratorTypesScopedList clone() {
    return (AcceleratorTypesScopedList) super.clone();
  }
