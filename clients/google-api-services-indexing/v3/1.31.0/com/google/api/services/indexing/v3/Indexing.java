...
public class Indexing extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Indexing API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.31
   */
  public static final String DEFAULT_MTLS_ROOT_URL = "https://indexing.mtls.googleapis.com/";
