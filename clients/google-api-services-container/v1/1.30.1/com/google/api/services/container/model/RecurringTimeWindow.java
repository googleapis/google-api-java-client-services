...
public final class RecurringTimeWindow extends com.google.api.client.json.GenericJson {
   ...
   *
   * This specifies how frequently the window starts. Eg, if you wanted to have a 9-5 UTC-4 window
   * every weekday, you'd use something like: ``` start time = 2019-01-01T09:00:00-0400 end time =
   ...
   * Saturday till the last minute of Sunday UTC: ``` start time = 2019-01-05T00:00:00Z end time =
   * 2019-01-07T23:59:00Z recurrence = FREQ=WEEKLY;BYDAY=SA ```
   *
