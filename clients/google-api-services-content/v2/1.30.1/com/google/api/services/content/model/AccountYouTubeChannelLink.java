...
public final class AccountYouTubeChannelLink extends com.google.api.client.json.GenericJson {
   ...
   * will remain unchanged. Re-uploading a link with deprecated status `inactive` is equivalent to
   * not submitting the link at all and will delete the link if it was active or cancel the link
