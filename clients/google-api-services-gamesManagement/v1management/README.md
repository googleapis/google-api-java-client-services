# Google Play Games Services Management API Client Library for Java
...
<project>
  <dependencies>
    <dependency>
      ...
      <version>v1management-rev20251003-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-gamesManagement:v1management-rev20251003-2.0.0'
}
```
