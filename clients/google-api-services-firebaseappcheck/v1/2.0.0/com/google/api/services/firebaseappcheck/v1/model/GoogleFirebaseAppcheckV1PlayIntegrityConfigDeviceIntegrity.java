...
public final class GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity setMinDeviceRecognitionLevel(java.lang.String minDeviceRecognitionLevel) {
    this.minDeviceRecognitionLevel = minDeviceRecognitionLevel;
    return this;
  }

  @Override
  public GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity clone() {
    return (GoogleFirebaseAppcheckV1PlayIntegrityConfigDeviceIntegrity) super.clone();
  }
