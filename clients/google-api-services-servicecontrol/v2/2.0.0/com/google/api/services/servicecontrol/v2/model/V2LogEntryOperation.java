...
public final class V2LogEntryOperation extends com.google.api.client.json.GenericJson {
   ...
   */
  public V2LogEntryOperation setFirst(java.lang.Boolean first) {
    this.first = first;
    return this;
  }
   ...
   */
  public V2LogEntryOperation setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public V2LogEntryOperation setLast(java.lang.Boolean last) {
    this.last = last;
    return this;
  }
   ...
   */
  public V2LogEntryOperation setProducer(java.lang.String producer) {
    this.producer = producer;
    return this;
  }

  @Override
  public V2LogEntryOperation set(String fieldName, Object value) {
    return (V2LogEntryOperation) super.set(fieldName, value);
  }

  @Override
  public V2LogEntryOperation clone() {
    return (V2LogEntryOperation) super.clone();
  }
