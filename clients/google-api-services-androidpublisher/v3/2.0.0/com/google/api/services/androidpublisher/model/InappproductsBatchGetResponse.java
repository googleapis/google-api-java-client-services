...
public final class InappproductsBatchGetResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public InappproductsBatchGetResponse setInappproduct(java.util.List<InAppProduct> inappproduct) {
    this.inappproduct = inappproduct;
    return this;
  }

  @Override
  public InappproductsBatchGetResponse set(String fieldName, Object value) {
    return (InappproductsBatchGetResponse) super.set(fieldName, value);
  }
