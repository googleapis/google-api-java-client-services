...
public final class ExternalVpnGatewayList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ExternalVpnGateway> items;

  static {
    // hack to force ProGuard to consider ExternalVpnGateway used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ExternalVpnGateway.class);
  }
   ...
   */
  public ExternalVpnGatewayList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public ExternalVpnGatewayList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ExternalVpnGateway> getItems() {
    return items;
  }
   ...
   */
  public ExternalVpnGatewayList setItems(java.util.List<ExternalVpnGateway> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public ExternalVpnGatewayList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public ExternalVpnGatewayList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public ExternalVpnGatewayList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public ExternalVpnGatewayList set(String fieldName, Object value) {
    return (ExternalVpnGatewayList) super.set(fieldName, value);
  }

  @Override
  public ExternalVpnGatewayList clone() {
    return (ExternalVpnGatewayList) super.clone();
  }
