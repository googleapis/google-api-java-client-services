...
/**
 * Model definition for ZoneSetNestedPolicyRequest.
 *
...
public final class ZoneSetNestedPolicyRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public ZoneSetNestedPolicyRequest setBindings(java.util.List<Binding> bindings) {
   ...
   */
  public ZoneSetNestedPolicyRequest setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @since 1.14
   */
  public ZoneSetNestedPolicyRequest encodeEtag(byte[] etag) {
   ...
   */
  public ZoneSetNestedPolicyRequest setPolicy(Policy policy) {
    this.policy = policy;
    return this;
  }

  @Override
  public ZoneSetNestedPolicyRequest set(String fieldName, Object value) {
    return (ZoneSetNestedPolicyRequest) super.set(fieldName, value);
  }

  @Override
  public ZoneSetNestedPolicyRequest clone() {
    return (ZoneSetNestedPolicyRequest) super.clone();
  }
