...
public final class DataLeakAlertDetail extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public DataLeakAlertDetail set(String fieldName, Object value) {
    return (DataLeakAlertDetail) super.set(fieldName, value);
  }

  @Override
  public DataLeakAlertDetail clone() {
    return (DataLeakAlertDetail) super.clone();
  }
