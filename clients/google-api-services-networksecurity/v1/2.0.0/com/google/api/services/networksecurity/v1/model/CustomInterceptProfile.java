...
public final class CustomInterceptProfile extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CustomInterceptProfile set(String fieldName, Object value) {
    return (CustomInterceptProfile) super.set(fieldName, value);
  }

  @Override
  public CustomInterceptProfile clone() {
    return (CustomInterceptProfile) super.clone();
  }
