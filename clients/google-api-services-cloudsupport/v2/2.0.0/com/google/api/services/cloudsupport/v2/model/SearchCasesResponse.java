...
public final class SearchCasesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<CloudSupportCase> cases;

  static {
    // hack to force ProGuard to consider CloudSupportCase used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(CloudSupportCase.class);
  }

  /**
   * A token to retrieve the next page of results. This should be set in the `page_token` field of
   * subsequent `SearchCaseRequest` message that is issued. If unspecified, there are no more
   * results to retrieve.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public SearchCasesResponse setNextPageToken(java.lang.String nextPageToken) {
    this.nextPageToken = nextPageToken;
    return this;
  }

  @Override
  public SearchCasesResponse set(String fieldName, Object value) {
    return (SearchCasesResponse) super.set(fieldName, value);
  }

  @Override
  public SearchCasesResponse clone() {
    return (SearchCasesResponse) super.clone();
  }
