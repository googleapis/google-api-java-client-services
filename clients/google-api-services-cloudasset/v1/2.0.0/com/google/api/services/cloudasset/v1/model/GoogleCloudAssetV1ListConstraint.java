...
public final class GoogleCloudAssetV1ListConstraint extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAssetV1ListConstraint setSupportsIn(java.lang.Boolean supportsIn) {
   ...
   */
  public GoogleCloudAssetV1ListConstraint setSupportsUnder(java.lang.Boolean supportsUnder) {
    this.supportsUnder = supportsUnder;
    return this;
  }

  @Override
  public GoogleCloudAssetV1ListConstraint set(String fieldName, Object value) {
    return (GoogleCloudAssetV1ListConstraint) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAssetV1ListConstraint clone() {
    return (GoogleCloudAssetV1ListConstraint) super.clone();
  }
