...
public final class GoogleIdentityAccesscontextmanagerV1Condition extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleIdentityAccesscontextmanagerV1Condition setDevicePolicy(GoogleIdentityAccesscontextmanagerV1DevicePolicy devicePolicy) {
   ...
   */
  public GoogleIdentityAccesscontextmanagerV1Condition setIpSubnetworks(java.util.List<java.lang.String> ipSubnetworks) {
   ...
   */
  public GoogleIdentityAccesscontextmanagerV1Condition setMembers(java.util.List<java.lang.String> members) {
   ...
   */
  public GoogleIdentityAccesscontextmanagerV1Condition setNegate(java.lang.Boolean negate) {
    this.negate = negate;
    return this;
  }
   ...
   */
  public GoogleIdentityAccesscontextmanagerV1Condition setRegions(java.util.List<java.lang.String> regions) {
  ...
  @Override
  public GoogleIdentityAccesscontextmanagerV1Condition set(String fieldName, Object value) {
    return (GoogleIdentityAccesscontextmanagerV1Condition) super.set(fieldName, value);
  }

  @Override
  public GoogleIdentityAccesscontextmanagerV1Condition clone() {
    return (GoogleIdentityAccesscontextmanagerV1Condition) super.clone();
  }
