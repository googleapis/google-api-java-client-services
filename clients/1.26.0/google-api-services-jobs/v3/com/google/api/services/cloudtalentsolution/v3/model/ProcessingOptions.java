...
public final class ProcessingOptions extends com.google.api.client.json.GenericJson {
   ...
   */
  public ProcessingOptions setHtmlSanitization(java.lang.String htmlSanitization) {
    this.htmlSanitization = htmlSanitization;
    return this;
  }

  @Override
  public ProcessingOptions set(String fieldName, Object value) {
    return (ProcessingOptions) super.set(fieldName, value);
  }

  @Override
  public ProcessingOptions clone() {
    return (ProcessingOptions) super.clone();
  }
