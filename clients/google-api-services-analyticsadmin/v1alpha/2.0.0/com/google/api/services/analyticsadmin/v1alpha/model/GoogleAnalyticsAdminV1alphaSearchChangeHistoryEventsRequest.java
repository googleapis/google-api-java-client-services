...
public final class GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setAction(java.util.List<java.lang.String> action) {
    this.action = action;
    return this;
  }
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setActorEmail(java.util.List<java.lang.String> actorEmail) {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setEarliestChangeTime(String earliestChangeTime) {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setLatestChangeTime(String latestChangeTime) {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setPageToken(java.lang.String pageToken) {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setProperty(java.lang.String property) {
   ...
   */
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest setResourceType(java.util.List<java.lang.String> resourceType) {
    this.resourceType = resourceType;
    return this;
  }

  @Override
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest set(String fieldName, Object value) {
    return (GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest clone() {
