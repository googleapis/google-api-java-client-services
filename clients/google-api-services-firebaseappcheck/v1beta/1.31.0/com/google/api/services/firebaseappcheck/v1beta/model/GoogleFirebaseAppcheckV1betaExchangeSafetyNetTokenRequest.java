...
public final class GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest setSafetyNetToken(java.lang.String safetyNetToken) {
    this.safetyNetToken = safetyNetToken;
    return this;
  }

  @Override
  public GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest set(String fieldName, Object value) {
    return (GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest clone() {
    return (GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest) super.clone();
  }
