...
public final class GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata setAnnotatedDataset(java.lang.String annotatedDataset) {
   ...
   */
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata setCreateTime(String createTime) {
   ...
   */
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata setDataset(java.lang.String dataset) {
   ...
   */
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata setPartialFailures(java.util.List<GoogleRpcStatus> partialFailures) {
    this.partialFailures = partialFailures;
    return this;
  }

  @Override
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata set(String fieldName, Object value) {
    return (GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata clone() {
