...
public final class GoogleSecuritySafebrowsingV4ThreatEntry extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleSecuritySafebrowsingV4ThreatEntry setDigest(java.lang.String digest) {
    this.digest = digest;
    return this;
  }
   ...
   * @since 1.14
   */
  public GoogleSecuritySafebrowsingV4ThreatEntry encodeDigest(byte[] digest) {
   ...
   */
  public GoogleSecuritySafebrowsingV4ThreatEntry setHash(java.lang.String hash) {
    this.hash = hash;
    return this;
  }
   ...
   * @since 1.14
   */
  public GoogleSecuritySafebrowsingV4ThreatEntry encodeHash(byte[] hash) {
   ...
   */
  public GoogleSecuritySafebrowsingV4ThreatEntry setUrl(java.lang.String url) {
    this.url = url;
    return this;
  }

  @Override
  public GoogleSecuritySafebrowsingV4ThreatEntry set(String fieldName, Object value) {
    return (GoogleSecuritySafebrowsingV4ThreatEntry) super.set(fieldName, value);
  }
