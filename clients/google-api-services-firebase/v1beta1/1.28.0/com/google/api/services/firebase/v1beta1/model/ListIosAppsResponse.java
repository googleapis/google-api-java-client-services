...
/**
 * Model definition for ListIosAppsResponse.
 *
...
public final class ListIosAppsResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<IosApp> apps;

  static {
    // hack to force ProGuard to consider IosApp used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(IosApp.class);
  }
   ...
   */
  public java.util.List<IosApp> getApps() {
    return apps;
  }
   ...
   */
  public ListIosAppsResponse setApps(java.util.List<IosApp> apps) {
    this.apps = apps;
    return this;
  }
  ...
  @Override
  public ListIosAppsResponse set(String fieldName, Object value) {
    return (ListIosAppsResponse) super.set(fieldName, value);
  }

  @Override
  public ListIosAppsResponse clone() {
    return (ListIosAppsResponse) super.clone();
  }
