 ...
 * <pre>
  public static class MyRequestInitializer extends SQLAdminRequestInitializer {
    ...
    {@literal @}Override
    public void initializeSQLAdminRequest(SQLAdminRequest{@literal <}?{@literal >} request)
        throws IOException {
      // custom logic
    }
  }
 ...
 * @since 1.12
 */
public class SQLAdminRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public SQLAdminRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeSQLAdminRequest((SQLAdminRequest<?>) request);
  }

  /**
   * Initializes SQLAdmin request.
   *
   * <p>
   ...
   */
  protected void initializeSQLAdminRequest(SQLAdminRequest<?> request) throws java.io.IOException {
  }
}
