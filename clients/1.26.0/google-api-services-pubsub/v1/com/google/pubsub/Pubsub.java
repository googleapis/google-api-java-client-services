...
public class Pubsub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Pub/Sub API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Snapshots {
       ...
       *
       * BETA: This feature is part of a beta release. This API might be changed in backward-incompatible
       * ways and is not recommended for production use. It is not subject to any SLA or deprecation
       * policy. If the snapshot already exists, returns `ALREADY_EXISTS`. If the requested subscription
       * doesn't exist, returns `NOT_FOUND`. If the backlog in the subscription is too old -- and the
       ...
       * @param content the {@link com.google.pubsub.model.CreateSnapshotRequest}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.pubsub.model.CreateSnapshotRequest content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends PubsubRequest<com.google.pubsub.model.Snapshot> {
         ...
         * deprecation policy. If the snapshot already exists, returns `ALREADY_EXISTS`. If the requested
      ...
      Format is `projects/{project}/snapshots/{snap}`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.pubsub.model.CreateSnapshotRequest content) {
          super(Pubsub.this, "PUT", REST_PATH, content, com.google.pubsub.model.Snapshot.class);
       ...
       * existing subscription to the state captured by a snapshot. BETA: This feature is part of a beta
       * release. This API might be changed in backward-incompatible ways and is not recommended for
       * production use. It is not subject to any SLA or deprecation policy. When the snapshot is deleted,
       * all messages retained in the snapshot are immediately dropped. After a snapshot is deleted, a new
      ...
      public class Delete extends PubsubRequest<com.google.pubsub.model.Empty> {
         ...
         * an existing subscription to the state captured by a snapshot. BETA: This feature is part of a
         * beta release. This API might be changed in backward-incompatible ways and is not recommended
         * for production use. It is not subject to any SLA or deprecation policy. When the snapshot is
         * deleted, all messages retained in the snapshot are immediately dropped. After a snapshot is
         * deleted, a new one may be created with the same name, but the new one has no association with
         * the old snapshot or its subscription, unless the same subscription is specified.
         *
         * Create a request for the method "snapshots.delete".
         *
         * This request holds the parameters needed by the the pubsub server.  After setting any optional
      ...
      Format is `projects/{project}/snapshots/{snap}`.
        ...
        protected Delete(java.lang.String snapshot) {
          super(Pubsub.this, "DELETE", REST_PATH, null, com.google.pubsub.model.Empty.class);
       ...
       * messages in an existing subscription to the state captured by a snapshot. BETA: This feature is
       * part of a beta release. This API might be changed in backward-incompatible ways and is not
      ...
      public class Get extends PubsubRequest<com.google.pubsub.model.Snapshot> {
      ...
      Format is `projects/{project}/snapshots/{snap}`.
        ...
        protected Get(java.lang.String snapshot) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.Snapshot.class);
          this.snapshot = com.google.api.client.util.Preconditions.checkNotNull(snapshot, "Required parameter snapshot must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SNAPSHOT_PATTERN.matcher(snapshot).matches(),
                "Parameter snapshot must conform to the pattern " +
      ...
      public class GetIamPolicy extends PubsubRequest<com.google.pubsub.model.Policy> {
       ...
       *        the appropriate value for this field.
        ...
        protected GetIamPolicy(java.lang.String resource) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.Policy.class);
      ...
      public class List extends PubsubRequest<com.google.pubsub.model.ListSnapshotsResponse> {
      ...
      Format is `projects/{project-id}`.
        ...
        protected List(java.lang.String project) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.ListSnapshotsResponse.class);
       ...
       * existing subscription to the state captured by a snapshot. BETA: This feature is part of a beta
       * release. This API might be changed in backward-incompatible ways and is not recommended for
       * production use. It is not subject to any SLA or deprecation policy. Note that certain properties
       ...
       * @param content the {@link com.google.pubsub.model.UpdateSnapshotRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.pubsub.model.UpdateSnapshotRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends PubsubRequest<com.google.pubsub.model.Snapshot> {
         ...
         * an existing subscription to the state captured by a snapshot. BETA: This feature is part of a
         * beta release. This API might be changed in backward-incompatible ways and is not recommended
         * for production use. It is not subject to any SLA or deprecation policy. Note that certain
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.pubsub.model.UpdateSnapshotRequest content) {
          super(Pubsub.this, "PATCH", REST_PATH, content, com.google.pubsub.model.Snapshot.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      See the operation documentation for
       *        the appropriate value for this field.
       * @param content the {@link com.google.pubsub.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.pubsub.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends PubsubRequest<com.google.pubsub.model.Policy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.pubsub.model.SetIamPolicyRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
      ...
      See the operation
       *        documentation for the appropriate value for this field.
       * @param content the {@link com.google.pubsub.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.pubsub.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends PubsubRequest<com.google.pubsub.model.TestIamPermissionsResponse> {
       ...
       *        documentation for the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.pubsub.model.TestIamPermissionsRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
    ...
    public class Subscriptions {
       ...
       * @param content the {@link com.google.pubsub.model.AcknowledgeRequest}
       * @return the request
       */
      public Acknowledge acknowledge(java.lang.String subscription, com.google.pubsub.model.AcknowledgeRequest content) throws java.io.IOException {
        Acknowledge result = new Acknowledge(subscription, content);
        initialize(result);
        return result;
      }

      public class Acknowledge extends PubsubRequest<com.google.pubsub.model.Empty> {
       ...
       *        `projects/{project}/subscriptions/{sub}`.
         ...
         * @since 1.13
         */
        protected Acknowledge(java.lang.String subscription, com.google.pubsub.model.AcknowledgeRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
       ...
       * @param content the {@link com.google.pubsub.model.Subscription}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.pubsub.model.Subscription content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends PubsubRequest<com.google.pubsub.model.Subscription> {
      ...
      in length, and it must not start with `"goog"`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.pubsub.model.Subscription content) {
          super(Pubsub.this, "PUT", REST_PATH, content, com.google.pubsub.model.Subscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends PubsubRequest<com.google.pubsub.model.Subscription> {
      ...
      Format is `projects/{project}/subscriptions/{sub}`.
        ...
        protected Get(java.lang.String subscription) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.Subscription.class);
          this.subscription = com.google.api.client.util.Preconditions.checkNotNull(subscription, "Required parameter subscription must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SUBSCRIPTION_PATTERN.matcher(subscription).matches(),
                "Parameter subscription must conform to the pattern " +
      ...
      public class List extends PubsubRequest<com.google.pubsub.model.ListSubscriptionsResponse> {
      ...
      Format is `projects/{project-id}`.
         ...
         */
        protected List(java.lang.String project) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.ListSubscriptionsResponse.class);
          this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
                "Parameter project must conform to the pattern " +
      ...
      Format is `projects/{project}/subscriptions/{sub}`.
       * @param content the {@link com.google.pubsub.model.ModifyAckDeadlineRequest}
       * @return the request
       */
      public ModifyAckDeadline modifyAckDeadline(java.lang.String subscription, com.google.pubsub.model.ModifyAckDeadlineRequest content) throws java.io.IOException {
        ModifyAckDeadline result = new ModifyAckDeadline(subscription, content);
        initialize(result);
        return result;
      }

      public class ModifyAckDeadline extends PubsubRequest<com.google.pubsub.model.Empty> {
      ...
      Format is `projects/{project}/subscriptions/{sub}`.
         ...
         * @since 1.13
         */
        protected ModifyAckDeadline(java.lang.String subscription, com.google.pubsub.model.ModifyAckDeadlineRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
          this.subscription = com.google.api.client.util.Preconditions.checkNotNull(subscription, "Required parameter subscription must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SUBSCRIPTION_PATTERN.matcher(subscription).matches(),
       ...
       * @param subscription The name of the subscription.
      Format is `projects/{project}/subscriptions/{sub}`.
       * @param content the {@link com.google.pubsub.model.ModifyPushConfigRequest}
       * @return the request
       */
      public ModifyPushConfig modifyPushConfig(java.lang.String subscription, com.google.pubsub.model.ModifyPushConfigRequest content) throws java.io.IOException {
        ModifyPushConfig result = new ModifyPushConfig(subscription, content);
        initialize(result);
        return result;
      }

      public class ModifyPushConfig extends PubsubRequest<com.google.pubsub.model.Empty> {
      ...
      Format is `projects/{project}/subscriptions/{sub}`.
         ...
         * @since 1.13
         */
        protected ModifyPushConfig(java.lang.String subscription, com.google.pubsub.model.ModifyPushConfigRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
          this.subscription = com.google.api.client.util.Preconditions.checkNotNull(subscription, "Required parameter subscription must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SUBSCRIPTION_PATTERN.matcher(subscription).matches(),
       ...
       *        be between 3 and 255 characters
      in length, and it must not start with `"goog"`.
       * @param content the {@link com.google.pubsub.model.UpdateSubscriptionRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.pubsub.model.UpdateSubscriptionRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends PubsubRequest<com.google.pubsub.model.Subscription> {
      ...
      in length, and it must not start with `"goog"`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.pubsub.model.UpdateSubscriptionRequest content) {
          super(Pubsub.this, "PATCH", REST_PATH, content, com.google.pubsub.model.Subscription.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      Format is
       *        `projects/{project}/subscriptions/{sub}`.
       * @param content the {@link com.google.pubsub.model.PullRequest}
       * @return the request
       */
      public Pull pull(java.lang.String subscription, com.google.pubsub.model.PullRequest content) throws java.io.IOException {
        Pull result = new Pull(subscription, content);
        initialize(result);
        return result;
      }

      public class Pull extends PubsubRequest<com.google.pubsub.model.PullResponse> {
       ...
       *        `projects/{project}/subscriptions/{sub}`.
         ...
         * @since 1.13
         */
        protected Pull(java.lang.String subscription, com.google.pubsub.model.PullRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.PullResponse.class);
          this.subscription = com.google.api.client.util.Preconditions.checkNotNull(subscription, "Required parameter subscription must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SUBSCRIPTION_PATTERN.matcher(subscription).matches(),
                "Parameter subscription must conform to the pattern " +
       ...
       * snapshot must be on the same topic. BETA: This feature is part of a beta release. This API might
       ...
       * @param content the {@link com.google.pubsub.model.SeekRequest}
       * @return the request
       */
      public Seek seek(java.lang.String subscription, com.google.pubsub.model.SeekRequest content) throws java.io.IOException {
        Seek result = new Seek(subscription, content);
        initialize(result);
        return result;
      }

      public class Seek extends PubsubRequest<com.google.pubsub.model.SeekResponse> {
         ...
         * the snapshot must be on the same topic. BETA: This feature is part of a beta release. This API
         ...
         * @since 1.13
         */
        protected Seek(java.lang.String subscription, com.google.pubsub.model.SeekRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.SeekResponse.class);
          this.subscription = com.google.api.client.util.Preconditions.checkNotNull(subscription, "Required parameter subscription must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(SUBSCRIPTION_PATTERN.matcher(subscription).matches(),
                "Parameter subscription must conform to the pattern " +
    ...
    public class Topics {
       ...
       * @param content the {@link com.google.pubsub.model.Topic}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.pubsub.model.Topic content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends PubsubRequest<com.google.pubsub.model.Topic> {
      ...
      must not start with `"goog"`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.pubsub.model.Topic content) {
          super(Pubsub.this, "PUT", REST_PATH, content, com.google.pubsub.model.Topic.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends PubsubRequest<com.google.pubsub.model.Topic> {
      ...
      Format is `projects/{project}/topics/{topic}`.
        ...
        protected Get(java.lang.String topic) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.Topic.class);
          this.topic = com.google.api.client.util.Preconditions.checkNotNull(topic, "Required parameter topic must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(TOPIC_PATTERN.matcher(topic).matches(),
                "Parameter topic must conform to the pattern " +
      ...
      public class List extends PubsubRequest<com.google.pubsub.model.ListTopicsResponse> {
      ...
      Format is `projects/{project-id}`.
         ...
         */
        protected List(java.lang.String project) {
          super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.ListTopicsResponse.class);
          this.project = com.google.api.client.util.Preconditions.checkNotNull(project, "Required parameter project must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PROJECT_PATTERN.matcher(project).matches(),
                "Parameter project must conform to the pattern " +
       ...
       *        It must be between 3 and 255 characters in length, and it
      must not start with `"goog"`.
       * @param content the {@link com.google.pubsub.model.UpdateTopicRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.pubsub.model.UpdateTopicRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends PubsubRequest<com.google.pubsub.model.Topic> {
      ...
      must not start with `"goog"`.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.pubsub.model.UpdateTopicRequest content) {
          super(Pubsub.this, "PATCH", REST_PATH, content, com.google.pubsub.model.Topic.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param content the {@link com.google.pubsub.model.PublishRequest}
       * @return the request
       */
      public Publish publish(java.lang.String topic, com.google.pubsub.model.PublishRequest content) throws java.io.IOException {
        Publish result = new Publish(topic, content);
        initialize(result);
        return result;
      }

      public class Publish extends PubsubRequest<com.google.pubsub.model.PublishResponse> {
       ...
       *        `projects/{project}/topics/{topic}`.
         ...
         * @since 1.13
         */
        protected Publish(java.lang.String topic, com.google.pubsub.model.PublishRequest content) {
          super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.PublishResponse.class);
          this.topic = com.google.api.client.util.Preconditions.checkNotNull(topic, "Required parameter topic must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(TOPIC_PATTERN.matcher(topic).matches(),
                "Parameter topic must conform to the pattern " +
      ...
      public class Snapshots {
         ...
         * not recommended for production use. It is not subject to any SLA or deprecation policy.
         *
         * Create a request for the method "snapshots.list".
         *
         * This request holds the parameters needed by the pubsub server.  After setting any optional
        ...
        public class List extends PubsubRequest<com.google.pubsub.model.ListTopicSnapshotsResponse> {
        ...
        Format is `projects/{project}/topics/{topic}`.
          ...
          protected List(java.lang.String topic) {
            super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.ListTopicSnapshotsResponse.class);
            this.topic = com.google.api.client.util.Preconditions.checkNotNull(topic, "Required parameter topic must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(TOPIC_PATTERN.matcher(topic).matches(),
                  "Parameter topic must conform to the pattern " +
      ...
      public class Subscriptions {
        ...
        public class List extends PubsubRequest<com.google.pubsub.model.ListTopicSubscriptionsResponse> {
         ...
         *        `projects/{project}/topics/{topic}`.
           ...
           */
          protected List(java.lang.String topic) {
            super(Pubsub.this, "GET", REST_PATH, null, com.google.pubsub.model.ListTopicSubscriptionsResponse.class);
            this.topic = com.google.api.client.util.Preconditions.checkNotNull(topic, "Required parameter topic must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(TOPIC_PATTERN.matcher(topic).matches(),
                  "Parameter topic must conform to the pattern " +
