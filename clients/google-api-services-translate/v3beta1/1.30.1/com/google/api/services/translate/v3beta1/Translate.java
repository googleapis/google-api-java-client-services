...
public class Translate extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.30.1 of the Cloud Translation API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
     ...
     *
     * @param parent Required. Target project or location to make a call.
    Format: `projects/{project-id}/locations
     *        /{location-id}` or
    `projects/{project-id}`.
    For global calls, use `projects/{project-
     *        id}/locations/global` or
    `projects/{project-id}`.
    Only models within the same region (has
     *        same location-id) can be used.
     ...
     *        otherwise an INVALID_ARGUMENT (400) error is returned.
     ...
     missing, then display names are not returned in a response.
       ...
       * id}/models/general/nmt`, `projects/{project-id}/locations/{location-
    ...
    `projects/{project-id}`.
    Non-global location is required for
     *        requests using AutoML models or
    custom glossaries.
    Models and glossaries must be within
     *        the same region (have same
    ...
    public class Locations {
      ...
      Only AutoML Translation
       *        models or glossaries within the same region (have
      the same location-id) can be used,
       *        otherwise an INVALID_ARGUMENT (400)
      error is returned.
      ...
      Otherwise an INVALID_ARGUMENT (400) error is returned.
         ...
         * Format: `projects/{project-id}/locations/{location-id}` or `projects/{project-id}`.
         *
         * For global calls, use `projects/{project-id}/locations/global` or `projects/{project-
         * id}`.
         *
         * Only models within the same region (has same location-id) can be used. Otherwise an
         * INVALID_ARGUMENT (400) error is returned.
       ...
       *        otherwise an INVALID_ARGUMENT (400) error is returned.
       ...
       missing, then display names are not returned in a response.
         ...
         * The format depends on model type:
         *
         * - AutoML Translation models: `projects/{project-id}/locations/{location-id}/models
         * /{model-id}`
         *
         * - General (built-in) models: `projects/{project-id}/locations/{location-
         * id}/models/general/nmt`, `projects/{project-id}/locations/{location-
