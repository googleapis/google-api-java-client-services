...
/**
 * Model definition for CreateBuiltInVariableResponse.
 *
...
public final class CreateBuiltInVariableResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public CreateBuiltInVariableResponse setBuiltInVariable(java.util.List<BuiltInVariable> builtInVariable) {
    this.builtInVariable = builtInVariable;
    return this;
  }

  @Override
  public CreateBuiltInVariableResponse set(String fieldName, Object value) {
    return (CreateBuiltInVariableResponse) super.set(fieldName, value);
  }

  @Override
  public CreateBuiltInVariableResponse clone() {
    return (CreateBuiltInVariableResponse) super.clone();
  }
