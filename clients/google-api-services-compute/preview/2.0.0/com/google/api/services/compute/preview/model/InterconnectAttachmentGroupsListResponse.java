...
/**
 * Model definition for InterconnectAttachmentGroupsListResponse.
 *
...
public final class InterconnectAttachmentGroupsListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InterconnectAttachmentGroup> items;

  static {
    // hack to force ProGuard to consider InterconnectAttachmentGroup used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(InterconnectAttachmentGroup.class);
  }
   ...
   */
  public InterconnectAttachmentGroupsListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public InterconnectAttachmentGroupsListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InterconnectAttachmentGroup> getItems() {
    return items;
  }
   ...
   */
  public InterconnectAttachmentGroupsListResponse setItems(java.util.List<InterconnectAttachmentGroup> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InterconnectAttachmentGroupsListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InterconnectAttachmentGroupsListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InterconnectAttachmentGroupsListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InterconnectAttachmentGroupsListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public InterconnectAttachmentGroupsListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InterconnectAttachmentGroupsListResponse set(String fieldName, Object value) {
    return (InterconnectAttachmentGroupsListResponse) super.set(fieldName, value);
  }

  @Override
  public InterconnectAttachmentGroupsListResponse clone() {
    return (InterconnectAttachmentGroupsListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for InterconnectAttachmentGroupsListResponseWarningData.
     */
