...
public final class TombstoneMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public TombstoneMetadata setTombstoneType(java.lang.String tombstoneType) {
    this.tombstoneType = tombstoneType;
    return this;
  }

  @Override
  public TombstoneMetadata set(String fieldName, Object value) {
    return (TombstoneMetadata) super.set(fieldName, value);
  }

  @Override
  public TombstoneMetadata clone() {
    return (TombstoneMetadata) super.clone();
  }
