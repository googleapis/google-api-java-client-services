...
public final class ListCustomRangesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<CustomRange> customRanges;

  static {
    // hack to force ProGuard to consider CustomRange used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(CustomRange.class);
  }
   ...
   */
  public ListCustomRangesResponse setUnreachable(java.util.List<java.lang.String> unreachable) {
    this.unreachable = unreachable;
    return this;
  }

  @Override
  public ListCustomRangesResponse set(String fieldName, Object value) {
    return (ListCustomRangesResponse) super.set(fieldName, value);
  }

  @Override
  public ListCustomRangesResponse clone() {
    return (ListCustomRangesResponse) super.clone();
  }
