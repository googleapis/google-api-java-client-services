...
public final class EnrolledService extends com.google.api.client.json.GenericJson {
   ...
   * Pub/Sub * Cloud Spanner * Cloud Storage * Google Kubernetes Engine * Persistent Disk Note:
   ...
   * container.googleapis.com * cloudkms.googleapis.com * compute.googleapis.com *
   * dataflow.googleapis.com * iam.googleapis.com * logging.googleapis.com * pubsub.googleapis.com *
   * spanner.googleapis.com * storage.googleapis.com Calls to UpdateAccessApprovalSettings using
   * 'all' or any of the XXX.googleapis.com will be translated to the associated product name
   * ('all', 'App Engine', etc.). Note: 'all' will enroll the resource in all products supported at
   * both 'GA' and 'Preview' levels. More information about levels of support is available at
