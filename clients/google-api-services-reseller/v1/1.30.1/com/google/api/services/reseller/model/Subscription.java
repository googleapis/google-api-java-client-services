 ...
 * transmitted over HTTP when working with the Google Apps Reseller API. For a detailed explanation
 * see:
...
public final class Subscription extends com.google.api.client.json.GenericJson {
   ...
   * APIs payment plans, see the API concepts.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private Plan plan;
  ...
  /**
   * URL to customers Subscriptions page in the Admin console. The read-only URL is generated by the
   * API service. This is used if your client application requires the customer to complete a task
   * using the Subscriptions page in the Admin console.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * A required property. The skuId is a unique system identifier for a products SKU assigned to a
  ...
  /**
   * Read-only external display name for a products SKU assigned to a customer in the subscription.
   * SKU names are subject to change at Googles discretion. For products and SKUs available in this
  ...
  /**
   * The plan property is required. In this version of the API, the G Suite plans are the flexible
   * plan, annual commitment plan, and the 30-day free trial plan. For more information about the APIs
  ...
  public static final class Plan extends com.google.api.client.json.GenericJson {
    ...
    /**
     * The isCommitmentPlan propertys boolean value identifies the plan as an annual commitment
     * plan:true  The subscriptions plan is an annual commitment plan.false  The plan is not an annual
     * commitment plan.
     * The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    ...
    /**
     * The planName property is required. This is the name of the subscriptions plan. For more
     ...
     * commitment plan with yearly payments   FLEXIBLE  The flexible plan   TRIAL  The 30-day free
     * trial plan. A subscription in trial will be suspended after the 30th free day if no payment
     * plan is assigned. Calling changePlan will assign a payment plan to a trial but will not
    ...
    public static final class CommitmentInterval extends com.google.api.client.json.GenericJson {
      ...
      /**
       * An annual commitment plans intervals endTime in milliseconds using the UNIX Epoch format. See
  ...
  public static final class TrialSettings extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Determines if a subscriptions plan is in a 30-day free trial or not:true  The plan is in
