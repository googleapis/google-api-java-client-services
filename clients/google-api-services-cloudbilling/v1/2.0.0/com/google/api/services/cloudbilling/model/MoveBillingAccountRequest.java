...
public final class MoveBillingAccountRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public MoveBillingAccountRequest set(String fieldName, Object value) {
    return (MoveBillingAccountRequest) super.set(fieldName, value);
  }

  @Override
  public MoveBillingAccountRequest clone() {
    return (MoveBillingAccountRequest) super.clone();
  }
