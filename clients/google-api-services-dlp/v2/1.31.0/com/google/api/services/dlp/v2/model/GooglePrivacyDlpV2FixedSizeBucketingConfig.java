 ...
 * {lower_bound}-{upper_bound}, i.e if lower_bound = 10 and upper_bound = 20 all values that are
 * within this bucket will be replaced with "10-20". This can be used on data of type: double, long.
 ...
 * comparing. See https://cloud.google.com/dlp/docs/concepts-bucketing to learn more.
 *
