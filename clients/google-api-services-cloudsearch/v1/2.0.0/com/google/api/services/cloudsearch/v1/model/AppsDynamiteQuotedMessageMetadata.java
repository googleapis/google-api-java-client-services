...
public final class AppsDynamiteQuotedMessageMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setAnnotations(java.util.List<AppsDynamiteAnnotation> annotations) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setAppProfile(AppsDynamiteSharedAppProfile appProfile) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setBotAttachmentState(java.lang.String botAttachmentState) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setCreatorId(AppsDynamiteUserId creatorId) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setLastUpdateTimeWhenQuotedMicros(java.lang.Long lastUpdateTimeWhenQuotedMicros) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setMessageId(AppsDynamiteMessageId messageId) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setMessageState(java.lang.String messageState) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setRetentionSettings(AppsDynamiteSharedRetentionSettings retentionSettings) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setTextBody(java.lang.String textBody) {
   ...
   */
  public AppsDynamiteQuotedMessageMetadata setUploadMetadata(java.util.List<AppsDynamiteUploadMetadata> uploadMetadata) {
    this.uploadMetadata = uploadMetadata;
    return this;
  }

  @Override
  public AppsDynamiteQuotedMessageMetadata set(String fieldName, Object value) {
    return (AppsDynamiteQuotedMessageMetadata) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteQuotedMessageMetadata clone() {
    return (AppsDynamiteQuotedMessageMetadata) super.clone();
  }
