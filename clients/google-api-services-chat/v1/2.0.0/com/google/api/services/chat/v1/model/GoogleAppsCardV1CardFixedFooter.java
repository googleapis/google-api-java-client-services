 ...
 * an error. [Google Workspace Add-ons and Chat
 * apps](https://developers.google.com/workspace/extend): For Chat apps, you can use fixed footers
 * in [dialogs](https://developers.google.com/chat/how-tos/dialogs), but not [card
