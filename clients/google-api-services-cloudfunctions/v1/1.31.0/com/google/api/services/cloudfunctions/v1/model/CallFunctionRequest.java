...
public final class CallFunctionRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CallFunctionRequest set(String fieldName, Object value) {
    return (CallFunctionRequest) super.set(fieldName, value);
  }

  @Override
  public CallFunctionRequest clone() {
    return (CallFunctionRequest) super.clone();
  }
