...
public final class GoogleDevtoolsCloudbuildV1Secret extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleDevtoolsCloudbuildV1Secret setKmsKeyName(java.lang.String kmsKeyName) {
   ...
   */
  public GoogleDevtoolsCloudbuildV1Secret setSecretEnv(java.util.Map<String, java.lang.String> secretEnv) {
    this.secretEnv = secretEnv;
    return this;
  }

  @Override
  public GoogleDevtoolsCloudbuildV1Secret set(String fieldName, Object value) {
    return (GoogleDevtoolsCloudbuildV1Secret) super.set(fieldName, value);
  }

  @Override
  public GoogleDevtoolsCloudbuildV1Secret clone() {
    return (GoogleDevtoolsCloudbuildV1Secret) super.clone();
  }
