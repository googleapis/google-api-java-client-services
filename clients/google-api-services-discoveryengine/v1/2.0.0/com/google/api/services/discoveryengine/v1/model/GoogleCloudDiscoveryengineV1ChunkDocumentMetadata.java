...
public final class GoogleCloudDiscoveryengineV1ChunkDocumentMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata setStructData(java.util.Map<String, java.lang.Object> structData) {
   ...
   */
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata setUri(java.lang.String uri) {
    this.uri = uri;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1ChunkDocumentMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1ChunkDocumentMetadata clone() {
    return (GoogleCloudDiscoveryengineV1ChunkDocumentMetadata) super.clone();
  }
