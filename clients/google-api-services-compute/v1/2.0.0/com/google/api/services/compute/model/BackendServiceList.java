...
public final class BackendServiceList extends com.google.api.client.json.GenericJson {
   ...
   */
  public BackendServiceList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public BackendServiceList setItems(java.util.List<BackendService> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public BackendServiceList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public BackendServiceList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendServiceList set(String fieldName, Object value) {
    return (BackendServiceList) super.set(fieldName, value);
  }

  @Override
  public BackendServiceList clone() {
    return (BackendServiceList) super.clone();
  }
