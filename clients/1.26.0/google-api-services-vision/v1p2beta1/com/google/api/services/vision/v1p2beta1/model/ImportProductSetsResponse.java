...
public final class ImportProductSetsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public ImportProductSetsResponse setReferenceImages(java.util.List<ReferenceImage> referenceImages) {
   ...
   */
  public ImportProductSetsResponse setStatuses(java.util.List<Status> statuses) {
    this.statuses = statuses;
    return this;
  }

  @Override
  public ImportProductSetsResponse set(String fieldName, Object value) {
    return (ImportProductSetsResponse) super.set(fieldName, value);
  }
