...
public final class Topic extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The name of the topic, generated by the user. Leading and trailing whitespaces, if any, are
   * trimmed. Also, multiple consecutive whitespaces are collapsed into one inside the name. The
