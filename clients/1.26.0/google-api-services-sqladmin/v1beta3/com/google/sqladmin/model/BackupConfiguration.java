...
public final class BackupConfiguration extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Identifier for this configuration. This gets generated automatically when a backup
  ...
  /**
   * Whether replication log archiving is enabled. Replication log archiving is required for the
   * point-in-time recovery (PITR) feature. PostgreSQL instances only.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public BackupConfiguration setId(java.lang.String id) {
    this.id = id;
    return this;
  }
