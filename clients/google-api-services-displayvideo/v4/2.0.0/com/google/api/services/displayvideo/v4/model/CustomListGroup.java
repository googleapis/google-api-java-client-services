...
/**
 * Details of custom list group. All custom list targeting settings are logically ‘OR’ of each
 * other.
 *
...
public final class CustomListGroup extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CustomListGroup set(String fieldName, Object value) {
    return (CustomListGroup) super.set(fieldName, value);
  }

  @Override
  public CustomListGroup clone() {
    return (CustomListGroup) super.clone();
  }
