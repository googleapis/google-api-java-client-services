...
public final class GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudDiscoveryengineV1alphaInterval> intervals;

  static {
    // hack to force ProGuard to consider GoogleCloudDiscoveryengineV1alphaInterval used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudDiscoveryengineV1alphaInterval.class);
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setCaseInsensitive(java.lang.Boolean caseInsensitive) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudDiscoveryengineV1alphaInterval> getIntervals() {
    return intervals;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setIntervals(java.util.List<GoogleCloudDiscoveryengineV1alphaInterval> intervals) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setKey(java.lang.String key) {
    this.key = key;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setOrderBy(java.lang.String orderBy) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setPrefixes(java.util.List<java.lang.String> prefixes) {
   ...
   */
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey setRestrictedValues(java.util.List<java.lang.String> restrictedValues) {
    this.restrictedValues = restrictedValues;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey clone() {
