...
public class DataPortability extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ArchiveJobs {
    ...
    public class GetPortabilityArchiveState extends DataPortabilityRequest<com.google.api.services.dataportability.v1.model.PortabilityArchiveState> {
     ...
     *        the InitiatePortabilityArchiveResponse.
      ...
      protected GetPortabilityArchiveState(java.lang.String name) {
        super(DataPortability.this, "GET", REST_PATH, null, com.google.api.services.dataportability.v1.model.PortabilityArchiveState.class);
     ...
     * @param content the {@link com.google.api.services.dataportability.v1.model.RetryPortabilityArchiveRequest}
     * @return the request
     */
    public Retry retry(java.lang.String name, com.google.api.services.dataportability.v1.model.RetryPortabilityArchiveRequest content) throws java.io.IOException {
      Retry result = new Retry(name, content);
      initialize(result);
      return result;
    }

    public class Retry extends DataPortabilityRequest<com.google.api.services.dataportability.v1.model.RetryPortabilityArchiveResponse> {
     ...
     *        InitiatePortabilityArchiveResponse. Retrying is only executed if the initial job failed.
       ...
       * @since 1.13
       */
      protected Retry(java.lang.String name, com.google.api.services.dataportability.v1.model.RetryPortabilityArchiveRequest content) {
        super(DataPortability.this, "POST", REST_PATH, content, com.google.api.services.dataportability.v1.model.RetryPortabilityArchiveResponse.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
  ...
  public class Authorization {
     ...
     *
     * @param content the {@link com.google.api.services.dataportability.v1.model.ResetAuthorizationRequest}
     * @return the request
     */
    public Reset reset(com.google.api.services.dataportability.v1.model.ResetAuthorizationRequest content) throws java.io.IOException {
      Reset result = new Reset(content);
      initialize(result);
      return result;
    }

    public class Reset extends DataPortabilityRequest<com.google.api.services.dataportability.v1.model.Empty> {

      private static final String REST_PATH = "v1/authorization:reset";
       ...
       * @since 1.13
       */
      protected Reset(com.google.api.services.dataportability.v1.model.ResetAuthorizationRequest content) {
        super(DataPortability.this, "POST", REST_PATH, content, com.google.api.services.dataportability.v1.model.Empty.class);
      }
  ...
  public class PortabilityArchive {
     ...
     *
     * @param content the {@link com.google.api.services.dataportability.v1.model.InitiatePortabilityArchiveRequest}
     * @return the request
     */
    public Initiate initiate(com.google.api.services.dataportability.v1.model.InitiatePortabilityArchiveRequest content) throws java.io.IOException {
      Initiate result = new Initiate(content);
      initialize(result);
      return result;
    }

    public class Initiate extends DataPortabilityRequest<com.google.api.services.dataportability.v1.model.InitiatePortabilityArchiveResponse> {

      private static final String REST_PATH = "v1/portabilityArchive:initiate";
       ...
       * @since 1.13
       */
      protected Initiate(com.google.api.services.dataportability.v1.model.InitiatePortabilityArchiveRequest content) {
        super(DataPortability.this, "POST", REST_PATH, content, com.google.api.services.dataportability.v1.model.InitiatePortabilityArchiveResponse.class);
      }
