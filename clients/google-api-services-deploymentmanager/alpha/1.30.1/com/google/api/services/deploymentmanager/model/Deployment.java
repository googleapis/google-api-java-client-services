...
public final class Deployment extends com.google.api.client.json.GenericJson {
   ...
   * and `cancelPreview()` requests. A fingerprint is a randomly generated value that must be
   * provided with `update()`, `stop()`, and `cancelPreview()` requests to perform optimistic
   * locking. This ensures optimistic concurrency so that only one request happens at a time. The
   * fingerprint is initially generated by Deployment Manager and changes after every request to
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<DeploymentOutputEntry> outputs;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<DeploymentOutputEntry> getOutputs() {
    return outputs;
  }
   ...
   */
  public Deployment setOutputs(java.util.List<DeploymentOutputEntry> outputs) {
