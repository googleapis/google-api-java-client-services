...
public final class BackendServiceAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, BackendServicesScopedList> items;
   ...
   */
  public BackendServiceAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, BackendServicesScopedList> getItems() {
    return items;
  }
   ...
   */
  public BackendServiceAggregatedList setItems(java.util.Map<String, BackendServicesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public BackendServiceAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public BackendServiceAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public BackendServiceAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public BackendServiceAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public BackendServiceAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public BackendServiceAggregatedList set(String fieldName, Object value) {
    return (BackendServiceAggregatedList) super.set(fieldName, value);
  }

  @Override
  public BackendServiceAggregatedList clone() {
    return (BackendServiceAggregatedList) super.clone();
  }
