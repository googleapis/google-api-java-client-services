...
public class Iam extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Identity and Access Management (IAM) API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class IamPolicies {
     ...
     *
     * @param content the {@link com.google.iam.v1.model.LintPolicyRequest}
     * @return the request
     */
    public LintPolicy lintPolicy(com.google.iam.v1.model.LintPolicyRequest content) throws java.io.IOException {
      LintPolicy result = new LintPolicy(content);
      initialize(result);
      return result;
    }

    public class LintPolicy extends IamRequest<com.google.iam.v1.model.LintPolicyResponse> {
       ...
       * @since 1.13
       */
      protected LintPolicy(com.google.iam.v1.model.LintPolicyRequest content) {
        super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.LintPolicyResponse.class);
      }
     ...
     * operation.
     *
     * @param content the {@link com.google.iam.v1.model.QueryAuditableServicesRequest}
     * @return the request
     */
    public QueryAuditableServices queryAuditableServices(com.google.iam.v1.model.QueryAuditableServicesRequest content) throws java.io.IOException {
      QueryAuditableServices result = new QueryAuditableServices(content);
      initialize(result);
      return result;
    }

    public class QueryAuditableServices extends IamRequest<com.google.iam.v1.model.QueryAuditableServicesResponse> {
       ...
       * @since 1.13
       */
      protected QueryAuditableServices(com.google.iam.v1.model.QueryAuditableServicesRequest content) {
        super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.QueryAuditableServicesResponse.class);
      }
  ...
  public class Organizations {
    ...
    public class Roles {
      ...
      `projects/{PROJECT_ID}`
       * @param content the {@link com.google.iam.v1.model.CreateRoleRequest}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.iam.v1.model.CreateRoleRequest content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends IamRequest<com.google.iam.v1.model.Role> {
      ...
      `projects/{PROJECT_ID}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.iam.v1.model.CreateRoleRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.Role.class);
      ...
      public class Delete extends IamRequest<com.google.iam.v1.model.Role> {
       ...
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
        ...
        protected Delete(java.lang.String name) {
          super(Iam.this, "DELETE", REST_PATH, null, com.google.iam.v1.model.Role.class);
      ...
      public class Get extends IamRequest<com.google.iam.v1.model.Role> {
       ...
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
        ...
        protected Get(java.lang.String name) {
          super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.Role.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends IamRequest<com.google.iam.v1.model.ListRolesResponse> {
      ...
      `projects/{PROJECT_ID}`
        ...
        protected List(java.lang.String parent) {
          super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.ListRolesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       *        `organizations/{ORGANIZATION_ID}/roles/{ROLE_NAME}`
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
       * @param content the {@link com.google.iam.v1.model.Role}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.iam.v1.model.Role content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends IamRequest<com.google.iam.v1.model.Role> {
       ...
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.iam.v1.model.Role content) {
          super(Iam.this, "PATCH", REST_PATH, content, com.google.iam.v1.model.Role.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        `organizations/{ORGANIZATION_ID}/roles/{ROLE_NAME}`
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
       * @param content the {@link com.google.iam.v1.model.UndeleteRoleRequest}
       * @return the request
       */
      public Undelete undelete(java.lang.String name, com.google.iam.v1.model.UndeleteRoleRequest content) throws java.io.IOException {
        Undelete result = new Undelete(name, content);
        initialize(result);
        return result;
      }

      public class Undelete extends IamRequest<com.google.iam.v1.model.Role> {
       ...
       *        `projects/{PROJECT_ID}/roles/{ROLE_NAME}`
         ...
         * @since 1.13
         */
        protected Undelete(java.lang.String name, com.google.iam.v1.model.UndeleteRoleRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.Role.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public class Permissions {
     ...
     * operation.
     *
     * @param content the {@link com.google.iam.v1.model.QueryTestablePermissionsRequest}
     * @return the request
     */
    public QueryTestablePermissions queryTestablePermissions(com.google.iam.v1.model.QueryTestablePermissionsRequest content) throws java.io.IOException {
      QueryTestablePermissions result = new QueryTestablePermissions(content);
      initialize(result);
      return result;
    }

    public class QueryTestablePermissions extends IamRequest<com.google.iam.v1.model.QueryTestablePermissionsResponse> {
       ...
       * @since 1.13
       */
      protected QueryTestablePermissions(com.google.iam.v1.model.QueryTestablePermissionsRequest content) {
        super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.QueryTestablePermissionsResponse.class);
      }
  ...
  public class Projects {
    ...
    public class ServiceAccounts {
       ...
       *        /my-project-123`.
       * @param content the {@link com.google.iam.v1.model.CreateServiceAccountRequest}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.iam.v1.model.CreateServiceAccountRequest content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends IamRequest<com.google.iam.v1.model.ServiceAccount> {
       ...
       *        /my-project-123`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.iam.v1.model.CreateServiceAccountRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.ServiceAccount.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Delete extends IamRequest<com.google.iam.v1.model.Empty> {
      ...
      `unique_id` of the service account.
         ...
         */
        protected Delete(java.lang.String name) {
          super(Iam.this, "DELETE", REST_PATH, null, com.google.iam.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends IamRequest<com.google.iam.v1.model.ServiceAccount> {
      ...
      `unique_id` of the service account.
         ...
         */
        protected Get(java.lang.String name) {
          super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.ServiceAccount.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class GetIamPolicy extends IamRequest<com.google.iam.v1.model.Policy> {
       ...
       *        the appropriate value for this field.
        ...
        protected GetIamPolicy(java.lang.String resource) {
          super(Iam.this, "POST", REST_PATH, null, com.google.iam.v1.model.Policy.class);
      ...
      public class List extends IamRequest<com.google.iam.v1.model.ListServiceAccountsResponse> {
       ...
       *        /my-project-123`.
        ...
        protected List(java.lang.String name) {
          super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.ListServiceAccountsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      See the operation documentation for
       *        the appropriate value for this field.
       * @param content the {@link com.google.iam.v1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.iam.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends IamRequest<com.google.iam.v1.model.Policy> {
       ...
       *        the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.iam.v1.model.SetIamPolicyRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
       ...
       *        `email` address or the
      `unique_id` of the service account.
       * @param content the {@link com.google.iam.v1.model.SignBlobRequest}
       * @return the request
       */
      public SignBlob signBlob(java.lang.String name, com.google.iam.v1.model.SignBlobRequest content) throws java.io.IOException {
        SignBlob result = new SignBlob(name, content);
        initialize(result);
        return result;
      }

      public class SignBlob extends IamRequest<com.google.iam.v1.model.SignBlobResponse> {
      ...
      `unique_id` of the service account.
         ...
         * @since 1.13
         */
        protected SignBlob(java.lang.String name, com.google.iam.v1.model.SignBlobRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.SignBlobResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        `email` address or the
      `unique_id` of the service account.
       * @param content the {@link com.google.iam.v1.model.SignJwtRequest}
       * @return the request
       */
      public SignJwt signJwt(java.lang.String name, com.google.iam.v1.model.SignJwtRequest content) throws java.io.IOException {
        SignJwt result = new SignJwt(name, content);
        initialize(result);
        return result;
      }

      public class SignJwt extends IamRequest<com.google.iam.v1.model.SignJwtResponse> {
      ...
      `unique_id` of the service account.
         ...
         * @since 1.13
         */
        protected SignJwt(java.lang.String name, com.google.iam.v1.model.SignJwtRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.SignJwtResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      See the operation
       *        documentation for the appropriate value for this field.
       * @param content the {@link com.google.iam.v1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.iam.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends IamRequest<com.google.iam.v1.model.TestIamPermissionsResponse> {
       ...
       *        documentation for the appropriate value for this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.iam.v1.model.TestIamPermissionsRequest content) {
          super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
      ...
      `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`.
       * @param content the {@link com.google.iam.v1.model.ServiceAccount}
       * @return the request
       */
      public Update update(java.lang.String name, com.google.iam.v1.model.ServiceAccount content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends IamRequest<com.google.iam.v1.model.ServiceAccount> {
      ...
      `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`.
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.iam.v1.model.ServiceAccount content) {
          super(Iam.this, "PUT", REST_PATH, content, com.google.iam.v1.model.ServiceAccount.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Keys {
         ...
         *        `email` address or the
        `unique_id` of the service account.
         * @param content the {@link com.google.iam.v1.model.CreateServiceAccountKeyRequest}
         * @return the request
         */
        public Create create(java.lang.String name, com.google.iam.v1.model.CreateServiceAccountKeyRequest content) throws java.io.IOException {
          Create result = new Create(name, content);
          initialize(result);
          return result;
        }

        public class Create extends IamRequest<com.google.iam.v1.model.ServiceAccountKey> {
        ...
        `unique_id` of the service account.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String name, com.google.iam.v1.model.CreateServiceAccountKeyRequest content) {
            super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.ServiceAccountKey.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends IamRequest<com.google.iam.v1.model.ServiceAccountKey> {
        ...
        `unique_id` of the service account.
           ...
           */
          protected Get(java.lang.String name) {
            super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.ServiceAccountKey.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends IamRequest<com.google.iam.v1.model.ListServiceAccountKeysResponse> {
        ...
        `unique_id` of the service account.
           ...
           */
          protected List(java.lang.String name) {
            super(Iam.this, "GET", REST_PATH, null, com.google.iam.v1.model.ListServiceAccountKeysResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
  ...
  public class Roles {
     ...
     *
     * @param content the {@link com.google.iam.v1.model.QueryGrantableRolesRequest}
     * @return the request
     */
    public QueryGrantableRoles queryGrantableRoles(com.google.iam.v1.model.QueryGrantableRolesRequest content) throws java.io.IOException {
      QueryGrantableRoles result = new QueryGrantableRoles(content);
      initialize(result);
      return result;
    }

    public class QueryGrantableRoles extends IamRequest<com.google.iam.v1.model.QueryGrantableRolesResponse> {
       ...
       * @since 1.13
       */
      protected QueryGrantableRoles(com.google.iam.v1.model.QueryGrantableRolesRequest content) {
        super(Iam.this, "POST", REST_PATH, content, com.google.iam.v1.model.QueryGrantableRolesResponse.class);
      }
