...
public final class UserPermission extends com.google.api.client.json.GenericJson {
   ...
   */
  public UserPermission setAccountId(java.lang.String accountId) {
   ...
   */
  public UserPermission setPath(java.lang.String path) {
    this.path = path;
    return this;
  }

  @Override
  public UserPermission set(String fieldName, Object value) {
    return (UserPermission) super.set(fieldName, value);
  }
