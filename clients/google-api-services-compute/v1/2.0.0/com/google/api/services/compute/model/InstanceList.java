...
public final class InstanceList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. [Output Only] Type of resource. Always compute#instanceList for lists of Instance
   * resources.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public InstanceList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public InstanceList setItems(java.util.List<Instance> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstanceList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public InstanceList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstanceList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public InstanceList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceList set(String fieldName, Object value) {
    return (InstanceList) super.set(fieldName, value);
  }

  @Override
  public InstanceList clone() {
    return (InstanceList) super.clone();
  }
