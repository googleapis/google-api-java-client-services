...
public class CloudResourceManager extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Cloud Resource Manager API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class Search extends CloudResourceManagerRequest<com.google.api.services.cloudresourcemanager.v3.model.SearchProjectsResponse> {
     ...
     where listing should continue.
       ...
       * label `color` has the value `red` and its label `size` has the value `big`.| If no query is
