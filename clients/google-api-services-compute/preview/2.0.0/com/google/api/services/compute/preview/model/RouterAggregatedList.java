...
public final class RouterAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, RoutersScopedList> items;
   ...
   */
  public RouterAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, RoutersScopedList> getItems() {
    return items;
  }
   ...
   */
  public RouterAggregatedList setItems(java.util.Map<String, RoutersScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RouterAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RouterAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RouterAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RouterAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public RouterAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RouterAggregatedList set(String fieldName, Object value) {
    return (RouterAggregatedList) super.set(fieldName, value);
  }

  @Override
  public RouterAggregatedList clone() {
    return (RouterAggregatedList) super.clone();
  }
