...
/**
 * Model definition for SslPoliciesScopedList.
 *
...
public final class SslPoliciesScopedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A list of SslPolicies contained in this scope.
   * @param sslPolicies sslPolicies or {@code null} for none
   */
  public SslPoliciesScopedList setSslPolicies(java.util.List<SslPolicy> sslPolicies) {
   ...
   */
  public SslPoliciesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public SslPoliciesScopedList set(String fieldName, Object value) {
    return (SslPoliciesScopedList) super.set(fieldName, value);
  }

  @Override
  public SslPoliciesScopedList clone() {
    return (SslPoliciesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for SslPoliciesScopedListWarningData.
     */
