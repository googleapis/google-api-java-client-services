...
public final class TargetVpnGatewayList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetVpnGateway> items;

  static {
    // hack to force ProGuard to consider TargetVpnGateway used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetVpnGateway.class);
  }
   ...
   */
  public TargetVpnGatewayList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetVpnGateway> getItems() {
    return items;
  }
   ...
   */
  public TargetVpnGatewayList setItems(java.util.List<TargetVpnGateway> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetVpnGatewayList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetVpnGatewayList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetVpnGatewayList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetVpnGatewayList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetVpnGatewayList set(String fieldName, Object value) {
    return (TargetVpnGatewayList) super.set(fieldName, value);
  }

  @Override
  public TargetVpnGatewayList clone() {
    return (TargetVpnGatewayList) super.clone();
  }
