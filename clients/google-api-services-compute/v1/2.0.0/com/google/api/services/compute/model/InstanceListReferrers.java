...
public final class InstanceListReferrers extends com.google.api.client.json.GenericJson {
   ...
   */
  public InstanceListReferrers setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Reference> getItems() {
    return items;
  }
   ...
   */
  public InstanceListReferrers setItems(java.util.List<Reference> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstanceListReferrers setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstanceListReferrers setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstanceListReferrers set(String fieldName, Object value) {
    return (InstanceListReferrers) super.set(fieldName, value);
  }

  @Override
  public InstanceListReferrers clone() {
    return (InstanceListReferrers) super.clone();
  }
