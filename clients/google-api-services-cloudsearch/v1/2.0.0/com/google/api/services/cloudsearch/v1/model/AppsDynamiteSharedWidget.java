...
public final class AppsDynamiteSharedWidget extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private AppsDynamiteSharedColumns columns;
   ...
   */
  @com.google.api.client.util.Key
  private AppsDynamiteSharedDivider divider;
   ...
   */
  @com.google.api.client.util.Key
  private AppsDynamiteSharedGrid grid;
   ...
   */
  public AppsDynamiteSharedWidget setButtonList(AppsDynamiteSharedButtonList buttonList) {
   ...
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedColumns getColumns() {
    return columns;
  }
   ...
   */
  public AppsDynamiteSharedWidget setColumns(AppsDynamiteSharedColumns columns) {
   ...
   */
  public AppsDynamiteSharedWidget setDateTimePicker(AppsDynamiteSharedDateTimePicker dateTimePicker) {
   ...
   */
  public AppsDynamiteSharedWidget setDecoratedText(AppsDynamiteSharedDecoratedText decoratedText) {
   ...
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedDivider getDivider() {
    return divider;
  }
   ...
   */
  public AppsDynamiteSharedWidget setDivider(AppsDynamiteSharedDivider divider) {
   ...
   * @return value or {@code null} for none
   */
  public AppsDynamiteSharedGrid getGrid() {
    return grid;
  }
   ...
   */
  public AppsDynamiteSharedWidget setGrid(AppsDynamiteSharedGrid grid) {
    this.grid = grid;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedWidget setHorizontalAlignment(java.lang.String horizontalAlignment) {
   ...
   */
  public AppsDynamiteSharedWidget setImage(AppsDynamiteSharedImage image) {
    this.image = image;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedWidget setSelectionInput(AppsDynamiteSharedSelectionInput selectionInput) {
   ...
   */
  public AppsDynamiteSharedWidget setTextInput(AppsDynamiteSharedTextInput textInput) {
   ...
   */
  public AppsDynamiteSharedWidget setTextParagraph(AppsDynamiteSharedTextParagraph textParagraph) {
    this.textParagraph = textParagraph;
    return this;
  }

  @Override
  public AppsDynamiteSharedWidget set(String fieldName, Object value) {
    return (AppsDynamiteSharedWidget) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedWidget clone() {
    return (AppsDynamiteSharedWidget) super.clone();
  }
