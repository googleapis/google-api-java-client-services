...
public final class RegionSetPolicyRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public RegionSetPolicyRequest setBindings(java.util.List<Binding> bindings) {
   ...
   */
  public RegionSetPolicyRequest setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   * @since 1.14
   */
  public RegionSetPolicyRequest encodeEtag(byte[] etag) {
   ...
   */
  public RegionSetPolicyRequest setPolicy(Policy policy) {
    this.policy = policy;
    return this;
  }

  @Override
  public RegionSetPolicyRequest set(String fieldName, Object value) {
    return (RegionSetPolicyRequest) super.set(fieldName, value);
  }

  @Override
  public RegionSetPolicyRequest clone() {
    return (RegionSetPolicyRequest) super.clone();
  }
