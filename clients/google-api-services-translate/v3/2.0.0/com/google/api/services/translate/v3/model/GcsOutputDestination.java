...
public final class GcsOutputDestination extends com.google.api.client.json.GenericJson {

  /**
   * Required. Google Cloud Storage URI to output directory. For example, `gs://bucket/directory`.
   * The requesting user must have write permission to the bucket. The directory will be created if
   * it doesn't exist.
   ...
   */
  public GcsOutputDestination setOutputUriPrefix(java.lang.String outputUriPrefix) {
    this.outputUriPrefix = outputUriPrefix;
    return this;
  }

  @Override
  public GcsOutputDestination set(String fieldName, Object value) {
    return (GcsOutputDestination) super.set(fieldName, value);
  }

  @Override
  public GcsOutputDestination clone() {
    return (GcsOutputDestination) super.clone();
  }
