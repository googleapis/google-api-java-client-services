...
public final class BatchAnnotateFilesRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AnnotateFileRequest> requests;

  static {
    // hack to force ProGuard to consider AnnotateFileRequest used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(AnnotateFileRequest.class);
  }
   ...
   */
  public BatchAnnotateFilesRequest setLabels(java.util.Map<String, java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public BatchAnnotateFilesRequest setParent(java.lang.String parent) {
    this.parent = parent;
    return this;
  }
  ...
  @Override
  public BatchAnnotateFilesRequest set(String fieldName, Object value) {
    return (BatchAnnotateFilesRequest) super.set(fieldName, value);
  }
