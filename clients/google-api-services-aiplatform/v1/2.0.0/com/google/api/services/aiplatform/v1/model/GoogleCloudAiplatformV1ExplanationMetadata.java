...
public final class GoogleCloudAiplatformV1ExplanationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataInputMetadata> inputs;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataOutputMetadata> outputs;
   ...
   */
  public GoogleCloudAiplatformV1ExplanationMetadata setFeatureAttributionsSchemaUri(java.lang.String featureAttributionsSchemaUri) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataInputMetadata> getInputs() {
    return inputs;
  }
   ...
   */
  public GoogleCloudAiplatformV1ExplanationMetadata setInputs(java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataInputMetadata> inputs) {
    this.inputs = inputs;
    return this;
  }
   ...
   */
  public GoogleCloudAiplatformV1ExplanationMetadata setLatentSpaceSource(java.lang.String latentSpaceSource) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataOutputMetadata> getOutputs() {
    return outputs;
  }
   ...
   */
  public GoogleCloudAiplatformV1ExplanationMetadata setOutputs(java.util.Map<String, GoogleCloudAiplatformV1ExplanationMetadataOutputMetadata> outputs) {
    this.outputs = outputs;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1ExplanationMetadata set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1ExplanationMetadata) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1ExplanationMetadata clone() {
