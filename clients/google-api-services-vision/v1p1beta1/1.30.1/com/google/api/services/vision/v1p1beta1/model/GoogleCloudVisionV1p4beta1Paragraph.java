...
public final class GoogleCloudVisionV1p4beta1Paragraph extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVisionV1p4beta1Word> words;
   ...
   */
  public GoogleCloudVisionV1p4beta1Paragraph setBoundingBox(GoogleCloudVisionV1p4beta1BoundingPoly boundingBox) {
   ...
   */
  public GoogleCloudVisionV1p4beta1Paragraph setConfidence(java.lang.Float confidence) {
   ...
   */
  public GoogleCloudVisionV1p4beta1Paragraph setProperty(GoogleCloudVisionV1p4beta1TextAnnotationTextProperty property) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudVisionV1p4beta1Word> getWords() {
    return words;
  }
   ...
   */
  public GoogleCloudVisionV1p4beta1Paragraph setWords(java.util.List<GoogleCloudVisionV1p4beta1Word> words) {
    this.words = words;
    return this;
  }

  @Override
  public GoogleCloudVisionV1p4beta1Paragraph set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p4beta1Paragraph) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p4beta1Paragraph clone() {
