...
/**
 * Model definition for QueuedResourceList.
 *
...
public final class QueuedResourceList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<QueuedResource> items;
   ...
   */
  public QueuedResourceList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<QueuedResource> getItems() {
    return items;
  }
   ...
   */
  public QueuedResourceList setItems(java.util.List<QueuedResource> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public QueuedResourceList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public QueuedResourceList set(String fieldName, Object value) {
    return (QueuedResourceList) super.set(fieldName, value);
  }

  @Override
  public QueuedResourceList clone() {
    return (QueuedResourceList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for QueuedResourceListWarningData.
     */
