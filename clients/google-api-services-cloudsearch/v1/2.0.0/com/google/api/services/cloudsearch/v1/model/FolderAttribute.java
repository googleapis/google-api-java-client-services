...
public final class FolderAttribute extends com.google.api.client.json.GenericJson {
   ...
   */
  public FolderAttribute setFolder(java.util.List<Folder> folder) {
    this.folder = folder;
    return this;
  }

  @Override
  public FolderAttribute set(String fieldName, Object value) {
    return (FolderAttribute) super.set(fieldName, value);
  }

  @Override
  public FolderAttribute clone() {
    return (FolderAttribute) super.clone();
  }
