...
public final class GoogleCloudDataplexV1Partition extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. The values must be HTML URL encoded two times before constructing the path. For
   * example, if you have a value of "US:CA", encoded it two times and you get "US%253ACA". Then if
   * you have the 2nd value is "CA#Sunnyvale", encoded two times and you get "CA%2523Sunnyvale". The
   * partition values path is "US%253ACA/CA%2523Sunnyvale". The final URL will be
   * "https://.../partitions/US%253ACA/CA%2523Sunnyvale". The name field in the responses will
   * always have the encoded format.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
