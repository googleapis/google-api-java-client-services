 ...
 * they may still fail upon later execution (for example, if a statement from another batch of
 ...
 * fails, all subsequent statements in the batch are automatically cancelled. Each batch of
 * statements is assigned a name which can be used with the Operations API to monitor progress. See
