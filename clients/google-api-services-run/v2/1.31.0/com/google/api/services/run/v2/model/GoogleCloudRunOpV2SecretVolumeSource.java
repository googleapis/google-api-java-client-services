...
public final class GoogleCloudRunOpV2SecretVolumeSource extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudRunOpV2VersionToPath> items;
   ...
   */
  public GoogleCloudRunOpV2SecretVolumeSource setDefaultMode(java.lang.Integer defaultMode) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudRunOpV2VersionToPath> getItems() {
    return items;
  }
   ...
   */
  public GoogleCloudRunOpV2SecretVolumeSource setItems(java.util.List<GoogleCloudRunOpV2VersionToPath> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public GoogleCloudRunOpV2SecretVolumeSource setSecret(java.lang.String secret) {
    this.secret = secret;
    return this;
  }

  @Override
  public GoogleCloudRunOpV2SecretVolumeSource set(String fieldName, Object value) {
    return (GoogleCloudRunOpV2SecretVolumeSource) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRunOpV2SecretVolumeSource clone() {
