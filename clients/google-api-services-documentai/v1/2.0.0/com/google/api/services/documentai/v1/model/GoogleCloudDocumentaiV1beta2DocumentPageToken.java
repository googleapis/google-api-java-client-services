...
public final class GoogleCloudDocumentaiV1beta2DocumentPageToken extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDocumentaiV1beta2DocumentPageToken setDetectedBreak(GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak detectedBreak) {
   ...
   */
  public GoogleCloudDocumentaiV1beta2DocumentPageToken setDetectedLanguages(java.util.List<GoogleCloudDocumentaiV1beta2DocumentPageDetectedLanguage> detectedLanguages) {
   ...
   */
  public GoogleCloudDocumentaiV1beta2DocumentPageToken setLayout(GoogleCloudDocumentaiV1beta2DocumentPageLayout layout) {
    this.layout = layout;
    return this;
  }
   ...
   */
  public GoogleCloudDocumentaiV1beta2DocumentPageToken setProvenance(GoogleCloudDocumentaiV1beta2DocumentProvenance provenance) {
   ...
   */
  public GoogleCloudDocumentaiV1beta2DocumentPageToken setStyleInfo(GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo styleInfo) {
    this.styleInfo = styleInfo;
    return this;
  }

  @Override
  public GoogleCloudDocumentaiV1beta2DocumentPageToken set(String fieldName, Object value) {
    return (GoogleCloudDocumentaiV1beta2DocumentPageToken) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDocumentaiV1beta2DocumentPageToken clone() {
    return (GoogleCloudDocumentaiV1beta2DocumentPageToken) super.clone();
  }
