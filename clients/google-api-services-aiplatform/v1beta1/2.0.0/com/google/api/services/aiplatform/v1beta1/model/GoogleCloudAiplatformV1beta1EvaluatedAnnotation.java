...
public final class GoogleCloudAiplatformV1beta1EvaluatedAnnotation extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> errorAnalysisAnnotations;

  static {
    // hack to force ProGuard to consider GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> explanations;
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setDataItemPayload(java.lang.Object dataItemPayload) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> getErrorAnalysisAnnotations() {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setErrorAnalysisAnnotations(java.util.List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> errorAnalysisAnnotations) {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setEvaluatedDataItemViewId(java.lang.String evaluatedDataItemViewId) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> getExplanations() {
    return explanations;
  }
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setExplanations(java.util.List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> explanations) {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setGroundTruths(java.util.List<java.lang.Object> groundTruths) {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setPredictions(java.util.List<java.lang.Object> predictions) {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation setType(java.lang.String type) {
    this.type = type;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1EvaluatedAnnotation) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation clone() {
    return (GoogleCloudAiplatformV1beta1EvaluatedAnnotation) super.clone();
  }
