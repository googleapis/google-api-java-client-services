...
public final class GenaiVertexV1beta1GoogleMapsResultContent extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<GenaiVertexV1beta1GoogleMapsResultContentGoogleMapsResult> result;

  /**
   * Required. The results of the Google Maps.
   * @return value or {@code null} for none
   */
  public java.util.List<GenaiVertexV1beta1GoogleMapsResultContentGoogleMapsResult> getResult() {
    return result;
  }
   ...
   */
  public GenaiVertexV1beta1GoogleMapsResultContent setResult(java.util.List<GenaiVertexV1beta1GoogleMapsResultContentGoogleMapsResult> result) {
    this.result = result;
    return this;
  }
