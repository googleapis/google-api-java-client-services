...
public class Recommender extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Recommender API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Organizations {
    ...
    public class Locations {
      ...
      public class InsightTypes {
        ...
        public class GetConfig extends RecommenderRequest<com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig> {
         ...
         *        `organizations/[ORGANIZATION_ID]/locations/global/recommenders/[INSIGHT_TYPE_ID]/config`
          ...
          protected GetConfig(java.lang.String name) {
            super(Recommender.this, "GET", REST_PATH, null, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig}
         * @return the request
         */
        public UpdateConfig updateConfig(java.lang.String name, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig content) throws java.io.IOException {
          UpdateConfig result = new UpdateConfig(name, content);
          initialize(result);
          return result;
        }

        public class UpdateConfig extends RecommenderRequest<com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig> {
         ...
         *        projects/[PROJECT_NUMBER]/locations/[LOCATION]/insightTypes/[INSIGHT_TYPE_ID]/config
           ...
           * @since 1.13
           */
          protected UpdateConfig(java.lang.String name, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig content) {
            super(Recommender.this, "PATCH", REST_PATH, content, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1InsightTypeConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Recommenders {
        ...
        public class GetConfig extends RecommenderRequest<com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig> {
         ...
         *        izations/[ORGANIZATION_ID]/locations/[LOCATION]/recommenders/[RECOMMENDER_ID]/config`
           ...
           */
          protected GetConfig(java.lang.String name) {
            super(Recommender.this, "GET", REST_PATH, null, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         *        projects/[PROJECT_NUMBER]/locations/[LOCATION]/recommenders/[RECOMMENDER_ID]/config
         * @param content the {@link com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig}
         * @return the request
         */
        public UpdateConfig updateConfig(java.lang.String name, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig content) throws java.io.IOException {
          UpdateConfig result = new UpdateConfig(name, content);
          initialize(result);
          return result;
        }

        public class UpdateConfig extends RecommenderRequest<com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig> {
         ...
         *        projects/[PROJECT_NUMBER]/locations/[LOCATION]/recommenders/[RECOMMENDER_ID]/config
           ...
           * @since 1.13
           */
          protected UpdateConfig(java.lang.String name, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig content) {
            super(Recommender.this, "PATCH", REST_PATH, content, com.google.api.services.recommender.v1.model.GoogleCloudRecommenderV1RecommenderConfig.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
