...
public class BigLakeService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Catalogs {
      ...
      public class GetIamPolicy extends BigLakeServiceRequest<com.google.api.services.biglake.v1.model.Policy> {

        private static final String REST_PATH = "v1/{+resource}:getIamPolicy";

        private final java.util.regex.Pattern RESOURCE_PATTERN =
            java.util.regex.Pattern.compile("^projects/[^/]+/catalogs/[^/]+$");
       ...
       *        this field.
        ...
        protected GetIamPolicy(java.lang.String resource) {
          super(BigLakeService.this, "GET", REST_PATH, null, com.google.api.services.biglake.v1.model.Policy.class);
       ...
       *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
       *        this field.
       * @param content the {@link com.google.api.services.biglake.v1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.api.services.biglake.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends BigLakeServiceRequest<com.google.api.services.biglake.v1.model.Policy> {
       ...
       *        this field.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.api.services.biglake.v1.model.SetIamPolicyRequest content) {
          super(BigLakeService.this, "POST", REST_PATH, content, com.google.api.services.biglake.v1.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
       ...
       *        names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for
       *        this field.
       * @param content the {@link com.google.api.services.biglake.v1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.api.services.biglake.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends BigLakeServiceRequest<com.google.api.services.biglake.v1.model.TestIamPermissionsResponse> {
       ...
       *        this field.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.api.services.biglake.v1.model.TestIamPermissionsRequest content) {
          super(BigLakeService.this, "POST", REST_PATH, content, com.google.api.services.biglake.v1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
       ...
       * <pre>
       *   {@code BigLakeService biglake = new BigLakeService(...);}
       *   {@code BigLakeService.Namespaces.List request = biglake.namespaces().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Namespaces {
        ...
        public class GetIamPolicy extends BigLakeServiceRequest<com.google.api.services.biglake.v1.model.Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/catalogs/[^/]+/namespaces/[^/]+$");
        ...
        public class Tables {
          ...
          public class GetIamPolicy extends BigLakeServiceRequest<com.google.api.services.biglake.v1.model.Policy> {
            ...
            private final java.util.regex.Pattern RESOURCE_PATTERN =
                java.util.regex.Pattern.compile("^projects/[^/]+/catalogs/[^/]+/namespaces/[^/]+/tables/[^/]+$");
