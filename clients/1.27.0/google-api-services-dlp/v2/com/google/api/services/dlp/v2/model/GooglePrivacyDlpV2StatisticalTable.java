...
/**
 * An auxiliary table containing statistical information on the relative frequency of different
 * quasi-identifiers values. It has one or several quasi-identifiers columns, and one column that
...
public final class GooglePrivacyDlpV2StatisticalTable extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GooglePrivacyDlpV2StatisticalTable set(String fieldName, Object value) {
    return (GooglePrivacyDlpV2StatisticalTable) super.set(fieldName, value);
  }

  @Override
  public GooglePrivacyDlpV2StatisticalTable clone() {
    return (GooglePrivacyDlpV2StatisticalTable) super.clone();
  }
