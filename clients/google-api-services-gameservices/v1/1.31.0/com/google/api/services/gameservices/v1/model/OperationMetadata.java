...
public final class OperationMetadata extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, OperationStatus> operationStatus;
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, OperationStatus> getOperationStatus() {
   ...
   */
  public OperationMetadata setOperationStatus(java.util.Map<String, OperationStatus> operationStatus) {
   ...
   */
  public OperationMetadata setUnreachable(java.util.List<java.lang.String> unreachable) {
