...
public class PolyService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Assets {
    ...
    public class Get extends PolyServiceRequest<com.google.api.services.polyservice.v1.model.Asset> {
      ...
      protected Get(java.lang.String name) {
        super(PolyService.this, "GET", REST_PATH, null, com.google.api.services.polyservice.v1.model.Asset.class);
    ...
    public class List extends PolyServiceRequest<com.google.api.services.polyservice.v1.model.ListAssetsResponse> {
       ...
       */
      protected List() {
        super(PolyService.this, "GET", REST_PATH, null, com.google.api.services.polyservice.v1.model.ListAssetsResponse.class);
      }
  ...
  public class Users {
    ...
    public class Assets {
      ...
      public class List extends PolyServiceRequest<com.google.api.services.polyservice.v1.model.ListUserAssetsResponse> {
      ...
      an OAuth token with the request.
        ...
        protected List(java.lang.String name) {
          super(PolyService.this, "GET", REST_PATH, null, com.google.api.services.polyservice.v1.model.ListUserAssetsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class Likedassets {
      ...
      public class List extends PolyServiceRequest<com.google.api.services.polyservice.v1.model.ListLikedAssetsResponse> {
      ...
      an OAuth token with the request.
         ...
         */
        protected List(java.lang.String name) {
          super(PolyService.this, "GET", REST_PATH, null, com.google.api.services.polyservice.v1.model.ListLikedAssetsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
