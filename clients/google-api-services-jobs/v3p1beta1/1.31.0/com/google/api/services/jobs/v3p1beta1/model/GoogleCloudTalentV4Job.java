...
public final class GoogleCloudTalentV4Job extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudTalentV4JobApplicationInfo applicationInfo;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudTalentV4CompensationInfo compensationInfo;
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, GoogleCloudTalentV4CustomAttribute> customAttributes;

  static {
    // hack to force ProGuard to consider GoogleCloudTalentV4CustomAttribute used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudTalentV4CustomAttribute.class);
  }
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudTalentV4JobDerivedInfo derivedInfo;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudTalentV4JobProcessingOptions processingOptions;
   ...
   */
  public GoogleCloudTalentV4Job setAddresses(java.util.List<java.lang.String> addresses) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudTalentV4JobApplicationInfo getApplicationInfo() {
   ...
   */
  public GoogleCloudTalentV4Job setApplicationInfo(GoogleCloudTalentV4JobApplicationInfo applicationInfo) {
   ...
   */
  public GoogleCloudTalentV4Job setCompany(java.lang.String company) {
   ...
   */
  public GoogleCloudTalentV4Job setCompanyDisplayName(java.lang.String companyDisplayName) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudTalentV4CompensationInfo getCompensationInfo() {
   ...
   */
  public GoogleCloudTalentV4Job setCompensationInfo(GoogleCloudTalentV4CompensationInfo compensationInfo) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, GoogleCloudTalentV4CustomAttribute> getCustomAttributes() {
   ...
   */
  public GoogleCloudTalentV4Job setCustomAttributes(java.util.Map<String, GoogleCloudTalentV4CustomAttribute> customAttributes) {
   ...
   */
  public GoogleCloudTalentV4Job setDegreeTypes(java.util.List<java.lang.String> degreeTypes) {
   ...
   */
  public GoogleCloudTalentV4Job setDepartment(java.lang.String department) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudTalentV4JobDerivedInfo getDerivedInfo() {
    return derivedInfo;
  }
   ...
   */
  public GoogleCloudTalentV4Job setDerivedInfo(GoogleCloudTalentV4JobDerivedInfo derivedInfo) {
   ...
   */
  public GoogleCloudTalentV4Job setDescription(java.lang.String description) {
   ...
   */
  public GoogleCloudTalentV4Job setEmploymentTypes(java.util.List<java.lang.String> employmentTypes) {
   ...
   */
  public GoogleCloudTalentV4Job setIncentives(java.lang.String incentives) {
   ...
   */
  public GoogleCloudTalentV4Job setJobBenefits(java.util.List<java.lang.String> jobBenefits) {
   ...
   */
  public GoogleCloudTalentV4Job setJobEndTime(String jobEndTime) {
   ...
   */
  public GoogleCloudTalentV4Job setJobLevel(java.lang.String jobLevel) {
   ...
   */
  public GoogleCloudTalentV4Job setJobStartTime(String jobStartTime) {
   ...
   */
  public GoogleCloudTalentV4Job setLanguageCode(java.lang.String languageCode) {
   ...
   */
  public GoogleCloudTalentV4Job setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public GoogleCloudTalentV4Job setPostingCreateTime(String postingCreateTime) {
   ...
   */
  public GoogleCloudTalentV4Job setPostingExpireTime(String postingExpireTime) {
   ...
   */
  public GoogleCloudTalentV4Job setPostingPublishTime(String postingPublishTime) {
   ...
   */
  public GoogleCloudTalentV4Job setPostingRegion(java.lang.String postingRegion) {
   ...
   */
  public GoogleCloudTalentV4Job setPostingUpdateTime(String postingUpdateTime) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudTalentV4JobProcessingOptions getProcessingOptions() {
   ...
   */
  public GoogleCloudTalentV4Job setProcessingOptions(GoogleCloudTalentV4JobProcessingOptions processingOptions) {
   ...
   */
  public GoogleCloudTalentV4Job setPromotionValue(java.lang.Integer promotionValue) {
   ...
   */
  public GoogleCloudTalentV4Job setQualifications(java.lang.String qualifications) {
   ...
   */
  public GoogleCloudTalentV4Job setRequisitionId(java.lang.String requisitionId) {
   ...
   */
  public GoogleCloudTalentV4Job setResponsibilities(java.lang.String responsibilities) {
   ...
   */
  public GoogleCloudTalentV4Job setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }
   ...
   */
  public GoogleCloudTalentV4Job setVisibility(java.lang.String visibility) {
    this.visibility = visibility;
    return this;
  }

  @Override
  public GoogleCloudTalentV4Job set(String fieldName, Object value) {
    return (GoogleCloudTalentV4Job) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudTalentV4Job clone() {
    return (GoogleCloudTalentV4Job) super.clone();
  }
