...
/**
 * Model definition for PreviewFeatureList.
 *
...
public final class PreviewFeatureList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<PreviewFeature> items;

  static {
    // hack to force ProGuard to consider PreviewFeature used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(PreviewFeature.class);
  }
   ...
   */
  public PreviewFeatureList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public PreviewFeatureList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<PreviewFeature> getItems() {
    return items;
  }
   ...
   */
  public PreviewFeatureList setItems(java.util.List<PreviewFeature> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public PreviewFeatureList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public PreviewFeatureList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PreviewFeatureList set(String fieldName, Object value) {
    return (PreviewFeatureList) super.set(fieldName, value);
  }

  @Override
  public PreviewFeatureList clone() {
    return (PreviewFeatureList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for PreviewFeatureListWarningData.
     */
