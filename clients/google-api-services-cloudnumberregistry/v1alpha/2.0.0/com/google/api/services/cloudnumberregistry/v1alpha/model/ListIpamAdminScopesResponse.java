...
public final class ListIpamAdminScopesResponse extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<IpamAdminScope> ipamAdminScopes;

  static {
    // hack to force ProGuard to consider IpamAdminScope used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(IpamAdminScope.class);
  }
   ...
   */
  public ListIpamAdminScopesResponse setUnreachable(java.util.List<java.lang.String> unreachable) {
    this.unreachable = unreachable;
    return this;
  }

  @Override
  public ListIpamAdminScopesResponse set(String fieldName, Object value) {
    return (ListIpamAdminScopesResponse) super.set(fieldName, value);
  }

  @Override
  public ListIpamAdminScopesResponse clone() {
    return (ListIpamAdminScopesResponse) super.clone();
  }
