 ...
 *
 * If year, month, or day are 0, the DateTime is considered not to have a specific year, month, or
 * day respectively.
 *
 * This type may also be used to represent a physical time if all the date and time fields are set
 * and either case of the `time_offset` oneof is set. Consider using `Timestamp` message for
 * physical time instead. If your use case also would like to store the user's timezone, that can be
 * done in another field.
 *
...
public final class DateTime extends com.google.api.client.json.GenericJson {
   ...
   */
  public DateTime setDay(java.lang.Integer day) {
    this.day = day;
    return this;
  }
   ...
   */
  public DateTime setHours(java.lang.Integer hours) {
    this.hours = hours;
    return this;
  }
   ...
   */
  public DateTime setMinutes(java.lang.Integer minutes) {
   ...
   */
  public DateTime setMonth(java.lang.Integer month) {
    this.month = month;
    return this;
  }
   ...
   */
  public DateTime setSeconds(java.lang.Integer seconds) {
