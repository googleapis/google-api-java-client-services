...
public final class GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfigSourceEntry> getSources() {
    return sources;
  }
   ...
   */
  public GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig setSources(java.util.List<GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfigSourceEntry> sources) {
    this.sources = sources;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig clone() {
    return (GoogleCloudAiplatformV1SchemaPredictParamsGroundingConfig) super.clone();
  }
