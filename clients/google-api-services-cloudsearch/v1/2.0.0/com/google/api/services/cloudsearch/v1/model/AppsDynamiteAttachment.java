...
public final class AppsDynamiteAttachment extends com.google.api.client.json.GenericJson {
   ...
   */
  public AppsDynamiteAttachment setAddOnData(GoogleChatV1ContextualAddOnMarkup addOnData) {
   ...
   */
  public AppsDynamiteAttachment setAppId(AppsDynamiteUserId appId) {
    this.appId = appId;
    return this;
  }
   ...
   */
  public AppsDynamiteAttachment setAttachmentId(java.lang.String attachmentId) {
   ...
   */
  public AppsDynamiteAttachment setCardAddOnData(AppsDynamiteSharedCard cardAddOnData) {
   ...
   */
  public AppsDynamiteAttachment setDeprecatedAddOnData(ContextualAddOnMarkup deprecatedAddOnData) {
   ...
   */
  public AppsDynamiteAttachment setSlackData(AppsDynamiteV1ApiCompatV1Attachment slackData) {
   ...
   */
  public AppsDynamiteAttachment setSlackDataImageUrlHeight(java.lang.Integer slackDataImageUrlHeight) {
    this.slackDataImageUrlHeight = slackDataImageUrlHeight;
    return this;
  }

  @Override
  public AppsDynamiteAttachment set(String fieldName, Object value) {
    return (AppsDynamiteAttachment) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteAttachment clone() {
