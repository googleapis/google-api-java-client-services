...
public final class TargetSslProxyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetSslProxy> items;

  static {
    // hack to force ProGuard to consider TargetSslProxy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(TargetSslProxy.class);
  }
   ...
   */
  public TargetSslProxyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetSslProxy> getItems() {
    return items;
  }
   ...
   */
  public TargetSslProxyList setItems(java.util.List<TargetSslProxy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetSslProxyList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetSslProxyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetSslProxyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetSslProxyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetSslProxyList set(String fieldName, Object value) {
    return (TargetSslProxyList) super.set(fieldName, value);
  }

  @Override
  public TargetSslProxyList clone() {
    return (TargetSslProxyList) super.clone();
  }
