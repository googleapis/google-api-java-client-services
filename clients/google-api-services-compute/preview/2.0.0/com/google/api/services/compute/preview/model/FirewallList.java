...
public final class FirewallList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Firewall> items;
   ...
   */
  public FirewallList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Firewall> getItems() {
    return items;
  }
   ...
   */
  public FirewallList setItems(java.util.List<Firewall> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public FirewallList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public FirewallList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public FirewallList set(String fieldName, Object value) {
    return (FirewallList) super.set(fieldName, value);
  }

  @Override
  public FirewallList clone() {
    return (FirewallList) super.clone();
  }
