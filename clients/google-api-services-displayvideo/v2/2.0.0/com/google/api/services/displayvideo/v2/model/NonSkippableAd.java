...
public final class NonSkippableAd extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public NonSkippableAd set(String fieldName, Object value) {
    return (NonSkippableAd) super.set(fieldName, value);
  }

  @Override
  public NonSkippableAd clone() {
    return (NonSkippableAd) super.clone();
  }
