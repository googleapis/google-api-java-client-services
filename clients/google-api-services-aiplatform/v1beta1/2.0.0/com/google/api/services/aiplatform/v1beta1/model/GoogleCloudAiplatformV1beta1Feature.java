...
public final class GoogleCloudAiplatformV1beta1Feature extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Deprecated: The custom monitoring configuration for this Feature, if not set, use the
   * monitoring_config defined for the EntityType this Feature belongs to. Only Features with type
   * (Feature.ValueType) BOOL, STRING, DOUBLE or INT64 can enable monitoring. If this is populated
   * with FeaturestoreMonitoringConfig.disabled = true, snapshot analysis monitoring is disabled; if
  ...
  /**
   * Output only. A list of historical SnapshotAnalysis stats requested by user, sorted by
  ...
  /**
   * Output only. Immutable. The version ID of the feature. It is an auto-incrementing decimal
   * number in string representation. A new version is committed when a new model version is created
   * under an existing feature id.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudAiplatformV1beta1Feature setVersionCreateTime(String versionCreateTime) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Feature setVersionDescription(java.lang.String versionDescription) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Feature setVersionId(java.lang.String versionId) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Feature setVersionLabels(java.util.Map<String, java.lang.String> versionLabels) {
   ...
   */
  public GoogleCloudAiplatformV1beta1Feature setVersionUpdateTime(String versionUpdateTime) {
