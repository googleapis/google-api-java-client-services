...
public final class ProjectInfo extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The default resource location of other Firebase resources (such as Cloud Firestore). Not all
   * projects will have this field populated. If it is not populated, it means that the project is
   * not yet associated with any region. Consequently, a call to AddFirebase must provide a location
   * in this case. For examples, see https://cloud.google.com/appengine/docs/locations.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
