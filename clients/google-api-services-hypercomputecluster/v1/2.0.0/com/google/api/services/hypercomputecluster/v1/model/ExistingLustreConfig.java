...
public final class ExistingLustreConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public ExistingLustreConfig setLustre(java.lang.String lustre) {
    this.lustre = lustre;
    return this;
  }

  @Override
  public ExistingLustreConfig set(String fieldName, Object value) {
    return (ExistingLustreConfig) super.set(fieldName, value);
  }

  @Override
  public ExistingLustreConfig clone() {
    return (ExistingLustreConfig) super.clone();
  }
