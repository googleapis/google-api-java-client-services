...
public final class GoogleCloudRetailV2alphaSearchResponseSearchResult extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setMatchingVariantCount(java.lang.Integer matchingVariantCount) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setMatchingVariantFields(java.util.Map<String, String> matchingVariantFields) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setPersonalLabels(java.util.List<java.lang.String> personalLabels) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setProduct(GoogleCloudRetailV2alphaProduct product) {
   ...
   */
  public GoogleCloudRetailV2alphaSearchResponseSearchResult setVariantRollupValues(java.util.Map<String, java.lang.Object> variantRollupValues) {
    this.variantRollupValues = variantRollupValues;
    return this;
  }

  @Override
  public GoogleCloudRetailV2alphaSearchResponseSearchResult set(String fieldName, Object value) {
    return (GoogleCloudRetailV2alphaSearchResponseSearchResult) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2alphaSearchResponseSearchResult clone() {
    return (GoogleCloudRetailV2alphaSearchResponseSearchResult) super.clone();
  }
