...
/**
 * Model definition for NetworkAttachmentsScopedList.
 *
...
public final class NetworkAttachmentsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<NetworkAttachment> networkAttachments;

  static {
    // hack to force ProGuard to consider NetworkAttachment used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkAttachment.class);
  }
   ...
   */
  public java.util.List<NetworkAttachment> getNetworkAttachments() {
    return networkAttachments;
  }

  /**
   * A list of NetworkAttachments contained in this scope.
   * @param networkAttachments networkAttachments or {@code null} for none
   */
  public NetworkAttachmentsScopedList setNetworkAttachments(java.util.List<NetworkAttachment> networkAttachments) {
   ...
   */
  public NetworkAttachmentsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkAttachmentsScopedList set(String fieldName, Object value) {
    return (NetworkAttachmentsScopedList) super.set(fieldName, value);
  }

  @Override
  public NetworkAttachmentsScopedList clone() {
    return (NetworkAttachmentsScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkAttachmentsScopedListWarningData.
     */
