...
public final class GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig setPrivateServiceConnectConfig(GoogleCloudAiplatformV1beta1PrivateServiceConnectConfig privateServiceConnectConfig) {
    this.privateServiceConnectConfig = privateServiceConnectConfig;
    return this;
  }

  @Override
  public GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig clone() {
    return (GoogleCloudAiplatformV1beta1DeployRequestEndpointConfig) super.clone();
  }
