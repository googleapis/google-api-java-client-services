...
public final class AddressesScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public AddressesScopedList setAddresses(java.util.List<Address> addresses) {
   ...
   */
  public AddressesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public AddressesScopedList set(String fieldName, Object value) {
    return (AddressesScopedList) super.set(fieldName, value);
  }

  @Override
  public AddressesScopedList clone() {
    return (AddressesScopedList) super.clone();
  }
