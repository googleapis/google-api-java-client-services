...
public final class GoogleCloudDialogflowV2beta1QueryParameters extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. This field can be used to pass HTTP headers for a webhook call. These headers will be
   * sent to webhook alone with the headers that have been configured through Dialogflow web
   * console. The headers defined within this field will overwrite the headers configured through
