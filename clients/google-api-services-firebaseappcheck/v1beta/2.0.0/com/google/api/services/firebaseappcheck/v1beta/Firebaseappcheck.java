...
public class Firebaseappcheck extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class OauthClients {
     ...
     *        Alternatively, if this method is being called for an OAuth client protected by App Check,
     *        this field can also be in the format: ``` oauthClients/{oauth_client_id} ``` You can view
     *        the OAuth client ID for your OAuth clients in the Google Cloud console. Note that only iOS
     *        OAuth clients are supported at this time, and they must be linked to corresponding iOS
     *        Firebase apps. Please see [the documentation](https://developers.google.com/identity/sign-
     *        in/ios/appcheck/get-started#project-setup) for more information.
     ...
     *        in/ios/appcheck/get-started#project-setup) for more information.
     ...
     oauthClients/{oauth_client_id} ``` You can view the OAuth client ID for your OAuth clients in the
     ...
     documentation](https://developers.google.com/identity/sign-in/ios/appcheck/get-started#project-
  ...
  public class Projects {
    ...
    public class Apps {
       ...
       *        be replaced with the project ID of the Firebase project. Learn more about using project
       *        identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.
       * @param content the {@link com.google.api.services.firebaseappcheck.v1beta.model.GoogleFirebaseAppcheckV1betaMintAppCheckTokenRequest}
       * @return the request
       */
      public MintAppCheckToken mintAppCheckToken(java.lang.String app, com.google.api.services.firebaseappcheck.v1beta.model.GoogleFirebaseAppcheckV1betaMintAppCheckTokenRequest content) throws java.io.IOException {
        MintAppCheckToken result = new MintAppCheckToken(app, content);
        initialize(result);
        return result;
      }

      public class MintAppCheckToken extends FirebaseappcheckRequest<com.google.api.services.firebaseappcheck.v1beta.model.GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse> {

        private static final String REST_PATH = "v1beta/{+app}:mintAppCheckToken";
       ...
       *        identifiers in Google's [AIP 2510](https://google.aip.dev/cloud/2510) standard.
         ...
         * @since 1.13
         */
        protected MintAppCheckToken(java.lang.String app, com.google.api.services.firebaseappcheck.v1beta.model.GoogleFirebaseAppcheckV1betaMintAppCheckTokenRequest content) {
          super(Firebaseappcheck.this, "POST", REST_PATH, content, com.google.api.services.firebaseappcheck.v1beta.model.GoogleFirebaseAppcheckV1betaMintAppCheckTokenResponse.class);
          this.app = com.google.api.client.util.Preconditions.checkNotNull(app, "Required parameter app must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(APP_PATTERN.matcher(app).matches(),
                "Parameter app must conform to the pattern " +
