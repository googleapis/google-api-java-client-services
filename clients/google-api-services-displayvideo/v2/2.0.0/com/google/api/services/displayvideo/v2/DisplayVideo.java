...
public class DisplayVideo extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Media {
    ...
    public class Download extends DisplayVideoRequest<com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia> {
      ...
      protected Download(java.lang.String resourceName) {
        super(DisplayVideo.this, "GET", REST_PATH, null, com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia.class);
     ...
     *
     * @param resourceName Name of the media that is being downloaded. See ReadRequest.resource_name.
     * @param content the {@link com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia}
     * @return the request
     */
    public Upload upload(java.lang.String resourceName, com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia content) throws java.io.IOException {
     ...
     */
    public Upload upload(java.lang.String resourceName, com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia content, com.google.api.client.http.AbstractInputStreamContent mediaContent) throws java.io.IOException {
      Upload result = new Upload(resourceName, content, mediaContent);
      initialize(result);
      return result;
    }

    public class Upload extends DisplayVideoRequest<com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia> {
       ...
       * @since 1.13
       */
      protected Upload(java.lang.String resourceName, com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia content) {
        super(DisplayVideo.this, "POST", REST_PATH, content, com.google.api.services.displayvideo.v2.model.GoogleBytestreamMedia.class);
        this.resourceName = com.google.api.client.util.Preconditions.checkNotNull(resourceName, "Required parameter resourceName must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(RESOURCE_NAME_PATTERN.matcher(resourceName).matches(),
              "Parameter resourceName must conform to the pattern " +
  ...
  public class Sdfdownloadtasks {
    ...
    public class Operations {
      ...
      public class Get extends DisplayVideoRequest<com.google.api.services.displayvideo.v2.model.Operation> {
        ...
        protected Get(java.lang.String name) {
          super(DisplayVideo.this, "GET", REST_PATH, null, com.google.api.services.displayvideo.v2.model.Operation.class);
