...
public final class JobReference extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. The job ID, which must be unique within the project. The job ID is generated by the
   * server upon job submission or provided by the user as a means to perform retries without
   * creating duplicate jobs. The ID must contain only letters (a-z, A-Z), numbers (0-9),
