...
public final class GoogleCloudApigeeV1SyncAuthorization extends com.google.api.client.json.GenericJson {
   ...
   * from overwriting each other. It is strongly suggested that systems make use of the `etag` in
   * the read-modify-write cycle to avoid race conditions: An `etag` is returned in the response to
   * `getSyncAuthorization`, and systems are expected to put that etag in the request to
   * `setSyncAuthorization` to ensure that their change will be applied to the same version.
   *
   * If no `etag` is provided in the call to `setSyncAuthorization`, then the existing authorization
  ...
  /**
   * Required. The list of identities to grant access to control plane resources.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
