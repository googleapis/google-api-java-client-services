...
public final class GoogleCloudAiplatformV1AgentData extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudAiplatformV1ConversationTurn> turns;
   ...
   */
  public GoogleCloudAiplatformV1AgentData setAgents(java.util.Map<String, GoogleCloudAiplatformV1AgentConfig> agents) {
    this.agents = agents;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<GoogleCloudAiplatformV1ConversationTurn> getTurns() {
    return turns;
  }
   ...
   */
  public GoogleCloudAiplatformV1AgentData setTurns(java.util.List<GoogleCloudAiplatformV1ConversationTurn> turns) {
    this.turns = turns;
    return this;
  }
