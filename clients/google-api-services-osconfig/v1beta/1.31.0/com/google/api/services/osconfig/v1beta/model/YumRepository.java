...
/**
 * Represents a single Yum package repository. This repository is added to a repo file that is
 * stored at `/etc/yum.repos.d/google_osconfig.repo`.
 *
...
public final class YumRepository extends com.google.api.client.json.GenericJson {
   ...
   */
  public YumRepository setBaseUrl(java.lang.String baseUrl) {
   ...
   */
  public YumRepository setDisplayName(java.lang.String displayName) {
   ...
   */
  public YumRepository setGpgKeys(java.util.List<java.lang.String> gpgKeys) {
   ...
   */
  public YumRepository setId(java.lang.String id) {
    this.id = id;
    return this;
  }

  @Override
  public YumRepository set(String fieldName, Object value) {
    return (YumRepository) super.set(fieldName, value);
  }

  @Override
  public YumRepository clone() {
    return (YumRepository) super.clone();
  }
