...
public final class GoogleCloudRetailV2betaIntentClassificationConfigExample extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfigExample setIntentType(java.lang.String intentType) {
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfigExample setQuery(java.lang.String query) {
    this.query = query;
    return this;
  }
   ...
   */
  public GoogleCloudRetailV2betaIntentClassificationConfigExample setReason(java.lang.String reason) {
    this.reason = reason;
    return this;
  }

  @Override
  public GoogleCloudRetailV2betaIntentClassificationConfigExample set(String fieldName, Object value) {
    return (GoogleCloudRetailV2betaIntentClassificationConfigExample) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudRetailV2betaIntentClassificationConfigExample clone() {
    return (GoogleCloudRetailV2betaIntentClassificationConfigExample) super.clone();
  }
