...
/**
 * Model definition for CompositeHealthChecksScopedList.
 *
...
public final class CompositeHealthChecksScopedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Informational warning which replaces the list of composite health checks when the list is
   * empty.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public CompositeHealthChecksScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public CompositeHealthChecksScopedList set(String fieldName, Object value) {
    return (CompositeHealthChecksScopedList) super.set(fieldName, value);
  }

  @Override
  public CompositeHealthChecksScopedList clone() {
    return (CompositeHealthChecksScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for CompositeHealthChecksScopedListWarningData.
     */
