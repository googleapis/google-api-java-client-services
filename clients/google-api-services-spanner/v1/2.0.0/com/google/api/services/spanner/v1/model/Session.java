...
public final class Session extends com.google.api.client.json.GenericJson {
   ...
   * concurrent operations including any combination of read-only and read-write transactions. Use
   * `sessions.create` to create multiplexed sessions. Don't use BatchCreateSessions to create a
