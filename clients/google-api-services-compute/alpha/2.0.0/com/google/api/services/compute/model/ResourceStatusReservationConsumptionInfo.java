...
/**
 * Model definition for ResourceStatusReservationConsumptionInfo.
 *
...
public final class ResourceStatusReservationConsumptionInfo extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The full resource name of the reservation block that this instance is consuming from.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * The full resource name of the reservation sub-block that this instance is consuming from.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
