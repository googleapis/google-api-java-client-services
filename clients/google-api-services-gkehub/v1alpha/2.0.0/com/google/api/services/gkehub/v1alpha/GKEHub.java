  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Namespaces {
        ...
        public class List extends GKEHubRequest<com.google.api.services.gkehub.v1alpha.model.ListNamespacesResponse> {
         ...
         *        format `projects/locations`.
           ...
           */
          protected List(java.lang.String parent) {
            super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v1alpha.model.ListNamespacesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
        ...
        public class Rbacrolebindings {
          ...
          public class List extends GKEHubRequest<com.google.api.services.gkehub.v1alpha.model.ListRBACRoleBindingsResponse> {
           ...
           *        format `projects/locations/namespaces`.
             ...
             */
            protected List(java.lang.String parent) {
              super(GKEHub.this, "GET", REST_PATH, null, com.google.api.services.gkehub.v1alpha.model.ListRBACRoleBindingsResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
