  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Environments {
         ...
         * `config.softwareConfig.airflowConfigOverrides` * Replace all Apache Airflow config overrides. If
         a replacement config overrides map is not included in `environment`, all config overrides are
