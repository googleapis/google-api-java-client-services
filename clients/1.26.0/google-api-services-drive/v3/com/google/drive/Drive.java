...
public class Drive extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Changes {
     ...
     * @return the request
     */
    public Watch watch(java.lang.String pageToken, com.google.drive.model.Channel content) throws java.io.IOException {
     ...
     *        getStartPageToken method.
       ...
       * @since 1.13
       */
      protected Watch(java.lang.String pageToken, com.google.drive.model.Channel content) {
  ...
  public class Comments {
     ...
     * @return the request
     */
    public Create create(java.lang.String fileId, com.google.drive.model.Comment content) throws java.io.IOException {
      Create result = new Create(fileId, content);
      initialize(result);
      return result;
    }

    public class Create extends DriveRequest<com.google.drive.model.Comment> {
       ...
       * @since 1.13
       */
      protected Create(java.lang.String fileId, com.google.drive.model.Comment content) {
  ...
  public class Files {
     ...
     * @return the request
     */
    public Create create(com.google.drive.model.File content) throws java.io.IOException {
     ...
     */
    public Create create(com.google.drive.model.File content, com.google.api.client.http.AbstractInputStreamContent mediaContent) throws java.io.IOException {
      Create result = new Create(content, mediaContent);
      initialize(result);
      return result;
    }

    public class Create extends DriveRequest<com.google.drive.model.File> {
       ...
       * @since 1.13
       */
      protected Create(com.google.drive.model.File content) {
        super(Drive.this, "POST", REST_PATH, content, com.google.drive.model.File.class);
      }
       ...
       * @since 1.13
       */
      protected Create(com.google.drive.model.File content, com.google.api.client.http.AbstractInputStreamContent mediaContent) {
    ...
    public class Update extends DriveRequest<com.google.drive.model.File> {
      ...
      protected Update(java.lang.String fileId, com.google.drive.model.File content, com.google.api.client.http.AbstractInputStreamContent mediaContent) {
        super(Drive.this, "PATCH", "/upload/" + getServicePath() + REST_PATH, content, com.google.drive.model.File.class);
        this.fileId = com.google.api.client.util.Preconditions.checkNotNull(fileId, "Required parameter fileId must be specified.");
        initializeMediaUpload(mediaContent);
      }
  ...
  public class Permissions {
     ...
     * @return the request
     */
    public Create create(java.lang.String fileId, com.google.drive.model.Permission content) throws java.io.IOException {
      Create result = new Create(fileId, content);
      initialize(result);
      return result;
    }

    public class Create extends DriveRequest<com.google.drive.model.Permission> {
       ...
       * @since 1.13
       */
      protected Create(java.lang.String fileId, com.google.drive.model.Permission content) {
  ...
  public class Replies {
     ...
     * @param fileId The ID of the file.
     * @param commentId The ID of the comment.
     * @param content the {@link com.google.drive.model.Reply}
     * @return the request
     */
    public Create create(java.lang.String fileId, java.lang.String commentId, com.google.drive.model.Reply content) throws java.io.IOException {
      Create result = new Create(fileId, commentId, content);
      initialize(result);
      return result;
    }

    public class Create extends DriveRequest<com.google.drive.model.Reply> {
       ...
       * @since 1.13
       */
      protected Create(java.lang.String fileId, java.lang.String commentId, com.google.drive.model.Reply content) {
        super(Drive.this, "POST", REST_PATH, content, com.google.drive.model.Reply.class);
        this.fileId = com.google.api.client.util.Preconditions.checkNotNull(fileId, "Required parameter fileId must be specified.");
        this.commentId = com.google.api.client.util.Preconditions.checkNotNull(commentId, "Required parameter commentId must be specified.");
      }
    ...
    public class Get extends DriveRequest<com.google.drive.model.Reply> {
      ...
      protected Get(java.lang.String fileId, java.lang.String commentId, java.lang.String replyId) {
        super(Drive.this, "GET", REST_PATH, null, com.google.drive.model.Reply.class);
        this.fileId = com.google.api.client.util.Preconditions.checkNotNull(fileId, "Required parameter fileId must be specified.");
        this.commentId = com.google.api.client.util.Preconditions.checkNotNull(commentId, "Required parameter commentId must be specified.");
        this.replyId = com.google.api.client.util.Preconditions.checkNotNull(replyId, "Required parameter replyId must be specified.");
      }
    ...
    public class List extends DriveRequest<com.google.drive.model.ReplyList> {
      ...
      protected List(java.lang.String fileId, java.lang.String commentId) {
        super(Drive.this, "GET", REST_PATH, null, com.google.drive.model.ReplyList.class);
        this.fileId = com.google.api.client.util.Preconditions.checkNotNull(fileId, "Required parameter fileId must be specified.");
        this.commentId = com.google.api.client.util.Preconditions.checkNotNull(commentId, "Required parameter commentId must be specified.");
      }
     ...
     * @return the request
     */
    public Update update(java.lang.String fileId, java.lang.String commentId, java.lang.String replyId, com.google.drive.model.Reply content) throws java.io.IOException {
      Update result = new Update(fileId, commentId, replyId, content);
      initialize(result);
      return result;
    }

    public class Update extends DriveRequest<com.google.drive.model.Reply> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String fileId, java.lang.String commentId, java.lang.String replyId, com.google.drive.model.Reply content) {
        super(Drive.this, "PATCH", REST_PATH, content, com.google.drive.model.Reply.class);
        this.fileId = com.google.api.client.util.Preconditions.checkNotNull(fileId, "Required parameter fileId must be specified.");
        this.commentId = com.google.api.client.util.Preconditions.checkNotNull(commentId, "Required parameter commentId must be specified.");
        this.replyId = com.google.api.client.util.Preconditions.checkNotNull(replyId, "Required parameter replyId must be specified.");
        checkRequiredParameter(content, "content");
  ...
  public class Teamdrives {
     ...
     * @return the request
     */
    public Create create(java.lang.String requestId, com.google.drive.model.TeamDrive content) throws java.io.IOException {
      Create result = new Create(requestId, content);
      initialize(result);
      return result;
    }

    public class Create extends DriveRequest<com.google.drive.model.TeamDrive> {
     ...
     *        already exists a 409 error will be returned.
       ...
       * @since 1.13
       */
      protected Create(java.lang.String requestId, com.google.drive.model.TeamDrive content) {
    ...
    public class Update extends DriveRequest<com.google.drive.model.TeamDrive> {
      ...
      protected Update(java.lang.String teamDriveId, com.google.drive.model.TeamDrive content) {
        super(Drive.this, "PATCH", REST_PATH, content, com.google.drive.model.TeamDrive.class);
        this.teamDriveId = com.google.api.client.util.Preconditions.checkNotNull(teamDriveId, "Required parameter teamDriveId must be specified.");
      }
