...
public final class GoogleCloudBillingBudgetsV1NotificationsRule extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Optional. Email targets to send notifications to when a threshold is exceeded. This is in
   * addition to the `DefaultIamRecipients` who receive alert emails based on their billing account
   * IAM role. The value is the full REST resource name of a Cloud Monitoring email notification
   * channel with the form `projects/{project_id}/notificationChannels/{channel_id}`. A maximum of 5
  ...
  /**
   * Optional. The name of the Pub/Sub topic where budget-related messages are published, in the
  ...
  @Override
  public GoogleCloudBillingBudgetsV1NotificationsRule set(String fieldName, Object value) {
    return (GoogleCloudBillingBudgetsV1NotificationsRule) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudBillingBudgetsV1NotificationsRule clone() {
