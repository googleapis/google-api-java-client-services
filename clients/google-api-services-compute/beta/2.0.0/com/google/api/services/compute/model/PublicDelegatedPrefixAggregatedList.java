...
public final class PublicDelegatedPrefixAggregatedList extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] Type of the resource. Always compute#publicDelegatedPrefixAggregatedList for
   ...
   */
  public PublicDelegatedPrefixAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, PublicDelegatedPrefixesScopedList> getItems() {
    return items;
  }
   ...
   */
  public PublicDelegatedPrefixAggregatedList setItems(java.util.Map<String, PublicDelegatedPrefixesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public PublicDelegatedPrefixAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public PublicDelegatedPrefixAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public PublicDelegatedPrefixAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public PublicDelegatedPrefixAggregatedList set(String fieldName, Object value) {
    return (PublicDelegatedPrefixAggregatedList) super.set(fieldName, value);
  }

  @Override
  public PublicDelegatedPrefixAggregatedList clone() {
    return (PublicDelegatedPrefixAggregatedList) super.clone();
  }
