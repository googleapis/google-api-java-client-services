...
public final class KnowledgeAnswersCompoundType extends com.google.api.client.json.GenericJson {
   ...
   */
  public KnowledgeAnswersCompoundType setComponentSpecificContracts(NlpMeaningComponentSpecificContracts componentSpecificContracts) {
   ...
   */
  public KnowledgeAnswersCompoundType setRemodelings(NlpMeaningMeaningRemodelings remodelings) {
    this.remodelings = remodelings;
    return this;
  }

  @Override
  public KnowledgeAnswersCompoundType set(String fieldName, Object value) {
    return (KnowledgeAnswersCompoundType) super.set(fieldName, value);
  }

  @Override
  public KnowledgeAnswersCompoundType clone() {
    return (KnowledgeAnswersCompoundType) super.clone();
  }
