...
public final class RenderAccountIssuesResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<AccountIssue> issues;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<AccountIssue> getIssues() {
    return issues;
  }
   ...
   */
  public RenderAccountIssuesResponse setIssues(java.util.List<AccountIssue> issues) {
    this.issues = issues;
    return this;
  }
