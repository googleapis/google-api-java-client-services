...
public class ShoppingContent extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Merchantsupport {
     ...
     * content and display a user input form. You can submit an allowlist request in the [Shopping API
     * Support Form](https://support.google.com/merchants/contact/shopping_api_support_form) under "What
     * is the issue/question?" to get access to this feature. The action can be successfully started
     * only once all `required` inputs are provided. If any `required` input is missing, or invalid
     * value was provided, the service will return 400 error. Validation errors will contain Ids for all
    ...
    public class Triggeraction extends ShoppingContentRequest<com.google.api.services.content.model.TriggerActionResponse> {
       ...
       * specific content and display a user input form. You can submit an allowlist request in the
       * [Shopping API Support
       * Form](https://support.google.com/merchants/contact/shopping_api_support_form) under "What is
       * the issue/question?" to get access to this feature. The action can be successfully started only
