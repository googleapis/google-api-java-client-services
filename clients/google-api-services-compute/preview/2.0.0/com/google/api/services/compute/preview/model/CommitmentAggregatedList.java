...
public final class CommitmentAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, CommitmentsScopedList> items;
   ...
   */
  public CommitmentAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, CommitmentsScopedList> getItems() {
    return items;
  }
   ...
   */
  public CommitmentAggregatedList setItems(java.util.Map<String, CommitmentsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public CommitmentAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public CommitmentAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public CommitmentAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public CommitmentAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public CommitmentAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public CommitmentAggregatedList set(String fieldName, Object value) {
    return (CommitmentAggregatedList) super.set(fieldName, value);
  }

  @Override
  public CommitmentAggregatedList clone() {
    return (CommitmentAggregatedList) super.clone();
  }
