...
public final class FirewallPolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<FirewallPolicy> items;

  static {
    // hack to force ProGuard to consider FirewallPolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(FirewallPolicy.class);
  }
   ...
   */
  public FirewallPolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<FirewallPolicy> getItems() {
    return items;
  }
   ...
   */
  public FirewallPolicyList setItems(java.util.List<FirewallPolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public FirewallPolicyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public FirewallPolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public FirewallPolicyList set(String fieldName, Object value) {
    return (FirewallPolicyList) super.set(fieldName, value);
  }

  @Override
  public FirewallPolicyList clone() {
    return (FirewallPolicyList) super.clone();
  }
