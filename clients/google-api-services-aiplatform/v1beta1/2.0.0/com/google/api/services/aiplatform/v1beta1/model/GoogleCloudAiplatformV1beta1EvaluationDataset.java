...
public final class GoogleCloudAiplatformV1beta1EvaluationDataset extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudAiplatformV1beta1EvaluationDataset setBigquerySource(GoogleCloudAiplatformV1beta1BigQuerySource bigquerySource) {
  ...
  @Override
  public GoogleCloudAiplatformV1beta1EvaluationDataset set(String fieldName, Object value) {
    return (GoogleCloudAiplatformV1beta1EvaluationDataset) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudAiplatformV1beta1EvaluationDataset clone() {
    return (GoogleCloudAiplatformV1beta1EvaluationDataset) super.clone();
  }
