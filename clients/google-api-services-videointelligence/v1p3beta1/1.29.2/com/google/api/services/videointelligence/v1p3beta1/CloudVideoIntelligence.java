...
/**
 * Service definition for CloudVideoIntelligence (v1p3beta1).
 *
 * <p>
...
public class CloudVideoIntelligence extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Videos {
     ...
     *
     * @param content the {@link com.google.api.services.videointelligence.v1p3beta1.model.GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest}
     * @return the request
     */
    public Annotate annotate(com.google.api.services.videointelligence.v1p3beta1.model.GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest content) throws java.io.IOException {
      Annotate result = new Annotate(content);
      initialize(result);
      return result;
    }

    public class Annotate extends CloudVideoIntelligenceRequest<com.google.api.services.videointelligence.v1p3beta1.model.GoogleLongrunningOperation> {

      private static final String REST_PATH = "v1p3beta1/videos:annotate";
       ...
       * @since 1.13
       */
      protected Annotate(com.google.api.services.videointelligence.v1p3beta1.model.GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest content) {
        super(CloudVideoIntelligence.this, "POST", REST_PATH, content, com.google.api.services.videointelligence.v1p3beta1.model.GoogleLongrunningOperation.class);
      }
