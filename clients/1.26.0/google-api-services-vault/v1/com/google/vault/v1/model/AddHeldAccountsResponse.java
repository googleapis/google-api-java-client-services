...
public final class AddHeldAccountsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.util.List<AddHeldAccountResult> getResponses() {
    return responses;
  }
   ...
   */
  public AddHeldAccountsResponse setResponses(java.util.List<AddHeldAccountResult> responses) {
    this.responses = responses;
    return this;
  }

  @Override
  public AddHeldAccountsResponse set(String fieldName, Object value) {
    return (AddHeldAccountsResponse) super.set(fieldName, value);
  }

  @Override
  public AddHeldAccountsResponse clone() {
