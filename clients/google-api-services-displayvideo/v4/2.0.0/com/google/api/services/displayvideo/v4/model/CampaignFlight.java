...
public final class CampaignFlight extends com.google.api.client.json.GenericJson {
  ...
  private java.lang.Long plannedSpendAmountMicros;
  ...
  @Override
  public CampaignFlight set(String fieldName, Object value) {
    return (CampaignFlight) super.set(fieldName, value);
  }

  @Override
  public CampaignFlight clone() {
    return (CampaignFlight) super.clone();
  }
