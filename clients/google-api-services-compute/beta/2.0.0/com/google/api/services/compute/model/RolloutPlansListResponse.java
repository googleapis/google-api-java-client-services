...
public final class RolloutPlansListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<RolloutPlan> items;

  static {
    // hack to force ProGuard to consider RolloutPlan used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(RolloutPlan.class);
  }
   ...
   */
  public RolloutPlansListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public RolloutPlansListResponse setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<RolloutPlan> getItems() {
    return items;
  }
   ...
   */
  public RolloutPlansListResponse setItems(java.util.List<RolloutPlan> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RolloutPlansListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RolloutPlansListResponse setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RolloutPlansListResponse setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public RolloutPlansListResponse setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RolloutPlansListResponse set(String fieldName, Object value) {
    return (RolloutPlansListResponse) super.set(fieldName, value);
  }

  @Override
  public RolloutPlansListResponse clone() {
    return (RolloutPlansListResponse) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RolloutPlansListResponseWarningData.
     */
