...
public final class AppsDynamiteSharedButton extends com.google.api.client.json.GenericJson {
   ...
   */
  public AppsDynamiteSharedButton setAltText(java.lang.String altText) {
   ...
   */
  public AppsDynamiteSharedButton setDisabled(java.lang.Boolean disabled) {
   ...
   */
  public AppsDynamiteSharedButton setIcon(AppsDynamiteSharedIcon icon) {
    this.icon = icon;
    return this;
  }
   ...
   */
  public AppsDynamiteSharedButton setOnClick(AppsDynamiteSharedOnClick onClick) {
   ...
   */
  public AppsDynamiteSharedButton setText(java.lang.String text) {
    this.text = text;
    return this;
  }

  @Override
  public AppsDynamiteSharedButton set(String fieldName, Object value) {
    return (AppsDynamiteSharedButton) super.set(fieldName, value);
  }

  @Override
  public AppsDynamiteSharedButton clone() {
