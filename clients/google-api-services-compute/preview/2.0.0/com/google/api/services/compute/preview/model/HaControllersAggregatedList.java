...
/**
 * Model definition for HaControllersAggregatedList.
 *
...
public final class HaControllersAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public HaControllersAggregatedList setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public HaControllersAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, HaControllersScopedList> getItems() {
    return items;
  }
   ...
   */
  public HaControllersAggregatedList setItems(java.util.Map<String, HaControllersScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HaControllersAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HaControllersAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HaControllersAggregatedList set(String fieldName, Object value) {
    return (HaControllersAggregatedList) super.set(fieldName, value);
  }

  @Override
  public HaControllersAggregatedList clone() {
    return (HaControllersAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for HaControllersAggregatedListWarningData.
     */
