...
public final class InstanceGroupManagerStatusStateful extends com.google.api.client.json.GenericJson {
  ...
  /**
   * [Output Only] A bit indicating whether the managed instance group is stateful, i.e. has any
   * disks in Stateful Policy or at least one per-instance config. This is determined based on the
   * user intent, the group may be reported as not stateful even when there is still some preserved
   * state on managed instances.
