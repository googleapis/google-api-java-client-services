...
public final class OperationAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public OperationAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, OperationsScopedList> getItems() {
    return items;
  }
   ...
   */
  public OperationAggregatedList setItems(java.util.Map<String, OperationsScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public OperationAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public OperationAggregatedList set(String fieldName, Object value) {
    return (OperationAggregatedList) super.set(fieldName, value);
  }

  @Override
  public OperationAggregatedList clone() {
    return (OperationAggregatedList) super.clone();
  }
