...
public final class ListReleaseSummariesResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public ListReleaseSummariesResponse set(String fieldName, Object value) {
    return (ListReleaseSummariesResponse) super.set(fieldName, value);
  }

  @Override
  public ListReleaseSummariesResponse clone() {
    return (ListReleaseSummariesResponse) super.clone();
  }
