...
/**
 * Model definition for HealthAggregationPolicyList.
 *
...
public final class HealthAggregationPolicyList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<HealthAggregationPolicy> items;

  static {
    // hack to force ProGuard to consider HealthAggregationPolicy used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(HealthAggregationPolicy.class);
  }
   ...
   */
  public HealthAggregationPolicyList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<HealthAggregationPolicy> getItems() {
    return items;
  }
   ...
   */
  public HealthAggregationPolicyList setItems(java.util.List<HealthAggregationPolicy> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public HealthAggregationPolicyList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public HealthAggregationPolicyList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public HealthAggregationPolicyList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthAggregationPolicyList set(String fieldName, Object value) {
    return (HealthAggregationPolicyList) super.set(fieldName, value);
  }

  @Override
  public HealthAggregationPolicyList clone() {
    return (HealthAggregationPolicyList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for HealthAggregationPolicyListWarningData.
     */
