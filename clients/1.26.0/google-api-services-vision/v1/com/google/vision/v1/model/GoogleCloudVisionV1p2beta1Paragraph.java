...
public final class GoogleCloudVisionV1p2beta1Paragraph extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<GoogleCloudVisionV1p2beta1Word> words;

  static {
    // hack to force ProGuard to consider GoogleCloudVisionV1p2beta1Word used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(GoogleCloudVisionV1p2beta1Word.class);
  }
   ...
   */
  public GoogleCloudVisionV1p2beta1Paragraph setBoundingBox(GoogleCloudVisionV1p2beta1BoundingPoly boundingBox) {
   ...
   */
  public GoogleCloudVisionV1p2beta1Paragraph setConfidence(java.lang.Float confidence) {
   ...
   */
  public GoogleCloudVisionV1p2beta1Paragraph setProperty(GoogleCloudVisionV1p2beta1TextAnnotationTextProperty property) {
  ...
  @Override
  public GoogleCloudVisionV1p2beta1Paragraph set(String fieldName, Object value) {
    return (GoogleCloudVisionV1p2beta1Paragraph) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudVisionV1p2beta1Paragraph clone() {
    return (GoogleCloudVisionV1p2beta1Paragraph) super.clone();
  }
