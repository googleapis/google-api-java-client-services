...
<project>
  <dependencies>
    <dependency>
      ...
      <version>ordertracking_v1beta-rev20260223-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:ordertracking_v1beta-rev20260223-2.0.0'
}
```
