...
public final class CreateClusterMetadata extends com.google.api.client.json.GenericJson {
   ...
   * call will be created in the new cluster by that API call, not this one. Values: information on
   * how much of a table's data has been copied to the newly-created cluster so far.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
