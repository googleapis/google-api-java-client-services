...
public final class GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams extends com.google.api.client.json.GenericJson {
   ...
   * `DOCUMENTS`. See [parse and chunk documents](https://cloud.google.com/generative-ai-app-
   * builder/docs/parse-chunk-documents)
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setBoostSpec(GoogleCloudDiscoveryengineV1SearchRequestBoostSpec boostSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setDataStoreSpecs(java.util.List<GoogleCloudDiscoveryengineV1SearchRequestDataStoreSpec> dataStoreSpecs) {
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setFilter(java.lang.String filter) {
    this.filter = filter;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setMaxReturnResults(java.lang.Integer maxReturnResults) {
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setOrderBy(java.lang.String orderBy) {
   ...
   */
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams setSearchResultMode(java.lang.String searchResultMode) {
    this.searchResultMode = searchResultMode;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams clone() {
    return (GoogleCloudDiscoveryengineV1AnswerQueryRequestSearchSpecSearchParams) super.clone();
  }
