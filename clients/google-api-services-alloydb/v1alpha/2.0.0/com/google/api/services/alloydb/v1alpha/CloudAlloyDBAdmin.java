  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Clusters {
         ...
         * @param content the {@link com.google.api.services.alloydb.v1alpha.model.GenerateClientCertificateRequest}
         * @return the request
         */
        public GenerateClientCertificate generateClientCertificate(java.lang.String parent, com.google.api.services.alloydb.v1alpha.model.GenerateClientCertificateRequest content) throws java.io.IOException {
          GenerateClientCertificate result = new GenerateClientCertificate(parent, content);
          initialize(result);
          return result;
        }

        public class GenerateClientCertificate extends CloudAlloyDBAdminRequest<com.google.api.services.alloydb.v1alpha.model.GenerateClientCertificateResponse> {

          private static final String REST_PATH = "v1alpha/{+parent}:generateClientCertificate";
         ...
         *        projects/{project}/locations/{location}/clusters/{cluster}
           ...
           * @since 1.13
           */
          protected GenerateClientCertificate(java.lang.String parent, com.google.api.services.alloydb.v1alpha.model.GenerateClientCertificateRequest content) {
            super(CloudAlloyDBAdmin.this, "POST", REST_PATH, content, com.google.api.services.alloydb.v1alpha.model.GenerateClientCertificateResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
