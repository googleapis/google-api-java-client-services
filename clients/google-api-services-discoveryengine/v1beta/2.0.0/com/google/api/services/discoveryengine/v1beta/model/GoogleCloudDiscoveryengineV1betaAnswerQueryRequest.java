...
public final class GoogleCloudDiscoveryengineV1betaAnswerQueryRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1betaAnswerQueryRequestEndUserSpec endUserSpec;
   ...
   */
  @com.google.api.client.util.Key
  private GoogleCloudDiscoveryengineV1betaAnswerQueryRequestGroundingSpec groundingSpec;
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setAnswerGenerationSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestAnswerGenerationSpec answerGenerationSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setAsynchronousMode(java.lang.Boolean asynchronousMode) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequestEndUserSpec getEndUserSpec() {
    return endUserSpec;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setEndUserSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestEndUserSpec endUserSpec) {
   ...
   * @return value or {@code null} for none
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequestGroundingSpec getGroundingSpec() {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setGroundingSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestGroundingSpec groundingSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setQuery(GoogleCloudDiscoveryengineV1betaQuery query) {
    this.query = query;
    return this;
  }
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setQueryUnderstandingSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestQueryUnderstandingSpec queryUnderstandingSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setRelatedQuestionsSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestRelatedQuestionsSpec relatedQuestionsSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setSafetySpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestSafetySpec safetySpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setSearchSpec(GoogleCloudDiscoveryengineV1betaAnswerQueryRequestSearchSpec searchSpec) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setUserLabels(java.util.Map<String, java.lang.String> userLabels) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest setUserPseudoId(java.lang.String userPseudoId) {
    this.userPseudoId = userPseudoId;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaAnswerQueryRequest) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaAnswerQueryRequest clone() {
