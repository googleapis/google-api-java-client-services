...
public final class GoogleTypeTimeOfDay extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public GoogleTypeTimeOfDay set(String fieldName, Object value) {
    return (GoogleTypeTimeOfDay) super.set(fieldName, value);
  }

  @Override
  public GoogleTypeTimeOfDay clone() {
    return (GoogleTypeTimeOfDay) super.clone();
  }
