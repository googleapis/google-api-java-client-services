...
/**
 * Model definition for StoragePoolTypesScopedList.
 *
...
public final class StoragePoolTypesScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<StoragePoolType> storagePoolTypes;
   ...
   */
  public java.util.List<StoragePoolType> getStoragePoolTypes() {
    return storagePoolTypes;
  }

  /**
   * [Output Only] A list of storage pool types contained in this scope.
   * @param storagePoolTypes storagePoolTypes or {@code null} for none
   */
  public StoragePoolTypesScopedList setStoragePoolTypes(java.util.List<StoragePoolType> storagePoolTypes) {
   ...
   */
  public StoragePoolTypesScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public StoragePoolTypesScopedList set(String fieldName, Object value) {
    return (StoragePoolTypesScopedList) super.set(fieldName, value);
  }

  @Override
  public StoragePoolTypesScopedList clone() {
    return (StoragePoolTypesScopedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for StoragePoolTypesScopedListWarningData.
     */
