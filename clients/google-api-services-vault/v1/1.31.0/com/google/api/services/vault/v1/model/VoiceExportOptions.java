...
public final class VoiceExportOptions extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public VoiceExportOptions set(String fieldName, Object value) {
    return (VoiceExportOptions) super.set(fieldName, value);
  }

  @Override
  public VoiceExportOptions clone() {
    return (VoiceExportOptions) super.clone();
  }
