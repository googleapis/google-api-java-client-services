...
public final class InventoryPickup extends com.google.api.client.json.GenericJson {
   ...
   * supported", must be submitted together with `pickupSla`. Acceptable values are: - "`buy`" -
   * "`not supported`" - "`reserve`" - "`ship to store`"
   ...
   * Only supported for local inventory. Must be submitted together with `pickupMethod`. Acceptable
   * values are: - "`five day`" - "`four day`" - "`multi day`" - "`multi week`" - "`next day`" -
   * "`same day`" - "`seven day`" - "`six day`" - "`three day`" - "`two day`"
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
