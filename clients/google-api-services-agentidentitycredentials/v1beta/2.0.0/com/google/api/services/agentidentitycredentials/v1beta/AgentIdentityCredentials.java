...
package com.google.api.services.agentidentitycredentials.v1beta;

/**
 * Service definition for AgentIdentityCredentials (v1beta).
 *
 * <p>
 ...
 *
 * <p>
 * This service uses {@link AgentIdentityCredentialsRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class AgentIdentityCredentials extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "2.0.0 of the Agent Identity Credentials API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://agentidentitycredentials.googleapis.com/";
   ...
   * @since 1.31
   */
  public static final String DEFAULT_MTLS_ROOT_URL = "https://agentidentitycredentials.mtls.googleapis.com/";
   ...
   * @since 1.7
   */
  public AgentIdentityCredentials(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  AgentIdentityCredentials(Builder builder) {
    super(builder);
  }
    ...
    public class Locations {
      ...
      public class AuthProviders {
        ...
        public class Credentials {
           ...
           * @param content the {@link com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest}
           * @return the request
           */
          public Finalize finalize(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest content) throws java.io.IOException {
            Finalize result = new Finalize(authProvider, content);
            initialize(result);
            return result;
          }

          public class Finalize extends AgentIdentityCredentialsRequest<com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsResponse> {

            private static final String REST_PATH = "v1beta/{+authProvider}/credentials:finalize";
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
             ...
             * @since 1.13
             */
            protected Finalize(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsRequest content) {
              super(AgentIdentityCredentials.this, "POST", REST_PATH, content, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaFinalizeCredentialsResponse.class);
           ...
           *
           * Create a request for the method "credentials.retrieve".
           *
           * This request holds the parameters needed by the agentidentitycredentials server.  After setting
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
           * @param content the {@link com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest}
           * @return the request
           */
          public Retrieve retrieve(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest content) throws java.io.IOException {
            Retrieve result = new Retrieve(authProvider, content);
            initialize(result);
            return result;
          }

          public class Retrieve extends AgentIdentityCredentialsRequest<com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsResponse> {

            private static final String REST_PATH = "v1beta/{+authProvider}/credentials:retrieve";
             ...
             *
             * This request holds the parameters needed by the the agentidentitycredentials server.  After
             * setting any optional parameters, call the {@link Retrieve#execute()} method to invoke the
             * remote operation. <p> {@link
           ...
           *        `projects/{project}/locations/{location}/authProviders/{auth_provider}`
             ...
             * @since 1.13
             */
            protected Retrieve(java.lang.String authProvider, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsRequest content) {
              super(AgentIdentityCredentials.this, "POST", REST_PATH, content, com.google.api.services.agentidentitycredentials.v1beta.model.GoogleCloudAgentidentitycredentialsV1betaRetrieveCredentialsResponse.class);
              this.authProvider = com.google.api.client.util.Preconditions.checkNotNull(authProvider, "Required parameter authProvider must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(AUTH_PROVIDER_PATTERN.matcher(authProvider).matches(),
                    "Parameter authProvider must conform to the pattern " +
  ...
  /**
   * Builder for {@link AgentIdentityCredentials}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link AgentIdentityCredentials}. */
    @Override
    public AgentIdentityCredentials build() {
      return new AgentIdentityCredentials(this);
    }
    ...
    /**
     * Set the {@link AgentIdentityCredentialsRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setAgentIdentityCredentialsRequestInitializer(
        AgentIdentityCredentialsRequestInitializer agentidentitycredentialsRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(agentidentitycredentialsRequestInitializer);
    }
