...
public final class GoogleCloudDiscoveryengineV1TrainCustomModelResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse setErrorConfig(GoogleCloudDiscoveryengineV1ImportErrorConfig errorConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse setErrorSamples(java.util.List<GoogleRpcStatus> errorSamples) {
   ...
   */
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse setMetrics(java.util.Map<String, java.lang.Double> metrics) {
   ...
   */
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse setModelName(java.lang.String modelName) {
   ...
   */
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse setModelStatus(java.lang.String modelStatus) {
    this.modelStatus = modelStatus;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1TrainCustomModelResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1TrainCustomModelResponse clone() {
    return (GoogleCloudDiscoveryengineV1TrainCustomModelResponse) super.clone();
  }
