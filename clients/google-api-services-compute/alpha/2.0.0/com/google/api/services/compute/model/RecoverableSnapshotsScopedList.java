...
/**
 * Model definition for RecoverableSnapshotsScopedList.
 *
...
public final class RecoverableSnapshotsScopedList extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<RecoverableSnapshot> recoverablesnapshots;

  static {
    // hack to force ProGuard to consider RecoverableSnapshot used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(RecoverableSnapshot.class);
  }

  /**
   * [Output Only] Informational warning which replaces the list of recoverablesnapshots when the
   * list is empty.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public java.util.List<RecoverableSnapshot> getRecoverablesnapshots() {
    return recoverablesnapshots;
  }

  /**
   * [Output Only] A list of recoverablesnapshots contained in this scope.
   * @param recoverablesnapshots recoverablesnapshots or {@code null} for none
   */
  public RecoverableSnapshotsScopedList setRecoverablesnapshots(java.util.List<RecoverableSnapshot> recoverablesnapshots) {
    this.recoverablesnapshots = recoverablesnapshots;
    return this;
  }
   ...
   */
  public RecoverableSnapshotsScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RecoverableSnapshotsScopedList set(String fieldName, Object value) {
    return (RecoverableSnapshotsScopedList) super.set(fieldName, value);
  }

  @Override
  public RecoverableSnapshotsScopedList clone() {
    return (RecoverableSnapshotsScopedList) super.clone();
  }

  /**
   * [Output Only] Informational warning which replaces the list of recoverablesnapshots when the list
   * is empty.
   */
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for RecoverableSnapshotsScopedListWarningData.
     */
