...
/**
 * Details of the database node resource. https://docs.oracle.com/en-
...
public final class DbNode extends com.google.api.client.json.GenericJson {
   ...
   */
  public DbNode setName(java.lang.String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public DbNode setProperties(DbNodeProperties properties) {
    this.properties = properties;
    return this;
  }

  @Override
  public DbNode set(String fieldName, Object value) {
    return (DbNode) super.set(fieldName, value);
  }

  @Override
  public DbNode clone() {
    return (DbNode) super.clone();
  }
