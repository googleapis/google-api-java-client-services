...
public final class MergedResult extends com.google.api.client.json.GenericJson {
   ...
   *
   *  Combining:  When the test cases from a suite are run in different steps (sharding),  the
   * results are added back together in one overview. (e.g., if shard1 has  2 failures and shard2
   * has 1 failure than the overview failure_count = 3).
   *
