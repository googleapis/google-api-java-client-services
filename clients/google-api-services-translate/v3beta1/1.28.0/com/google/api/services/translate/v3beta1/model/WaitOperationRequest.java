...
public final class WaitOperationRequest extends com.google.api.client.json.GenericJson {
   ...
   */
  public WaitOperationRequest setTimeout(String timeout) {
    this.timeout = timeout;
    return this;
  }

  @Override
  public WaitOperationRequest set(String fieldName, Object value) {
    return (WaitOperationRequest) super.set(fieldName, value);
  }

  @Override
  public WaitOperationRequest clone() {
    return (WaitOperationRequest) super.clone();
  }
