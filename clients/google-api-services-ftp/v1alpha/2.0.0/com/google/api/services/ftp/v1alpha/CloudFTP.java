...
package com.google.api.services.ftp.v1alpha;
...
public class CloudFTP extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Location> {
        ...
        protected Get(java.lang.String name) {
          super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.Location.class);
      ...
      public class List extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.ListLocationsResponse> {
        ...
        protected List(java.lang.String name) {
          super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.ListLocationsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Operations {
        ...
        public class Cancel extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Empty> {
           ...
           * @since 1.13
           */
          protected Cancel(java.lang.String name, com.google.api.services.ftp.v1alpha.model.CancelOperationRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Delete extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(CloudFTP.this, "DELETE", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.Empty.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.ListOperationsResponse> {
           ...
           */
          protected List(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.ListOperationsResponse.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
      ...
      public class Servers {
        ...
        public class Create extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {

          private static final String REST_PATH = "v1alpha/{+parent}/servers";
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.ftp.v1alpha.model.Server content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
        ...
        public class Delete extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
           ...
           */
          protected Delete(java.lang.String name) {
            super(CloudFTP.this, "DELETE", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Server> {
           ...
           */
          protected Get(java.lang.String name) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.Server.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class List extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.ListServersResponse> {
          ...
          protected List(java.lang.String parent) {
            super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.ListServersResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.ftp.v1alpha.model.Server content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.ftp.v1alpha.model.Server content) {
            super(CloudFTP.this, "PATCH", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
         ...
         * @param content the {@link com.google.api.services.ftp.v1alpha.model.StartServerRequest}
         * @return the request
         */
        public Start start(java.lang.String name, com.google.api.services.ftp.v1alpha.model.StartServerRequest content) throws java.io.IOException {
          Start result = new Start(name, content);
          initialize(result);
          return result;
        }

        public class Start extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
           ...
           * @since 1.13
           */
          protected Start(java.lang.String name, com.google.api.services.ftp.v1alpha.model.StartServerRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
         ...
         *
         * @param name Required. Name of the resource. Format: `projects/{project}/locations/{location}/servers/{server}`
         * @param content the {@link com.google.api.services.ftp.v1alpha.model.StopServerRequest}
         * @return the request
         */
        public Stop stop(java.lang.String name, com.google.api.services.ftp.v1alpha.model.StopServerRequest content) throws java.io.IOException {
          Stop result = new Stop(name, content);
          initialize(result);
          return result;
        }

        public class Stop extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
           ...
           * @since 1.13
           */
          protected Stop(java.lang.String name, com.google.api.services.ftp.v1alpha.model.StopServerRequest content) {
            super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
        ...
        public class Users {
          ...
          public class Create extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.Operation> {
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.ftp.v1alpha.model.User content) {
              super(CloudFTP.this, "POST", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
          ...
          public class Get extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.User> {
             ...
             */
            protected Get(java.lang.String name) {
              super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.User.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends CloudFTPRequest<com.google.api.services.ftp.v1alpha.model.ListUsersResponse> {
             ...
             */
            protected List(java.lang.String parent) {
              super(CloudFTP.this, "GET", REST_PATH, null, com.google.api.services.ftp.v1alpha.model.ListUsersResponse.class);
              this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                    "Parameter parent must conform to the pattern " +
           ...
           * @return the request
           */
          public Patch patch(java.lang.String name, com.google.api.services.ftp.v1alpha.model.User content) throws java.io.IOException {
            Patch result = new Patch(name, content);
            initialize(result);
            return result;
          }
           ...
           *        projects/{project}/locations/{location}/servers/{server}/users/{user}
             ...
             * @since 1.13
             */
            protected Patch(java.lang.String name, com.google.api.services.ftp.v1alpha.model.User content) {
              super(CloudFTP.this, "PATCH", REST_PATH, content, com.google.api.services.ftp.v1alpha.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
