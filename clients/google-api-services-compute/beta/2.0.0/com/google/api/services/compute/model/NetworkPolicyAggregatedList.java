...
/**
 * Model definition for NetworkPolicyAggregatedList.
 *
...
public final class NetworkPolicyAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, NetworkPoliciesScopedList> items;

  static {
    // hack to force ProGuard to consider NetworkPoliciesScopedList used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(NetworkPoliciesScopedList.class);
  }

  /**
   * [Output Only] Type of resource. Always compute#networkPolicyAggregatedList for lists of network
   * policies.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public NetworkPolicyAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, NetworkPoliciesScopedList> getItems() {
    return items;
  }
   ...
   */
  public NetworkPolicyAggregatedList setItems(java.util.Map<String, NetworkPoliciesScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public NetworkPolicyAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public NetworkPolicyAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public NetworkPolicyAggregatedList set(String fieldName, Object value) {
    return (NetworkPolicyAggregatedList) super.set(fieldName, value);
  }

  @Override
  public NetworkPolicyAggregatedList clone() {
    return (NetworkPolicyAggregatedList) super.clone();
  }
  ...
  public static final class Warning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * Model definition for NetworkPolicyAggregatedListWarningData.
     */
