...
public class Genomics extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.32.1 of the Genomics API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Pipelines {
     ...
     * pipeline completes successfully. **Note:** Before you can use this method, the Genomics Service
     * Agent must have access to your project. This is done automatically when the Cloud Genomics API is
     * first enabled, but if you delete this permission, or if you enabled the Cloud Genomics API before
     * the v2alpha1 API launch, you must disable and re-enable the API to grant the Genomics Service
     * Agent the required permissions. Authorization requires the following [Google
    ...
    public class Run extends GenomicsRequest<com.google.api.services.genomics.v2alpha1.model.Operation> {
       ...
       * [response] field will contain a google.genomics.v2alpha1.RunPipelineResponse object if the
       * pipeline completes successfully. **Note:** Before you can use this method, the Genomics Service
       * Agent must have access to your project. This is done automatically when the Cloud Genomics API
       * is first enabled, but if you delete this permission, or if you enabled the Cloud Genomics API
       * before the v2alpha1 API launch, you must disable and re-enable the API to grant the Genomics
       * Service Agent the required permissions. Authorization requires the following [Google
       * IAM](https://cloud.google.com/iam/) permission: * `genomics.operations.create` [1]:
       * /genomics/gsa
       *
       * Create a request for the method "pipelines.run".
       *
  ...
  public class Projects {
    ...
    public class Operations {
      ...
      public class List extends GenomicsRequest<com.google.api.services.genomics.v2alpha1.model.ListOperationsResponse> {
        ...
        /**
         * A string for filtering Operations. In v2alpha1, the following filter fields are
         * supported: * createTime: The time this job was created * events: The set of event (names)
         * that have occurred while running the pipeline. The : operator can be used to determine if
         * a particular event has occurred. * error: If the pipeline is running, this value is NULL.
         * Once the pipeline finishes, the value is the standard Google error code. * labels.key or
         * labels."key with space" where key is a label key. * done: If the pipeline is running,
         * this value is false. Once the pipeline finishes, the value is true. Examples: *
       ...
       value is true. Examples: * `projectId = my-project AND createTime >= 1432140000` * `projectId = my-
       project AND createTime >= 1432140000 AND createTime <= 1432150000 AND status = RUNNING` *
       `projectId = my-project AND labels.color = *` * `projectId = my-project AND labels.color = red`
         */
