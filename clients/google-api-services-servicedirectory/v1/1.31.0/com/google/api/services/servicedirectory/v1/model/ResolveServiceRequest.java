...
public final class ResolveServiceRequest extends com.google.api.client.json.GenericJson {
   ...
   * than the string, so "endpoint-e" is returned but "endpoint-a" is not * `annotations.owner!=sd
   * AND annotations.foo=bar` returns endpoints that have `owner` in annotation key but value is not
