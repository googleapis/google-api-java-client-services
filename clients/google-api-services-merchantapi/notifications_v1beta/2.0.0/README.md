...
<project>
  <dependencies>
    <dependency>
      ...
      <version>notifications_v1beta-rev20260901-2.0.0</version>
    </dependency>
  </dependencies>
</project>
```
...
dependencies {
  implementation 'com.google.apis:google-api-services-merchantapi:notifications_v1beta-rev20260901-2.0.0'
}
```
