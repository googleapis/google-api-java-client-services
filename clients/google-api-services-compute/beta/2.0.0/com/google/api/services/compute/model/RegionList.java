...
public final class RegionList extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider Region used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(Region.class);
  }
   ...
   */
  public RegionList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Region> getItems() {
    return items;
  }
   ...
   */
  public RegionList setItems(java.util.List<Region> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RegionList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RegionList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RegionList set(String fieldName, Object value) {
    return (RegionList) super.set(fieldName, value);
  }
