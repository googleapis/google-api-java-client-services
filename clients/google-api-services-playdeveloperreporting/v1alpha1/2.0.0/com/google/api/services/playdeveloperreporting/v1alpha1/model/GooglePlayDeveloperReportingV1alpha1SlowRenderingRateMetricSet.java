 ...
 * (string): unique identifier of the user's device model. * `deviceBrand` (string): unique
 * identifier of the user's device brand. * `deviceType` (string): the type (also known as form
 * factor) of the user's device. * `countryCode` (string): the country or region of the user's
