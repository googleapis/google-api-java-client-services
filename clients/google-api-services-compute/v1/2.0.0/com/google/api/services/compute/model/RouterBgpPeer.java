...
public final class RouterBgpPeer extends com.google.api.client.json.GenericJson {
   ...
   * following option:        - ALL_SUBNETS: Advertises all of the router's own VPC subnets. This
   ...
   * updates, and deletes this type of    BGP peer when the PARTNER InterconnectAttachment is
