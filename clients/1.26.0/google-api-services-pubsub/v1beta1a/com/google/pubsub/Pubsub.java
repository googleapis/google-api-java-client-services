...
public class Pubsub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Subscriptions {
     ...
     * @return the request
     */
    public Acknowledge acknowledge(com.google.pubsub.model.AcknowledgeRequest content) throws java.io.IOException {
    ...
    public class Acknowledge extends PubsubRequest<com.google.pubsub.model.Empty> {
       ...
       * @since 1.13
       */
      protected Acknowledge(com.google.pubsub.model.AcknowledgeRequest content) {
     ...
     * @return the request
     */
    public Create create(com.google.pubsub.model.Subscription content) throws java.io.IOException {
    ...
    public class Create extends PubsubRequest<com.google.pubsub.model.Subscription> {
       ...
       * @since 1.13
       */
      protected Create(com.google.pubsub.model.Subscription content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Subscription.class);
      }
     ...
     * @return the request
     */
    public ModifyAckDeadline modifyAckDeadline(com.google.pubsub.model.ModifyAckDeadlineRequest content) throws java.io.IOException {
    ...
    public class ModifyAckDeadline extends PubsubRequest<com.google.pubsub.model.Empty> {
       ...
       * @since 1.13
       */
      protected ModifyAckDeadline(com.google.pubsub.model.ModifyAckDeadlineRequest content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
      }
     ...
     * @return the request
     */
    public ModifyPushConfig modifyPushConfig(com.google.pubsub.model.ModifyPushConfigRequest content) throws java.io.IOException {
    ...
    public class ModifyPushConfig extends PubsubRequest<com.google.pubsub.model.Empty> {
       ...
       * @since 1.13
       */
      protected ModifyPushConfig(com.google.pubsub.model.ModifyPushConfigRequest content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
      }
     ...
     * @return the request
     */
    public Pull pull(com.google.pubsub.model.PullRequest content) throws java.io.IOException {
    ...
    public class Pull extends PubsubRequest<com.google.pubsub.model.PullResponse> {
       ...
       * @since 1.13
       */
      protected Pull(com.google.pubsub.model.PullRequest content) {
     ...
     *
     * @param content the {@link com.google.pubsub.model.PullBatchRequest}
     * @return the request
     */
    public PullBatch pullBatch(com.google.pubsub.model.PullBatchRequest content) throws java.io.IOException {
      PullBatch result = new PullBatch(content);
      initialize(result);
      return result;
    }

    public class PullBatch extends PubsubRequest<com.google.pubsub.model.PullBatchResponse> {
       ...
       * @since 1.13
       */
      protected PullBatch(com.google.pubsub.model.PullBatchRequest content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.PullBatchResponse.class);
      }
  ...
  public class Topics {
     ...
     * @return the request
     */
    public Create create(com.google.pubsub.model.Topic content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }
    ...
    public class Create extends PubsubRequest<com.google.pubsub.model.Topic> {
       ...
       * @since 1.13
       */
      protected Create(com.google.pubsub.model.Topic content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Topic.class);
      }
     ...
     * @return the request
     */
    public Publish publish(com.google.pubsub.model.PublishRequest content) throws java.io.IOException {
      Publish result = new Publish(content);
      initialize(result);
      return result;
    }

    public class Publish extends PubsubRequest<com.google.pubsub.model.Empty> {
       ...
       * @since 1.13
       */
      protected Publish(com.google.pubsub.model.PublishRequest content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.Empty.class);
      }
     ...
     *
     * @param content the {@link com.google.pubsub.model.PublishBatchRequest}
     * @return the request
     */
    public PublishBatch publishBatch(com.google.pubsub.model.PublishBatchRequest content) throws java.io.IOException {
      PublishBatch result = new PublishBatch(content);
      initialize(result);
      return result;
    }

    public class PublishBatch extends PubsubRequest<com.google.pubsub.model.PublishBatchResponse> {
       ...
       * @since 1.13
       */
      protected PublishBatch(com.google.pubsub.model.PublishBatchRequest content) {
        super(Pubsub.this, "POST", REST_PATH, content, com.google.pubsub.model.PublishBatchResponse.class);
      }
