...
public final class StartWorkstationRequest extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public StartWorkstationRequest set(String fieldName, Object value) {
    return (StartWorkstationRequest) super.set(fieldName, value);
  }

  @Override
  public StartWorkstationRequest clone() {
    return (StartWorkstationRequest) super.clone();
  }
