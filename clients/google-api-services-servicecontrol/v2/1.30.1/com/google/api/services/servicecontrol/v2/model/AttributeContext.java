 ...
 *
 * An attribute is a piece of metadata that describes an activity on a network service. For example,
 * the size of an HTTP request, or the status code of an HTTP response.
 *
