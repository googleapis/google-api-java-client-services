...
public class Spanner extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Cloud Spanner API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class InstanceConfigs {
      ...
      public class Get extends SpannerRequest<com.google.spanner.v1.model.InstanceConfig> {
       ...
       *        `projects//instanceConfigs/`.
        ...
        protected Get(java.lang.String name) {
          super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.InstanceConfig.class);
      ...
      public class List extends SpannerRequest<com.google.spanner.v1.model.ListInstanceConfigsResponse> {
      ...
      `projects/`.
        ...
        protected List(java.lang.String parent) {
          super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.ListInstanceConfigsResponse.class);
    ...
    public class Instances {
      ...
      are of the form
       *        `projects/`.
       * @param content the {@link com.google.spanner.v1.model.CreateInstanceRequest}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.spanner.v1.model.CreateInstanceRequest content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }

      public class Create extends SpannerRequest<com.google.spanner.v1.model.Operation> {
       ...
       *        `projects/`.
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.spanner.v1.model.CreateInstanceRequest content) {
          super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
      ...
      public class Delete extends SpannerRequest<com.google.spanner.v1.model.Empty> {
      ...
      `projects//instances/`
        ...
        protected Delete(java.lang.String name) {
          super(Spanner.this, "DELETE", REST_PATH, null, com.google.spanner.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends SpannerRequest<com.google.spanner.v1.model.Instance> {
      ...
      `projects//instances/`.
         ...
         */
        protected Get(java.lang.String name) {
          super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.Instance.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        database resources.
       * @param content the {@link com.google.spanner.v1.model.GetIamPolicyRequest}
       * @return the request
       */
      public GetIamPolicy getIamPolicy(java.lang.String resource, com.google.spanner.v1.model.GetIamPolicyRequest content) throws java.io.IOException {
        GetIamPolicy result = new GetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class GetIamPolicy extends SpannerRequest<com.google.spanner.v1.model.Policy> {
       ...
       *        database resources.
         ...
         * @since 1.13
         */
        protected GetIamPolicy(java.lang.String resource, com.google.spanner.v1.model.GetIamPolicyRequest content) {
          super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Policy.class);
      ...
      public class List extends SpannerRequest<com.google.spanner.v1.model.ListInstancesResponse> {
       ...
       *        `projects/`.
         ...
         */
        protected List(java.lang.String parent) {
          super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.ListInstancesResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @param content the {@link com.google.spanner.v1.model.UpdateInstanceRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.spanner.v1.model.UpdateInstanceRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends SpannerRequest<com.google.spanner.v1.model.Operation> {
       ...
       *        the name must be between 6 and 30 characters in length.
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.spanner.v1.model.UpdateInstanceRequest content) {
          super(Spanner.this, "PATCH", REST_PATH, content, com.google.spanner.v1.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       *        `projects//instances/` for instance resources and `projects//instances//databases/` for
       *        databases resources.
       * @param content the {@link com.google.spanner.v1.model.SetIamPolicyRequest}
       * @return the request
       */
      public SetIamPolicy setIamPolicy(java.lang.String resource, com.google.spanner.v1.model.SetIamPolicyRequest content) throws java.io.IOException {
        SetIamPolicy result = new SetIamPolicy(resource, content);
        initialize(result);
        return result;
      }

      public class SetIamPolicy extends SpannerRequest<com.google.spanner.v1.model.Policy> {
       ...
       *        databases resources.
         ...
         * @since 1.13
         */
        protected SetIamPolicy(java.lang.String resource, com.google.spanner.v1.model.SetIamPolicyRequest content) {
          super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Policy.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
       ...
       *        `projects//instances/` for instance resources and `projects//instances//databases/` for
       *        database resources.
       * @param content the {@link com.google.spanner.v1.model.TestIamPermissionsRequest}
       * @return the request
       */
      public TestIamPermissions testIamPermissions(java.lang.String resource, com.google.spanner.v1.model.TestIamPermissionsRequest content) throws java.io.IOException {
        TestIamPermissions result = new TestIamPermissions(resource, content);
        initialize(result);
        return result;
      }

      public class TestIamPermissions extends SpannerRequest<com.google.spanner.v1.model.TestIamPermissionsResponse> {
       ...
       *        database resources.
         ...
         * @since 1.13
         */
        protected TestIamPermissions(java.lang.String resource, com.google.spanner.v1.model.TestIamPermissionsRequest content) {
          super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.TestIamPermissionsResponse.class);
          this.resource = com.google.api.client.util.Preconditions.checkNotNull(resource, "Required parameter resource must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(RESOURCE_PATTERN.matcher(resource).matches(),
                "Parameter resource must conform to the pattern " +
      ...
      public class Databases {
         ...
         *        `projects//instances/`.
         * @param content the {@link com.google.spanner.v1.model.CreateDatabaseRequest}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.spanner.v1.model.CreateDatabaseRequest content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }
         ...
         *        `projects//instances/`.
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.spanner.v1.model.CreateDatabaseRequest content) {
            super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Operation.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
        ...
        public class DropDatabase extends SpannerRequest<com.google.spanner.v1.model.Empty> {
        ...
        public class Get extends SpannerRequest<com.google.spanner.v1.model.Database> {
         ...
         *        `projects//instances//databases/`.
           ...
           */
          protected Get(java.lang.String name) {
            super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.Database.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
        ...
        public class GetDdl extends SpannerRequest<com.google.spanner.v1.model.GetDatabaseDdlResponse> {
          ...
          protected GetDdl(java.lang.String database) {
            super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.GetDatabaseDdlResponse.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                  "Parameter database must conform to the pattern " +
        ...
        public class List extends SpannerRequest<com.google.spanner.v1.model.ListDatabasesResponse> {
         ...
         *        `projects//instances/`.
           ...
           */
          protected List(java.lang.String parent) {
            super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.ListDatabasesResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
         ...
         * @param content the {@link com.google.spanner.v1.model.UpdateDatabaseDdlRequest}
         * @return the request
         */
        public UpdateDdl updateDdl(java.lang.String database, com.google.spanner.v1.model.UpdateDatabaseDdlRequest content) throws java.io.IOException {
          UpdateDdl result = new UpdateDdl(database, content);
          initialize(result);
          return result;
        }

        public class UpdateDdl extends SpannerRequest<com.google.spanner.v1.model.Operation> {
           ...
           * @since 1.13
           */
          protected UpdateDdl(java.lang.String database, com.google.spanner.v1.model.UpdateDatabaseDdlRequest content) {
            super(Spanner.this, "PATCH", REST_PATH, content, com.google.spanner.v1.model.Operation.class);
            this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
        ...
        public class Operations {
          ...
          public class Cancel extends SpannerRequest<com.google.spanner.v1.model.Empty> {
            ...
            protected Cancel(java.lang.String name) {
              super(Spanner.this, "POST", REST_PATH, null, com.google.spanner.v1.model.Empty.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class Get extends SpannerRequest<com.google.spanner.v1.model.Operation> {
             ...
             */
            protected Get(java.lang.String name) {
              super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.Operation.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends SpannerRequest<com.google.spanner.v1.model.ListOperationsResponse> {
            ...
            protected List(java.lang.String name) {
              super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.ListOperationsResponse.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
        ...
        public class Sessions {
           ...
           * @param content the {@link com.google.spanner.v1.model.BeginTransactionRequest}
           * @return the request
           */
          public BeginTransaction beginTransaction(java.lang.String session, com.google.spanner.v1.model.BeginTransactionRequest content) throws java.io.IOException {
            BeginTransaction result = new BeginTransaction(session, content);
            initialize(result);
            return result;
          }

          public class BeginTransaction extends SpannerRequest<com.google.spanner.v1.model.Transaction> {
             ...
             * @since 1.13
             */
            protected BeginTransaction(java.lang.String session, com.google.spanner.v1.model.BeginTransactionRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Transaction.class);
           ...
           * @param content the {@link com.google.spanner.v1.model.CommitRequest}
           * @return the request
           */
          public Commit commit(java.lang.String session, com.google.spanner.v1.model.CommitRequest content) throws java.io.IOException {
            Commit result = new Commit(session, content);
            initialize(result);
            return result;
          }

          public class Commit extends SpannerRequest<com.google.spanner.v1.model.CommitResponse> {
             ...
             * @since 1.13
             */
            protected Commit(java.lang.String session, com.google.spanner.v1.model.CommitRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.CommitResponse.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
                    "Parameter session must conform to the pattern " +
           ...
           * @param content the {@link com.google.spanner.v1.model.CreateSessionRequest}
           * @return the request
           */
          public Create create(java.lang.String database, com.google.spanner.v1.model.CreateSessionRequest content) throws java.io.IOException {
            Create result = new Create(database, content);
            initialize(result);
            return result;
          }

          public class Create extends SpannerRequest<com.google.spanner.v1.model.Session> {
             ...
             * @since 1.13
             */
            protected Create(java.lang.String database, com.google.spanner.v1.model.CreateSessionRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Session.class);
              this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                    "Parameter database must conform to the pattern " +
           ...
           * @param content the {@link com.google.spanner.v1.model.ExecuteSqlRequest}
           * @return the request
           */
          public ExecuteSql executeSql(java.lang.String session, com.google.spanner.v1.model.ExecuteSqlRequest content) throws java.io.IOException {
            ExecuteSql result = new ExecuteSql(session, content);
            initialize(result);
            return result;
          }

          public class ExecuteSql extends SpannerRequest<com.google.spanner.v1.model.ResultSet> {
             ...
             * @since 1.13
             */
            protected ExecuteSql(java.lang.String session, com.google.spanner.v1.model.ExecuteSqlRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.ResultSet.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
                    "Parameter session must conform to the pattern " +
           ...
           * @return the request
           */
          public ExecuteStreamingSql executeStreamingSql(java.lang.String session, com.google.spanner.v1.model.ExecuteSqlRequest content) throws java.io.IOException {
            ExecuteStreamingSql result = new ExecuteStreamingSql(session, content);
            initialize(result);
            return result;
          }

          public class ExecuteStreamingSql extends SpannerRequest<com.google.spanner.v1.model.PartialResultSet> {
             ...
             * @since 1.13
             */
            protected ExecuteStreamingSql(java.lang.String session, com.google.spanner.v1.model.ExecuteSqlRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.PartialResultSet.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
                    "Parameter session must conform to the pattern " +
          ...
          public class Get extends SpannerRequest<com.google.spanner.v1.model.Session> {
             ...
             */
            protected Get(java.lang.String name) {
              super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.Session.class);
              this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                    "Parameter name must conform to the pattern " +
          ...
          public class List extends SpannerRequest<com.google.spanner.v1.model.ListSessionsResponse> {
            ...
            protected List(java.lang.String database) {
              super(Spanner.this, "GET", REST_PATH, null, com.google.spanner.v1.model.ListSessionsResponse.class);
              this.database = com.google.api.client.util.Preconditions.checkNotNull(database, "Required parameter database must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(DATABASE_PATTERN.matcher(database).matches(),
                    "Parameter database must conform to the pattern " +
           ...
           * @param content the {@link com.google.spanner.v1.model.PartitionQueryRequest}
           * @return the request
           */
          public PartitionQuery partitionQuery(java.lang.String session, com.google.spanner.v1.model.PartitionQueryRequest content) throws java.io.IOException {
            PartitionQuery result = new PartitionQuery(session, content);
            initialize(result);
            return result;
          }

          public class PartitionQuery extends SpannerRequest<com.google.spanner.v1.model.PartitionResponse> {
             ...
             * @since 1.13
             */
            protected PartitionQuery(java.lang.String session, com.google.spanner.v1.model.PartitionQueryRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.PartitionResponse.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
                    "Parameter session must conform to the pattern " +
           ...
           *
           * @param session Required. The session used to create the partitions.
           * @param content the {@link com.google.spanner.v1.model.PartitionReadRequest}
           * @return the request
           */
          public PartitionRead partitionRead(java.lang.String session, com.google.spanner.v1.model.PartitionReadRequest content) throws java.io.IOException {
            PartitionRead result = new PartitionRead(session, content);
            initialize(result);
            return result;
          }

          public class PartitionRead extends SpannerRequest<com.google.spanner.v1.model.PartitionResponse> {
             ...
             * @since 1.13
             */
            protected PartitionRead(java.lang.String session, com.google.spanner.v1.model.PartitionReadRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.PartitionResponse.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
           ...
           * @param content the {@link com.google.spanner.v1.model.ReadRequest}
           * @return the request
           */
          public Read read(java.lang.String session, com.google.spanner.v1.model.ReadRequest content) throws java.io.IOException {
            Read result = new Read(session, content);
            initialize(result);
            return result;
          }

          public class Read extends SpannerRequest<com.google.spanner.v1.model.ResultSet> {
             ...
             * @since 1.13
             */
            protected Read(java.lang.String session, com.google.spanner.v1.model.ReadRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.ResultSet.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
           ...
           * @param content the {@link com.google.spanner.v1.model.RollbackRequest}
           * @return the request
           */
          public Rollback rollback(java.lang.String session, com.google.spanner.v1.model.RollbackRequest content) throws java.io.IOException {
            Rollback result = new Rollback(session, content);
            initialize(result);
            return result;
          }

          public class Rollback extends SpannerRequest<com.google.spanner.v1.model.Empty> {
             ...
             * @since 1.13
             */
            protected Rollback(java.lang.String session, com.google.spanner.v1.model.RollbackRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.Empty.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
                    "Parameter session must conform to the pattern " +
           ...
           * @return the request
           */
          public StreamingRead streamingRead(java.lang.String session, com.google.spanner.v1.model.ReadRequest content) throws java.io.IOException {
            StreamingRead result = new StreamingRead(session, content);
            initialize(result);
            return result;
          }

          public class StreamingRead extends SpannerRequest<com.google.spanner.v1.model.PartialResultSet> {
             ...
             * @since 1.13
             */
            protected StreamingRead(java.lang.String session, com.google.spanner.v1.model.ReadRequest content) {
              super(Spanner.this, "POST", REST_PATH, content, com.google.spanner.v1.model.PartialResultSet.class);
              this.session = com.google.api.client.util.Preconditions.checkNotNull(session, "Required parameter session must be specified.");
              if (!getSuppressPatternChecks()) {
                com.google.api.client.util.Preconditions.checkArgument(SESSION_PATTERN.matcher(session).matches(),
