...
/**
 * Count of entities that match the query. The `COUNT(*)` aggregation function operates on the
 * entire entity so it does not require a field reference.
 *
