 ...
 * content.
 *
 * Note that an individual NamedRange may consist of multiple discontinuous ranges. In this case,
 * only the content in the first range will be replaced. The other ranges and their content will be
 * deleted.
 *
 * In cases where replacing or deleting any ranges would result in an invalid document structure, a
...
public final class ReplaceNamedRangeContentRequest extends com.google.api.client.json.GenericJson {
   ...
   *
   * If there are multiple named ranges with the given name, then the content of each one will be
   * replaced. If there are no named ranges with the given name, then the request will be a no-op.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
