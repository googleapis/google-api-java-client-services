  ...
  public class Properties {
    ...
    public class AndroidAppDataStreams {
      ...
      public class MeasurementProtocolSecrets {
         ...
         * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The parent resource where this secret will be created. Any type of stream (WebDataStream,
         ...
         * optional parameters, call the {@link Delete#execute()} method to invoke the remote operation.
         *
         * @param name Required. The name of the MeasurementProtocolSecret to delete. Format: properties/{property}/webData
         *        Streams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolSecret} Note: Any
         *        type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream) may be a parent.
         * @return the request
         */
        public Delete delete(java.lang.String name) throws java.io.IOException {
          Delete result = new Delete(name);
        ...
        public class Delete extends GoogleAnalyticsAdminRequest<com.google.api.services.analyticsadmin.v1alpha.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^properties/[^/]+/androidAppDataStreams/[^/]+/measurementProtocolSecrets/[^/]+$");
         ...
         *        type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream) may be a parent.
           ...
           * erty}/webDataStreams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolSec
           * ret} Note: Any type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream)
           * may be a parent.
           */
          @com.google.api.client.util.Key
          private java.lang.String name;

          /** Required. The name of the MeasurementProtocolSecret to delete. Format: properties/{property}/webDat
         aStreams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolSecret} Note: Any type of
         ...
         * optional parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
         * @param name Required. The name of the measurement protocol secret to lookup. Format: properties/{property}/webDa
         *        taStreams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolSecret} Note: Any
         *        type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream) may be a parent.
         * @return the request
         */
        public Get get(java.lang.String name) throws java.io.IOException {
         ...
         *        type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream) may be a parent.
           ...
           * operty}/webDataStreams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolS
           * ecret} Note: Any type of stream (WebDataStream, IosAppDataStream, AndroidAppDataStream)
           * may be a parent.
           */
          @com.google.api.client.util.Key
          private java.lang.String name;

          /** Required. The name of the measurement protocol secret to lookup. Format: properties/{property}/webD
         ataStreams/{webDataStream}/measurementProtocolSecrets/{measurementProtocolSecret} Note: Any type of
         stream (WebDataStream, IosAppDataStream, AndroidAppDataStream) may be a parent.
           */
          public java.lang.String getName() {
            return name;
         ...
         * optional parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The resource name of the parent stream. Any type of stream (WebDataStream,
         *        IosAppDataStream, AndroidAppDataStream) may be a parent. Format:
    ...
    public class IosAppDataStreams {
      ...
      public class MeasurementProtocolSecrets {
        ...
        public class Delete extends GoogleAnalyticsAdminRequest<com.google.api.services.analyticsadmin.v1alpha.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^properties/[^/]+/iosAppDataStreams/[^/]+/measurementProtocolSecrets/[^/]+$");
    ...
    public class WebDataStreams {
      ...
      public class MeasurementProtocolSecrets {
        ...
        public class Delete extends GoogleAnalyticsAdminRequest<com.google.api.services.analyticsadmin.v1alpha.model.GoogleProtobufEmpty> {
          ...
          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^properties/[^/]+/webDataStreams/[^/]+/measurementProtocolSecrets/[^/]+$");
