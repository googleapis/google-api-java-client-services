...
public final class DiskAggregatedList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.Map<String, DisksScopedList> items;

  /**
   * Output only. [Output Only] Type of resource. Alwayscompute#diskAggregatedList for aggregated
   * lists of persistent disks.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   */
  public DiskAggregatedList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.Map<String, DisksScopedList> getItems() {
    return items;
  }
   ...
   */
  public DiskAggregatedList setItems(java.util.Map<String, DisksScopedList> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public DiskAggregatedList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public DiskAggregatedList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public DiskAggregatedList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public DiskAggregatedList setUnreachables(java.util.List<java.lang.String> unreachables) {
   ...
   */
  public DiskAggregatedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public DiskAggregatedList set(String fieldName, Object value) {
    return (DiskAggregatedList) super.set(fieldName, value);
  }

  @Override
  public DiskAggregatedList clone() {
    return (DiskAggregatedList) super.clone();
  }
