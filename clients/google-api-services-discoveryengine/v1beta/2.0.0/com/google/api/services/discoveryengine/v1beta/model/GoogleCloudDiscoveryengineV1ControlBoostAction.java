...
public final class GoogleCloudDiscoveryengineV1ControlBoostAction extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1ControlBoostAction setDataStore(java.lang.String dataStore) {
  ...
  @Override
  public GoogleCloudDiscoveryengineV1ControlBoostAction set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1ControlBoostAction) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1ControlBoostAction clone() {
    return (GoogleCloudDiscoveryengineV1ControlBoostAction) super.clone();
  }
