...
package com.google.firebaserules.v1;
...
public class FirebaseRules extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Firebase Rules API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
     ...
     * @param content the {@link com.google.firebaserules.v1.model.TestRulesetRequest}
     * @return the request
     */
    public Test test(java.lang.String name, com.google.firebaserules.v1.model.TestRulesetRequest content) throws java.io.IOException {
      Test result = new Test(name, content);
      initialize(result);
      return result;
    }

    public class Test extends FirebaseRulesRequest<com.google.firebaserules.v1.model.TestRulesetResponse> {
     ...
     *        `projects/{project_id}/rulesets/{ruleset_id}`
       ...
       * @since 1.13
       */
      protected Test(java.lang.String name, com.google.firebaserules.v1.model.TestRulesetRequest content) {
        super(FirebaseRules.this, "POST", REST_PATH, content, com.google.firebaserules.v1.model.TestRulesetResponse.class);
    ...
    public class Releases {
      ...
      Format: `projects/{project_id}`
       * @param content the {@link com.google.firebaserules.v1.model.Release}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.firebaserules.v1.model.Release content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Release> {
      ...
      Format: `projects/{project_id}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.firebaserules.v1.model.Release content) {
          super(FirebaseRules.this, "POST", REST_PATH, content, com.google.firebaserules.v1.model.Release.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Delete extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Empty> {
      ...
      Format: `projects/{project_id}/releases/{release_id}`
        ...
        protected Delete(java.lang.String name) {
          super(FirebaseRules.this, "DELETE", REST_PATH, null, com.google.firebaserules.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Release> {
      ...
      Format: `projects/{project_id}/releases/{release_id}`
        ...
        protected Get(java.lang.String name) {
          super(FirebaseRules.this, "GET", REST_PATH, null, com.google.firebaserules.v1.model.Release.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class GetExecutable extends FirebaseRulesRequest<com.google.firebaserules.v1.model.GetReleaseExecutableResponse> {
      ...
      Format: `projects/{project_id}/releases/{release_id}`
        ...
        protected GetExecutable(java.lang.String name) {
          super(FirebaseRules.this, "GET", REST_PATH, null, com.google.firebaserules.v1.model.GetReleaseExecutableResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends FirebaseRulesRequest<com.google.firebaserules.v1.model.ListReleasesResponse> {
      ...
      Format: `projects/{project_id}`
        ...
        protected List(java.lang.String name) {
          super(FirebaseRules.this, "GET", REST_PATH, null, com.google.firebaserules.v1.model.ListReleasesResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param name Resource name for the project which owns this `Release`.
      Format: `projects/{project_id}`
       * @param content the {@link com.google.firebaserules.v1.model.UpdateReleaseRequest}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.firebaserules.v1.model.UpdateReleaseRequest content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Release> {
      ...
      Format: `projects/{project_id}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.firebaserules.v1.model.UpdateReleaseRequest content) {
          super(FirebaseRules.this, "PATCH", REST_PATH, content, com.google.firebaserules.v1.model.Release.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
    ...
    public class Rulesets {
      ...
      Format: `projects/{project_id}`
       * @param content the {@link com.google.firebaserules.v1.model.Ruleset}
       * @return the request
       */
      public Create create(java.lang.String name, com.google.firebaserules.v1.model.Ruleset content) throws java.io.IOException {
        Create result = new Create(name, content);
        initialize(result);
        return result;
      }

      public class Create extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Ruleset> {
      ...
      Format: `projects/{project_id}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String name, com.google.firebaserules.v1.model.Ruleset content) {
          super(FirebaseRules.this, "POST", REST_PATH, content, com.google.firebaserules.v1.model.Ruleset.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class Get extends FirebaseRulesRequest<com.google.firebaserules.v1.model.Ruleset> {
      ...
      Format: `projects/{project_id}/rulesets/{ruleset_id}`
         ...
         */
        protected Get(java.lang.String name) {
          super(FirebaseRules.this, "GET", REST_PATH, null, com.google.firebaserules.v1.model.Ruleset.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends FirebaseRulesRequest<com.google.firebaserules.v1.model.ListRulesetsResponse> {
      ...
      Format: `projects/{project_id}`
         ...
         */
        protected List(java.lang.String name) {
          super(FirebaseRules.this, "GET", REST_PATH, null, com.google.firebaserules.v1.model.ListRulesetsResponse.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
