...
public final class GrantDnsBindPermissionRequest extends com.google.api.client.json.GenericJson {
   ...
   * ID, the server can check if original operation with the same request ID was received, and if
   * so, will ignore the second request. This prevents clients from accidentally creating duplicate
   ...
   */
  public GrantDnsBindPermissionRequest setRequestId(java.lang.String requestId) {
    this.requestId = requestId;
    return this;
  }

  @Override
  public GrantDnsBindPermissionRequest set(String fieldName, Object value) {
    return (GrantDnsBindPermissionRequest) super.set(fieldName, value);
  }

  @Override
  public GrantDnsBindPermissionRequest clone() {
    return (GrantDnsBindPermissionRequest) super.clone();
  }
