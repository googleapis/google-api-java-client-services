...
public final class IngestUserIdDataStatus extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public IngestUserIdDataStatus set(String fieldName, Object value) {
    return (IngestUserIdDataStatus) super.set(fieldName, value);
  }

  @Override
  public IngestUserIdDataStatus clone() {
    return (IngestUserIdDataStatus) super.clone();
  }
