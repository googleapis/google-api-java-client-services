...
public final class InstanceGroupManagerStatus extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. The accelerator topology applied to this MIG. Currently only one accelerator
  ...
  /**
   * Output only. The list of instance statuses and the number of instances in this managed instance
   * group that have the status. Currently only shown for TPU MIGs
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. A bit indicating whether the managed instance group is in a stable state. A stable
   * state means that: none of the instances in the managed instance group is currently undergoing
   * any type of change (for example, creation, restart, or deletion); no future changes are
   * scheduled for instances in the managed instance group; and the managed instance group itself is
   * not being modified.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  /**
   * Output only. A status of consistency of Instances' versions with their target version specified
