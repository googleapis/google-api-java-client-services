...
public final class CheckFreeAccessResponse extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public CheckFreeAccessResponse set(String fieldName, Object value) {
    return (CheckFreeAccessResponse) super.set(fieldName, value);
  }

  @Override
  public CheckFreeAccessResponse clone() {
    return (CheckFreeAccessResponse) super.clone();
  }
