...
public final class TargetPoolList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<TargetPool> items;
   ...
   */
  public TargetPoolList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<TargetPool> getItems() {
    return items;
  }
   ...
   */
  public TargetPoolList setItems(java.util.List<TargetPool> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public TargetPoolList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TargetPoolList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public TargetPoolList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public TargetPoolList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public TargetPoolList set(String fieldName, Object value) {
    return (TargetPoolList) super.set(fieldName, value);
  }

  @Override
  public TargetPoolList clone() {
    return (TargetPoolList) super.clone();
  }
