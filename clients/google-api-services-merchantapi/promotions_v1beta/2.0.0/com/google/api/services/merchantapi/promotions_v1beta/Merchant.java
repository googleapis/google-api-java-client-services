...
/**
 * Service definition for Merchant (promotions_v1beta).
 *
 * <p>
...
public class Merchant extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Accounts {
    ...
    public class Promotions {
      ...
      public class Get extends MerchantRequest<com.google.api.services.merchantapi.promotions_v1beta.model.Promotion> {

        private static final String REST_PATH = "promotions/v1beta/{+name}";
       ...
       *        `accounts/{account}/promotions/{promotions}`
        ...
        protected Get(java.lang.String name) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.promotions_v1beta.model.Promotion.class);
       ...
       * @param content the {@link com.google.api.services.merchantapi.promotions_v1beta.model.InsertPromotionRequest}
       * @return the request
       */
      public Insert insert(java.lang.String parent, com.google.api.services.merchantapi.promotions_v1beta.model.InsertPromotionRequest content) throws java.io.IOException {
        Insert result = new Insert(parent, content);
        initialize(result);
        return result;
      }

      public class Insert extends MerchantRequest<com.google.api.services.merchantapi.promotions_v1beta.model.Promotion> {

        private static final String REST_PATH = "promotions/v1beta/{+parent}/promotions:insert";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String parent, com.google.api.services.merchantapi.promotions_v1beta.model.InsertPromotionRequest content) {
          super(Merchant.this, "POST", REST_PATH, content, com.google.api.services.merchantapi.promotions_v1beta.model.Promotion.class);
      ...
      public class List extends MerchantRequest<com.google.api.services.merchantapi.promotions_v1beta.model.ListPromotionsResponse> {

        private static final String REST_PATH = "promotions/v1beta/{+parent}/promotions";
        ...
        protected List(java.lang.String parent) {
          super(Merchant.this, "GET", REST_PATH, null, com.google.api.services.merchantapi.promotions_v1beta.model.ListPromotionsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
