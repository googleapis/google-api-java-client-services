...
public final class CustomLevel extends com.google.api.client.json.GenericJson {
   ...
   */
  public CustomLevel setExpr(Expr expr) {
    this.expr = expr;
    return this;
  }

  @Override
  public CustomLevel set(String fieldName, Object value) {
    return (CustomLevel) super.set(fieldName, value);
  }

  @Override
  public CustomLevel clone() {
    return (CustomLevel) super.clone();
  }
