 ...
 *
 *      foo := {...}      any, err := ptypes.MarshalAny(foo)      ...      foo := {}      if err :=
...
public final class Any extends com.google.api.client.json.GenericJson {
   ...
   * google.protobuf.Type   value in binary format, or produce an error. * Applications are allowed
   * to cache lookup results based on the   URL, or have them precompiled into a binary to avoid any
