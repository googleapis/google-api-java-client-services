...
public final class RegionalInventory extends com.google.api.client.json.GenericJson {
   ...
   * generally follows the structure: `content_language~feed_label~offer_id`. Example:
   ...
   * `en~US~sku/123`, the `{product}` segment must be the base64url encoding of this string, which
   ...
   * tilde-separated string `content_language~feed_label~offer_id`. This format is suitable only
