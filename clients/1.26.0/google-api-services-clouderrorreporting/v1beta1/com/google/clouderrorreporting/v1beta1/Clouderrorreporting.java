...
public class Clouderrorreporting extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Stackdriver Error Reporting API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Projects {
    ...
    public class DeleteEvents extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.DeleteEventsResponse> {
     ...
     *        Example: `projects/my-project-123`.
      ...
      protected DeleteEvents(java.lang.String projectName) {
        super(Clouderrorreporting.this, "DELETE", REST_PATH, null, com.google.clouderrorreporting.v1beta1.model.DeleteEventsResponse.class);
    ...
    public class Events {
      ...
      public class List extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.ListEventsResponse> {
       ...
       *        Example: `projects/my-project-123`.
        ...
        protected List(java.lang.String projectName) {
          super(Clouderrorreporting.this, "GET", REST_PATH, null, com.google.clouderrorreporting.v1beta1.model.ListEventsResponse.class);
          this.projectName = com.google.api.client.util.Preconditions.checkNotNull(projectName, "Required parameter projectName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PROJECT_NAME_PATTERN.matcher(projectName).matches(),
                "Parameter projectName must conform to the pattern " +
       ...
       *        Example: `projects/my-project-123`.
       * @param content the {@link com.google.clouderrorreporting.v1beta1.model.ReportedErrorEvent}
       * @return the request
       */
      public Report report(java.lang.String projectName, com.google.clouderrorreporting.v1beta1.model.ReportedErrorEvent content) throws java.io.IOException {
        Report result = new Report(projectName, content);
        initialize(result);
        return result;
      }

      public class Report extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.ReportErrorEventResponse> {
       ...
       *        Example: `projects/my-project-123`.
         ...
         * @since 1.13
         */
        protected Report(java.lang.String projectName, com.google.clouderrorreporting.v1beta1.model.ReportedErrorEvent content) {
          super(Clouderrorreporting.this, "POST", REST_PATH, content, com.google.clouderrorreporting.v1beta1.model.ReportErrorEventResponse.class);
          this.projectName = com.google.api.client.util.Preconditions.checkNotNull(projectName, "Required parameter projectName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PROJECT_NAME_PATTERN.matcher(projectName).matches(),
                "Parameter projectName must conform to the pattern " +
    ...
    public class GroupStats {
      ...
      public class List extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.ListGroupStatsResponse> {
      ...
      Example: projects/my-project-123.
         ...
         */
        protected List(java.lang.String projectName) {
          super(Clouderrorreporting.this, "GET", REST_PATH, null, com.google.clouderrorreporting.v1beta1.model.ListGroupStatsResponse.class);
          this.projectName = com.google.api.client.util.Preconditions.checkNotNull(projectName, "Required parameter projectName must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PROJECT_NAME_PATTERN.matcher(projectName).matches(),
                "Parameter projectName must conform to the pattern " +
    ...
    public class Groups {
      ...
      public class Get extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.ErrorGroup> {
       ...
       *        /my-project-123/groups/my-group
        ...
        protected Get(java.lang.String groupName) {
          super(Clouderrorreporting.this, "GET", REST_PATH, null, com.google.clouderrorreporting.v1beta1.model.ErrorGroup.class);
       ...
       * @param content the {@link com.google.clouderrorreporting.v1beta1.model.ErrorGroup}
       * @return the request
       */
      public Update update(java.lang.String name, com.google.clouderrorreporting.v1beta1.model.ErrorGroup content) throws java.io.IOException {
        Update result = new Update(name, content);
        initialize(result);
        return result;
      }

      public class Update extends ClouderrorreportingRequest<com.google.clouderrorreporting.v1beta1.model.ErrorGroup> {
      ...
      Example: projects/my-project-123/groups/my-groupid
         ...
         * @since 1.13
         */
        protected Update(java.lang.String name, com.google.clouderrorreporting.v1beta1.model.ErrorGroup content) {
          super(Clouderrorreporting.this, "PUT", REST_PATH, content, com.google.clouderrorreporting.v1beta1.model.ErrorGroup.class);
