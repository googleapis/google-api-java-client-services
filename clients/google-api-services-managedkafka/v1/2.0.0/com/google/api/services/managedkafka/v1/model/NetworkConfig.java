...
public final class NetworkConfig extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. Name of the VPC subnet in which to create Private Service Connect (PSC) endpoints for
   * the Kafka brokers and bootstrap address. Structured like:
   * projects/{project}/regions/{region}/subnetworks/{subnet_id} The subnet must be located in the
   * same region as the Kafka cluster. The project may differ. Multiple subnets from the same parent
   * network must not be specified.
   ...
   */
  public NetworkConfig setSubnet(java.lang.String subnet) {
    this.subnet = subnet;
    return this;
  }
