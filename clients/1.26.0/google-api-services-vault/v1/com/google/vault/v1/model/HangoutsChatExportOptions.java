...
public final class HangoutsChatExportOptions extends com.google.api.client.json.GenericJson {
  ...
  @Override
  public HangoutsChatExportOptions set(String fieldName, Object value) {
    return (HangoutsChatExportOptions) super.set(fieldName, value);
  }

  @Override
  public HangoutsChatExportOptions clone() {
    return (HangoutsChatExportOptions) super.clone();
  }
