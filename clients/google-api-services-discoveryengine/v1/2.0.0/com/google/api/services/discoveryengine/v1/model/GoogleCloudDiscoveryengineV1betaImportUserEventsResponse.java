...
public final class GoogleCloudDiscoveryengineV1betaImportUserEventsResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse setErrorConfig(GoogleCloudDiscoveryengineV1betaImportErrorConfig errorConfig) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse setErrorSamples(java.util.List<GoogleRpcStatus> errorSamples) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse setJoinedEventsCount(java.lang.Long joinedEventsCount) {
   ...
   */
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse setUnjoinedEventsCount(java.lang.Long unjoinedEventsCount) {
    this.unjoinedEventsCount = unjoinedEventsCount;
    return this;
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse set(String fieldName, Object value) {
    return (GoogleCloudDiscoveryengineV1betaImportUserEventsResponse) super.set(fieldName, value);
  }

  @Override
  public GoogleCloudDiscoveryengineV1betaImportUserEventsResponse clone() {
    return (GoogleCloudDiscoveryengineV1betaImportUserEventsResponse) super.clone();
  }
