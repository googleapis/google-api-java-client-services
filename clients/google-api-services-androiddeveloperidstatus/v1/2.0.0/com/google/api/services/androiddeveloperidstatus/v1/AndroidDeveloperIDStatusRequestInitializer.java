...
/**
 * AndroidDeveloperIDStatus request initializer for setting properties like key and userIp.
 *
 * <p>
 ...
 * @since 1.12
 */
public class AndroidDeveloperIDStatusRequestInitializer extends com.google.api.client.googleapis.services.json.CommonGoogleJsonClientRequestInitializer {
   ...
   */
  public AndroidDeveloperIDStatusRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public AndroidDeveloperIDStatusRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(com.google.api.client.googleapis.services.json.AbstractGoogleJsonClientRequest<?> request) throws java.io.IOException {
    ...
    initializeAndroidDeveloperIDStatusRequest((AndroidDeveloperIDStatusRequest<?>) request);
  }

  /**
   * Initializes AndroidDeveloperIDStatus request.
   *
   * <p>
   ...
   */
  protected void initializeAndroidDeveloperIDStatusRequest(AndroidDeveloperIDStatusRequest<?> request) throws java.io.IOException {
  }
}
