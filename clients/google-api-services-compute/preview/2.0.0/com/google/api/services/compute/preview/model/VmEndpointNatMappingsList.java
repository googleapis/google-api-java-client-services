...
public final class VmEndpointNatMappingsList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<VmEndpointNatMappings> result;

  static {
    // hack to force ProGuard to consider VmEndpointNatMappings used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(VmEndpointNatMappings.class);
  }
   ...
   */
  public VmEndpointNatMappingsList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   */
  public VmEndpointNatMappingsList setNextPageToken(java.lang.String nextPageToken) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<VmEndpointNatMappings> getResult() {
    return result;
  }
   ...
   */
  public VmEndpointNatMappingsList setResult(java.util.List<VmEndpointNatMappings> result) {
    this.result = result;
    return this;
  }
   ...
   */
  public VmEndpointNatMappingsList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public VmEndpointNatMappingsList set(String fieldName, Object value) {
    return (VmEndpointNatMappingsList) super.set(fieldName, value);
  }

  @Override
  public VmEndpointNatMappingsList clone() {
    return (VmEndpointNatMappingsList) super.clone();
  }
