...
public final class GoogleAppsAlertcenterTypeMailPhishing extends com.google.api.client.json.GenericJson {
   ...
   */
  public GoogleAppsAlertcenterTypeMailPhishing setDomainId(GoogleAppsAlertcenterTypeDomainId domainId) {
   ...
   */
  public GoogleAppsAlertcenterTypeMailPhishing setIsInternal(java.lang.Boolean isInternal) {
   ...
   */
  public GoogleAppsAlertcenterTypeMailPhishing setMaliciousEntity(GoogleAppsAlertcenterTypeMaliciousEntity maliciousEntity) {
   ...
   */
  public GoogleAppsAlertcenterTypeMailPhishing setMessages(java.util.List<GoogleAppsAlertcenterTypeGmailMessageInfo> messages) {
   ...
   */
  public GoogleAppsAlertcenterTypeMailPhishing setSystemActionType(java.lang.String systemActionType) {
    this.systemActionType = systemActionType;
    return this;
  }

  @Override
  public GoogleAppsAlertcenterTypeMailPhishing set(String fieldName, Object value) {
    return (GoogleAppsAlertcenterTypeMailPhishing) super.set(fieldName, value);
  }

  @Override
  public GoogleAppsAlertcenterTypeMailPhishing clone() {
    return (GoogleAppsAlertcenterTypeMailPhishing) super.clone();
  }
