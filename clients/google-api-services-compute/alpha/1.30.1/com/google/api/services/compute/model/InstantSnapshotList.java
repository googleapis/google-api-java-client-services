...
public final class InstantSnapshotList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<InstantSnapshot> items;
   ...
   */
  public InstantSnapshotList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<InstantSnapshot> getItems() {
    return items;
  }
   ...
   */
  public InstantSnapshotList setItems(java.util.List<InstantSnapshot> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public InstantSnapshotList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public InstantSnapshotList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public InstantSnapshotList set(String fieldName, Object value) {
    return (InstantSnapshotList) super.set(fieldName, value);
  }

  @Override
  public InstantSnapshotList clone() {
    return (InstantSnapshotList) super.clone();
  }
