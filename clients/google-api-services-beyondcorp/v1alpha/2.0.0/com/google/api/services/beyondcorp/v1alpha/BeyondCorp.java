    ...
    public class Locations {
      ...
      public class Global {
        ...
        public class PartnerTenants {
           ...
           *
           * Create a request for the method "partnerTenants.create".
           *
           * This request holds the parameters needed by the beyondcorp server.  After setting any optional
           * parameters, call the {@link Create#execute()} method to invoke the remote operation.
           *
           * @param parent Required. The resource name of the parent organization using the form:
           ...
           * @return the request
           */
          public Create create(java.lang.String parent, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerTenant content) throws java.io.IOException {
          ...
          public class Create extends BeyondCorpRequest<com.google.api.services.beyondcorp.v1alpha.model.GoogleLongrunningOperation> {
            ...
            /**
             * Creates a new BeyondCorp Enterprise partnerTenant in a given organization and can only be
             * called by onboarded BeyondCorp Enterprise partner.
             *
             * Create a request for the method "partnerTenants.create".
             *
           ...
           *        `organizations/{organization_id}/locations/global`
             ...
             * @since 1.13
             */
            protected Create(java.lang.String parent, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerTenant content) {
          ...
          public class BrowserDlpRules {
             ...
             *
             * Create a request for the method "browserDlpRules.create".
             *
             * This request holds the parameters needed by the beyondcorp server.  After setting any optional
             * parameters, call the {@link Create#execute()} method to invoke the remote operation.
             *
             * @param parent Required. The resource name of the BrowserDlpRule parent using the form:
             *        `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
             ...
             * @return the request
             */
            public Create create(java.lang.String parent, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule content) throws java.io.IOException {
              Create result = new Create(parent, content);
              initialize(result);
              return result;
            }
             ...
             *        `organizations/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
               ...
               * @since 1.13
               */
              protected Create(java.lang.String parent, com.google.api.services.beyondcorp.v1alpha.model.GoogleCloudBeyondcorpPartnerservicesV1alphaBrowserDlpRule content) {
                super(BeyondCorp.this, "POST", REST_PATH, content, com.google.api.services.beyondcorp.v1alpha.model.GoogleLongrunningOperation.class);
                this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
                if (!getSuppressPatternChecks()) {
                  com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
              ...
              /**
               * Required. The resource name of the BrowserDlpRule parent using the form: `organizat
               * ions/{organization_id}/locations/global/partnerTenants/{partner_tenant_id}`
               */
              @com.google.api.client.util.Key
              private java.lang.String parent;
  ...
  public class Projects {
    ...
    public class Locations {
      ...
      public class Connectors {
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "connectors.testIamPermissions".
         *
         * This request holds the parameters needed by the beyondcorp server.  After setting any optional
         * parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote operation.
         *
      ...
      /**
       * An accessor for creating requests from the NetConnections collection.
       *
       * <p>The typical use is:</p>
       * <pre>
       *   {@code BeyondCorp beyondcorp = new BeyondCorp(...);}
       *   {@code BeyondCorp.NetConnections.List request = beyondcorp.netConnections().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      public NetConnections netConnections() {
        return new NetConnections();
      }

      /**
       * The "netConnections" collection of methods.
       */
      public class NetConnections {
         ...
         * does not have a policy set.
         *
         * Create a request for the method "netConnections.getIamPolicy".
         *
         * This request holds the parameters needed by the beyondcorp server.  After setting any optional
         * parameters, call the {@link GetIamPolicy#execute()} method to invoke the remote operation.
         *
        ...
        public class GetIamPolicy extends BeyondCorpRequest<com.google.api.services.beyondcorp.v1alpha.model.GoogleIamV1Policy> {
          ...
          private final java.util.regex.Pattern RESOURCE_PATTERN =
              java.util.regex.Pattern.compile("^projects/[^/]+/locations/[^/]+/netConnections/[^/]+$");
         ...
         * return `NOT_FOUND`, `INVALID_ARGUMENT`, and `PERMISSION_DENIED` errors.
         *
         * Create a request for the method "netConnections.setIamPolicy".
         *
         * This request holds the parameters needed by the beyondcorp server.  After setting any optional
         * parameters, call the {@link SetIamPolicy#execute()} method to invoke the remote operation.
         *
         ...
         * authorization checking. This operation may "fail open" without warning.
         *
         * Create a request for the method "netConnections.testIamPermissions".
         *
         * This request holds the parameters needed by the beyondcorp server.  After setting any optional
         * parameters, call the {@link TestIamPermissions#execute()} method to invoke the remote operation.
         *
