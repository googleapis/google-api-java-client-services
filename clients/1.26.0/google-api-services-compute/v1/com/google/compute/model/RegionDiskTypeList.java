...
public final class RegionDiskTypeList extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<DiskType> items;

  static {
    // hack to force ProGuard to consider DiskType used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(DiskType.class);
  }
   ...
   */
  public RegionDiskTypeList setId(java.lang.String id) {
    this.id = id;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<DiskType> getItems() {
    return items;
  }
   ...
   */
  public RegionDiskTypeList setItems(java.util.List<DiskType> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public RegionDiskTypeList setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RegionDiskTypeList setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public RegionDiskTypeList setSelfLink(java.lang.String selfLink) {
   ...
   */
  public RegionDiskTypeList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public RegionDiskTypeList set(String fieldName, Object value) {
    return (RegionDiskTypeList) super.set(fieldName, value);
  }

  @Override
  public RegionDiskTypeList clone() {
    return (RegionDiskTypeList) super.clone();
  }
