...
public class AccessContextManager extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.26.0-SNAPSHOT of the Access Context Manager API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class AccessPolicies {
     ...
     *
     * @param content the {@link com.google.accesscontextmanager.v1beta.model.AccessPolicy}
     * @return the request
     */
    public Create create(com.google.accesscontextmanager.v1beta.model.AccessPolicy content) throws java.io.IOException {
      Create result = new Create(content);
      initialize(result);
      return result;
    }

    public class Create extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.Operation> {
       ...
       * @since 1.13
       */
      protected Create(com.google.accesscontextmanager.v1beta.model.AccessPolicy content) {
        super(AccessContextManager.this, "POST", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
      }
    ...
    public class Delete extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.Operation> {
    ...
    Format `accessPolicies/{policy_id}`
      ...
      protected Delete(java.lang.String name) {
        super(AccessContextManager.this, "DELETE", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.Operation.class);
    ...
    public class Get extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.AccessPolicy> {
    ...
    Format `accessPolicies/{policy_id}`
      ...
      protected Get(java.lang.String name) {
        super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.AccessPolicy.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class List extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.ListAccessPoliciesResponse> {
       ...
       */
      protected List() {
        super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.ListAccessPoliciesResponse.class);
      }
     ...
     * @return the request
     */
    public Patch patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.AccessPolicy content) throws java.io.IOException {
      Patch result = new Patch(name, content);
      initialize(result);
      return result;
    }

    public class Patch extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.Operation> {
    ...
    `accessPolicies/{policy_id}`
       ...
       * @since 1.13
       */
      protected Patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.AccessPolicy content) {
        super(AccessContextManager.this, "PATCH", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
    ...
    public class AccessLevels {
      ...
      Format:
       *        `accessPolicies/{policy_id}`
       * @param content the {@link com.google.accesscontextmanager.v1beta.model.AccessLevel}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.accesscontextmanager.v1beta.model.AccessLevel content) throws java.io.IOException {
       ...
       *        `accessPolicies/{policy_id}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.accesscontextmanager.v1beta.model.AccessLevel content) {
          super(AccessContextManager.this, "POST", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
      ...
      public class Get extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.AccessLevel> {
       ...
       *        `accessPolicies/{policy_id}/accessLevels/{access_level_id}`
         ...
         */
        protected Get(java.lang.String name) {
          super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.AccessLevel.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.ListAccessLevelsResponse> {
       ...
       *        `accessPolicies/{policy_id}`
        ...
        protected List(java.lang.String parent) {
          super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.ListAccessLevelsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.AccessLevel content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }
       ...
       *        `accessPolicies/{policy_id}/accessLevels/{short_name}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.AccessLevel content) {
          super(AccessContextManager.this, "PATCH", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
    ...
    public class ServicePerimeters {
      ...
      Format:
       *        `accessPolicies/{policy_id}`
       * @param content the {@link com.google.accesscontextmanager.v1beta.model.ServicePerimeter}
       * @return the request
       */
      public Create create(java.lang.String parent, com.google.accesscontextmanager.v1beta.model.ServicePerimeter content) throws java.io.IOException {
        Create result = new Create(parent, content);
        initialize(result);
        return result;
      }
       ...
       *        `accessPolicies/{policy_id}`
         ...
         * @since 1.13
         */
        protected Create(java.lang.String parent, com.google.accesscontextmanager.v1beta.model.ServicePerimeter content) {
          super(AccessContextManager.this, "POST", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
      ...
      public class Get extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.ServicePerimeter> {
       ...
       *        `accessPolicies/{policy_id}/servicePerimeters/{service_perimeters_id}`
         ...
         */
        protected Get(java.lang.String name) {
          super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.ServicePerimeter.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.ListServicePerimetersResponse> {
       ...
       *        `accessPolicies/{policy_id}`
         ...
         */
        protected List(java.lang.String parent) {
          super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.ListServicePerimetersResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
       ...
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.ServicePerimeter content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }
       ...
       *        `accessPolicies/{policy_id}/servicePerimeters/{short_name}`
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.accesscontextmanager.v1beta.model.ServicePerimeter content) {
          super(AccessContextManager.this, "PATCH", REST_PATH, content, com.google.accesscontextmanager.v1beta.model.Operation.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
  ...
  public class Operations {
    ...
    public class Get extends AccessContextManagerRequest<com.google.accesscontextmanager.v1beta.model.Operation> {
       ...
       */
      protected Get(java.lang.String name) {
        super(AccessContextManager.this, "GET", REST_PATH, null, com.google.accesscontextmanager.v1beta.model.Operation.class);
        this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
              "Parameter name must conform to the pattern " +
