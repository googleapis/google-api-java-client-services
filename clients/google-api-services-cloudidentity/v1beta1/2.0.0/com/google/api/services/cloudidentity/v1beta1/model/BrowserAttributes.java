...
public final class BrowserAttributes extends com.google.api.client.json.GenericJson {
   ...
   */
  public BrowserAttributes setChromeProfileId(java.lang.String chromeProfileId) {
  ...
  @Override
  public BrowserAttributes set(String fieldName, Object value) {
    return (BrowserAttributes) super.set(fieldName, value);
  }

  @Override
  public BrowserAttributes clone() {
    return (BrowserAttributes) super.clone();
  }
