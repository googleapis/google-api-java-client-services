...
public final class GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig extends com.google.api.client.json.GenericJson {
   ...
   * @return value or {@code null} for none
   */
  public GoogleChromeManagementVersionsV1XdrSettings getXdrSettings() {
    return xdrSettings;
  }

  /**
   * Required. The XDR settings for the CrowdStrike XDR config.
   * @param xdrSettings xdrSettings or {@code null} for none
   */
  public GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig setXdrSettings(GoogleChromeManagementVersionsV1XdrSettings xdrSettings) {
    this.xdrSettings = xdrSettings;
    return this;
  }

  @Override
  public GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig set(String fieldName, Object value) {
    return (GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig) super.set(fieldName, value);
  }

  @Override
  public GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig clone() {
    return (GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig) super.clone();
  }
