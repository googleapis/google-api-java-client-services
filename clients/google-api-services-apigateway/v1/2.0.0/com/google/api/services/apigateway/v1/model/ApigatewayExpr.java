 ...
 * /cel-spec. Example (Comparison): title: "Summary size limit" description: "Determines if a
 * summary is less than 100 chars" expression: "document.summary.size() < 100" Example (Equality):
 * title: "Requestor is owner" description: "Determines if requestor is the document owner"
 * expression: "document.owner == request.auth.claims.email" Example (Logic): title: "Public
 * documents" description: "Determine whether the document should be publicly visible" expression:
...
public final class ApigatewayExpr extends com.google.api.client.json.GenericJson {
   ...
   */
  public ApigatewayExpr setDescription(java.lang.String description) {
   ...
   */
  public ApigatewayExpr setExpression(java.lang.String expression) {
   ...
   */
  public ApigatewayExpr setLocation(java.lang.String location) {
   ...
   */
  public ApigatewayExpr setTitle(java.lang.String title) {
    this.title = title;
    return this;
  }

  @Override
  public ApigatewayExpr set(String fieldName, Object value) {
    return (ApigatewayExpr) super.set(fieldName, value);
  }

  @Override
  public ApigatewayExpr clone() {
    return (ApigatewayExpr) super.clone();
  }
