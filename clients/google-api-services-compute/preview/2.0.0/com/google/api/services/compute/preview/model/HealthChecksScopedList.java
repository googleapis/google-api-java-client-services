...
public final class HealthChecksScopedList extends com.google.api.client.json.GenericJson {
   ...
   */
  public HealthChecksScopedList setHealthChecks(java.util.List<HealthCheck> healthChecks) {
   ...
   */
  public HealthChecksScopedList setWarning(Warning warning) {
    this.warning = warning;
    return this;
  }

  @Override
  public HealthChecksScopedList set(String fieldName, Object value) {
    return (HealthChecksScopedList) super.set(fieldName, value);
  }

  @Override
  public HealthChecksScopedList clone() {
    return (HealthChecksScopedList) super.clone();
  }
