...
public final class FirewallPolicy extends com.google.api.client.json.GenericJson {
   ...
   *
   * A firewall policy with the VPC scope set to GLOBAL_VPC_NETWORK is allowed to be attached only
   * to global networks.
   *
   * When the VPC scope is set to REGIONAL_VPC_NETWORK the firewall policy is allowed to be attached
   * only to regional networks in the same scope as the firewall policy.
   *
